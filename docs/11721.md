...
> 原文:[https://dev . to/0x koji/train-own-image-classifier-with-one-line-command-1ho8](https://dev.to/0xkoji/train-own-image-classifier-with-one-line-command-1ho8)
...
## [](#train-image-classifier)训练图像分类器

...
### [](#100x-magnification)放大 100 倍

在我的设置中，我走的是惰性路线，使用一个全局状态对象(`window.data`)来控制 vuejs 数据。这种方法很难理解 js 何时会观察到变化。但是，如果我想模拟一个状态，只需在控制台中修改该对象就很好了。

供参考:

## ![GitHub logo](../Images/a73f630113876d78cff79f59c2125b24.png)[【kyleprisi】](https://github.com/kyleparisi)/[【无建筑-vuej】](https://github.com/kyleparisi/buildless-vuejs)

...
> 原文:[https://dev.to/glebec/when-nesting-promises-is-correct-h8f](https://dev.to/glebec/when-nesting-promises-is-correct-h8f)
...
## [](#libraryspecific-bluebird-raw-bind-endraw-)图书馆专用:蓝鸟`bind`
...
## [](#acompliant-ecmaapproved-raw-promiseall-endraw-)符合 A+，ECMA 批准:`Promise.all`
...
## [](#controlled-state-shared-scope)受控状态，共享范围
...
## [](#the-punchline-nested-promises)笑点:嵌套承诺
...
## [](#silly-experiment-formatting-tricks)愚蠢的实验:格式化的把戏
...
## [](#the-promised-land-asyncawait)应许之地:异步/等待

...
> 原文:[https://dev . to/Samantha Ming/es6-arrow-functions-cheat sheet-1cn](https://dev.to/samanthaming/es6-arrow-functions-cheatsheet-1cn)

[![Code Tidbit by SamanthaMing.com](../Images/b3d6fa8e74b4a4f69a86aa0c5e073de3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vlqQ-UWU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/rhg7nntibsuufeibmt4u.png)
...
## [](#implicit-vs-explicit-return)隐性 vs 显性回归
...
### [](#example-a-normal-function)例题 A:普通函数
...
### [](#example-b-arrow-function-with-explicit-return)例 B:显式返回的箭头函数
...
### [](#example-c-arrow-function-with-implicit-return)示例 C:带隐式返回的箭头函数
...
### [](#parentheses-are-optional-for-a-single-parameter)括号对于单个参数是可选的
...
### [](#parentheses-are-required-for-multiple-parameters)多个参数需要括号
...
## [](#arrow-functions-gotcha-returning-objects)⚠️箭头函数 Gotcha:返回对象

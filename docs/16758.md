...
> 原文:[https://dev.to/simov/oauth-like-a-boss-2m3b](https://dev.to/simov/oauth-like-a-boss-2m3b)
...
# [](#login-from-another-host)从另一台主机登录
...
# [](#login-from-browser-extension)从浏览器扩展登录
...
# [](#login-from-another-language)从另一种语言登录

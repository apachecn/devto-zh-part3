...
> 原文:[https://dev.to/dr_sam_walpole/short-circuit-assignment-25ik](https://dev.to/dr_sam_walpole/short-circuit-assignment-25ik)

# [](#assigning-default-values-to-variables-in-javascript)在 Javascript 中给变量赋予默认值
...
## [](#logical-operators-and-nonboolean-values)逻辑运算符和非布尔值

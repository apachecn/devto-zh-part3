...
> 原文:[https://dev.to/hexrcs/fun-with-javascript-regex-101c](https://dev.to/hexrcs/fun-with-javascript-regex-101c)
...
## [](#repetition-qualifiers-aka-quantifiers)重复限定词(又名。量词)
...
## [](#sometimes-we-need-to-escape)有时候我们需要逃避
...
## [](#predefined-character-class-shorthands)预定义字符类简写

...
> 原文:[https://dev . to/Nicky tonline/dev-to-s-frontend-a-brain-dump-in-one-act-7mg](https://dev.to/nickytonline/dev-to-s-frontend-a-brain-dump-in-one-act-7mg)
...
## [](#preact-webpacker-amp-webpack)[Preact，webpacker & webpack](#preact-webpack-webpacker)
...
[dev.to/webpacker.yml 在 master the practical dev/dev . to GitHub](https://github.com/thepracticaldev/dev.to/blob/master/config/webpacker.yml)T2】
...
[dev.to/development.js 在 master the practical dev/dev . to GitHub](https://github.com/thepracticaldev/dev.to/blob/master/config/webpack/development.js)T2】
...
# [![GitHub logo](../Images/75095a8afc1e0f207cda715962e75c8d.png)  @在评论框中提及自动完成 #354](https://github.com/thepracticaldev/dev.to/issues/354) 

[![benhalpern avatar](../Images/2b95d19f70b4d1ccc724ce3ad9480e00.png)](https://github.com/benhalpern) **[benhalpern](https://github.com/benhalpern)** posted on [<time datetime="2018-08-14T18:32:13Z">Aug 14, 2018</time>](https://github.com/thepracticaldev/dev.to/issues/354)
...
[dev.to/application.html.erb 在 master the practical dev/dev . to GitHub](https://github.com/thepracticaldev/dev.to/blob/master/app/views/layouts/application.html.erb#L38)T2】
...
[dev.to/_top_bar.html.erb 在 master the practical dev/dev . to GitHub](https://github.com/thepracticaldev/dev.to/blob/master/app/views/layouts/_top_bar.html.erb#L12)T2】
...
[dev.to/Search.jsx 在 master the practical dev/dev . to GitHub](https://github.com/thepracticaldev/dev.to/blob/master/app/javascript/packs/Search.jsx#L5)T2】
...
## [](#instantclick)[瞬间点击](#instant-click)
...
[dev.to/githubRepos.jsx 在 master the practical dev/dev . to GitHub](https://github.com/thepracticaldev/dev.to/blob/master/app/javascript/packs/githubRepos.jsx#L11)T2】
...
[dev.to/buildCommentHTML.js.erb 在 master the practical dev/dev . to GitHub](https://github.com/thepracticaldev/dev.to/blob/master/app/assets/javascripts/utilities/buildCommentHTML.js.erb#L80)T2】
...
## [](#linting-code-formatting)[【林挺】/代码格式化](#linting-formatting)

### [](#eslint-amp-prettier)斯洛文尼亚&职业
...
### [](#writing-a-storybook-story)写故事书故事
...
### [](#stuff-to-do-for-storybook)为故事书做的事情

这目前还没有部署到 Netlify，但有一个问题尚未解决。

# [![GitHub logo](../Images/75095a8afc1e0f207cda715962e75c8d.png) 部署故事书 #338](https://github.com/thepracticaldev/dev.to/issues/338) 

[![nickytonline avatar](../Images/849ad90a82f294a93718c2c4da688f82.png)](https://github.com/nickytonline) **[nickytonline](https://github.com/nickytonline)** posted on [<time datetime="2018-08-13T02:05:51Z">Aug 13, 2018</time>](https://github.com/thepracticaldev/dev.to/issues/338)
...
[![The DEV Team](../Images/6b3a9c79aeecf790d5144f3fe1881f50.png)![](../Images/fe64a787b888dfb20fc13ad1e466da3d.png)](/devteam) [## 诚聘投稿人:夜间模式/开发主题
...
[![CSS code snapshot](../Images/ab091c36f4f4ad25a8f58f80a60c9247.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8OdzbR0W--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/mbpdyjirntq3aoefp2m3.png)

主题切换的魔力可以在用户配置中看到。在这里，我们可以看到一些应用的风格，无论是夜晚主题还是粉色主题。

[dev.to/_user_config.html.erb 在 master the practical dev/dev . to GitHub](https://github.com/thepracticaldev/dev.to/blob/master/app/views/layouts/_user_config.html.erb#L8)T2】
...
### [](#edge-caching-and-the-frontend)边缘缓存和前端
...
[![I know kungfu](../Images/fe18ca947b47cd3d391c62e73d224640.png)](https://i.giphy.com/media/3o7btNhMBytxAM6YBa/giphy.gif)T3】

...
> 原文:[https://dev . to/yawaramin/a-modular-ocaml-project-structure-1 ikd](https://dev.to/yawaramin/a-modular-ocaml-project-structure-1ikd)
...
## [](#why-raw-mynamemyproject-endraw-instead-of-raw-mynamemyproject-endraw-)为什么是`Myname__Myproject`而不是`Myname.Myproject`
...
## [](#the-toplevel-module-should-contain)顶层模块应该包含...
...
## [](#exported-modules-vs-not)导出模块 vs 未导出模块
...
## [](#aliased-module-cyclic-dependencies)别名模块循环依赖

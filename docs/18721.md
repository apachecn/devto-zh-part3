...
> 原文:[https://dev.to/roznet/word-cloud-thumbnails-for-jekyll-4elj](https://dev.to/roznet/word-cloud-thumbnails-for-jekyll-4elj)

我爱字云。由于我刚刚用 jekyll 创建了一个网站，我想知道将单词云缩略图作为缩略图添加到帖子列表中会是什么样子，会有多难？

## [](#building-the-word-cloud-images)建筑一字云图像
...
[![](../Images/d77afd6a714e16bc388e4544dc750583.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--viH4sevq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://roznet.github.io/assets/clouds/2018-12-09-wordcloud-jekyll-thumbnail.png)
...
## [](#adding-the-thumbnail-to-the-list-of-posts)给帖子列表添加缩略图
...
## [](#positioning-the-thumbnail)定位缩略图
...
## [](#automating-the-generation)自动化生成

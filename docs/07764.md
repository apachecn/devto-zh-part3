...
> 原文:[https://dev . to/chrisrhymes/using-laravel-口才-s-多对多关系-d61](https://dev.to/chrisrhymes/using-laravel-eloquent-s-many-to-many-relationship-d61)
...
## [](#creating-models-migrations-and-controllers)创建模型、迁移和控制器

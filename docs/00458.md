...
> 原文:[https://dev . to/walking river/introduction-to-typescript-for-explored-developers-25hd](https://dev.to/walkingriver/introduction-to-typescript-for-experienced-developers-25hd)
...
# [](#object-and-array-literals)对象和数组文字
...
# [](#some-are-more-equal-than-others)有些人比另一些人更平等
...
# [](#what-about-raw-var-endraw-)那`var`呢？

...
> 原文:[https://dev.to/chaseadamsio/writing-drafts-in-gatsbyjs-netlify-3 CHN](https://dev.to/chaseadamsio/writing-drafts-in-gatsbyjs--netlify-3chn)
...
### [](#finding-drafts-is-clear)找草稿很清楚
...
### [](#single-author-hosting-content-on-dropbox)单个作者在 Dropbox 上托管内容
...
## [](#how-i-write-drafts-in-gatsby)我如何在《盖茨比》中写草稿

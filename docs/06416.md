...
> 原文:[https://dev . to/azure/building-a-server less-IOT-solution-with-kotlin-azure-functions-and-signalr-2 lpg](https://dev.to/azure/building-a-serverless-iot-solution-with-kotlin-azure-functions-and-signalr-2lpg)
...
[![solution overview](../Images/081acd57bda1b9250059f899dbc237e2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--3VhTWdJQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gloveboxes/Going-Serverless-with-Kotlin-Azure-Functions-SignalR/master/docs/resources/solution-architecture.png)
...
## [](#developing-kotlin-azure-functions)开发 Kotlin Azure 函数
...
## [](#solution-components-included-in-this-github-repo)解决方案组件(包含在本 GitHub repo 中)
...
### [](#telemetry-calibration-optimization)遥测校准优化
...
## [](#azure-signalr-integration)Azure SignalR 集成
...
[![](../Images/cd564dfe1edf801f07d6820a9163c811.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--umkLgrSy--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gloveboxes/Going-Serverless-with-Kotlin-Azure-Functions-SignalR/master/docs/resources/service-side-signalr.png)

## [](#set-up-overview)设置概述
...
### [](#step-1-follow-the-raspberry-pi-simulator-guide-to-set-up-azure-iot-hub)第一步:按照 Raspberry Pi 模拟器指南设置 Azure 物联网中心
...
[![raspberry Pi Simulator](../Images/eb2c127481db398f6f4669b57649c6b8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--QOkeHfbG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://docs.microsoft.com/en-us/azure/iot-hub/media/iot-hub-raspberry-pi-web-simulator/3_banner.png%3FWT.mc_id%3Ddevto-blog-dglover)

### [](#step-2-create-an-azure-resource-group)第二步:创建 Azure 资源组
...
### [](#step-3-create-a-azure-signal-service)第三步:创建 Azure 信号服务
...
### [](#step-4-create-a-storage-account)第四步:创建存储账户
...
### [](#step-5-clone-the-project)第五步:克隆项目
...
### [](#step-7-open-the-kotlin-azure-functions-project-with-intellij)第七步:用 IntelliJ 打开 Kotlin Azure Functions 项目
...
### [](#step-8-update-the-localsettingsjson)第八步:更新 local.settings.json
...
### [](#step-9-deploy-the-kotlin-azure-function)第九步:部署 Kotlin Azure 功能

打开' **Maven** 标签，运行' **clean** '，运行' **package** ，然后运行' **azure-functions:deploy**

[![](../Images/ffad0a96aac8819bafd2078d0617cb7f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--nUdsnHKj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gloveboxes/Going-Serverless-with-Kotlin-Azure-Functions-SignalR/master/docs/resources/azure-function-deploy.jpg)

### [](#step-10-enable-static-websites-for-azure-storage)第十步:为 Azure 存储启用静态网站
...
### [](#step-11-enable-cors-for-the-signalr-net-core-azure-function)步骤 11:使能信号员的 CORS。NET Core Azure 函数
...
### [](#step-12-start-the-dashboard)第十二步:启动仪表盘
...
[![dashboard](../Images/c68d3731bcb1a1675f977f660c0cc47b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--t2T6SDDp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gloveboxes/Going-Serverless-with-Kotlin-Azure-Functions-SignalR/master/docs/resources/dashboard.png)
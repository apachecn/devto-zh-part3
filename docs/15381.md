...
> 原文:[https://dev . to/admiralty/running-Argo-workflows-cross-multiple-kubernetes-clusters-4 jap](https://dev.to/admiralty/running-argo-workflows-across-multiple-kubernetes-clusters-4jap)
...
## [](#a-multicluster-pods-journey)一个多集群吊舱的旅程
...
## ![GitHub logo](../Images/a73f630113876d78cff79f59c2125b24.png)/[多集群调度器](https://github.com/admiraltyio/multicluster-scheduler)
...
### [](#scenario-a-optimizing-a-large-parallel-workflow)场景 A:优化大型并行工作流
...
### [](#scenario-b-multicluster-etl)场景 B:多集群 ETL
...
## [](#discussion-podlevel-federation)讨论:Pod 级联邦

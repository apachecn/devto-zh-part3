...
> 原文:[https://dev . to/RF _ Schubert/how-to-create-a-pip-package-and-host-on-private-github-repo-58pa](https://dev.to/rf_schubert/how-to-create-a-pip-package-and-host-on-private-github-repo-58pa)
...
### [](#creating-root-path-and-start-a-git)创建根路径并启动 git
...
#### [](#installing-with-raw-pip-endraw-)用`pip`安装
...
### [](#how-to-deploy-to-heroku)如何部署到 Heroku？

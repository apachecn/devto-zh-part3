...
> 原文:[https://dev.to/snesjhon/readmemd-as-a-personal-site-1km7](https://dev.to/snesjhon/readmemd-as-a-personal-site-1km7)
...
# [](#github-pages-gitlab-pages-showdownjs)Github 页面，Gitlab 页面+对决. js
...
### [](#so-why-not-just-a-simple-raw-html-endraw-file)那么为什么不只是一个简单的`html`文件呢？
...
# [](#overengineering-a-solution)(完)工程一解决方案

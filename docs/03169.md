...
> 原文:[https://dev . to/moesif/steps-to-building-authentic ation-and-authorization-for-graphql-APIs-2c6e](https://dev.to/moesif/steps-to-building-authentication-and-authorization-for-graphql-apis-2c6e)
...
## [](#the-difference-between-authentication-and-authorization)认证和授权的区别
...
## [](#authentication-authorization-and-graphql)认证、授权和 GraphQL
...
### [](#structure-of-a-graphql-system)一个 GraphQL 系统的结构

GraphQL 系统的结构如下图所示:

[![GraphQL System Structure](../Images/e5854b985301949e6de3020f50f48572.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Ck3dmfW_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/75tvovigykdkogeq519s.png)
...
### [](#integration-of-authentication-into-graphql)将认证集成到 GraphQL 中
...
### [](#integration-of-authorization-into-graphql)授权集成到 GraphQL 中

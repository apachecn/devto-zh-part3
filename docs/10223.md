...
> 原文:[https://dev . to/Victoria/a-remote-sync-solution-for-IOs-and-Linux-git-and-working-copy-19cl](https://dev.to/victoria/a-remote-sync-solution-for-ios-and-linux-git-and-working-copy-19cl)

[![](../Images/127fa15c6c500e29098cb62cfb712e06.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Xzld4qw4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://victoria.dev/verbose/a-remote-sync-solution-for-ios-and-linux-git-and-working-copy/cover_remote-sync_hu1984111f2d75b603219adcc3d215dc57_618766_640x0_resize_box_2.png)
...
[![Settings menu in Working Copy](../Images/217509990e329515ee611097d7d86d0b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--OcQj-mjC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://victoria.dev/verbose/a-remote-sync-solution-for-ios-and-linux-git-and-working-copy/workingcopy-settings.png%23screenshot)

点击 SSH 键，您将看到以下屏幕:

[![SSH Key for Working Copy on iPad](../Images/b5baf2e08ae67160b3e5f71fc61b4ed7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--GA5QFy3b--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://victoria.dev/verbose/a-remote-sync-solution-for-ios-and-linux-git-and-working-copy/workingcopy-ssh.png%23screenshot)
...
[![Connect to GitHub or Bitbucket in Working Copy](../Images/650ec8554d7734540e8ed0e0ef40c8ac.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--kPZEfD5S--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://victoria.dev/verbose/a-remote-sync-solution-for-ios-and-linux-git-and-working-copy/workingcopy-ssh-connect.png%23screenshot)

工作副本支持轻松连接 BitBucket 和 GitHub。点击“与 GitHub 连接”或 BitBucket，调出一些熟悉的登录屏幕，授权工作副本访问您的帐户。

连接后，点击侧边栏右上角的“+”号添加新的存储库。选择“克隆存储库”以显示此屏幕:

[![Loading repositories from remote](../Images/c30b8d6a9e391a0e9b10662d3329201a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--mndGPIl3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://victoria.dev/verbose/a-remote-sync-solution-for-ios-and-linux-git-and-working-copy/workingcopy-read-repos.png%23screenshot)

在这里，您可以手动输入远程 URL，或者简单地从 Working Copy 从您连接的帐户获取的存储库列表中选择。当你做出选择时，应用程序会将存储库克隆到你的 iPad 上，并显示在侧边栏中。你接通了！

## [](#open-and-edit-files-with-ia-writer)用 iA Writer 打开并编辑文件
...
## [](#push-changes-back-to-remote)将更改推回远程

对文件进行更改后，再次打开工作副本。您应该在更改后的存储库上看到一个黄点。

[![Yellow dot indicating changes to repository](../Images/b6fbe909caf901cffb3b3d86dca7e04a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--bL39z4b7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://victoria.dev/verbose/a-remote-sync-solution-for-ios-and-linux-git-and-working-copy/workingcopy-changed-repo.png%23screenshot)
...
[![Changes to commit](../Images/ab3423bd0b5e7e7e044df4c291b85f58.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--XmFQzSGn--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://victoria.dev/verbose/a-remote-sync-solution-for-ios-and-linux-git-and-working-copy/workingcopy-changes-to-commit.png%23screenshot)
...
[![Add a commit message and select files to commit](../Images/cf7fa6f6b9dc2b4ed9c27218030a7afb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Q2x3Qs-O--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://victoria.dev/verbose/a-remote-sync-solution-for-ios-and-linux-git-and-working-copy/workingcopy-commit-changes.png%23screenshot)

输入提交消息，并选择要添加的文件。当您提交文件时，打开“推送”开关将所有内容发送到您的远程存储库。然后点击“提交”

上传文件时，您会看到一个进度条，然后在状态屏幕上显示一条确认消息。

[![Commit success message](../Images/c70e393c13c465a24876ce9078969809.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--6VhZ3lmJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://victoria.dev/verbose/a-remote-sync-solution-for-ios-and-linux-git-and-working-copy/workingcopy-commit-success.png%23screenshot)

恭喜你！您的更改现在出现在 GitHub 上的远程存储库中。您已成功远程同步了您的文件！

## [](#pull-changes-from-repository-on-your-computer)从您计算机上的存储库中提取变更
...
[![List of Remotes in Working Copy](../Images/6060da6dfe2080361c8bbe4b534ed34f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--J_upm5s0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://victoria.dev/verbose/a-remote-sync-solution-for-ios-and-linux-git-and-working-copy/workingcopy-git-remote.png%23screenshot)

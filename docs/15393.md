...
> 原文:[https://dev . to/app signal/serving-plug-building-an-elixir-http-server-from-scratch-205 I](https://dev.to/appsignal/serving-plug-building-an-elixir-http-server-from-scratch-205i)
...
[![A screenshot of our Elixir HTTP server displaying the current time.](../Images/0ff5215d489bdff56a2db2d03afbb972.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--7KMPdswz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.appsignal.com/images/blog/2019-01/http_1.png)
...
### [](#writing-a-plug-adapter)编写一个插头适配器
...
[![A screenshot of our Elixir HTTP server displaying the current time.](../Images/ba66b95ab38d386d0c26dd5f6ca9397d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--JbehwlPI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.appsignal.com/images/blog/2019-01/http_2.png)

## [](#swapping-out-plug-applications)换出插件应用
...
[![A screenshot of our Elixir HTTP server running Plug.Octopus.](../Images/911f12fe6db16cfe6c0fe67ca82df9d3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--05TlJ_1q--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.appsignal.com/images/blog/2019-01/octopus_1.png)

但是，点击*翻转！*和*撞车了！* buttons 不做任何事情，任何被调用的 URL 都显示相同的页面。这是因为我们完全跳过了解析请求。因为我们不读取请求，所以我们总是返回相同的响应。让我们解决这个问题。

## [](#parsing-requests)解析请求
...
[![A screenshot of our Elixir HTTP server running Plug.Octopus and accepting URL parameters.](../Images/8d386d0a2783f98a3cbc4baa09b82a36.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vV4E04YC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.appsignal.com/images/blog/2019-01/octopus_2.png)

## [](#a-minimal-web-server-example-that-flips-and-crashes)一个最小的 Web 服务器例子，翻转和崩溃

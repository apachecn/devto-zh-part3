...
> 原文:[https://dev.to/metamn/rgb-vs-hsl-another-round-3db5](https://dev.to/metamn/rgb-vs-hsl-another-round-3db5)

人们应该能够使用代码来处理颜色，并以思考其他编程工件(如数据和算法)的同样方式来思考颜色。

## [](#color-models-and-spaces)颜色模型和空间

...
> 原文:[https://dev . to/seang Wright/kentico-12-class-libraries-with-modern-net-core-features-34n 5](https://dev.to/seangwright/kentico-12-class-libraries-with-modern-net-core-features-34n5)

[![](../Images/4205c446e392193836475867fbe4714c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--pFrrEcwK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AehNR1NeN_rfOV6p5lktvdQ.png)

## [](#three-great-net-core-features)三大。网络核心功能
...
### [](#how-does-modern-net-work-with-kentico)如何现代。和 Kentico 的网络工作？
...
### [](#-raw-ltpackagereferencegt-endraw-)`<PackageReference>`
...
### [](#the-new-common-project-system-cps)新建通用项目系统(CPS)
...
<figure>[![](../Images/4c127ab5a4ba5965daa0569ba21f5b97.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--fueldKSk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/400/1%2A54sskJQdx1F57EDpNe3A1A.jpeg) 

<figcaption>想知道为什么`Mono.Cecil`或`AngleSharp`在你的 Kentico 项目的`/bin`里？现在，您可以使用新的 CPS 来挖掘整个依赖关系树。</figcaption>

T9】</figure>

## [](#lets-build-something-the-kentico-library)我们来建个东西:肯帝科图书馆！👊
...
<figure>[![](../Images/c5c39240e42a1a499c52354e70282639.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--N4m6vlkx--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AVQSsoMAzKFj6lUcAKKJJmw.png) 

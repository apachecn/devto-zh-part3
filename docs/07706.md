...
> 原文:[https://dev . to/iheartbenzee _ 20/teaching-yourself-to-code-iv-76m](https://dev.to/iheartbenzene_20/teaching-yourself-to-code-iv-76m)
...
相反，老实说，我很难让同样的函数在 Python 中很好地工作。 [![Python Gradient Descent](../Images/f0bbce84df8cb2bd59f479eb3bb179dc.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--ExStyTVz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/kg5fkzwhcmd6wqziqozp.png) 
就像，它最终是一个小得多的代码量，但这些 [![runtime warnings](../Images/e5fc19d8fbb1088cfb8aed8b0effb2ad.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--o_y1N6-0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/qzqzf44bpcuaj0ehy7ym.png) 表明，如果我想在这种情况下保持功能，就必须以不同的方式处理某些东西。诚然，Python 版本没有编码表面图，甚至没有等高线图，但如果它确实在下降的初始部分有问题，那么我可能还不应该担心这些事情。

然而，我再次为我的预算被改写和使用一些样本数据的小小成就感到自豪。 [![sample budget](../Images/ef6ec5d7bdb67abf7a3b14fea07791b1.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--5Et7CqBf--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/1jn2chlsrakupeb7dmhr.png) 
在这种情况下，线性回归图 [![linear regression](../Images/c63aa4ada141eb50a50a660c0b88660c.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--bAWVtznS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8flzpdz4qt8ykgcayrdb.png) 也可以，但我最终不得不使用 numpy 的 polyfit 功能，而不是像我希望的那样使用渐变下降。要么这样，要么严重限制了分析中使用的范围...但老实说，这似乎有点矛盾，因为梯度下降被誉为一种旨在找到局部(或全局)最优的机器学习算法，我觉得如果范围变得太小，那么它的能力将被严重抑制。

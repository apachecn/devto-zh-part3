...
> 原文:[https://dev . to/dotnetcoreblog/html-rendering-an-important-lesson-54hp](https://dev.to/dotnetcoreblog/html-rendering-an-important-lesson-54hp)

*标题图片:[现场笔记和铅笔](https://unsplash.com/photos/EPppwcVTZEo)by[hello queue](https://unsplash.com/@helloquence)T5】*

我周末发了一条推特:

> ![](../Images/1c336ed90a5be0209d65d175a9ce465b.png)dotnetcore . show@ dotnetcore show![](../Images/4d9c44713c216584b3d48ff3455cbb68.png)当你把一个页面的负载从 2.99 秒降到 700 毫秒的那一刻(无需使用缓存)
> [# kindOfABigDeal](https://twitter.com/hashtag/kindOfABigDeal)[# web optimization](https://twitter.com/hashtag/webOptimisation)下午 14:31-2019 年 1 月 19 日[![Twitter reply action](../Images/269095962147c28351274afdd5486a48.png)](https://twitter.com/intent/tweet?in_reply_to=1086632262702108672)
...
[![My current site design](../Images/2596ac02bb7d4579f964deb08e006f42.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--wOTbkTJn--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/j6l5xjxh97crwcqx5xqo.jpg)

## [](#the-issue-and-how-browsers-render-html)问题——以及浏览器如何呈现 HTML
...
### [](#but-we-can-do-better)但是我们可以做得更好

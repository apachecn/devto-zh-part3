...
> 原文:[https://dev . to/angular/ngrx-from-the-beginning-part-iii-ngrx-store-13bf](https://dev.to/angular/ngrx-from-the-beginning-part-iii-ngrx-store-13bf)
...
### [](#%C2%A0with-a-function-selector)带功能选择器

...
> 原文:[https://dev . to/nab bisen/gitea-on-openbsd-using-official-package-2 ogl](https://dev.to/nabbisen/gitea-on-openbsd-using-official-package-2ogl)
...
### [](#1-preparing-database)#1。正在准备数据库
...
##### [](#-note-giteacustom)#(注)GITEA_CUSTOM
...
#### [](#suppressing-u2f-temporarily)压制 U2F(暂时？)
...
#### [](#activatingstarting-daemon)激活/启动守护进程
...
[![nabbisen](../Images/6759a36884202f6cf21b258b1e80383e.png)](/nabbisen) [## rcctl:如何在 OpenBSD 6.4 中调试
...
### [](#5-initialization-via-web-installer)#5。通过 Web 安装程序初始化

目标快到了！
让我们使用网络浏览器访问网站，然后转到`/install`。
跟随网络安装程序给我们带来了温和的目标:

[![web installer](../Images/8bf7212a5d276a9a37902f8e9e241d4e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--_0srbIuA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/sy3muv23s0b2lhlt49fz.png)

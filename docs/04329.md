...
> 原文:[https://dev . to/just alever/latest-news-rails-6-jump start-pro-and-kick-updates-28g 0](https://dev.to/justalever/latest-news-rails-6-jumpstart-pro-and-kickoff-updates-28g0)
...
### [](#kickoff-tailwind-rails-application-template)启动–顺风(Rails 应用程序模板)

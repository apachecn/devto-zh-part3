...
> 原文:[https://dev . to/learn byexample/ruby-regexp-part-5-matched-portions-904](https://dev.to/learnbyexample/ruby-regexp-part-5-matched-portions-904)

# [](#working-with-matched-portions)处理匹配部分
...
## [](#using-regexp-as-a-string-index)使用 regexp 作为字符串索引
...
## [](#split-with-capture-groups)用捕获组分割
...
## [](#regexp-global-variables)regexp 全局变量
...
## [](#substitution-in-conditional-expression)条件表达式中的替换

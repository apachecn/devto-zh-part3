...
> 原文:[https://dev . to/Maxwell _ dev/the-three-little-creative-patterns-a-design-patterns-intro-1 DMN](https://dev.to/maxwell_dev/the-three-little-creational-patterns-a-design-patterns-intro-1dmn)
...
## [](#introducing-design-patterns-as-fairy-tales)介绍童话般的设计模式
...
## [](#building-a-straw-house-with-a-factory)用工厂建造稻草屋
...
## [](#building-a-stick-house-with-a-prototype)用原型建造一个棍子房子
...
## [](#building-a-brick-house-with-a-builder)用建筑工人建造砖房
...
## [](#building-a-business-with-a-singleton)单身创业
...
[![maxwell_dev](../Images/e584c820fe4a86bb236ed5cdf1a3fe68.png)](/maxwell_dev) [## Eevees，测验，和单曲，哦，我的天！

### 最大 Anton ucci Apr 5 ' 195 分钟读数

#javascript #ember #showdev](/maxwell_dev/eevees-quizzes-and-singletons-oh-my-1blh)

## [](#taking-over-the-housing-market-with-an-abstract-factory)用抽象工厂接管房市

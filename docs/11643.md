...
> 原文:[https://dev . to/Samantha Ming/how-to-deep-clone-an-array-in-JavaScript-3c ig](https://dev.to/samanthaming/how-to-deep-clone-an-array-in-javascript-3cig)

[![Code Tidbit by SamanthaMing.com](../Images/698d802e0bb9028c52f212e021d4ade5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--PYLtLqbO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/may9lgvv80ou524d7kzo.png)
...
## [](#arrays-are-reference-types)数组是引用类型
...
### [](#copying-a-reference-type)复制参考类型
...
### [](#shallow-vs-deep-clone)浅层 vs 深层克隆
...
### [](#values-not-compatible-with-json)值与 JSON 不兼容

...
> 原文:[https://dev . to/the passle/web-components-from-zero-to-hero-part-three-3c5h](https://dev.to/thepassle/web-components-from-zero-to-hero-part-three-3c5h)

# [](#web-components-from-zero-to-hero-part-three)Web 组件:从零到英雄，第三部分

## [](#web-components-hero-with-litelement)Web 组件英雄同💥文学元素💥
...
### [](#properties-and-attributes)💅属性和特性
...
### [](#lifecycle-and-rerendering)♻️生命周期和重新渲染

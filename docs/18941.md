...
> 原文:[https://dev . to/tee Kay/everything-you-need-to-know-about-tree-data-structures-2599](https://dev.to/teekay/everything-you-need-to-know-about-tree-data-structures-2599)

[![](../Images/ef2df6f21f083497a9f7bbfea21e5f8a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Y4Q45wEI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1000/1%2AWeWOBZy6N7cXkq4inS7FVA.jpeg)
...
### [](#lets-dive-into-real-life-examples)让我们深入现实生活中的例子吧！

我说的分层次是什么意思？

想象一个家谱图，它包含了所有世代的关系:祖父母、父母、子女、兄弟姐妹等等。我们通常按等级组织家谱。

[![](../Images/b54766109d59aed609b24044ba4c7830.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--0tv6KF8j--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AMasdC5DmucEU2abIXQe45Q.jpeg)
...
[![](../Images/453c18850b8241dfc9bc9d6998e0c929.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--TaS49Ec0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AGsBCmW5E1GuJ3MpH3Zz0Ew.jpeg)

在 HTML 中，文档对象模型(DOM)像树一样工作。

[![](../Images/55f8de7e792b98277057d59adc05c7f9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ZzEW2y6I--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AdLXUdR4NuIZG8GJdu_Cinw.jpeg)

`HTML`标签包含其他标签。我们有一个`head`标签和一个`body`标签。那些标签包含特定的元素。`head`标签有`meta`和`title`标签。`body`标签包含显示在用户界面中的元素，例如`h1`、`a`、`li`等。

### [](#a-technical-definition)一个技术定义

一个`tree`是被称为`nodes`的实体的集合。节点由`edges`连接。每个`node`包含一个`value`或`data`，它可能有也可能没有`child node`。

[![](../Images/ec3b68af7002027e4034a655573bc70f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--gZMQ0Jwu--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2A3WN7tIQ-kNBQmY9MgvTuOA.jpeg)

`tree`的`first node`称为`root`。如果这个`root node`由另一个`node`连接，那么`root`就是一个`parent node`，连接的`node`就是一个`child`。

[![](../Images/271e60e1f8fcee13e81f64daf3f8c048.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--NxozBvGm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2A9AtR3bhhlMJxQlaUVEQgrw.jpeg)

所有的`Tree nodes`都由称为`edges`的链路连接。它是`trees`的重要组成部分，因为它管理着`nodes`之间的关系。

[![](../Images/982a60cc1905caf7b271eadf1d682915.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--w0Zwv36P--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2Aj5qKwIxKcEjoxy88EOc1Rg.jpeg)

`Leaves`是`tree.`上的最后一个`nodes`它们是没有孩子的节点。像真树一样，我们有`root`、`branches`，最后还有`leaves`。

[![](../Images/ed64fa85f247226268687317f1d40fa0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Pknhtei3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2Ac9_5uMUsIy4Q3OA7Q8bJiw.jpeg)
...
[![](../Images/0d829c5691c29d0b718e8d8ddb3cb983.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--tDccGu9N--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2Aofbwuz4inpf2OlB-l9gtHw.jpeg)

### [](#lets-code-a-binary%C2%A0tree)我们来编码一棵二叉树
...
[![](../Images/37e3e84bdfecfcc6268f05c4efb08acf.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--uh_BNuvu--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AV_EUgNXVc8Wy9H1-JoqT3g.jpeg)
...
#### [](#depthfirst-search%C2%A0dfs)深度优先搜索(DFS)

在**回溯**并探索另一条路径之前，DFS 探索一条路径直到一片叶子。让我们看一个这种类型遍历的例子。

[![](../Images/695df68d70b59c59a93ced0d81efab56.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Gz5INn68--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2A-sCuUx3R9e1ougu2pGdThg.jpeg)
...
#### [](#breadthfirst-search%C2%A0bfs)广度优先搜索(BFS)

**BFS** 算法对`tree`逐层逐深度遍历。

[![](../Images/417929c80ee5f13b8bb893a8afca728c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--7zu7494a--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AZNxp_NkRZLCeak85rreebA.jpeg)
...
[![](../Images/89e615f9d11b2afba0be0da857fd3004.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--zjjP3vvy--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AA4yGfEoiqcZ-COvAfr2CWQ.jpeg)

### [](#binary-search%C2%A0tree)二叉查找树
...
[![](../Images/f41fe6143ce470e00747e8d61ee3d7a6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--AOuDVCa4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AmslH9VtVUN9Hs983XxUN5A.jpeg)
...
### [](#lets-code-a-binary-search%C2%A0tree)我们来码一个二叉查找树吧！
...
#### [](#insertion-adding-new-nodes-to-our%C2%A0tree)插入:向我们的树添加新的节点

假设我们有一个空的`tree`,我们想添加一个新的`nodes`,其值依次为:50，76，21，4，32，100，64，52。

我们需要知道的第一件事是 50 是否是我们的树的`root`。

[![](../Images/6c89d2a645201c78719b7d8f1209fd73.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vgN4PX3Z--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AfxSlTwgQSN_DlzfEmcxqQg.jpeg)
...
[![](../Images/6f40e45bc840a9a4949c4f46b0972feb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Xf8wSkm6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2ALlLDNx7wgJfH6VAGnyAbIQ.jpeg)
...
#### [](#lets-search-for-the-node-value-or%C2%A0not)让我们搜索节点值…或者不…
...
[![](../Images/690d5d7de792c48cd5db166a294db3fd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--6kCGeqVQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2ANwvTrpKiJWb1u2yAY-nnAA.jpeg)
...
#### [](#deletion-removing-and-organizing)删除:移除和组织

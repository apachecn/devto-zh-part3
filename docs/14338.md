...
> 原文:[https://dev.to/soasme/enqueuezero-techshack-2019-05-5b7](https://dev.to/soasme/enqueuezero-techshack-2019-05-5b7)

# enqueue zero Techshack 2019-05

## [](#our-software-dependency-problem)我们的软件依赖问题
...
## [](#systemd-as-tragedy)Systemd 为悲剧
...
## [](#finding-kafkas-throughput-limit-in-dropbox-infrastructure)寻找 Kafka 在 Dropbox 基础设施中的吞吐量极限
...
## [](#its-time-to-move-on-from-twophase-commit)是时候离开两阶段提交了
...
## [](#selecting-a-software-architecture)选择软件架构
...
## [](#a-lifetime-of-systems-thinking)一生的系统思考
...
## [](#lessons-learned-scaling-postgresql-database-to-12bn-recordsmonth)将 PostgreSQL 数据库扩展到每月 12 亿条记录的经验教训
...
[![paradigms](../Images/0c5119b1f790d2fb7d8814d19aba8104.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ItF6F2L7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://adriancolyer.files.wordpress.com/2019/01/Programming-paradigms-Fig-2.png)

*   解决一个编程问题需要选择正确的概念，许多问题需要不同部分的不同概念集。而且，很多程序要解决的问题不止一个！缺少问题的范例会让你的程序难看。

[![state](../Images/c570bb2dabc0f31882540fc4fb60a0c0.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--snBwqp-K--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://adriancolyer.files.wordpress.com/2019/01/Programming-paradigms-Fig-3.jpeg)
[![The four ways of organize a data abstraction](../Images/236c14728847732a99120960331a56ea.png)T6】](https://res.cloudinary.com/practicaldev/image/fetch/s--xKS0NIlt--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://adriancolyer.files.wordpress.com/2019/01/Programming-paradigms-Fig-14.jpeg)
...
## [](#scaling-azure-functions-to-make-500000-requests-to-weathercom-in-under-3-minutes)扩展 Azure 功能，在 3 分钟内向 Weather.com 发出 50 万个请求
...
*   总体设计:![overall design](../Images/6c8ab0136f20e355e69a6bc8968a3dd1.png)
    *   坐标存储在 Azure 表存储中。记录是不可变的。
    *   持久函数用于用表中的坐标填充一组存储队列。每条消息代表一个对天气服务的未决请求。
    *   为队列中的每条消息调用 Azure 函数。
    *   向第三方服务发出请求以获取预测详细信息。
    *   预测请求的结果被发布到事件中心以供进一步处理。
*   为了使队列触发的函数运行得更快，负载(数据获取请求)被分布到多个队列中。![load balancing](../Images/1fe6114ac3157998d481fb26d1774ae6.png)
...
## [](#serverless-at-scale-serving-stackoverflowlike-traffic)大规模无服务器:服务堆栈式流量
...
## [](#why-we-use-ruby-on-rails-to-build-gitlab)为什么我们使用 Ruby on Rails 来构建 GitLab
...
## [](#develop-new-features-vs-maintain)开发新功能 v/s 维护

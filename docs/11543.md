...
> 原文:[https://dev . to/惠晶/an-exercise-in-progressive-enhancement-lk1](https://dev.to/huijing/an-exercise-in-progressive-enhancement-lk1)
...
## [](#a-basic-koajs-application-on-glitch)一个关于 Glitch 的基本 Koa.js 应用
...
[![Starting a new Node project on Glitch](../Images/0d9701b3b18bd05da5e745d8a3f7657e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--i8fNhcow--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.chenhuijing.com/assets/images/posts/progressive-enhancement/glitch-1280.jpg)

如果你想确保你的项目持续下去，注册一个故障账户是个好主意。Glitch 一直在相当频繁地进行功能改进，所以如果你阅读的是遥远的未来，这可能会改变，但在撰写本文时，他们支持通过脸书、GitHub、电子邮件或登录代码登录。

[![Sign in to a Glitch account](../Images/ccdeb931c5531148a720ea44485e9f3e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--414vJDZh--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.chenhuijing.com/assets/images/posts/progressive-enhancement/glitch2-1280.jpg)

默认情况下，Glitch 上的节点应用程序运行在 Express 上，这完全没问题。我选择在我的项目中使用 Koa.js，所以还需要几个步骤。

[![Default package.json on a fresh Glitch Node project](../Images/dfbeaf35b033de782b73bb09540ae2a4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--HIZ483bJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.chenhuijing.com/assets/images/posts/progressive-enhancement/glitch3-1280.jpg)

如果你点击屏幕左下方的工具，你会看到一些选项，比如日志、控制台、容器统计等等。

[![Tools options on Glitch](../Images/61c8721cef5085971cabcf376af64cfe.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--NU9GaljS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.chenhuijing.com/assets/images/posts/progressive-enhancement/glitch4-1280.jpg)

在开发应用程序时打开日志是很好的，因为你的一切都会在这里显示出来。

[![Viewing logs on Glitch](../Images/fb039da1d798c3aed3758c2a3f2aa91c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--piyH2l-N--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.chenhuijing.com/assets/images/posts/progressive-enhancement/glitch5-1280.jpg)

要定制您想要在项目中使用的 npm 模块，您可以像访问本地机器或远程服务器一样访问命令行。需要注意的一点是，Glitch 使用`pnpm`作为包管理器，而不是`npm`。

[![Accessing the Glitch console](../Images/61d1064631f04807ef077e9ff8e32534.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--FDiipU5V--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.chenhuijing.com/assets/images/posts/progressive-enhancement/glitch6-1280.jpg)
...
[![Check that Koa.js is running fine](../Images/c0589b97475a2a72703e9cd7cbce97ee.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--2Vw3ThJ6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.chenhuijing.com/assets/images/posts/progressive-enhancement/glitch7-1280.jpg)
...
## [](#basic-routing-and-rendering)基本路由和渲染
...
## [](#interacting-with-the-database)与数据库交互
...
[![Every form submission will refresh the page](../Images/756aa9309ab247f8adeb972adfa1e64b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--wwkM3aMO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/nbcipivycbv2neiyvkee.gif)

## [](#adding-the-clientside-javascript)添加客户端 Javascript
...
[![No reload, just parsing the response data](../Images/396c83ccca42e059b157bdecc80f9c83.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--_A4MbC65--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/roq9kzs6yfrg88jx1zp0.gif)
...
[![remix button](../Images/098a93546163c1d1bd480b4e3054d673.png)T2】](https://glitch.com/edit/#!/remix/no-js-no-problem)

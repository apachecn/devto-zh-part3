...
> 原文:[https://dev.to/flaviabastos/networking-for-developers-第二部分-应用层和传输层-21dh](https://dev.to/flaviabastos/networking-for-developers--part-2-application-and-transport-layers-21dh)
...
### [](#troubleshooting-the-application-and-transport-layers)应用层和传输层故障排除

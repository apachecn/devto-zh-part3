...
> 原文:[https://dev.to/dexygen/accidentally-declarative-g37](https://dev.to/dexygen/accidentally-declarative-g37)

#### [](#an-approach-for-mapping-input-field-values-tofrom-json)一种将输入字段值映射到 JSON 从 JSON 映射的方法

...
> 原文:[https://dev . to/mmphego/how-I-configured-sonar qube-for-python-code-analysis-with-Jenkins-and-docker-28fm](https://dev.to/mmphego/how-i-configured-sonarqube-for-python-code-analysis-with-jenkins-and-docker-28fm)
...
## [](#run-sonarqube-server)运行 SonarQube 服务器
...
[![](../Images/4f977050f7a18799b352af755e90d917.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--QKo3ybuQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.mphomphego.co.za/assets/sonarqube_server.png)

跑步，

[![SonarqubeHome](../Images/02b9d58d82f8c8efdf80796620138023.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--aBfYUtAo--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.mphomphego.co.za/assets/sonarqube-running.png)
...
*   使用**管理员** / **管理员**登录，并按照提示进行操作。
    ...
    *   遵循所有提示并保存您的令牌以备将来使用。![Sonarqube setup](../Images/9b76386610eb23030ea441b1cb907511.png)
*   进入**管理**标签- > **市场** - > **已安装**
...
## [](#configuring-sonarscanner-on-jenkins)在 Jenkins 上配置声纳扫描仪
...
### [](#enable-analysis-with-sonarqube-scanner)启用 SonarQube 扫描仪分析
...
[![Sonarqube scanner](../Images/5465e3175416f28efa72b72f6e074afe.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--2B8eAR1N--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.mphomphego.co.za/assets/sonarqube-scanner.png)

## [](#configure-jenkins-build)配置詹金斯构建
...
*   *我的个人属性* ![SonarqubeHome](../Images/9267cbeb5f9a162b52ec4a9bd2eba7e2.png)
...
1.  确认在您的构建中配置了 SonarQube。
    ...
    [![SonarqubeHome](../Images/6e83c3a553fc2a0eec3c1295eecd6bcb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--YKSRRwvA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.mphomphego.co.za/assets/sonarqube-builder.png)
...
## [](#interpreting-sonarqubes-results)解读 SonarQube 的结果
...
[![SonarqubeProj](../Images/d1efff1f06611617d5d0157dcb403786.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--HyXSCTfa--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.mphomphego.co.za/assets/sonarqube-project.png)

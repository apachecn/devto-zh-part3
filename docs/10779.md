...
> 原文:[https://dev . to/making loops/visualizing-thin-aspnet-controllers-via-solid-principles-33nl](https://dev.to/makingloops/visualizing-thin-aspnet-controllers-via-solid-principles-33nl)

[![](../Images/4da4b5d1d825408ba77bc3681d757670.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--lnFmV1Jl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/n5qjmssanu75ossseym4.png)
...
[![A fat controller](../Images/eeb527e6df54aae8e6ec3238b6fe409a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--zgolIx-x--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://makingloops.com/public/fat-controller.png)
...
### [](#so-why-is-this-a-code-smell)那么，为什么这是一种码味呢？
...
## [](#thin-controllers-via-the-single-responsibility-principle)瘦控制器采用单一责任原则
...
[![A fat controller with changes animated](../Images/05f61798335d511dd7af3b516f08550d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--uxuL8QoX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://makingloops.com/public/fat-controller-changes.gif)

我用闪烁的红色和绿色方块来表示变化的区域。绿色表示添加代码，红色表示修改或删除现有代码。

我们如何改进这个设计，使它不那么吸引熵？

## [](#shrinking-the-controllers-change-surface-with-application-services)用应用服务收缩控制器的变化面

一个直接的策略是将协调 dto 和`LoanQuote`之间工作的逻辑转移到通常被称为*应用服务*的地方。

然后，可以为应用服务分配该任务编排的单一职责，**让控制器成为 HTTP 请求和服务方法**之间的简单网关。

[![A controller making use of an application service](../Images/4ca2e62451233546fc6591a805d4ef06.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--i_r4JhQw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://makingloops.com/public/app-service.png)
...
## [](#programming-to-interfaces-to-support-extension-and-further-reduce-the-change-surface)编程*到*接口支持扩展，进一步减少变化面

在创建应用程序服务时，我倾向于将实现隐藏在接口后面，以便更容易测试，通过 decorators 进行扩展，并尽可能清楚地表明我的松散耦合意图。

[![An application service interface](../Images/07bb967b03f283a940631e0472f665d7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--LMc3GtQ2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://makingloops.com/public/app-service-interface.png)
...
## [](#bloated-application-services)臃肿的应用服务
...
[![A controller with multiple fat actions](../Images/2ed3a441878e36efc958d221209a4a7d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--G1IQlUuB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://makingloops.com/public/multi-action-fat-controller.png)
...
## [](#breaking-up-fat-application-services-via-cqrs)通过 CQRS 拆分 fat 应用服务
...
[![Applying CQRS](../Images/e8e991ca4beb11232ce4188e6cfccbaa.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9Kv0zH99--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://makingloops.com/public/cqrs.png)

...
> 原文:[https://dev . to/oktadev/a-quick-guide-to-oauth-2-0-with-spring-security-1cad](https://dev.to/oktadev/a-quick-guide-to-oauth-2-0-with-spring-security-1cad)
...
## [](#create-an-oauth-20-server)创建 OAuth 2.0 服务器
...
## [](#build-your-client-app)构建您的客户端应用
...
## [](#test-the-resource-server)测试资源服务器
...
## [](#create-a-new-spring-boot-app)创建新的 Spring Boot App
...
[![Okta Login Form](../Images/7c7d5000e9dbe55325f3ed32969305b6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--49_27Zhc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://d33wubrfki0l68.cloudfront.net/5a507d253535a8b3eee9fe025ef700aef81de6ba/7bb85/assets-jekyll/blog/spring-boot-authz-server/okta-login-c689b6b1793dc3aed41d8fd719c57944d8887baaa17400dd40e6dfb537bc6db4.png)

登录，你会看到有你名字的安全页面！

## [](#learn-more-about-spring-boot-spring-security-and-oauth-20)了解有关 Spring Boot、Spring Security 和 OAuth 2.0 的更多信息

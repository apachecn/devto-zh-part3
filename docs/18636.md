...
> 原文:[https://dev.to/kylessg/step-by-step-写作-e2e-为你的网络项目测试-4mde](https://dev.to/kylessg/step-by-step---writing-e2e-tests-for-your-web-project-4mde)
...
[![](../Images/9ab1526729d2f2818b19718e6d249742.png)T2】](https://i.giphy.com/media/1AIR5b2wYTtNUVuSlw/giphy.gif)
...
# [](#1-project-setup)1。项目设置

*项目:[https://github.com/kyle-ssg/e2e-tutorial/](https://github.com/kyle-ssg/e2e-tutorial/tree/master)T3】*

## [](#11-installing-nightwatch-selenium-and-chromedriver)1.1。安装 nightwatch、selenium 和 chromedriver
...
## [](#12-writing-a-nightwatchconfjs-file)1.2。编写 nightwatch.conf.js 文件
...
## [](#13-adding-a-script-in-packagejson-to-run-tests)1.3。在 package.json 中添加脚本以运行测试
...
## [](#14-writing-our-test-entry-file)1.4。编写我们的测试入口文件
...
## [](#15-our-skeleton-tests)1.5。我们的骨骼测试
...
# [](#2-writing-our-first-test)2。编写我们的第一个测试
...
## [](#22-targeting-dom-elements-sensibly)2.2 明智地瞄准 DOM 元素
...
## [](#3-finishing-our-confirm-email-tests-with-mailinator)3。用 mailinator 完成我们的确认邮件测试
...
[![](../Images/aeb6d5d627976b8c4b6dcb2155d35f01.png)T2】](https://i.giphy.com/media/28evywxMTHbvLdLakP/giphy.gif)

...
> 原文:[https://dev . to/sema text/docker-container-monitoring-and-management-challenges-3jfe](https://dev.to/sematext/docker-container-monitoring-and-management-challenges-3jfe)

[![container monitoring challenges](../Images/6c643222a901b673d7fcdf4535eed4e7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--X10F0EyS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://sematext.com/wp-content/uploads/2019/04/Docker-monitoring-part-1-FI_black-1024x560.jpg)
...
## [](#new-infrastructure-layers)**新建基础设施层**
...
## [](#new-dynamic-deployment-and-orchestration)**新的动态部署和编排**
...
## [](#new-resource-management-and-metrics)**新的资源管理和指标**
...
## [](#new-log-management-needs)**新增日志管理需求**
...
## [](#new-microservice-architecture-and-distributed-transaction-tracing)**新的微服务架构和分布式事务跟踪**
...
## [](#new-container-monitoring-tools)**新型集装箱监控工具**

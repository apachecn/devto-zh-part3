...
> 原文:[https://dev.to/gugadev/observables-尤娜-介绍人-4k7](https://dev.to/gugadev/observables---una-introduccin-4k7)

观测值是您可以“订阅”以访问这些值的“lazy”价值观集合。Observable 是一种新的 JavaScript“推送”系统；它通过“推”观测者(消费者)产生多个值。

## [](#qu%C3%A9-es-un-sistema-push)是“推”系统吗？
...
## [](#anatom%C3%ADa-de-un-observable)不可观察

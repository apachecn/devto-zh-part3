...
> 原文:[https://dev . to/awwsmm/build-a-fluent-interface-in-Java-in-less-5-minutes-m7e](https://dev.to/awwsmm/build-a-fluent-interface-in-java-in-less-than-5-minutes-m7e)

[(跳到精彩部分！)](#good-part)

## [](#building-a-basic-class)建筑基础类
...
## [](#building-a-custom-constructor)构建自定义构造函数

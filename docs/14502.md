...
> 原文:[https://dev . to/csuartedwards/create-an-angular-6-site-in-net-core-part-2-3g 05](https://dev.to/cstuartedwards/create-an-angular-6-site-in-net-core-part-2-3g05)
...
3.  添加一个**型号**文件夹到项目:
    [![](../Images/209cfd399ee397adefc0f68dd2f1a672.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--CsjPcjMr--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://charles.stuartedwards.me.uk/media/Blog%2520Images/Post%25203/3-14.png)

4.  添加一个**英雄**类到模型文件夹:选择**模型**文件夹。按下 **Shift + Alt + C** 打开**添加新项目**对话框。选择类物品，命名为 **Hero.cs** 。
    [![](../Images/56b1cc4c2bd8202f1e587222fb535049.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--a8d-6KGs--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://charles.stuartedwards.me.uk/media/Blog%2520Images/Post%25203/3-15.png)
...
7.  该类需要从 **DbContext** an 继承，需要添加适当的使用引用:
    [![](../Images/14a25e82243174f76b76ecb2b7835635.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--ZvGo0_TM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://charles.stuartedwards.me.uk/media/Blog%2520Images/Post%25203/3-17.png)
...
12.  添加一个**控制器**文件夹:
    [![](../Images/ba0fe0ef6c26cf90b1de3bdffe77e584.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--jhWlI6rf--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://charles.stuartedwards.me.uk/media/Blog%2520Images/Post%25203/3-18.png)

13.  添加一个 API 控制器:选择**控制器**文件夹。按下 **Shift + Alt + C** 。选择 **Web** 类别并选择 **API 控制器类**。将该类命名为 **HeroesController** 并点击**添加**
    [![](../Images/b7c7ac796216d939d2687dd294114b9a.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--0naJVA-N--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://charles.stuartedwards.me.uk/media/Blog%2520Images/Post%25203/3-19.png)
...
15.  用以下内容替换 **Get** 方法:
    ...
    [![](../Images/5ae1edfe9eeff2307b7fc336ac04601f.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--ouxEE-rQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://charles.stuartedwards.me.uk/media/Blog%2520Images/Post%25203/3-20.png)，检查 API 调用是否有效

    如果您想测试 Angular 应用程序是否与新的 api 一起工作，那么在 app.module.ts 文件中注释掉导入数组中的**httpclientmemorywebapimodule**声明:
    [![](../Images/b5983ae1c1963b64b0218351523716fe.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--xxlYXQ9j--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://charles.stuartedwards.me.uk/media/Blog%2520Images/Post%25203/3-21.png)

    导航到 **/heroes** ，您应该会看到 GetAll 方法中声明的英雄。
    T3![](../Images/1dafbf3afa630e0abcf0aaa701d06c7c.png)T5】
...
18.  用下面的**创建**方法替换 **Post** 方法:
    ...
    [![](../Images/2689d7111f3d8928f201e19094f23083.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--W-semJvm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://charles.stuartedwards.me.uk/media/Blog%2520Images/Post%25203/3-23.png)
    ...
    [![](../Images/edcd09af8d3dcf101b0ce539c4f77096.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--hbfrzxuh--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://charles.stuartedwards.me.uk/media/Blog%2520Images/Post%25203/3-24.png)

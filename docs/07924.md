...
> 原文:[https://dev . to/Allen Woods/how-to-setup-a-domain-on-VPS-from-registration-to-SSL-certification-4d oh](https://dev.to/allenwoods/how-to-setup-a-domain-on-vps-from-registration-to-ssl-certification-4doh)

[![Server Room](../Images/625fa9dcdb299a53d3b96de4ae0c4be4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--n2AEq_y---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.maintech.com/wp-content/uploads/2016/09/iStock_70297009_XXXLARGE.jpg)

# [](#there-is-never-a-right-time)永远没有“正确”的时间
...
# [](#creating-a-droplet-on-digitalocean)在数字海洋上创建水滴
...
### [](#commanding-the-line-ubuntu)居高临下(Ubuntu)
...
### [](#using-secure-shell-ssh)使用安全外壳(SSH)
...
### [](#choosing-a-droplet-type)选择一个液滴类型
...
[![4 GB Memory, 2 vCPU, 80 GB SSD, 4 TB Transfer](../Images/83ea56161ebdd23de65c0978da9ee33a.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--4guo6And--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/jt92xzno7ii8h1du6ylu.png)
...
### [](#uploading-your-hello-world)上传你的 Hello World
...
# [](#binding-your-domain-to-your-host)将您的域绑定到您的主机
...
### [](#nameservers-ip-and-ssl)域名服务器、IP 和 SSL

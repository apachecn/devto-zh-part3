...
> 原文:[https://dev.to/magnificode/intro-to-graphql-queries-381d](https://dev.to/magnificode/intro-to-graphql-queries-381d)
...
### [](#querying-all-of-a-type)查询所有的一种类型

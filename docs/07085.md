...
> 原文:[https://dev.to/rshiva/welcome-to-nginx-part-ii-32km](https://dev.to/rshiva/welcome-to-nginx-part-ii-32km)

本帖是[第一部](https://dev.to/rshiva/welcome-to-nginx-part-i-58mn)的续篇。如果你还没有读过那篇文章，我推荐你读一下。

默认情况下，nginx 有一些文件夹和文件，如下所示。

[![nginx_folder](../Images/c14fbc8c01774bafb9a46a5123ce6a87.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--64taAr0p--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/piaotz3mj3e1naeuu1at.png)

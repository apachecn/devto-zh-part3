...
> 原文:[https://dev . to/shinda Kun/interactive-with-the-dev to-article-API-a-simple-retry-system-551m](https://dev.to/shindakun/interacting-with-the-devto-article-api---a-simple-retry-system-551m)

# [](#atlg-sidebar)ATLG 边栏

## [](#but-what-about-errors)但是错误呢

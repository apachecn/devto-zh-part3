...
> 原文:[https://dev . to/robertohuertasm/publishing-a-flutter-package-with-Travis-ci-20 H3](https://dev.to/robertohuertasm/publishing-a-flutter-package-with-travis-ci-20h3)

你正在考虑建立一个[颤振包](https://pub.dartlang.org/flutter)或者你已经建立了一个，但你不知道如何设置[特拉维斯-CI](https://travis-ci.org/) ？如果是这样的话，你来对地方了！

## [](#building-a-flutter-package)构建一个扑包
...
[![Pub Scoring](../Images/22ded3d4abbccc78bbda738b3a05d650.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--UjEhsX9y--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/1k3bzto4u5bp8p6ee9gn.png)

## [](#composing-the-travisci-configuration-file)构成 Travis-CI 配置文件
...
[![Travis environment variables](../Images/53f39f44c17784d00ddec65adc5e13fe.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--yRbzWuv---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/jcgahna80j4yvqwotn5r.png)

## [](#things-to-take-into-account)把事情考虑进去

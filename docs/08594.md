...
> 原文:[https://dev . to/azure/building-a-visual-studio-code-extension-dkj](https://dev.to/azure/building-a-visual-studio-code-extension-dkj)

# [](#visual-studio-code-extension-development)Visual Studio 代码扩展开发
...
### [](#what-kind-of-extensions-can-i-build)可以构建什么样的扩展？

你可以建造任何你想建造的东西。您可以构建几个主要的扩展“类型”,这可以让您更好地了解从哪里开始。让我们按照你可能想做的事情来把它们分类。

#### [](#1-customize-vs-codes-look-and-feel)1。定制 VS 代码的外观和感觉
...
[![The result when cycling through VS Code color theme options](../Images/c3d1761d2b413f84a0bca4d1e389c117.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--U4M6yWzS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/aqx4ru3kvmv30wmnh8yr.gif)
...
[![The result when cycling through VS Code icon theme options](../Images/b28ed21bc99fe2232bdbbf6dcd44f085.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--yGPIBu8U--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/c7osr8qz093hr1133zd4.gif)

* * *

#### [](#2-extend-existing-functionality)2。扩展现有功能
...
#### [](#3-add-new-functionality)3。添加新功能
...
#### [](#4-aggregate-other-extensions-into-one-place)4。将其他扩展聚合到一个地方
...
### [](#how-do-i-build-an-extension)如何构建扩展？

最简单的扩展之一是颜色主题扩展。现在让我们一步一步地构建其中的一个。

#### [](#building-a-color-theme-extension)构建颜色主题扩展
...
[![VS Code Yeoman Generator - results from running yo code in the terminal/command prompt](../Images/b1a6d983b18bd084e3ac78744b238548.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--JEfyFTL0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/e6x6l1vfo5vo55gedk8o.png)

当你输入完你的颜色主题的所有选项后，在最后一个提示下按`Enter`键开始生成所有的东西。您将在终端/命令提示符下看到一些进展，显示它为您生成的文件和文件夹。

[![VS Code Yeoman Generator - results from running yo code in the terminal/command prompt](../Images/a4982bfbae1d93e5bf95379d0e24cbc3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--b1W6QV0p--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/j5ttotn1201k7zeu6y86.png)

完成后，您应该会看到一条消息，内容如下:“要开始编辑 Visual Studio 代码，请使用以下命令:”运行下面显示的命令，您会看到 VS Code 打开了颜色主题扩展的文件夹。

[![VS Code with the current color theme extension folder open](../Images/058eb953fcea8a294364ea11119c725d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--jrF93jGT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/zvcxfnq5rl8ojd6ahc20.png)

使用键盘快捷键`CTRL/CMD + SHIFT + D`在 VS 代码中打开调试器视图(或者点击有 bug 的图标)。点击绿色的“播放”按钮(如下图所示)开始调试/运行你的颜色主题扩展。

[![VS Code with the current color theme .json file open](../Images/9c9eb81659d8c9fab7a2cdb9873efabb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--a8Gc0e3F--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/kat6ziphx2qpp9nsupld.png)
...
[![VS Code with the current color theme .json file open](../Images/40604903e3bcc36d07f0b4c7340f9e32.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--a_DMfJIk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/d63w8m50wbqjnzehkweb.png)

回到另一个打开了扩展文件夹的 VS 代码实例。展开“主题”文件夹，双击`.json`文件打开/查看内容。

[![VS Code with the current color theme .json file open](../Images/088e0c0517b267305afb8ea9d2d81079.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--44Jna96K--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/iaz9vbpywvvpire7tm6b.png)
...
[![Editing the background color for the color theme in VS](../Images/464e8c68fa4d5c99c57996c9e65433b3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--0evWUYJx--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/agw0c23qixn1ymkrm4mp.png)

一旦你保存了你的修改，你会看到 VS 代码的“扩展开发主机”会自动更新并显示颜色的变化。

[![Editing the background color for the color theme in VS](../Images/c7b63931cb74a57748b550c47d4c0b67.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--XX1ep-w1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/jb15tt8902y8kt7959qy.png)

你做到了！祝贺您为 Visual Studio 代码创建了第一个扩展！随意继续调整`.json`文件中的颜色选项，进一步定制你的颜色主题扩展。

#### [](#building-something-more)多建点东西
...
[![Terminal/command line prompt using the Yeoman generator for VS Code and selecting 'New Extension (TypeScript)'](../Images/16dc2e846005b8d28dcfbf445c21d3e8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--PXRmmMNr--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/6k3x1lxdkjp2y4s6qdks.png)
...
[![Filling in options for creating a new VS Code extension with the Yeoman generator](../Images/41c25429ec68deb28dee0abbf263c912.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--j7Iqw8cg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/93uji99emqhn7f6i8gek.png)

切换到新生成的扩展目录，并在 VS 代码中打开它

[![Changing directories and opening the folder in VS Code via the terminal/command line](../Images/1ab760b8ddf9335203d1ee04e1a8f8bb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--HM0ViJnX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/hr56jncdzqs9lujclqzq.png)
...
[![Modifying the package.json file for our new extension](../Images/1a0d9590d8db7d6c5adff69d5cfbd468.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8A0t08Bw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/l9j8dj4c9v9umzt4og5p.png)
...
[![Changing the name of the registered command in code](../Images/5d7473334aa15b6de99600f1aa75291c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--0sfV6oCs--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/nnwrbgpt8e84qf5bzilb.png)
...
[![Creating a new file in the 'src' folder](../Images/8d69196873fcb9d7d5f6a0919883d3f6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Jm9W3F96--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4n8j7jm5cimw4va0z36z.png)
...
[![Running/debugging the Extension Lister extension](../Images/9803c637466aaa8fd7ab66d58c1bd785.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--zsOCPBOY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/vqgrwy8qvsdntk0k5l62.png)

然后，您将看到一个新的 VS 代码实例加载，标题为“扩展开发主机”，其中运行着您的扩展。使用键盘快捷键`CTRL/CMD + SHIFT + P`打开命令面板，并键入`lister`来查看我们的扩展可用的命令。

[![Testing out the Extension Lister extension](../Images/67cde8b9d8266fa3952dabbb04fc9b5d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Lt0xaYsh--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ull8yq84dx5g0tygeow5.png)

按下键盘上的“Enter”键，系统会提示您为文件选择一个位置和名称。为您的文件选择一个位置和名称，然后单击“保存”按钮。您应该会看到在 VS 代码的右下角弹出一个成功通知。

[![A success notification for completing the file creation in our extension](../Images/fb6e3419331054dd0eddc91473d3b70b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--u5crruUg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/x8deblmu2jenmlyuurm6.png)

只是为了确保转到您保存文件的位置并打开它来查看内容。您应该会看到您正在使用的活动扩展的完整列表及其 marketplace URLs。

[![The resulting file contents from the VS Code Extension Lister extension](../Images/1009b5fcb006afd3050954fdae0f3a92.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--v4LZ3HeQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/l3mejaj13c3pgfkxz2yh.png)

恭喜你创建了另一个 VS 代码扩展，并且增加了新的功能！

### [](#how-do-i-publish-the-extension)如何发布扩展？
...
### [](#where-do-i-go-to-find-out-more)去哪里了解更多？

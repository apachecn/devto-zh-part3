...
> 原文:[https://dev . to/baens/setting-up-a-docker-container-on-a-container-optimized-OS-running-on-the-Google-cloud-1 iik](https://dev.to/baens/setting-up-a-docker-container-on-a-container-optimized-os-running-on-the-google-cloud-1iik)
...
# [](#making-gcloud-do-all-the-work)让 gcloud 做所有的工作
...
# [](#setting-up-a-custom-docker-image)设置自定义 Docker 图像
...
# [](#authenticating-with-the-registry)向注册中心认证
...
# [](#notes-on-troubleshooting)故障排除注意事项

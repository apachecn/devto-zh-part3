...
> 原文:[https://dev.to/fteem/a-deeper-dive-in-elixirs-plug-2dk8](https://dev.to/fteem/a-deeper-dive-in-elixirs-plug-2dk8)
...
[![](../Images/67e32c8eb4c136244d7b70fc02e1575c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--gjaHzbBb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/wc1em7dxm4kmw7zq7efb.jpg)
...
## [](#web-servers-yeehaw)Web 服务器，yeehaw！
...
## [](#plugging-a-plug-as-an-endpoint)插一个插头作为端点
...
## [](#diving-into-the-raw-plugconn-endraw-)潜入`Plug.Conn`
...
## [](#nextlevel-raw-plug-endraw-ging-using-raw-plugrouter-endraw-)下一级`Plug`使用`Plug.Router`生成
...
### [](#-raw-pluglogger-endraw-)`Plug.Logger`

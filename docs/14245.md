...
> 原文:[https://dev.to/blizzerand/react-basics-状态-道具-功能-组件-5cll](https://dev.to/blizzerand/react-basics--state-props--functional-components-5cll)
...
## [](#final-words-choosing-the-right-component)最后的话——选择正确的组件

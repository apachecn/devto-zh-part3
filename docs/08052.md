...
> 原文:[https://dev . to/ij lee 2/animation-and-predictable-data-loading-in-ember-j74](https://dev.to/ijlee2/animation-and-predictable-data-loading-in-ember-j74)
...
# [](#1-predictable-data-loading)1。可预测的数据加载
...
## [](#a-raw-linkto-endraw-bug)a. {{link-to}} bug
...
[![As of version 3.8, Ember documentation suggests that it's okay to pass model to the link-to helper. It is not.](../Images/fb74528fa632804998eb332df7b2370f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Ij9m3jK6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://crunchingnumbersdotlive.files.wordpress.com/2019/04/ember_link_to.png)
...
[![Ember Data Storefront provides a runtime error for missing data relationships.](../Images/a6649e46ab08ba1422eafb2629d59b58.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--uz0n6ILF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://crunchingnumbersdotlive.files.wordpress.com/2019/04/ember_data_storefront_error.jpg)
...
## [](#a-web-animations-api)a .网页动画 API

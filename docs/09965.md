...
> 原文:[https://dev . to/jamesmh/where-do-I-put-my-business-rules-and-validation-o2f](https://dev.to/jamesmh/where-do-i-put-my-business-rules-and-validation-o2f)
...
# [](#a-short-ddd-primer)一本简短的 DDD 入门书
...
# [](#where-does-my-validation-go)我的验证去哪了？

在 DDD，业务规则和验证进入值对象是一个很好的实践。

有两个基本属性使它成为一项伟大的技术——不变性和在创建时立即验证。

## [](#immediate-validation)立即验证
...
# [](#insurance-policy-scenario)保险单场景
...
## [](#adding-our-business-rules)添加我们的业务规则
...
### [](#how-to-process-invalid-state)如何处理无效状态
...
## [](#but-what-about-showing-multiple-error-messages)但是显示多个错误信息怎么办？
...
## [](#using-our-value-objects-for-validation)使用我们的值对象进行验证

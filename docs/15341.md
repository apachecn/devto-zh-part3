...
> 原文:[https://dev.to/mikister/blueprint-一个样板-终端工具-57pb](https://dev.to/mikister/blueprint---a-boilerplate-tool-for-the-terminal-57pb)
...
#### [](#creating-a-new-blueprint)创造新的*蓝图*
...
#### [](#deleting-an-existing-blueprint)删除已有的*蓝图*
...
#### [](#listing-all-existing-blueprint)列出所有现存的*蓝图*
...
#### [](#searching-for-blueprint-names-with-regex)用正则表达式搜索*蓝图*名称
...
#### [](#showing-contents-of-a-blueprint)显示蓝图的内容
...
## [](#what-i-plan-to-do-with-this)我打算用这个做什么

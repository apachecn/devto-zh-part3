...
> 原文:[https://dev.to/justalever/lets-build-with-ruby-on-rails-活动安排-支付应用-hce](https://dev.to/justalever/lets-build-with-ruby-on-rails--event-scheduling-app-with-payments-hce)
...
## ![GitHub logo](../Images/292a238c61c5611a7f4d07a21d9e8e0a.png)/[请教](https://github.com/justalever/consultly)

### 一个演示 Rails 应用程序，围绕咨询和安排事件的概念构建。

<article class="markdown-body entry-content container-lg" itemprop="text">

[![Let’s Build: With Ruby on Rails – Event Scheduling App with Payments](../Images/189ca6bc7c995815685b27cc9074f080.png)T2】](https://web-crunch.com/lets-build-ruby-on-rails-event-scheduling-app-payments/)
...
#### [](#the-lets-build-with-ruby-on-rails-series-so-far)到目前为止，让我们用 Ruby on Rails 构建系列

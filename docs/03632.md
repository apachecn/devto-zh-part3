...
> 原文:[https://dev.to/joro550/side-project-update-1-4o2a](https://dev.to/joro550/side-project-update-1-4o2a)

# [](#starting-my-project)开始我的项目

所以我不得不做了很多研究才走到这一步，但是感觉真好！让我带你看一下到目前为止我已经完成的一些决策和代码。

## [](#feature-set-right-now)功能设置(此时)
...
## [](#what-else-have-you-done)你还做过什么？

天哪，这还不够吗！？我想我还想谈两件事，一件我犯的小错误和一件很酷的事

### [](#mistake-you-say)你说失误？
...
### [](#what-about-the-cool-thing)那很酷的东西呢？

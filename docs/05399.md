...
> 原文：<https://dev.to/carlillo/4-javascript-challenges-13-high-school-students-2-hours-4456>
...
[![Challenge 1](img/66bc67f0dac82cc13d2b2fb17c9700f4.png)](https://cdn-images-1.medium.com/max/2000/0*-ADM580IeTro_e7y.gif)

这个问题中的 HTML 文档如下所示:

[![](img/ad8dc6d03ebd1d6a9568527989294dae.png)](https://cdn-images-1.medium.com/max/3212/1*80KFkx5_mzV1AD6j-N9Smw.png)

提供给学生的 JavaScript 文件如下，其中有注释和文本 TODO，他们应该在那里进行修改。

[![](img/9db1298e1b36c468faa960245344a807.png)](https://cdn-images-1.medium.com/max/3348/1*uDY7AzbTxAhGN0U5PSlJ7g.png)

## 问题 2——猜一个数

第二个问题稍微复杂一些。目标是创建一个算法，其中随机生成一个介于 1 和 7 之间的数字。然后，玩家可以输入数字，试着猜一猜。有 3 次猜测数字的尝试，如果没有，游戏就输了。无论哪种情况，都必须向玩家显示一条消息。

[![Challenge 2](img/6e2ae95ff0031a0f2a3b9214dab26455.png)](https://cdn-images-1.medium.com/max/2850/0*SC9CswJ9F-4LXkQW.gif)

这个问题中的 HTML 文档如下所示:

[![](img/6c2e6a51335f039d752dc12667d2b909.png)](https://cdn-images-1.medium.com/max/3212/1*ewb0JJj8fg2KW6wG-9S0cQ.png)

提供给学生的 JavaScript 文件如下:

[![](img/ac751be650287408eb7414ced5f91f8e.png)](https://cdn-images-1.medium.com/max/2368/1*i1bp9LQGsHidOSFrxset9A.png)
...
[![Chanllenge 3](img/39d9f46afb5702c27bd5275ebd2dff72.png)](https://cdn-images-1.medium.com/max/2848/0*wJGX3SK-KDCiV9Fs.gif)

[![](img/cfa9aa72ebfb4a6bdfa4591d56eeba65.png)](https://cdn-images-1.medium.com/max/3416/1*MfGye7havr97FZR3Pr_h9A.png)

提供给学生的 JavaScript 文件如下:

[![](img/4a6fe46aac066d34b6bcb2092faa1729.png)](https://cdn-images-1.medium.com/max/3244/1*tuJCyMUvuPKyC2tZ1AZHbQ.png)
...
[![Challenge 4](img/840ae0056a14881d9f89dd983bdb7d57.png)](https://cdn-images-1.medium.com/max/2142/0*Sc73JZBg7inBbEfw.gif)

[![](img/d05c66c17ea59de1f401af054fcb4d88.png)](https://cdn-images-1.medium.com/max/3280/1*HhRmOQE8cCv4k_pNNddkDQ.png)

提供给学生的 JavaScript 文件如下:

[![](img/2fd272efbe159d99f946f7be9334a227.png)](https://cdn-images-1.medium.com/max/2808/1*taJGfAS-5RoppF3u-b_S4w.png)

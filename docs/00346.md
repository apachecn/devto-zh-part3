...
> 原文:[https://dev.to/dotnet/trying-out-try-net-ckn](https://dev.to/dotnet/trying-out-try-net-ckn)

试一试。NET 是一个来自。允许你在浏览器中尝试. NET。你可以把它看作是一种创造互动的方式。NET 文档使用。网芯。

## [](#what-is-try-net)什么叫尝试。网
...
[![Markdown with a runnable code bock showing hello world code being run](../Images/4a3e98c09d169f19d6ec68ef06de20d2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--DaRX7ohE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8xrq2t5eez4zqo1cf0lp.png)

### [](#only-surface-what-you-need)只表面自己需要的东西
...
## [](#creating-your-first-try-net-project)创造你的第一次尝试。网络项目
...
### [](#create-a-dotnet-project)创建一个 dotnet 项目
...
[![Markdown in a browser](../Images/6760cf40f8b0ea8757ec40834ecf2b21.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--lxBraRYj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/rvg319y8nu5g3j919dos.png)

### [](#add-some-code)添加一些代码
...
[![Markdown with an embedded C# window running code](../Images/2eb66922f4818ba114e3ce41063e29f0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--2n7dme3X--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/qwxfjgyki7h1cotqrpg6.png)

这很酷——但是更酷的是你可以编辑这段代码。玩一玩——你会得到完整的智能感知和 *ctrl+space* 自动完成，如果你的代码没有编译，你会得到适当的编译器错误——行号基于浏览器中的代码，而不是在`.cs`文件中。

[![An error in the C# window](../Images/bcdc3545da29b45b7d0135ab7cc1a9a1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--UG2OtErG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/o7e4xf7ljtn6siawia6k.png)

### [](#whats-happening)发生什么事了

当您的代码运行时，它将编译包含您所做的任何代码更改的控制台应用程序。如果编译失败，您会看到错误，否则控制台应用程序会正常运行——运行`main`方法，控制台的任何输出都会显示在您的代码下面。

## [](#creating-a-more-advanced-project)创建更高级的项目
...
[![C# code in the markdown dumping the command line arguments](../Images/918a213ebd54594dc29144bec10b9714.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ms8UIeP_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/u7m3fqbrtqh44yb8aoaj.png)
...
## [](#what-about-adding-packages)加包呢？
...
[![Using JSON.NET in the C# code in the markdown](../Images/d4de137ddd35ce13fb5c47158ac7b56c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--kEo1ep1_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/246kg4x1nm0nlrlkdsnb.png)

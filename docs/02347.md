...
> 原文:[https://dev . to/spekulatius 1984/differences-between-locally-loaded-vs-store-installed-extensions-3k5d](https://dev.to/spekulatius1984/differences-between-locally-loaded-vs-store-installed-extensions-3k5d)
...
## [](#firefox-storage-api-locally-vs-in-production)Firefox 本地存储 API 与生产中
...
## [](#found-more-problems-please-reach-out)发现更多问题？请伸出手来！

...
> 原文:[https://dev . to/codercatdev/rx fire-in-react js-using-firebase-firestore-and-authentic ation-1i5p](https://dev.to/codercatdev/rxfire-in-reactjs-using-firebase-firestore-and-authentication-1i5p)
...
# [](#rxfire-in-reactjs-using-firebase-firestore-and-authentication)RxFire 在 ReactJS 中使用 Firebase Firestore 和认证
...
## [](#create-firebasejs)创建 Firebase.js
...
## [](#simple-initial-component)简单的初始组件

### [](#remove-appjs-and-replace)删除 App.js 并替换
...
## [](#update-collection-catfacts)更新集合 catfacts
...
## [](#add-firebase-authentication)添加 Firebase 认证
...
## [](#update-addcat-to-include-user-uid)更新 AddCat 以包含用户 uid

### [](#pass-user-to-addcat)将用户传递给 AddCat
...
## [](#update-firestorerules)更新 firestore.rules
...
## [](#create-list-of-cat-facts)创建猫事实列表

### [](#create-listcatfacts)创建 ListCatFacts

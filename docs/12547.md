...
> 原文:[https://dev . to/rem bou 1/how-to-configure-a-blazor-application-4 hpo](https://dev.to/rembou1/how-to-configure-a-blazor-application-4hpo)

# [](#how-to-configure-a-blazor-application)如何配置 Blazor 应用程序
...
## [](#how-to-define-environement)如何定义环境
...
## [](#find-the-environment-on-startup)启动时查找环境

...
> 原文:[https://dev . to/ann Lin/what-happens-when-you-enter-URL-in-a-browser-part-1-uri-35hg](https://dev.to/annlin/what-happens-when-you-enter-url-in-a-browser-part-1-uri-35hg)

[https://www.youtube.com/embed/gtY88BlO7d4](https://www.youtube.com/embed/gtY88BlO7d4)

# [](#what-really-happens)真正发生的事情，

1.  在浏览器中输入网站链接，`www.example.com`。
2.  浏览器知道是网站，在前面加了`https://`。

## [](#-raw-https-endraw-is-one-of-the-many-uri-schemes)`https://`是 URI 众多方案中的一个

[![](../Images/652ba3a0964310d86835cf83492e82ba.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--otNLdKGJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/eo72prtjugzgdlor2aks.png)T3】URI =统一资源标识符
URL =统一资源定位符
骨灰盒(不是那个骨灰盒🌝)=统一资源名称

URN 和 URL 是 URI 的子集。骨灰盒只是一个名字或参考，可能没有办法找到那个东西。URL 知道资源的确切位置，并返回那个东西。

### [](#url-example-paste-on-your-browser)URL 示例(粘贴在浏览器上):

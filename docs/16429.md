...
> 原文:[https://dev.to/lvl99/basic-security-hygiene-2a11](https://dev.to/lvl99/basic-security-hygiene-2a11)
...
## [](#dont-commit-files-with-access-credentials-or-important-api-keys)不要提交带有访问凭证或重要 API 密钥的文件
...
## [](#make-your-code-repo-private)让你的代码回购私有
...
## [](#deleting-credential-files-in-your-code-repo-is-not-enough)在您的代码库中删除凭证文件是不够的
...
## [](#ensure-database-backups-and-sensitive-files-arent-accessible-via-the-public-web)确保数据库备份和敏感文件无法通过公共网络访问...
...
## [](#-better-yet-use-your-pipelineserver-infrastructure-to-store-the-credentials)...更好的是，使用您的管道/服务器基础设施来存储凭证
...
## [](#exercise-caution-when-passing-credentials-around)传递凭证时要小心
...
## [](#if-you-can-create-peruser-or-perproject-credentials)如果可以，创建每个用户或每个项目的凭证

当人们离开一个组织或者一个项目被移除时，这样做将允许更好的安全控制。

此外，使重置凭据的过程变得非常简单。如果您的用户/项目凭证受到损害，您将希望能够重置并生成新的用户名和密码，并尽快更新项目。

## [](#please-create-smarter-and-more-secure-credentials)请创建更智能、更安全的凭证
...
## [](#ensure-your-external-suppliers-practice-basic-security-hygiene)确保您的外部供应商实践*基本安全卫生*

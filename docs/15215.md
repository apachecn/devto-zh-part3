...
> 原文:[https://dev . to/hml on/explaining-how-oauth-works-as-a-example-5djl](https://dev.to/hmlon/explaining-how-oauth-works-with-spotify-as-an-example-5djl)
...
[![Authorization screen on Spotify](../Images/7f56760eaed758414e8f81e2afb67efa.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--99sEhmL9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://kholinlabs.com/assets/2018-12-24-how-oauth-works-with-spotify-as-an-example/spotify-oauth-screen.png)
...
# [](#create-a-client-application)创建一个“客户端应用程序”
...
# [](#build-a-link-to-the-provider)建立到“提供商”的链接
...
# [](#create-an-endpoint-for-the-redirect-url)为重定向 URL 创建端点
...
# [](#save-the-refresh-token-too)保存刷新令牌过

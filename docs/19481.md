...
> 原文:[https://dev . to/aris/easy-way-to-backup-your-data-in-gnulinux-1gc 5](https://dev.to/aris/easy-way-to-backup-your-data-in-gnulinux-1gc5)

数据对我们来说非常重要。数据丢失对每个人来说都是一场灾难，包括系统管理员。因此，有必要定期备份您的数据。在 Linux 中我们可以很容易地自动和定时备份数据。下面将解释如何操作。

## [](#step-01-setup-ssh)步骤 01–设置 ssh
...
## [](#step-02-install-backup2l)步骤 02–安装备份 2l
...
## [](#step-03-configure-backup2l)步骤 03–配置备份 2l

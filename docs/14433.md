...
> 原文:[https://dev.to/fridanyvall/variable-fonts-on-the-web-187k](https://dev.to/fridanyvall/variable-fonts-on-the-web-187k)
...
# [](#normal-vs-variable)正常与可变

### [](#normal-fonts)普通字体

字体可以有不同的变体。例如，下面的 Roboto 家族由 12 种不同的变体组成。还有一个由 6 个变体组成的精简版本。

<figure>[![Variants of Roboto and Roboto Condensed](../Images/e83a0908926fdd2d2e6a3e0c527b4e93.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--xdZwllKW--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://redonion.se/wp-content/uploads/2019/01/roboto-1.png)
...
<figure>[![Changing the custom axis "Daffness"](../Images/58c05fbbefd200cacd9a974ecb7e87f7.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--GgvRpXj8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://redonion.se/wp-content/uploads/2019/01/customaxes.gif) 
...
## [](#where-can-i-find-variable-fonts)哪里可以找到可变字体？

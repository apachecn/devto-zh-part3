...
> 原文:[https://dev.to/gcanti/functional-design-tagless-final-332k](https://dev.to/gcanti/functional-design-tagless-final-332k)
...
## [](#writing-a-raw-monadio-endraw-instance)写一个`MonadIO`实例

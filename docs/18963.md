...
> 原文:[https://dev.to/ossia/how-freecodecamporg-uses-the-jamstack-一个单 api 服务器-每月帮助数百万人学习编码-4d5g](https://dev.to/ossia/how-freecodecamporg-uses-the-jamstack--a-single-api-server-to-help-millions-of-people-learn-to-code-every-month-4d5g)

[![freeCodeCamp's JAMstack architecture](../Images/374874f53e53b80904fc4ace7988a185.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--jfZ2uyDW--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/b5xt0zbpinkqamc2gdqv.png)
...
[![](../Images/85cbd6ea4c4313c00b8e7d85235494c1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--AOwTqrph--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/k5q206fh4jfbwrmc6sc8.jpg)

尽管有 1，368 人同时使用 freeCodeCamp.org，但我们的 Node.js / Loopback 服务器几乎不费吹灰之力。

[![](../Images/8010ae4786a4ccbc69dc7e23d74219aa.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9XwDO_NM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/tz9m8ldmi94wgl9ha0ar.jpg)
...
## [](#freecodecamporgs-jamstack-architecture)freeCodeCamp.org 的 JAMstack 架构
...
### [](#benefit-1-the-jamstack-is-super-cheap)好处# 1:jam stack 超级便宜。

我们是一个小型非营利组织。我们希望将尽可能多的稀缺资金用于帮助人们学习编码——而不是为不必要的服务器和带宽买单。

自从我们开始将服务转移到 JAMstack 以来，我们的基础架构成本大幅下降。

### [](#benefit-2-its-simpler)好处二:更简单。

当你的栈很简单并且只有很少的可移动部分时，你所得到的理智是有道理的。这是更少的东西可以在半夜打破。

### [](#benefit-3-its-more-secure-and-more-reliable)好处#3:更安全，更可靠。
...
## [](#the-more-you-know)知道的越多

[![The more you know meme](../Images/f7590bb49a8137cc74d5cf70e6c17496.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--EBsww7cy--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/dt1k6ijileailxxoslbu.png)

...
> 原文:[https://dev . to/goolord/trasa-tutorial-pt-1-type-safe-web-routing-with-trasa-5b1p](https://dev.to/goolord/trasa-tutorial-pt-1-type-safe-web-routing-with-trasa-5b1p)

# [](#-raw-trasa-endraw-type-safe-http-routing-and-dispatch-in-haskell)[`trasa`](https://hackage.haskell.org/package/trasa) :在 Haskell 中键入安全的 HTTP 路由和调度

## [](#hello-world)您好，世界！

[![](../Images/d8e289ce5c0031625172ca92d4016eeb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--mFzXRF32--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/3kukx3rnokmaegp7rnmd.png)
...
#### [](#providing-metadata-for-our-route-type)为我们的路线类型提供元数据
...
T3![](../Images/d8e289ce5c0031625172ca92d4016eeb.png)T5】

## [](#captures-and-queries)捕获和查询
...
重新运行，瞧！
[![](../Images/078153977e9c23dc6080bd7a13b2cb79.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--HZnAtCSG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/t9ld8i5y7e2p4cc1i40n.png)

...
> 原文:[https://dev . to/tong rhj/the-error-developers-make-when-coding-a-hamburger-menu-1 deg](https://dev.to/tongrhj/the-mistake-developers-make-when-coding-a-hamburger-menu-1deg)
...
# [](#the-problem-with-many-hamburger-menus)汉堡菜单多的问题

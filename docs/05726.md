...
> 原文:[https://dev . to/sandordargo/parameterized-testing-with-gt est-50l 9](https://dev.to/sandordargo/parameterized-testing-with-gtest-50l9)
...
## [](#how-to-make-our-tests-less-repetitive-without-parameterized-tests)如何在没有参数化测试的情况下，让我们的测试不那么重复？
...
### [](#the-good-old-raw-for-endraw-loop)美好的旧`for`循环
...
## [](#parameterized-tests-what-are-they-parameterizedtests)参数化测试，它们是什么？[参数化测试]
...
### [](#write-parameterized-tests-without-a-fixture)编写没有夹具的参数化测试
...
### [](#write-parameterized-tests-based-on-an-existing-fixture)编写基于现有夹具的参数化测试
...
[![Test Class Hierarchy](../Images/2947abe6ea45563ab7e3c20b9d5a8d68.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ltm7UF4W--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/v1/%7B%7B%20site.baseurl%20%7D%7D/assets/img/test-class-hierarchy.jpg)

### [](#how-to-pass-multiple-parameters-to-the-same-test-case)如何给同一个测试用例传递多个参数？

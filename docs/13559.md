...
> 原文:[https://dev . to/gcanti/inter operability-with-non-functional-code-using-FP-ts-432 e](https://dev.to/gcanti/interoperability-with-non-functional-code-using-fp-ts-432e)
...
## [](#-raw-undefined-endraw-and-raw-null-endraw-)`undefined`和`null`
...
## [](#synchronous-side-effects)同步副作用
...
## [](#asynchronous-side-effects)异步副作用

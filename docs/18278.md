...
> 原文:[https://dev.to/runosaduwa/es6-rest-and-spread-operators-dep](https://dev.to/runosaduwa/es6-rest-and-spread-operators-dep)

[![](../Images/047b3f748f57c0a8334cf181cfcd276c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--etPCAmKZ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/wwnx9xpy59s885qq1a72.png)
...
#### [](#when-you-should-use-the-rest-operators)时应该使用*休息符*
...
#### [](#rest-parameters-to-the-rescue)休息参数救援
...
### [](#when-you-need-to-copy-an-array)需要复制数组时
...
### [](#adding-array-elements-to-another-array)将数组元素添加到另一个数组中

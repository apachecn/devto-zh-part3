...
> 原文:[https://dev.to/vonagedev/send-sms-with-github-actions-11me](https://dev.to/vonagedev/send-sms-with-github-actions-11me)
...
## [](#creating-your-first-workflow)创建您的第一个工作流程
...
[![Creating a new repository on GitHub.](../Images/7a5dd69ae53216f257ed88a73440aaeb.png)T2】](https://www.nexmo.com/wp-content/uploads/2019/01/create-new-repo.png)

### [](#create-a-new-workflow)创建新的工作流

创建存储库后，您需要导航到“操作”选项卡，在这里您会看到一个创建新工作流的按钮:

[![Create your first workflow on GitHub](../Images/6c2767b67d0abf8af04eaac3034cda78.png)T2】](https://www.nexmo.com/wp-content/uploads/2019/01/create-first-workflow.png)

工作流程可以在图形用户界面(GUI)中创建，也可以通过创建一个`workflow`文件来创建。

### [](#link-the-action-trigger-to-an-action)将动作触发器链接到一个动作

向下拖动蓝色连接器以创建您的第一个操作。

[![Drag the connector to create a new action](../Images/843c95bf31529192a746c6f9061957d7.png)T2】](https://www.nexmo.com/wp-content/uploads/2019/01/create-action.gif)
...
[![Enter the Nexmo Send SMS Action](../Images/48550837bbb64bcb788cb171dad4e8d1.png)T2】](https://www.nexmo.com/wp-content/uploads/2019/01/choose-nexmo-action.png)
...
[![Define your secrets.](../Images/e5fb85fee1b592c6f78d44c61d9378ac.png)T2】](https://www.nexmo.com/wp-content/uploads/2019/01/define-secrets.gif)
...
[![Save your action](../Images/e64f72d748633754f687cd97890d1f9d.png)T2】](https://www.nexmo.com/wp-content/uploads/2019/01/save-changes.png)

保存动作本身就是一个`push`。如果查看“操作”选项卡，您可以看到操作的状态。

[![See the status of the action in progress.](../Images/23d7cd016446e43b646fb2f5430d2b63.png)T2】](https://www.nexmo.com/wp-content/uploads/2019/01/workflow-in-progress.png)

在保存您的操作和任何其他到存储库的推送时，您应该会收到一条文本消息。

[![Text message which states that you are working.](../Images/7e5ac98c54e2244d0b32c2ddc324e5cd.png)T2】](https://www.nexmo.com/wp-content/uploads/2019/01/hey-boss-sms.png)

## [](#conclusion)结论

很快你的老板就会开始意识到你给公司带来的真正价值。你的工作将是填满他们的短信收件箱，让他们进入“我的直接下属棒极了”的兴奋状态。

[![You being praised by all of your bosses.](../Images/15c11c8b5018c5dfd5cf9f3a542d24fc.png)T2】](https://www.nexmo.com/wp-content/uploads/2019/01/happy-boss.png)

...
> 原文:[https://dev . to/fredrikbergqvist/typing-react-with-typescript-53ma](https://dev.to/fredrikbergqvist/typing-react-with-typescript-53ma)
...
## [](#wrapping-another-component)包装另一个组件
...
## [](#using-withstyles-and-withtheme)使用 WithStyles 和 WithTheme
...
[![TS2741: Property 'classes' is missing in type '{buttonText: string}' but required in type '{ classes: Record<string, string>}'](../Images/ad76c467968f9c8d05c94651081f31d4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ZUExbiCe--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/yzbeicf42yxovopp1zfl.PNG)

## [](#redux-connect-and%C2%A0compose)还原连接和合成
...
## [](#bonus-typing-the-usestate%C2%A0hook)奖励:输入使用状态挂钩

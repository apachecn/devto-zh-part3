...
> 原文:[https://dev.to/molly/performance-testing-elasticsearch-2f7](https://dev.to/molly/performance-testing-elasticsearch-2f7)

当您有一个大型的 Elasticsearch 集群，并且希望对索引进行更改时，无论是对映射还是设置，您都希望确保这种更改会提高性能。这种改变也可能很难实现，所以您想知道性能的提高是否值得您花费时间来更新代码。

## [](#we-will-do-it-live)我们就做现场！

[![](../Images/e4e9674a904b35093c6361162082b63a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--AAdZ-ZRK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/dq2l5qphws8dc2szxqoy.gif)
...
## [](#how-we-test-elasticsearch-changes)我们如何测试弹性搜索的变化
...
### [](#optimization-storing-ids-as-keywords)优化:将 id 存储为关键字

...
> 原文:[https://dev . to/damn Jan/when-PHP-framework-sucks-series-magic-inside-frameworks-3jc 8](https://dev.to/damnjan/when-php-framework-sucks-series-magic-inside-frameworks-3jc8)
...
#### [](#defining-code-inside-method-or-class-annotations)在方法或类注释内定义代码
...
#### [](#defining-classes-instances-in-yaml-or-any-file-different-than-php)在 yaml 或任何不同于的文件中定义类实例。服务器端编程语言（Professional Hypertext Preprocessor 的缩写）
...
#### [](#containers-which-contains-anything)容器里面“装”着什么东西

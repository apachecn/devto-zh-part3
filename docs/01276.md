...
> 原文:[https://dev . to/endtest/10-things-you-not-know-on-selenium-39eh](https://dev.to/endtest/10-things-you-didn-t-know-about-selenium-39eh)

### [](#1-you-can-use-selenium-to-test-chrome-extensions)**1)你可以用 Selenium 来测试 Chrome 扩展。**
...
### [](#2-taking-a-screenshot-of-an-element-instead-of-the-entire-page)**2)对一个元素而不是整个页面进行截图。**
...
### [](#3-uploading-a-file-in-a-test)**3)在测试中上传文件。**

我从朋友那里学到的一个很酷的技巧。

当您在网站上上传文件时，操作系统会打开一个本机窗口，允许您选择文件。

[![](../Images/43cee47808e3d7f8120d8880dcb9d53d.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--MXbjNTcf--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ck5zymf6ig5h0ohcyqgt.png) 
...
### [](#4-clicking-on-a-certain-point-inside-an-element)**4)点击一个元素内部的某个点。**
...
### [](#5-reading-the-page-source)**5)阅读页面来源。**
...
### [](#7-simulate-a-webcam-and-a-microphone)**7)模拟网络摄像头和麦克风。**

如果您在一台来自云的机器上运行您的测试，这将非常有用。
仅适用于 chromedriver。

[![](../Images/a87b7f7de1f0cdb02663456455b04db1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--rEDEyhNx--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/95qbfh4qv6l8gqpyzad0.png)
...
### [](#8-using-http-basic-authentication)**8)使用 HTTP 基本认证。**

这是一个本机窗口，要求提供访问网站的凭据。

[![](../Images/ce7cb5061364b8c2c75dade8e6d76225.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--BuZE561x--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/kcow15ktmw01jntr6grb.jpg)
...
### [](#9-using-machine-learning-to-fix-your-tests)**9。使用机器学习来修正你的测试。**

[https://www.youtube.com/embed/t7Wa5mTP45Q](https://www.youtube.com/embed/t7Wa5mTP45Q)

### [](#10-using-any-attribute-to-locate-an-element)**10。使用任何属性来定位元素。**
...
[![](../Images/416c5cd34c46cf51cbb19fb890e22d5d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--NtRAv6_g--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/wbol1ucy4za0oqkximuf.png)

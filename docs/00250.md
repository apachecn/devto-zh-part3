...
> 原文:[https://dev . to/mlisidoro/what-s-new-for-SharePoint-and-office-365-from-SharePoint-conference-2019-part-2-o5g](https://dev.to/mlisidoro/what-s-new-for-sharepoint-and-office-365-from-sharepoint-conference-2019-part-2-o5g)
...
## [](#whats-new-for-administrators)管理员的新功能

与其他领域一样，这里也有许多针对管理员的新公告。

### [](#sharepoint-admin-center)SharePoint 管理中心

在一段时间的预览中，现代 SharePoint 管理中心将成为管理 SharePoint Online 的默认体验，包括通过新的现代 UI 管理经典体验。下面是一些最重要的公告。

### [](#consolidated-views-available-soon)合并视图(即将推出)

有了新的更新，在新的 SharePoint 管理中心体验中，您可以管理与现代 SharePoint 体验和经典功能相关的设置，这意味着无需在现代和经典管理中心之间工作来管理现代和经典设置之间的设置。

[![](../Images/a6de15511bfd6814bb51e23e0a38f0ed.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--qjlUTXlc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i1.wp.com/blogit.create.pt/wp-content/uploads/2019/06/SharePoint_Admin_Center_ClassicFeatures.jpg%3Ffit%3D696%252C392%26ssl%3D1)

### [](#bulk-actions-available-soon)批量操作(即将推出)

很快就可以对一组站点执行批量操作了。这些操作包括更新站点的共享配置、执行中心站点关联或删除站点。

[![](../Images/beae3e715b0f62aa57b73d350d107504.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--U4Y2SfMu--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i1.wp.com/blogit.create.pt/wp-content/uploads/2019/06/SharePoint_Admin_Center_BulkActions.jpg%3Fw%3D696%26ssl%3D1)

### [](#site-url-rename-available-soon)站点 URL 重命名(即将推出)
...
[![](../Images/16d45c0dfe330f477b66bdedfcc4c7c2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--DP3HjvdS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i1.wp.com/blogit.create.pt/wp-content/uploads/2019/06/SharePoint_Admin_Center_SiteRename.jpg%3Fw%3D696%26ssl%3D1)

如果你担心你会有断开的链接，停止担心！对站点 URL 的更改不会产生任何影响，因为对旧 URL 的访问请求将被重定向到新 URL，这意味着用户不需要更新他们的链接和书签。

### [](#sharepoint-site-swap-coming-soon)SharePoint 站点交换(即将推出)
...
## [](#whats-new-for-security-and-compliance)安全性和合规性的新特性
...
[![](../Images/3291ea7b3c739f89d0fc683a227dedd2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--HONrdcfT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i2.wp.com/blogit.create.pt/wp-content/uploads/2019/06/Security_Sensitivity_Labels.jpg%3Fw%3D696%26ssl%3D1)

该事件的主要安全声明之一是，只要您拥有文档的编辑权限，很快就可以编辑带有敏感性标签的受保护文档。这是一个重大更新，因为在此更新之前，根本不可能编辑受保护的文档。

[![](../Images/67f3cd52024db3d621fdc3419e5f72ad.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8eYmP2en--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i1.wp.com/blogit.create.pt/wp-content/uploads/2019/06/Security_Sensitivity_Labels_Collaboration.jpg%3Fw%3D696%26ssl%3D1)

### [](#external-access-expiration-preview-q3-cy19)外部访问到期(预览 Q3 CY19)

此次活动中宣布的另一项重要更新是，租户管理员可以指定外部用户可以访问站点的时间以及与他们共享的内容。一旦过期，外部用户将不再能够访问网站或内容，除非网站所有者延长了他们的访问权限或发送了新的共享邀请。

[![](../Images/05c7e3326d7d7ef8dde56db59f215953.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--1EnEX_Xd--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i2.wp.com/blogit.create.pt/wp-content/uploads/2019/06/Security_External_Access_Expiration.jpg%3Fw%3D696%26ssl%3D1)

### [](#dlp-restricted-sharing-private-preview-q3-cy19)DLP 受限分享(私人预览 Q3 CY19)

有了这一新的更新，组织将有可能阻止共享被 DLP(数据丢失防护)标记为敏感内容的匿名链接。

[![](../Images/35b1dc4cb2e3a1f96a31d17d5ac62140.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Mmiub7w2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i1.wp.com/blogit.create.pt/wp-content/uploads/2019/06/Security_DLP_Restricted_Sharing.jpg%3Fw%3D696%26ssl%3D1)

### [](#onedrive-restricted-user-access-private-preview)OneDrive 限制用户访问(私人预览)

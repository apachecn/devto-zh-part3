...
> 原文:[https://dev . to/mmenestret/anatomy-of-functors-and-category-theory-2fg 0](https://dev.to/mmenestret/anatomy-of-functors-and-category-theory-2gf0)
...
# [](#how-does-it-look-like-in-practice)实际情况如何

在接下来的章节中，我将提供的例子和代码片段将会出现在 *Scala* 中。

## [](#let-explore-some-examples)让我们探讨一些例子
...
## [](#how-do-we-abstract-and-encode-that-ability-)我们如何对那种能力进行抽象和编码？
...
# [](#an-insight-about-the-theory-behind-functors)洞察*函子背后的理论*
...
## [](#tiny-crash-course-into-category-theory)成范畴论的微型速成班
...
[![category](../Images/f2a0366b6e6761ee023883718c411e82.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--MN7xGNrl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://upload.wikimedia.org/wikipedia/commons/thumb/f/ff/Category_SVG.svg/1024px-Category_SVG.svg.png)
...
## [](#and-then-back-to-our-functors)然后回到我们的*函子*

...
> 原文:[https://dev . to/Iberian pig/how-to-install-and-customize-fusuma-73l](https://dev.to/iberianpig/how-to-install-and-customize-fusuma-73l)
...
## [](#confirm-installed-ruby-version)确认安装的 Ruby 版本
...
## [](#install-fusuma-from-rubygems)从 RubyGems 安装 Fusuma
...
## [](#create-configurations-file-for-fusuma)为 Fusuma 创建配置文件
...
## [](#add-the-user-to-input-groups)将用户添加到输入组
...
## [](#keep-running-in-the-background-when-the-terminal-is-closed)终端关闭时保持后台运行
...
# [](#configure-commands-to-be-assigned-gesture)配置要分配手势的命令

在`~/.config/fusuma/config.yml`中添加识别手势并向其分配命令。

## [](#confirm-command-to-run-in-terminal)在终端确认命令运行
...
## [](#switch-the-workspace-in-the-four-fingers-swipe)在四指轻扫中切换工作区

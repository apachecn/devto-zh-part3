...
> 原文:[https://dev . to/oktadev/build-a-graph QL-API-with-ASP-net-core-2cfj](https://dev.to/oktadev/build-a-graphql-api-with-asp-net-core-2cfj)
...
## [](#create-your-aspnet-core-api-for-your-graphql-architecture)为您的 GraphQL 架构创建您的 ASP.NET 核心 API
...
### [](#create-your-aspnet-core-api-models)创建您的 ASP.NET 核心 API 模型
...
## [](#set-up-graphql-in-your-aspnet-core-api)在您的 ASP.NET 核心 API 中设置 GraphQL

现在可以开始添加 GraphQL 相关代码了。您将首先设置一些中间件，使测试您的 GraphQL 端点变得容易得多。

### [](#graphql-middleware)图形 QL 中间件

...
> 原文:[https://dev . to/bbossola/execute-Java-code-on-a-remote-server-using-JSON-2 nod](https://dev.to/bbossola/execute-java-code-on-a-remote-server-using-json-2nod)

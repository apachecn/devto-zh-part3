...
> 原文:[https://dev . to/johndemian/quickly-debug-your-AWS-lambda-functions-205m](https://dev.to/johndemian/quickly-debug-your-aws-lambda-functions-205m)

伟大的作家用隐喻来表达他们的观点，所以让我很快的尝试一下。虫子是讨厌的小害虫，嗯？很难摆脱它们，但除了到处喷洒毒药，只剩下几个选择了。其中一个选择是利用天敌来对付这些虫子，比如鸟类。所以鸟可以帮你赶走虫子。我在一家名为 Dash **bird** 的公司工作，帮助开发人员调试他们的 AWS Lambda 应用程序。看到我做了什么吗？害虫\臭虫< - >鸟类\Dashbirds？很聪明，对吧？现在，我需要打电话给谁来获得我的普利策奖？

## [](#main-reasons-for-using-aws-lambda-functions)使用 AWS Lambda 函数的主要原因

AWS Lambda 的好处之一是，正如 AWS 声称的那样**“你可以忘记所有项目的基础设施，只专注于在云中启动应用程序，同时你将能够与其他亚马逊服务进行集成。”**可扩展性和使用 AWS 计算资源的低成本是随之而来的其他好处。

[![](../Images/cdd494742725ee30bcf1ce5a012f651d.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--8i376uX0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/rvsm59em8ijtn9wt2h4h.png)T3】

<center>Anatomy of a Lambda function - AWS re:Invent 2017</center>

首先，您需要做的就是编写您的函数，将它连接到一个事件，部署它，AWS 会处理剩下的事情。Lambda 函数将能够在 AWS 上每小时处理数千个请求，而不需要我们付出任何努力。

## [](#how-to-debug-aws-lambda-functions)如何调试 AWS Lambda 函数？
...
## [](#debugging-aws-lambda-functions-with-dashbird)用 Dashbird 调试 AWS Lambda 函数
...
[![](../Images/37dc17d2cd06da47ea496e535c97c968.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Kjfx0AUR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/f86h82npl8856sjihaxi.png)

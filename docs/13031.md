...
> 原文:[https://dev . to/nicol rx/how-to-automatically-share-your-WordPress-articles-on-social-media-with-buffer-and-cron-3d 77](https://dev.to/nicolrx/how-to-automatically-share-your-wordpress-articles-on-social-media-with-buffer-and-cron-3d77)

[![Wordpress Buffer Cron](../Images/5354b24b72e329622813867c9a8199a0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--QJtBD3yq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/2ol73s93ufo8lpdiw531.png)
...
## [](#lets-set-up-the-new-cron-job)让我们设置新的 cron 作业
...
## [](#create-the-function-to-schedule-posts-with-the-buffer-api)创建函数，用缓冲 API 调度帖子

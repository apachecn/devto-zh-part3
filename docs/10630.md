...
> 原文:[https://dev . to/iuriimednikov/how-to-start-with-unit-testing-in-Java-a-complete-introduction-to-JUnit-5-3cc](https://dev.to/iuriimednikov/how-to-start-with-unit-testing-in-java-a-complete-introduction-to-junit-5-3cc)
...
## [](#install-junit5)安装 JUnit5

### [](#build-tools-support)构建工具支持
...
## [](#an-anatomy-of-unit-test)解剖单元测试

### [](#basic-structure)基本结构

考虑这个例子:我们有一个程序，它对一个整数数组中的一个数字执行[](https://www.geeksforgeeks.org/linear-search/)*线性搜索。这里有一个主类，我们把它放在 *src/main/java/* 文件夹中:* 
 ...
 **## [](#using-standard-assertions-api)使用标准断言 API

...
> 原文:[https://dev . to/bocadillo/building-a-real-time-chatbot-server-in-python-with-web socket-chatterbot-and-bocadillo-482g](https://dev.to/bocadillo/building-a-real-time-chatbot-server-in-python-with-websocket-chatterbot-and-bocadillo-482g)
...
> ![unknown tweet media content](../Images/277486be44e88f8c709c5bf28c80f73c.png)![Bocadillo profile image](../Images/563c3d90dde2f3c9ca5ac7f28db8d91b.png)博卡迪略@博卡迪略![twitter logo](../Images/4c8a2313941dda016bf4d78d103264aa.png)Psst—博卡迪略 v0.13 刚刚发布！🤩🥳
> 
> 一些最美味的新增功能的新鲜切片:
> 
> -提供者:web 视图中的依赖注入
...
> -基于 Cookie 的会话
> 
> 在发行说明中了解更多信息👉[bocadilloproject.github.io/blog/release-0…](https://t.co/RKBr2hGqJ9)2019 年 3 月 21 日 21 点 21 分![Twitter reply action](../Images/44d8b042100e231770330321e5b63d65.png)[![Twitter retweet action](../Images/93d9c70ccc54851d2e8e881b53c21dae.png)](https://twitter.com/intent/retweet?tweet_id=1107029038923743232)[![Twitter like action](../Images/2e93f7775eadefab8bcd34a4542cc5a7.png)](https://twitter.com/intent/like?tweet_id=1107029038923743232)
...
## [](#bootstrapping-the-application)引导应用程序
...
## [](#writing-the-websocket-endpoint)编写 WebSocket 端点
...
## [](#trying-out-the-websocket-endpoint)试用 WebSocket 端点
...
## [](#refactoring-the-chatbot-as-a-provider)重构聊天机器人为提供者
...
## [](#exposing-client-count-via-a-rest-endpoint)通过 REST 端点公开客户端数量

...
> 原文:[https://dev.to/hardy613/a-linked-list-in-javascript-50g](https://dev.to/hardy613/a-linked-list-in-javascript--50g)
...
# [](#-raw-find-endraw-by-value)`find`按值
...
# [](#-raw-remove-endraw-by-value)`remove`按值
...
# [](#-raw-get-endraw-by-index)`get`被索引

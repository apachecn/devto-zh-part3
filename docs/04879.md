...
> 原文:[https://dev.to/risacan/rspec-havecontent-hascontent-5191](https://dev.to/risacan/rspec-havecontent-hascontent-5191)

# [](#-raw-havecontent-endraw-and-raw-hascontent-endraw-is-different-in-rspec)`have_content?`和`has_content?`在 RSpec 中是不同的

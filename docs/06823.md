...
> 原文:[https://dev . to/Samantha Ming/how-to-get-a-object-length-30pd](https://dev.to/samanthaming/how-to-get-an-object-length-30pd)

[![Code Tidbit by SamanthaMing.com](../Images/45a414f3551c840c08b77e55a31f0526.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--1TQ7hJNg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/sf0t2ir572d8elv1oic9.png)
...
## [](#why-cant-we-call-raw-length-endraw-on-an-object)为什么我们不能在一个对象上调用`length`
...
### [](#enumerable-defaults-to-true)可枚举默认为真
...
## [](#object-length-with-symbols)物体长度用符号表示
...
[![Thanks Eugene Karataev](../Images/9e17468b1436bd8ffeee31dd2e50931e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--FD2YnBUD--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/up6o4ozejq30mg9nnlr0.png)

...
> 原文:[https://dev . to/database sponge/running-heroku-CLI-commands-in-an-heroku-application-2j7f](https://dev.to/databasesponge/running-heroku-cli-commands-in-an-heroku-application-2j7f)
...
# [](#running-rake-tasks-from-within-your-application)从您的应用程序中运行 rake 任务

...
> 原文:[https://dev . to/scraping bee/how-to-log-in-the almost-any-websites-7dn](https://dev.to/scrapingbee/how-to-log-in-to-almost-any-websites-7dn)
...
### [](#hacker-news-authentication)黑客新闻认证

假设您想要创建一个登录到 hacker news 的 bot(提交一个链接或执行一个需要验证的操作) :

下面是登录表单和相关的 DOM:

[![](../Images/e1cf450969c4380e71ca36ae8d2906b2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--AYcjSLil--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.scrapingbee.com/images/post/java-login/screenshot_hn_login_form.png)

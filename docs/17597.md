...
> 原文:[https://dev . to/gaijinity/writing-craft-plugins-with-extensible-components-4p6a](https://dev.to/gaijinity/writing-craft-plugins-with-extensible-components-4p6a)

# [](#writing-craft-plugins-with-extensible-components)用可扩展组件编写工艺插件

### 如何为 Craft CMS 编写一个插件，允许其他人以灵活、组合的方式扩展它

安德鲁·韦尔奇

[![Puzzle Pieces Components](../Images/e9d49b809ff0036d2e5e3f9edae0d7f8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--BC9ohqli--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://nystudio107-ems2qegf7x6qiqq.netdna-ssl.com/img/blog/_1200x675_crop_center-center_82_line/puzzle-pieces-components.jpg)
...
[![Concrete Craft Cms Plugin Example](../Images/698d6bb881f392609294b9cd4d77e73b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--5fEXfG5b--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://nystudio107-ems2qegf7x6qiqq.netdna-ssl.com/img/blog/_1200x675_crop_center-center_82_line/concrete-craft-cms-plugin-example.jpg)

关注真实世界的例子通常比使用虚构或复杂的例子更有用。因此，让我们深入研究一下，看看我们如何以一种可扩展的方式在图像优化中实现图像转换。

## [](#php-inter%C2%ADfaces)PHP 界面
...
## [](#php-base-abstract-classes)PHP 基础抽象类
...
[![Image Transform Class Hierarchy](../Images/a1f2c3b97ddb8df9b6d1d5d63fbb183c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--tmXWnu_z--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://nystudio107-ems2qegf7x6qiqq.netdna-ssl.com/img/blog/_1200x769_crop_center-center_100_line/image-transform-hierarchy.png)
...
## [](#mix%C2%ADing-our-com%C2%ADpo%C2%ADnents-in)将我们的组分混合在一起
...
[![Mixing In Plugin Components](../Images/d12dc4b786eaaf6f89bc85cef7d1cf26.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--rdnQ8etq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://nystudio107-ems2qegf7x6qiqq.netdna-ssl.com/img/blog/_992x558_crop_center-center_82_line/mixing-in-plugin-components.jpg)
...
## [](#mak%C2%ADing-com%C2%ADpo%C2%ADnents-discoverable)使组件可被发现
...
## [](#edit%C2%ADing-and-stor%C2%ADing-com%C2%ADpo%C2%ADnent-settings)编辑存储组件设置
...
## [](#go-forth-and-componentize)往前走，组件化！

这有点难以理解，但我认为它将有助于以一种非常简单/专业的方式提供扩展能力的插件。有了这些知识，你就可以着手制作一些可扩展的插件了！

[![Go Forth And Explore](../Images/ca82ede0eec97d643a6924f627d49a97.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--hf6fg4Ue--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://nystudio107-ems2qegf7x6qiqq.netdna-ssl.com/img/blog/_1200x675_crop_center-center_82_line/go-forth-and-explore.jpg)

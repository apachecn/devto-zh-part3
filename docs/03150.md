...
> 原文:[https://dev . to/radix DLT/radix-use cases-card-payment-system-1nda](https://dev.to/radixdlt/radix-usecases-card-payment-system-1nda)
...
# [](#card-payments-with-radix)用基数卡支付
...
# [](#loading-a-card-with-tokens)装载代币卡
...
# [](#signing-the-atom-hash-on-card)签名卡上的原子哈希

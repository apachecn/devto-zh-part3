...
> 原文:[https://dev . to/Nielsen Jared/how-to-deploy-a-gatsbyjs-blog-on-github-pages-as-a-user-site-26cb](https://dev.to/nielsenjared/how-to-deploy-a-gatsbyjs-blog-on-github-pages-as-a-user-site-26cb)

[![How to Deploy a GatsbyJS Blog on GitHub Pages as a User Site](../Images/f736c04a1a92b6fc13fc9939443da9fb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--DL7xYLdi--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/m3dvx2xcdpxcdwgvqp16.png)
...
## [](#install-gatsbyjs-and-create-a-new-blog)安装 GatsbyJS，创建新博客
...
## [](#install-amp-configure-ghpages)安装&配置 GH-页面
...
## [](#using-a-custom-domain-name-with-github-pages)使用自定义域名与 GitHub 页面

...
> 原文:[https://dev . to/brodan/configuring-a-pypirc-file-for-easy-python-packaging-2d 50](https://dev.to/brodan/configuring-a-pypirc-file-for-easier-python-packaging-2d50)
...
# [](#uploading-python-packages)上传 Python 包
...
# [](#securing-the-pypirc-file)固若金汤。pypirc 文件

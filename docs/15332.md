...
> 原文:[https://dev . to/Jon rimmer/where-to-initiate-data-load-in-ngrx-358 l](https://dev.to/jonrimmer/where-to-initiate-data-load-in-ngrx-358l)
...
#### [](#in-your-appcomponent)在你的 AppComponent 中
...
### [](#when-a-container-component-is-initialised)初始化容器组件时
...
### [](#when-the-app-navigates-to-a-route)当 app 导航到一条路线时
...
### [](#dispatch-an-action-from-a-check-inside-a-selector)从选择器内部的检查中分派动作

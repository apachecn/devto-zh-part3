...
> 原文:[https://dev . to/radix DLT/introducing-the-radix-command-line-interface-CLI-internal-hackathon-winner-5cie](https://dev.to/radixdlt/introducing-the-radix-command-line-interface-cli-internal-hackathon-winner-5cie)

# [](#radix-command-line-interface-cli)Radix 命令行界面(CLI)
...
# [](#offledger-smart-contracts%E2%80%8D)账外智能 Contracts‍

...
> 原文:[https://dev . to/azure/turn-a-command-line-tool-into-a-rest-API-with-azure-functions-37ll](https://dev.to/azure/turn-a-command-line-tool-into-a-rest-api-with-azure-functions-37ll)

[![command line tool](../Images/e0e18465a2993c4007ac0912d26b3397.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--x8IAASCN--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gloveboxes/Turn-a-Command-Line-tool-into-a-REST-API-with-Azure-Functions/master/docs/banner.jpg)
...
## [](#how-to-run-a-command-line-tool-to-a-rest-api)如何对 REST API 运行命令行工具
...
2.  上传命令和关联的库。![Upload command tool](../Images/759e6406a33d203308010292c94917fc.png)
...
1.  从功能应用程序 UI 选择平台功能![Set CORS rules](../Images/1d5d9dac0e130b1e13a1e4d2784c6d91.png)
2.  指定进行跨原点调用的 JavaScript 应用程序的原点 URL。![create CORS rule](../Images/5651112e905dcfa5082a653b0a377f4f.png)

...
> 原文:[https://dev . to/praveenweb/build-and-deploy-real time-svelte-3-apps-using-graph QL-1 fkj](https://dev.to/praveenweb/build-and-deploy-realtime-svelte-3-apps-using-graphql-1fkj)

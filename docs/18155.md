...
> 原文:[https://dev.to/royalaid/aws-api-拉姆达- cljs-29ca](https://dev.to/royalaid/aws-api--lambda--cljs-29ca)

# [](#building-on-our-own-shoulders)建筑在自己的肩膀上
...
[![Image of AWS Services Dashboard](../Images/a15370a9ebf873d6a4dd5d3625865c60.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--2rgv3hy6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/vfypyrxsekhw72m659co.png) 
...
## ![GitHub logo](../Images/a73f630113876d78cff79f59c2125b24.png) [皇家援助](https://github.com/royalaid) / [影子-节点-AWS](https://github.com/royalaid/Shadow-Node-AWS)
...
## [](#cljs-vs-js)CLJS VS JS

###### [](#note-i-have-basically-ported-the-js-to-its-literal-but-not-idiomatic-cljs-equivalent-i-would-use-this-code-to-help-get-a-better-understanding-of-how-the-two-languages-relate-and-how-to-call-one-from-the-other-i-would-not-code-like-this-when-using-cljs-as-the-primary-language)注意:我基本上已经将 JS 移植到了它的字面上，但不是惯用的，CLJS 的等价物。我将使用这段代码来帮助更好地理解这两种语言之间的关系，以及如何从另一种语言中调用一种语言。当使用 CLJS 作为主要语言时，我不会*像这样*编码。

在这篇文章中，我将只分解例子`createTable`，因为任何例子之间的唯一区别是`params` var 和`dynamodb` / `docClient` fn 调用。

### [](#js-for-reference)JS 为参考
...
## [](#nodejs-repl-calls)Node.js REPL 来电

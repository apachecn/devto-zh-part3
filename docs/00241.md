...
> 原文:[https://dev . to/jsrn/modules-macros-meta programming-and-magic-12k 0](https://dev.to/jsrn/modules-macros-metaprogramming-and-magic-12k0)
...
# [](#executing-code-during-interpretation-time)在解释期间执行代码

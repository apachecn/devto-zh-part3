...
> 原文:[https://dev . to/lepo virta/check-your-kubernetes-deployments-4fbh](https://dev.to/lepovirta/check-your-kubernetes-deployments-4fbh)
...
## [](#typical-flow-for-deploying-applications-to-kubernetes)将应用部署到 Kubernetes 的典型流程
...
[![Incomplete Kubernetes deployment flow](../Images/4ddbbc0d730f7e559fc8bd0700ff6152.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--5qpgzlFb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://lepovirta.org/posts/images/kubernetes_deployment_flow_incomplete.png)

为了正确地检查更新是否按预期进行，我们需要另一个 kubectl 命令的帮助。

## [](#rollout-to-the-rescue)卷展救援！
...
## [](#readiness-probes-and-deadlines)准备就绪探查和截止日期
...
## [](#scripting-automated-rollback)脚本自动回滚
...
[![Improved Kubernetes deployment flow](../Images/0e132b5b5b5ce3136c69b4c01693c5a4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--fA4emziK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://lepovirta.org/posts/images/kubernetes_deployment_flow_improved.png)

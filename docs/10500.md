...
> 原文:[https://dev . to/bolajayodeji/how-to-convert-github-markdown-files-to-a-simple-website-4e 14](https://dev.to/bolajiayodeji/how-to-convert-github-markdown-files-to-a-simple-website-4e14)
...
### [](#determine-the-repository-where-you-want-to-activate-github-pages)确定你想要激活 GitHub 页面的存储库

如果您愿意，当然可以创建一个新的存储库。

### [](#create-the-raw-configyml-endraw-file)创建`_.config.yml`文件
...
### [](#activate-github-pages-in-your-repository-configuration)在您的存储库配置中激活 GitHub 页面

在项目的 GitHub 页面上，进入`Settings > Options > Github Pages`:

[![](../Images/60f4c88ef78741bbb6acee05d97c7f2f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--KL_orP2S--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/880/0%2AeZBV54NOulDlzKy8.png)

在`Source`选项中，选择`master branch`，然后选择`Save`:

[![](../Images/77193c7b10a014796f6e4a3f74bc37c5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--gE4XqTVM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/880/0%2AH972YMaFG9Gfiolm.png)

您还必须选择一个主题:

[![](../Images/7932b765ad7be7fa841aae48e7e145bb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--jFO5-QtS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/880/0%2AzdXm2jwli-YMIBAh.png)

...
> 原文:[https://dev . to/lennythedev/quick-database-with-node-express-and-disk db-in-5-minutes-1jjj](https://dev.to/lennythedev/quick-database-with-node-express-and-diskdb-in-5-minutes-1jjj)
...
我有没有提到*没有桌子*？
T3![no_sql_joke](../Images/a553ff19efe7df7a61778d0b272b1e2a.png)T5】

关于整个 **SQL vs NoSql** 的细节，请看这篇文章:

[![flippedcoding image](../Images/bf52a01cd56e1fb6b6aba2826deacb3b.png)](/flippedcoding) [## SQL 和 NoSQL 数据库之间的差异

### 米利西亚

#webdev #beginners #database #sql](/flippedcoding/differences-between-sql-and-nosql-databases-3ml4)

# [](#what-is-raw-diskdb-endraw-)什么是`diskdb`？
...
## [](#1-create-database-file)1。创建数据库文件
...
## [](#2-exclude-data-files-from-nodemon)2。从 Nodemon 中排除数据文件
...
## [](#3-install-raw-diskdb-endraw-)3。安装`diskdb`
...
## [](#4-import-and-connect-to-db)4。导入并连接到数据库
...
## [](#4-add-a-movie-to-test-out-connection)4。添加一部电影来测试连接
...
## [](#5-crud-to-rest-to-db)5。CRUD 到 REST 到 DB
...
## [](#6-changing-to-diskdb-operations)6。更改为 diskdb 操作
...
### [](#heres-the-complete-code)这里是完整的代码

[使用 Node + Express + diskdb 的快速数据库](https://github.com/lenmorld/devto_posts/tree/master/quick_node_express_diskdb)

[![hackerman](../Images/155bdef101a6516089d9d0a37b05be1b.png)T2】](https://i.giphy.com/media/gGuOldphm6vzW/source.gif)

## [](#okay-that-was-nice-but-what-can-i-do-with-this-)*“好的，那很好。但是我能用这个做什么呢？”*
...
## ![GitHub logo](../Images/a73f630113876d78cff79f59c2125b24.png)/[节点 _ 车间](https://github.com/lenmorld/node_workshop)

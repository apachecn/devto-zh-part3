...
> 原文:[https://dev . to/rem bou 1/how-to-change-blazor-dll-file-extension-with-aspnet-core-3d6d](https://dev.to/rembou1/how-to-change-blazor-dll-file-extension-with-aspnet-core-3d6d)
...
[![Toss startup network tab](../Images/bc430969fd400e97e589b54a4c20dae8.png "Toss startup network tab")T2】](/assets/img/Capture.PNG)
...
## [](#changing-the-incoming-request)更改呼入请求
...
## [](#changing-on-client-side)在客户端改变
...
[![Toss startup network tab](../Images/dd93dae52c95d4e2f1be8ef97a54902a.png "Toss startup network tab")T2】](/assets/img/Capture2.PNG)

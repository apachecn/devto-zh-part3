...
> 原文:[https://dev . to/oktadev/build-a-secure-node-js-app-with-SQL-server-22oa](https://dev.to/oktadev/build-a-secure-node-js-app-with-sql-server-22oa)
...
## [](#set-up-your-nodejs-development-environment)设置你的 Node.js 开发环境
...
### [](#install-sql-server-on-windows)在 Windows 上安装 SQL Server

下载并安装 [SQL Server 开发者版](https://www.microsoft.com/en-us/sql-server/sql-server-downloads)。

### [](#install-sql-server-on-mac-or-linux)在 Mac 或 Linux 上安装 SQL Server
...
## [](#set-up-the-sql-database)设置 SQL 数据库
...
## [](#create-a-nodejs-web-application)创建 Node.js Web 应用程序
...
### [](#nodejs-project-structure)Node.js 项目结构
...
### [](#create-a-basic-server-with-routes)创建一个带有路由的基本服务器
...
## [](#create-a-nodejs-api-with-sql-server)用 SQL Server 创建 Node.js API
...
### [](#create-the-sql-data-access-layer)创建 SQL 数据访问层
...
### [](#create-a-database-client-plugin)创建数据库客户端插件
...
[![First API Results!](../Images/fb47f0937fdc59d876e2fa67b5b26fed.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--3lsgTYcN--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://developer.okta.com/assets-jekyll/blog/node-sql-server/first-api-results-d6ff9da647140254fad89f8a1fb23a53e1f0bc913df7baf0d59060ade52e2d08.jpg)

## [](#add-authentication-to-your-nodejs-application)向 Node.js 应用程序添加身份验证
...
### [](#register-ui-and-authentication-plugins)注册 UI 和认证插件
...
### [](#update-routes-to-support-views-and-authentication)更新路由以支持查看和认证
...
### [](#update-api-routes-and-add-sql-queries)更新 API 路由并添加 SQL 查询

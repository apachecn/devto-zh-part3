...
> 原文：<https://dev.to/bnevilleoneill/using-animation-worklet-4m35>

[![](img/0e25dde2355f6645d3fb43c83f3576f8.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--CiR6scDx--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2Aiuo5l1EHzkrnqUPDwbBVAA.jpeg)
...
简而言之，Animation Worklet(与其他动画技术如 [CSS 过渡](https://dev.to/bnevilleoneill/css-transitions-101-lets-animate-a-toggle-button-icon-e32)、[带关键帧的 CSS 动画](https://developer.mozilla.org/en-US/docs/Web/CSS/animation)或 [WAAPI](https://developer.mozilla.org/en-US/docs/Web/API/Web_Animations_API) 相比)不必基于时间。这使得我们可以基于用户输入来制作动画，比如滚动、以前的状态或者任何我们可以用 JavaScript 访问的东西。
...
使用动画小工具的帖子[首先出现在](https://blog.logrocket.com/using-animation-worklet-4a3914c19112/)[博客](https://blog.logrocket.com)上。
...
> 原文:[https://dev.to/_darrenburns/the-piece-table——你的文本编辑器的无名英雄——al8](https://dev.to/_darrenburns/the-piece-table---the-unsung-hero-of-your-text-editor-al8)
...
## [](#first-instincts-the-array-of-strings)第一本能——字符串的排列
...
[![shifting](../Images/8e242b5122ba63635ee4038ab12467a9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--12MUbiU7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/k21rt35uetkehabyuhwa.png)
...
## [](#an-appendonly-representation)仅附加的表示
...
[![pt-basic](../Images/60e7fe30fbb2234d1aa710d75aecf7d1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--feKmxmN4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/nw7ezjpvygc7do16tg61.png)
...
## [](#adding-text-to-a-file)向文件中添加文本
...
[![pt-example](../Images/a9d23c3f4e26ac7db43009b96bd5c8d5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--rUNAl_7P--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/h1kgfx3rh901nzsj4jcc.png)

当你在一篇文章的开头或结尾插入文本时，情况会有所不同。在这种情况下，添加文本不会将现有的部分“分割”成两半，因此我们只需要一个额外的部分来表示新插入的文本。

## [](#saving-and-displaying-the-open-file)保存并显示打开的文件
...
## [](#referencesfurther-reading)参考文献/进一步阅读

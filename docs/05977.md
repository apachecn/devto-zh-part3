...
> 原文:[https://dev . to/Napoleon 039/how-to-test-vue-apps-with-popular-cypress-framework-4jfg](https://dev.to/napoleon039/how-to-test-vue-apps-with-the-popular-cypress-framework-4jfg)
...
## [](#setting-up-the-application)设置应用程序
...
[![Todo app main code](../Images/2541a5e77372d91fae7fa0dbfc6dbd8d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--IE-gKXUZ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/po3xshkbh2c1tiyvhamx.png)

这是 todo 应用程序的代码。非常简约，没有太多造型。但是它是有效的，这就是我们开始编写测试所需要的。所以让我们开始写测试吧。我们必须先安装赛普拉斯。

## [](#installing-and-setting-up-cypress)安装和架设柏树

要使用 npm 安装 Cypress:

[![Cypress install command](../Images/db7c858945ba8fa2c49624ee00fbc02a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--RAqsCf0T--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/v8s0ffhhxxwk98uzhkua.png)
...
[![First test](../Images/c07d3074563b9884d211687322f90cd4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--eGv8BJ1g--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/72qr9dzzhb0mm5ox7f2u.png)
...
[![Second test](../Images/baabf3a67eb066a4b6e6cc08c5a843b1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--CPaL4aEn--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/rcx0m7n45fxa5nx04kg0.png)
...
[![Third test](../Images/eb538f7bdbaee6f2d63dff73c1b8f24f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--B_IZd4_c--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/19nt1puw8lqykacwf4ky.png)

这次的测试相当小。我们使用`cy.get()`和链接`click()`得到按钮。最后，我们得到特定的任务，并断言它不包含任务内容。至此，我们已经完成了所有的测试，并确保应用程序的基本功能正常工作。

以下是我们在一个地方编写的所有测试:

[![All todo app tests](../Images/6921e465dc78f59743818bdf3f140408.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--iwFe4sSa--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/wt60c5tp9edask515t1x.png)

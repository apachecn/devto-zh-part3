...
> 原文:[https://dev . to/samu yi/how-to-setup-nginx-for-HLS-video-streaming-on-centos-7-3jb 8](https://dev.to/samuyi/how-to-setup-nginx-for-hls-video-streaming-on-centos-7-3jb8)
...
## [](#step-1-download-and-compile-nginx-with-its-dependencies)步骤 1 -下载并编译 Nginx 及其依赖项
...
## [](#step-2-setup-and-configure-nginx)步骤 2–设置和配置 Nginx
...
## [](#step-3-stream-and-publish-videos)步骤 3-流式传输和发布视频

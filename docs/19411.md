...
> 原文:[https://dev.to/voronar/practical-typescript-react-redux-4enh](https://dev.to/voronar/practical-typescript-react--redux-4enh)
...
### [](#i-dont-know-how-do-you-live-at-all-without-a-strong-static-typing-what-do-you-do-debug-your-code-all-day-unknown-person)“我根本不知道没有强静打字你是怎么活的。你是做什么的？整天调试你的代码？”未知的人。

### [](#no-we-write-types-all-day-my-colleague)“不，我们整天写打字。”我的同事。
...
### [](#super-force-of-typescript)超强的打字力

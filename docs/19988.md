...
> 原文:[https://dev . to/neo/create-a-cryptocurrency-tracking-app-with-push-notifications-using-swift-and-laravel-part-1-the-back end-2 mdh](https://dev.to/neo/create-a-cryptocurrency-tracking-app-with-push-notifications-using-swift-and-laravel---part-1-the-backend-2mdh)
...
### [](#how-the-backend-application-will-work)后端应用程序将如何工作
...
### [](#how-the-application-will-look)应用程序的外观

当我们完成应用程序时，下面是应用程序的外观:

[![](../Images/df1eb9df4f73add13ace5015747ef33a.png)T2】](//images.ctfassets.net/1es3ne0caaid/1K08NTSdaoIIqWQ2YAyOqo/4efdb4fa01a2ee599bf5b71561a717a4/ios-cryptocurrency-part-1-demo.gif)

让我们开始吧。

## [](#setting-up-pusher-beams-and-channels)设置推杆横梁和通道

### [](#setting-up-pusher-channels)设置推杆通道

登录到您的[推杆仪表板](https://dashboard.pusher.com)。如果您没有帐户，请创建一个。您的仪表板应该如下所示:

[![](../Images/5ca544eb850f7abb3360bfc849fd113a.png)T2】](//images.ctfassets.net/1es3ne0caaid/47FA7jeU0w62siO8G6iCQi/aeda1c00644c75e4d327dbe6725694d7/ios-cryptocurrency-part-1-keys.png)

创建新的频道应用程序。你可以通过点击右下角的大**创建新频道应用**卡来轻松完成。创建新应用程序时，会为您提供密钥。保管好它们，因为你很快就会需要它们。

### [](#setting-up-pusher-beams)设置推杆横梁
...
[![](../Images/5eca7db1e9d3b5a32176e3e2c16a30cb.png)T2】](//images.ctfassets.net/1es3ne0caaid/4xKD0goX606gGqUSQW2EcC/3dcd7757df87351ddc54cb62397ce2e7/ios-cryptocurrency-part-1-new-beams.png)

创建实例后，您将看到一个快速入门指南。选择 **IOS** 快速入门，并按照向导进行操作。

[![](../Images/83a156dc4395425f7be821f142e1772e.png)T2】](//images.ctfassets.net/1es3ne0caaid/27fmUEHf64Qc0KcIQo0KAw/265bde6f67ea031f5d5495a10273e678/ios-cryptocurrency-part-1-beams-quickstart.png)

当您完成创建 Beams 应用程序时，您将获得一个实例 ID 和一个密钥，我们稍后会用到它们。

## [](#setting-up-your-backend-application)设置您的后端应用程序
...
### [](#setting-up-our-pusher-beams-library)设置我们的推焦梁库
...
### [](#setting-up-our-pusher-channels-library)设置我们的推焦渠道库
...
## [](#building-the-backend-application)构建后端应用程序

现在我们已经设置了所有的依赖项，我们可以开始构建应用程序了。我们将从创建路线开始。然而，我们不是创建控制器来挂接路由，而是将逻辑直接添加到路由中。

### [](#setting-up-the-database-migration-and-model)设置数据库、迁移和模型
...
### [](#creating-the-jobs-events-and-notifiers)创建作业、事件和通知程序

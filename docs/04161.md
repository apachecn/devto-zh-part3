...
> 原文:[https://dev . to/simply tunde/kubernetes-performance-and-CPU-manager-4ea 9](https://dev.to/simplytunde/kubernetes-performance-and-cpu-manager-4ea9)
...
##### [](#cpu-manager-and-scheduling)CPU 管理器和调度

...
> 原文:[https://dev . to/mgr eiler/how-code-reviews-work-at-Microsoft-4igc](https://dev.to/mgreiler/how-code-reviews-work-at-microsoft-4igc)
...
<figure>[![](../Images/f7935e06db36042840eb27bc0c1c8bf4.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--rjHw4vXF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i1.wp.com/www.michaelagreiler.com/wp-content/uploads/2019/05/E-Book-Preview.jpg%3Fw%3D600%26ssl%3D1) 

<figcaption>[独家代码评论最佳实践电子书](https://www.michaelagreiler.com/code-review-e-book/)送给我的订阅者。</figcaption>

</figure>

## [](#investigating-code-reviews-at-microsoft)在微软调查代码审查
...
## [](#who-are-relevant-reviewers)谁是相关审核人？

Rose 选择她认为可以为这段代码贡献知识的评审员。评审者通常是其他开发人员，但是也可以包括其他利益相关者，比如开发-运营工程师、UI 专家或者经理。一些评审者是因为他们的专业知识而被挑选出来的，其他的是为了随时了解即将到来的变化。

<figure>[![common steps of a code review](../Images/9b8cd8d99ae68befa360dfe78be5d4c7.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--VqWsBOJ8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i1.wp.com/www.michaelagreiler.com/wp-content/uploads/2019/03/Code-review-cycle.png%3Fw%3D800%26ssl%3D1) 
...
## [](#receiving-feedback-is-an-iterative-process)接收反馈是一个反复的过程
...
## [](#rose-prepares-a-new-improved-version-of-the-code)罗斯准备了新的改进版代码
...
## [](#all-reviewers-approve-and-rose-checksin-the-code)所有审核人批准和升检-在代码中
...
## [](#code-reviews-including-user-interface)代码评审包括用户界面

如果更改影响了用户界面，要求开发人员提交截图也是一个明智的想法。通过这种方式，代码审查者可以在不运行代码的情况下看到代码更改的效果。第二，代码审查者可以在自己的机器上运行代码时发现差异。

## [](#code-reviews-including-static-analysis)代码评审包括静态分析
...
## [](#microsofts-code-review-tool)微软的代码审查工具
...
### [](#codeflows-interface-explained)CodeFlow 的接口说明
...
## [](#want-more-on-code-reviews)想要更多关于代码评审的信息吗？
...
我想提一下我在微软和维多利亚大学的同事们，他们也参与了这项研究:克里斯·伯德、T2、亚采克·切沃恩卡、T4、劳拉·麦克劳德和玛格丽特·安妮·斯托里。我喜欢和你一起做这个 [![♥](../Images/a89750fea4feefb02d3e8d1db7af67c3.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--dx3he-Lh--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s.w.org/images/core/emoji/11/72x72/2665.png)

...
> 原文:[https://dev.to/mpixel/deconstructing-onlykey-agent-401l](https://dev.to/mpixel/deconstructing-onlykey-agent-401l)
...
## [](#generate-the-private-key-retrieve-the-public-key)生成私钥，检索公钥
...
### [](#conclusion-for-slot-selection)为插槽选择的结论

...
> 原文:[https://dev . to/mesadhan/Android-oauth 2-basic-implementation-447 p](https://dev.to/mesadhan/android-oauth2-basic-implementation-447p)

# [](#implementations-task-checklist)实施任务清单:-
...
# [](#run-and-test-application-from-source)从源代码运行并测试应用程序

...
> 原文:[https://dev . to/javinpaul/top-20-string-coding-problems-from-programming-job-visities-493m](https://dev.to/javinpaul/top-20-string-coding-problems-from-programming-job-interviews-493m)

*披露:这篇文章包括附属链接；如果您从本文提供的不同链接购买产品或服务，我可能会收到报酬。*

[![](../Images/56b111f7abff68ac302dd271ad8bf571.png)](https://www.udemy.com/course/data-structures-and-algorithms-deep-dive-using-java/?LSNPUBID=JVFxdTr9V80&ranEAID=JVFxdTr9V80&ranMID=39197&ranSiteID=JVFxdTr9V80-HtAKxsXlpXTUmaSiBItBww) 
...
## [](#how-to-solve-string-based-coding-problems)如何解决基于字符串的编码问题？

...
> 原文:[https://dev . to/tirthbodawala/cloning-JavaScript-array-in-multiple-ways-4i5c](https://dev.to/tirthbodawala/cloning-javascript-array-in-multiple-ways-4i5c)

有很多不同的方法来克隆 JavaScript 数组。在本文中，我将列出克隆数组**最突出和最快的方法。**

## [](#different-ways-to-clone-a-javascript-array)克隆 JavaScript 数组的不同方式
...
## [](#serialising-then-deserializing)序列化然后反序列化

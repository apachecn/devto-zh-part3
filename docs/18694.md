...
> 原文:[https://dev.to/codingcatdev/ajonp-hugo-ionic-template-2kcc](https://dev.to/codingcatdev/ajonp-hugo-ionic-template-2kcc)
...
### [](#lesson-2-required-for-algolia)第二课(阿尔戈利亚必修)
...
# [](#create-new-hugo-site)创建新的 Hugo 站点
...
[![Hugo Skeleton](../Images/2d171a2d210c736cf68cce19b17ea481.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9MeHqO5g--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://res.cloudinary.com/ajonp/image/upload/f_auto%2Cfl_lossy%2Cq_auto/v1544487496/ajonp-ajonp-com/4-lesson-hugo-ionic/hugo_init.jpg)
...
## [](#update-indexhtml)更新 Index.html
...
# [](#start-using-ajonp-template)开始使用 AJonP 模板

## [](#theme-download-location)主题下载位置
...
## [](#git-integraiton)Git 积分

### [](#clone-easy-not-updated)克隆(简单，不更新)
...
### [](#submodule-better-updated)子模块(更好，更新)

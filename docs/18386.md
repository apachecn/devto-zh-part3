...
> 原文:[https://dev . to/krofdrakula/some-lists-is-not-like-the-others-3h8i](https://dev.to/krofdrakula/some-lists-are-not-like-the-others-3h8i)

到目前为止，在本系列中，我们一直将数组作为值的自然容器来处理，这使得我们可以将它们视为一个序列。但是什么是数组呢？是什么让它们滴答作响？让我们来了解一下！

## [](#impostors-impostors-everywhere)冒名顶替，到处冒名顶替
...
[![](../Images/4aec56d69e3da5e2f68c35cbcf490227.png)T2】](https://i.giphy.com/media/QiMwnrZNifT7G/giphy.gif)
...
### [](#iterators-iterables-and-raw-symboliterator-endraw-)迭代器、可迭代对象和`Symbol.iterator`

[![](../Images/a1c3593b912d5b2adc6a6e29ac920bdb.png)T2】](https://i.giphy.com/media/TeinpBGRY5UOc/giphy.gif)
...
## [](#arrays-the-fast-and-easy-parts)数组:快速简单的部分
...
## [](#arrays-the-costly-parts)数组:昂贵的零件
...
## [](#the-big-and-scary-o-notation)阿大(又吓人)的批注

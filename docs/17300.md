...
> 原文:[https://dev . to/harshadranganathan/building-and-publishing-your-messenger-bot-3 FEA](https://dev.to/harshadranganathan/building-and-publishing-your-messenger-bot-3fea)

最初发表于[rharshad.com](https://rharshad.com/building-publishing-facebook-messenger-bot/)

# [](#building-your-bot)打造你的机器人

在这个例子中，我们将使用 Node.js 来构建我们的 bot，它将响应用户的消息。

## [](#create-a-new-nodejs-project)新建一个 Node.js 项目
...
## [](#configure-an-environment-file)配置一个环境文件
...
## [](#create-an-http-server)创建一个 HTTP 服务器
...
## [](#add-webhook-verification-endpoint)添加 webhook 验证端点
...
## [](#sending-structured-message)发送结构化消息
...
[![](../Images/0b411c20ae89aa3ae097ba7fd2166da5.png)T2】](https://rharshad.com/assets/img/2019/01/messenger-quick-replies.png)
...
# [](#deploy-your-webhook)部署你的 webhook
...
# [](#set-up-your-facebook-app)设置您的脸书应用程序
...
[![](../Images/f48d4112b69d08eaa0d43cb2f8aa3a44.png)T2】](https://rharshad.com/assets/img/2019/01/create-fb-page.png)
...
### [](#whitelist-domain-amp-subscription-messaging)白名单域&订阅消息
...
[![](../Images/f88c4543c77e6e8a4907ac2d82df98b6.png)T2】](https://rharshad.com/assets/img/2019/01/messaging-platform-features.png)
...
## [](#facebook-developer-account)脸书开发者账号
...
### [](#add-messenger-platform-to-your-app)将 Messenger Platform 添加到您的应用

1.  在“产品”下的应用程序设置侧栏中，单击“+添加产品”。
2.  将鼠标悬停在“Messenger”上以显示选项。
3.  点击“设置”按钮。

[![](../Images/5a342e0b8b0a2db1bf41478e0b648f26.png)T2】](https://rharshad.com/assets/img/2019/01/messenger-product-fb-app.png)
...
[![](../Images/8c43305a142472ef2280b614015c30ca.png)T2】](https://rharshad.com/assets/img/2019/01/setup-webhook.png)

### [](#subscribe-your-facebook-page)订阅您的脸书页面
...
[![](../Images/55dfd6946dd224934da6d64efed4e159.png)T2】](https://rharshad.com/assets/img/2019/01/webhooks-section.png)

### [](#generate-page-access-token)生成页面访问令牌
...
## [](#permissions-and-features-review)权限和功能审核
...
### [](#select-app-permissions)选择 app 权限

在 messenger 设置的应用审查部分下请求 pages_messaging 权限，这允许您的 bot 在实时模式下发送消息。

[![](../Images/e2e7b64970442cb076d606ac2805b7d2.png)T2】](https://rharshad.com/assets/img/2019/01/app-review-messenger.png)
...
[![](../Images/554226e66c73598b8bc58bf2a6fb0e99.png)T2】](https://rharshad.com/assets/img/2019/01/messenger-test-users.png)
...
## [](#business-information-and-verification-documents)业务信息及验证文件
...
## [](#accept-supplemental-terms-and-sign-tech-provider-agreement)接受补充条款并签署技术提供商协议

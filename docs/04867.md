...
> 原文:[https://dev . to/drift er z13/quick-introduction-to-react-hook-4 CHO](https://dev.to/drifterz13/quick-introduction-to-react-hook-4cho)
...
# [](#introduction-to-usestate)使用状态介绍
...
# [](#introduction-to-useeffect)使用效果介绍

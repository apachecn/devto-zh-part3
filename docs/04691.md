...
> 原文:[https://dev . to/mgr eiler/proven-code-review-best-practices-from-Microsoft-AAP](https://dev.to/mgreiler/proven-code-review-best-practices-from-microsoft-aap)
...
## [](#a-typical-code-review-process)典型的代码评审过程

一个典型的基于工具的代码评审过程在工程师准备评审代码时开始。然后，她为代码变更选择相关的审阅者。评审员得到通知，并对代码给出反馈。代码评审作者处理反馈，直到各方都满意为止。然后，将代码签入公共代码库。

<figure>[![A typical code review](../Images/9b8cd8d99ae68befa360dfe78be5d4c7.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--VqWsBOJ8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i1.wp.com/www.michaelagreiler.com/wp-content/uploads/2019/03/Code-review-cycle.png%3Fw%3D800%26ssl%3D1) 
...
<figure>[![Exclusive Code Review Best Practice e-Book](../Images/f7935e06db36042840eb27bc0c1c8bf4.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--rjHw4vXF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i1.wp.com/www.michaelagreiler.com/wp-content/uploads/2019/05/E-Book-Preview.jpg%3Fw%3D600%26ssl%3D1) 
...
## [](#read-through-the-change-carefully)仔细通读变化
...
## [](#aim-for-small-incremental-changes)以微小的、渐进的变化为目标
...
## [](#cluster-related-changes)集群相关变化
...
## [](#describe-the-purpose-and-motivation-of-the-change)形容改变的目的和动机
...
<figure>[![Code review is not a puzzle - a puzzle with many parts](../Images/3afffe0eed1d59185c61d37df4e8e530.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--1heda4jG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i0.wp.com/www.michaelagreiler.com/wp-content/uploads/2019/04/puzzle.jpg%3Ffit%3D800%252C534%26ssl%3D1) 
...
## [](#automate-what-can-be-automated)自动化能自动化的
...
## [](#skip-unnecessary-reviews)跳过不必要的评论
...
## [](#do-not-select-too-many-reviewers)不要选择太多的审核人
...
## [](#add-experienced-reviewers-to-get-insightful-feedback)添加有经验的评审员以获得有见地的反馈
...
## [](#give-reviewers-a-headsup-before-the-review)在评审前给评审者一个提示
...
## [](#show-respect-and-gratitude-to-the-reviewers)对评审者表示尊重和感谢
...
## [](#code-review-best-practices-for-code-reviewers)代码评审员的代码评审最佳实践
...
## [](#give-respectful-and-constructive-feedback)给予尊重和建设性的反馈
...
## [](#go-and-talk-in-person-if-necessary)如有必要，亲自去谈
...
## [](#ensure-traceability-for-decisions)确保决策的可追溯性
...
<figure>[![traces in sand symbolizing code review feedback traces](../Images/9be7b68ddfbed4cc67c1f307f03e6f44.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--yrTiBG7Y--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i1.wp.com/www.michaelagreiler.com/wp-content/uploads/2019/04/traces.jpg%3Ffit%3D800%252C534%26ssl%3D1) 
...
## [](#always-explain-why-you-rejected-a-change)总是解释你拒绝改变的原因
...
<figure>[![a person working a bit lost at a computer](../Images/6d1267cb5824b5f4e64b4c91e9026751.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--fKkADPne--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i2.wp.com/www.michaelagreiler.com/wp-content/uploads/2019/04/productivity.png%3Ffit%3D800%252C400%26ssl%3D1) 
...
## [](#give-feedback-in-a-timely-manner)及时给予反馈
...
## [](#review-frequently-not-in-a-big-bang-fashion)不要大张旗鼓地频繁复习
...
## [](#focus-on-core-issues-less-nitpicking)关注核心问题，少吹毛求疵
...
<figure>[![Code Review Best Practices e-Book](../Images/cb4690452879a9fe790c43a537b83060.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--AfzfFZM3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i1.wp.com/www.michaelagreiler.com/wp-content/uploads/2019/05/E-Book-Preview.jpg%3Fw%3D500%26ssl%3D1) 

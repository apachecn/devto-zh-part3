...
> 原文:[https://dev . to/starlightslo/how-to-install-Tomcat-on-MAC OS-5hi 0](https://dev.to/starlightslo/how-to-install-tomcat-on-macos-5hi0)
...
## [](#download-tomcat-for-macos)下载 MacOS 版 Tomcat

对于 MacOS，你必须下载**内核【tar.gz】T2**并解压。(你可以选择你想要的版本)

## [](#create-tomcat-folder)创建 Tomcat 文件夹
...
## [](#make-all-scripts-executable)使所有脚本可执行

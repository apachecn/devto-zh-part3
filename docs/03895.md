...
> 原文:[https://dev . to/about _ hiroppy/fusuma-which-can-create-slides-with-markdown-easy-has-released-3ii](https://dev.to/about_hiroppy/fusuma-which-can-create-slides-with-markdown-easily-has-been-released-3ii)

* * *

[广博/扶桑](https://github.com/hiroppy/fusuma)

## [](#what-is%C2%A0fusuma)扶桑是什么？
...
[![](../Images/cb6450d136d167c23715778a9cacf07e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--QKLPuh_D--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ubjrrbrqlmz8bgqi38bm.png)
...
## [](#writing-in%C2%A0markdown)在减价中写作
...
## [](#presenter-mode)演示者模式

扶桑有主持人的模式。下图供演示者使用。

[![](../Images/bd9b33c3bdf057a897655e43bd5b4b48.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--GbGffwNt--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/uf4oa81lhfotar0q7536.png)
...
## [](#sample-slide-and-repository)样本载玻片和储存库

...
> 原文:[https://dev.to/irosthebeggar/flutter 制作音乐应用程序第一天选择套餐 28e7](https://dev.to/irosthebeggar/flutter---making-a-music-app-day-1---choosing-packages-28e7)
...
*我的 pubspec.yaml 文件:*
[![My pubspec.yaml file](../Images/0116199abb945cbfbb4f1d7e653ba806.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--xv2JUr-A--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/3jzwtnh81twbdpm9k9mx.png)

## [](#packages-needed-for-a-music-app)一个音乐 App 需要的包
...
## [](#http-path-amp-downloads)HTTP，路径，&下载

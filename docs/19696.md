...
> 原文:[https://dev . to/Ben/NPM-package-discovered-to-have-bit coin-stealing-back door-j7i](https://dev.to/ben/npm-package-discovered-to-have-bitcoin-stealing-backdoor-j7i)

我认为人们预料到这种情况会发生，或者已经发生了。这是一个严重的安全风险，我们在开源软件中都遇到过。

# [![GitHub logo](../Images/75095a8afc1e0f207cda715962e75c8d.png) 不知说什么好。 #116](https://github.com/dominictarr/event-stream/issues/116) 

[![FallingSnow avatar](../Images/02d733b1ab2699e5a893e22ffd240014.png)](https://github.com/FallingSnow) **[FallingSnow](https://github.com/FallingSnow)** posted on [<time datetime="2018-11-20T21:26:01Z">Nov 20, 2018</time>](https://github.com/dominictarr/event-stream/issues/116)
...
## [](#im-harvesting-credit-card-numbers-and-passwords-from-your-site-heres-how)[我正在从你的网站上获取信用卡号码和密码。以下是方法。](https://hackernoon.com/im-harvesting-credit-card-numbers-and-passwords-from-your-site-here-s-how-9a8cb347c5b5)

这是另一个刚刚创建的主题，与主题相关:

## [](#how-do-we-improve-security-in-the-npm-ecosystem)[我们如何提高 npm 生态系统的安全性？](https://dev.to/nepeckman/how-do-we-improve-security-in-the-npm-ecosystem-3hmj)

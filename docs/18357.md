...
> 原文:[https://dev . to/craftzdog/making-a-full-text-search-module-that-works-both-desktop-and-mobile-pt-1-1n9i](https://dev.to/craftzdog/making-a-full-text-search-module-that-works-on-both-desktop-and-mobile-pt-1-1n9i)
...
## [](#how-about-mobile-platforms)移动平台怎么样？

### [](#android-doesnt-support-fts5-by-default)安卓默认不支持 FTS5
...
### [](#ios-supports-fts5-by-default)iOS 默认支持 FTS5
...
## [](#sync-index-with-pouchdb)同步索引与 pouchdb

...
> 原文:[https://dev . to/jalerson/hello-server less-with jets-and-dynamo id-3fi 8](https://dev.to/jalerson/hello-serverless-with-jets-and-dynamoid-3fi8)
...
# [](#creating-our-jets-app)创建我们的 Jets 应用

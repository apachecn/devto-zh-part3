...
> 原文:[https://dev . to/joaofbantunes/episode-021-integrating-identity server 4-part-1-overview-ASP-net-core-from-0-to-overkill-23 no](https://dev.to/joaofbantunes/episode-021-integrating-identityserver4-part-1-overview-asp-net-core-from-0-to-overkill-23no)
...
## [](#application-architecture-overview)应用架构概述

让我们先来看一下我们期望的架构，包括我们目前拥有的组件。

`Architecture diagram`
[![architecture diagram](../Images/6e1e79f6c8a1dc01c667e6cd24786cc8.png)T4】](https://thepracticaldev.s3.amazonaws.com/i/t5cdldndwp83k1od9bhk.jpg)
...
[![Authentication flow diagram](../Images/791ca2b6b49a2774104a9243b3e93a9d.png)T4】](https://thepracticaldev.s3.amazonaws.com/i/6bj59eg5o4h88ervsluo.jpg)
...
## [](#openid-connect-flow)OpenId 连接流

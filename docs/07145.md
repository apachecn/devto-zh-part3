...
> 原文:[https://dev.to/aromig/c-oop-class-modifiers-51a](https://dev.to/aromig/c-oop-class-modifiers-51a)
...
#### [](#autoimplemented-properties)自动实现的属性
...
### [](#summary-of-access-modifiers)访问修饰符汇总
...
### [](#constants-amp-readonly-variables)常量&只读变量

...
> 原文:[https://dev . to/dev team/dev to-repo-recap-from-the-past-week-8e 7](https://dev.to/devteam/devto-repo-recap-from-the-past-week-8e7)
...
*   感谢[@韵](https://dev.to/rhymes)，你现在可以导出你的评论数据了！查看变更日志和公关的所有细节。谢谢，[@韵](https://dev.to/rhymes)！
    ...
    *   [链接到 PR](https://github.com/thepracticaldev/dev.to/pull/1471)[![rhymes](../Images/91ed8188209dceb0374b6a8c88308333.png)](/rhymes) [## Changelog:导出注释
...
*   [@link2twenty](https://dev.to/link2twenty) 写了一个 JSFiddle 液体标签，把 JSFiddle 嵌入到你的帖子或者评论里！谢谢安德鲁。
    ...
    *   [Link to PR](https://github.com/thepracticaldev/dev.to/pull/1509)[![link2twenty](../Images/658801eb0300e3b6e98dde9a1fc0aa97.png)](/link2twenty) [## Change log: JSFiddle liquid label is now online
...
*   如果你错过了，我们现在有文章阅读时间！最后一推是 [@ben](https://dev.to/ben) 做的。查看 PR 和 changelog 帖子了解更多详细信息:
    ...
    *   [Link to PR](https://github.com/thepracticaldev/dev.to/pull/1538)[![The DEV Team](../Images/6b3a9c79aeecf790d5144f3fe1881f50.png)![](../Images/fe64a787b888dfb20fc13ad1e466da3d.png)](/devteam) [## Change log: now it shows the reading time
...
*   [@avocadoras](https://dev.to/avocadoras) 写帖子时请求支持 Org 模式语法。谢谢@avocadoras！
    ...
    # [![GitHub logo](../Images/75095a8afc1e0f207cda715962e75c8d.png) 新增组织模式语法支持 #1526](https://github.com/thepracticaldev/dev.to/issues/1526) 

    [![avocadoras avatar](../Images/ac116008e5988bfe7c06da7b7e71514e.png)](https://github.com/avocadoras) **[avocadoras](https://github.com/avocadoras)** posted on [<time datetime="2019-01-13T20:05:33Z">Jan 13, 2019</time>](https://github.com/thepracticaldev/dev.to/issues/1526)
...
*   [@tiagomagalhaes](https://dev.to/tiagomagalhaes) 请求了一个 Reddit 液体标签。谢谢， [@tiagomagalhaes](https://dev.to/tiagomagalhaes) ！
    ...
    # [![GitHub logo](../Images/75095a8afc1e0f207cda715962e75c8d.png)  Reddit 液态标签 #1536](https://github.com/thepracticaldev/dev.to/issues/1536) 

    [![tiagomsmagalhaes avatar](../Images/c65386205ec1a25b13d6b00389466b61.png)](https://github.com/tiagomsmagalhaes) **[tiagomsmagalhaes](https://github.com/tiagomsmagalhaes)** posted on [<time datetime="2019-01-14T15:02:55Z">Jan 14, 2019</time>](https://github.com/thepracticaldev/dev.to/issues/1536)
...
*   @michaeltharrington 写了一个关于允许他人编辑文章的详细问题，以及对你的帖子的版本控制的其他想法。这是一个有趣的想法，所以看看下面:
    ...
    # [![GitHub logo](../Images/75095a8afc1e0f207cda715962e75c8d.png) “允许编辑我的文章”的个人资料复选框+在 VC 上沉思文章 #1539](https://github.com/thepracticaldev/dev.to/issues/1539) 

    [![michael-tharrington avatar](../Images/c934bfd77e2c4ba8316feb7132acb1de.png)](https://github.com/michael-tharrington) **[michael-tharrington](https://github.com/michael-tharrington)** posted on [<time datetime="2019-01-14T19:57:42Z">Jan 14, 2019</time>](https://github.com/thepracticaldev/dev.to/issues/1539)
...
*   我们目前有一些 bug 是由我们的 bug 监控服务 Airbrake 报告的。这是一个运行时错误，应该是可以修复的。下面来看看:
    ...
    # [![GitHub logo](../Images/75095a8afc1e0f207cda715962e75c8d.png) 【空气制动】【生产】CloudinaryHelper 的未定义方法“cl_image_path”:模块 #1541](https://github.com/thepracticaldev/dev.to/issues/1541) 

    [![benhalpern avatar](../Images/2b95d19f70b4d1ccc724ce3ad9480e00.png)](https://github.com/benhalpern) **[benhalpern](https://github.com/benhalpern)** posted on [<time datetime="2019-01-14T23:07:07Z">Jan 14, 2019</time>](https://github.com/thepracticaldev/dev.to/issues/1541)
...
*   [@dylan](https://dev.to/dylan) 报告了编辑评论框不能正常调整大小的问题。谢谢迪伦。
    ...
    # [![GitHub logo](../Images/75095a8afc1e0f207cda715962e75c8d.png) 编辑评论框不调整大小 #1554](https://github.com/thepracticaldev/dev.to/issues/1554) 

    [![dylanking42 avatar](../Images/cb2a20113393eb045fc59a42301c046c.png)](https://github.com/dylanking42) **[dylanking42](https://github.com/dylanking42)** posted on [<time datetime="2019-01-15T16:36:04Z">Jan 15, 2019</time>](https://github.com/thepracticaldev/dev.to/issues/1554)
    ...
    **截图**如果适用，添加截图来帮助解释您的问题。请注意页脚和文本注释编辑框之间的巨大间隙。
    ...
    [![editing comment example](../Images/6b4597035fce742193487430092c73e3.png)T2】](https://user-images.githubusercontent.com/15676450/51194412-01386400-18b9-11e9-8324-62d2442b3748.PNG)

    [![edit comment exmaple 2](../Images/5dd380bd0745206542bdb0fbafb6891b.png)T2】](https://user-images.githubusercontent.com/15676450/51194755-b3702b80-18b9-11e9-98c5-6e449ec6aa02.PNG)
...
*   [@nickytonline](https://dev.to/nickytonline) 请求了用户资料的一项功能。当访问共同关注者时，有一个 CTA 可供您与他们开始新的连接对话。谢谢尼克。
    ...
    # [![GitHub logo](../Images/75095a8afc1e0f207cda715962e75c8d.png) 作为 dev.to 社区的用户，我希望在我关注的人的个人资料上看到行动号召，以便与他们开始/继续对话。 #1567](https://github.com/thepracticaldev/dev.to/issues/1567) 

    [![nickytonline avatar](../Images/849ad90a82f294a93718c2c4da688f82.png)](https://github.com/nickytonline) **[nickytonline](https://github.com/nickytonline)** posted on [<time datetime="2019-01-16T03:30:14Z">Jan 16, 2019</time>](https://github.com/thepracticaldev/dev.to/issues/1567)
    ...
    **附加上下文**在此添加关于功能请求的任何其他上下文或截图。
    ...
    [![image](../Images/f50d47c64811339a08fca227e2dba8fa.png)T2】](https://user-images.githubusercontent.com/833231/51224559-843ad800-1914-11e9-8d76-d0f655cfcc6a.png)
...
*   [@damian](https://dev.to/damian) 报告了一个评论在 Edge 中重叠的 bug。谢谢达米安。
    ...
    # [![GitHub logo](../Images/75095a8afc1e0f207cda715962e75c8d.png) 评论重叠在边缘 #1593](https://github.com/thepracticaldev/dev.to/issues/1593) 

    [![kingdamian42 avatar](../Images/cd2a6cea3e07afb44764a75cb0baab86.png)](https://github.com/kingdamian42) **[kingdamian42](https://github.com/kingdamian42)** posted on [<time datetime="2019-01-18T20:04:58Z">Jan 18, 2019</time>](https://github.com/thepracticaldev/dev.to/issues/1593)

...
> 原文:[https://dev.to/equinusocio/web-fonts-in-2018-321e](https://dev.to/equinusocio/web-fonts-in-2018-321e)
...
## [](#correct-fontface-declaration)正确的字体-字体声明
...
## [](#avoid-invisible-text-during-font-loading)字体加载时避免不可见文本
...
| 浏览器 | 字体未准备好时的默认行为… |
| --- | --- |
| ![Microsoft Edge](../Images/015f5d51cee1fbc937b86f35adef98c1.png "💩") | 使用系统字体，直到字体就绪。换出字体。 |
| ![Google Chrome](../Images/b2d2d10f72c045750010df2b2a1a68fe.png) | 将隐藏文字长达 3 秒钟。如果文本仍未准备好，则使用系统字体，直到字体准备好。换出字体。 |
| ![Firefox](../Images/47fb85644c9818046fd8c1f455ed578b.png) | 将隐藏文字长达 3 秒钟。如果文本仍未准备好，则使用系统字体，直到字体准备好。换出字体。 |
| ![Safari](../Images/b9811cf7fc3b33309c968e120da9c3d2.png "💩") | 在字体准备好之前隐藏文本。 |
...
**默认**
[![standard](../Images/13c7870c94edcf9fcce3b3e2f32a185b.png)](//images.ctfassets.net/gz0sygvqczyz/Jj9itpvLMI6WC2m0gGEy0/2aeaef6adc66f7f769e3e4e23cb68970/standard.png)

**优化**
[![opt](../Images/1ec2808389b7f12944d20ace28197b81.png)](//images.ctfassets.net/gz0sygvqczyz/12OTKvbLRyoEsYSq8KqcKe/96ded21bde16f3f2d94d32a76e3c9e7a/opt.png)

[![](../Images/4b1163453f28a9c108e3f827a7bc3b56.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--xq6TC9Xb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/opqw69peq0v7bve3jp1r.png)
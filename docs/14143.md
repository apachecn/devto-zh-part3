...
> 原文:[https://dev . to/cube js/building-MongoDB-dashboard-using-nodejs-409 l](https://dev.to/cubejs/building-mongodb-dashboard-using-nodejs-409l)
...
## [](#setting-up-mongodb-connector-for-bi)为 BI 设置 MongoDB 连接器
...
## [](#importing-test-dataset)导入测试数据集
...
## [](#spinning-up-cubejs-application)旋转起来的 Cube.js 应用
...
[![](../Images/8483cf536ea66f02aa9bbb53669c4ce3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--57ja1ZO8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://media.graphcms.com/oORb3acEQ7ahiKaQ4onH)

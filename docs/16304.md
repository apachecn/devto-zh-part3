...
> 原文:[https://dev.to/bananabrann/includes-for-noobs-41cc](https://dev.to/bananabrann/includes-for-noobs-41cc)
...
### [](#searching-within-arrays)**在数组内搜索**
...
### [](#tell-it-when-to-start)**告诉它什么时候开始**

##### [](#index-and-negative-index)**(指数和负指数)**

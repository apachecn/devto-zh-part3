...
> 原文:[https://dev . to/oktadev/use-angular-schematics-to-simplify-your-life-157 e](https://dev.to/oktadev/use-angular-schematics-to-simplify-your-life-157e)
...
## [](#use-schematics-to-add-authentication-to-your-angular-app)使用 Schematics 向您的 Angular 应用程序添加验证
...
## [](#angular-cli-angular-schematics-and-angular-devkit)角度 CLI、角度示意图和角度开发套件
...
## [](#create-your-first-schematic)创建您的第一个原理图
...
### [](#add-a-hello-world-example)添加一个 Hello World 示例
...
### [](#copy-and-manipulate-templates)复制和操作模板
...
### [](#run-your-schematics-with-angular-cli)使用 Angular CLI 运行原理图
...
### [](#publish-your-schematics-to-npm)将您的原理图发布到 npm
...
## [](#add-support-for-raw-ng-add-endraw-with-angular-cli)用 Angular CLI 添加对`ng add`的支持
...
## [](#learn-more-about-angular-and-schematics)了解更多关于角度和原理图

...
> 原文:[https://dev . to/mega 6382/MySQL-vs-mysqli-vs-PDO-performance-benchmark-difference-and-security-comparison-565 o](https://dev.to/mega6382/mysql-vs-mysqli-vs-pdo-performance-benchmark-difference-and-security-comparison-565o)

### [](#1-pdo-vs-mysqli-vs-mysql)1。PDO vs MySQL vs MySQL

### [](#2-difference-to-connect-using-mysqli-and-pdo)2。使用 MySQLi 和 PDO 连接的区别

### [](#3-pdo-vs-mysqli-vs-mysql-performance-benchmark)3。PDO vs MySQL vs MySQL 性能基准测试

### [](#4-pdo-vs-mysqli-security-using-prepared-statements)4。使用预准备语句的 PDO vs MySQL 安全

### [](#5-comparison-between-pdo-and-mysqli-terms-of-usage)5。PDO 和 MySQLi 使用条款的比较

### [](#6-converting-mysql-applications-to-use-pdo-or-mysqli)6。将 MySQL 应用程序转换为使用 PDO 或 MySQLi

### [](#7-package-recommendations-for-use-with-pdo-and-mysqli)7。用于 PDO 和 MySQLi 的软件包建议

### [](#8-what-to-use-in-a-new-project-pdo-or-mysqli)8。在新项目中使用什么:PDO 还是 MySQLi？

[![](../Images/d5520fa6bf7853b0e25661aac4b20e88.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--h0BgLvPq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/600/0%2AN884HE7J-twKG4zq.png)
...
### [](#3-pdo-vs-mysqli-security-using-prepared-statements)3。使用预准备语句的 PDO vs MySQL 安全
...
### [](#4-pdo-vs-mysqli-vs-mysql-performance-benchmark)4。PDO vs MySQL vs MySQL 性能基准测试

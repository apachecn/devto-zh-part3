...
> 原文:[https://dev . to/renegade coder 94/小心复制可变数据类型-2loa](https://dev.to/renegadecoder94/be-careful-when-copying-mutable-data-types-2loa)
...
### [](#copying-mutable-objects-in-python)在 Python 中复制可变对象

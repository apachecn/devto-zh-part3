...
> 原文:[https://dev . to/ccleary 00/should-you-log-the-express-req-object-and-external-API-responses-pj2](https://dev.to/ccleary00/should-you-log-the-express-req-object-and-external-api-responses-pj2)

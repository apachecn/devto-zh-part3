...
> 原文:[https://dev . to/fwuensche/say-goodbye-to-vim-work-in-the-cloud-using-vs-code-2jdm](https://dev.to/fwuensche/say-goodbye-to-vim-work-in-the-cloud-using-vs-code-2jdm)
...
#### [](#stepbystep-installation-mac)分步安装(Mac)
...
[![sshcode demo gif](../Images/0bf551df597f8b32e374180caf89881b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--msD7HUFm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://raw.githubusercontent.com/codercom/sshcode/master/demo.gif)

# [](#extra-tricks)额外招数

#### [](#open-an-specific-project)打开一个具体项目

您可以指定一个远程目录作为第二个参数:
`sshcode kyle@dev.kwc.io /root/www/doctolib`

#### [](#skip-extensions-sync)跳过扩展名同步

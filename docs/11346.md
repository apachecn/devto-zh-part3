...
> 原文:[https://dev . to/sanidz/angular-http-mock-interceptor-for-mock-back end-1h5g](https://dev.to/sanidz/angular-http-mock-interceptor-for-mocked-backend-1h5g)

# [](#skip-to-end-for-stackblitz-example)跳到 stackblitz 示例的结尾
...
# [](#implementation-with-mock)实现同模拟
...
## [](#1-httpmockrequestinterceptor)1。HttpMockRequestInterceptor
...
# [](#3-match-url-and-return-json)3 匹配 URL 并返回 JSON
...
## [](#4-load-mockinterceptor-with-startmock-script)4 用 start:mock 脚本加载 mockinterceptor

...
> 原文:[https://dev . to/software dot com/vs-code-settings-you-should-customize-5e 75](https://dev.to/softwaredotcom/vs-code-settings-you-should-customize-5e75)

VS Code 是一个高度可扩展的代码编辑器，拥有大量的扩展来增强你的工作流程。但是有许多现成的强大设置和定制，可以让 VS 代码更好地为您工作。

## [](#how-to-edit-your-settings)如何编辑您的设置
...
## [](#save-time-by-automatically-formatting-pasted-code)通过自动格式化粘贴的代码节省时间
...
## [](#save-even-more-time-by-automatically-formatting-on-save)保存时自动格式化，节省更多时间
...
## [](#make-code-more-concise-with-font-ligatures)用字体连字让代码更简洁
...
[![Fira Code](../Images/214e29a2efef7f49216c000aa3ddf513.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--uzH3ViYK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/tonsky/FiraCode/master/showcases/all_ligatures.png)

<figcaption>The ligatures available with Fira Code</figcaption>

</figure>

## [](#quickly-find-your-unsaved-work-by-highlighting-modified-tabs)通过高亮显示已修改的标签快速找到您未保存的工作
...
[![highlight modified tab](../Images/ad162467418a3c2153f0998d4be4311a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ess15JVS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/u6n0cp4x9bdsy7l5r8s6.png)
...
## [](#supercharge-the-file-explorer-by-sorting-your-files-by-type-or-recent-changes)通过按类型或最近更改对文件进行排序，增强文件浏览器的性能
...
## [](#change-things-up-by-customizing-your-cursor)通过定制光标改变事物
...
## [](#enter-a-new-line-without-accepting-a-suggestion)输入新的一行而不接受建议
...
## [](#save-your-settings-and-discover-other-features)保存您的设置并发现其他功能

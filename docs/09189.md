...
> 原文:[https://dev . to/web 3 coach/leveling-up-your-ssh-private-key-from-RSA-to-ed 25519-symmetric-password-protection-3175](https://dev.to/web3coach/levelling-up-your-ssh-private-key-from-rsa-to-ed25519--symmetric-password-protection---3175)
...
## [](#step-13-generate-a-new-ed25519-priv-key)第 1/3 步-生成新的 ED25519 Priv 密钥
...
## [](#step-23-configuring-ssh-agent)步骤 2/3 -配置 SSH 代理

连接到服务器，将新的本地公钥`cat ~/.ssh/id_ed25519_devto_tutorial.pub`的内容添加到服务器的`.ssh/authorized_keys`文件中，并删除旧的 RSA 密钥:

[![authorized_keys](../Images/0e28f57c0e4baab46f708d296659c85b.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--ARapDeZ0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://rablater.sirv.com/Images/DevTo/ecdsa_authorized_keys.jpg) 
...
## [](#step-33-dialing-the-connection)步骤 3/3 -拨号连接

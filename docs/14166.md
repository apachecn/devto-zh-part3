...
> 原文:[https://dev . to/kbild/use-AWS-code pipeline-to-automatically-deploy-your-Hugo-website-to-AWS-S3-7li](https://dev.to/kbild/use-aws-codepipeline-to-automatically-deploy-your-hugo-website-to-aws-s3-7li)

所以我现在有了一个 Hugo 网站，但是将生成的 HTML 文件部署到我的 AWS S3 桶，并使我的 AWS Cloudfront 部署无效是非常耗时的。

因此，我计划有一个 AWS 代码管道来帮助我完成这个过程。需要采取以下步骤:

[![AWS CodePipeline](../Images/1cc2b860236bb16e03dde6832e8c6c1d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vDumOiVl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://kbild.ch/201902/AWSCodePipeline01.png)
...
[![Which Docker Image](../Images/5585929fc29400c8dab180eb89be609e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--WlXmTFe3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://kbild.ch/201902/DockerImage.png)

这里我们将选择`Managed Image`，并将使用以下参数:

[![Image Settings](../Images/bf93dd0b7a976ec960bfa18d67405543.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--qxzAciTe--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://kbild.ch/201902/DockerImage02.png)
...
[![Build Action](../Images/8e12752a1f65c77a06ad198c4e634ccd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--rtxFEu7K--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://kbild.ch/201902/BuildAction.png)

在 GitHub Repo 上发布了一篇新的博客文章后，我们将看到我们的代码管道在全面运行:

[![Build Pipeline](../Images/29c9c775433643732f1b21d996971761.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--VhPsOl1a--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://kbild.ch/201902/Buildpipeline.png)

...
> 原文:[https://dev . to/azure/building-a-server less-IOT-solution-with-python-azure-functions-and-signalr-4ljp](https://dev.to/azure/building-a-serverless-iot-solution-with-python-azure-functions-and-signalr-4ljp)
...
[![solution overview](../Images/f5432a4a0ba5073c218539a8fd341b2b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ArEcQdSf--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gloveboxes/Go-Serverless-with-Python-Azure-Functions-and-SignalR/master/docs/resources/solution-architecture.png)
...
## [](#developing-python-azure-functions)开发 Python Azure 函数
...
[![](../Images/04c1449ea1b2e65599f1793ce9094b99.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--1sCJccYb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gloveboxes/Go-Serverless-with-Python-Azure-Functions-and-SignalR/master/docs/resources/service-side-signalr.png)
...
### [](#step-7-update-the-localsettingsjson)第七步:更新 local.settings.json
...
### [](#step-9-open-the-python-functions-project-with-visual-studio-code)第九步:用 Visual Studio 代码打开 Python 函数项目
...
### [](#step-10-update-the-localsettingsjson)第十步:更新 local.settings.json
...
### [](#step-11-deploy-the-python-azure-function)步骤 11:部署 Python Azure 功能
...
### [](#step-12-enable-static-websites-for-azure-storage)步骤 12:为 Azure 存储启用静态网站
...
### [](#step-13-enable-cors-for-the-signalr-net-core-azure-function)第十三步:使能信号员的 CORS。NET Core Azure 函数
...
### [](#step-14-start-the-dashboard)第十四步:启动仪表盘
...
[![dashboard](../Images/4f69350fb17061daadb2c80d486412f2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vg9eeqjs--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gloveboxes/Go-Serverless-with-Python-Azure-Functions-and-SignalR/master/docs/resources/dashboard.png)
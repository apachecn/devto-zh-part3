...
> 原文：<https://dev.to/shano/better-local-development-for-serverless-functions-52ah>

[![](img/2d085f9b769d4e38c4d8b8486cd4c91f.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--3wyPSeNC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AroedigbmFjRYkZobdZWuKg.jpeg)
...
Localstack 绝对是这里最大的银弹尝试。基本上，它在本地模拟了一大块 AWS，你可以将你的无服务器功能连接到其中。我没有使用它的原因:
...
对于任何亚马逊基础设施，我们将使用 [aws-sdk-mock](https://www.npmjs.com/package/aws-sdk-mock) 。这是一个围绕 [sinon](https://www.npmjs.com/package/sinon) 模仿 AWS 基础设施的优秀包装器，对于单元测试非常有用，稍后您将会看到。
...
现在，为了让我们的代码与内存中的 Mongo-DB 服务器集成，我们需要添加一些安装/拆卸函数和一个 Mongo 环境。克隆此[回购](https://github.com/vladgolubev/jest-mongodb)并放置:

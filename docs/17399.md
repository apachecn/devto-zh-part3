...
> 原文:[https://dev.to/ananyaneogi/observing-your-web-app-快速围捕-3ji0](https://dev.to/ananyaneogi/observing-your-web-app---a-quick-round-up-3ji0)

作为 web 开发人员，我们编写大量代码来检测 web 应用程序中的变化，并根据这些变化进行操作。今天，网络上有很多 API 可以*“观察”*你的网络应用程序的许多类型的变化，并让你基于这些变化执行操作。

这里有一个快速的总结-

## [](#1-observing-the-dom-through-event-listeners)1。通过事件监听器观察 DOM
...
## [](#2-check-for-dom-tree-modifications)2。检查 DOM 树修改
...
## [](#3-check-when-an-element-comes-into-view)3。检查元素何时进入视图
...
## [](#4-check-when-the-elements-in-dom-are-resized)4。检查 DOM 中的元素何时调整大小
...
## [](#5-check-if-your-web-app-is-on-fullscreen-mode)5。检查您的 web 应用程序是否处于全屏模式
...
## [](#6-check-if-the-tab-is-in-focus)6。检查选项卡是否在焦点上
...
## [](#7-check-for-device-orientation-changes)7。检查设备方向的变化
...
## [](#8-check-for-network-status-and-changes)8。检查网络状态和变化
...
## [](#9-check-status-of-the-device-battery)9。检查设备电池的状态
...
## [](#10-check-when-your-web-app-uses-a-deprecated-api-or-hits-a-browser-intervention)10。检查你的网络应用程序何时使用废弃的 API 或点击[浏览器干预](https://github.com/WICG/interventions)
...
## [](#11-check-the-performance-of-you-web-app)11。检查您的 web 应用程序的性能

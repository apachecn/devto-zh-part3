...
> 原文:[https://dev . to/ars waw/create-a-lightweight-componented-spa-without-node-569j](https://dev.to/arswaw/create-a-lightweight-componentized-spa-without-node-569j)
...
#### [](#step-1-creating-your-indexhtml-file)步骤 1 -创建您的 index.html 文件。
...
#### [](#step-2-app-entry-point-and-vue-integration)第二步——App 入口点，与 Vue 整合。
...
#### [](#step-3-adding-templates)第三步-添加模板。
...
#### [](#step-4-adding-components)第四步-添加组件。
...
#### [](#step-5-importing-our-components)步骤 5 -导入我们的组件。
...
#### [](#step-6-adding-routing)第六步-添加路由。

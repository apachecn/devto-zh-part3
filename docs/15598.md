...
> 原文:[https://dev.to/emgodev/less-really-is-more-1250](https://dev.to/emgodev/less-really-is-more-1250)

前几天，我开始使用 LESS，诚然，我不知道这不是萨斯/SCSS 的组成部分。我现在喜欢上它了。如果你用过 SASS，也许你知道为什么？或者也许我不知道如何使用 SASS？

# [](#a-few-things-about-sass)关于萨斯的几件事
...
# [](#how-is-less-awesome-in-my-opinion)怎么就没那么牛逼了(在我看来)？

...
> 原文:[https://dev . to/alvaromantoro/fix-85-of-your-web-accessibility-issues-in-5-easy-steps-pnf](https://dev.to/alvaromontoro/fix-85-of-your-web-accessibility-issues-in-5-easy-steps-pnf)
...
### [](#1-increase-text-color-contrast)1。增加文本颜色对比度

根据 WebAIM 的报告，文本对比度差是最常见的错误。平均而言，所分析的主页包含 36 个文本与其背景之间对比度不足的问题。

[![Examples of text contrast in a button](../Images/21a0e37f184cbeb645d260035c32211a.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--tD7GmCOR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/fup4n1sm04xzkpw3rskq.png) 
...
### [](#2-add-alternative-text-to-images)2。给图像添加可选文本
...
| ![](../Images/c7505949ec100538bb33f3d23dac5d52.png) | `alt="Guernica painting by Pablo Picasso"``alt="Guernica: a large oil painting by Spanish artist Pablo Picasso completed in June 1937"``alt=""` |
...
### [](#3-label-form-elements)3。标签表单元素
...
### [](#4-add-meaning-to-links)4。给链接添加意义
...
### [](#5-organize-content-correctly)5。正确组织内容

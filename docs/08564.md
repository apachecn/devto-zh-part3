...
> 原文:[https://dev . to/jlouzado/TDD-your-unit-tests-should-be-immutable-119m](https://dev.to/jlouzado/tdd-your-unit-tests-should-be-immutable-119m)
...
# [](#achieving-test-immutability)实现测试的不变性
...
### [](#use-terms-relevant-to-your-users)使用与你的用户相关的术语

*   坏:`$1.00 - $2000.00 = No Interest`
*   好:`Loans of $2000 and below are interest-free`

### [](#describe-expected-behaviour-in-the-test-name-rather-than-in-the-raw-expected-endraw-result)描述测试名称中的预期行为，而不是`expected`结果中的预期行为
...
## [](#single-assert-per-test)每次测试单个断言
...
## [](#dont-assert-on-an-object)不断言一个对象
...
## [](#manage-your-branches-well)管好你的分公司

...
> 原文:[https://dev . to/graphic beacon/build-we b-API-with-aqueduct-3-video-series-20go](https://dev.to/graphicbeacon/build-web-apis-with-aqueduct-3-video-series-20go)
...
## [](#what-are-serializable-objects)什么是可序列化对象？

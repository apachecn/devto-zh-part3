...
> 原文:[https://dev . to/alexsasharegan/pattern-matching-custom-data-types-in-typescript-4h 87](https://dev.to/alexsasharegan/pattern-matching-custom-data-types-in-typescript-4h87)
...
# [](#what-is-pattern-matching)什么是模式匹配？
...
## [](#pattern-matching-with-enums)模式匹配与枚举
...
# [](#applying-pattern-matching-in-typescript)在打字稿中应用模式匹配
...
## [](#step-2-discriminated-unions)第二步:有区别的联合
...
## [](#step-3-matcher-objects)第三步:匹配器对象
...
## [](#step-4-match-implementation)第四步:匹配实现

...
> 原文:[https://dev . to/iuriimednikov/a-small-introduction-to-Java-11-s-http client-nhj](https://dev.to/iuriimednikov/a-small-introduction-to-java-11-s-httpclient-nhj)
...
### [](#send-get-in-async-way)以异步方式发送获取
...
### [](#send-post-in-sync-way)以同步方式发送帖子
...
### [](#send-post-in-async-way)以异步方式发送帖子

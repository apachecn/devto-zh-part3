...
> 原文:[https://dev . to/nab bisen/ffmpeg-using-command-line-to-cut-out-video-files-1o3a](https://dev.to/nabbisen/ffmpeg-using-command-line-to-cut-out-video-files-1o3a)
...
##### [](#cutting-out-media-files)剪切出媒体文件

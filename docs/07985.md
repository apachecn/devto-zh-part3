...
> 原文:[https://dev . to/oieduardorabelo/JavaScript-eliminando-dependencias-circulares-3hcj](https://dev.to/oieduardorabelo/javascript-eliminando-dependencias-circulares-3hcj)
...
# [](#verificando-depend%C3%AAncias-circulares)检查循环相依性
...
[![Saída do `circular-dependency-plugin`](../Images/4498da6e21744dca55ddbf15bf6cc3fb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--PcXTfxT3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/mq8d5mw0oo2corq0low7.png)

# [](#corrigindo-as-depend%C3%AAncias-circulares)修正循环依赖关系

...
> 原文:[https://dev . to/jtenner/an-assembly script-primer-for-typescript-developers-lf1](https://dev.to/jtenner/an-assemblyscript-primer-for-typescript-developers-lf1)
...
## [](#how-to-use-assemblyscript)如何使用汇编脚本
...
## [](#consuming-the-assemblyscript-module)消耗 AssemblyScript 模块
...
## [](#the-assemblyscript-language)汇编脚本语言

### [](#assemblyscript-numbers)汇编脚本编号
...
### [](#assemblyscript-functions)汇编脚本函数
...
## ![GitHub logo](../Images/a73f630113876d78cff79f59c2125b24.png) [ WebAssembly ](https://github.com/WebAssembly) / [多值](https://github.com/WebAssembly/multi-value)

### 向 WebAssembly 添加多值的建议

<article class="markdown-body entry-content container-lg" itemprop="text">

[![Build Status](../Images/d71bd569a88c31ff0f38271c123c1274.png)T2】](https://travis-ci.org/WebAssembly/multi-value)
...
### [](#linking-to-javascript)链接到 Javascript

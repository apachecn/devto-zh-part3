...
> 原文:[https://dev . to/Alex MacArthur/quickly-spin-up-MySQL-w-docker-compose-4g 35](https://dev.to/alexmacarthur/quickly-spin-up-mysql-w-docker-compose-4g35)
...
## [](#running-commands-inside-container)容器内运行命令

要在运行容器中运行任何 Bash 命令，可以使用`docker-compose exec db bash`。

## [](#connecting-w-sequelpro-or-similar-tool)用 SequelPro 或类似工具连接

...
> 原文:[https://dev . to/melezhik/ssh-bulk-check-super-flexible-check-of-group-of-nodes-by-ssh-42ff](https://dev.to/melezhik/ssh-bulk-check-super-flexible-check-of-group-of-nodes-by-ssh-42ff)
...
# [](#install-sparrow6)安装 Sparrow6

`zef install https://github.com/melezhik/Sparrow6.git`

# [](#create-sparrow6-repository)创建 Sparrow6 存储库
...
# [](#sparrowdo-scenario)Sparrowdo 场景

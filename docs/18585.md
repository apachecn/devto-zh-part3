...
> 原文:[https://dev . to/Boris Zn/error-handling-and-validation-architecture-in-net-core-3lhe](https://dev.to/boriszn/error-handling-and-validation-architecture-in-net-core-3lhe)
...
[![alt text](../Images/52bc7946e49dcfa4c5fbc42af6886cb9.png "architecture")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--EdtpLUvA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2AZbQ2SaW7CUPHAMS83DAxgw.png)

验证和错误处理架构包含几个组件，我将在接下来的几个部分中描述它们。

## [](#api-validation-level)API 验证级别
...
## [](#business-layer-validation)业务层验证
...
## [](#exception-handling-middleware)异常处理中间件

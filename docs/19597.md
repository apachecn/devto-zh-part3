...
> 原文:[https://dev.to/martyhimmel/javascript-es5-objects-3cce](https://dev.to/martyhimmel/javascript-es5-objects-3cce)
...
## [](#creating-objects-with-constructor-functions)用构造函数创建对象

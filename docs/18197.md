...
> 原文:[https://dev . to/snowleo 208/how-to-create-your-instant-form-validation-39ek](https://dev.to/snowleo208/how-to-create-your-instant-form-validation-39ek)
...
我们今天要创造的:
[![alt="Our form with validation"](../Images/458306256ecb59f84b3e8ba94ad88aa6.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--VeE2At5h--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/soxmux2t9zcrcmdl97h2.jpg)

* * *

## [](#first-step-create-your-patterns)第一步:创建你的图案！
...
## [](#step-2-hide-the-error%C2%A0message)第二步:隐藏错误信息
...
## [](#step-3-trigger-the-error%C2%A0message)第三步:触发错误信息
...
## [](#step-4-instant-validation-is-coming%C2%A0yay)第四步:即时验证来了！耶！

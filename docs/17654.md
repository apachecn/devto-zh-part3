...
> 原文:[https://dev . to/kuba apk/image-processing-with-jimp-optional-methods-parameters-1k4i](https://dev.to/kubaapk/image-processing-with-jimp-optional-methods-parameters-1k4i)

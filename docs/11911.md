...
> 原文:[https://dev . to/hey Pieter/add-content-negotiation-to-website-when-using-nginx-4j 07](https://dev.to/heypieter/add-content-negotiation-to-website-when-using-nginx-4j07)
...
### [](#describing-a-person-via-html-and-rdf)通过 HTML 和 RDF 描述一个人
...
### [](#explaining-an-ontology-via-html-and-rdf)通过 HTML 和 RDF 解释本体

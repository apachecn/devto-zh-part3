...
> 原文：<https://dev.to/faizanbashir/building-python-data-science-container-usingdocker-3f8p>
...
2.  SciPy 为回归、最小化、傅立叶变换等提供了有用的函数。基于 NumPy，SciPy 扩展了它的功能。SciPy 的主要数据结构也是一个多维数组，由 Numpy 实现。该软件包包含的工具有助于解决线性代数，概率论，积分学，以及更多的任务。
3.  Pandas : Pandas 为操纵数据结构和执行广泛的数据分析提供了多功能和强大的工具。它可以很好地处理不完整、非结构化和无序的真实世界数据——并且附带了用于整形、聚合、分析和可视化数据集的工具。
...
> ## is small. Simple. Safe. Alpine Linux is a security-oriented lightweight Linux distribution based on musl libc and busybox.
...
提取图像后，您可以在 docker 文件中使用图像并扩展，或者在 docker-compose 或 stack 文件中用作图像。

* * *

# 余波

人工智能、人工智能的世界如今变得越来越令人兴奋，并将继续变得更加令人兴奋。大型企业正在这些领域大举投资。是时候开始利用数据的力量了，谁知道它会带来什么美妙的东西。

## ![](img/375dfcc32199b4dedf2b526645c27ff7.png) [费赞巴希尔](https://github.com/faizanbashir) / [ python-datascience](https://github.com/faizanbashir/python-datascience)

### 安装了 NumPy、SciPy、Scikit-learn、Matplotlib、nltk、pandas 包的 python datascience 容器的 Docker 映像。

<article class="markdown-body entry-content" itemprop="text">

Python 数据科学容器的 Docker 图像

</article>

[View on GitHub](https://github.com/faizanbashir/python-datascience)
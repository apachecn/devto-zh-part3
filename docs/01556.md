...
> 原文:[https://dev . to/krzysztofzuraw/typescript-function-overloads-1 IFF](https://dev.to/krzysztofzuraw/typescript-function-overloads-1iff)
...
你甚至可以看到这个函数被悬停过载:
[![Imgur](../Images/5acc9dc030c98246e93ba3688e53e953.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--42As3d7h--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/RrQOA0a.jpg)
...
### [](#function-overloads-in-class-methods)类方法中的函数重载

...
> 原文:[https://dev . to/decudio ly/how-I-emacs-and-so-can-you-packages-m9p](https://dev.to/deciduously/how-i-emacs-and-so-can-you-packages-m9p)
...
### [](#ivycounselswiper)常春藤/法律顾问/Swiper
...
### [](#interlude-wait-there-totally-are-modes)插曲:等等，总共有模式
...
## [](#languagespecific-packages)语言特定包

...
> 原文:[https://dev . to/thebrianemory/elixir-phoenix-how-I-turn-a-function-into-raw-SQL-and-then-into-an-ecto-query-995](https://dev.to/thebrianemory/elixir-phoenix-how-i-turned-a-function-into-raw-sql-and-then-into-an-ecto-query-995)
...
## [](#phase-1-build-a-working-function)阶段 1:构建工作函数
...
[![original function](../Images/40f331000557d62100a2a3f4c31cf7ae.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--5y6y7oxl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/z7ohvmqilu5uipjz0rgm.png)
...
## [](#phase-2-turning-it-into-a-sql%C2%A0query)阶段 2:将它转换成 SQL 查询
...
[![raw SQL](../Images/4f71e7cb6d2a0f48b1bcf08ec3b36213.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--zz6z6R55--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/cku2xczhuzdaddz6qluw.png)
...
[![refactored SQL](../Images/291c45bab9a7f8495373538bd179a54f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--7Sq3gIR2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/3v9ywj3eirc0jgmxrqby.png)

## [](#phase-3-turning-sql-into-ecto%C2%A0queries)第三阶段:将 SQL 转换成 Ecto 查询
...
[![refactored function](../Images/c8c0837e6c1c90b85656bf01a6f468b3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--XU9IvbGX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/cc2xef5kfalpxjvzz2oh.png)

这是我最初的解决方案。但是在 Twitter 上获得 SQL 建议后，我能够进一步重构，将函数简化为一个 Ecto 查询。

[![further refactoring](../Images/e52954f2dcd63a572fd56b935be75f6b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--t0MMkA-F--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ona2eh81apvqo3rusdw8.png)

...
> 原文:[https://dev . to/kin zal/aliases-convert-from-container-to-command-1839](https://dev.to/kinzal/aliases-convert-from-container-to-command-1839)
...
## [](#switch-the-version-of-the-command-to-execute)切换命令执行的版本
...
## [](#combine-multiple-containers-and-resolve-dependency-on-commands)组合多个容器并解决对命令的依赖
...
## [](#execute-on-circleci)在 CircleCI 上执行

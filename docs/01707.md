...
> 原文:[https://dev . to/yakimych/adding-reason ml-to-an-existing-code base-part-1-3kg](https://dev.to/yakimych/adding-reasonml-to-an-existing-codebase-part-1-3kkg)
...
## [](#step-2-calling-a-reasonml-function-from-javascript)第二步:从 JavaScript 调用 ReasonML 函数
...
[![Compilation on the fly](../Images/e8f1604ae4864cf6e2b2e5a3bd04ffd5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--BpaEn7Yu--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/vnuq44ze0c3ce9qslc9b.gif)

## [](#step-3-returning-a-record-from-reasonml)第三步:从 ReasonML 返回一条记录

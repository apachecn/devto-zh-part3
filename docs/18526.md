...
> 原文:[https://dev . to/hydro weaver/keras-opinion-analysis-in-from-the-book-in-plain-English-36hd](https://dev.to/hydroweaver/keras-sentiment-analysis-in-from-the-book-in-plain-english-36hd)

[![image](../Images/bd38b5e73425af5fbcb0ecbe2a8824bd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--gZpWXtN---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://upload.wikimedia.org/wikipedia/commons/c/c9/Keras_Logo.jpg)
...
[![image](../Images/4a29d3566e535c0c71656213eee34398.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--7ZvcYF_L--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/http://24.media.tumblr.com/eecfad666a96b0cb8442f40f9fd98fc5/tumblr_ms3u79OvgE1qc66bjo1_r1_500.gif)
...
### [](#training-and-testing-data)训练和测试数据？
...
### [](#not-all-comments-are-of-the-same-length-dude-amp-vectorize)不是所有评论都是一样长的哥们！&向量化
...
### [](#what-is-validation)什么是验证？

现在到了我们分割**训练**数据的时候了！是啊，但为什么要这么做？

什么是过剩或不足？

[![civic](../Images/1066b68a131f9a1e7034a1a30fce2077.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vstfFPUa--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://upload.wikimedia.org/wikipedia/commons/f/f0/04-05_Honda_Civic_LX_sedan.jpg)
...
### [](#where-is-the-machine-learning-in-all-this)这一切机器学习在哪里？
...
### [](#whats-an-activation-function)什么是激活函数？
...
### [](#hidden-layers-and-hidden-units)隐藏图层和隐藏单元？
...
[![model](../Images/30cae24a0e48ccde13d64dbcb220d2c0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--S15EOeXm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/oxz27vxtyy8bw11tjol2.png)
...
## [](#go-run-yourself-a-model-and-sorry-for-the-long-post)**自己去跑个模:)**又抱歉长文了！
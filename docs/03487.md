...
> 原文:[https://dev . to/michaeljolley/adding-command-aliases-to-powershell-1ip 4](https://dev.to/michaeljolley/adding-command-aliases-to-powershell-1ip4)
...
## [](#powershell-alias)PowerShell 别名

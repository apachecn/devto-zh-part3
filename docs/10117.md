...
> 原文:[https://dev.to/naufraghi/procedural-macro-in-rust-101-k3f](https://dev.to/naufraghi/procedural-macro-in-rust-101-k3f)
...
#### [](#iterator-based-implementation)基于迭代器的实现
...
# [](#modern-rust-raw-combinations-endraw-)【现代】锈`combinations()`
...
3.  再次由 DanielKeep，[锈宏的小本子:计数](https://danielkeep.github.io/tlborm/book/blk-counting.html)T2】↩

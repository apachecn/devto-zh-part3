...
> 原文:[https://dev . to/sobolevn/building-blanoble-working-environment-17hl](https://dev.to/sobolevn/building-blameless-working-environment--17hl)
...
[![Bugs everywhere](../Images/19f68a54fdd344a6318e8853c32a0e7d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ddTTV6cs--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/6pquqfacysta1rvvafzs.jpg)

因此，我们必须准备好处理这种情况。我们必须创建一套有效的规则和实践来避免可能的错误，并处理那些我们未能及早发现的错误。

但是怎么做呢？

## [](#small-tasks-and-clear-scopes)小任务，明确范围
...
[![1000 lines to review](../Images/e392d23cb10e305c5a1981be8050c38d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--2UFRyhzh--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/cck8gyl3ccz8p5qojdh9.png)

我坚持认为，任务应该很小(不超过 4 小时)，应该有一个明确的范围。拥有五个明确定义的小任务比一个大任务要好。

[![100 lines to review](../Images/af08e988fc1744da0a29ac42081f2dc3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--iBQsAMYO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/q1m302fa1liwuewvy4tt.png)

这降低了误解的可能性。并允许双方轻松跟踪进度、控制截止日期和感受项目的脉搏。

## [](#make-your-ci-as-strict-as-possible)让你的 CI 尽可能的严格

越早发现代码中的错误，对项目越有利。这个图表说明了允许 bug 流入产品的成本(在时间和金钱方面)有多高。

[![Error cost](../Images/611f303d6a72a176055cb67bf3f8a3d6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--sG0_R0Sn--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/uuq2isu4i4y040tx277n.png)

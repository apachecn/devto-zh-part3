...
> 原文:[https://dev.to/awwsmm/roastmysetup-3o0j](https://dev.to/awwsmm/roastmysetup-3o0j)
...
### [](#jvm-management-ampamp-git-ampamp-homebrew)JVM 管理(& & Git & &家酿)
...
### [](#markdown-plaintext-editors)降价/明文编辑
...
### [](#nonjvm-programming-languages)非 JVM 编程语言

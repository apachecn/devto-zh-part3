...
> 原文:[https://dev.to/samthor/webgl-point-sprites-a-tutorial-4m6p](https://dev.to/samthor/webgl-point-sprites-a-tutorial-4m6p)
...
[![Triangle vs points](../Images/39547db78e0dd958a39b957940e74a3e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Gw3K49ge--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/jmzvzpoxee5mhfxbpqbp.png)

所以记住方法，让我们开始吧！🌈

# [](#tutorial)教程

## [](#step-0-get-a-rendering-context)第 0 步:获取渲染上下文
...
## [](#step-1-create-a-shader-program)第一步:创建着色器程序
...
## [](#step-2-compile-the-shader-program)第二步:编译着色器程序
...
## [](#step-3-upload-variables)第三步:上传变量

...
> 原文:[https://dev . to/solace devs/Alibaba-cloud-a-data-driven-analysis-41ci](https://dev.to/solacedevs/alibaba-cloud-a-data-driven-analysis-41ci)

### [](#alibaba-cloud%E2%80%8A%E2%80%8Aa-datadriven-analysis)阿里云——数据驱动的分析

<figure>[![](../Images/29c42fd6a73c60d141416f16148991b5.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--8ZohY121--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/946/1%2AffZ01s3Hwm0NwZkKkLytOw.png) 
...
### [](#gt-whats-all-the-hype-with-alibaba)**>阿里巴巴的炒作是怎么回事？**
...
### [](#gt-alibaba-cloud-launches-london-uk-region)**>阿里云推出英国伦敦地区**

上月，阿里巴巴高调地为其全球数据中心网络增加了一个英国“区域”:

<figure>[![](../Images/004971b1253ad8ec730d9bbbf370738e.png)](http://www.alibabacloud.com/event/london-2018) 
...
#### [](#yay-or-nay-for-brexit)**英国退出欧盟赞成还是反对？**

我发现有趣的是，虽然这个新地区表面上被称为“英国(伦敦)”，但实际上是这样的:

<figure>[![](../Images/2332c5c4f6d51be4c10d7e198b137e04.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--6wp5N9uO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2A5lGL6Iw8nWKg90FYUKJ82A.png) 
...
<figure>[![](../Images/11433068c3f0c6702a92bffdd1b86fe0.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--xULgrFZL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AY-f5FmQw3mf-qN0GA7KGvQ.png) 
...
### [](#gt-how-can-we-fairly-compare-alibaba-cloud-with-the-big-three-aws-azure-and-google)**>如何才能公平地将阿里云与三巨头相比较？(AWS、Azure 和谷歌)**
...
#### [](#show-me-the-money)**把钱拿出来。**

这种多云和多区域设置的直观结果示例如下:

<figure>[![](../Images/2a67696eb29cb32e396b43a02dd3e0fc.png)](http://london.solace.com/multi-cloud/arbitrage.html) 
...
#### [](#just-deploy-it-already)**刚刚已经部署好了！**

事实证明，将 Java 应用程序和 Solace PubSub+ Broker 部署到阿里云相当简单。跨四种云选择的等效虚拟机类型和区域可在下面查看:

<figure>[![](../Images/c0e93e9cad848e08cbea21b9e1d88104.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--I2fDxHHv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AQjw8X935lXj8xJJa8UrQtw.png) 

<figcaption>等效虚拟机大小和地区选择(AWS、Azure、Google 和 Alibaba)</figcaption>

</figure>

### [](#gt-the-internet-has-a-personality-too)**>互联网也有个性……**

英国阿里巴巴的结果显示，响应返回 Solace 内部数据中心大约需要 73 毫秒。这个延迟数字非常奇怪，因为它与其他三个云中从美国地区收到的响应的延迟相当，所以我最初的想法是，我一定是在错误的地方为阿里巴巴部署了“英国”虚拟机！

<figure>[![](../Images/58d95e8f2d701ecc2c13606e8f11f200.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--2B_T8vrT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/658/1%2Aqj_XSyYqQspWo3OIBBfA9A.png) 
...
#### [](#london-to-london-the-scenic-route)**伦敦到伦敦，风景优美的路线。**

<figure>[![](../Images/452a64a6d038f28364e4bda1df52d48f.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--Z1U_OuDZ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AoixwOel6vTz36MbaUjA3EA.png) 
...
<figure>[![](../Images/e46fbd230b9b8ce48043a0e4d8894d58.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--fely-ht2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AcOfQhkkQzWWF6Hz_6rtxjg.png)
...
#### [](#show-me-the-way-to-alibaba)**告诉我去阿里巴巴的路。**
...
#### [](#keeping-an-eye-on-the-mileage)**紧盯里程。**
...
### [](#gt-so-how-does-alibaba-compare)**>那么阿里巴巴如何比较呢？**
...
<figure>[![](../Images/dfaf012a9c6a751a5759eb8375a7391f.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--pan3WPnj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn-images-1.medium.com/max/587/1%2AIe8WV-CMU480uVcuQTHYOg.gif) 
...
#### [](#ladies-and-gentlemen-place-your-bets)**各位，下注吧。**
...
<figure>[![](../Images/6851cd46cf96935fa0f260446d8a5780.png)](http://london.solace.com/multi-cloud/arbitrage.html) 
...
[![](../Images/48517a56378719e752501b9bbec24883.png)T2】](http://dilbert.com/strip/2009-11-18)
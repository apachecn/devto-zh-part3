...
> 原文:[https://dev . to/chaseadamsio/share-specific-lines-in-a-markdown-file-with-github-4ff 0](https://dev.to/chaseadamsio/share-specific-lines-in-a-markdown-file-with-github-4ff0)
...
## [](#sharing-a-line-with-github-ui)与 GitHub UI 共享一行
...
[![GitHub rendered README.md](../Images/528d5051f6046e28f155efcec1f50269.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--stLIzVcP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://chaseonsoftware.com/img/gh-md-readme-view.png)

对于我们的例子，我们想要共享的 Markdown 文件的部分是“单行注释以#或//”开始，正如你所看到的，从这个视图中没有办法做到这一点。

**为了选择特定的行，我们将使用责备视图。**点击内容视图右上角的**责备**按钮:

[![GitHub button for Blame for README.md](../Images/42c5022d1bc04b1dc3b6fc1cbe2f62c2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--L2UbBs_8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://chaseonsoftware.com/img/gh-md-blame.png)
...
## [](#sharing-multiple-lines-with-github-ui)与 GitHub UI 共享多行
...
## [](#for-github-if-youre-listening)对于 GitHub，如果你在听的话...

你已经用 GitHub 动作搞定了这个 UI，所以如果你正在寻找小的容易的胜利，考虑为渲染的 blob 和源 blob 应用切换器:

[![GitHub rendered README.md](../Images/7d9a0a47de0319104e727eecd076d894.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--c7BjzL9U--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://chaseonsoftware.com/img/gh-md-better-buttons.png)

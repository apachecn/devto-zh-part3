...
> 原文:[https://dev . to/oscheller/changing-the-MySQL-root-user-from-auth socket-to-password-authentic ation-using-ansi ble-3l5m](https://dev.to/oscherler/changing-the-mysql-root-user-from-authsocket-to-password-authentication-using-ansible-3l5m)

...
> 原文:[https://dev.to/baens/dockerize-the-kotlin-toolchain-1d0m](https://dev.to/baens/dockerize-the-kotlin-toolchain-1d0m)
...
# [](#step-1-getting-the-basic-build-working)第一步:让基本构建工作起来
...
# [](#step-2-put-into-jar-into-docker)第二步:将罐子放入对接器
...
# [](#step-3-build-time-improvements)第三步:构建时间改进
...
# [](#step-4-profit-evaluating-if-this-is-practical)第四步:.....利润？？....评估这是否可行

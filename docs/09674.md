...
> 原文:[https://dev . to/azure/how-do-you-structure-your-code-when-move-your-API-from-express-to-server less-functions-30bc](https://dev.to/azure/how-do-you-structure-your-code-when-moving-your-api-from-express-to-serverless-functions-30bc)
...
[![heroes-serverless API folder structure](../Images/4e3224d9d1f4e3a309b3703fe6912447.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--U2Hl_SQw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/07y8kaeg3k6g0gnw2kgo.png)

## [](#your-entry-point)你的切入点
...
## [](#shared-database-module)共享数据库模块

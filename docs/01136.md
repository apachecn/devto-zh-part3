...
> 原文:[https://dev . to/concat ly/how-to-deploy-a-dockerize-a-basic-PHP-application-4756](https://dev.to/concatly/how-to-deploy-a-dockerize-a-basic-php-application-4756)

# Docker 是什么？

Docker 是一个工具，旨在通过使用容器来简化应用程序的创建、部署和运行。容器允许开发人员将应用程序与它需要的所有部分打包在一起，比如库和其他依赖项，然后作为一个包发送出去。

# [](#steps-for-dockerizing-a-basic-php-application)一个基本 PHP 应用程序的 Dockerizing 步骤

## [](#files-required-for-setup)设置所需的文件

...
> 原文:[https://dev . to/adityasridhar/what-a-mutation-in-graph QL-and-how-to-use-it-2on 0](https://dev.to/adityasridhar/what-is-a-mutation-in-graphql-and-how-to-use-it-2on0)
...
## [](#how-is-mutation-and-query-different)突变和查询有什么不同？
...
### [](#resolve-function-of-a-mutation)解析突变功能
...
## [](#testing-the-mutation-end-points)测试突变结束点
...
### [](#test-addmovie-mutation-endpoint)测试 addMovie 突变终点
...
### [](#test-adddirector-mutation-endpoint)测试 addDirector 突变终点

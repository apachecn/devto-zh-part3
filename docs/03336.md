...
> 原文:[https://dev . to/yerac/un shelving-TFS-changes-into-another-branch-vs-2017-4kip](https://dev.to/yerac/unshelving-tfs-changes-into-another-branch-vs-2017-4kip)
...
## [](#adding-visual-studio-command-prompt-to-visual-studio)向 Visual Studio 添加 Visual Studio 命令提示符
...
<figure>[![](../Images/dac4d56bafc5a3058182f19b8d4c10e4.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--etivKavm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i1.wp.com/yer.ac/blog/wp-content/uploads/2019/05/image-1.png%3Ffit%3D700%252C407) 
...
## [](#item-could-not-be-found-in-your-workspace-or-you-do-not-have-permission-to-access-it-)*"在您的工作区中找不到项目，或者您没有权限访问它。*

<figure>[!["Item could not be found in your workspace, or you do not have permission to access it.](../Images/39c675b6a71e46596cd5a86af6137594.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--UV2qI3mZ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i2.wp.com/yer.ac/blog/wp-content/uploads/2019/05/image-2.png%3Fw%3D840) 
...
## [](#bonus-round-unshelving-another-users-shelveset-into-another-branch)奖励回合:将另一个用户搁置集解除搁置到另一个分支

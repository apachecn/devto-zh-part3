...
> 原文:[https://dev . to/oktadev/build-a-basic-app-with-spring-boot-and-JPA-using-PostgreSQL-ke9](https://dev.to/oktadev/build-a-basic-app-with-spring-boot-and-jpa-using-postgresql-ke9)
...
## [](#install-postgresql-for-jpa-persistence)为 JPA 持久化安装 PostgreSQL
...
## [](#create-a-postgresql-database-for-your-jpa-entities)为你的 JPA 实体创建一个 PostgreSQL 数据库
...
### [](#give-the-user-a-password)给用户一个密码
...
## [](#build-a-spring-boot-resource-server)搭建 Spring Boot 资源服务器
...
## [](#add-a-domain-class-with-spring-data-and-jpa)用 Spring 数据和 JPA 添加一个域类
...
## [](#implement-a-crud-repository-with-spring-data-jpa)用 Spring 数据 JPA 实现一个 CRUD 库
...
## [](#test-your-spring-boot-resource-server)测试你的 Spring Boot 资源服务器
...
## [](#test-the-protected-spring-boot-server)测试受保护的 Spring Boot 服务器
...
## [](#generate-an-access-token)生成一个访问令牌
...
## [](#add-groupbased-authorization)添加集团授权
 ...
 **## [](#test-the-admin-user-in-your-spring-boot-app)在你的 Spring Boot 应用中测试管理员用户
...
## [](#create-a-nonadmin-user)创建非管理员用户
...
## [](#test-groupbased-authorization-in-your-spring-boot-app)在您的 Spring Boot 应用中测试基于组的授权
...
## [](#learn-more-about-spring-boot-spring-security-and-secure-authentication)了解有关 Spring Boot、Spring Security 和安全认证的更多信息

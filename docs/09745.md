...
> 原文:[https://dev . to/lennythedev/quick-server-with-node-and-express-in-5-minutes-17m 7](https://dev.to/lennythedev/quick-server-with-node-and-express-in-5-minutes-17m7)

我知道，我知道...另一个节点快速教程😑。但是如果你还没有开始学习 Node 和构建服务器，也许这个超级快速的教程就是你所期待的！😆

# [](#step-1-install-node)第一步:安装节点
...
# [](#step-3-install-and-import-express-middleware)第三步:安装导入快递中间件
...
# [](#step-4-add-a-json-route-handler)第四步:添加一个 JSON **路由处理器**
...
# [](#step-5-add-a-html-route-handler)第五步:添加一个 HTML **路由处理程序**
...
[![hackerman](../Images/5c23b90c9623adc400bed01450015661.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--4zfiGmp3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ypqz165i5f8sb44w8iji.png)
...
## [](#okay-that-was-nice-but-what-can-i-do-with-this-)“好的，很好。但是我能用这个做什么呢？”

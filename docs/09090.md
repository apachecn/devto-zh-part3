...
> 原文:[https://dev . to/oktadev/build-a-crud-app-with-ASP-net-core-and-typescript-1l 53](https://dev.to/oktadev/build-a-crud-app-with-asp-net-core-and-typescript-1l53)
...
## [](#create-an-aspnet-mvc-project)创建一个 ASP.NET MVC 项目
...
## [](#build-a-crud-app-with-aspnet-core)用 ASP.NET 核心打造 CRUD App
...
## [](#typescript-spambot-check-for-your-aspnet-core-app)为你的 ASP.NET 核心应用键入垃圾邮件-Bot 检查
...
## [](#add-the-typescript-spambot-check-to-your-aspnet-core-app)将 TypeScript SpamBot 检查添加到您的 ASP.NET 核心应用程序
...
## [](#secure-your-aspnet-core-typescript-application)保护您的 ASP.NET 核心+打字稿应用
...
[![Okta sign in](../Images/bcb7320bd132ef04c0572042b74ff885.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--hRP6TXwa--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://developer.okta.com/assets-jekyll/blog/netcore-typescript/okta-sign-in-80edc74df26ec008acba6586b26441475f778f05e21047d49504b3e5ac8462e8.png)

## [](#add-sign-in-and-sign-out-links-to-your-aspnet-core-mvc-typescript-application)为您的 ASP.NET 核心 MVC + TypeScript 应用程序添加登录和注销链接
...
[![Signed in](../Images/ff46e4b82a14e7dfbfab1c93da68c416.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--0NJBr8SV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://developer.okta.com/assets-jekyll/blog/netcore-typescript/signed-in-32ce1c0a8bd2a5fe2ef1b064721300f9372251db8553d45b027f55f5e0a4e0f2.png)

确保可以登录和退出后，就大功告成了！

## [](#learn-more-about-aspnet-core-crud-apps-and-typescript)了解更多关于 ASP.NET 核心 CRUD 应用和 TypeScript 的信息

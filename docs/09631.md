...
> 原文:[https://dev.to/swyx/unsupervised-learning-clustering-42mi](https://dev.to/swyx/unsupervised-learning-clustering-42mi)
...
[![https://upload.wikimedia.org/wikipedia/commons/thumb/0/09/ClusterAnalysis_Mouse.svg/450px-ClusterAnalysis_Mouse.svg.png](../Images/a56745c0935bec0c73d9d9c35cae1a3f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--zhY6Fone--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://upload.wikimedia.org/wikipedia/commons/thumb/0/09/ClusterAnalysis_Mouse.svg/450px-ClusterAnalysis_Mouse.svg.png)

## [](#defining-the-basic-clustering-problem)定义基本聚类问题
...
## [](#single-linkage-clustering)单个联动聚类
...
## [](#soft-clustering-best-also-known-as-expectation-maximization-or-gaussian-mixing)软聚类(最好！)也称为期望最大化或高斯混合
...
## [](#practical-issue-picking-raw-k-endraw-elbows-silhouettes-and-more)实用问题:挑选`k`:手肘、轮廓等等

虽然你可以依靠领域知识来选择`k`，但是有算法可以帮助选择[“肘”，即在集群数量与解释能力](https://en.wikipedia.org/wiki/Elbow_method_%28clustering%29)之间权衡的“最佳”点。

[![https://upload.wikimedia.org/wikipedia/commons/c/cd/DataClustering_ElbowCriterion.JPG](../Images/4131e0814d14f34d83f64603d64ab09b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9HDCgl_f--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://upload.wikimedia.org/wikipedia/commons/c/cd/DataClustering_ElbowCriterion.JPG)
...
## [](#practical-issue-visualizing-clusters)实际问题:可视化集群
...
## [](#theoretical-aside-kleinberg-impossibility-theorem)(撇开理论不谈)克莱因伯格不可能定理

...
> 原文:[https://dev . to/sirtimbly/develop-front-end-code-with-a-real-rest-API-with-with-non-down-to-ask-for-back-end-development-377j](https://dev.to/sirtimbly/develop-front-end-code-with-a-real-rest-api-without-slowing-down-to-ask-for-back-end-development-377j)
...
## [](#getting-typescript-definitions-for-you-strapi-schemas)为您的 Strapi 模式获取类型脚本定义

...
> 原文:[https://dev . to/drumusician/things-you-could-do-with-mix-2pe 0](https://dev.to/drumusician/things-you-could-do-with-mix-2pe0)

## [](#things-you-could-do-with-mix)用 mix 可以做的事情

### [](#part-2-passing-arguments)第二部分:传递参数

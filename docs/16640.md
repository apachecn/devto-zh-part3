...
> 原文:[https://dev . to/seankilleen/how-to-forward-a-long-conference-number-using-twilio-2o4n](https://dev.to/seankilleen/how-to-forward-to-a-long-conference-number-using-twilio-2o4n)
...
## [](#the-solution-enter-twilio-amp-twiml-bins)解决方案:输入 Twilio&TwiML bin

语音&短信平台 Twilio 为这类解决方案提供了强大且经济高效的支持。

在本文中，我们将一步一步地介绍如何使用 Twilio 为会议电话设置转发。

## [](#the-overview-how-it-works)概述:工作原理
...
## [](#how-to-set-up-a-twiml-bin-for-conference-line-forwarding)如何设置会议线路转发的 TwiML bin

下面我们将一步一步地介绍这个过程。

你可以通过[https://www.twilio.com/try-twilio](https://www.twilio.com/try-twilio)使用免费账户加入 Twilio，但你可能需要注册一个付费账户，添加支付信息等。

### [](#buying-a-twilio-number)购买 Twilio 号码
...
#### [](#adding-and-examinig-the-twiml)添加和检查 TwiML
...
#### [](#associating-the-twiml-bin-with-the-phone-number)将 TwiML bin 与电话号码关联

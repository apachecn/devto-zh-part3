...
> 原文:[https://dev . to/Stephen Weiss/postman-uri-encoding-and-occams-razor-1 kik](https://dev.to/stephencweiss/postman-uri-encoding-and-occams-razor-1kik)
...
# [](#background-and-how-i-initially-suspected-uri-encoding)我最初怀疑 URI 的背景和编码
...
<figure>[![BBB API Instructions](../Images/7c13f732d36a8fda84b23f47a2b6c8fe.png)](https://i0.wp.com/www.stephencharlesweiss.com/wp-content/uploads/2018/12/BBB-API-Instructions.png?ssl=1) 
...
[![Postman Header Config](../Images/1476e8659af699b25e9cc7f9e9882ef0.png)T2】](https://i0.wp.com/www.stephencharlesweiss.com/wp-content/uploads/2018/12/Postman-Header-Config.png?ssl=1)

设置好标题后，我移动到主体上，并(几乎)完全按照说明进行操作！但是正如下面的屏幕截图所示，我在行尾留下了一个空格或者一个换行符。事实证明——这很重要。那是我开始得到`400 Bad Request`错误的时候。

[![Postman Body Config With Errors](../Images/d44daf8e1b0e17fd6a3a11be5ba49886.png)T2】](https://i2.wp.com/www.stephencharlesweiss.com/wp-content/uploads/2018/12/Postman-Body-Config-With-Errors.png?ssl=1)
...
[![Postman Body Config Success](../Images/72d80e00c8b8b83546ee375fb0030f51.png)T2】](https://i2.wp.com/www.stephencharlesweiss.com/wp-content/uploads/2018/12/Postman-Body-Config-Success.png?ssl=1)
...
## [](#disproving-a-bad-theory)驳斥不好的理论
...
<figure>[![Two way URL Encoding](../Images/9746dfaf65ef584e302f6ef75c6fbbf4.png)](https://i0.wp.com/media.giphy.com/media/1ziDlkSSPJ8yLRvUvU/giphy.gif?ssl=1) 

...
[![](../Images/86955c1ce32cef65d1fa314bb8e0e196.png)T2】](https://skillsandmore.org/introduzione-terminale/)
...
## [](#che-cosa-%C3%A8-un-terminale)什么是终端？
...
[![](../Images/b7e0399c794276e17da374fc8e0fb2d4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--mrxFTUPK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://skillsandmore.org/wp-content/uploads/2019/02/operazioni-terminale.jpg)
...
[![Investi in te stesso e diventa uno Skillato oggi!](../Images/fb8b34bb8a735accf5af8605b9890826.png)T2】](https://skillsandmore.org/diventa-uno-skillato/)

## [](#primi-comandi-da-terminale)首个终端命令
...
[![Impostazioni base del terminale](../Images/cecc23a241d9a55448c8c1a9cb99a973.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--nI5AqE0N--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://skillsandmore.org/wp-content/uploads/2018/12/terminal-basic.gif)
...
### [](#muoviti-tra-file-e-cartelle)在文件和文件夹之间移动
...
[![pwd, ls, cd sono i comandi fondamentali per muoversi all'interno del nostro computer con il terminale.](../Images/b61c9e5c8a68155bcf79ba7500d2bd7c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--4xl_HbO---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://skillsandmore.org/wp-content/uploads/2019/02/comandi-fondamentali-terminale.jpg)

在本文的结尾，我会列举一些其他非常有用的命令，但现在是时候采取实际行动了。

### [](#caso-duso-per-i-comandi-principali-del-terminale)案例对终端主指令
...
## [](#caratteri-speciali-opzioni-e-consigli-utili)有用的特殊字符、选项和提示
...
[![Il terminale automatizza molti compiti ma è anche pericoloso! È bene conoscere i suoi segreti](../Images/60255cc351b27e2abec35bc0a92dbf09.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--5iRuSxkR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://skillsandmore.org/wp-content/uploads/2019/02/segreti-terminale.jpg)
...
[![Mostro il manuale del comando ls ottenuto digitando man ls all'interno del terminale.](../Images/a3b8ca3c5996737a4295b09e56dde197.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--W1CzbQ24--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://skillsandmore.org/wp-content/uploads/2019/02/man-ls.png)
...
### [](#le-opzioni-di-un-comando)命令的选项
...
[![Il risultato del comando ls eseguito da terminale.](../Images/06d5673e02445746d80f134c75f91417.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--cQEyIwkM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://skillsandmore.org/wp-content/uploads/2019/02/ls-al.png)
...
## [](#piccoli-esempi-in-cui-%C3%A8-utile-conoscere-il-terminale)了解终端有用的小例子

在这最后一节中，我想给大家看一些终端知识简化了我们作为开发者的生活的实际例子。

[![Quattro esempi per scoprire che il terminale vince 10 - 1 contro qualsiasi applicazione con GUI](../Images/4ef5e0e0269f995e3cdbc0b8f60c2c92.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--0hnuhNPq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://skillsandmore.org/wp-content/uploads/2019/02/esempi-terminale.jpg)

终端被证明是最好的工具的案例数以千计，在很多情况下是可以使用的工具。

### [](#creazione-di-uno-script-bash)创建 Bash 脚本
...
### [](#avviare-un-preprocessore-css)启动 CSS 预处理程序
...
[![](../Images/4f8604de68159ff716fee99f1503d1e9.png)T2】](https://skillsandmore.org/corso-sass)

如果您想知道如何配置您的开发环境以利用 Gulp 评论这篇文章或订阅我们的时事通讯，无论哪种情况，我都会联系您，让您知道我何时将发表关于这一强大任务执行者的文章！

### [](#connettersi-a-un-server-remoto)连接到远程服务器
...
### [](#modificare-un-database-wordpress)修改 WordPress 数据库

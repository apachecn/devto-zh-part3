...
> 原文:[https://dev . to/mkrl/JavaScript-quirks-in-one-image-from-the-internet-52m 7](https://dev.to/mkrl/javascript-quirks-in-one-image-from-the-internet-52m7)

最近我在谷歌图片上偶然发现了这张照片:

[![Thanks for inventing JavaScript](../Images/1a0550a970653b4d9be32b0b25e32f09.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Ysm3UtDq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4n583bhdqnz03mq3t13v.png)
...
#### [](#not-a-number-is-a-number)不是数就是数
...
#### [](#mathmax-lt-mathmin-)Math.max() < Math.min()？

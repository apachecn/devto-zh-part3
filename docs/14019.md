...
> 原文:[https://dev . to/cmiles 74/provision-programmably-with-cloud formation-finally-some-instances-2d ha](https://dev.to/cmiles74/provision-programmatically-with-cloudformation-finally-some-instances-2dha)

[![CloudFormation Diagram](../Images/be30118700265c6300c0423ae70b21dd.png "Diagram of our CloudFormation Tutorial Stack")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--77I3zfP1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/cmiles74/cloudformation-tutorial/master/template-diagram-2.png)
...
## [](#setup-an-admininstrators-group)设置“管理员”组
...
### [](#setup-a-role-for-our-instances)为我们的实例设置角色
...
### [](#provision-cloudwatch-log-groups)调配 CloudWatch 日志组
...
### [](#provision-the-database-server)调配数据库服务器
...
## [](#set-alarms-on-instance-usage)设置实例使用警报

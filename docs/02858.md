...
> 原文:[https://dev . to/particle/learn-how-to-build-this-cellular-asset-tracker-with a-particle-boron-519h](https://dev.to/particle/learn-how-to-build-this-cellular-asset-tracker-with-a-particle-boron-519h)
...
## [](#project-parts-amp-tools)项目部件&工具

[![](../Images/b081c41b2134267904487a5a9acb3b1b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--C9GTirHt--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.particle.io/wp-content/uploads/2019/05/conclusion-169-crop-1024x576.jpg)
...
## [](#step-1-soldering-the-headers)第一步。焊接接头

这个项目中的一些羽状翼需要你将插头焊接到电路板上。以保持头部与电路板垂直。将它们放在一个备用的试验板上，要添加管脚的板放在上面。这将有助于您获得正确的对齐，并且在零件牢固就位的情况下进行焊接会更加方便。

<figure>[![](../Images/b5d2b32c6070361731f1a97fd7cce21e.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--Cfls_GIr--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.particle.io/wp-content/uploads/2019/05/soldering-oled.jpg) 
...
<figure>[![](../Images/de14138cba5d50ed0400a3f03ca41c06.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--TrBIxkIL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.particle.io/wp-content/uploads/2019/05/soldering-tripler.jpg) 

<figcaption>焊接三倍增器不需要帮手，但需要一双稳定的手。</figcaption>

</figure>

## [](#step-2-assembling-your-featherwings)第二步。组装你的羽翼
...
## [](#step-3-lasercut-your-enclosure-or-build-your-own)第三步。激光切割您的外壳或构建您自己的外壳

[![](../Images/89c6415c357825f2058038fb4d2ca14a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--wkmirxrH--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.particle.io/wp-content/uploads/2019/05/enclosure-crop-1024x768.jpg)

如果您已经制作或购买了一个附件，现在就可以开始在里面安装项目了。

## [](#navigating-the-boron-asset-tracker-source-code)导航硼资产跟踪器源代码
...
[![](../Images/1a386e68cd2d349d3e7721dd05750d7f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--RM0nKfa_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.particle.io/wp-content/uploads/2019/05/Tracker-hero.jpg)
...
## [](#code-highlights-and-commentary)代码集锦和注释
...
## [](#visualizing-your-data-with-ubidots)使用 Ubidots 可视化您的数据

[![](../Images/8c9b906f93494d523bd4348fc637570f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---_ZBAwgO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.particle.io/wp-content/uploads/2019/05/ubidots-map.jpg)
...
[![](../Images/7c0d8f856390acb0787a545d2cd6fcb9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--XoMgoYTS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.particle.io/wp-content/uploads/2019/05/ubidots-config-crop.jpg)

在您成功完成每个步骤后，您现在应该有一个正常工作的蜂窝资产追踪器，它将在屏幕上显示其 GPS 坐标，并将其发布到云，您可以通过不同的方式使用它们来达到您的目的。

## [](#where-will-you-take-you-take-your-asset-tracker)你会带着你的资产追踪器去哪里？

从这个项目开始，你可以用它作为汽车跟踪系统的基础，为你的宠物或孩子设置地理围栏，跟踪集装箱或做一些普通的事情，如制作互联网连接的踏板车。可能性当然是存在的，基础也是如此。

[![](../Images/34ffc804a281a1bcfe01100c594ea127.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--GWgNhD9e--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.particle.io/wp-content/uploads/2019/05/tracker-front-on-169-crop-1024x576.jpg)

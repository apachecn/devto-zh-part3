...
> 原文:[https://dev . to/matmooredev/3-lessons-for-building-better-ai-from-the-2019-turing-talk-3d D1](https://dev.to/matmooredev/3-lessons-for-building-better-ai-from-the-2019-turing-talk-3dd1)
...
# [](#so-what-can-go-wrong)那么，会出什么差错呢？
...
# [](#lesson-1-optimal-for-the-whole-population%C2%A0%C2%A0optimal-for-subgroups)第一课:整体最优！=子组的最佳选择
...
[![Ethical dilemmas in setting objectives. It's impossible to optimize all group errors simultaneously (Chouldechova 2016)](../Images/70e2b24a6a9ccbd10a49a02a72340bf7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--CLDeu_bQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/fux367y4nwvtab2dxbjb.jpg)

# [](#lesson-2-sampling-bias-in-your-training-data-biases-the-result)第二课:训练数据中的采样偏差会使结果产生偏差

另一个例子是“预测性警务”(你让警察去哪里处理与毒品有关的犯罪？)-问题是训练数据来自警方报告，如果你与其他药物使用的估计相比，警察已经不成比例地针对黑人社区。当人们根据算法的结果采取行动时，这就形成了一个恶性循环，算法使已经存在的偏见永久化。

[![Training bias in predictive policing: estimated drug use in Oakland vs 2010 Oakland Police Department drug crime reports](../Images/e2d6073a5a0ae86d177b3a7dfe66a0b4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--12da5Qgi--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/0drxndvq9bxh0pohfhgk.jpg)
...
[![Gender bias in machine translation: gender neutral phrases in turkish are translated to gendered english ones (*she* is a cook, *he* is an engineer, *he* is a doctor, *she* is a nurse)](../Images/e5fb00d15c76a6c1d9983459a74a4e4d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--YqeJq0fQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ahl0mn7xyspzegta3twu.jpg)

# [](#how-can-we-do-better)怎样才能做得更好？

...
> 原文:[https://dev . to/mandrew cito/signalr-core-python-client-iii-stream Ming-3lkj](https://dev.to/mandrewcito/signalr-core-python-client-iii-streamming-3lkj)
...
T3![Code function](../Images/2190ab21244f633ba6a20b13948786de.png)T5】

## [](#tiny-example)微小的例子

### [](#start-and-open-connection)启动并打开连接
...
[![Javascript example stream](../Images/cfe2424e279d2078dc225fc3ecd0d888.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--ZFGe86tX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/2vdrjcuozfuehsjbzhvs.png) 匹配的回调函数

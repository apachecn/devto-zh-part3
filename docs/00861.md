...
> 原文:[https://dev . to/flrnd/plastic-vim-a-dark-color scheme-for-vim-neovim-with-low-contrast-colors-for-long-coding-sessions-5g0g](https://dev.to/flrnd/plastic-vim-a-dark-colorscheme-for-vim-neovim-with-low-contrast-colors-for-long-coding-sessions-5g0g)

塑料是我最喜欢的 Visual Studio 代码配色方案之一。

因为我使用 neovim 作为我的主要编辑器，所以我决定为 vim/neovim 创建一个端口。

## ![GitHub logo](../Images/75095a8afc1e0f207cda715962e75c8d.png)[flrnd](https://github.com/flrnd)/[plastic . vim](https://github.com/flrnd/plastic.vim)

### 用于 vim/neovim 的 VSCode 塑料主题端口。

<article class="markdown-body entry-content container-lg" itemprop="text">

[![plastic.vim](../Images/1ec38babde58ec92526a06b4b4946afd.png)T2】](https://github.com/flrnprz/plastic.vim/blob/master/plastic-vim-screen.png)

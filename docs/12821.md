...
> 原文:[https://dev . to/sandordargo/the-big-STL-algorithms-tutorial-allof-any of-none of-28dl](https://dev.to/sandordargo/the-big-stl-algorithms-tutorial-allof-anyof-noneof-28dl)
...
这个版本更短，更密集，你只有这个 lambda 表达式:`[](int i){return i == 3;})`，而不是我们类`IsEqualTo`的整个定义。

...
> 原文:[https://dev . to/molily/maintaining-large-JavaScript-applications-4 aoj](https://dev.to/molily/maintaining-large-javascript-applications-4aoj)
...
## [](#small-improvements-instead-of-big-rewrites)小改进代替大改写

提到的两个项目都是相当大的客户端 JavaScript 应用程序。如今，多年来关于维护现有 JavaScript 代码库的博客文章已经很少了。不过，您会发现许多关于用目前流行的任何 JavaScript 框架重写前端的帖子。

<figure>

[![Satirical book cover: Rewriting Your Front End Every Six Weeks by @ThePracticalDev](../Images/82a54c0d9355ae902925af1b3c1b0d2d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9q7sdXrU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://9elements.com/io/images/rewriting-frontend.jpg)
...
## [](#learning-from-longterm-projects)从长期项目中学习
...
## [](#avoid-complex-structures)避免复杂的结构
...
## [](#avoid-creating-untyped-objects)避免创建无类型的对象

...
> 原文:[https://dev . to/jmoore 53/mounting-S3-as-a-file system-with-s3fs-538 I](https://dev.to/jmoore53/mounting-s3-as-a-filesystem-with-s3fs-538i)
...
### [](#macos-launchd-mount-on-user-login)MacOS - launchd -用户登录时挂载
...
### [](#ubuntu-etcfstab-mounting-on-boot)Ubuntu - /etc/fstab -安装在开机上

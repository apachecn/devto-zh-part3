...
> 原文:[https://dev . to/jamesmh/scalable-task-scheduling-in-net-core-with-Cora vel-1k 83](https://dev.to/jamesmh/scalable-task-scheduling-in-net-core-with-coravel-1k83)
...
# [](#scheduling-tasks-from-net-core-console-applications)调度任务从。NET 核心控制台应用程序
...
# [](#supporting-net-core-dependency-injection-with-invocables)配角。使用 Invocables 的 NET Core 依赖注入
...
# [](#problem-with-scalability)可扩展性问题
...
## [](#you-might-also-enjoy-from-my-blog)你可能也会喜欢(来自我的博客)

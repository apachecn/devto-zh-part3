...
> 原文:[https://dev . to/biros/its-been-three-months sin-my-first-go-loc-419d](https://dev.to/biros/its-been-three-months-since-my-first-go-loc----419d)

我用 Golang 写第一行代码已经 3 个月了。

[![biros image](../Images/f8e520c158b11124ad64d790d5a94ecc.png)](/biros) [## 我从 PHP 到 Go 的旅程
...
# [](#reading-from-requests-body)从请求体中读取
...
## [](#mocking-your-dependencies)嘲讽你的依赖
...
# [](#my-custom-development-environment)我的定制开发环境

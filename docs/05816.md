...
> 原文:[https://dev.to/clawfire/vapid-hosting-on-heroku-44oo](https://dev.to/clawfire/vapid-hosting-on-heroku-44oo)

#### [](#how-to-deploy-a-vapid-website-on-heroku-and-configure-the-database-transfer-your-data-but-still-have-the-file-storage-issue)如何在 Heroku 上部署一个乏味的网站并配置数据库，传输您的数据，但仍然存在文件存储问题。

<figure>[![](../Images/c741fb7f410fdc339756b4ab51e8cafd.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--ZLAiBvLG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/0%2AUBH0g-fFJ34PfFa1) 
...
### [](#creating-a-new-app)创建新应用

[![](../Images/ee710397c5eedec4e7ff9571338d1db0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--kuPwk-6---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/282/1%2A3JCGVNLZ9FdaagVwbI1MrQ.png)
...
[![](../Images/dae473fdf8affbf9af9f050ec11d07ba.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--L45CCm6n--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2A5uBTXshd21oocufKqy2UNQ.png)

### [](#preparing-the-vapid-install)准备 vapid 安装

现在，我假设您已经有了一个本地制作的 vapid 站点，并且只想部署它。

#### [](#editing-the-packagejson-file)编辑 package.json 文件
...
### [](#optional-importing-your-data)可选:导入您的数据
...
[![](../Images/d6d990e2bf42db55f3ebf7428de06c98.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--cZOianYD--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AwQOLR88JmSnJRH6pWpIJuw.png)

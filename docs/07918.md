...
> 原文:[https://dev . to/the burning monk/comparisng-nucl io-and-AWS-lambda-234 b](https://dev.to/theburningmonk/comparing-nuclio-and-aws-lambda-234b)
...
<figure>[![](../Images/2a3859996a246e3ca59deb309e93c14c.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--RDso85AB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://theburningmonk.com/wp-content/uploads/2019/04/img_5ca6568e7ee78.png) 
...
<figure>[![](../Images/1fcd6663ce9bf9f063cd74e621990b7b.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--7-i7SkZJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://theburningmonk.com/wp-content/uploads/2019/04/img_5ca656d098960.png) 
...
<figure>[![](../Images/4e51a1a91909c7d4019bca60c82581eb.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--MQrHUFch--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://theburningmonk.com/wp-content/uploads/2019/04/img_5ca656ea4ddbc.png) 
...
<figure>[![](../Images/4948b47884c9a2498588d1232296c5f7.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--oHsNgt-r--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://theburningmonk.com/wp-content/uploads/2019/04/img_5ca6570474d4e.png) 
...
<figure>[![](../Images/8836622a374a204eeb16663000a84746.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--PQRowbeT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://theburningmonk.com/wp-content/uploads/2019/04/img_5ca6571f19494.png) 
...
### [](#caching-state-between-invocations)缓存调用之间的状态

Lambda 和 Nuclio 函数在调用过程中都接受事件和上下文。

<figure>[![](../Images/7c1b8e52b20c4db2e0898fec051b4a1c.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--PKmeIYOA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://theburningmonk.com/wp-content/uploads/2019/04/img_5ca657411148f.png) 
...
<figure>[![](../Images/152f37639f7a2ee849201d59a984c55a.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--rN1UW1J4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://theburningmonk.com/wp-content/uploads/2019/04/img_5ca6575c7bda6.png) 

<figcaption id="caption-attachment-8714">图 7:使用 Nuclio，您可以为每个函数选择默认的日志级别。</figcaption>

</figure>

<figure>[![](../Images/677eb6d4514d432cd5b64b78a02cf203.png)](https://res.cloudinary.com/practicaldev/image/fetch/s---hg7VCKS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://theburningmonk.com/wp-content/uploads/2019/04/img_5ca6576c24e36.png) 
...
### [](#data-volumes-and-persistent-data-connections)数据量和持久数据连接
...
<figure>[![](../Images/39ea91216615f358eec407eda62529d4.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--_QfkQR2Q--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://theburningmonk.com/wp-content/uploads/2019/04/img_5ca657955d1cf.png) 
...
### [](#builtin-http-trigger)内置 HTTP 触发器
...
<figure>[![](../Images/2dd93e2070cdf6010268843ec2cc791b.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--Xnl0Y3bN--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://theburningmonk.com/wp-content/uploads/2019/04/img_5ca657bb6e864.png) 

<figcaption id="caption-attachment-8717">图 10:使用 Nuclio，每个函数都默认获得一个私有的 HTTP 接口。</figcaption>

</figure>

## [](#unlocking-new-use-cases-with-nuclio)**用 Nuclio 解锁新用例**

从我们的比较中可以看出，Nuclio 在许多重要方面与 Lambda 不同，比如它的并发模型和它没有最大执行时间。这为一系列用例打开了大门。让我们花点时间来看几个。

### [](#highthroughput-data-processing-pipelines-or-apis)高吞吐量数据处理管道或 API
...
### [](#apis-with-predictable-spikes-in-traffic)流量峰值可预测的 API
...
### [](#realtime-applications)实时应用

Nuclio 不会遭受冷启动，并且能够在调用时提供一致的亚毫秒级响应时间。这使得它成为对实时性有严格要求的应用程序(如多人游戏和实时机器人)的合适解决方案。

### [](#serving-machine-learning-models-in-real-time)实时服务机器学习模型
...
### [](#longrunning-jobs-and-services)长期运行的作业和服务

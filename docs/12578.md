...
> 原文:[https://dev.to/uilicious/adopt-your-own-devto-用一个单一的命令-几乎-1c04](https://dev.to/uilicious/adopt-your-own-devto----with-a-single-command-almost-1c04)
...
[![Script command demo](../Images/22c4a3e72b07eb4568c66036987576a0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--XibRlTD4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/nhlrb6e52kctxt4fzrmv.gif)

* * *

# [](#longer-docker-based-commands-no-git-clone)更长的基于 docker 的命令(没有 git 克隆)
...
[![Minion minion shouting joy scene](../Images/c333509212619f783d21ccc2fe4bf8d6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ziXEi9GF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/7iwunbbyov3mftowthgc.gif)

<figure>

[![Dev.to on localhost:3000 example](../Images/9113e4a969c0aeecf62e4d4b20883490.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--K5uJ7ci5--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/u4x9nfb5mlncywi37163.png)
...
# [](#why-do-this-isnt-it-possible-to-setup-the-server-using-the-official-readme-)为什么要这样做？难道不能用官方的 readme 来设置服务器吗？？

一开始是这样的，然后...

[![I failed](../Images/3cfd8c5a59ef3b4dacb7752b098fb332.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---hL_7O-U--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/9e1hod91kjx34o1xyc5u.jpg)
...
[![Please do not test in production](../Images/8ad9dae59dfc93db45be6eb029a93337.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--rcCWDnfl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/vdxtfl6d06nwxoekp2ck.jpg)
...
# [](#oh-one-more-thing-dev-mode)哦，还有一件事——DEV 模式

```
./docker-run.sh DEV 
```

[![dev.to dev mode](../Images/f9e70d3c47f906be503c5b6c28c5a4b4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9JizBpBO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/c4b4tsy3qgtht0y2peda.gif)

...
> 原文:[https://dev . to/melezhik/azure-automation-with-perl 6-and-sparrow 6-45eh](https://dev.to/melezhik/azure-automation-with-perl6-and-sparrow6-45eh)
...
# [](#installing-sparrow6)安装备用行 6

`zef install https://github.com/melezhik/Sparrow6.git`

# [](#setup-sparrow6-repostory)设置备用 6 仓库

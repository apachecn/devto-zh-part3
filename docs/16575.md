...
> 原文:[https://dev.to/andrious/clean-up-all-the-flutter-92f](https://dev.to/andrious/clean-up-all-the-flutter-92f)

*飘动杂乱难读！去清理一下！*

[![](../Images/b047eeec0ffe550b8198d22571c3a692.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Sg3a3FWa--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2Aw-CZ_K9qMqDjjiuqCGThSg.png)

你知道我不喜欢 Flutter 什么吗？非常少。然而，我不得不习惯于阅读那些长长的垂直的参数列表。大多数情况下，它们不仅仅是参数，它们是作为参数传递的匿名函数列表，这使得阅读起来更加困难。还有男人！有时，有很多杂乱！很多乱七八糟的东西！

[![](../Images/a6d63b84a661ac1085880f0c2cd5073e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--g5D6GCuH--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2APmp-k7zG__X4mkJEhhmP0g.png)

当然，一个人可以适应。它确实有它的优点，但我决定清理一下。下面是“之前和之后”的图片。你怎么想呢?

[![](../Images/0fdb9a1320ebb62e5d14f83b8c3f8808.png)T2】](https://github.com/fluttercommunity/flutter_contacts/blob/master/example/lib/main.dart#L80)

<figure>[![](../Images/0ce2a9b9fc6d7bfcea5ab3d697ac7c54.png)](https://github.com/Andrious/contacts_service_example/blob/master/lib/src/view/ContactDetailsPage.dart#L48) 
...
<figure>[![](../Images/6d40c8fc65c3366880067f570a195449.png)](https://github.com/Andrious/contacts_service_example/blob/master/lib/src/view/ContactDetailsPage.dart)
...
<figure>[![](../Images/f8664e9b8e3ccdedcee5945620e670e4.png)](https://github.com/Andrious/contacts_service_example/blob/master/lib/src/controller/Contacts.dart#L53) 
...
<figure>[![](../Images/55c86a20ad2c58895c80fb97b0d60842.png)](https://github.com/Andrious/contacts_service_example/blob/master/lib/src/controller/Contacts.dart#L53) 

<figcaption>[联系人.镖](https://github.com/Andrious/contacts_service_example/blob/master/lib/src/controller/Contacts.dart#L53)</figcaption>

</figure>

### [](#mvc-inside-and-out)MVC 内外
...
[![](../Images/72a5f20cf2269c4477a3a916259f7c0a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--RhQA5fM0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/937/1%2AAkbK9lsYFSaZIx6W8wV-HA.png)

<figure>[![](../Images/5e83c2a07bb844d2af56e12af9337a9d.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--9ePelNRl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/943/1%2Amtxv6VtxXvuiDEeht0tPJg.png) 

<figcaption>本项目的目录结构及其内容</figcaption>

</figure>

### [](#get-it-got-it-good)明白了吗？明白了。很好！
...
<figure>[![](../Images/b60618f322bf0fe61fc666128e93e418.png)](https://github.com/Andrious/contacts_service_example/blob/master/lib/src/controller/Contacts.dart#L84) 
...
[![](../Images/254925a90de46aaa13344f79d52b4794.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--nwcTu2LQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/233/1%2An4G9W9ZmtYYv8cNOvF8z5A.png)
...
<figure>[![](../Images/398be9e07b3c6c7f381eab53e54c76ca.png)](https://github.com/Andrious/contacts_service_example/blob/master/lib/src/view/AddContactPage.dart#L46)
...
<figure>[![](../Images/441def3ea46c2763d7ef8785d2845ede.png)](https://github.com/fluttercommunity/flutter_contacts/blob/master/example/lib/main.dart#L180)
...
<figure>[![](../Images/40f9a49e6597cc6de22fdff9a0cdf9e2.png)](https://github.com/Andrious/contacts_service_example/blob/master/lib/src/controller/Contacts.dart#L112) 
...
<figure>[![](../Images/70df1b08458fafde533d8f6e18d05126.png)](https://github.com/Andrious/contacts_service_example/blob/master/lib/src/controller/Contact.dart#L30) 
...
<figure>[![](../Images/64f780bd5c5dbf06b72f7384fa35dc1c.png)](https://github.com/Andrious/contacts_service_example/blob/master/lib/src/view/ContactListPage.dart#L32) 
...
### [](#whats-your-field)你是什么领域的？

让我们快速浏览一下其中一个“字段”类。上面列出的第一个是类 DisplayName。这一个和其他的非常相似，但是和其他的一样，它必须是特定的，并且提供它特定的字段名称，displayName。注意，变量 value 来自父类 Field。

<figure>[![](../Images/84d188da0140d3e211e57256f28854e1.png)](https://github.com/Andrious/contacts_service_example/blob/master/lib/src/controller/Contact.dart#L239) 
...
<figure>[![](../Images/9dc551a76265d0f2eec711b530fb5fb0.png)](https://github.com/Andrious/contacts_service_example/blob/master/lib/src/controller/Contacts.dart#L163) 
...
<figure>[![](../Images/42f1864370bef63b7775b1f993987e39.png)](https://github.com/Andrious/contacts_service_example/blob/master/lib/src/view/ContactListPage.dart#L72)
...
### [](#wheres-this-dismissible-discerned)这不屑一顾的辩别在哪里？
...
正如你在类 [ContactFields](https://medium.com/p/69cb308382f4#3b0c) 中看到的，有一大堆‘Field’类正在被定义。正是在这个阶层、领域里，你会发现方法，[](https://github.com/AndriousSolutions/mvc_application/blob/master/lib/src/view/utils/fields.dart#L618)**。**

 **<figure>[![](../Images/cc123add2611897aa7e60b5ffdd842b6.png)](https://github.com/AndriousSolutions/mvc_application/blob/master/lib/src/view/utils/fields.dart#L618)
...
### [](#the-getter-gets-it)吸气剂搞定

上面的方法实际上调用了 *getter* ，可忽略。是 *getter* 将所需的小部件(在本例中是一个可忽略的)返回给上面列出的变量 newWidget。

<figure>[![](../Images/22ef3e39ec0adee624aa7ba568cecb47.png)](https://github.com/AndriousSolutions/mvc_application/blob/master/lib/src/view/utils/fields.dart#L598) 
...
### [](#talk-about-flutter-clutter)谈扑杂波
...
<figure>[![](../Images/f91e15dddfdb0cfa2017dee0f91604ce.png)](https://github.com/Andrious/contacts_service_example/blob/fdf2a09e8f2db00bdf3ec50bc05ca55a1822faf8/lib/src/view/ContactListPage.dart#L72)
...
<figure>[![](../Images/29d534ae0abc32db8ddda50bef9ee8e6.png)](https://github.com/Andrious/contacts_service_example/blob/fdf2a09e8f2db00bdf3ec50bc05ca55a1822faf8/lib/src/controller/Contact.dart#L234) 
...
### [](#mvc-means-manageability)MVC 意味着可管理性
...
<figure>[![](../Images/6c7f4f868e23ba743d46a2a6a1645561.png)](https://github.com/AndriousSolutions/mvc_application/blob/master/lib/src/view/utils/fields.dart)

<figcaption>[. dart](https://github.com/AndriousSolutions/mvc_application/blob/master/lib/src/view/utils/fields.dart)</figcaption>

</figure>

### [](#the-point-to-all-this)指向这一切
...
### [](#widgets-how-many-widgets)Widgets？有多少部件？
...
### [](#so-whats-the-real-point-to-all-this)那么这一切的真正意义是什么呢？
...
### [](#with-mvcpattern-comes-mvcapplication)随着 MVC_Pattern 而来的是 MVC_Application
...
[![](../Images/4f2a6654c22355361165fe9b463a9dc1.png)T2】](https://medium.com/@greg.perry/flutter-and-sqlite-f72878bc5859)

[![](../Images/19e7e0a2342670be2689e9c21fb87e58.png)T2】](https://medium.com/@greg.perry/store-and-read-your-apps-preferences-4139e836cfe9)

[![](../Images/e3f8a20a53a1d3051cf70112187e2ced.png)T2】](https://medium.com/@greg.perry/ads-in-a-snap-flutter-example-4362a2c88c0b)

### [](#whats-my-end-game)我的最终目标是什么

...
> 原文:[https://dev . to/k _ penguin _ sato/cache-rails-gems-using-docker-compose-3o3f](https://dev.to/k_penguin_sato/cache-rails-gems-using-docker-compose-3o3f)
...
# [](#set-up-your-dockercomposeyml)设置码头-堆肥. yml
...
## [](#create-the-cache-of-the-gems)创建宝石的缓存

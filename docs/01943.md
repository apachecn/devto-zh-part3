...
> 原文:[https://dev . to/missamarakay/intro-to-calling-third-party-ai-services-in-unreal-engine-23kc](https://dev.to/missamarakay/intro-to-calling-third-party-ai-services-in-unreal-engine-23kc)

#### [](#learning-in-public%E2%80%8A%E2%80%8Ausing-a-blueprint-plugin-no-code)公开学习——使用蓝图插件(无代码！)

<figure>[![](../Images/11cf6fd8164bf6660b12d90c819d959f.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--mazQlP_P--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2Abk_VaKf4WPJFKTEUl421MQ.jpeg) 
...
#### [](#where-to-start-with-unreal)从哪里开始幻化

虚幻是一个 C++引擎，当然，我已经有*年*没写过一行 C++了。所以我做了任何开发人员都会做的事情，我下载了引擎，并寻找某种示例项目来打开，并找出如何以及在哪里可以编写一些 C++来调用 REST API。

[![](../Images/a4a4b787d4fc25a5efdfe28518df98cd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Nc8oWwQA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AuEphqAT4WsAqJJSAoLK0mQ.png)
...
[![](../Images/e41f95eb0dcc04d22ed62aee80b9241c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--7_y5fOO---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2ArTujB52wzOlKZaLUZR1OqA.png)
...
[![](../Images/bd00b87cc12705a85fb8906d360e9e82.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8IJL3agh--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/674/1%2A2ASXhKHFbi8ao7vP29i6ZA.png)

我得到两个脚本选项，一个是新的 Blueprint 脚本组件，另一个是新的 C++组件。

我用 C++组件，得到一个关于选择父类的窗口。

[![](../Images/42c2c36745df8211788f844d38397e7f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--bpE92jMF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2A2_geNcvbFaMpBTWJaPXW9w.png)
...
[![](../Images/5440ebc7ee72437d10b91e54e36e0e56.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--MO3gLGBD--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AmB1d7LWcsEk8D8VBNItFlA.png)

我知道我将需要在 BeingPlay()函数中放置任何代码或对我的 REST API 代码的调用，这样一旦游戏开始(如果不是更早的话)我将触发我的代码，它不会只是闲置在那里。

#### [](#ok-but-how-do-you-call-the-service)好的，但是怎么调用服务呢？
...
[![](../Images/a9d1870673390fa700758d0a473e256c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--dxXKFf3I--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/622/1%2AhycW7ncfRIPEuyKHJXT-yA.png)
...
[![](../Images/1cd8c135d80ada19519c2ca003a86502.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--4YYIfTQe--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/818/1%2AopiEfrpXNfWCTZevqynOjA.png)

我需要一个地方来放置 URL，所以我开始研究“应用 URL”和“处理 URL”。“应用 URL”似乎实际上返回了一些东西，而“处理 URL”只是发起请求。

[![](../Images/36641957785e4b4238871bd2bd0e8e6c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--1mkwl4j9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/654/1%2Aglhto0ph5-R0zhlib04QHQ.png)

这是一个很好的解释，你想点击的网址在网址栏里。但是如何打印请求对象的结果呢？嗯。

#### [](#frustrating-with-blueprints)令人沮丧的蓝图…
...
#### [](#succeeding-with-blueprints)成功有蓝图！

最后，我构建了一个 GET，用于返回定制的声音音频文件，我用这些文件来训练 Watson 语音到文本的定制声音模型。

[![](../Images/d0b10ef1f58a0871a8779055e1821374.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vgarqBwD--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AUMkfR_9J9jkKIy1DtNNXDQ.png)

我交叉手指，保存/编译，然后点击播放按钮。有用！！！我在控制台中看到我的音频文件列表！

[![](../Images/d76b69af6486e3c81c998577494abfe2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--XkW1rFlD--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2Ai7FO0i9nyNA5cpzE51tp_w.png)

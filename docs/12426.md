...
> 原文:[https://dev . to/progress telerik/the-journey-of-JavaScript-from-download-scripts-to-execution-part-I-3 a4](https://dev.to/progresstelerik/the-journey-of-javascript-from-downloading-scripts-to-execution---part-i-3a4)
...
## [](#understanding-the-script-tag)理解脚本标签
...
[![loading-scripts](../Images/b96afa797562bb5775646901588db29d.png "loading-scripts")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--R44bW_Fn--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://d585tldpucybw.cloudfront.net/sfimages/default-source/default-album/loading-scripts.png%3Fsfvrsn%3D9c36ac48_1)
...
## [](#downloading-scripts-asynchronously)异步下载脚本
...
## [](#deferring-the-execution-of-scripts)推迟脚本的执行
...
[![defer-scripts](../Images/540a5512c7e4e12ae696457bea74bcc6.png "defer-scripts")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--29BqQs6x--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://d585tldpucybw.cloudfront.net/sfimages/default-source/default-album/defer-scripts.png%3Fsfvrsn%3D8df6a065_1)

在上面的截图中我们可以看到，third.js 和 fourth.js 是在 first.js 和 second.js 之前执行的。

以下是添加脚本的三种技术的简要概述:

[![comparison](../Images/ef3ef00ba6503054f3b07e1d53be16c7.png "comparison")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--aQfm3kt5--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://d585tldpucybw.cloudfront.net/sfimages/default-source/default-album/comparison.jpg%3Fsfvrsn%3D63483a10_1)
...
[![js-engine](../Images/fa1a7a1fc5f4bab8a5116167c5d3d7b9.png "js-engine")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Q9EM6Jow--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://d585tldpucybw.cloudfront.net/sfimages/default-source/default-album/js-engine.png%3Fsfvrsn%3Ddc2f64eb_1)
...
[![parser-error](../Images/c15f2d5121e9d02df7e186406b0a31e5.png "parser-error")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--0jyzl0tS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://d585tldpucybw.cloudfront.net/sfimages/default-source/default-album/parser-error.png%3Fsfvrsn%3Df08c6652_1)
...
## [](#parsing-of-inner-functions)解析内部函数
...
[![parsed-output](../Images/cb9a3d8fb436928740b854d9e35e10f4.png "parsed-output")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--jsokMOn4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://d585tldpucybw.cloudfront.net/sfimages/default-source/default-album/parsed-output.png%3Fsfvrsn%3D4c64e1d6_1)
...
[![streaming](../Images/e4dac5463da627b6d8be070ca93848f1.png "streaming")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--6Toxc7Tn--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://d585tldpucybw.cloudfront.net/sfimages/default-source/default-album/streaming.png%3Fsfvrsn%3D709711b0_1)

在本教程中，我们学习了基于用例下载脚本的多种方式。我们学习了解析器在解析代码时如何生成抽象语法树及其试探法。在本文的后面，我们学习了脚本流。在下一篇文章中，我们将了解 V8 编译器如何编译解析代码。

## [](#for-more-on-building-apps-with-jquery)关于使用 jQuery 构建应用程序的更多信息:

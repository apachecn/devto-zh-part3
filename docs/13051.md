...
> 原文:[https://dev . to/kbild/proper-monitoring-how-to-use-Prometheus-with-your-AWS-ec2-instances-4 NPM](https://dev.to/kbild/proper-monitoring-how-to-use-prometheus-with-your-aws-ec2-instances-4npm)
...
## [](#prometheus-aws-service-discovery)普罗米修斯 AWS 服务发现
...
[![Prometheus Service Discovery](../Images/d83309b8da77ddcd492978bc976a5eb3.png)T2】](https://kbild.ch/201902/Prometheus_SD.png)

## [](#graphs-and-dashboards)图表和仪表盘

我们定义每分钟收集一次指标，几分钟后我们可以在 Prometheus UI 中看到结果:

[![Prometheus Graph](../Images/2bd56c31a1e1875c11a1fd6da86614dc.png)T2】](https://kbild.ch/201902/Prometheus_Graph.png)
...
[![Grafana Dashboard](../Images/a5dfc69304d272cba0384b791c280816.png)T2】](https://kbild.ch/201902/Grafana_Dashboard.png)

...
> 原文:[https://dev . to/spences 10/get-your-graphcms-data-into-Gatsby-3jkl](https://dev.to/spences10/get-your-graphcms-data-into-gatsby-3jkl)

###### edu·劳顿在 Unsplash 上拍摄的照片

### [](#get-your-graphcms-data-into-gatsby)把你的 GraphCMS 数据导入 Gatsby
...
### [](#5-query-the-data-in-gatsby-graphiql)5。查询 Gatsby GraphiQL 中的数据

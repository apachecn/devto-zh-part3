...
> 原文:[https://dev . to/nehalist/routing-with-type script-decorators-for-node-applications-4fnb](https://dev.to/nehalist/routing-with-typescript-decorators-for-node-applications-4fnb)

[![Routing with TypeScript decorators for node applications](../Images/32769aa30fc3c6e21b0fafe72a31ad09.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ervjHWkb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ghost.nehalist.io/content/images/2019/06/typescript-decorators-routing.png)
...
[![Routing with TypeScript decorators for node applications](../Images/9ca22ac9cdaf309006264a04392d7523.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--DaaK3XqG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ghost.nehalist.io/content/images/2019/03/routing-arch-2.png)
...
[![Routing with TypeScript decorators for node applications](../Images/d04ef08f2daeac19d8cd7ed0edfac92e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--nM5ZHjO5--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ghost.nehalist.io/content/images/2019/03/routing-metadata.png)

我们只需将路由保存到控制器元数据中。稍后，当在我们的 express 应用程序中注册我们的路线时，我们已经需要加载我们的控制器——这就是我们简单地读取我们的路线元数据并正确注册它们的地方。

知道了所有这些，让我们开始实现我们的路由装饰器吧！

## [](#express-application)快递申请
...
## [](#advancing-this-approach)推进这种方法

...
> 原文:[https://dev . to/Lars waechter/path-aliases-with-type script-in-nodejs-4353](https://dev.to/larswaechter/path-aliases-with-typescript-in-nodejs-4353)
...
### [](#step-1-update-tsconfigjson)第一步:更新 tsconfig.json
...
### [](#step-2-install-modulealias-package)第二步:安装模块别名包

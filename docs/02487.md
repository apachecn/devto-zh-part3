...
> 原文:[https://dev.to/pulljosh/why-is-jsx-okay-1l2g](https://dev.to/pulljosh/why-is-jsx-okay-1l2g)

# [](#the-old-way-splitting-code-by-language)老办法:按语言拆分代码
...
# [](#the-new-way-splitting-code-by-component)新方式:按组件拆分代码
...
[![Dan the Witch](../Images/1150d289631e8a05368a63815244a8bf.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--BbzS972h--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/0d1r6louz13ppynjeltw.png)
...
# [](#change-is-the-only-raw-const-endraw-)变化是唯一的`const`

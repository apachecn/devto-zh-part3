...
> 原文:[https://dev.to/onerzafer/diy-redux-with-rxjs-part-3-2ndb](https://dev.to/onerzafer/diy-redux-with-rxjs-part-3-2ndb)
...
### [](#stitching-the-rxdx-with-a-react-component-a-reallife-example-of-hoc)用 React 组件缝合 RxDx:HOC 的真实例子

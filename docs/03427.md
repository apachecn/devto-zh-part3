...
> 原文:[https://dev . to/eecms/how-to-create-a-flexible-hero-block-23n 7](https://dev.to/eecms/how-to-create-a-flexible-hero-block-23n7)

所以你想让你的作者能够为你的条目指定一个“英雄”风格的标题，但是当他们不想要的时候有一个后备。

为了这个例子的目的，我们假设你的英雄块有一个图像，标题和描述。

## [](#lets-set-up-some-fields)让我们设置一些字段

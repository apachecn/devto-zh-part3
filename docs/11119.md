...
> 原文:[https://dev.to/oktadev/build-a-simple-rest-api-in-php-2k0k](https://dev.to/oktadev/build-a-simple-rest-api-in-php-2k0k)
...
## [](#create-the-php-project-skeleton-for-your-rest-api)为你的 REST API 创建 PHP 项目框架
...
## [](#configure-a-database-for-your-php-rest-api)为你的 PHP REST API 配置一个数据库
...
## [](#add-a-gateway-class-for-the-person-table)为人员表添加一个网关类
...
## [](#implement-the-php-rest-api)实现 PHP REST API
...
[![View the client credentials](../Images/0b48bab2f13766e5b278605511d8e842.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--_P7QH3v7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://developer.okta.com/assets-jekyll/blog/php-rest-api/view-client-credentials-640dd0d4299f8b8915d6c890083e385a656b69cb6bee5075023deed8ee14e5b7.png)
...
## [](#add-authentication-to-your-php-rest-api)给你的 PHP REST API 添加认证
...
## [](#build-a-sample-client-application-command-line-script-to-test-the-php-rest-api)构建一个示例客户端应用程序(命令行脚本)来测试 PHP REST API
...
## [](#learn-more-about-php-secure-rest-apis-and-oauth-20-client-credentials-flow)了解关于 PHP、安全 REST APIs 和 OAuth 2.0 客户端凭证流的更多信息

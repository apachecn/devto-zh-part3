...
> 原文:[https://dev . to/ijsucceed/how-to-integrate-pay stack-payment-system-with-PHP-5a8m](https://dev.to/ijsucceed/how-to-integrate-paystack-payment-system-with-php-5a8m)
...
[![paystack payment form](../Images/3bedeed6b4b32ad57bcc04b7bc2ffc45.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s----xMo72e--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ijsucceed.com/uploads/paystack_ui.png)

当支付成功时，您的浏览器将显示一个提示，指示交易成功，并带有一个参考键。

[![paystack payment form](../Images/842652abb12ff59edef9382ff793e381.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--YREm20aX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ijsucceed.com/uploads/paystack_integration_ui_testcard.png)

使用这种内联方法，一切都在一个页面上进行。另外，请注意`callback`和`onClose`对象关键点。如果支付成功，`callback`允许您在回调函数中控制用户体验。例如将用户重定向到感谢页面。

## [](#paystack-standard)工资单标准
...
## [](#initialize-a-transaction)初始化一笔交易
...
[!['paystack standard demo'](../Images/afd90c8410ad875841a271f88ab5bff6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--abCZDZKk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://i.imgflip.com/3d97so.gif)

...
> 原文:[https://dev . to/lmolivera/everything-you-need-know-about-relational-databases-3ejl](https://dev.to/lmolivera/everything-you-need-to-know-about-relational-databases-3ejl)
...
# [](#what-is-a-relational-database)什么是关系数据库？

关系数据库是一种数据库。它使用的结构允许我们识别和访问数据库中与另一条数据相关的数据。关系数据库中的数据被组织成表。

### [](#table-record-field-row-amp-column)表格，记录，字段，行&列

*   一个**表**是一组数据元素(值)。
*   文件中的一段数据称为一个**记录**。
*   记录中的每一项被称为一个**字段**。

[![Table, Record, Field, Row & Column](../Images/080b1e4a02bed1176e70eaf4ffe7a3f8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--LFRV2Ygk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/acc34n6kn7g4uyncsoix.PNG)

*   一条数据或记录被称为一个**行**。
*   每个项目或字段称为一个**列**。

### [](#primary-key-unique-amp-null)主键，唯一&空

[![Primary Key, Unique & Null](../Images/d8c7c8e8b3e64953836330c9faaa1629.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Mc8nL-Z1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/hccsa1yjjlkxd6yqic13.PNG)
...
[![Entity, attributes](../Images/b04ab0647c40b0c38799b63ba3717dcb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--o4LLm7pR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/vyo30fopflvkj8osi2oz.png)

*   **R 指关系**。实体如何相互关联。例如，水果和出口目的地相互关联，因为您向出口目的地销售水果。用菱形表示。水果出口到许多出口目的地，出口目的地购买多种水果。我们称之为**多对多关系**。在 E-R 模型中，考虑了实体之间的关联数量，这被称为**基数**。

[![Entity, attributes, relation, cardinality](../Images/a2ec5a4861e3346cbab129ca7a5680cc.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--NYiquFrp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/bb2submtxhrjy2rqp7yz.png)
...
### [](#steps-for-designing-a-database)设计数据库的步骤
...
[![Comparison operators](../Images/2a5c02b73bc508977c1c57dc85b84435.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--weY89oGv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/fdideqrlqhu6vu3jz5sr.PNG)

#### [](#logical-operators)逻辑运算符

[![Logical operators](../Images/af935990db75fb23071c10d5b6d28155.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--d_7M5C69--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/om8fkvymhxfeyioawn5c.PNG)
...
[![Wildcards](../Images/22c50a79425e8c68510e6726721f68d5.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--Z7OEaIKa--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/179st9pc62uwq62okzox.PNG)
...
T3![Wildcards](../Images/3a57facac3a1e34f4dc29722bed1b5d5.png)T5】
...
#### [](#aggregating-data-by-grouping)分组汇总数据
...
### [](#searching-for-data)搜索数据

SQL 中还有更复杂的查询方法。

#### [](#subquery-and-in)子查询和在
...
#### [](#different-types-of-sql-joins)不同类型的 SQL 连接

以下是 SQL 中不同类型的联接:

*   (内部)联接:返回在两个表中具有匹配值的记录。![Inner join](../Images/dcf33bbd4d808f1ff63ad875cbfbaed0.png)
*   左(外)连接:返回左表中的所有记录，以及右表中的匹配记录。![Inner join](../Images/e2d1360cf8fad402f7ac5802da1283cb.png)
*   右(外)连接:返回右表中的所有记录，以及左表中的匹配记录。![Inner join](../Images/76e6fd83a6cb367ef0da8e881ac0ed3b.png)
*   完全(外部)连接:当左表或右表中有匹配项时，返回所有记录。![Inner join](../Images/9985f9a078da9d8299373423300bbdc4.png)
...
#### [](#constraints-on-a-table)约束一个表

防止数据冲突的表规范。

[![Constraints](../Images/2645b07cc695798ec92674b81729cf1d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--kPV1HmIu--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/975c35mams0xs8teiqyq.PNG)

### [](#inserting-data-into-a-table)向表格中插入数据
...
#### [](#properties-required-for-a-transaction)交易所需的属性

[![Properties required for a transaction](../Images/142df58d85b55c89b2ee39f38423b109.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--q8am4swk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ylsuvfc6mth48q2h798c.PNG)
...
##### [](#other-concurrency-controls)其他并发控制
...
[![Isolation](../Images/e3ecc658c058dc505da1dc409fa07e50.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--bXyPHKXk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/tz0mdce3ni8o85x3dkpf.PNG)
...
[![Privileges](../Images/8bd52e42063cba2fc173aa80166145c7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Rh-N1MnE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/wmzfgh0wydcujg6lbvuw.PNG)
...
[![Privileges](../Images/da438dff2b557e28beeb8c077e8abc76.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--C0iFB3x4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/2jmcr8vovt3yzxq0o7ra.PNG)

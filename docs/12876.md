...
> 原文:[https://dev . to/vonagedev/record-a-phone-message-with-Java-56j 3](https://dev.to/vonagedev/record-a-phone-message-with-java-56j3)
...
## [](#record-a-phone-message-with-java)用 Java 记录电话留言
...
#### [](#define-the-answer-route)定义应答路线
...
#### [](#define-the-recordings-route)定义录像路线

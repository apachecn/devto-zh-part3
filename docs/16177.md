...
> 原文:[https://dev . to/awwsmm/101-bash-commands-and-tips-for-初学者到专家-30je](https://dev.to/awwsmm/101-bash-commands-and-tips-for-beginners-to-experts-30je)
...
## [](#first-commands-navigating-the-filesystem)第一个命令，导航文件系统
...
### [](#-raw-pwd-ls-cd-endraw-)`pwd / ls / cd`
...
### [](#-raw-head-tail-cat-less-endraw-)`head / tail / cat / less`
...
### [](#-raw-nano-nedit-endraw-)`nano / nedit`
...
### [](#-raw-mkdir-rm-rmdir-endraw-)`mkdir / rm / rmdir`
...
## [](#moving-and-copying-files-making-links-command-history)移动和复制文件，制作链接，命令历史

### [](#-raw-mv-cp-ln-endraw-)`mv / cp / ln`
...
## [](#directory-trees-disk-usage-and-processes)目录树、磁盘使用情况和进程

### [](#-raw-mkdir-p-tree-endraw-)`mkdir –p / tree`
...
### [](#-raw-passwd-logout-exit-endraw-)`passwd / logout / exit`
...
## [](#disk-memory-and-processor-usage)磁盘、内存和处理器使用情况

### [](#-raw-ncdu-endraw-)`ncdu`
...
## [](#repls-and-software-versions)复制器和软件版本
...
### [](#-raw-version-version-v-endraw-)`-version / --version / -v`
...
## [](#environment-variables-and-aliases)环境变量和别名
...
## [](#basic-raw-bash-endraw-scripting)基础`bash`脚本

### [](#-raw-bash-endraw-scripts)`bash`脚本
...
### [](#custom-prompt-and-raw-ls-endraw-)自定义提示和`ls`
...
### [](#config-files-raw-bashrc-endraw-)配置文件/ `.bashrc`
...
### [](#-raw-whereis-which-whatis-endraw-)`whereis / which / whatis`
...
### [](#-raw-locate-find-endraw-)`locate / find`
...
## [](#downloading-things)下载东西

### [](#-raw-ping-wget-curl-endraw-)`ping / wget / curl`
...
### [](#-raw-apt-gunzip-tar-gzip-endraw-)`apt / gunzip / tar / gzip`
...
## [](#redirecting-input-and-output)重定向输入输出

### [](#-raw-gt-lt-echo-printf-endraw-)`| / > / < / echo / printf`
...
### [](#-raw-0-1-2-tee-endraw-)`0 / 1 / 2 / tee`
...
### [](#-raw-chmod-chown-endraw-)`chmod / chown`
...
### [](#-raw-uniq-sort-diff-cmp-endraw-)`uniq / sort / diff / cmp`
...
## [](#copying-files-over-raw-ssh-endraw-)复制文件结束`ssh`

### [](#-raw-ssh-scp-endraw-)`ssh / scp`
...
## [](#longrunning-processes)长时间运行的流程

### [](#-raw-yes-nohup-ps-kill-endraw-)`yes / nohup / ps / kill`
...
### [](#-raw-cron-crontab-gtgt-endraw-)`cron / crontab / >>`
...
### [](#-raw-pushd-popd-endraw-)`pushd / popd`
...
[![](../Images/f1d05fa3fe4dd7ec1f22312296f1d0ec.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--TDALl0_O--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ftg29mpjtru1o5vs3pzv.png)

### [](#-raw-xargs-endraw-)`xargs`
...
# [](#bonus-fun-but-mostly-useless-things)加成:好玩但大多没用的东西

### [](#-raw-w-write-wall-lynx-endraw-)`w / write / wall / lynx`
...
[![](../Images/84ebf4dc844bea84669a0375f8369e5c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--phlvU7h8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/qgr62yiukzj0skkbe5az.png)

### [](#-raw-nautilus-date-cal-bc-endraw-)`nautilus / date / cal / bc`

 ...
 **# [](#ainda-utilizando-callbacks)仍然使用回调
...
# [](#c%C3%B3digo-sequencial-desnecess%C3%A1rio)不必要的顺序码
...
# [](#esquecer-de-usar-promise-no-awssdk)Esquecer de usar。promise()没有 AWS-SDK

...
> 原文:[https://dev . to/oktadev/build-a-basic-website-with-ASP-net-MVC-and-angular-4k do](https://dev.to/oktadev/build-a-basic-website-with-asp-net-mvc-and-angular-4kdo)
...
## [](#create-an-angular-project)创建一个角度项目
...
### [](#add-the-connection-string)添加连接字符串
...
### [](#create-your-dbcontext-and-data-models-in-angular)在 Angular 中创建你的 DbContext 和数据模型
...
### [](#enable-and-run-migrations-in-your-aspnet-project)在您的 ASP.NET 项目中启用并运行迁移
...
## [](#add-authentication-to-your-angular-application)为您的 Angular 应用程序添加认证
...
### [](#add-login-section-to-layout)向布局添加登录部分
...
## [](#set-up-your-aspnet-api-endpoints)设置你的 ASP.NET API 端点
...
## [](#set-a-default-formatter-for-aspnet-web-api-2)为 ASP.NET Web API 2 设置默认格式化程序
...
## [](#set-up-the-angular-application-for-aspnet-mvc)为 ASP.NET MVC 设置角度应用
...
## [](#create-a-model-and-api-service-for-your-angular-application)为你的 Angular 应用创建一个模型和 API 服务
...
## [](#fetch-data-from-the-aspnet-api-endpoint)从 ASP.NET API 端点获取数据
...
## [](#test-out-your-aspnet-and-angular-application)测试您的 ASP.NET 和角度应用

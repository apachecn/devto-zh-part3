...
> 原文:[https://dev . to/Tathagata/moving-your-cron-jobs-to-AWS-lambdas-with-Sam-CLI-4k1i](https://dev.to/tathagata/moving-your-cron-jobs-to-aws-lambdas-with-sam-cli-4k1i)
...
## [](#whats-with-the-cover-picture)封面图片是怎么回事？

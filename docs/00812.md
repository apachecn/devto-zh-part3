...
> 原文：<https://dev.to/tangweejieleslie/5-takeaways-from-launching-my-first-web-application-33ij>
...
## 4。不需要“完美”，甚至不需要“好”的应用程序

我从一些先入为主的基准开始了旅程，这些基准是关于在我应该部署我的应用程序并发布消息之前我需要达到的标准。

在我认为它足够好之前就发布了它，并得到了一些积极的反馈，这让我很高兴这样做了。

[![](img/30773f995712cdbe2079a65251e76d26.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--2k-Nrn1G--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4j2sdp8bwnsw34u1q7v1.JPG) 
*关于申请的一些正面反馈*

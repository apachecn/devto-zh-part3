...
> 原文:[https://dev . to/tpetrov 9/web methods-第三方身份提供者单点登录-3d2i](https://dev.to/tpetrov9/webmethods-single-sign-on-with-a-third-party-identity-provider-3d2i)

# [](#example-with-okta%C2%AE)以秋田为例

越来越多的公司依赖第三方提供商进行身份管理和认证。好处包括更好地防止数据泄露，以及在应用程序之间切换时的无缝用户体验。我的 webMethods 服务器(MWS)还提供了对集成第三方身份提供者的支持。

## [](#why-single-signon-sso)**为什么要单点登录(SSO)？**

SSO 让我们可以方便地登录一次，访问来自不同供应商、托管在不同环境中的多个应用程序。随着企业的应用程序环境变得越来越复杂，这种便利性成为一个必备的特性。

## [](#using-a-thirdparty-identity-provider)**使用第三方身份提供商**

第三方身份提供商(IDP)提供用户身份和登录功能来验证用户。一旦验证了登录，用户就被转发到所请求的应用程序，也称为服务提供商(SP)。身份和服务提供者之间的通信通过安全断言标记语言(SAML)协议进行。

## [](#idp-initiated-vs-sp-initiated-login)**IDP 发起的与 SP 发起的登录**
...
[![SAML Flow](../Images/e180e26e6f3472e34d414b5e354b9d1b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--S-eUBaSR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://techcommunity.softwareag.com/documents/10157/10255328/sso1.png/f4cbedcb-ef6f-417c-a56b-2e0080c08b23%3Ft%3D1548937276319)

从版本 10.3 开始，我的 webMethods 服务器只支持 IDP 启动的登录(参见第 4 点)。

## [](#setting-up-mws)**设置 MWS**
...
## [](#creating-an-okta-developer-account)**创建 OKTA 开发者账号**

OKTA 提供了一个免费的开发者账号，可以设置为 SSO 到 MWS。创建一个 SAML web 应用程序并提供 MWS 连接的详细信息。创建应用程序后，记下嵌入链接的 URL。

[![](../Images/fb6cc8bb84d1879d4f978df734b3a10b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--uNYCWKIp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://techcommunity.softwareag.com/documents/10157/10255328/sso2.png/0c9079c1-4227-42fa-8a61-c82de491be36%3Ft%3D1548937279998)

## [](#try-it-out)**试用一下**

要测试 IDP 启动的 MWS 登录，只需打开浏览器窗口，输入 OKTA 应用程序中的嵌入 URL 链接。

[![](../Images/69d4bd526b39b3af5e175f55a2e06006.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--TNfkQg0c--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://techcommunity.softwareag.com/documents/10157/10255328/sso3.png/8b51f99d-f31b-4898-bd56-c391a46a24a6%3Ft%3D1548937282880)

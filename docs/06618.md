...
> 原文:[https://dev.to/psfeng/setting-up-jenkins-on-microk8s-4b8a](https://dev.to/psfeng/setting-up-jenkins-on-microk8s-4b8a)
...
## [](#installing-jenkins-on-kubernetes)在 Kubernetes 上安装詹金斯
...
## [](#creating-a-github-pipeline)创建 Github 管道
...
### [](#other-things-of-interest)其他感兴趣的事情

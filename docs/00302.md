...
> 原文:[https://dev.to/buddyreno/organizing-routes-in-rails-1hd3](https://dev.to/buddyreno/organizing-routes-in-rails-1hd3)
...
## [](#folder-and-file-structure)文件夹和文件结构

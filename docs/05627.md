...
> 原文:[https://dev . to/alone guid/deploying-azure-functions-with-application-insights-via-arm-109k](https://dev.to/aloneguid/deploying-azure-functions-with-application-insights-via-arm-1o9k)

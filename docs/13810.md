...
> 原文:[https://dev . to/robbmanes/running-coredns-as-a-DNS-server-in-a-container-1d 0](https://dev.to/robbmanes/running-coredns-as-a-dns-server-in-a-container-1d0)

...
> 原文:[https://dev.to/katiekodes/intro-to-xml-and-json-56co](https://dev.to/katiekodes/intro-to-xml-and-json-56co)
...
[![](../Images/2f46bf112f350ef9a188d1219f4a8514.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ALyKjjcl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://katiekodes.com/images/grocery_vs_ledger.png)

## [](#xml-amp-json-are-for-lists-of-lists-csvs-are-for-tables)XML & JSON 是列表的列表。CSV 是用于表的。
...
### [](#principle-1-xml-%E2%89%88-json)原则 1: XML ≈ JSON

XML 和 JSON 在很大程度上可以互换。

### [](#principle-2-xmljson-gt-csv)原则二:XML/JSON > CSV

XML 和 JSON 能够容纳比 CSV 文件更复杂的数据。

XML & JSON 文件能够存储 CSV 文件能够存储的任何“表格状”数据*(尽管通常不如 CSV 文件简洁)*。

### [](#principle-3-csv-lt-xmljson)原则三:CSV < XML/JSON
...
### [](#principle-4-line-breaks-%E2%89%A0-internetfriendly)原则 4:换行符≠互联网友好
...
2.  表格对比列表*(本帖)*
     [![katiekodes image](../Images/91ff852c8568473209156ff5bd632209.png)](/katiekodes) 

...
> 原文:[https://dev . to/duplocloud/deploy-existing-web-applications-as-server less-using-AWS-lambda-zappa-and-duplocloud-4l3c](https://dev.to/duplocloud/deploy-existing-web-applications-as-serverless-using-aws-lambda-zappa-and-duplocloud-4l3c)
...
## [](#1-code-package-and-infrastructure-configuration)**1。代码包和基础设施配置:**
...
# [](#why-and-why-not-server-less)为什么和为什么不服务器少？

[![](../Images/d1ff3679f1a486513da69e4a481a210c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Td52LGcC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://miro.medium.com/max/1284/1%2AQKKqSbMW8qP0rdmlLaREKA.jpeg)

# [](#aws-lambda-zappa-and-duplocloud)AWS Lambda、Zappa 和 DuploCloud
...
## [](#3-clone-a-sample-django-hello-world-repo)3。克隆一个样本 Django Hello World Repo
...
## [](#4-create-zappa-settings-file)4。创建 zappa 设置文件
...
## [](#5-create-duplocomposejson)5。创建 duplo_compose.json
...
## [](#6-build-the-lambda-package)6。构建 lambda 包
...
[![](../Images/c1d68795d9133cc66d95f3f881c2df89.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--kcg7xAb_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://miro.medium.com/max/1344/1%2AO2Z34DFYrwa70af7FcVUyQ.jpeg)

## [](#7-deploy-the-lambda-package-in-aws-using-duplocloud)7。使用 DuploCloud 在 AWS 中部署 lambda 包

如果您已经在步骤 1 中注册了 DuploCloud 帐户，请登录门户。在控制面板中，单击 API 图标，它将显示 cli 命令，如下例屏幕截图所示

[![](../Images/1661c85a70b56c9f7ab0cfc9d3ea3f63.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--SpiTNcjS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://miro.medium.com/max/1288/1%2AqMjN4TfZEg_Vk8qD69eTcQ.jpeg)
...
[![](../Images/034610c6823dcbde6451e9533eafaf00.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--kaDltiMi--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://miro.medium.com/max/1400/1%2AECQgdbwlHj486rwbaHPZ4Q.jpeg)

## [](#8-test-the-lambda-application-in-aws)8。在 AWS 中测试 lambda 应用程序

在 web 浏览器中，再次登录 duplocloud 并转到 AWS 选项卡。你会看到你的 S3 桶和λ函数。以下是我的工作空间的屏幕截图

[![](../Images/790ed9aeea3d64a778959397df1e2796.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--6QufwUhO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://miro.medium.com/max/1400/1%2A8mTxYMA9rQWktks83WgJTA.jpeg)

让我们从这里进入 AWS Lambda 控制台，单击 Lambda 功能表下方的第二个 AWS 控制台按钮。在不拥有或管理 AWS 控制台的情况下访问它似乎很神奇。

下面是我的 lambda 函数的屏幕截图。

[![](../Images/32fb19765976dc94fffe42475fbf4f00.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Zv4_hT0q--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://miro.medium.com/max/1400/1%2AK-SbD7eW34plY_gCGg6vEA.jpeg)

点击测试并运行测试。它应该会成功。我们的一个屏幕截图是

[![](../Images/deb120af51dd77274a6803ac5448a603.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ykvJZHJL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://miro.medium.com/max/1400/1%2AhvX8zo8e9JZgy_7F-WkxOA.jpeg)

## [](#9-expose-the-service-via-apigateway)9。通过 APIGateway 公开服务
...
[![](../Images/685ef90658afc14c9221d26cc84dcf64.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9Y5tZlJ7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://miro.medium.com/max/1400/1%2A08qED0kkJ3v_p5-YMmJbNQ.jpeg)

在 Duplo 门户中配置已经创建的 API。有时需要一分钟。Duplo portal 中的 AWS 选项卡将如下所示

[![](../Images/662231efe5a3dd43c41c42c7f205505d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--P94WkZUt--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://miro.medium.com/max/1400/1%2A_jqlgcexdsTQGYKttR182g.jpeg)

## [](#10-test-the-apigateway-lambda-integration)10。测试 APIGateway Lambda 集成

在 Duplo 门户中，选择表格中的 API 网关行，然后单击下面的 AWS 控制台按钮，它将带您进入 API 网关屏幕，如下所示

[![](../Images/2087c542a2e52a9545f60728c8ef480d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--YElPrBd---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://miro.medium.com/max/1400/1%2A6qnWHHvG9dR45s5Wov3FeA.jpeg)

选择第二个 ANY 资源，然后单击 test，如下图所示

[![](../Images/26f6430d9a0b28d29f5d89aedcd450b9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--PZUGnDBc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://miro.medium.com/max/1400/1%2AlJwuztxBPrOLH11-8ucJFQ.jpeg)

这将带您到下面的测试屏幕，在方法下拉列表中选择“GET ”,并在路径文本框中键入 getInfo。单击底部的测试。结果应该是成功的文本“CICD 演示！”如下图所示。

[![](../Images/8f04d3ede662f58d3d9a4695b444f4d1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9-ghk8Qb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://miro.medium.com/max/1400/1%2AgFRmdNVo1RszPMFRg-0xoQ.jpeg)

现在我们已经测试了应用程序 E2E。让我们来“部署”API。在第二个窗格中，操作下拉菜单选择“部署 API”。您需要创建一个新的阶段，将其命名为“dev”并点击 Deploy。这将使 API 公开，并给你一个如下图所示的 URL。

[![](../Images/ec80876bd7a4949022cb98d3bd10860e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vXGaCDQj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://miro.medium.com/max/954/1%2AtytSA99wV8AWKPhzKCHfDw.jpeg)

现在，您可以获取 URL、append /getInfo 并在浏览器中打开它，您应该会看到“CI/CD Demo！”如下图。

[![](../Images/13c13449f4c60fb7904e0eb9f602b5dc.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--EOdDIApp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://miro.medium.com/max/1400/1%2Aj3GFy4tVLRrnIX7YS1QB7A.jpeg)

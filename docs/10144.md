...
> 原文:[https://dev . to/dw alsh 01/managing-user-roles-in-react-using-casl-11 F6](https://dev.to/dwalsh01/managing-user-roles-in-react-using-casl-11f6)
...
### [](#%C2%A0defining-abilities-for-user-roles)为用户角色定义能力
...
### [](#checking-rules-in-the-ui)界面中的检查规则
...
## [](#entire-raw-abilityjs-endraw-file)完整的`ability.js`文件

...
> 原文:[https://dev . to/jean 182/rails-API-with-a-frontend-built-in-react-part-ii-2 jib](https://dev.to/jean182/rails-api-with-a-frontend-built-in-react-part-ii-2jib)
...
## [](#removing-unnecessary-crap)剔除不必要的废话

现在让我们移除一些我们不会用到的东西。在这种情况下，我们将删除位于 src 文件夹中的所有 css 文件和 logo.svg，以及代码中的引用。它应该看起来像上面的图像

[![Src folder](../Images/e119e475d951879d7e2fa5c0ed637dd5.png)T2】](https://niceguysfinishlast.dev/static/541953bdc12335de794360d3f86eb5ce/32b9d/src-first.png)
...
## [](#adding-a-code-formatter)添加代码格式化程序。
...
[![Src folder](../Images/64dc441a8948686d75b6fd1ecea6ed6a.png)T2】](https://niceguysfinishlast.dev/static/9962b5b527ad17f29f4c3d1c483eee14/349f8/prettier-output.png)

## [](#styling-our-app)设计我们的应用程序
...
[![Changing the colors](../Images/77a6393dfb08a816d3d6f9dd78486bc8.png)T2】](https://niceguysfinishlast.dev/static/ccd0d99f5c124914a888d17891498d9c/8844e/text-primary.png)

请注意它是如何从引导默认蓝色变为我们在 _variables.scss 文件中定义的主要颜色的。

## [](#redux-for-global-state)Redux 为全局状态
...
[![Default state](../Images/e1ea0e29141d49afbed75b48839d0a3f.png)T2】](https://niceguysfinishlast.dev/static/56a4c0edbecd2908fbbe5ffb176933d8/2b3f6/getState.png)

很酷吧？

## [](#creating-env-variables)创建环境变量

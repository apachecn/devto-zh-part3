...
> 原文:[https://dev . to/dabi T3/how-to-build-production-ready-vue-authentic ation-23mk](https://dev.to/dabit3/how-to-build-production-ready-vue-authentication-23mk)

[![Production-ready Vue Authentication with AWS](../Images/f7381f3989efee7a8f2d7350a48ec4b1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--1gXjOW5m--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/y99r9vv53zvu298c4mev.jpg)
...
> ![Nader Dabit profile image](../Images/e5f4dbee552070447c02ae734d8d58cc.png)

### [](#authentication-overview)认证概述
...
### [](#creating-the-vue-project)创建 Vue 项目
...
#### [](#creating-the-folder-structure)创建文件夹结构
...
#### [](#initializing-the-amplify-project)初始化放大项目
...
#### [](#adding-the-authentication-service)添加认证服务
...
## [](#part-1-using-the-preconfigured-raw-amplifyauthenticator-endraw-component)第 1 部分-使用预配置的`amplify-authenticator`组件

接下来，我们需要更新 **main.js** 来配置 Vue 项目，以便与我们新的 **aws-exports.js** 文件 Amplify &一起工作。我们还需要让我们的应用程序知道我们将在下一步创建的路由器。

#### [](#srcmainjs)src/main.js
...
#### [](#srccomponentsauthvue)src/components/Auth.vue
...
#### [](#srccomponentshomevue)src/components/Home.vue
...
[![](../Images/882970c3871e4be21615d67fee58266c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--GNsTjoNC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/u5jwiokisa2hh811wnb1.jpg)

登录后，我们应该能够查看受保护的页面。

[![](../Images/deb9158f7840a0e3dc35d92222bab6e4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--HLWaprEL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/m9vdqggm4plbyzaesicm.jpg)
...
# [](#part-2-building-out-a-custom-authentication-flow)第 2 部分-构建自定义认证流程。
...
[![](../Images/144afa399590b2529d4ef047ba59fd56.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--mUpUMVC9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/tt2ltwhac7c8ed1snyjc.jpg)

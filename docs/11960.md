...
> 原文:[https://dev . to/ianknighton/deploying-a-microservice-on-azure-kubernetes-with-let-encrypt-4 eon](https://dev.to/ianknighton/deploying-a-microservice-on-azure-kubernetes-with-lets-encrypt-4eon)
...
### [](#create-an-ingress-controller)创建入口控制器
...
### [](#create-a-cluster-issuer)创建集群发布者
...
### [](#create-a-certificate-object)创建证书对象
...
### [](#grant-access-from-cluster-to-registry)授予从集群到注册表的访问权限
...
### [](#build-and-push-docker-image-to-registry)构建 Docker 映像并将其推送到注册表
...
### [](#deploy-images-to-kubernetes-cluster)将映像部署到 Kubernetes 集群
...
### [](#create-an-ingress-route)创建入口路由

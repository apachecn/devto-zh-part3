...
> 原文:[https://dev . to/jcoelho/10-reasons-to-use-groovy-in-2019-431 f](https://dev.to/jcoelho/10-reasons-to-use-groovy-in-2019-431f)

## [](#why-groovy)为什么是 Groovy？
...
#### [](#11-declaring-listsmaps)1.1 申报清单/地图
...
#### [](#12-iterating-over-listsmaps)1.2 遍历列表/映射
...
### [](#10-regular-expressions)10。正则表达式

...
> 原文:[https://dev.to/laurieontech/the-layers-of-css-3ae5](https://dev.to/laurieontech/the-layers-of-css-3ae5)
...
## [](#css-and-the-dom)CSS 和 DOM

当你在浏览器中打开你的站点时，渲染引擎解析 HTML 并解释 CSS。当它将元素添加到 DOM 树中时，它将元素映射到它们相关的样式。在这里，您可以打开检查器，查看给定元素的具体样式。

[![Chrome inspector showing CSS styles.](../Images/d4c41d0895f07ccef2c5287ff2e2bb9f.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--Etkhw0To--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://developers.google.com/web/tools/chrome-devtools/css/imgs/set-hover.png) 
*如果你愿意，你甚至可以随意改变风格！*

## [](#cascading-styles-like-a-river-in-egypt)层叠式，像埃及的河流
...
## [](#i-know-css-wait-who-is-this-less-person)我知道 CSS！等等，这个少民是谁？！
...
## [](#specificity-and-selectors)特异性和选择器
...
## [](#i-think-i-know-where-this-style-came-from)我想我知道这种风格从何而来？

...
> 原文:[https://dev . to/flexdinesh/don-build-your-portfolio-with-just-react-11 a9](https://dev.to/flexdinesh/dont-build-your-portfolio-with-just-react-11a9)
...
# [](#why-you-should-use-react)为什么要用 React
...
# [](#why-you-shouldnt-use-just-react)为什么不该用刚才的反应
...
# [](#ssr-and-static-site-generation-for-the-rescue)SSR 和 Static Site 代用于救援

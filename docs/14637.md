...
> 原文:[https://dev . to/guimg/how-to-serve-nodejs-applications-with-nginx-on-a-raspberry-jld](https://dev.to/guimg/how-to-serve-nodejs-applications-with-nginx-on-a-raspberry-jld)
...
## [](#prerequisites-and-specifications)先决条件和规范
...
## [](#install-and-run-nginx)安装并运行 Nginx
...
[![Nginx default page](../Images/76b51228d7d981dc382e9cb42f9789e7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--p9uVNp0L--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2A73xWgLveCtpOOoZGywlcqg.png)
...
## [](#create-a-nodejs-app)创建 Node.js app
...
## [](#nginx-proxy-to-the-app)Nginx 代理到 app
...
[![Node app served with nginx](../Images/e7f1b47c6b2171d1a4ab00968bfbb325.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--THn9n4zm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2Ay7oBAnhKV1SDW7vx-c2Nrg.png)

## [](#configure-ip-tables)配置 IP 表
...
## [](#dhcp-ip-reservation)DHCP IP 预留

...
> 原文:[https://dev . to/simone ch/the-ray-tracer-challenge-setting-the-project-with-the-dot net-CLI-4016](https://dev.to/simonech/the-ray-tracer-challenge-setting-up-the-project-with-the-dotnet-cli-4016)
...
## [](#libraries-used-xunit)使用的库:xUnit
...
## [](#creating-the-project-structure-using-the-dotnet-cli)使用 dotnet CLI 创建项目结构

...
> 原文:[https://dev . to/zellwk/publishing-packages-the-can-used-in-browsers-and-node-4fd 9](https://dev.to/zellwk/publishing-packages-that-can-be-used-in-browsers-and-node-4fd9)
...
## [](#writing-a-package-for-use-in-browsers)编写在浏览器中使用的包
...
## [](#writing-a-package-for-node)为节点编写一个包
...
<figure>[![](../Images/22554f44642eb217ddef81fe8b3bee90.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--bvm8a83q--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://zellwk.com/images/2019/authoring-packages/node-project.png) 
...
[![](../Images/4107ca74353c20abad25afa2dc7dabd4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--2XGT0lTP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://zellwk.com/images/2019/authoring-packages/run-node.png)

### [](#adding-libraries-to-node)向节点添加库
...
[![](../Images/4ef1f933a47cc7a6634e0add2e4a57fd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ddFl3VRr--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://zellwk.com/images/2019/authoring-packages/log-fs.png)
...
[![](../Images/8822c5a9ae99abe0345596fbfd81d51f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--P3IDOn0h--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/v1/2019/authoring-packages/log-express.png)

第三，如果您将`./`添加到`require`，Node 将查找位于当前目录中的文件。这是我们开始编写`peach-blossom`库的地方。

### [](#writing-your-first-library-for-node)为节点编写第一个库
...
<figure>[![](../Images/4f1e80ebe54b9e3249fb4544285a9f33.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--LRfAkkVz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/v1/2019/authoring-packages/node-peach-blossom.png) 
...
<figure>[![](../Images/9713fdb6d842547656830201829c8bdd.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--PyZbsVhv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/v1/2019/authoring-packages/node-peach-blossom-error.png) 
...
### [](#publishing-your-library-as-an-npm-package)将您的库发布为 npm 包
...
## [](#writing-modules-that-are-usable-in-both-frontend-and-backend-javascript)编写前端和后端都可用的 JavaScript 模块

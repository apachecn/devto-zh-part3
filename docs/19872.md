...
> 原文:[https://dev . to/rhymes/how-to-make-python-code-concurrent-with-3-lines-of-code-2fpe](https://dev.to/rhymes/how-to-make-python-code-concurrent-with-3-lines-of-code-2fpe)

我的灵感来自于 [@rpalo](https://dev.to/rpalo) 探索 Python 标准库中的宝石

[![rpalo](../Images/36441fefd071e9a78e983319aa0f9264.png)](/rpalo) [## 默认规则:永远不要再检查一个键是否存在！

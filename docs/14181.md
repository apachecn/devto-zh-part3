...
> 原文:[https://dev . to/Apium _ hub/CSS-grid-solution-to-the-problems-of-float-and-flexbox-3hdn](https://dev.to/apium_hub/css-grid-solution-to-the-problems-of-float-and-flexbox-3hdn)

在继续解释什么是 *CSS 网格*以及它的用途之前，我将解释我们在开发网站布局时所拥有的工具的当前状态。

假设我们想要创建以下布局:

[![](../Images/734941ea5d0c992cc25d6e608044acdd.png)T2】](https://apiumhub.com/wp-content/uploads/2019/02/navbar1.png)
...
## [](#using-unnecessary-tags)使用不必要的标签
...
[![layout navbar](../Images/f9965d3db81a142e9cbcd82883993c7a.png)T2】](https://apiumhub.com/wp-content/uploads/2019/02/navbar2.png)

[拉小提琴](https://jsfiddle.net/arnausd/asgvjbxL/)

## [](#gridtemplatecolumns-and-gridtemplaterows)网格-模板-列和网格-模板-行
...
[![navbar layout](../Images/cbecb71bcad48190c5b86a2be300c1ca.png)T2】](https://apiumhub.com/wp-content/uploads/2019/02/navbar3.png)

## [](#gridcolumn-and-gridrow)网格-列和网格-行
...
[![](../Images/ae09b01fc004c6e3c23a8be548318aa6.png)T2】](https://apiumhub.com/wp-content/uploads/2019/02/5.png)
...
[![css grid](../Images/042a33b953ca1bc711eddad0473540d5.png)T2】](https://apiumhub.com/wp-content/uploads/2019/02/navbar6.png)

[拉小提琴](https://jsfiddle.net/arnausd/8men10jd/)

## [](#repeat-fr-and-gridgap)重复()，fr 和 grid-gap
...
[![css grid layout web](../Images/dd035ccd2616ba0f2ddf94b0b107029e.png)T2】](https://apiumhub.com/wp-content/uploads/2019/02/navbar7.png)

## [](#gridtemplateareas)网格-模板-区域
...
[![navbar css grid](../Images/3b354a9b4d30ca2c594b2deaeeb7599b.png)T2】](https://apiumhub.com/wp-content/uploads/2019/02/navbar9.png)
...
[![navbar layout web css grid](../Images/43bc7495e663f73cb04bebe20471d280.png)T2】](https://apiumhub.com/wp-content/uploads/2019/02/navbar10.png)

我给 codepen 添加了一个链接,在这个链接中我可以修改属性 grid-template-areas，这样就可以看到布局是如何变化的。

## [](#when-to-use-css-grid)何时使用 css 网格

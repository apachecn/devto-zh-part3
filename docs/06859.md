...
> 原文:[https://dev . to/param Harrison/learn-by-building-a-book-search-app-using-react-and-its-siblings-part-1-1590](https://dev.to/paramharrison/learn-by-building-a-book-search-app-using-react-and-its-siblings-part-1-1590)
...
## [](#search-input-state-using-usestate-hooks)使用 useState 钩子搜索输入状态
...
## [](#axios-data-call-for-books-api)Axios 数据调用书籍 API
...
## [](#updating-books-search-result-to-state)更新图书搜索结果到状态
...
## [](#ui-for-books-search-result)图书搜索结果界面

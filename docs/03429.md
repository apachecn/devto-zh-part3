...
> 原文:[https://dev . to/christianotto/enriching-a-minimal-JavaScript-todo-app-with-orgenic-ui-ni1](https://dev.to/christianotto/enriching-a-minimal-javascript-todo-app-with-orgenic-ui-ni1)

**一个小的待办事项 app。嗯，没什么新东西，对吧？添加新任务，然后将它们标记为完成或未完成，甚至将它们从列表中完全删除...听起来可行。**

这里有一个小模型，它可能看起来像。

[![ToDo-App mockup](../Images/0f6116ef02421a41b81a239bf7f2fc97.png "ToDo-App mockup")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--eEW4AsvL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/bbg249weoasp20dx3dg4.png)
...
## [](#orgenic-ui)ORGENIC UI

好了，是时候介绍一下 **[ORGENIC UI](https://orgenic.org/)** 了，这是一组新的、不断增长的现成 web 组件，支持通过 CSS 自定义属性(也称为 CSS 变量)进行主题化。

[![ORGENIC UI](../Images/c6dbbe59bd801ba1f5f8f31938595b2b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--J3JG7PRZ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/kqjmketpffonnxnr1kmf.png)

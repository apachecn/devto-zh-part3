...
> 原文:[https://dev . to/Davids bond/golang-creating-distributed-systems-using-member list-2fa 9](https://dev.to/davidsbond/golang-creating-distributed-systems-using-memberlist-2fa9)
...
### [](#creating-a-simple-cluster)创建简单的集群
...
### [](#communication-between-members)成员之间的交流

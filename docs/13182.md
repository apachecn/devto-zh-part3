...
> 原文:[https://dev . to/vinay hegde 1990/automated-SSL-on-our-internal-applications-51hn](https://dev.to/vinayhegde1990/automated-ssl-on-our-internal-applications-51hn)
...
[![Image Courtesy](../Images/5422a29fed24236a0651aa4b545686cc.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--D2CnKdsi--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cheapsslsecurity.com/blog/wp-content/uploads/2017/10/ssl-tls-handshake-process-1024x670.png)
...
[![Our Reaction on discovering LetsEncrypt](../Images/2331940c87b39d19c82656b9203ee545.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--jsnO3LOt--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgflip.com/1cvwdb.jpg)

### [](#our-situation)**我们的处境如何？**
...
为了涵盖以上所有要点，我们开始使用托管我们所有基础设施的 AWS API 在[](https://id-rsa.pub/post/certbot-auto-dns-validation-with-lexicon/)**组合中创建一个 Shell 脚本。由于 LetsEncrypt 坚持高合规性，任何人为一个域生成或更新 SSL 的人也应该能够证明其所有权。这可以通过 [**方法**](https://letsencrypt.org/how-it-works/) 实现，如 **HTTPS** 通过独立网络服务器验证，或者 **DNS** 通过发布临时解析 TXT 记录验证。**

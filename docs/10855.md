...
> 原文:[https://dev . to/codebrotha/how-to-fix-MAC OS-corrupt-trash-4 jpg](https://dev.to/codebrotha/how-to-fix-macos-corrupt-trash-4jpg)

在一个典型的工作日，我倾向于在我的桌面上积累临时文件。这些可能是占位符图像或我为以后编写的代码片段，或者是从 Stack Overflow“借用”的...

[![](../Images/09df05446019ff1c9487d2cd292d20a0.png)T2】](https://i.giphy.com/media/XreQmk7ETCak0/giphy.gif)

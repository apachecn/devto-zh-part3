...
> 原文:[https://dev . to/aro MIG/c-OOP-data-types-struts-and-classes-453 p](https://dev.to/aromig/c-oop-data-types-structs-and-classes-453p)
...
## [](#value-types-vs-reference-types)值类型 vs 引用类型

### 一个类和一个结构有多大的不同？

虽然它们看起来很相似，都可以作为数据结构的蓝图，但是结构和类之间还是有一些主要的区别。

#### [](#structs-are-value-types)结构是值类型
...
[![Stack vs Heap Visual](../Images/ae621770ae5c2052e6a41db858b756bf.png "Stack vs Heap Visual")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--qgGJkNA5--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://romig.dev/assets/images/blog/stack-v-heap.jpg)
...
#### [](#why-do-we-have-a-stack-and-a-heap)为什么我们会有栈和堆？

...
> 原文:[https://dev . to/pamil/tame-behat-with-the-brand-new-symfony-extension-ih9](https://dev.to/pamil/tame-behat-with-the-brand-new-symfony-extension-ih9)
...
### [](#support-for-symfonys-autowiring-and-autoconfiguration)支持 Symfony 的自动布线和自动配置
...
#### [](#behatsymfony2extension)行为/符号 2 扩展
...
### [](#symfony-flex-recipe)Symfony Flex 配方
...
### [](#zeroconfiguration-for-most-symfony-3-and-4-based-apps)大多数基于 Symfony 3 和 4 的应用程序的零配置

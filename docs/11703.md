...
> 原文:[https://dev . to/karlredman/resolve-docker-hostnames-from-host-with-DNS-proxy-server-1d 08](https://dev.to/karlredman/resolve-docker-hostnames-from-host-with-dns-proxy-server-1d08)
...
## [](#additional-features-added-to-the-previous-howto)添加到[上的附加功能](https://dev.to/karlredman/dnsmasq--networkmanager--private-network-setup-258l):
...
### [](#allow-for-async-nameserver-lookups)允许异步名称服务器查找
...
### [](#add-dps-configuration-to-networkmanager)将 DPS 配置添加到网络管理器
...
### [](#create-dps-config-file)创建 DPS 配置文件
...
### [](#obtain-and-build-a-docker-image-for-testing)获取并构建 docker 映像进行测试
...
### [](#start-example-containers)启动示例容器
...
### [](#view-dps-web-page-doesnt-seem-to-work-for-me)查看 DPS 网页(好像对我不起作用)
...
### [](#test-addresses-via-browser)通过浏览器测试地址
...
### [](#test-dockercompose-instance)测试 docker-撰写实例

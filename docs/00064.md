...
> 原文:[https://dev . to/ikey 2244/beginner-s-guide-to-a-developer-work-environment-part-1-ibk](https://dev.to/ikey2244/beginner-s-guide-to-a-developer-work-environment-part-1-ibk)
...
### [](#4-zshohmyzshmacos-or-windows)4。Zsh(oh-my-zsh)(MacOs 或 Windows)
...
### [](#5-visual-studio-codemacos-or-windows)5。Visual Studio 代码(MacOs 或 Windows)

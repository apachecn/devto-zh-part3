...
> 原文:[https://dev.to/soasme/enqueuezero-techshack-2019-06-nil](https://dev.to/soasme/enqueuezero-techshack-2019-06-nil)

# enqueue zero Techshack 2019-06

## [](#a-kubernetes-developer-workflow-for-macos)面向 MacOS 的 Kubernetes 开发者工作流
...
## [](#what-you-need-to-know-gitops)你需要知道的事情- GitOps
...
## [](#introducing-aresdb-ubers-gpupowered-open-source-realtime-analytics-engine)介绍 AresDB:优步基于 GPU 的开源实时分析引擎
...
[![aresdb architecture](../Images/950c8aab42f16cf7b2d00160a6fda708.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9fh_5gr4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://eng.uber.com/wp-content/uploads/2019/01/image20-1068x605.png)
...
## [](#from-activemq-to-amazon-mq-why-and-how-we-moved-to-awss-managed-solution)从 ActiveMQ 到 Amazon MQ:我们为什么以及如何迁移到 AWS 的托管解决方案
...
## [](#kubernetes-failure-stories)Kubernetes 的失败故事
...
## [](#cnab-packagaging-for-applications-with-multiple-toolchains)CNAB:用多个工具链打包应用程序
...
## [](#distributing-with-distribution-upcoming-changes-to-helm-chart-repositories)随分布分布:舵图库即将发生的变化
...
## [](#target-labels-are-for-life-not-just-for-christmas)目标标签是为了生活，而不只是为了圣诞节
...
## [](#journey-to-event-driven-part-1-why-eventfirst-thinking-changes-everything)事件驱动之旅——第一部分:为什么事件优先思维会改变一切
...
## [](#overload-control-for-scaling-wechat-microservices)伸缩微信微服务的过载控制
...
[![3-tier services](../Images/c50eee7ea6f6cb692ff5e63eed6db0fb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--0JMxlmC4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://adriancolyer.files.wordpress.com/2018/11/dagor-fig-1.jpeg)
...
[![drop requests](../Images/458f2de514960b00dfa793f237745010.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--U9i4l7nS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://adriancolyer.files.wordpress.com/2018/11/dagor-fig-4.jpeg)
...
## [](#stranglerapplication)绞杀应用

[martinfowler.com](https://www.martinfowler.com/bliki/StranglerApplication.html)

[![stranger](../Images/dc76923a6c04319e5423c8fc81202f87.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--1gxOf9Vw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.martinfowler.com/bliki/images/stranglerApplication/11090068.jpg)
...
[![githistory.xyz](../Images/937dac98616cf585830fe5de5d5a95b6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Jo8cmrUc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://githistory.xyz/static/media/demo.165514d4.gif)

## [](#dotfile-madness)网络疯癫

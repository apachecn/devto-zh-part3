...
> 原文:[https://dev . to/Simon _ sugob/terra form-quick-reference-guide-47n 8](https://dev.to/simon_sugob/terraform-quick-reference-guide-47n8)
...
### [](#why-do-i-love-terraform-for-5-reasons)我为什么爱 Terraform？–出于 5 个原因:
...
[![Terraform Quick Reference Guide](../Images/945edb0f8e4c253814a5378d83e7f990.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Pj1lL-nz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.hiredevops.org/wp-content/uploads/2019/01/terraform-quick-reference-guide-1200x900.png)

## [](#q1-why-terraform)Q1。**为什么是 Terraform？**
...
## [](#q2-how-terraform-compares-to-other-infrastructure-as-code-tools)Q2。**作为代码工具，Terraform 与其他基础设施相比如何？**
...
## [](#q3-where-can-i-find-terraform-guide-best-practices-and-tips)Q3。**我在哪里可以找到 Terraform 指南、最佳实践和技巧？**
...
## [](#q4-why-should-you-contribute-to-terraform)Q4。**你为什么要为 Terraform 做贡献？**
...
## [](#q5-why-terraform-modules-and-how-to-build-them)Q5。**为什么要 Terraform 模块，如何构建？**
...
## [](#q6-what-about-repository-structure)Q6。**存储库结构怎么样？**
...
## [](#q7-how-to-provide-zero-downtime-updates-with-terraform)Q7。**如何使用 Terraform 提供零停机更新？**
...
## [](#q8-how-to-get-started-with-terraform-automation)Q8。**如何开始使用 Terraform Automation？**
...
## [](#q9-using-terraform-with-different-cloud-providers)Q9。**通过不同的云提供商使用 Terraform。**
...
## [](#q10-terraforms-integration-with-other-devops-tools)Q10。 **Terraform 与其他 DevOps 工具的集成。**

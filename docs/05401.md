...
> 原文:[https://dev . to/hackersandslackers/plotting-data-with-seaborn-and-pandas-59nk](https://dev.to/hackersandslackers/plotting-data-with-seaborn-and-pandas-59nk)

[![Plotting Data With Seaborn and Pandas](../Images/ff9ed1d016ab69f017395213efab53c2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--BTKb2F3d--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://hackersandslackers.com/content/images/2019/04/seaborn-2-1.jpg)
...
## [](#preparing-data-in-pandas)在熊猫中准备数据
...
### [](#fixing-our-temperatures)固定我们的温度
...
### [](#adjusting-our-datatypes)调整我们的数据类型
...
### [](#seabornfriendly-data-formatting)Seaborn 友好的数据格式
...
### [](#setting-our-chart-colors)设置我们的图表颜色
...
[![Plotting Data With Seaborn and Pandas](../Images/e384abc7976c459f6599491eb44c0ed1.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--RyOu5PGa--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://hackersandslackers.com/content/images/2019/04/download-1.png) 
...
[![Plotting Data With Seaborn and Pandas](../Images/0df27b40927c8cb4b37aae448c87ba6f.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--IJtBRsrc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://hackersandslackers.com/content/images/2019/04/plot.png) 

<figcaption>看哪:一块空白的画布。</figcaption>

我们现在已经设置了图表的样式，设置了大小尺寸，并给它起了个名字。我们差不多准备好做生意了。

## [](#plotting-line-charts)绘制折线图

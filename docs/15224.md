...
> 原文:[https://dev . to/Denise pen/setting-up-travel-for-a-rails-application-part-2-2g km](https://dev.to/denisepen/setting-up-vagrant-for-a-rails-application-part-2--2gkm)
...
### [](#configuring-the-vagrant-box)配置流浪箱
...
## [](#creating-an-application-from-scratch)从头开始创建应用程序

如果您将从头开始创建一个应用程序，您将需要在您的本地机器上这样做。

### [](#performed-on-you-local-machine-not-vagrant)在您的本地机器上执行-非流浪者
...
## [](#using-an-existing-application)使用现有的应用程序

...
> 原文:[https://dev . to/graphql editor/-installing-MongoDB-for-graphql-3 LMA](https://dev.to/graphqleditor/-installing-mongodb-for-graphql-3lma)

我的同事阿图尔关于如何用 GraphQL 设置 MongoDB 的简短教程。

## [](#install-mongodb-with-homebrew)用家酿安装 MongoDB
...
[![Done!](../Images/db49da64d9621046e244549e6c39e6eb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Csd25QOs--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/y339isgl6y1so36a7wig.gif)
...
> 原文:[https://dev . to/azu/write-snapshot s-testing-without-jest-1 PCG](https://dev.to/azu/write-snapshots-testing-without-jest-1pcg)
...
### [](#setup-snapshot-input-file)设置快照输入文件
...
### [](#create-outputjsonsnapshot-from-inputjson)从 input.json 创建 output.json(快照)

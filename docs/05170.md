...
> 原文:[https://dev . to/sync fusion/7-tips-to-optimize-xa marin-charts-performance-3m1h](https://dev.to/syncfusion/7-tips-to-optimize-xamarin-charts-performance-3m1h)
...
## [](#1-use-fast-line-series-instead-of-line-series)**#1:用快线系列代替线系列**
...
## [](#2-do-not-use-data-markers-use-trackball-or-tooltips)**#2:不使用数据标记，使用轨迹球或工具提示**
...
## [](#3-reduce-the-stroke-width-of-the-fast-line-series-to-1)**#3:将快线条系列的笔画宽度减少为 1**
...
## [](#4-make-use-of-suspendseriesnotification-and-resumeseriesnotification)**#4:利用暂停系列通知和简历通知**
...
## [](#5-disable-the-antialiasing)**#5:禁用抗锯齿**
...
## [](#6-avoid-categoryaxis-use-numericalaxis-and-datetimeaxis)**#6:避免分类混乱，使用数轴和日期时间轴**
...
## [](#7-replace-the-fastlineseries-with-fastlinebitmapseries-in-uwp)**#7:在 UWP 用 FastLineBitmapSeries 替换 FastLineSeries】**

...
> 原文:[https://dev . to/samthor/arrow-functions-break-JavaScript-parsers-1 LDP](https://dev.to/samthor/arrow-functions-break-javascript-parsers-1ldp)

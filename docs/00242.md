...
> 原文:[https://dev . to/techiediaries/angular-8-data-binding-tutorial-build-your-first-angular-app-53lp](https://dev.to/techiediaries/angular-8-data-binding-tutorial-build-your-first-angular-app-53lp)
...
## [](#angular-property-binding-by-example)角度属性绑定示例
...
## [](#angular-event-binding-by-example)角事件通过例子绑定

...
> 原文:[https://dev . to/Levi VM/creating-a-server less-rest-API-using-Google-cloud-functions-firebasefirestore-in-10-min-37km](https://dev.to/levivm/creating-a-serverless-rest-api-using-google-cloud-functions-firebasefirestore-in-10-min-37km)

# [](#api-rest-using-google-cloud-functions-serverless)API REST 使用谷歌云功能(无服务器)
...
## [](#%C2%A0creating-our-firebase-project)创建我们的 firebase 项目
...
[![image1](../Images/355ccf80116b8b6cdc46252b7fc2e1dd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--hMGfib_x--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/m6tvhhv2ifz29iugrctp.png)

为了创建我们的数据库，点击*开发* > *数据库*，并选择“以测试模式启动”。

[![image2](../Images/c5ec329c2bcf51b387e69927371f7282.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--lhV6-l1a--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/uckh6gvzzcv9wnhk37tv.png)
...
[![image3](../Images/593ffa7243682945782f6758cb035f67.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--zuqNXuw6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/gx4iai2itqmmxsfjftlz.png)
...
## [](#installing-expressjs-and-dependencies)安装 Express.js 及依赖项
...
## [](#creating-our-google-cloud-function)创建我们的谷歌云功能

打开`src/index.ts`，这将是我们 Express.js 服务器的入口点

### [](#%C2%A0import-main-libraries)导入主库
...
### [](#initialize-firebase-for-accesing-to-its-services)初始化 firebase 以访问其服务

```
admin.initializeApp(functions.config().firebase); 
```

### [](#intialize-expressjs-server)初始化 Express.js 服务器
...
### [](#%C2%A0export-our-function)导出我们的函数。
...
### [](#creating-our-first-service)创建我们的第一个服务
...
### [](#%C2%A0deploying-our-function)部署我们的功能。
...
### [](#%C2%A0testing-our-function)测试我们的功能
...
[![image4](../Images/461ec568a4ee7c1b14ed9c534f485d6e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Xg03hSz7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/fepjsdvbvkwz47t1ftoq.png)

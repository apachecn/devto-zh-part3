...
> 原文:[https://dev . to/oktadev/create-and-verify-jwts-in-PHP-with-oauth-2-0-5713](https://dev.to/oktadev/create-and-verify-jwts-in-php-with-oauth-2-0-5713)
...
## [](#the-big-secret-about-user-authentication)关于用户认证的大秘密
...
## [](#store-and-use-jwts-securely)安全存放和使用 jwt
...
## [](#use-jwts-for-access-tokens-in-php)在 PHP 中使用 jwt 进行访问令牌
...
## [](#learn-more-about-php-jwts-and-secure-authentication)了解关于 PHP、JWTs 和安全认证的更多信息

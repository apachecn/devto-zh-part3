...
> 原文:[https://dev . to/ken bellows/current color-the-first-CSS-variable-12dl](https://dev.to/kenbellows/currentcolor-the-first-css-variable-12dl)

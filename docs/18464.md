...
> 原文:[https://dev.to/zac_siegel/how-to-deploy-java-apps-in-docker-15h](https://dev.to/zac_siegel/how-to-deploy-java-apps-in-docker--15h)
...
## [](#create-a-dockerfile-for-your-java-app)为你的 Java 应用创建 docker 文件
...
## [](#build-and-run-your-java-app-in-the-docker-container)在 Docker 容器中构建并运行您的 Java 应用程序

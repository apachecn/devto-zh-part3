...
> 原文:[https://dev . to/sel bekk/how-to-write-a-progressive-image-loading-hook-1jj 2](https://dev.to/selbekk/how-to-write-a-progressive-image-loading-hook-1jj2)

当我们优化 JavaScript 包中的每一千字节时，我们经常忘记以同样的方式优化我们的图像加载策略。在英雄图像加载之前，我们可能会看着一个空白的屏幕几秒钟，为你的白色文本提供背景。

这篇文章将向你展示如何编写一个钩子来处理你的渐进式图片加载！

> ## [](#whats-progressive-image-loading)什么是渐进式图像加载？
> 
...
> ### [](#whats-with-the-action-types)动作类型是什么？
> 

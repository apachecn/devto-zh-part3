...
> 原文:[https://dev . to/rocksetcloud/building-a-live-dashboard-on-streaming-data-using-Amazon-kinesis-and-rockset-5 Gai](https://dev.to/rocksetcloud/building-a-live-dashboard-on-streaming-data-using-amazon-kinesis-and-rockset-5gai)
...
### [](#setting-up-a-kinesis-stream)**设置变身流**

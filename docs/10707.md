...
> 原文:[https://dev . to/rpalo/advanced-argument-handling-in-bash-377 b](https://dev.to/rpalo/advanced-argument-handling-in-bash-377b)
...
## [](#1-parameter-substitution)1。参数代换
...
### [](#11-required-values-raw-1error-message-endraw-)1.1。必需值:`${1:?Error Message}`
...
### [](#12-default-values-raw-1default-endraw-)1.2。默认值:`${1:-default}`
...
### [](#13-assign-a-default-raw-varvalue-endraw-)1.3。分配默认值:`${var:=value}`
...
### [](#14-alternative-values-raw-1value-endraw-)1.4。可选值:`${1:+value}`
...
## [](#2-lets-get-raw-shift-endraw-y)2。让我们开始吧
...
#### [](#311-the-main-option-loop)3.1.1。主选项循环
...
#### [](#312-matching-the-options)3.1.2。匹配选项
...
#### [](#313-the-magic-of-raw-optind-endraw-)3.1.3。`$OPTIND`的魔力
...
#### [](#314-handling-positional-arguments)3.1.4。处理位置参数
...
#### [](#316-handling-errors)3.1.6。处理错误
...
#### [](#321-the-new-loop-condition)3.2.1。新的循环条件
...
#### [](#322-matching-the-options)3.2.2。匹配选项
...
#### [](#323-handling-multiple-options-on-a-single-dash)3.2.3。在单个仪表板上处理多个选项
...
#### [](#324-handling-options-with-arguments)3.2.4。处理带参数的选项
...
#### [](#325-end-of-arguments)3.2.5。争论结束
...
#### [](#326-finishing-the-loop)3.2.6。完成循环
...
#### [](#327-handling-errors)3.2.7。处理错误
...
## [](#4-looking-forward-some-more)4。期待更多

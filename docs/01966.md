...
### [](#note-app-more-on-that-app-here)笔记 app。更多关于那个应用的信息[点击这里](https://dev.to/antonrich/note-app-practice-with-elm-some-struggles-as-well-1g8p)

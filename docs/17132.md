...
> 原文:[https://dev . to/full stack cafe/20-tricky-es6-interview-questions-to-breach-your-JavaScript-skills-5a4o](https://dev.to/fullstackcafe/20-tricky-es6-interview-questions-to-revamp-your-javascript-skills-5a4o)

[![20 Tricky ES6/ES2015 Interview Questions to Revamp Your Javascript Skills](../Images/473362f0a502ea92620f7e3cd416e1ff.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--FIkPqMgJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://images.pexels.com/photos/611328/pexels-photo-611328.jpeg%3Fauto%3Dcompress%26cs%3Dtinysrgb%26dpr%3D2%26w%3D500) 
...
### [](#q2-what-is-iifes-immediately-invoked-function-expressions)Q2:什么是 IIFEs(立即调用函数表达式)？
...
### [](#q4-what-is-the-motivation-for-bringing-symbols-to-es6)Q4:把符号带到 ES6 的动机是什么？
...
### [](#q5-what-are-the-benefits-of-using-spread-syntax-in-es6-and-how-is-it-different-from-rest-syntax)Q5:在 ES6 中使用 spread 语法有什么好处，与 rest 语法有什么不同？
...
### [](#q8-why-should-we-use-es6-classes)Q8:为什么要用 ES6 类？
...
### [](#q10-explain-the-difference-between-objectfreeze-vs-const)Q10:解释 Object.freeze()与 const 的区别
...
### [](#q12-explain-the-prototype-design-pattern)Q12:解释原型设计模式
...
### [](#q20-how-to-deepfreeze-object-in-javascript)Q20:如何在 JavaScript 中“深度冻结”对象？

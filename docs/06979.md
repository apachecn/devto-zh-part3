...
> 原文:[https://dev . to/serhatteker/django-环境-变量-2hjp](https://dev.to/serhatteker/django-environment-variables-2hjp)
...
### [](#2-djangoenviron-module-library)2 - Django-Environ 模块库

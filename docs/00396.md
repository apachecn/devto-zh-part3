...
> 原文:[https://dev.to/trezy/on-handlebars-and-template-tags-19ic](https://dev.to/trezy/on-handlebars-and-template-tags-19ic)
...
## [](#why-isnt-this-being-used-elsewhere)这个为什么没有用在别的地方？

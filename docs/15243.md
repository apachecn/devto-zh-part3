...
> 原文:[https://dev . to/Brett Mn/beauty-with-lighting-web-components-2 plk](https://dev.to/brettmn/prettier-with-lighting-web-components-2plk)
...
#### [](#-raw-prettierignore-endraw-)`.prettierignore`

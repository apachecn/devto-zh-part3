...
> 原文:[https://dev . to/pauls wail/migrating-authentic ation-from-express-js-to-API-gateway-using-a-lambda-authorizer-450m](https://dev.to/paulswail/migrating-authentication-from-express-js-to-api-gateway-using-a-lambda-authorizer-450m)
...
## [](#using-a-lambda-authorizer-to-authenticate-api-requests)使用 Lambda 授权器认证 API 请求
...
## [](#reverse-engineering-the-express-authentication-logic)逆向工程快速认证逻辑
...
## [](#allowing-and-denying-requests)允许和拒绝请求
...
## [](#wiring-up-auth-logic-to-a-private-endpoint)将验证逻辑连接到私有端点

...
> 原文:[https://dev . to/black smoke 16/utilizing-macros-annotations-in-a-web-framework-3abk](https://dev.to/blacksmoke16/utilizing-macros-annotations-in-a-web-framework-3abk)
...
## [](#auto-registering-cli-commands)自动注册 CLI 命令

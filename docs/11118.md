...
> 原文:[https://dev . to/flaviabastos/display-nested-dictionary-content-sorted-by-key-in-python-314 l](https://dev.to/flaviabastos/display-nested-dictionary-content-sorted-by-key-in-python-314l)

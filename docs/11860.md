...
> 原文:[https://dev . to/renegade coder 94/be-CAID-with-strings-substring-method-in-Java-gjg](https://dev.to/renegadecoder94/be-careful-with-strings-substring-method-in-java-gjg)

...
> 原文:[https://dev . to/lennythedev/prop-drilling-react-context-and-higher-order-component-hoc-40 M9](https://dev.to/lennythedev/prop-drilling-react-context-and-higher-order-component-hoc-40m9)

对 React Context 感到好奇，使用 HoC 来概括上下文消费者，为什么您可能需要使用 contextType，或者什么是 prop-drilling？🤔

[![prop drilling](../Images/9203fa818bcac53f8aa5ad04b631fe77.png)T2】](https://i.giphy.com/media/3NtEfcZmzePW6Ps7Gn/giphy-downsized.gif)

如果是，酷！继续读下去，因为这可能是帮助你开始了解上下文的指南。

# [](#intro-why-you-need-react-context-)简介:为什么需要 React 上下文？

[![Theming with prop drilling](../Images/a52fd1b8dd46d7eacad7de305a5c5cac.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--AJJMWQNa--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/fupirzu2t7zqttlpcdkb.png)
...
### [](#context-provider-raw-ltthemecontextprovidergt-endraw-)上下文提供者:`<ThemeContext.Provider>`
...
### [](#context-consumer-raw-ltthemecontextconsumergt-endraw-)语境消费者:`<ThemeContext.Consumer>`
...
# [](#using-a-higher-order-component-hoc-to-generalize-a-context-container)使用高阶组件(HoC)来概括上下文容器
...
# [](#adding-stuff-to-the-context)向上下文添加内容
...
[![Adding data in context](../Images/a386650e99f3ed63d72cf64417f7678a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--LwNGvLpM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/w2rjfhptvf9ui18710z3.png)

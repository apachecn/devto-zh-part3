...
> 原文:[https://dev . to/harshadranganathan/deploy-react-app-to-your-server-with-Travis-ci-3212](https://dev.to/harshadranganathan/deploy-react-app-to-your-server-with-travis-ci-3212)
...
## [](#install-travis-cli)安装 Travis CLI
...
## [](#generate-and-encrypt-private-key)生成并加密私钥
...
## [](#create-a-new-user-for-travis-in-your-server)在您的服务器上为 Travis 创建一个新用户
...
## [](#setup-travisyml)Setup .travis.yml
...
### [](#adding-to-ssh-known-hosts)向 SSH 添加已知主机
...
### [](#safelist-travis-ip-addresses)安全列表 Travis IP 地址

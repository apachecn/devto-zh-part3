...
> 原文:[https://dev.to/jeikabu/powershell-crash-course-3go5](https://dev.to/jeikabu/powershell-crash-course-3go5)
...
## [](#shell-keyboard-shortcuts)外壳键盘快捷键
...
[![](../Images/698345176a2bcabe901c073094c91a78.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--Y-_lK1b---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://rendered-obsolete.github.io/assets/osx_term_option.png) 使用`Option`(推荐)
...
## [](#parameters-and-functions)参数和功能
...
*   在 Windows 上，安装 PowerShell Core，并在 Visual Studio 代码中单击“PowerShell 会话菜单”:![](../Images/9530708d47d0bcba672a254d5b228dc3.png)

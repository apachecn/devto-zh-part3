...
> 原文:[https://dev.to/prestonjlamb/unit-testing-in-angular-56bn](https://dev.to/prestonjlamb/unit-testing-in-angular-56bn)
...
## [](#testing-utilities)[测试实用程序](#testing-utilities)
...
## [](#testing-pipes)[测试管道](#testing-pipes)
...
## [](#testing-services)[检测服务](#testing-services)
...
## [](#testing-directives)[检测指令](#testing-directives)
...
## [](#testing-components)[检测组件](#testing-components)
...
## [](#testing-guards)[测试守卫](#testing-guards)

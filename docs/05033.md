...
> 原文:[https://dev . to/dceddia/implementing-a-mock up-CSS-layout-step-by-step-3ag 0](https://dev.to/dceddia/implementing-a-mockup-css-layout-step-by-step-3ag0)

[![Implementing a mockup with CSS](../Images/38525b2c2910994001ec23d09ed71093.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--i5PFxfVI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://daveceddia.com/images/css-layout-header.png)
...
## [](#a-small-layout-example)一个小的布局例子

在这篇文章中，我们将复制一些看起来像推文的东西:

[![Sketch of a tweet](../Images/a60c9e7b34114bd3478ff56b990689a3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Rdql3UzX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://daveceddia.com/images/tweet-sketch.jpg)

无论你是从这样的草图开始，还是从一个像素完美的模型开始，有一些东西开始都是一个好主意。

当你在头脑中设计 CSS 布局的同时，不试图在浏览器中胡乱拼凑时，它会进行得更顺利。你绝对*能*达到那个水平！但是如果你正在读这篇文章，我会假设你还没有到*:)*

 *## [](#first-step-identify-the-pieces)第一步:识别棋子

在我们编写任何 HTML 或 CSS 之前，我们将突出显示这个布局的各个部分:

[![Tweet with component parts highlighted](../Images/409fbf45df00317a7aa86013caf95a1a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Scw2f3f2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://daveceddia.com/images/tweet-highlighted.jpg)
...
## [](#second-step-draw-boxes-around-stuff)第二步:在东西周围画方框

让我们在元素周围画一些方框，看看我们是否能把它变成一些行和列的外观。我们将在流向相同的部分周围放置方框。

[![Tweet with boxes around sections](../Images/6438c9ec28b01b5e875b4ac79a752474.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--HyMfqXbw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://daveceddia.com/images/tweet-first-level-layout-boxes.jpg)
...
[![Screenshot of tweet with default styling](../Images/931d0b604e4b86781b89ef413e9422b2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--hs40kjjw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://daveceddia.com/images/tweet-default-layout.png)

…这与我们想要的相差甚远。但是！所有的内容都在那里。一些元素群甚至朝着正确的方向流动。

你可以这样做，这种布局甚至在没有进一步样式化的情况下也能表达重点，这是 HTML 的一个很好的目标。

### [](#a-note-on-semantic-html)关于语义 HTML 的一个注记
...
### [](#default-styling-of-elements)元素的默认样式
...
## [](#step-three-more-boxes)第三步:更多盒子
...
[![Tweet with boxes around every layer of the layout](../Images/79f793410389b7a18da49486087df893.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--6aodLOvK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://daveceddia.com/images/tweet-all-layout-boxes.jpg)
...
[![Tweet with arrows showing flex directions](../Images/cbda6f97f89cacb0c1db16835ebfece5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--tX0E05BW--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://daveceddia.com/images/tweet-layout-arrows.jpg)

### [](#why-flexbox-instead-of-grid)为什么是 Flexbox 而不是 Grid？
...
### [](#step-four-apply-flexbox)步骤四:应用 Flexbox
...
[![Screenshot of tweet with display:flex](../Images/bea3aa35bdd9929a0a9ebe6ea2033d27.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--brwm_taj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://daveceddia.com/images/tweet-display-flex.png)
...
### [](#direction-row-or-column)方向:行还是列？
...
[![Rubin's vase](../Images/12dfaf887db78f1aa84aee51722c4807.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--51ZLGAHm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://daveceddia.com/images/Rubins-vase.jpg) 
[百科](https://en.wikipedia.org/wiki/Rubin_vase)

### [](#content-should-take-more-space)内容要多占空间
...
[![Screenshot of tweet with display:flex](../Images/f0f7af857a6f4d0b90704405a372f82c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--62CVR8Bi--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://daveceddia.com/images/tweet-with-avatar-margin.png)
...
### [](#removing-the-list-style)删除列表样式
...
[![Screenshot of tweet with actions side-by-side](../Images/dd3cc3154a97c62ca106f59009e0c59b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--CEtbVKJo--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://daveceddia.com/images/tweet-actions-display-flex.png)
...
### [](#spread-out-the-buttons)摊开按钮

我们可以用几种方式展开按钮。

一种是通过设置伸缩项的*对齐方式*。您可能对几乎所有富文本编辑器顶部的这些按钮都很熟悉:

[![Justification buttons for left/center/right/justify](../Images/98f9dee53baac1936ff2d6f85d9d2689.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--fCXXj3Ws--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://daveceddia.com/images/justify-buttons.png)
...
[![Tweet with buttons justified space-between](../Images/36f81e3b7e70c678f65046c5158d52af.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ysp4Y0oZ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://daveceddia.com/images/tweet-justify-content-space-between.png)
...
[![Tweet with a border, and buttons spaced out](../Images/7ad1cb56a68334196ac34b42c1244e7c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--50EFrPXs--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://daveceddia.com/images/tweet-bordered-buttons-spaced.png)
...
[![Tweet with padding, showing padding around p and ul](../Images/9489b60956d6159a0380fd5d92989ab3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--4auJh5FI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://daveceddia.com/images/tweet-showing-padding.gif)
...
[![Tweet with margins](../Images/608c111427f72d1d36840748e1004dc0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--HWMYK7z7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://daveceddia.com/images/tweet-margins-fixed.png)
...
[![Gravatar with border radius of 5 pixels](../Images/238ddf1a965f04fda2b2735136e3362b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--LLomCzdl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://daveceddia.com/images/border-radius-5px.png)
...
[![Tweet with a round avatar](../Images/a2fe02de0148c2e15435ba4ec0789c02.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--TKqM3fWC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://daveceddia.com/images/tweet-round-avatar.png)

## [](#draw-the-rest-of-the-owl)画出其余的猫头鹰
...
[![Finished Tweet](../Images/7dbac26160f4dcd9331e1ac37a39d8b5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--_avwgN8S--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://daveceddia.com/images/tweet-finished-hover-button.png)

如果你想亲自体验一下，这里有一个代码沙箱。

## [](#how-to-get-better-at-css)如何更好地掌握 CSS

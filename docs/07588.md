...
> 原文:[https://dev . to/Samantha Ming/number-truncation-in-JavaScript-1li](https://dev.to/samanthaming/number-truncation-in-javascript-1li)

[![Code Tidbit by SamanthaMing.com](../Images/4545debab5080e940c8e50c82379eba4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--qqB9hkW5--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ysfyefk4v6gaygudtey2.png)
...
## [](#number-truncation-using-raw-parseint-endraw-)数字截断使用`parseInt`
...
### [](#-raw-mathtrunc-endraw-vs-raw-parseint-endraw-)`Math.trunc()` vs `parseInt()`
...
### [](#the-gotcha-with-raw-parseint-endraw-)抓到你了`parseInt`
...
### [](#bitwise-operator-solutions)按位运算符解法

...
> 原文:[https://dev . to/setevoy/debian-无人值守-升级-自动升级-安装-电子邮件通知-via-aws-ses-59nk](https://dev.to/setevoy/debian-unattended-upgrades-automatic-upgrades-installation-with-email-notifications-via-aws-ses-59nk)

[![](../Images/64b150e578e221f867435d91aca472d1.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--NePp9sgS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://rtfm.co.ua/wp-content/uploads/2013/04/debian-logo_lenny2-e1427785970734.png)`unattended-upgrades`软件包在 Debian/Ubuntu 系统上执行自动升级安装。
...
[![](../Images/7b271ac1a8f1a689b8149eecb8cd839f.png)T2】](https://rtfm.co.ua/wp-content/uploads/2019/05/Screenshot_20190523_131750.png)

### [](#-raw-20autoupgrades-endraw-)`20auto-upgrades`
...
#### [](#-raw-unattendedupgradeoriginspattern-endraw-)`Unattended-Upgrade::Origins-Pattern`
...
#### [](#-raw-unattendedupgradepackageblacklist-endraw-)`Unattended-Upgrade::Package-Blacklist`
...
#### [](#-raw-unattendedupgraderemoveunuseddependencies-endraw-)`Unattended-Upgrade::Remove-Unused-Dependencies`
...
#### [](#-raw-unattendedupgrademail-endraw-)`Unattended-Upgrade::Mail`
...
#### [](#-raw-unattendedupgrademailonlyonerror-endraw-)`Unattended-Upgrade::MailOnlyOnError`
...
#### [](#-raw-unattendedupgradeautomaticreboot-endraw-)`Unattended-Upgrade::Automatic-Reboot`
...
#### [](#-raw-unattendedupgradeautomaticreboottime-endraw-)`Unattended-Upgrade::Automatic-Reboot-Time`
...
### [](#running-unattendedupgrade)无人值守运行-升级

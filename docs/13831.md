...
> 原文:[https://dev.to/notriddle/installing-nix-under-wsl-2eim](https://dev.to/notriddle/installing-nix-under-wsl-2eim)
...
## [](#work-around-missing-cgroups-support)解决缺少 cgroups 支持的问题
...
## [](#work-around-incorrect-file-locking)解决不正确的文件锁定

...
> 原文:[https://dev . to/jessekphillips/协方差-and-multi-interface-inheritance-4n3f](https://dev.to/jessekphillips/covariance-and-multiple-interface-inheritance-4n3f)

...
> 原文:[https://dev . to/gablaroche/tip-1-centering-elements-without-flexbox-and-automatic-margins-374 l](https://dev.to/gablaroche/tip-1-centering-elements-without-flexbox-and-automatic-margins-374l)
...
### [](#vertical-amp-horizontal-centering)垂直&水平居中
...
### [](#center-a-relative-element-to-its-container)将一个相对元素对其容器居中

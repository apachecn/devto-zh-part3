...
> 原文:[https://dev . to/cube js/high-performance-data-analytics-with-cube-js-pre-aggregations-3305](https://dev.to/cubejs/high-performance-data-analytics-with-cube-js-pre-aggregations-3305)
...
[![](../Images/1ec068c321d17abc379e6f353938209c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--_LCBno3t--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/statsbotco/cube.js/master/docs/pre-aggregations-schema.png)
...
## [](#creating-a-simple-preaggregation)创建简单的预聚合
...
### [](#preaggregate-queries-across-multiple-cubes)跨多个多维数据集预聚合查询

...
> 原文:[https://dev . to/yoro DM/python-decoratores-estn Dar-y-su-uso-3fe](https://dev.to/yorodm/python-decoradores-estndar-y-su-uso-3fe)

Python 的*电池包括*在内，有几个装饰家来为我们的生活提供便利。以下是一些使用方法的简短说明。

## [](#decoradores-para-oop)装饰者
...
### [](#abcabstractmethod)abc.abstractmethod
...
## [](#decoradores-para-funciones)功能装饰

### [](#functoolslrucache)functools.lru_cache
...
### [](#contextlibcontextmanager)contextlib.contextmanager

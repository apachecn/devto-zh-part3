...
> 原文:[https://dev . to/the Jared wilcurt/reducing-app-distribution-size-in-nwjs-3d 5f](https://dev.to/thejaredwilcurt/reducing-app-distribution-size-in-nwjs-3d5f)
...
## [](#1-using-older-versions-of-nwjs)1。使用 NW.js 的旧版本

[![Homer Simpson talking to his younger self](../Images/d2c3bfb018e2225311504dd4071b9ae3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--srqZnP9N--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/g4jil7ad37plleoy1kay.png)
...
### [](#results-of-this-choice)本次选择的结果
...
## [](#2-reducing-node-modules)2。减少节点模块

[![ran  raw `rm -rf node_modules` endraw  and I *swear*, my laptop actually feels lighter. - Tweet by I Am A Developer](../Images/7317647cd290560ae3d44493bce51eae.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--VUo0igbJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/y0rwhiii0pmcst3op5uo.png)
...
### [](#results-of-reducing-node-modules)减少节点模块的结果
...
## [](#3-optimizing-your-app)3。优化您的应用

[![XKCD - Flow chart for if you are prematurely optimizing in which consulting a flowchart confirms you are](../Images/dec347ad3d1d9e81a428c4cbe72d3b92.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--jjJU3iHm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/zx3c2787yvn73uy9nkag.png)

当谈到优化网络应用程序时，许多人都专注于减少比特和字节。老实说，当处理用 NW.js 制作的 XPDAs 时，这是浪费时间。我将快速介绍您可以跳过的内容，以及有可能节省几兆字节的内容。

### [](#what-not-to-optimize)哪些不优化:
...
[![Cat in a small box with caption cat.rar](../Images/098a967d0615d344410d789722df54bc.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--UxnfeUEf--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/tdtmwjt680bp3pmwusxk.png)
...
## [](#4-removing-files-from-nwjs-itself-not-advised)4。从 NW.js 本身删除文件(不建议)

[![Man next to a car being gutted saying "But some of those parts looked important"](../Images/50cc24dce4f356b48772bb47159b765f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--W3hOowQS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/sfm9qef2lwcdzj1rm127.png)
...
[![Cat dunked in water up to neck, looking as though it shrunk with caption "Cat app filesize reduced by 61% (uncompressed header)"](../Images/56aec1295e469b4e81c3b66150f5ef41.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--L1bkiw5h--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/arsze4aod9owmia43wzo.jpg)

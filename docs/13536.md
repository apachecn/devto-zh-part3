...
> 原文:[https://dev . to/kbild/cloud formation-template-tag-AWS-volumes-for-life cycle-manager-backups-3n L3](https://dev.to/kbild/cloudformation-template-tag-aws-volumes-for-lifecycle-manager-backups-3nl3)
...
## [](#lifecycle-manager-snapshot-lifecycle-policy)生命周期管理器-快照生命周期策略

在下面的示例中，我们将在 09 和 10 UTC 之间对标记为`backupid: AUT01`的所有卷进行 24 小时快照，并将保留 7 个快照。

* * *

[![AWS Lifecycle Manager](../Images/2f6e0878b9ef9d553d1fb50e64c0fd6f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--rM58c__D--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://kbild.ch/201902/Lifecycle.png)
...
## [](#needed-user-data-script)需要的用户数据脚本

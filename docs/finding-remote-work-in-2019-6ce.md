...
> 原文：<https://dev.to/k_ivanow/finding-remote-work-in-2019-6ce>

不同平台和网站之间的比较以及面试过程中的一些技巧。

<figure>[![](img/28cc63489b9b1855344435bd31f7e79a.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--x-C-VTj9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/0%2AXykMQaRJYrG9Uhfx) 
...
有许多招聘网站和平台面向经过审查的承包商/自由职业者。他们都声称他们只雇佣 1%或 3%最好的自由职业者。在过去的近三个月里，我经历了其中的许多。下面是我发现的一个简短的总结，以及一些面试前和面试中应该做的事情。希望能为你在找异地工作时省去一些麻烦。

### 发布招聘信息的平台

#### [我们远程办公](https://weworkremotely.com)

目前为止我最喜欢的！到目前为止。

**优点**:

+我在这个网站上联系过的所有公司都很快做出了回应。所有人都经历了一个快速的招聘过程。It 有几种类型的工作——营销、编程等。它还有一个好处是显示候选人必须在哪里工作。
...
+它还提供了一个简单的申请选项，使您能够保存您的简历以及使用堆栈溢出申请表的每个工作的简短介绍。

+也说明你申请了广告，即使公司重新贴出。它允许你通过特定的津贴、技术、报酬等来过滤帖子。

从 2022 年 4 月起，堆栈溢出作业已被移除。你可以在这里了解更多信息。

### [远程科技岗位](https://remotetechjobs.com)

根据其描述，构建为堆栈溢出作业的替代。
**优点:**
+它比其他选项有更好的过滤能力，找到你要找的东西
+所有工作最多在 30 天后被撤下，确保新鲜的列表。
+有很多打开的机会。在撰写本文时，大约有 5 000 人，考虑到前一点，许多公司都在寻找候选人。
+有一个简单的应用选项。他们还汇集了来自其他 11 个平台的工作，旨在成为寻找远程工作的首选。然而，当用我们远程工作的几个帖子进行测试时，它们没有出现在远程技术工作的结果中。

#### [联系在一起](https://linkedin.com)
...
——多为永久职位，很少有远程职位。我建议联系猎头或招聘人员，并与他们讨论他们是否与一家正在寻找具备你这种资质的人的公司合作。

#### [说](https://www.dice.com)

优点:

+每天都有很多帖子。

+公司也是积极的，它允许像在堆栈溢出容易申请。

#### 【Reed.co.uk】[Experteer.co.uk](https://www.experteer.co.uk/jobs)[Cwjobs.co.uk](https://www.cwjobs.co.uk/)[Jooble](https://uk.jooble.org)
...
——我接触过的超过 60%的公司实际上已经忘记了他们在那里发布了一个职位，而这个职位实际上已经有人了。

#### [removed](https://remotive.io/find-a-remote-job/)

它和没有办公桌有着同样的问题——很多职位都招满了，但公司却忘了撤下广告。

#### [远程工作枢纽](https://remoteworkhub.com/)
...
目前为止我最喜欢的。招聘过程很有趣，他们的平台制作精良，看起来很专业。你会惊讶有多少其他平台有可怕的网络平台。他们也理解和快速。
...
P.S .上面写的一切都是从一个 JavaScript 开发人员和一个之前面试和招聘过人员的团队领导的角度出发的。不同学科可能有所不同。我很乐意在下面的评论中或者在 [twitter](https://twitter.com/k_ivanow) 上讨论其他人在寻找工作机会时遇到了什么
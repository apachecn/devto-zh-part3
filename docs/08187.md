...
> 原文:[https://dev . to/itachiuchiha/writing-a-Firefox-we B- extension-using-vue-js-2 ijp](https://dev.to/itachiuchiha/writing-a-firefox-web-extension-using-vue-js-2ijp)
...
## [](#creating-vue-project)创建 Vue 项目
...
## [](#replacing-default-component)替换默认组件。

...
> 原文:[https://dev.to/fteem/testing-in-go-failing-tests-44k1](https://dev.to/fteem/testing-in-go-failing-tests-44k1)
...
## [](#a-short-overview-of-the-raw-testing-endraw-package)简介`testing`套餐
...
## [](#logging-with-raw-log-endraw-and-raw-logf-endraw-)用`Log`和`Logf`记录

如果我们查看`testing`包中`T`类型的[索引](https://golang.org/pkg/testing/#T)，有一个表示错误或失败的函数列表:

[![](../Images/d732054005e96a7672ccb764ace2994f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---B3ZrEPb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ieftimov.com/testing-in-go-errors/type-t-index.png)
...
## [](#delayed-vs-immediate-failure)延迟与立即失败
...
## [](#signal-amp-report-failures-in-one-go)信号&报告故障一气呵成

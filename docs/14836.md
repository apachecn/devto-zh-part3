...
> 原文:[https://dev . to/progress telerik/creating-a-reuse-JavaScript-free-blazor-modal-3f 30](https://dev.to/progresstelerik/creating-a-reusable-javascript-free-blazor-modal-3f30)
...
### [](#creating-a-blazor-library)创建 Blazor 库
...
### [](#iservicecollection-extension)IServiceCollection 扩展
...
[![SolutionWithTestProject](../Images/5d7b299aa966bc941f7fd2346faef9b6.png "SolutionWithTestProject")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--yF-mm-oz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://d585tldpucybw.cloudfront.net/sfimages/default-source/blogs/2019/january/solutionwithtestproject.png%3Fsfvrsn%3D1ed29280_1)

### [](#setting-up-the-test-project)设置测试项目
...
### [](#creating-a-test-component)创建一个测试组件
...
### [](#running-our-test-app)运行我们的测试应用

我们现在可以运行我们的测试应用程序，如果一切按计划进行，它应该像这样工作。

[![BlazorModal](../Images/b3cfaaa83e9ffcb326f0ce6744a9a120.png "BlazorModal")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Xv2Hlf7p--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://d585tldpucybw.cloudfront.net/sfimages/default-source/blogs/2019/january/blazormodal.gif%3Fsfvrsn%3D6aa58b90_1)

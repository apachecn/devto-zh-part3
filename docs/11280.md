...
> 原文:[https://dev . to/bholmesdev/why-im-using-surge-and-not-github-pages-4l F5](https://dev.to/bholmesdev/why-im-using-surge-and-not-github-pages-4lf5)
...
## [](#hm-so-whats-a-surge-exactly)嗯，那么到底什么是“激增”呢？🤔
...
## [](#looks-easy-but-where-are-my-git-hooks)看起来很容易，但是我的 git 钩子在哪里？
...
## [](#neat-but-what-are-the-benefits-exactly)整齐。但是到底有什么好处呢？

...
> 原文:[https://dev . to/ft EEM/OTP-in-elixir-learn-gen server-by-building-your-own-URL-shortener-5b0d](https://dev.to/fteem/otp-in-elixir-learn-genserver-by-building-your-own-url-shortener-5b0d)
...
[![](../Images/072851f52a3ac1a2634c5df0ca8e2a37.png) ](https://res.cloudinary.com/practicaldev/image/fetch/s--V1_-VcpU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ieftimov.com/img/posts/mario-caruso-770233-unsplash.jpg) <small>马里奥·卡鲁索在 Unsplash</small> 上的照片
...
[![](../Images/86317baf4bb1305e6f3852c0413b2983.png) ](https://res.cloudinary.com/practicaldev/image/fetch/s--iOaRkU2r--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ieftimov.com/img/posts/jon-flobrant-225260-unsplash.jpg) <small>我是一名 OTP 专家👆我知道
...
### [](#server-start-amp-state)服务器启动&状态
...
### [](#sync-amp-async-messages)同步&异步消息📨
...
## [](#reimplementing-raw-urlshortener-endraw-using-raw-genserver-endraw-)重新实现`URLShortener`，使用`GenServer` ♻️
...
### [](#fetching-a-shortened-url)获取缩短的 URL🔗
...
## [](#more-configurations-%F0%9F%8E%9B)更多配置🎛

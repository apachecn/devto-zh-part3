...
> 原文:[https://dev . to/devdammak/react-hook-use state-with-react-context-API-3pco](https://dev.to/devdammak/react-hook-usestate-with-react-context-api-3pco)
...
# [](#what-is-react-context-api)什么是 React 上下文 API
...
# [](#terminologies-to-understand)术语理解

### [](#reactcreatecontext)反应. createContext
...
## [](#passing-data-via-props)通过道具传递数据
...
## [](#managing-state-with-hook-and-context-api)用钩子和上下文 API 管理状态
...
## [](#how-to-update-my-state-from-child-or-consumer-component)如何从子组件或消费者组件更新我的状态

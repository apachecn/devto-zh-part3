...
> 原文:[https://dev . to/janhoogeveen/how-to-whitelist-your-next js-server less-deployments-on-now-5d3f](https://dev.to/janhoogeveen/how-to-whitelist-your-nextjs-serverless-deployments-on-now-5d3f)
...
# [](#checking-for-visitor-ip-address-in-your-now-lambdas)在您的 Now Lambdas 中检查访问者 IP 地址

...
> 原文:[https://dev . to/graphicbeacon/10-interest-dart-and-CSS-libraries-for-may-2019-29l 9](https://dev.to/graphicbeacon/10-interesting-dart-and-css-libraries-for-may-2019-29l9)
...
## [](#1-dio)1。[迪奥](https://pub.dartlang.org/packages/dio)
...
## [](#3-rxdart)3。 [RxDart](https://pub.dartlang.org/packages/rxdart)
...
## [](#4-watercss)4。 [Water.css](https://github.com/kognise/water.css)
...
## [](#5-html)5。 [html](https://pub.dartlang.org/packages/html)
...
## [](#6-animatecss)6。 [animate.css](https://daneden.github.io/animate.css/)

[**Animate.css**](https://daneden.github.io/animate.css) 提供*刚加水* CSS 动画，简单！它有反弹，脉冲，震动和其他一些效果。

## [](#7-markdown)7。[降价](https://pub.dartlang.org/packages/markdown)
...
## [](#8-dyncss)8\. [DynCSS](https://www.vittoriozaccaria.net/dyn-css/)
...
## [](#9-pdf)9。 [pdf](https://pub.dartlang.org/packages/pdf)
...
## [](#10-hovercss)10。 [Hover.css](http://ianlunn.github.io/Hover/)

...
> 原文:[https://dev . to/dandyvica/yarit-yet-another-rust-iterators-tutorial-46dk](https://dev.to/dandyvica/yarit-yet-another-rust-iterators-tutorial-46dk)
...
## [](#iterators-tldr)迭代器:TL；速度三角形定位法(dead reckoning)
...
### [](#rust-standard-collections)锈标收藏
...
## [](#implementing-your-own-iterators)实现自己的迭代器
...
## [](#iterators-on-userdefined-collections)用户定义集合上的迭代器

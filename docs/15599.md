...
> 原文:[https://dev . to/commons host/build-your-own-URL-shortener-in-15-minutes-279n](https://dev.to/commonshost/build-your-own-url-shortener-in-15-minutes-279n)
...
## [](#domain-name-and-dns)域名和 DNS

设置您的域名。

使用免费的公共主机子域，或您自己注册的自定义域名。

### [](#option-a-free-raw-commonshost-endraw-subdomain)选项 A)自由`*.commons.host`子域
...
### [](#option-b-custom-domain-name)选项 B)自定义域名
...
## [](#sign-up-to-commons-host)注册共享主机
...
## [](#deploy-to-commons-host)部署到公共主机

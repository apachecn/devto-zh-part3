...
> 原文:[https://dev.to/thekashey/react-code-splitting-in2019-3cmg](https://dev.to/thekashey/react-code-splitting-in2019-3cmg)

都 2019 年了！每个人都认为他们知道代码分解。所以-让我们仔细检查一下！
[![](../Images/c7aed44be89df0e0e6ad7a817dacb313.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--e9igJiqb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://habrastorage.org/webt/da/lx/0b/dalx0bnbenxiqebdymmcrp8in68.png)

## [](#what-does-codesplitting-stand-for)代码分裂代表什么？

简而言之——代码分割就是不加载整个东西。然后你正在阅读这个页面，你不必加载整个网站。当您从数据库中选择一行时，您不必选择所有行。
明显？代码分割也很明显，只是不是关于你的数据，而是你的代码。

## [](#who-is-making-codesplitting)是谁在搞代码分裂？

`React.lazy`？不–它只使用它。代码分割是在捆绑级别上工作的——web pack、package，或者在“本地”的情况下仅仅是您的文件系统。代码分割只是文件，你可以“以后”在某个地方加载的文件。

## [](#who-is-using-code-splitting)谁在用代码拆分？

`React.lazy`正在使用。只是用你的捆绑器的代码分割。只是在渲染时调用导入。仅此而已。

## [](#whats-about-reactloadable)什么叫 React-loadable？

取代了它。并且提供了更多的功能，像`Suspense`来控制加载状态。所以——用`React.Lazy`代替。

> 是的，就这些。感谢您的阅读，祝您愉快。

## [](#why-this-article-is-not-finished)为什么这篇文章没有写完？

好吧。关于`React.lazy`和代码分割，有一些*灰色地带*，我忘了说了。

### [](#grey-zone-1-testing)灰色区域 1–测试
...
# [![GitHub logo](../Images/375dfcc32199b4dedf2b526645c27ff7.png) 支持 sync# 14626](https://github.com/facebook/react/pull/14626)

[![gaearon avatar](../Images/2aa9b939a78baf4d2e67a9984cb321a3.png) ](https://github.com/gaearon)  **[gaearon](https://github.com/gaearon)** commented on [Jan 18, 2019](https://github.com/facebook/react/pull/14626)
...
### [](#behold-codesplitting-libraries)看代码分解库
...
## ![GitHub logo](../Images/375dfcc32199b4dedf2b526645c27ff7.png) [平滑码](https://github.com/smooth-code) / [可加载组件](https://github.com/smooth-code/loadable-components)

### 反应代码分裂使✂️✨变得容易

<article class="markdown-body entry-content p-5" itemprop="text">

# [![loadable-components](../Images/85e80c9e998d91b8f57e7c301e0771c9.png "loadable-components")T2】](https://raw.githubusercontent.com/smooth-code/loadable-components/master/resources/loadable-components.png)

React 代码分割变得简单。毫无压力地减少你的包裹尺寸<g-emoji class="g-emoji" alias="scissors" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/2702.png">✂️</g-emoji>T2】✨。

[![License](../Images/f2b7f6cb97c2c07254a6c79d3651d1ff.png)](https://github.com/smooth-code/loadable-components/blob/master/LICENSE)[![Donate](../Images/cc5eb5c85924ec12f345cb35cdcc378a.png)](https://opencollective.com/loadable/donate)[![npm package](../Images/a62cef6ce5ed5431fa94a2a959cdcaf9.png)](https://www.npmjs.com/package/@loadable/component)[![npm downloads](../Images/4001c0be8ed4cbc98936c4090c536fef.png)](https://www.npmjs.com/package/@loadable/component)[![Build Status](../Images/f3706fa73231b5649a4306f7d10f97ed.png)](https://travis-ci.org/smooth-code/loadable-components)[![Code style](../Images/2113a413b334e649fd64b7626cd40572.png)](https://camo.githubusercontent.com/c83b8df34339bd302b7fd3fbb631f99ba25f87f8/68747470733a2f2f696d672e736869656c64732e696f2f62616467652f636f64655f7374796c652d70726574746965722d6666363962342e737667)[![Dependencies](../Images/fd3f77f8b314a892ceb00cc02e56c6a8.png)](https://david-dm.org/smooth-code/loadable-components?path=packages/component)[![DevDependencies](../Images/014fa38cdadc9b7bfda1e9e7ca4bac54.png)](https://david-dm.org/smooth-code/loadable-components?type=dev)[T25】](https://unpkg.com/@loadable/component/dist/loadable.min.js)
...
[![gold-sponsors](../Images/e8592dca693d4de180790748b0466ef7.png)T2】](https://camo.githubusercontent.com/db285608ed1b7de56900dbbb8179948af4886415/68747470733a2f2f6f70656e636f6c6c6563746976652e636f6d2f6c6f616461626c652f74696572732f676f6c642d73706f6e736f72732e7376673f6176617461724865696768743d3132302677696474683d363030)
...
## ![GitHub logo](../Images/375dfcc32199b4dedf2b526645c27ff7.png) [卡西](https://github.com/theKashey) / [反应-进口-组件](https://github.com/theKashey/react-imported-component)
...
[![imported components](../Images/9484e17309a3eb1b982175dea5d11586.png)](https://raw.githubusercontent.com/theKashey/react-imported-component/master/./assets/imported-logo.png)

SSR-friendly code splitting compatible with any platform
Deliver a better experience within a single import

[![](../Images/18c096915e5ecca8b9c64ae7cbc018d1.png) ](https://www.npmjs.com/package/react-imported-component) [ ![Build status](../Images/aa1d04bfe2bdb043f83b2ff81b273937.png) ](https://circleci.com/gh/theKashey/react-imported-component/tree/master) [ ![npm downloads](../Images/d1dfa3df5184feb4b90ce2f38889e7f9.png) ](https://www.npmjs.com/package/react-imported-component) [ ![bundle size](../Images/bda8df20174fa7e1e4b4482bb2915a82.png) ](https://bundlephobia.com/result?p=react-imported-component) [![](../Images/cb954434d0af1afe5e173e7c0e261142.png)](https://camo.githubusercontent.com/ca8f583465c5a251169737a84d9725d17732945b/68747470733a2f2f6261646765732e677265656e6b65657065722e696f2f7468654b61736865792f72656163742d696d706f727465642d636f6d706f6e656e742e737667)

> <sup>*</sup> 它真的永远不会让你失望。一切都归功于你的 bundler。

<g-emoji class="g-emoji" alias="point_right" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/1f449.png">👉</g-emoji> [用法](https://raw.githubusercontent.com/theKashey/react-imported-component/master/#usage) | [API](https://raw.githubusercontent.com/theKashey/react-imported-component/master/#api) | [设置](https://raw.githubusercontent.com/theKashey/react-imported-component/master/#setup)|[SSR](https://raw.githubusercontent.com/theKashey/react-imported-component/master/#ssr)|[CCS](https://raw.githubusercontent.com/theKashey/react-imported-component/master/#css)[并发加载](https://raw.githubusercontent.com/theKashey/react-imported-component/master/#concurrent-loading)|[web pack/package](https://raw.githubusercontent.com/theKashey/react-imported-component/master/#bundler-integration)

| 图书馆 | 焦虑 | 苏维埃社会主义共和国 | 钩住 | 图书馆 | 非模块 | 导入(`./${value}`) | 巴别塔宏 | 仅 webpack |
| --- | :-: | :-: | :-: | :-: | :-: | :-: | :-: | :-: |
| 反应.懒惰 | <g-emoji class="g-emoji" alias="white_check_mark" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/2705.png">✅</g-emoji> | <g-emoji class="g-emoji" alias="x" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/274c.png">❌</g-emoji> | <g-emoji class="g-emoji" alias="x" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/274c.png">❌</g-emoji> | <g-emoji class="g-emoji" alias="x" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/274c.png">❌</g-emoji> | <g-emoji class="g-emoji" alias="x" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/274c.png">❌</g-emoji> | <g-emoji class="g-emoji" alias="x" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/274c.png">❌</g-emoji> | <g-emoji class="g-emoji" alias="joy_cat" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/1f639.png">😹</g-emoji> |
| 可反作用加载 | <g-emoji class="g-emoji" alias="white_check_mark" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/2705.png">✅</g-emoji> | <g-emoji class="g-emoji" alias="white_check_mark" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/2705.png">✅</g-emoji> | <g-emoji class="g-emoji" alias="x" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/274c.png">❌</g-emoji> | <g-emoji class="g-emoji" alias="x" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/274c.png">❌</g-emoji> | <g-emoji class="g-emoji" alias="white_check_mark" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/2705.png">✅</g-emoji> | <g-emoji class="g-emoji" alias="x" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/274c.png">❌</g-emoji> | <g-emoji class="g-emoji" alias="x" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/274c.png">❌</g-emoji> | <g-emoji class="g-emoji" alias="crying_cat_face" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/1f63f.png">😿</g-emoji> |
| @可加载/组件 | <g-emoji class="g-emoji" alias="white_check_mark" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/2705.png">✅</g-emoji> | <g-emoji class="g-emoji" alias="white_check_mark" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/2705.png">✅</g-emoji> | <g-emoji class="g-emoji" alias="x" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/274c.png">❌</g-emoji> | <g-emoji class="g-emoji" alias="white_check_mark" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/2705.png">✅</g-emoji> | <g-emoji class="g-emoji" alias="x" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/274c.png">❌</g-emoji> | <g-emoji class="g-emoji" alias="white_check_mark" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/2705.png">✅</g-emoji> | <g-emoji class="g-emoji" alias="x" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/274c.png">❌</g-emoji> | <g-emoji class="g-emoji" alias="crying_cat_face" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/1f63f.png">😿</g-emoji> |
| 进口组件 | <g-emoji class="g-emoji" alias="white_check_mark" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/2705.png">✅</g-emoji> | <g-emoji class="g-emoji" alias="white_check_mark" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/2705.png">✅</g-emoji> | <g-emoji class="g-emoji" alias="white_check_mark" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/2705.png">✅</g-emoji> | <g-emoji class="g-emoji" alias="white_check_mark" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/2705.png">✅</g-emoji> | <g-emoji class="g-emoji" alias="white_check_mark" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/2705.png">✅</g-emoji> | <g-emoji class="g-emoji" alias="x" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/274c.png">❌</g-emoji> | <g-emoji class="g-emoji" alias="white_check_mark" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/2705.png">✅</g-emoji> | <g-emoji class="g-emoji" alias="smile_cat" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/1f638.png">😸</g-emoji> |

> 阅读更多关于[该表显示的内容](https://raw.githubusercontent.com/theKashey/react-imported-component/master/#comparisonLegend)

主要特点:

*   <g-emoji class="g-emoji" alias="one" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/0031-20e3.png">1️⃣</g-emoji> 真相的唯一来源——你的**捆绑者驱动**一切
*   <g-emoji class="g-emoji" alias="book" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/1f4d6.png">📖</g-emoji> **库**级代码**拆分**
*   🧙️混合动力车与**预渲染**兼容
*   <g-emoji class="g-emoji" alias="bulb" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/1f4a1.png">💡</g-emoji> **打字稿**装订
*   <g-emoji class="g-emoji" alias="atom_symbol" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/269b.png">**反应过来。底层的惰性**(如果热模块更新被禁用)</g-emoji>
*   <g-emoji class="g-emoji" alias="star2" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/1f31f.png">🌟</g-emoji>客户端异步，服务器同步。支持**悬念**(连上…

</article>

[View on GitHub](https://github.com/theKashey/react-imported-component)

## ![GitHub logo](../Images/375dfcc32199b4dedf2b526645c27ff7.png)[faceyspacey](https://github.com/faceyspacey)/[react-universal-component](https://github.com/faceyspacey/react-universal-component)

### 🚀React 通用组件的最终答案:同步 SSR +代码拆分

<article class="markdown-body entry-content p-5" itemprop="text">[![Reactlandia Chat](../Images/e89a531afc57043ee49077b15f3b9cfb.png) ](https://gitter.im/Reactlandia/Lobby) [ ![Edit React Universal Component on StackBlitz](../Images/bf36868e3b129d50b1d984e5b56c1ed9.png) ](https://stackblitz.com/edit/react-pnzphy) [![Edit React Universal Component on CodeSandBox](../Images/256aaad2b17afd53ba9f392eb8778e7b.png)](https://codesandbox.io/s/github/faceyspacey/redux-first-router-codesandbox/tree/master/?module=r1oVP5YEUZ) 

# 反应通用组件

[![Version](../Images/64dfe6cfd5f4f2d6fa025f5799762e43.png)](https://www.npmjs.com/package/react-universal-component)[![Build Status](../Images/af74684d3094391759ec1cc6f03da2d9.png)](https://travis-ci.org/faceyspacey/react-universal-component)[![Coverage Status](../Images/49d1e1d003527d2fefcc8150465b9a6f.png)](https://lima.codeclimate.com/github/faceyspacey/react-universal-component/coverage)[![Downloads](../Images/d2301e9258121bb06abcee531ba1ee65.png)](https://www.npmjs.com/package/react-universal-component)[![License](../Images/1b5ca352d0d6367c430fc120a6303a74.png)](https://www.npmjs.com/package/react-universal-component)

[![](../Images/6e7f9cef670b55dc2c6e3fc4ac1b4eb1.png)T2】](https://camo.githubusercontent.com/20394442136fc23def46fef4750555939814f80b/68747470733a2f2f63646e2e72656163746c616e6469612e636f6d2f756e6976657273616c2d636f6d706f6e656e742d62616e6e65722e706e67)

<g-emoji class="g-emoji" alias="champagne" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/1f37e.png">🍾</g-emoji> <g-emoji class="g-emoji" alias="champagne" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/1f37e.png">🍾</g-emoji> <g-emoji class="g-emoji" alias="champagne" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/1f37e.png">🍾</g-emoji> [GIT 克隆 3.0 本地演示](https://github.com/faceyspacey/universal-demo) <g-emoji class="g-emoji" alias="rocket" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/1f680.png">🚀</g-emoji> <g-emoji class="g-emoji" alias="rocket" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/1f680.png">🚀</g-emoji>T12】🚀
...
## [](#grey-zone-3-hybrid-render)灰色区域 3–混合渲染
...
[![](../Images/9d439aad467e99eae320e88c6078df35.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--e558xCgt--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://habrastorage.org/webt/tr/sz/9i/trsz9i4ct8jc7cnwxtm-ljnepuq.png)
...
### [](#reactprerenderedcomponent)反应-预渲染-组件
...
## ![GitHub logo](../Images/375dfcc32199b4dedf2b526645c27ff7.png) [卡西](https://github.com/theKashey) / [反应-预渲染-组件](https://github.com/theKashey/react-prerendered-component)
...
[![](../Images/85944b18b2d6e95eeafa893cf1e64cc1.png)](https://www.npmjs.com/package/react-prerendered-component) 

## 想法

简而言之:不要试图**运行** js 代码，并生成一个匹配预渲染的 react 树，而是**使用**预渲染的 html，直到 js 代码准备好替换它。让它活起来。

在 HTML 级别上还能做什么？缓存，*模板化*，还有其他好东西给<g-emoji class="g-emoji" alias="rocket" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/1f680.png">🚀</g-emoji>，就在一个 3kb*里。

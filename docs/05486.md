...
> 原文:[https://dev . to/oktadev/tutorial-build-universal-applications-with-nuxt-js-1p0o](https://dev.to/oktadev/tutorial-build-universal-applications-with-nuxt-js-1p0o)
...
## [](#build-your-nuxt-application)构建您的 Nuxt 应用程序
...
## [](#learn-more-about-vue-and-authentication)了解有关 Vue 和认证的更多信息

...
> 原文:[https://dev . to/will worth/APIs-graph QL-and-queries-in-Gatsby-1k P1](https://dev.to/willworth/apis-graphql-and-queries-in-gatsby-1kp1)
...
## [](#where-did-the-query-come-from)查询从何而来？

...
> 原文:[https://dev.to/apium_hub/scala-implicits-presentations-4a16](https://dev.to/apium_hub/scala-implicits-presentations-4a16)
...
## [](#what-does-implicit-and-explicit-mean)隐性和显性是什么意思？
...
## [](#implicit-conversions-implicit-functions)隐式转换(隐式函数)
...
### [](#what-problems-do-they-have)他们有什么问题？
...
## [](#final-words-scala-implicits)最后一句话:Scala 隐含
...
## [](#recommended-readings-on-implicits)关于暗示的推荐读物

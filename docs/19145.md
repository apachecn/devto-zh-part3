...
> 原文:[https://dev . to/progress telerik/10-more-things-you-not-know-about-create-react-app-3d j8](https://dev.to/progresstelerik/10-more-things-you-didnt-know-about-create-react-app-3dj8)
...
## [](#1-service-workers-support)1。服务人员支持
...
## [](#4-code-splitting-using-dynamic-imports)4。使用动态导入进行代码拆分
...
## [](#5-proxy-api-requests-during-development)5。开发期间的代理 API 请求
...
## [](#6-support-https-during-development)6。在开发过程中支持 HTTPS
...
## [](#7-support-for-environment-variables)7。支持环境变量
...
## [](#8-support-for-latest-javascript-standards)8。支持最新的 JavaScript 标准
...
## [](#9-one-build-dependency)9。一个生成依赖项

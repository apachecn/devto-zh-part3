...
> 原文:[https://dev . to/Healey codes/creating-cute-github-badges-based-off-a-projects-mood-nodejs-59c](https://dev.to/healeycodes/creating-cute-github-badges-based-off-a-projects-mood-nodejs-59c)
...
[![](../Images/5e51ecfa4969ec385618f04ed3f791f9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--gEiUkZUn--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/jk4f14j4bab2g4oucluk.png)
...
## ![GitHub logo](../Images/a73f630113876d78cff79f59c2125b24.png) [ healeycodes ](https://github.com/healeycodes) / [项目-心情](https://github.com/healeycodes/project-mood)

### Node.js API，用于根据存储库的心情生成 GitHub 徽章🌸🔵☀️🌃

<article class="markdown-body entry-content container-lg" itemprop="text">

[![Build Status](../Images/0344a8fc7b69410dfb712508d93bd398.png)T2】](https://travis-ci.org/healeycodes/project-mood)
...
SVG 将通过内部 SVG 标签`<title>`将平均提交时间作为悬停文本。

| [![](../Images/e54cd686b7b7457eeaeba23cd88cbb9f.png)T2】](https://github.com/healeycodes/project-mood/blob/master/samples/project%20mood-morning.svg) | [![](../Images/278d0784b0d72c2befcfdf241f724cbe.png)T2】](https://github.com/healeycodes/project-mood/blob/master/samples/project%20mood-day-time.svg) | [![](../Images/d18442efedf8cb33bb94ffefd9d6930b.png)T2】](https://github.com/healeycodes/project-mood/blob/master/samples/project%20mood-twilight.svg) | [![](../Images/1f135ec6940b2ca1e934f597eeba637d.png)T2】](https://github.com/healeycodes/project-mood/blob/master/samples/project%20mood-night-time.svg) |
| --- | --- | --- | --- |

### 路线图<g-emoji class="g-emoji" alias="car" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/1f697.png">🚗</g-emoji>

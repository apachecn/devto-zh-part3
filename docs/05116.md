...
> 原文:[https://dev.to/pencillr/spawn-a-jenkins-from-code-gfa](https://dev.to/pencillr/spawn-a-jenkins-from-code-gfa)

## [](#through-the-ci-looking-glass)隔着 CI 窥镜
...
## [](#not-according-to-the-manual)不按说明书办事

让我们这样宣布我们的目标:

##### [](#set-up-a-jenkins-straight-from-code-using-configuration-that-is-kept-in-files-so-it-can-be-version-controlled)*直接从代码中设置一个 Jenkins，使用保存在文件中的配置，这样就可以进行版本控制。*
...
## [](#apply-configuration-through-cli)通过 CLI 应用配置

...
> 原文:[https://dev . to/fundatillus/how-to-use-MAC OS-boot-camp-on-a-USB-stick-1 M8](https://dev.to/fundatillus/how-to-use-macos-boot-camp-on-a-usb-stick-1m8)
...
### [](#1-partition-the-usb-hard-drive)1。对 USB 硬盘进行分区
...
### [](#2-write-the-windows-image-to-the-usb-hard-drive)2。将 Windows 映像写入 USB 硬盘
...
### [](#3-make-the-usb-hard-drive-bootable)3。使 USB 硬盘可引导
...
### [](#4-clone-the-usb-hard-drive-contents-to-the-usb-stick-using-dd)4。使用 dd 将 USB 硬盘内容克隆到 u 盘

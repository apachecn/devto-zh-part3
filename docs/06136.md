...
> 原文:[https://dev.to/_tink3r/gomobile-under-the-hood-d6p](https://dev.to/_tink3r/gomobile-under-the-hood-d6p)

这篇文章最初发表在我的博客

<center>
![](../Images/d6aae4c5084cf2e793af2572ba0ea595.png)
</center>
...
#### [](#c-and-c-support-in-java-and-objectivec)C 和 C++支持 Java 和 Objective-C
...
#### [](#so-what-does-gomobile-do)那么 Gomobile 是做什么的？

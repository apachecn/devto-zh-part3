...
> 原文:[https://dev . to/Steve blue/accessibility-with-customized-built-in-elements-2k 8](https://dev.to/steveblue/accessibility-with-customized-built-in-elements-2k8)
...
## [](#customized-builtin-elements)定制内置元素
...
### [](#compatibility-with-javascript-frameworks)兼容 JavaScript 框架
...
### [](#dynamic-customized-builtin-elements)动态定制内置元素

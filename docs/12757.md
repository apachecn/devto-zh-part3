...
> 原文:[https://dev.to/zorbash/the-10-minute-rails-pubsub-22af](https://dev.to/zorbash/the-10-minute-rails-pubsub-22af)

这一次，我们将尝试一种快速构建 Rails
应用程序的方法，使用发布/订阅来代替模型回调。

## [](#whats-wrong-with-callbacks)回调怎么了
...
## [](#enter-activesupportnotifications)输入 ActiveSupport::通知
...
[![they_should](../Images/08dbe8405eace6b49bfeec0f023076ff.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--BxzVmWeg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://zorbash.com/images/posts/the_10_minute_rails_pubsub/they_should.jpg)

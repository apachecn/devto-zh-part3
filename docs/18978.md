...
> 原文:[https://dev.to/booyaa/enable-linting-in-your-react-app-4ng3](https://dev.to/booyaa/enable-linting-in-your-react-app-4ng3)
...
## [](#add-to-your-raw-packagejson-endraw-)加到你的`package.json`
...
## [](#bonus-enable-in-visual-studio-code)加成:在 Visual Studio 代码中启用

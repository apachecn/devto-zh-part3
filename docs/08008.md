...
> 原文:[https://dev . to/0x hjohnson/setup-react-babel-7-and-web pack-4-2168](https://dev.to/0xhjohnson/setup-react-babel-7-and-webpack-4-2168)
...
# [](#create-babel-config-file)创建通天塔配置文件
...
# [](#create-webpack-config-file)创建 Webpack 配置文件
...
# [](#add-scripts-to-packagejson)向 package.json 添加脚本
...
# [](#create-indexjs-file-inside-src)在 src 内部创建 index.js 文件

...
> 原文:[https://dev . to/satans deer/automate-git-with-hooks-and-husky-4a mo](https://dev.to/satansdeer/automate-git-with-hooks-and-husky-4amo)
...
## [](#access-git-params-and-stdin)访问 Git 参数和标准输入

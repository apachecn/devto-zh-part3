...
> 原文:[https://dev . to/5 chdn/ether eum-node-configuration-modes-cheat-sheet-25l 8](https://dev.to/5chdn/ethereum-node-configuration-modes-cheat-sheet-25l8)
...
## [](#-raw-geth-syncmode-light-endraw-)`❯ geth --syncmode light`
...
## [](#-raw-parity-light-endraw-)`❯ parity --light`
...
## [](#-raw-parity-light-nohardcodedsync-endraw-)`❯ parity --light --no-hardcoded-sync`
...
## [](#-raw-geth-syncmode-full-endraw-)`❯ geth --syncmode full`

同步从源节点开始的完整节点，验证所有块并执行所有事务。这种模式比*快速*同步模式稍慢，但安全性更高。

## [](#-raw-parity-endraw-)`❯ parity`
...
## [](#-raw-parity-nowarp-endraw-)`❯ parity --no-warp`
...
## [](#-raw-geth-syncmode-full-gcmode-archive-endraw-)`❯ geth --syncmode full --gcmode archive`
...
## [](#-raw-parity-nowarp-pruning-archive-endraw-)`❯ parity --no-warp --pruning archive`

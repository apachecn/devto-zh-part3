...
> 原文:[https://dev . to/Jake dohm _ 34/5-help-language-features-proposed-for-JavaScript-2018-edition-4l5h](https://dev.to/jakedohm_34/5-helpful-language-features-proposed-for-javascript-2018-edition-4l5h)
...
## [](#nullish-coalescing-operator)空(ish)合并运算符

...
> 原文:[https://dev . to/mega 6382/how-can-PHP-import-excel-to-MySQL-using-an-PHP-xlsx-reader-and-excel-xlsx-converter-2293](https://dev.to/mega6382/how-can-php-import-excel-to-mysql-using-an-php-xlsx-reader-and-excel-xlsx-converter-2293)

[![](../Images/ace44d7ba37a1866be48f8a46de28e72.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--6SG8ohka--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/600/0%2ABgL1kH6oowWVmshI.png)
...
### [](#parsing-xlsx-in-php)解析 PHP 中的 XLSX
...
### [](#ways-to-import-xlsx-in-mysql)在 MySQL 中导入 XLSX 的方法
...
### [](#importing-xlsx-in-mysql-via-php)通过 PHP 在 MySQL 中导入 XLSX
...
### [](#download-the-simplexlsx-package)下载 SimpleXLSX 包

...
> 原文:[https://dev.to/appsignal/pouring-protocols-in-elixir-5fo2](https://dev.to/appsignal/pouring-protocols-in-elixir-5fo2)

在今天的炼丹术中，我们将搅拌成协议的药剂。Elixir 有几个机制允许我们编写表达性和直观的代码。

例如，模式匹配是一种处理多种场景的强大方法，而不必进入复杂的分支。它让我们的每一个功能都清晰简洁。

# [](#what-are-protocols)什么是协议？
...
# [](#implementing-the-protocol)实现协议

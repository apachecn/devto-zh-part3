...
> 原文:[https://dev . to/eka FYI/adding-generators-to-your-Gatsby-site-with-plop-2g D5](https://dev.to/ekafyi/adding-generators-to-your-gatsby-site-with-plop-2gd5)
...
## [](#step-1-install-plop-and-prepare-the-directory)第一步:安装扑通，准备目录
...
## [](#step-2-prepare-the-folder-plopfile-and-helper)第二步:准备文件夹、plopfile 和 helper
...
## [](#step-3-make-a-generator)第三步:制作发电机！
...
## [](#step-4-ask-questions-prompts)第四步:提问(提示)
...
## [](#step-5-do-things-actions)第五步:做事(动作)
...
## [](#step-6-make-the-template)第六步:制作模板

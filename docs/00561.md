...
> 原文:[https://dev . to/sakko/how-I-setup-my-MAC-for-development-2obp](https://dev.to/sakko/how-i-setup-my-mac-for-development-2obp)
...
# [](#check-set-my-home-folder)检查/设置我的个人文件夹
...
# [](#install-xcode-command-line-tools)安装 Xcode 命令行工具
...
# [](#configure-git-config)配置 git 配置
...
# [](#setup-global-gitignores)设置全局。gitignores
...
# [](#homebrew-postgresql-mysql-elasticsearch-redis-and-other-apps)家酿、Postgresql、MySql、ElasticSearch、Redis 等 app

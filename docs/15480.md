...
> 原文:[https://dev . to/bnevilleoneill/node-js-threading-what-worker-threads-and-why-do-they-matter-1 obo](https://dev.to/bnevilleoneill/node-js-multithreading-what-are-worker-threads-and-why-do-they-matter-1obo)

[![](../Images/23e0a9f1a06fc8c248cbe5652bd051c3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--91PclxeJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/960/1%2A4VBxaeHaxTxjZiPbI7g3kw.jpeg)
...
### [](#living-in-a-singlethreaded-world)生活在单线程的世界
...
### [](#why-we-will-never-have-threads-in-javascript)为什么 JavaScript 中永远不会有线程
...
### [](#the-na%C3%AFve-solution-tick-tick-tick)天真的解决方案:滴答，滴答，滴答
...
### [](#lets-start-using-worker-threads)让我们开始使用工作线程吧！

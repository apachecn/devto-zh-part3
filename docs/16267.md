...
> 原文:[https://dev . to/sunny Singh/JavaScript-quick-tip-import-from-folder-3pd 0](https://dev.to/sunnysingh/javascript-quick-tip-import-from-folder-3pd0)
...
## [](#the-index-reexport-pattern)指数转口模式

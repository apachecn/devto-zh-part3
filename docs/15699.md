...
> 原文:[https://dev . to/kayut/using-arrow-function-to-define-a-method-2em 3](https://dev.to/kayut/using-arrow-function-to-define-a-method-2em3)

嗨，

我开始学习 React，现在我有点困惑在哪里使用 Arrow-function 来定义一个方法，在哪里不使用它。

# [](#first-lets-check-object-literals)首先让我们检查对象的字面量

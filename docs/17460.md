...
> 原文:[https://dev . to/piczmar _ 0/framework-less-rest-API-in-Java-1jbl](https://dev.to/piczmar_0/framework-less-rest-api-in-java-1jbl)

[![Photo by Hieu Vu Minh on Unsplash](../Images/4dba961bab1a5de2f815e79d9438dd18.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--hh3IXbP7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/bp5s7ju2fnxa5t7p7ckx.jpg)
...
## [](#support-different-http-methods)支持不同的 HTTP 方式
...
## [](#json-exception-handlers-and-others)JSON、异常处理程序和其他

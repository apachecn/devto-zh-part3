...
> 原文:[https://dev . to/azure/creating-a-spring-boot-and-angular-application-for-azure-1-7-2mb 8](https://dev.to/azure/creating-a-spring-boot-and-angular-application-for-azure-1-7-2mb8)
...
## [](#adding-some-business-logic-to-the-application)向应用程序添加一些业务逻辑
...
## [](#testing-and-running-the-application-locally)在本地测试和运行应用程序
...
[![](../Images/89d1fa3115e97097d561194846f60153.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ZvFSqti2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/hj62hhyb1lkbvixvuomn.png)
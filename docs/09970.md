...
> 原文:[https://dev . to/bnevilleoneill/improve-your-ui-with-react-transition-group-3jmi](https://dev.to/bnevilleoneill/improve-your-ui-with-react-transition-group-3jmi)

[![](../Images/51bf3fff071d66274668ebdf1a41b179.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--XwGlLrJj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AMLFqXC9V1urGVH0vNT1Kkw.jpeg)
...
### [](#transition-a-react-component-using-css-with-csstransition)使用 CSS 转换一个 React 组件
...
#### [](#after-csstransition)**后** CSSTransition

[CSSTransition 组件(带过渡)- CodeSandbox](https://codesandbox.io/embed/wy4rnqly2k)

#### [](#how-the-transition-was-created-using-csstransition)如何使用 CSSTransition 创建过渡
...
### [](#adding-the-appear-prop-to-display-transition-on-load)添加出现道具以显示载入过渡
...
### [](#using-enter-and-exit-props)使用进入和退出道具
...
### [](#applying-transitions-to-elements-in-a-list-using-transitiongroup-and-csstransition)使用 TransitionGroup 和 CSSTransition 将过渡应用于列表中的元素
...
### [](#transitions-using-jss)使用 JSS 转场

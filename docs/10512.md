...
> 原文:[https://dev . to/resir 014/using-typescripts-absolute-paths-in-create-react-app-20-without-ejecting-4kd 9](https://dev.to/resir014/using-typescripts-absolute-paths-in-create-react-app-20-without-ejecting-4kd9)
...
## [](#set-up-raw-craco-endraw-)设置`craco`
...
## [](#extend-raw-paths-endraw-option-from-a-separate-file)从一个单独的文件中扩展`paths`选项
...
## [](#rewire-webpack-aliases-using-raw-craco-endraw-)Rewire webpack 别名使用`craco`
...
## [](#configure-jests-raw-modulenamemapper-endraw-)配置笑话的`moduleNameMapper`

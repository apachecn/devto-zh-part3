...
> 原文:[https://dev.to/tanker/tsrc-处理-大规模多 git-储存库- eg3](https://dev.to/tanker/tsrc---handling-multiple-git-repositories-at-scale--eg3)
...
[![tsrc screenshot](../Images/687e3ec477866aee90bcdf198d2bb57c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--0JE9HhsC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/wvd5t83st0ndl0x79w24.png)
...
## [](#making-sure-all-the-repositories-are-up-to-date)确保所有的库都是最新的
...
# [](#managing-merge-requests)管理合并请求

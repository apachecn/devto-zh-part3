...
> 原文:[https://dev.to/gdotdesign/mint-routing-2h69](https://dev.to/gdotdesign/mint-routing-2h69)
...
### [](#matching-all-not-defined-paths)匹配所有(未定义)路径
...
### [](#navigating-to-a-new-url)导航到新的网址
...
### [](#practical-usage-and-example)实际用法及举例
...
## ![GitHub logo](../Images/75095a8afc1e0f207cda715962e75c8d.png) [薄荷-郎](https://github.com/mint-lang) / [薄荷-举例-路由](https://github.com/mint-lang/mint-example-routing)

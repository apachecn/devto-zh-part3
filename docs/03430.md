...
> 原文:[https://dev . to/3 sanket 3/how-to-fast-deploy-node-js-app-to-heroku-58k 4](https://dev.to/3sanket3/how-to-quickly-deploy-node-js-app-to-heroku-58k4)
...
## [](#initialize-the-git-for-the-project-if-it-isnt)初始化项目的 Git(如果不是)

如果你的项目是 git 库本身，那么转到[安装 heroku](#install-heroku)T2】
...
## [](#create-a-heroku-app)创建 Heroku app
...
## [](#make-sure-the-raw-packagejson-endraw-of-your-project-have-a-raw-start-endraw-command)确保你的项目的`package.json`有一个`start`命令
...
[![heroku deployment output](../Images/ffbc6fdfe8482ff3aed1ddd8e6542754.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--2wRxP5eU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/oavbqxgphz9tx0lh396e.PNG)

## [](#check-deployment-logs)查看部署日志

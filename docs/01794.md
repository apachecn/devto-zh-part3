...
> 原文:[https://dev . to/nikoheikkila/generating-conventi on-changelogs-4n 39](https://dev.to/nikoheikkila/generating-conventional-changelogs-4n39)
...
## [](#bonus-export-in-any-format)奖金:以任意格式导出

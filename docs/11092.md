...
> 原文:[https://dev . to/muthuraja/running-selenium-automation-tests-using-selenium-intellij-and-maven-3d0e](https://dev.to/muthuraja/running-selenium-automation-tests-using-selenide-intellij-and-maven-3d0e)
...
## [](#benefits-of-selenium-testing-with-selenide)用硒元素测试硒的好处
...
[![](../Images/004a72eee003a68af26e404d89fe9a78.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Y6pRLsRQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/02/pasted-image-0-39.png)
...
*   **更加关注测试**:使用 Selenium 的 Selenium 测试更加关注自动化测试，在 Selenium WebDriver 之上提供了更好的便利性。![](../Images/8302443fa31e7fb8ef4858a46075ff5f.png)
...
## [](#kickstarting-selenium-testing-with-selenide)用硒化物启动硒测试
...
## [](#selenium-testing-with-selenide-setting-up-the-environment)硒元素测试:设置环境
...
[![](../Images/a8a26ddde3664fb909ad5e683b724b9c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--yCP0Fjla--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/02/003_Java_Home.png)

现在，我们需要编辑 Path 系统变量并在其中添加 JAVA_HOME，以便所有运行时程序都能够检测到机器中的 JAVA。确保在添加分号后追加该值。

[![](../Images/a5aebca1b3f4fe7978cfbab731bc2a57.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--e7J5JcMQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/02/004_Adding_JavaHome_in_Path.png)

验证 JDK 是否正确安装。您需要提供以下命令:
`java -version`

[![](../Images/75a744e4a5df21be83a53c14c8da0ef1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--a-Ngkyi3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/02/005_Verifying_Java_Version.png)

太棒了。您刚刚在您的计算机上成功安装了 JDK。

## [](#selenium-testing-with-selenide-download-intellij-and-setting-up-maven-project)用 Selenide 测试 Selenium 下载 IntelliJ 并设置 Maven 项目
...
[![](../Images/f878a0485499591425091f12ba3d0b1c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--eJ6NsVPF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/02/006_IntelliJ_Launch_Page.png)

对于本文，我更喜欢使用“Maven”项目。选择我们安装的特定 Java 版本，并使用默认参数单击 Next。

[![](../Images/6ef1ccc18b3a96efb2927d07428fb352.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--gqChks1q--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/02/007_Select_Maven.png)

在 GroupID、ArtifactID 等必要字段中输入值，并将其保留为默认版本。

[![](../Images/f7c37e716f66ad86b923e6080a14d8ff.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--bkEAFV59--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/02/008_projectName.png)

保留项目名称，并选择项目的位置。

如下所述，创建的用于硒化物测试的项目显示在 IntelliJ 中。
[![](../Images/922e51b2432d3bb462ffd11a64905e12.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--zi8MqSSB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/02/009_Maven_model.png)
...
[![](../Images/39d340336af48ab98a1bcb7890c3a2ad.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ajOGhg5V--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/02/011_default_chrome.png)

[![](../Images/67cbc8e55e69cbfcee2303edb796bd82.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--MQe5lqlu--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/02/010_Local_Instance_Test_Results.png)

## [](#wish-to-perform-selenium-testing-with-selenide-on-a-different-browser)希望在不同的浏览器上用 Selenide 进行 Selenium 测试？

在其他浏览器中运行相同的测试也非常简单。例如，如果你想使用火狐浏览器，我配置如下。

[![](../Images/10d2b5f9b718d08ac8d9b63d5928e990.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Z0AymAjM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/02/Firefox_config.png)

要了解更多关于浏览器配置和如何知道硒支持哪些浏览器，请看看下面的快照。

[![](../Images/5318d5588c1c6649d9861b89a253704e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--N9cvM-Qx--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/02/013_More_Browser_config.png)
...
[![](../Images/0476933f2deceef4cdbf47f52075d984.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--uYm2ZJXi--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/02/015_Element_Locators.png)

[![](../Images/4ce7001446dac67bb0b3b47f04c3cd18.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--DNU3ZtwE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/02/016_elements_locators_collections.png)
...
**条件:**
[![](../Images/4e504d3e02615f84bedac5d5365c56fc.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--8rMVwEjT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/02/017_conditions.png)
...
## [](#cross-browser-parallel-test-automation)跨浏览器并行测试自动化
...
[![](../Images/1451d29ecaf6ce499dc27c72bb5d3ee1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ccYA59KZ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/02/image16-3.png)
...
[![](../Images/d1b33908397398391653b3c378b0b06a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--oTR10AL5--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/02/020_Selenium_Grid.png)

现在，轮到硒节点了。

Selenium 节点配置设置:

[![](../Images/6ad6ae1835f649b9d8bec333b977e31b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--XLpCW1Jt--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/02/021_Selenium_Node.png)
...
[![](../Images/a422613d63f4a8841161af14169f52b1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--91LnMhs_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/02/022_Selenium_Node_start.png)

要验证网格控制台中浏览器实例的数量，请导航到 [http://localhost:4000](http://localhost:4000)

[![](../Images/a1fafbbf2e998a6a3e73c59ff2e1b087.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--b-XBoQiD--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/02/023_selenium_grid_Host.png)

默认存在 5 个火狐、5 个 Chrome 和 1 个 IE 浏览器。这取决于您所需的浏览器实例的数量，可以在 Selenium 节点配置中进行配置。

现在，是时候在跨浏览器平台中运行您的并行自动化了。

## [](#selenium-testing-with-selenide-sample-codeself-explanatory-cross-browser-parallel-automation-in-local)硒元素测试-样本代码(自我解释):跨浏览器本地并行自动化
...
## [](#what-is-desired-capability)什么是期望的能力？
...
[![](../Images/5d7e536d0aefc1ca0e72f271dd1648be.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--N63xZ88O--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/02/024_testng_parallel.png)
...
[![](../Images/0359c63ab82b01711539b8f477082f28.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--csePRkyT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/02/025_baseConfig.png)中提到的名称相同
...
[![](../Images/2f21427990a890dccf03cbe7fa4105b5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--7U0XZVsc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/02/026_Parallel_Test_Results.png)

## [](#running-parallel-test-in-lambdatest-for-selenium-testing-with-selenide)在 LambdaTest 中运行平行测试，用硒化物进行硒测试

在 LambdaTest 上并行执行相同的测试非常简单明了。我将在 LambdaTest 中解释相同的脚本，除了在 BaseConfig 类& TestNG 的代码中有一些调整。

[![](../Images/2c305440bbab0866423e5e7008e1bd92.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--mefC5cOg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/02/027_Parallel_Lambdatest.png)
...
[![](../Images/7112bd6775e535ea034e48d1ece21116.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vDYZin67--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/02/028_Capability_generator.png)

## LambdaTest 的 BaseConfig 类中的变化

[![](../Images/085a35d3cde8a286eac6eab70c4bb056.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--24vz60iZ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/02/029_BaseConfig_LambdaTest.png)
...
## [](#how-to-set-environment-variable-for-lambdatest-usernamepassword)如何为 LambdaTest 用户名/密码设置环境变量？
...
[![](../Images/475abb48a3591b7fa53182f621ce0078.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--tbx_JjRG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/02/image18-3.png)
...
[![](../Images/7c51a306d85f0c51c9f85e06e88f2530.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--D1768oU5--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/02/image27.png)

测试结果在 LambdaTest 门户中运行，结果可以显示在下面的快照中。

[![](../Images/d4b48f044175897ce983aee9b820f5fb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Ufh3QGvt--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/02/032_Detail_Veiw_Test_Results.png)
...
[![](../Images/5ca15e434455da9426a2aad75efd7d47.png)T2】](https://www.lambdatest.com/blog/wp-content/uploads/2018/11/Adword-Cyber2.jpg?utm_source=Dev&utm_medium=Blog&utm_campaign=mu-14-080319us&utm_term=OrganicPosting)

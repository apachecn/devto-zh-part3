...
> 原文:[https://dev.to/mindsers/decouple-your-code-5d](https://dev.to/mindsers/decouple-your-code-5d)

解耦你的代码，你的同事会感谢你的。

脱钩并不是一个新概念，但我最近才开始记录自己在这方面的经历。以下是我学到的东西。

## [](#what-is-decoupling-)什么是“脱钩”？
...
## [](#decoupling-is-the-solution)“脱钩”是解决之道

...
> 原文:[https://dev . to/kovah/a-drop-in-docker-stack-for-PHP-apps-112 e](https://dev.to/kovah/a-drop-in-docker-stack-for-php-apps-112e)
...
## [](#why-should-you-use-docker)为什么要用 Docker？
...
## [](#the-dropin-docker-stack)嵌入式 Docker 堆栈
...
### [](#microservices-over-monolithic-architecture)整体架构上的微服务
...
### [](#bitnami-docker-images)Bitnami 坞站图像
...
[![Teaser Image](../Images/ac005f052f2312c139bfe7ee34af2483.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--HRN_FCPW--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/my7t8460pp91eqtbyrtf.jpg)

## [](#details-about-the-stack)关于堆栈的详细信息

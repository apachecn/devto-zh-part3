...
> 原文:[https://dev . to/areknawo/how-to-think-and-type-in-typescript-5141](https://dev.to/areknawo/how-to-think-and-type-in-typescript-5141)
...
## [](#index-signature-with-additional-properties)带附加属性的索引签名
...
## [](#functions-with-properties)具有属性的函数
...
## [](#type-inference-amp-iteration)式推理&式迭代

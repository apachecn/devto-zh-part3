...
> 原文:[https://dev . to/marina mosti/hands-on-vue js-for-初学者-part-7-3e1c](https://dev.to/marinamosti/hands-on-vuejs-for-beginners-part-7-3e1c)
...
## [](#vue-i-want-you-to-grab-this-input-that-im-putting-this-raw-vmodel-endraw-directive-on-and-make-a-two-way-relation-with-it-im-going-to-give-you-a-raw-property-endraw-and-whenever-i-change-this-property-anywhere-in-my-code-i-want-you-to-change-it-on-the-input-and-likewise-whenever-this-input-changes-i-want-you-to-reflect-those-changes-in-my-prop)**Vue** ，我要你抓住我把这个`v-model`指令放进去的这个输入，并与它建立双向关系。我将给你一个`property`，每当我在代码中的任何地方改变这个属性，我希望你在输入端改变它，同样地，每当这个输入改变，我希望你在我的 prop 中反映这些改变。
...
[![](../Images/1ba6d9441d4383321928a3a338933763.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--DdZgRMFo--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/me1nmdwfmhv5plz1x2bg.png)

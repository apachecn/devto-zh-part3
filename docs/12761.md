...
> 原文:[https://dev.to/louhayes3/git-cheat-sheet-koa](https://dev.to/louhayes3/git-cheat-sheet-koa)

# [](#best-commands-and-steps-for-error-free-git-in-a-team)团队中无错 Git 的最佳命令和步骤。
...
### [](#to-check-all-versions)查看所有版本

```
git branch -va 
```

### [](#to-delete-the-local-git-branch-we-can-try-one-of-the-following-commands)要删除本地 GIT 分支，我们可以尝试以下命令之一:
...
### [](#to-delete-a-remote-branch-you-can-use-the-following-command)要删除一个远程分支可以使用以下命令:

```
git push <remote_name> --delete <branch_name> 
```

## [](#to-rebase-your-branch-with-the-upstreamforked-branch)用上游分支/分叉分支重置您的分支

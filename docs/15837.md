...
> 原文:[https://dev . to/fadilxcoder/using-codeigniter-3-captcha-helper-in-forms-gjl](https://dev.to/fadilxcoder/using-codeigniter-3-captcha-helper-in-forms-gjl)

嗨，

我将向您展示一个非常简单的方法来使用 codeigniter 3 的验证码助手时，提交一个表单在您的网络应用程序。

## [](#so-ready-set-code-)如此...准备，就位，开始！

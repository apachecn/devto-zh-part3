# 每位数据科学家必备的 5 项 Python 技能

> 原文:[https://dev.to/sinxloud/python-skills-data-scientist-3146](https://dev.to/sinxloud/python-skills-data-scientist-3146)

大多数数据科学家和机器学习工程师更喜欢使用 Python 进行数据科学，并开发人工智能和机器学习应用程序。

*本帖最初发表于[这里](https://sinxloud.com/skills-in-python-for-data-scientist/?)。*

## 这里是每个数据科学家必备的 5 项 Python 技能

如果您是一名数据科学家，或者想通过 Python track 学习数据科学，作为初学者，您需要掌握以下五项关键技能。

为了帮助您发展这些技能，我们已经链接了一些最佳可用资源，以帮助您成为一名创造性的数据从业者。

### [](#1-data-scraping)1。数据抓取
...
### [](#5-data-visualization)5。数据可视化

数据科学是关于交流你的发现，而数据可视化是其中非常有价值的一部分。

Python 通过 [matplotlib](http://matplotlib.org/users/pyplot_tutorial.html?__hstc=240889985.529c2bec104b4b98b18a4ad0eb20ac22.1539505603602.1539599559698.1539602103169.12&__hssc=240889985.6.1539602103169&__hsfp=1355148755) 提供了类似 Matlab 的绘图，这是功能性的，即使它缺乏，如果你真的对动态可视化很认真，试试 [d3](http://d3js.org/?__hstc=240889985.529c2bec104b4b98b18a4ad0eb20ac22.1539505603602.1539599559698.1539602103169.12&__hssc=240889985.6.1539602103169&__hsfp=1355148755) 。

* * *

*这些技巧在 DataCamp 提供的[数据科学家与 Python 职业跟踪](https://sinxloud.com/fly/data-scientist-with-python-track-datacamp/)中得到了很好的传授。*

*[DataCamp](https://www.datacamp.com?tap_a=5644-dce66f&tap_s=384177-0102f2) 提供超过 **100+** 由专家讲师讲授的课程，主题包括导入数据、数据可视化、SQL、机器学习、统计思维等。*

*通过 [DataCamp](https://www.datacamp.com?tap_a=5644-dce66f&tap_s=384177-0102f2) 对每次练习的即时和个性化反馈，你会学得更快。*

* * *

#### [](#before-you-go)出发前

你可能也有兴趣阅读[如何用 Python 学习数据科学](https://sinxloud.com/learn-data-science-with-python-track/)或者可能想从一个[最好的(并且负担得起的)开始...)数据科学课程](https://sinxloud.com/best-data-science-courses-specialization-certificate/)学习和提升您的技能。

如果你想学习数据科学的[概率和统计，我已经在这篇文章中为你介绍了最好的在线课程](https://sinxloud.com/probability-statistics-for-data-science-courses/)。

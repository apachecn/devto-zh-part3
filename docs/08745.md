...
> 原文:[https://dev . to/heroku/how-to-use-computer-vision-to-automatically-filter-images-3g7k](https://dev.to/heroku/how-to-use-computer-vision-to-automatically-filter-images-3g7k)
...
[![CatBook demo animated GIF](../Images/650b36445e1420ef966fb90707fe9491.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--a0tEhno---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/19lbxefcfh2gbchj7khx.gif)
...
[![CatBook architecture diagram](../Images/4acbeb39c2498faca9e01358913e4910.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--QMB1q9hf--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/k0vnv1jrs8aec9bwyc21.png)

<figcaption>Diagram displaying the network connections involved in CatBook.</figcaption>

## [](#start-with-a-basic-hello-world-app)从一个基本的“Hello World”App 开始
...
[![Create new app from Heroku Dashbaord](../Images/8b41925a868ebb0e399a0aea973e5409.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--bNW5AeCX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/582euwzmkz2koi0mmcm0.png)

给你的应用取一个合适的名字，然后从**部署**选项卡中，选择 GitHub 作为**部署方法**。

[![Choose deployment method from Heroku Dashboard](../Images/ced07e12ed75382bf932ea18853e78fc.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--oryKYHeF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/c1h8gz5kjlnlvtgjv735.png)
...
[![Enable automatic deploys from Heroku Dashboard](../Images/751bd0fcd19ab84b0e6c40ac97461a60.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--g2bVt9lg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8whh5dbjdjaq9nixxmif.png)

现在，为了使我们已经推送的代码生效，在最后的手动部署部分点击**部署分支**。

[![Deploy a branch from Heroku Dashboard](../Images/3353f144cda13c661a1cea1279c5f500.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--EssLtgBV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/1luhjngtg8tv5s4ym90p.png)

现在，在你的 Heroku 应用的右上角，点击**打开应用**。这将打开一个新的标签到你的网站的网址！

[![Open app from Heroku Dashboard](../Images/3f2990883c6df937b9ec47f77546f693.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--gwsQ2Z_c--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ydg6z40epo1ih2ttdoyb.png)

现在我们有了一个 Heroku 应用程序，可以从 GitHub 自动部署，我们可以简单地将更改推送到我们的存储库，这样它们就可以在我们的实时站点上自动更新。

## [](#set-up-google-cloud-vision-api)设置谷歌云视觉 API
...
[![Enable APIs and Services on Google Cloud](../Images/eacbaf2352de99403142037428658baa.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vJXAvBim--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/y6hda69zeuxb109cs3xg.png)
...
[![Enable Google Cloud Vision API](../Images/0779853dd00d7f6d1d9244301a049cbd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--QnncwdI5--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/big6s4qav5ln8toknvzk.png)
...
[![Create Service account key in Google Cloud](../Images/fcc40db90ab12a5d3ba2b8cd788647ad.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--6bGzcPh2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/mvb8pfh7l9p48mescm68.png)
...
[![Heroku app Config Vars](../Images/f4a83c399e5f947831f94dc5e1772e4a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--J5sXGm3c--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/voa1iu1cpbtze3opyhl8.png)

一切就绪！现在我们将在开发过程中使用我们的本地`.env`文件，而在生产中使用 Heroku 配置变量。在这个例子中，我们使用相同的变量。然而，在一个活动的项目中，这使得拥有各种环境、数据库连接、凭证等等用于开发、登台和生产变得非常容易。

## [](#create-a-backend-server-with-node)用节点创建一个后端服务器
...
## [](#build-the-frontend-in-react)在 React 中构建前端

...
> 原文:[https://dev . to/solace devs/introducing-the-solace-pubsub-for-PCF-tile-version-2-2-0-19mn](https://dev.to/solacedevs/introducing-the-solace-pubsub-for-pcf-tile-version-2-2-0-19mn)

[![](../Images/58b9b7399dc5e25ad869a3b32f1bec4e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--zVos6dmb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://solace.com/wp-content/uploads/2019/01/v2_DARK_Introducing-the-Solace-PubSub-for-PCF-Tile-Version-2.2.0-1.png)
...
## [](#ondemand-service-broker)按需服务代理
...
## [](#application-security-groups-asgs)应用安全组(ASG)
...
## [](#dynamic-message-routing-dmr)动态消息路由(DMR)
...
## [](#configurable-webhook-triggered-by-service-lifecycle-changes)服务生命周期变化触发的可配置 webhook
...
## [](#exportimport-service-instance-settings)导出/导入服务实例设置
...
## [](#operatorconfigurable-service-plans)运营商可配置的服务计划

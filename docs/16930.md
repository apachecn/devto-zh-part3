...
> 原文:[https://dev.to/areknawo/ecmascript-6-and-up-in-2019-d51](https://dev.to/areknawo/ecmascript-6-and-up-in-2019-d51)
...
# [](#enter-the-compilers-era)进入编译器时代
...
## [](#const-amp-let-variable-declarations)Const & let 变量声明
...
## [](#rest-parameters-spread-operator)其余参数/传播算子

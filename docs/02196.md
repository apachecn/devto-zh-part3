...
> 原文:[https://dev . to/twilio/server less-ruby-on-AWS-lambda-with-the-jets-framework-2g 24](https://dev.to/twilio/serverless-ruby-on-aws-lambda-with-the-jets-framework-2g24)
...
[![The Jets Logo](../Images/76fa8c763c5ffb9cf5c319d549647043.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8xBWUV7r--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3.amazonaws.com/com.twilio.prod.twilio-docs/images/MbSU26tM8FMRwHQ6hwnjPgtiseMlWDonId63c_uWs-eNUd.width-500.png)

## [](#from-rails-to-jets)从铁轨到喷气机
...
[![The Jets welcome page open in a browser.](../Images/273676b8a0242bed74d2a5f4a3d23b1c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--G5eC1U0N--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3.amazonaws.com/com.twilio.prod.twilio-docs/images/5Ux-cijdn83L7eiOHmlJvLy2XYQ-j7cFTijkQTuKrFzTRE.width-500.png)

如果您看到此页面，那么您的新 Jets 项目正在成功运行。

## [](#our-first-jets-controller)我们的第一架战机控制器
...
## [](#are-you-ready-to-deploy-iam)准备好部署了吗？我是！
...
[![Select IAM from the AWS dashboard](../Images/4fc9255c2e2907e7996f11571516fd65.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--v58NM7ZX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3.amazonaws.com/com.twilio.prod.twilio-docs/images/8v8dtoFQGT1xLEbege9lrVmCpy6wsbH8zOeEeYt0bC2lFH.width-500.png)

转到*策略*部分并创建一个新策略。

[![Navigate to policies and create a new policy.](../Images/0b90d13cbece9216b1faa7721b06a8bc.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--oFaai_zp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3.amazonaws.com/com.twilio.prod.twilio-docs/images/h_Hjb1Mr3f4b9wdpQ29dIvqiWx2sMhtClfqCs841tHQtLU.width-500.png)
...
[![Give the policy a name on the review page then save.](../Images/703fe51e93cb9936ad92e178c133843e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--6v8IGsud--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3.amazonaws.com/com.twilio.prod.twilio-docs/images/4jwzDK_cmz_1Et8KGGeiaBNxVVHs9QJwzP9xumd4tTgfHW.width-500.png)

保存策略。现在我们需要创建一个新用户，并将策略附加到它上面，授予它创建 Jets 需要部署的资源的权限。打开 *IAM* 控制台中的*用户*部分，创建一个新用户。

[![Navigate to Users and create a new user.](../Images/eeee2ec08d79c2b0d61e58dcdbf7a76c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--RVTRnHeS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3.amazonaws.com/com.twilio.prod.twilio-docs/images/3dt4UQR8aYoKlckCHlw113K3jxhHCGMRJ2rhPDGI1peBow.width-500.png)

给用户一个名字，选择*访问类型*的*程序化访问*。

[![Name the user and check the check box for programmatic access](../Images/6621d1c1fe9f1905fab84b095357d2d9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--wwFMlFNO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3.amazonaws.com/com.twilio.prod.twilio-docs/images/usEXv2bqNxbt3FPo0nJAkKEvm0YUTs62el40415Uu7e2ys.width-500.png)

点击*下一步*为您的新用户选择权限。选择*直接附加现有策略*并过滤您刚刚创建的策略的名称。选择该策略并点击*下一步*。

[![Filter for the policy you just created and select it.](../Images/09f4faa57156aceeb22c392e5e201b1c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--d-QDONTL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3.amazonaws.com/com.twilio.prod.twilio-docs/images/JORcX2AMUcp2pITsVXjLbxXpPNsO_obGu2lhRYjEzC83X8.width-500.png)

点击*下一步*，直到到达成功页面。

[![Success, you have created a new user.](../Images/1b408f95ce074886cc8442c105e3207a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--j0UAcVU2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3.amazonaws.com/com.twilio.prod.twilio-docs/images/XNdTXkfWx0BCu-UDHI1HZZBI_TOLxJ0u4qh9rYQTmMyTGr.width-500.png)

保存最后一个屏幕的*访问密钥 ID* 和*秘密访问密钥*。我们需要他们一起部署。现在我们准备部署。

## [](#deploying-to-lambda)部署到 Lambda
...
[![The last line of the output will include your application URL.](../Images/1bfb1353cdf2722b5d9fa49f45db22b1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--473dkMDb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3.amazonaws.com/com.twilio.prod.twilio-docs/images/D1fQn-0PRn7qXbHYvuIQT-vyo0jiar9lzG4BnVQ9ZY7wwx.width-500.png)
...
[![Enter the URL in the field for when a message comes in.](../Images/5bc930ea85c44a7c67e5d1d7544b0af3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--IBVW1xFW--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3.amazonaws.com/com.twilio.prod.twilio-docs/images/4cnCTI_Ww8IL6cgeyp-zlAIVlx6V_hvvdrT1ocjHfFgsTL.width-500.png)

保存您的号码并向其发送消息。你应该得到一个爸爸的笑话作为回应。现在，为了庆祝，去告诉附近的人这个笑话，让我知道他们是笑还是呻吟。

## [](#serverless-comedy)无服务器喜剧

...
> 原文:[https://dev . to/惠晶/understanding-grid-placement-through-building-a-html-periodic-table-15 m3](https://dev.to/huijing/understanding-grid-placement-through-building-a-html-periodical-table-15m3)
...
[![Screenshot of a 3x3 grid with 3 grid items styled like a chessboard and pieces](../Images/5d91471cacc5b93a551f7d8a51a41908.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--Tr56poS0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.chenhuijing.com/assets/images/posts/grid-placement/manual%402x.png)
...
## [](#grid-automatic-placement)网格自动放置
...
[![Inline box construction showing 3 anonymous line boxes and 2 element line boxes](../Images/d96649c306d78c7159d0e491bb2eea98.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--TPVn0RoD--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.chenhuijing.com/assets/images/posts/grid-placement/anonymous-1280.png)
...
【firefox devtools 的时候比较好，但是因为实现中的一个 bug 而不得不用 chromeಠ_ಠ[![Box placed outside the explicit grid, causing the generation of implicit grid columns to accommodate it](../Images/e3b432a9d7055a71e1b0e9c513e1175c.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--buGwgQNV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.chenhuijing.com/assets/images/posts/grid-placement/implicit-1280.png)

上面的例子是一个 4x3 的显式网格，但是`.rogue`网格项被放置在网格列`8`上，这导致在显式网格之后又生成了 4 个隐式列。

如果所有项目*中没有*的最大列跨度超过了隐式网格的列数，则在末尾添加更多列以适应该列跨度。

[![Implicit grid tracks generated to accommodate a grid item placed on column 6 but spans 3 columns, resulting in the generation of 6 more implicit columns](../Images/6ff12f743bcda2e59453fac8678f28ba.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--n2e1GtHY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.chenhuijing.com/assets/images/posts/grid-placement/implicit-grid-1280.png)
...
## [](#building-the-layout)建筑布局

当绘制到 20x10 的网格上时，我心中的目标设计看起来是这样的:

[![Mock-up of the letters HTML in a 20x10 grid](../Images/3fb955cd8043781074c3751827c053a8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--CveMug3O--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.chenhuijing.com/assets/images/posts/grid-placement/html-grid.svg)

但是等等，如果你靠近一点看，你会注意到有些东西没有完全对齐。

[![Diagram showing misaligned tiles in the letter M](../Images/e0a461886aad5934717bffe73913bb23.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--khXmsTED--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.chenhuijing.com/assets/images/posts/grid-placement/html-grid2.svg)
...
[![Mock-up of the letters HTML in a 40x10 grid](../Images/22ae0aad6dac99d3c1b6cbfd94b4aed1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--58o0jg4n--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.chenhuijing.com/assets/images/posts/grid-placement/html-grid3.svg)

那就 40x10 吧。

### [](#building-the-grid)构建网格
...
[![Adding classes for easier column position assignment](../Images/46e54d6e0ad9a758f357315a67131ff1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--nnV9WYEk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.chenhuijing.com/assets/images/posts/grid-placement/classes.svg)
...
[![Auto-placed grid items get packed into unoccupied cells when grid-auto-flow gets set to dense](../Images/6d017ceaad86186a095d2036145f44ae.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--M4a27u_k--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.chenhuijing.com/assets/images/posts/grid-placement/dense-1280.png)

## [](#fallbacks-and-narrow-viewports)后退并缩小视口

到目前为止，我已经习惯了迎合不支持网格的浏览器，以及我的目标设计无法工作的视口。我也将回顾一下我的思考过程。

[![The original target design only works well on a wide viewport](../Images/9177e4d7f0aee0b8dddc02880b3c191b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ZItQr9Tv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.chenhuijing.com/assets/images/posts/grid-placement/wide-1280.png)
...
[![No funky whitespaces at the edges with 1fr](../Images/e0fd39081496ee5ae8f58d7e93696114.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--PkKgKAdy--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/58je1c4fvezy0wkzrkrl.gif)
...
[![Fallback layout implemented with flexbox](../Images/a566df9d636b7330adcf068c0a83c784.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--_z0fl_F9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.chenhuijing.com/assets/images/posts/grid-placement/flex-1280.png)

## [](#sprinkle-on-some-javascript)撒上一些 Javascript
...
[![Mike Riethmuller's implementation of the HTML periodic table of elements that showed the definition of the element when clicked on](../Images/29743c849c913cf93e7db4412d4f6430.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--4x1xzNpJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.chenhuijing.com/assets/images/posts/grid-placement/mike-1280.png)

...
> 原文:[https://dev.to/sematext/top-node-js-metrics-to-monitor-1id5](https://dev.to/sematext/top-node-js-metrics-to-monitor-1id5)
...
[![cpu metrics](../Images/52951eede4585c7fcc3af41d6b2ac813.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--r5GcZEQh--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://sematext.com/wp-content/uploads/2019/05/pasted-image-0-4.png)
...
[![memory metrics](../Images/64d8062990644edd63cdc00ae4115452.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---6HHD12w--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://sematext.com/wp-content/uploads/2019/05/pasted-image-0-5.png)

## node . js 的垃圾收集指标

在 V8 运行时，垃圾收集会停止程序执行。 [](https://javascript.info/garbage-collection) [垃圾收集有两种](https://javascript.info/garbage-collection)。一种叫做清理，利用**增量垃圾收集周期**一次只处理堆的一部分。这与**完全垃圾收集周期**相比非常快，后者从经历了多次增量垃圾收集周期的对象和变量中回收内存。因为完整的垃圾收集周期会暂停程序的执行，所以它们的执行频率较低。
...
[![garbage collection metrics](../Images/addf2b7c0c224f60e0c70e51205968f1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--B9L81bZg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://sematext.com/wp-content/uploads/2019/05/pasted-image-0-2.png)

## [](#nodejs-event-loop-metrics)Node.js 事件循环指标
...
### [](#longrunning-synchronous-processes)长时间运行的同步流程
...
### [](#incremental-increase-in-tasks-per-loop)每循环任务增量
...
[![event loop latency metrics](../Images/48f72807a6c86f3aebc59be78d42770e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--cJNDwGpV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://sematext.com/wp-content/uploads/2019/05/pasted-image-0.png)

## [](#nodejs-clustermode-and-forking-worker-processes)Node.js 集群模式和分叉工作进程
...
[![worker metrics](../Images/4e4d253cff51090019743df967f25ea4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--uAFnqLml--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://sematext.com/wp-content/uploads/2019/05/pasted-image-0-1.png)

## [](#nodejs-http-requestresponse-latency)Node.js HTTP 请求/响应延迟
...
[![HTTP metrics](../Images/5c1855d140f8eee18b48b7bdc2ca6acd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--pAcWUre5--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://sematext.com/wp-content/uploads/2019/05/pasted-image-0-3.png)

## [](#nodejs-monitoring-dashboard-and-integrations)Node.js 监控仪表板和集成
...
[![Selection 454](../Images/04a5c99199a41e01e0e81cd785dab7ac.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--0AozHgTt--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://sematext.com/wp-content/uploads/2019/05/Selection_454.png)

## [](#wrapping-up-nodejs-key-metrics)总结 Node.js 关键指标
...
如果你需要一个软件栈的可观察性解决方案，看看 [](https://sematext.com/) [语义云](https://sematext.com/cloud/)。我们正在推动 [](https://github.com/sematext) [开源我们的产品](https://github.com/sematext)并产生影响。如果您想试用我们并监控您的 Node.js 应用程序，[注册](https://apps.sematext.com/ui/registration)获得 30 天的 pro 试用，或者立即选择免费等级。
...
> 原文:[https://dev . to/joshtynjala/upgrading-a-react-and-type script-app-from-react-scripts-ts-to-create-react-app-v21-4 akn](https://dev.to/joshtynjala/upgrading-a-react-and-typescript-app-from-react-scripts-ts-to-create-react-app-v21-4akn)
...
### [](#create-a-new-baseline-app)创建新的基线应用
...
### [](#update-library-dependencies)更新库依赖关系
...
### [](#switch-from-reactscriptsts-to-reactscripts)从*react-scripts*切换到 *react-scripts*
...
### [](#update-configuration-files)更新配置文件
...
### [](#my-project-is-upgraded)我的项目升级了

...
> 原文:[https://dev.to/hayk94/react-hooks-re-intro-77m](https://dev.to/hayk94/react-hooks-re-intro-77m)

# [](#react-hooks-reintro)React 钩子重新介绍
...
### [](#yet-another-requirement)还有一个要求
...
### [](#app-grows-performance-issues-come-up)App 成长！性能问题出现了！
...
### [](#new-requirement-with-lots-async-stuff)有大量异步材料的新需求
...
[![dimensions](../Images/cbb8995cea564ee8591b3d7f955a38f5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--dD8Py-90--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/M3HJ0lY.png)

我们有这两个维度来存储我们的数据。

`this`可以在范围内改变。

[![dimensions](../Images/a0b712161b96d68f3ed424f833cd9300.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--QsdibuL3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/gFhXEH1.png)

所以你需要知道我们的数据存在的二维空间。以及它们如何相互作用。

### [](#fucking-bring-hooks-already)他妈的已经带上钩子了！
...
#### [](#now-lets-look-at-benefits)现在我们来看看好处
...
[![One Dimension Only](../Images/9c02a67e7fa0a21cb29458fceee66439.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--U3HEePUU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/aqY05Tz.png)
...
### [](#useeffect-is-a-whole-new-concept)使用效果是一个全新的概念
...
### [](#its-useeffect-not-effects)是使用效果不是效果
...
### [](#some-general-rules-for-hooks)钩子的一些通用规则

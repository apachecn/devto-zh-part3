...
> 原文:[https://dev . to/UGIS 22/how-to-build-a-PostgreSQL-database-to-store-tweets-5c M8](https://dev.to/ugis22/how-to-build-a-postgresql-database-to-store-tweets-5cm8)

[![](../Images/ece01d4f361e3ddc06151178819fe35d.png)T2】](https://cdn-images-1.medium.com/max/1024/1*-_6kuOWGogsZw9Vnr5JTeQ.png)

#### [](#learning-how-to-stream-from-twitter-api)学习如何从 Twitter API 流
...
[![](../Images/991e323b04bf4be9c19676585e53962d.png)](https://cdn-images-1.medium.com/max/1024/1*RGtIAT2HYgyrBigzkCjjiA.png) 

<figcaption>在 Twitter 开发者账户中创建应用</figcaption>

之后，我们需要创建我们的访问令牌。访问令牌将允许我们的 Twitter 应用程序读取 Twitter 信息，如推文、提及、朋友等:

[![](../Images/01755df5660103c4348cb05b0de4a08b.png)T2】](https://cdn-images-1.medium.com/max/1024/1*LBZQmC3Qh7xqVXoAbFQAdg.png)

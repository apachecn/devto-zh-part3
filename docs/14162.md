...
> 原文:[https://dev . to/vladimirnovick/effortless-real-time-graph QL-API-with-server less-business-logic-running-in-any cloud-2j6b](https://dev.to/vladimirnovick/effortless-real-time-graphql-api-with-serverless-business-logic-running-in-anycloud-2j6b)
...
# [](#what-is-this-engine-and-why-its-open%C2%A0source)这个引擎是什么，为什么它是开源的
...
[![front-page](../Images/e191e747444c827d841f13513dccaac4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--lChVLXPG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2AGaDehSsImG95-w9wJuk6NQ.png)

这是一个非常快速和可靠的设置，但是对于生产级应用程序，您应该考虑使用不同的云。如您所见，您可以从各种云选项中进行选择，但为了简单起见，让我们从 Heroku 免费层的基本设置开始。

[![Deploy](../Images/a603a0f432f9fea7306bf76406d2f24f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--YeAAfhbB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2AXts79g-89CauVyOgvAvZ1Q.png)

导游会告诉你这个神奇的按钮。当你点击它的时候，引擎和 Heroku Postgres 插件一起被部署到 Heroku。

## [](#so-what-is-happening-here)那么这里发生了什么呢？
...
[![app.json](../Images/10c27b68fc1252ae32b7ac19ed431cf2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--hILCpg41--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2AjiT6Hg_gOxonE2YP-WYNog.png)

这个 json 文件告诉 Heroku 使用 Postgres addon 在自由层大小部署 web 编队。

除了`app.json`,我们还有`heroku.yml`,它很简单:

[![dockerheroku](../Images/0185c2a41771934caec1a88c9ba3ed52.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9fwtsqVw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2Aw7w-cVyoJIL9J-zhHp0oPw.png)

## [](#its-all-about%C2%A0docker)都是 Docker！
...
# [](#what-about-other%C2%A0clouds)其他的云呢？
...
[![containers](../Images/5a0e8eea4bee9af07540a68b4bf8ec73.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--cmeyVX1q--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2AXSk0VOUZ1La3UVMPcXX3Eg.png)

如您所见，引擎实例与 Postgres db 一起运行。

现在唯一剩下的就是去[http://localhost:8080/console](http://localhost:8080/console)看看了

[![Console](../Images/42f8fc77adfc58e28595bdd4e1df0cec.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--QT6Jm-wL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2A6-Qz7FD6O4winhcfGegKzg.png)

# [](#running-on-top-of-existing%C2%A0postgres)运行在现有 Postgres 之上
...
# [](#and-what-if-i-dont-use-postgres)而如果我不用 Postgres 呢？
...
### [](#endpoint-and-headers)端点和表头

在这个页面的顶部，您将找到 API 端点以及请求头，如果您想从客户端访问 GraphQL API，您需要提供这些请求头。

[![headers](../Images/8ef7dc206ec72bda97850fc037f2b01c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--UvkbDOJt--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2A9bQps8vAjxbfixptH-jzcA.png)

正如您在我们新创建的示例中看到的，我们只有内容类型的头，这并不真正安全，因为每个人都可以访问我们的 API。您会在右上角看到一个通知“保护您的终端”，该通知将引导您找到解释如何保护您的终端的文档。
这是一个安全访问 API 的不同示例:

[![xaccess](../Images/6ba25174009820581fdf733e57ce8355.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8n2vGpkJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2ApzOCoy5SnCiHTijXu4Migw.png)

在这里你可以看到我们有 X-Hasura-Access-Key 头来保护我们的端点。这也将确保对我们控制台的访问。

### [](#graphiql-ide-with-extensions)带扩展的图形集成开发环境
...
[![graphiql](../Images/859c4e58e8a8d5d3822b6d90f8d1e3f8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--KcoOqk5V--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2A6VtgDlPsRre2f1U9gYqqZA.png)
...
[![analyze](../Images/7f589386920e431000ce313bee98ba95.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--lsrqmSLR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2AkgUTU0XQARt-XZblRm0hPg.png)
...
[![remote schemas](../Images/8ed6ff1843c9c6a0406b27f78e7a402f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--6N92PK8f--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2AYXKM1scMRGbq21cvm3qm5g.png)
...
## [](#creating-or-modifying-tables)创建或修改表格

当我们访问我们的数据选项卡时，我们将有一个创建表格的选项。当创建一个表时，你需要指定它的列和类型。

[![modifying](../Images/a630e4d29679ae9a6686f2829d860a7a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--1DNggI9H--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2A873xA1dBG0gG3MUYWxhDLw.png)
...
[![foreign](../Images/ee2e6d562797d6bc51561c55a50fc6b7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--c3s6CHdB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2A9LFU3gBFWD9HUhhAITjX3A.png)

从这个例子中还可以看出，只要我们已经有了表，我们就可以修改它们、浏览行、插入行或添加关系。

## [](#autogenerated-queries)自动生成查询

最棒的是，每当我们添加一个表时，我们都可以在表上访问以下查询/订阅:

[![query](../Images/afa379a237b6b61ea0a1922d2b0a2650.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--KxEmz5xz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2AkSlc7sSqo8CqJfQ2u_73Wg.png)
...
[![object rel](../Images/b708466373b1cf591b9c159794baf69e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--2j7L-EQI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2Abe-XbotmHFwmE7GfmWEYAw.png)
...
[![rel](../Images/eaa50412e78c133314c6244d4731354e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--GY65gVsP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2AoRL24h62QYlByPRZi4Klag.png)
...
[![herokusample](../Images/c3e717d4940188d44e69ffddf639e1e5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--fatTNINR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2ATWWlRidIqSvqfHtXMAHnag.png)
...
[![auth](../Images/b242e8e660aec5830eb8065cf81e6e01.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--GeFZJbZL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2ABpXF9lOs61yNhyHq12RCIA.png)

您可以在此阅读更多关于不同认证选项的信息

# [](#custom-external-graphql-server-aka-remote%C2%A0schemas)自定义外部 GraphQL 服务器又名远程模式
...
[![remote](../Images/8ed6ff1843c9c6a0406b27f78e7a402f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--6N92PK8f--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2AYXKM1scMRGbq21cvm3qm5g.png)

在您的服务器上，假设您定义了一个变异，在将一行插入到同一个数据库之前，解析器运行一些定制逻辑，hasura 引擎连接到这个数据库。那么当数据被插入时会发生什么呢？来自 hasura 引擎的 GraphQL 订阅将按预期运行。

# [](#async-serverless-business-logic-with-event%C2%A0triggers)带事件触发器的异步无服务器业务逻辑
...
[![serverless](../Images/df7f00ffd444878df2a97aef785fefc0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--zvxn1VDF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2ArDAPtPK_PRfYdpmCc-RfcQ.png)

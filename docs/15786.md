...
> 原文:[https://dev . to/code mouse 92/dead-simple-python-data-typing-and-immunability-41dm](https://dev.to/codemouse92/dead-simple-python-data-typing-and-immutability-41dm)
...
# [](#word-of-warning-hungarian-notation)警告词:匈牙利符号
...
## [](#type-hinting-and-function-annotations)键入提示和功能注释
...
## [](#type-hinting-and-defaults)输入提示和默认值

...
> 原文:[https://dev . to/merri/creating-your-own-react-but-only-output-DOM-elements-n06](https://dev.to/merri/creating-your-own-react-but-only-output-dom-elements-n06)
...
## [](#having-a-look-at-what-is-out-there)看看外面有什么
...
## [](#breaking-with-react-compatibility)与 React 兼容性中断
...
## [](#things-done-to-achieve-this-idea)为实现这个想法所做的事情

...
> 原文:[https://dev . to/sergiodxa/conceptos-b sicos-de-js-array map-2hcb](https://dev.to/sergiodxa/conceptos-bsicos-de-js-arraymap-2hcb)
...
## [](#implementando-arraymap-a-mano)实现阵列#映射一个 mano

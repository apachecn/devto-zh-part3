...
> 原文:[https://dev . to/karx _ BRB/we B- components-let-s-build-em-all-3eb 0](https://dev.to/karx_brb/web-components-let-s-build-em-all-3eb0)

# [](#web-components-for-microfrontends-and-reusable-components)Web 组件-用于微前端和可重用组件
...
[![WebComponents Parts](../Images/d6db0ad020946bb1aa44bca212748caa.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--TzUzZvNH--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/0%2ARkhhR4vWy4O9nemq.png)

...
> 原文:[https://dev . to/heroku/building-a-slack bot-to-answer-analytics-questions-from-your-database-4ndf](https://dev.to/heroku/building-a-slackbot-to-answer-analytics-questions-from-your-database-4ndf)
...
[![Lita chatbot from Datclips](../Images/369de36a581f7f008ed5167e9aeaee1d.png "Lita chatbot")](https://res.cloudinary.com/practicaldev/image/fetch/s--R0bQdzXU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4hfhchjz9hqhv8c6n431.jpg)
*Lita 聊天机器人从 Dataclips 中获取数据的图示*

# [](#a-costsaving-alternative-to-bi-and-dashboards)商业智能和仪表板的节约成本的替代方案
...
# [](#how-to-create-your-own-chatbot)如何创建自己的聊天机器人
...
[![New Dataclip](../Images/812a20d5c6c861d76f1931e4a9ebabe6.png "New Dataclip")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--WHiNfzcm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/zwhocnfadn9drhu5rc09.png)

点击**保存&运行**，查询现在以表格格式呈现，并带有数据，以及以图表形式查看的选项:

[![data chart](../Images/eb89a1df2c379d9a6cd43766c9462cda.png "data chart")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--rYGQCzhg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/cmf1wcmlsv60a5iaygak.png)

最后，通过点击**下载/导出**并选择文本字段 **JSON url** 来复制 URL:

[![JSON URL](../Images/07840218bc9bf513a72b6864edbf3af2.png "JSON URL")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--BziCM4Ql--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/em3otp6g75o2i12vl0lq.png)

记下 URL 或者将其导出到环境变量`DOT_API_URL`(您将在开发聊天机器人时使用它)。

# [](#setting-up-lita)设置 Lita
...
# [](#interacting-with-your-chatbot)与您的聊天机器人互动
...
[![bot](../Images/cbef557cfb58089ae9bf0130147aefd7.png "bot")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--QF2n5FFl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/gwangdnmim6qzn3pdlb5.png)

您可以通过添加将 Slack 消息转换成 SQL 查询的功能来扩展您的聊天机器人的功能。这可以让您的团队在创建数据剪辑之前进行试验，并简化定制。

# [](#better-visibility-for-business-insights)更好的业务洞察力

...
> 原文:[https://dev . to/bzinoun/IBM-appid-integration-with-spring boot-2-37o 7](https://dev.to/bzinoun/ibm-appid-integration-with-springboot-2-37o7)

#### [](#what-we-gonna-do)我们要做什么
...
#### [](#ibm-appid-in-few-lines)几行 IBM AppId
...
#### [](#configure-appid-with-spring-boot)用 Spring Boot 配置 AppId

...
> 原文:[https://dev . to/twilio/an-introduction-to-the-media recorder-API-2k8i](https://dev.to/twilio/an-introduction-to-the-mediarecorder-api-2k8i)
...
[![The starter project for the web recorder. It has a heading, a button and a footer and it doesn&#39;t do anything yet.](../Images/b1163e239fedfbc00e6bbb08bdfcb517.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--nR9UYP56--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3.amazonaws.com/com.twilio.prod.twilio-docs/images/oVQ9H3NH773crqhbdIBTdhkl0zYHy1PmnjSyn_3G5W14TF.width-500.png)

现在让我们来看看 MediaRecorder API。

## [](#mediarecorder-api)媒体记录器 API
...
[![If you open the browser console, press the "Get microphone" button and accept the permission, you will see a MediaStream object logged to the console.](../Images/43d7001d96496cc17c1115c5a5063d4a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--OG7T50O_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3.amazonaws.com/com.twilio.prod.twilio-docs/images/ki7kNEUselR9FFmSiSTF7WYV46Tw_j4CCvkRt7xJ97Uf4D.width-500.png)
...
[![The completed application. This animation shows the full system, from getting the microphone to recording the audio, playing it back and downloading the recording.](../Images/d4f517ac10c20b63fada08401cca1783.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--apg5AJzO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3.amazonaws.com/com.twilio.prod.twilio-docs/original_images/9dpCqwpYg0gxuPp8SGEy0WMYsZXkDr4_hi_R68Hrz37qNxuJzwTP2Balg71Ds4AfZEDdRLltwbIajw)
...
## [](#your-browser-is-now-a-recorder)你的浏览器现在是一个记录器

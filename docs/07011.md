...
> 原文:[https://dev.to/mlanders/labs-week-4-a-review-5dfn](https://dev.to/mlanders/labs-week-4-a-review-5dfn)

[![Training Bot](../Images/d14b131f3c07e3d23133eaa5d37fe519.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--FeSEQ7e8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/jzwn4saemikowrhvz2c6.gif)
...
[![Profile payment](../Images/bc7b7a30aee1de31273e6240020bfb13.png)T2】](https://i.giphy.com/media/kcf1Eya06r30mEMrEy/giphy.gif)

当你选择一个支付选项时，它会添加一个漂亮的动画，一旦支付被接受，它会在指南中切换你的计划，并在简介卡的左侧。

| 苹果平板电脑 | iPhone 大号 | iPhone 小号 |
| --- | --- | --- |
| ![iPad](../Images/372662215def7b0b87579f06959d032d.png) | ![iPhone Large](../Images/2fd5250ec50b13872b251498a086e20c.png) | ![iPhone Small](../Images/0d49fa4ee59eadf1c531208de4509483.png) |

本周的第二个重大胜利是让主仪表板完全响应。这需要操作多个组件。需要使用样式组件和材料 UI 样式来调整样式。

[![Responsive](../Images/9e6beef0a176d727ecb481936e04f6b0.png)T2】](https://i.giphy.com/media/J3SSg61LY9xXXCRK5G/giphy.gif)

...
> 原文:[https://dev . to/bogdaamn/run-your-nodejs-application-on-a-headless-raspberry-pi-4jnn](https://dev.to/bogdaaamn/run-your-nodejs-application-on-a-headless-raspberry-pi-4jnn)
...
## [](#get-that-raspberry-pi-up-and-running)启动并运行树莓酱

无头安装不需要任何类型的额外硬件(如屏幕或键盘)，因此您需要的一切就是 Raspberry Pi 本身、microSD(或 SD，取决于您的硬件)卡和互联网连接(有线或无线，也取决于您的 Raspberry)。

### [](#1-get-the-raspbian-stretch-image)1。获取[拉斯边拉伸](https://www.raspbian.org/)图像
...
[![Download Raspbian Stretch Lite](../Images/753bfd79a7f24c1b52533a10bbbf95b7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--mp50ATwW--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/2atkux0j8lq2oqx0b2w5.png)

### [](#2-burn-that-image)2。烧掉那张照片
...
### [](#3-enable-headless-ssh-connections)3。启用无头 SSH 连接
...
### [](#4-boot-that-raspberry-pi)4。启动那个树莓派

插入卡、电源和网络电缆。绿色发光二极管停止闪烁后，您的树莓派就可以使用了！

[![My Raspberry Pi good to go!](../Images/db2e4390d1061e448574833febe0e1c6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--eaRPu3Bk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/39ugughmcqk0fzcwgjge.jpg)

### [](#5-find-that-raspberry-pi)5。找到那个树莓派
...
[![onmyway133 image](../Images/9fad8d3f9a9b830c5f9fde4da46eff87.png)](/onmyway133) [## 在 MAC 层理解 ARP

### khoa Pham Sep 21 ' 183 分钟读数

#arp #mac #ip](/onmyway133/understanding-arp-at-the-mac-layer-2a14)

### [](#6-finally-ssh-into-that-raspberry-pi)6。*最后*宋承宪进了那个树莓派
...
## [](#get-your-nodejs-application-up-and-running)启动并运行 Node.js 应用程序

你被录取了！您应该启动 Node.js 应用程序，因此下面的步骤是通过 SSH 在您的 Raspberry Pi 上运行的。

### [](#1-install-nodejs-on-raspbian)1。在 Raspbian 上安装 Node.js
...
## ![GitHub logo](../Images/292a238c61c5611a7f4d07a21d9e8e0a.png) [节点源](https://github.com/nodesource) / [分布](https://github.com/nodesource/distributions)
...
[![NodeSource](../Images/4bb369187147f0c32dd50828cf43f0c7.png)T2】](https://nodesource.com)

[![CircleCI](../Images/26db3850983affb23ebd0658d3aaba36.png)T2】](https://circleci.com/gh/nodesource/distributions/tree/master)
...
### [](#2-get-your-nodejs-app)2。获取 Node.js 应用程序
...
[![hamza image](../Images/f4c2b6ed44ae8852191397fdc6151502.png)](/hamza) [## Vim 入门——您需要知道的最基本的知识

### hamza Tamenaoul 12 月 25 日 173 分钟阅读

#vim #linux #terminal #beginners](/hamza/vim-for-starters---the-minimum-you-need-to-know-3ob)

### [](#3-finally-run-the-nodejs-application)3。*最后*运行 Node.js 应用程序
...
#### [](#start-the-application-with-pm2)用 PM2 启动应用程序
...
[![nickparsons image](../Images/32c77fbcf2cec4647856c475006ad783.png)](/nickparsons) [## 在生产环境中运行 PM2 & Node.js

### 尼克帕森斯 8 月 6 日 185 分钟阅读

#pm2 #node #processmanagement](/nickparsons/running-pm2--nodejs-in-production-environments-23i5)

## [](#make-use-of-a-reverse-proxy)利用反向代理
...
### [](#0-dont-use-a-reverse-proxy-)0。不要使用反向代理:(
...
[![Outer world](../Images/272c999c3a186e670f878bebf1d43a5b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--fFjTYaHw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/focj9afhpa6ej335qchv.jpg)
...
[![Welcome to Nginx, dev.to](../Images/2e301e999745731fcb09910d0f558dc8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--l8Ve4T8v--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/qhczm2oqnxy1sp947g5w.png)

### [](#2-configure-the-reverse-proxy-server)2。配置反向代理服务器
...
[![Finally the needed outer world](../Images/0c7324208370dbf07678eeee8898fc2d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--jRlV5DZH--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/qkcaxeoymobes8kzjxml.png)

搞定了。所有对 Raspberry 地址的请求都将被重定向到 Node.js 应用程序。

请注意，这是 Nginx 的基本配置，您可以在这里找到更多关于其他功能的信息。

[![mozartted image](../Images/fa0bab3eadb80c19c256214063eb8f69.png)](/mozartted) [## 了解 nginx(代理、反向代理、负载平衡)

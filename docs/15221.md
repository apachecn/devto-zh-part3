...
> 原文:[https://dev.to/tathagata/docker-cross-repository-push-4pkn](https://dev.to/tathagata/docker-cross-repository-push-4pkn)

[![header](../Images/f9c04f448c04af2d6e79e0e17e234dcb.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--A10mdbQh--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/aes0ixj8nlw39n6p9ibv.jpg) 
刚发现 dev.to 就立马爱上了复古🤣看啊！我没有花太多心思，而是开始绞尽脑汁——主要是想那些一开始就行不通的事情。没有任何努力是有益的-打字错误，错误，误传可能会提前。欢迎来到互联网！

### [](#problem-need-to-push-a-docker-image-from-one-aws-account-to-another)问题:需要将 docker 映像从一个 AWS 帐户推送到另一个帐户
...
#### [](#login-to-your-docker-registry-of-source-account)登录您的 docker 注册源账户
...
#### [](#ci-produced-docker-image)CI 制作的 docker 图像
...
#### [](#switch-repository-and-try-to-push)切换储存库并试推
...
#### [](#wait-what-does-the-picture-above-got-to-do-with-this-post)等待。上面的图片和这个帖子有什么关系？

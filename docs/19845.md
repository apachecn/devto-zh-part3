...
> 原文:[https://dev . to/cristicurteanu/how-else-you-can-define-properties-for-JavaScript-objects-2 cap](https://dev.to/cristicurteanu/how-else-you-can-define-properties-for-javascript-objects-2cap)

JavaScript 是一项了不起的技术。它非常灵活，允许很酷的运行时对象操作，这不像 Ruby 那样令人头疼(尽管这是我在使用两者后的个人观点)。

## [](#the-common-way-of-properties-definition)属性定义的常用方式
...
## [](#defining-property-using-objectdefineproperty-method)使用**方法定义属性**

...
> 原文:[https://dev . to/nested software/book-notes-learn-you-a-haskell-for-great-good-2 CNP](https://dev.to/nestedsoftware/book-notes-learn-you-a-haskell-for-great-good-2cnp)
...
### [](#recursion-and-higherorder-functions)递归和高阶函数
...
### [](#partial-application-of-type-constructors)类型构造函数的分部应用
...
### [](#the-infamous-raw-gtgt-endraw-function-and-raw-do-endraw-notation)声名狼藉的`>>=`函数和`do`符号
...
### [](#functions-as-functors-applicatives-and-monads)函数*作为*函子、应用和单子
...
### [](#monads-gt-applicatives-gt-functors)单子>适用子>函子

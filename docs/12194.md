...
> 原文:[https://dev.to/azure/docker-from-the-beginning-partiv-mi6](https://dev.to/azure/docker-from-the-beginning-partiv-mi6)
...
## [](#why-docker%C2%A0compose)码头工为什么作曲
...
### [](#the-case-for-docker%C2%A0compose)为 Docker 撰写的案例
...
## [](#docker-compose-features%C2%A0overview)Docker 撰写功能概述
...
## [](#when-plain-docker-isnt-enough%C2%A0anymore)当普通码头工人不再满足时
...
[![alt text](../Images/e2d595122a45c2c6ea8555bed9a8f8ed.png "Docker not scaling")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--itHBniqi--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/9zdbajjweos0erfkjl2h.gif)

### [](#enter-dockercomposeyaml)输入码头-化合物。yaml
...
## [](#docker-compose-in%C2%A0action)坞站在动作中复合

好了，现在我们知道 Docker Compose 可以处理我们在命令行上可以做的几乎所有事情，它还依赖于文件`docker-compose.yaml`来知道要执行什么操作。

### [](#authoring-a-dockercomposeyml-file)编写对接器-compose.yml 文件
...
[![alt text](../Images/7702856c476f0ae12373fcdb9540278a.png "Docker output")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--6_Zej_fI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/gezojc19cb7cvlda0fcr.png)
...
## [](#docker-compose-showing%C2%A0off)码头工人作曲炫耀
...
## [](#building-out-our%C2%A0solution)构建出我们的解决方案
...
[![alt text](../Images/3f48b96fb5c5a1583da3460532c3fa9d.png "Docker awesome")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ju0EHktg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/09jstlay2u68e0uhhllw.gif)

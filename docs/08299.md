...
> 原文:[https://dev . to/garettmd/unset-all-variables-matching-a-pattern-158d](https://dev.to/garettmd/unset-all-variables-matching-a-pattern-158d)

#### [](#unset-all-variables-beginning-with-prefix)取消设置所有以前缀开头的变量

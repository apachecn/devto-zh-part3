...
> 原文:[https://dev . to/radix DLT/knowledge base-update-atom-model-263 I](https://dev.to/radixdlt/knowledgebase-update-atom-model-263i)
...
# [](#particles-are-finite-state-machines)粒子是有限状态机
...
# [](#atom-size-restrictions)原子大小的限制

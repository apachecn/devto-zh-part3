...
> 原文:[https://dev . to/hackersandslackers/using-redis-to-store-information-in-python-applications-4j0k](https://dev.to/hackersandslackers/using-redis-to-store-information-in-python-applications-4j0k)

[![Using Redis to Store Information in Python Applications](../Images/99d5e04d867ee9e62b58957d0dfc30d8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--uVwQSsZ0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://res-2.cloudinary.com/hackers-and-slackers/image/upload/q_auto/v1/images/redis.jpg)
...
### [](#all-users-go-to-heaven-cloud-storage-for-user-sessions)所有用户上天堂:用户会话云存储
...
### [](#when-variables-are-on-a-bagel-you-can-have-variables-any-time)当变量在一个百吉饼上时，你可以随时拥有变量
...
## [](#using-the-redispy-python-library)使用 redis-py Python 库
...
### [](#storing-and-getting-values)存储和获取数值
...
## [](#more-redis-libraries-for-python)更多用于 Python 的 Redis 库
...
## [](#your-box-your-treasure-your-world-%E2%84%A2)你的盒子，你的宝藏，你的世界

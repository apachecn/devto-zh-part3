...
> 原文:[https://dev . to/Stephan 007/create-the-small-docker-image-using-jhipster-6-and-Java-11-35 M7](https://dev.to/stephan007/create-the-smallest-docker-image-using-jhipster-6-and-java-11-35m7)
...
# [](#setup-your-java-11-development-environment)设置您的 Java 11 开发环境
...
[![IDEA](../Images/b6887b802338fc3946d33a0fbc9249f6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--DVBOwQDM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8ivvwhncskw9ntbmj77b.jpeg)

# [](#the-broken-dockerfile-from-jhipster)来自 JHipster 的“损坏的”docker 文件
...
[![alpine](../Images/d035d376dbf051098ff646104acff0f4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8yvPJXSc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/37i55fblr6c42nirm2kc.jpeg)

# [](#from-debian-to-alpine-linux-to-distroless)从 Debian 到 Alpine Linux(到发行版)
...
# [](#azuls-openjdk-zulu)蓝色的 OpenJDK Zulu

Azul 为 Java 11 提供了 Alpine Linux OpenJDK 发行版，两全其美！

[![Azul](../Images/7b5ff362f9f421469c94830a2d652e38.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--FhOdO0g---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/z1urxzxxqbh2eq6mi9h5.jpeg)

> Azul 运行时集成并本地支持 musl 库，这使得集成更加有效(在内存占用和运行时性能方面)。
> 
> 另请参见 Portola 项目——这个项目的目标是为 Alpine Linux 发行版，特别是 musl C 库提供一个 JDK 的端口。

# [](#lets-strip-with-jlink)用 JLink 来脱衣吧
...
# [](#the-final-dockerfile)最后的 Dockerfile
...
[![Docker](../Images/eb31fdbc1b5c1617ed9fe0fef4e1f05c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ga-2wFU0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/kdhn4qntyjyjffjuwwi8.png)
...
> ![Christophe Bornet profile image](../Images/da23084a47ed1ce426be978add586891.png)克利斯朵夫婆罗门@ cbornet _![twitter logo](../Images/65e26e35707d96169ec8af6b3cbf2003.png)[@ Stephan 007](https://twitter.com/Stephan007)[@ Bruno Borges](https://twitter.com/brunoborges)[@ alpinelinux](https://twitter.com/alpinelinux)[@ Azul systems](https://twitter.com/AzulSystems)[@ Docker](https://twitter.com/Docker)[@ open JDK](https://twitter.com/OpenJDK)[@ alfio _ event](https://twitter.com/alfio_event)有意思。注意， [@java_hipster](https://twitter.com/java_hipster) 不再使用 Dockerfile，它已经从 master 中移除。我们现在用 jib 代替。2019 年 5 月 13 日上午 06:58[![Twitter reply action](../Images/269095962147c28351274afdd5486a48.png)](https://twitter.com/intent/tweet?in_reply_to=1127830445209600000)[![Twitter retweet action](../Images/771160ecf06ae3d4d7a7815c29c819c2.png)](https://twitter.com/intent/retweet?tweet_id=1127830445209600000)0[![Twitter like action](../Images/c077611ab2a5e0b4cd0c826ee7ae1e48.png)](https://twitter.com/intent/like?tweet_id=1127830445209600000)7
...
[![OpenJDK11](../Images/b941891b503dff9d12b2e762bd480d5c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--IjB6qddI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/r25l6yal3xlcx0i9op66.png)

# [](#distroless-docker-images)【畸变】对接器图像

我的 Devoxx 摩洛哥朋友 Mohammed(也是 Docker 冠军)在 Twitter 回复中建议看看 Google 的 Distroless docker 图片。看起来确实很有希望，需要更多的时间来调查😄

> ![Mohammed Aboullaite profile image](../Images/530718708b8ca575d2bf8516f9acbcec.png)Mohammed Aboullaite@ layt oun![twitter logo](../Images/65e26e35707d96169ec8af6b3cbf2003.png)[@ Stephan 007](https://twitter.com/Stephan007)[@ alpinelinux](https://twitter.com/alpinelinux)[@ Azul systems](https://twitter.com/AzulSystems)[@ Docker](https://twitter.com/Docker)[@ open JDK](https://twitter.com/OpenJDK)[@ alfio _ event](https://twitter.com/alfio_event)作为 alpine 的替代(以及 Musl 的问题)你可以使用一个非常轻量级的 linux 用 openjdk hotspot可以达到类似的效果 07:38am-2019 年 5 月 13 日[![Twitter reply action](../Images/269095962147c28351274afdd5486a48.png)](https://twitter.com/intent/tweet?in_reply_to=1127840532363919361)[![Twitter retweet action](../Images/771160ecf06ae3d4d7a7815c29c819c2.png)](https://twitter.com/intent/retweet?tweet_id=1127840532363919361)0[![Twitter like action](../Images/c077611ab2a5e0b4cd0c826ee7ae1e48.png)](https://twitter.com/intent/like?tweet_id=1127840532363919361)4

# [](#illegal-reflective-access-via-undertow)非法反射通过回流进入

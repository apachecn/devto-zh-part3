...
> 原文:[https://dev.to/jalbam/autohotkey-mouse-scripts——例如，不用鼠标在平板电脑上玩游戏——3hnk](https://dev.to/jalbam/autohotkey-mouse-scripts--play-games-without-a-mouse-on-a-tablet-for-example-3hnk)
...
## [](#compile-from-the-source-code)从源代码编译

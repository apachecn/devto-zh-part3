...
> 原文:[https://dev . to/gvetri/como-usar-El-Android-navigation-component-4 hhg](https://dev.to/gvetri/como-usar-el-android-navigation-component-4hhg)

# [](#android-architecture-components%E2%80%8A%E2%80%8Anavigation-component)Android 架构组件-导航组件

## [](#el-problema-de-la-navegaci%C3%B3n)航行问题
...
## [](#entra-en-escena-el-navigation-component-de%C2%A0android)安卓导航组件
...
## [](#mu%C3%A9strame-el%C2%A0c%C3%B3digo)给我看代码

要开始在项目中使用导航组件，必须将以下依赖项添加到我们的内部版本 app 模块和项目级别。

**Java:**

#### [](#buildgradle-del-proyecto)建设。工程程度
...
#### [](#buildgradle-del-modulo-app)构建。app 模块度
...
## [](#1-crear-el-navigation-graph%C2%A0)1。Crear el 导航图

为此，我们需要在 Android Studio 中打开我们的项目选项卡，右键单击“res”文件夹，选择 Android 资源文件，键入所需的导航图名称，然后选择“navigation(导航)”。

[![](../Images/0d68614745b040f6a0dcf856f7657f69.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--UEp5Iw0t--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/qneekzmbb5n1qpk5up52.png)

[![](../Images/23d782b2812621460652d66e5e52e3c3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--zIrWszRJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/h2bwotca0cvmrino07jz.png)
...
[![](../Images/2bb25da47c610f4d4f10422aa46128c3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--P5QaUsRD--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/o3ty6sj1w1iil8gg0k8b.png)

## [](#3-agregar-nuestros-fragments-al-navigation-graph)3。Agregar nuestros 片段 al 导航图

只需在屏幕上单击绿色+图标，然后单击“Create new destination”(创建新目标)即可添加先前创建的片段或创建新片段。

## [](#4-conectar-nuestros-fragments-utilizando-actions)4。连接体 nuestros 片段利用和操作

要连接它们，只需单击一个碎片，然后将箭头“拖动”到第二个碎片。我们已经创造了一个行动。

[![](../Images/3ba0828434e6deb5aaf30584e0fa09d9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Mm6x952v--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/kwarjfldz4yg9fasoriv.jpg)

## [](#5-moverse-entre-fragments)5。移动中心碎片
...
## [](#pasar-objetos-de-un-fragment-a%C2%A0otro)将物体从一个碎片传递到另一个碎片
...
## [](#pasar-objetos-de-un-fragment-a-otro-usando-el-plugin-de-safeargs)使用 safe-args 插件将对象从一个片段传递到另一个片段
...
[![](../Images/155f04d21b0861f3cd8c8c0d48ac507f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--5utYvdWO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/sfsp9dzhx4d4wn1x99ag.jpg)

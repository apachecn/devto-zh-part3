...
> 原文:[https://dev . to/Ganesh/day-8-random-wallpaper-changer-100-days-100-python-scripts-2on 6](https://dev.to/ganesh/day-8-random-wallpaper-changer-100-days-100-python-scripts-2on6)

## [](#day-8-updategnomewallpaper)第八天:更新 _ gnome _ 壁纸

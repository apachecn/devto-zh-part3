...
> 原文:[https://dev.to/steelwolf180/migrating-a-wix-blog-to-gatsby 阅读时间 3 分钟 2 秒钟](https://dev.to/steelwolf180/migrating-a-wix-blog-to-gatsby---read-time-3-mins-2glk)

[![Photo by frank mckenna on Unsplash](../Images/dd2a1c1a0aaec74e3f8579383206f211.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--sgTJcHLT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/410odziaisrwoek5mnio.jpg)
...
## [](#why-switch-from-wix-to-gatsby)为什么从 Wix 转到 Gatsby？
...
## [](#blogging-with-contentful)心满意足地写博客
...
## [](#pipeline-to-publish-a-blog-post)管道发布博文
...
### [](#build-a-blog-using-gatsbyjs-amp-react)用盖茨比建博客。JS &反应如何

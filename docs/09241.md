...
> 原文:[https://dev . to/dbanisimov/firestore-data flow-illustrated-and-measured-4k DG](https://dev.to/dbanisimov/firestore-dataflow-illustrated-and-measured-4kdg)
...
# [](#a-typical-firestore-app-dataflow)典型的 Firestore app 数据流
...
[![Firestore dataflow diagram](../Images/3fe8c62768b5622fcba5da6028951a72.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--MFti7nQP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/cejuxexw9jhlyis7bdfc.png)
...
## [](#a-special-case-with-a-callable-function)具有可调用功能的特例
...
[![Diagram of the Firestore dataflow with a callable function](../Images/cf3cfdb3722def7874519362fda407d3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--oYZdsLs4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/an0jl7hjwdhu4gfazf13.png)
...
## [](#measuring-the-paths-lengths)测量路径长度

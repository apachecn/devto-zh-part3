...
> 原文:[https://dev . to/therealdanvega/tips-for-vue-developers-避免直接操作 dom-19mn](https://dev.to/therealdanvega/tips-for-vue-developers-avoid-directly-manipulating-the-dom-19mn)
...
## [](#accessing-the-dom-using-refs)使用$refs 访问 DOM
...
## [](#practical-example-using-refs-in-vue)在 Vue 中使用$refs 的实际例子

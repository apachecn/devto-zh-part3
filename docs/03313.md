...
> 原文:[https://dev . to/app signal/doing-background-work-using-a-native-elixir-approach-2id 8](https://dev.to/appsignal/doing-background-work-using-a-native-elixir-approach-2id8)
...
## [](#some-background-background-job-queues)一些后台:后台作业队列
...
## [](#ongoing-background-work)正在进行的后台工作
...
## [](#moving-nonessential-work)移动不必要的工作
...
## [](#other-considerations-and-rabbitmq)其他注意事项和 RabbitMQ

...
> 原文:[https://dev . to/Doug sillars/how-to-use-screens-in-production-15ak](https://dev.to/dougsillars/how-to-use-screenshots-in-production-15ak)

在查看网页测试瀑布时，我经常遇到令人惊讶的属性。几周前，我偶然看到一个页面，其中的图片有一个熟悉的文件命名约定:

[![](../Images/7f06a5f3bc8729895ea0f129cb34ccf5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--F-WuMAGb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/604/1%2A9ALkF2wCD7psZzYiMCJXXw.png)
...
### [](#are-screen-shot-images-on-the-web-optimized)网页上的截屏图片优化了吗？
...
[![](../Images/19213274d2d005e4a3a3a94721a43fb8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--kSjwUfKj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/707/0%2AaICySTmFDETLpOWJ)

### [](#aside-all-the-images-in-this-post-are-screen-shots)旁白:本帖所有图片均为截屏。

但是在我的 Mac 上安装了 ImageOptim 之后，我只需“右击”——在上传到 WordPress 之前选择 ImageOptimize。一次额外的点击——所有的图像都得到了优化。

### [](#fun-with-regex-dates-and-times-in-screenshots)有趣的正则表达式:截图中的日期和时间

因此，有很多未经优化的图像，这并不奇怪。但是我们这里有一些很酷的额外数据——图像被捕捉的确切时刻。那么——这些截屏是什么时候制作的？使用一些奇特的正则表达式，我们可以运行这些数字:

### [](#hours-that-screenshots-are-taken)小时截图拍摄时间:

[![](../Images/76523c7a12b504d39b1af4a3f1a872d6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Ya4v2Vau--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/602/0%2Al7yTnLj5YwgG6d7A)
...
[![](../Images/929c3069292cf5a2927dccb3592b556d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ScNaY1UF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/591/0%2A3VNCauPfyTyILI-e)

大部分是在一周内，周五略低于 M-Th。

### [](#what-year-are-screenshots-taken)截图是哪一年拍的？

[![](../Images/a6626e153cc869b2a9464c43d1aed49b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--OM9iHerH--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/597/0%2Ad3U1qkjc18J3RzkP)
...
[![](../Images/30cc47779e86c9b188be9d35c1367a2b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--fqObBbxk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/741/0%2AT2I5pI-pRRs-K0xV)

这些数字并不十分重要，但是我们可以看到大多数截图都是最近的——大量截图是在 1 月份拍摄的——当时正在收集数据集！🙂

### [](#conclusion)结论

[![](../Images/a6dc7c652588e0031a410b2f6f9a865d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--_wBRANJ4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/607/1%2AQVomzjOD5pnqybjg9AJfBA.png)

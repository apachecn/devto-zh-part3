...
> 原文:[https://dev . to/oktadev/build-a-rest-API-with-ASP-net-core-2-2-5f9k](https://dev.to/oktadev/build-a-rest-api-with-asp-net-core-2-2-5f9k)
...
## [](#add-authentication-to-your-aspnet-core-rest-api)向您的 ASP.NET 核心 REST API 添加认证
...
[![Okta Org URL](../Images/87f64f787b46cfacd3fe352872516879.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--KNe8-X-m--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://developer.okta.com/assets-jekyll/blog/aspnetcore-restapi/okta-org-url-c4043a91b2e40b8bb69fa886de2afd1a831156a8d710b1ae2a9e30fa5bdc26b7.png)

现在，您需要通过浏览到 Applications 选项卡来创建一个新的应用程序。点击**添加应用**，从向导首页选择**服务**。

[![Okta Chose Platform](../Images/36160ffec09142b3a4aefa5a2f138148.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--GtHywA9O--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://developer.okta.com/assets-jekyll/blog/aspnetcore-restapi/okta-choose-platform-45ed0454eb407d738d00ea3f416e1c35996e25d806e6f0a0afc75b14fcec6e63.png)

在“设置”页面上，输入应用程序的名称:

[![Okta App Name](../Images/4abc93bb82c5c823de2ba82c2754d354.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8qgKJo_H--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://developer.okta.com/assets-jekyll/blog/aspnetcore-restapi/okta-app-name-7ec7b37b8b61334da2cc03465c6c09313ec0b9f935a473f64eae3bc6b063eb04.png)

你现在可以点击**完成**。

既然您的应用程序已经创建，请将客户端 ID 和客户端密码值复制到下一页，您很快就会需要它们(当然，您的会有所不同)。

[![Okta Client Credentials](../Images/a88fa67c364f8b26abbd7bde5aa7e9fe.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--kD4MxiLk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://developer.okta.com/assets-jekyll/blog/aspnetcore-restapi/okta-client-credentials-fc61b85256ab539cc2ae02a699b7397e8147843458538dcce09d1270b24eb5b2.png)

## [](#create-your-aspnet-core-rest-api-and-client-projects)创建您的 ASP.NET 核心 REST API 和客户端项目
...
### [](#add-a-model-and-database-for-your-aspnet-core-rest-api-and-client)为您的 ASP.NET 核心 REST API 和客户端添加模型和数据库
...
### [](#create-the-aspnet-core-rest-api-endpoints)创建 ASP.NET 核心 REST API 端点
...
### [](#validate-access-tokens-in-your-aspnet-core-api)验证 ASP.NET 核心 API 中的访问令牌
...
## [](#set-up-your-aspnet-core-mvc-client-app)设置您的 ASP.NET 核心 MVC 客户端应用
...
### [](#inject-the-token-service-class-into-the-aspnet-core-application)将令牌服务类注入 ASP.NET 核心应用
...
### [](#call-the-protected-rest-api-from-the-aspnet-core-mvc-client)从 ASP.NET 核心 MVC 客户端调用受保护的 REST API
...
## [](#test-your-aspnet-core-rest-api)测试您的 ASP.NET 核心 REST API
...
## [](#learn-more-about-aspnet-core-secure-rest-apis-and-authentication)了解关于 ASP.NET 核心、安全 REST APIs 和认证的更多信息

...
> 原文:[https://dev . to/bnevilleoneill/reverse-engineering-observable-21bh](https://dev.to/bnevilleoneill/reverse-engineering-observable-21bh)

[![](../Images/821f06575840f0fa0adc59ea7d9c8e2c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--0ND-DfiY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/512/1%2AxX3Dg4fZPHr-dDl9mnKGtQ.jpeg)
...
### [](#introduction-to-reactive-programming-and-rxjs)反应式编程和 RxJS 简介
...
#### [](#the-subscribe-method-and-observer)**订阅方法和观察者**
...
### [](#using-observable-and-observer-pattern)使用可观察和观察者模式
...
### [](#reverse-engineering-observable)逆向工程可观察

到目前为止，您已经了解了观察者、可观察对象、订阅等内容。现在我们将使用 TypeScript 类和接口创建 Observable。

### [](#creating-observer-interface)创建观察者界面
...
### [](#creating-subscription-class)创建订阅类
...
### [](#creating-observable-class)创建可观察类
...
### [](#creating-create-static-method-on-observable-class)在可观察类上创建创建静态方法
...
### [](#rxjs-creation-operators)RxJS 创建操作符
...
### [](#reverse-engineering-of-creation-operator)创建操作符的逆向工程
...
### [](#how-to-create-a-custom-creation-operator)如何创建自定义创建操作员？
...
### [](#creating-custom-pipeable-operators)创建自定义可管道操作符
...
### [](#creating-filter-operator)创建过滤运算符

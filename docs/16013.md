...
> 原文:[https://dev . to/wes/how 2-using-gpg-on-MAC OS-without-gpg tools-428 f](https://dev.to/wes/how2-using-gpg-on-macos-without-gpgtools-428f)
...
### [](#connecting-to-github)连接 GitHub

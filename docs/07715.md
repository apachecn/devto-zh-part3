...
> 原文:[https://dev . to/stemmellerjs/when-to-use-typescript-a-detailed-guide-through-common-scenarios-4d ef](https://dev.to/stemmlerjs/when-to-use-typescript-a-detailed-guide-through-common-scenarios-4def)

[![alt text](../Images/554c5d3783114f5fad90e36f4c89b219.png "When To Use TypeScript")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--GAVn6C29--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/fmnev5boz88ht0woqcip.jpg)
...
## [](#why-this-discussion-matters-more-than-ever-today)为什么今天的讨论比以往任何时候都重要
...
## [](#3-categories-of-hard-software-problems)3 类硬软件问题

一般来说，有 3 个。第一个是构建高性能系统的问题，第二个是嵌入式系统的问题，第三个是复杂领域的问题。

### [](#1-the-performant-system-problem)1。表演系统问题
...
### [](#2-the-embedded-system-problem)2。嵌入式系统问题
...
### [](#3-the-complex-domain-problem)3。复杂域问题
...
#### [](#objectoriented-javascript)面向对象的 JavaScript
...
## [](#production-software-vs-pet-projects)生产软件 vs .宠物项目
...
#### [](#communicating-patterns-amp-implementing-design-principles)沟通模式&实施设计原则
...
### [](#smaller-teams-amp-coding-styles)小团队&编码风格
...
## [](#if-you-are-in-a-position-to-learn-it-learn-it-it-does-wonders-for-your-software-design-skills)如果你有条件去学，那就去学。它为你的软件设计技能创造了奇迹

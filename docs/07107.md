...
> 原文:[https://dev . to/n1 try/explorative-analysis-on-github-data-oib](https://dev.to/n1try/exploratory-analysis-on-github-data-oib)
...
[![](../Images/d5a9d1db37e74c354ab6b9f59513043d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--pK7deNF---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://muetsch.io/images/gh_eer.png)
...
## [](#most-popular-programming-languages)最流行的编程语言
...
[![](../Images/84b078bfd9e44551f4033676cf17bdd5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--qPjCRDr0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://muetsch.io/images/gh_popular_lang.png)

不足为奇的是，由 JavaScript、HTML 和 CSS 组成的典型 web 堆栈是最受欢迎的编程语言之一，这取决于它们在存储库中出现的频率。

## [](#least-popular-programming-languages)最不受欢迎的编程语言
...
[![](../Images/256a7789384fce2ae44e1b8608247b3d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--mUCOCjuS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://muetsch.io/images/gh_locations.png)

显然，旧金山似乎是最受开发者欢迎的城市(或者至少对那些活跃在 GitHub 上的人来说)。

## [](#skills-by-location)技能按位置排列
...
[![](../Images/1f3a63dc6a47f0e1f2f469b84512c002.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--VqP4UO1E--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://muetsch.io/images/gh_location_langs.png)

看起来在世界不同城市之间的开发人员技能分布中没有真正的异常值。也许你可以这么说，例如，印度人喜欢 web 前端比命令行黑客多一点。

## [](#skills-karlsruhe-vs-the-world)技能:卡尔斯鲁厄 vs 世界
...
[![](../Images/e084e979d72377b35790c75a73087598.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--nUiULrCO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://muetsch.io/images/gh_ka_world.png)

这些结果让我有点吃惊。显然，与这个世界相比，基于卡尔斯鲁厄的开发人员似乎不喜欢 JavaScript。但是，这和我在这里的几份学生工作和实习经历是不一样的。

## [](#project-tech-stacks)项目技术堆栈

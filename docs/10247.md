...
> 原文:[https://dev . to/karlredman/compile-and-install-vim-v81-from-source-with-pyenv-5cjc](https://dev.to/karlredman/compile-and-install-vim-v81-from-source-with-pyenv-5cjc)
...
### [](#install-and-setup-pyenv)安装并设置 pyenv

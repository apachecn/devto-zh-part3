...
> 原文:[https://dev.to/niku/parameterized-testing-with-exunit-1j3d](https://dev.to/niku/parameterized-testing-with-exunit-1j3d)
...
## [](#use-assertions-instead-of-tests)用断言代替测试
...
## [](#use-exparameterized)使用 ex _ parameterized
...
## [](#use-exunitcaseregistertest4)用 ExUnit。Case.register_test/4

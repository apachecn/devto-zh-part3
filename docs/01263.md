...
> 原文:[https://dev . to/radix DLT/radix-DLT-kot Lin-client-library-1k8j](https://dev.to/radixdlt/radix-dlt-kotlin-client-library-1k8j)
...
# [](#storing-and-retrieving-data)存储和检索数据
...
# [](#sending-and-retrieving-tokens)发送和检索令牌

...
> 原文：<https://dev.to/nexttech/learn-python-interactively-with-these-5-tutorials-47cg>
...
# #1: [谷歌的 Python 类](https://developers.google.com/edu/python/introduction)
...
# #2: [官方 Python 教程](https://docs.python.org/3/tutorial/index.html)
...
# #3: [官瓶教程](https://docs.python.org/3/tutorial/index.html)
...
# #5: [条纹的 Python 集成](https://stripe.com/docs/api)

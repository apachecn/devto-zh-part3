...
> 原文:[https://dev . to/noahkuwae/protocol-oriented-programming-pop-brief-summary-4i5b](https://dev.to/noahkuwae/protocol-oriented-programming-pop-brief-summary-4i5b)
...
# [](#1-object-oriented-way)1。面向对象的方法
...
### [](#problem-of-object-oriented-way)面向对象方式的问题

*   所有 UIView 子类自动继承属性和行为，即使你不需要它们(代码闻起来像“拒绝遗赠”)
*   如果您想添加更多的功能并将其实现到扩展中，扩展会不断增长

# [](#2-protocol-oriented-way)2。面向协议的方式
...
### [](#benefits-of-protocol-oriented-way)面向协议方式的好处

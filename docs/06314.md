...
> 原文:[https://dev . to/frontity/Google-search-console-now-consolidates-search-performance-data-to-canonical-URLs-this-mean-for-SEOS-42jd](https://dev.to/frontity/google-search-console-now-consolidates-search-performance-data-to-canonical-urls-what-does-this-mean-for-seos-42jd)
...
## [](#google-to-show-data-only-consolidated-by-canonical-url-from-april-10th)从 4 月 10 日起，谷歌将只显示通过规范网址整合的数据
...
## [](#the-difference-between-a-canonical-and-a-noncanonical-url)规范和非规范 URL 的区别
...
## [](#what-does-this-change-mean-for-seo)这个变化对 SEO 意味着什么？
...
### [](#advantages-of-this-change-according-to-google)这种变化的优点，[据谷歌](https://searchengineland.com/google-search-console-to-consolidate-search-performance-reports-to-canonical-url-311704)
...
[![Search Console Old View](../Images/40cbb27860583cb5ab8267dea9d138c0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--rf7RsDvr--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.frontity.org/wp-content/uploads/2019/04/randomtrip-amp-search-console-old-view.png)

这是 Google 在**新视图**中标记为“AMP”的 URL 的数据:

[![Search Console New View](../Images/4a303a9c1a746d2f4ffca54b1c1fc471.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--LWW8TJxE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.frontity.org/wp-content/uploads/2019/04/randomtrip-amp-search-console-new-view.png)

我们可以清楚地看到，对于同一时期，我们有不同的数据:

[![Clicks and impressions Search Console canonicals change](../Images/832b856d4f94fbb80993c8d01e03c0a4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--cjO-Y1O9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.frontity.org/wp-content/uploads/2019/04/clicks-impressions-change-sc-canonicals.png)
...
[![detailed-view-specific-urls-search-console-lino-urunuela-errioxa](../Images/024695c8c9e7c3bb5a3d4751e14f2459.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--4f2KRnzX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.frontity.org/wp-content/uploads/2019/04/detailed-view-specific-urls-search-console-lino-urunuela-errioxa.jpg)

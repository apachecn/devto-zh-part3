...
> 原文:[https://dev.to/fteem/testing-in-go-first-principles-4j64](https://dev.to/fteem/testing-in-go-first-principles-4j64)
...
## [](#testing-our-go-code)测试我们的 Go 代码
...
## [](#testing-with-gos-raw-testing-endraw-package)用 Go 的`testing`包测试
...
## [](#what-happens-when-we-run-raw-go-test-endraw-)当我们运行时会发生什么`go test`
...
## [](#dealing-with-test-failures)处理测试失败

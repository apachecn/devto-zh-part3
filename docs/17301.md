...
> 原文:[https://dev . to/swim burger/web-performance-prevent-wasted-hidden-image-requests-3 if](https://dev.to/swimburger/web-performance-prevent-wasteful-hidden-image-requests-3oif)
...
## [](#solving-useless-image-request-using-plain-html5)使用普通 HTML5 解决无用的图片请求
...
[![page speed insights defer offscreen images recommendation fixed](../Images/24465be1f30e214947adcbf89fac3128.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--aANFXMKv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://swimburger.net/media/1098/page-speed-insights-defer-offscreen-images-recommendation-after.png)

...
> 原文:[https://dev . to/gle bec/property-testing-with-js verify-part-iii-5bp 0](https://dev.to/glebec/property-testing-with-jsverify-part-iii-5bp0)

# [](#part-iii-intermediate-jsverify-usage)第三部分:中级 JSVerify 用法
...
## [](#using-builtin-arbitraries)利用内置套利
...
## [](#combinators-deriving-new-arbitraries-from-existing-arbitraries)组合子:从现有套利交易中衍生出新的套利交易
...
## [](#defining-custom-arbitraries-from-scratch)从零开始定义自定义套利
...
### [](#dependentlygenerated-values)独立生成的值

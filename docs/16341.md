...
> 原文:[https://dev . to/masatana/when-you-want-to-build-a-old-PHP-from-source-be-care-of-certificate-5a 63](https://dev.to/masatana/when-you-want-to-build-an-old-php-from-source-be-careful-of-the-certificate-5a63)

...
> 原文:[https://dev . to/hag nerd/get-up-and-running-with-react-and-package-567j](https://dev.to/hagnerd/getting-up-and-running-with-reason-react-and-parcel-567j)

#### [](#updated-4232019)更新时间:2019 年 4 月 23 日
...
### [](#why-does-reason-use-ocaml-under-the-hood)为什么理智在引擎盖下使用 OCaml？
...
### [](#what-is-bucklescript)什么是 Bucklescript？
...
## [](#set-up-bsconfigjson)设置 bsconfig.json
...
## [](#lets-finally-write-some-reason)让我们最后写点理由
...
#### [](#rendering-to-element-with-a-specific-id)渲染到具有特定 id 的元素:
...
#### [](#what-is-with-the-raw-module-endraw-declaration)与`module`宣言有什么关系？
...
#### [](#what-is-this-reactcomponent)这是什么[@react.component]？

这是创建新 React 组件的推荐方法。它在幕后为我们做了一些事情，使我们的生活更容易，但如果你想学习如何在没有它的情况下手动创建自己的组件，请查看【React 文档中关于组件的新页面。

#### [](#what-is-the-raw-make-endraw-function)什么是`make`功能？
...
## [](#lets-refactor-a-little)我们稍微重构一下

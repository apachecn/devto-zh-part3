...
> 原文:[https://dev . to/ballopoint 胡萝卜/making-the-shell-less-terrible-start-out-4 i99](https://dev.to/ballpointcarrot/making-the-shell-less-scary-starting-out-4i99)
...
#### [](#-raw-mkdir-endraw-makes-the-dirs)`mkdir`异人 dirs
...
#### [](#add-raw-ls-endraw-to-the-list)将`ls`添加到列表中
...
[![miles](../Images/8a67120c04085fa8732014d08ae9e56d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--EHfgM8m8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.ballpointcarrot.net/images/miles.jpg)

...
> 原文:[https://dev.to/teekay/learning-python-from-zero-tohero-151h](https://dev.to/teekay/learning-python-from-zero-tohero-151h)

[![](../Images/bce13dc15ed7aaba5138d50127a18132.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--DUngkSWb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1000/1%2AueWmI48uuShON-hX7LwI0w.png)
...
#### [](#2-control-flow-conditional-statements)2。控制流:条件语句
...
#### [](#3-looping-%C2%A0iterator)3。循环/迭代器
...
### [](#list-collection-array-data-structure)列表:集合|数组|数据结构
...
[![](../Images/67f764739636480219f3a8009e5e7ffd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--IJf1w4nB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AReMk6NgghLII20vPD6uNEA.jpeg)
...
### [](#dictionary-keyvalue-data-structure)字典:键值数据结构
...
#### [](#a-little-bit-of%C2%A0theory)一点点理论:
...
#### [](#python-objectoriented-programming-mode%C2%A0on)Python 面向对象编程模式:开
...
#### [](#nonpublic-instance%C2%A0variable)非公共实例变量

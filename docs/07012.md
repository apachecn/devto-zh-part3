...
> 原文:[https://dev . to/dwd/resource-acquisition-is-initial ization-120h](https://dev.to/dwd/resource-acquisition-is-initialization-120h)
...
## [](#under-construction-and-destruction)正在建设和破坏中
...
## [](#resource-acquisition-is-initialization)资源采集正在初始化

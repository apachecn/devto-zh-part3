...
> 原文:[https://dev . to/ijen S1/first-post-motivations-some-notes-1khe](https://dev.to/ijens1/first-post-motivations-some-notes-1khe)
...
##### [](#arrays-decaying-to-pointers)数组衰减为指针
...
##### [](#functions-decaying-to-function-pointers)函数衰减为函数指针

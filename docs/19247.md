...
> 原文:[https://dev.to/ballpointcarrot/advent-of-code-2018-day-2-1a3p](https://dev.to/ballpointcarrot/advent-of-code-2018---day-2-1a3p)

欢迎回来！今天，我们将继续代码挑战的[来临。我通过我在](https://ladventofcode.com) [dev.to](https://dev.to) 社区中发现的令人敬畏的人们发现了这些挑战，他们已经接受了这些挑战，提供了讨论板等等。

### [](#day-2-problem-the-first)第二天，问题第一
...
### [](#day-2-problem-2-electric-boogaloo)初二第二题(电动布加洛)

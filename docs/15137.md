...
> 原文:[https://dev . to/dechamp/example-of-data-mutation-and-why-to-avoid-it-4 ogj](https://dev.to/dechamp/example-of-data-mutation-and-why-to-avoid-it-4ogj)
...
## [](#no-rollback-option-so-what-to-do)没有回滚选项，那么该怎么办？
...
[![structure](../Images/06d0b0fef436aefb98660b583321212e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--udadA_ef--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8ct28fi86a28t5ouumqn.png)
...
[![post with custom variable](../Images/1c55f8639fbdb3e595cd4e8a3fc3aa19.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--rb0WUxXI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/jkbvzzqbinn01ndun2al.png)

这可能看起来很简单，但有一个陷阱。我们刚刚创建了一项服务，要求您仅通过 post 向其传递数据。

如果我们调用 GET，PUT 等函数呢？这就是你开始看到问题的时候。

[![mutation](../Images/33bc68db4b16af30d57b251038ca2603.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--YEEFO68g--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/9nwmple5zw0vm22y6zrm.png)
...
[![non-mutation](../Images/5a0e80ae42d280fb932ef72378d565c6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---fq5IFBo--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/kawwot191m2dpkruwdsn.png)

通过告诉您的播放器服务接受任何方法，并使用更多的逻辑来设置数据，您不再需要在服务之间改变数据。

## [](#but-why-who-cares)但是为什么，谁在乎呢？
...
[![non-mutated success](../Images/ebe5333fa02bdd45197ac2175e86b4b8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--2LFx-Yuw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/t2tt3hvqr3jpp0flktac.png)

一切看起来不错！我们用不同类型的请求击中了所有三个，并且都通过了。

现在让我们用设计的试试吧！

[![mutated failed](../Images/81cda0d910921427db8d53552559ebea.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ULMZ5sD9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/73k9nf89c03ghw98582p.png)

呀！！这讨厌的红色是怎么回事？等等，所以我们不能在不修改数据的情况下点击播放器来定制 post 请求？吐槽！

## [](#so-what-the-replayer-is-temporary-right)那又怎样，重赛者是临时的对吗？

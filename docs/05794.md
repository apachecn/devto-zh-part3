...
> 原文:[https://dev . to/evil mars/active-storage-meets-graph QL-pt-2-exposure-attachment-URLs-2 MDN](https://dev.to/evilmartians/active-storage-meets-graphql-pt-2-exposing-attachment-urls-2mdn)
...
## [](#n1-problem-batch-loading-to-the-rescue)N+1 问题:批量装载救援
...
## [](#dealing-with-variants)处理变体

我们希望利用 GraphQL 的能力，并允许客户指定所需的图像变量(例如，拇指，封面等。):

[![API example](../Images/0f120ece9bfc6132aefa34c539b52dd7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Y1Phggf1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/mulczhx009kds5c57ix4.png)
...
[![ImageVariant type](../Images/6be086c466e1f2eafc3bbe8ebe3c4f08.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--28EU6wWh--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/zyucz9hf42o3qx5zj4ym.png)
...
## [](#bonus-adding-a-field-extension)加成:增加一个字段扩展

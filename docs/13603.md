...
> 原文:[https://dev . to/therealdanvega/creating-your-first-NPM-package-2ehf](https://dev.to/therealdanvega/creating-your-first-npm-package-2ehf)
...
## [](#creating-your-npm-package)创建您的 npm 包
...
## [](#npm-local-development)npm 地方发展
...
## [](#publishing-npm-package)出版 NPM 包

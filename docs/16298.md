...
> 原文:[https://dev . to/mikewheaton/rapid-prototypes-with-Google-sheets-CD8](https://dev.to/mikewheaton/rapid-prototypes-with-google-sheets-cd8)
...
## [](#creating-and-publishing-your-data)创建并发布您的数据
...
[![Screenshot of Google Sheets with multiple columns and rows of data](../Images/7e244065c7744773f44b132c5e9b8424.png "Your spreadsheet should look something like this.")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--PWxkDKtB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://wheaton.design/static/18930ba4ed8403c73100804ff6fb7b9a/3024d/sheet.png)

数据准备就绪后，转到文件菜单，选择“发布到网站”。默认设置很好，所以您可以点击发布。

[![Screenshot of the Publish to the web dialog in Google Sheets](../Images/f166c5e86ac7ae7831a7bfc6b4e702f4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vCExeId1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://wheaton.design/static/f014890d2cb6936d1fbc3e7a10d310cf/7a138/publish.png)

## [](#retrieving-your-data)检索您的数据
...
## [](#rendering-the-react-component)渲染 React 组件
...
## [](#exercises-and-further-reading)习题与延伸阅读

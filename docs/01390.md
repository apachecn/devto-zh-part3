...
> 原文:[https://dev . to/nathan bland/let-s-build-a-home-lab-server-a-build-log-2e 71](https://dev.to/nathanbland/let-s-build-a-home-lab-server-a-build-log-2e71)
...
## [](#install-and-troubleshooting)安装和故障排除

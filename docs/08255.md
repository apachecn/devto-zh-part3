...
> 原文:[https://dev . to/learn byexample/ruby-regexp-part-7-groupings-and-back references-2kfp](https://dev.to/learnbyexample/ruby-regexp-part-7-groupings-and-backreferences-2kfp)

# [](#groupings-and-backreferences)分组和反向引用

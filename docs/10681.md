...
> 原文:[https://dev . to/neutrino 2211/avoiding-verged-JavaScript-behaviour-true-true-2-but-true-1-pn9](https://dev.to/neutrino2211/avoiding-weird-javascript-behaviour-true--true--2-but-true--1-pn9)

每一种编程语言都被设计成直观的，Javascript 也不例外，但它确实有一些让它脱颖而出的古怪之处，其中之一就是它对类型的怪异行为，我很确定你已经看到了迷因。

[![javascript meme](../Images/8d890c9f68959f82cbc9df9d518eae84.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--_LM23l-b--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/a2k7x6ghilt6hp5mhgd7.png)
...
#### [](#falsy-vs-raw-false-endraw-)福尔西 vs `false`
...
#### [](#truthy-vs-raw-true-endraw-)真理 vs `true`

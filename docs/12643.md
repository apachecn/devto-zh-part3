...
> 原文:[https://dev . to/zing grid/get-started-with-data-basics-in-zing grid-726](https://dev.to/zinggrid/get-started-with-data-basics-in-zinggrid-726)
...
#### [](#array-of-nested-objects)嵌套对象的数组
...
#### [](#object-of-nested-objects)对象的嵌套对象
...
#### [](#html-inline-data-stringified)HTML 内嵌数据(字符串化)

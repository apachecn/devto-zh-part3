...
> 原文:[https://dev . to/adityasridhar/what-is-graph QL-and-how-to-use-it-1f 58](https://dev.to/adityasridhar/what-is-graphql-and-how-to-use-it-1f58)
...
# [](#how-to-use-graphql-with-nodejs)如何将 GraphQL 与 NodeJs 一起使用
...
## [](#enabling-graphql-in-the-code)在代码中启用 GraphQL
...
[![graphiql](../Images/bbdb395ae1850b1f7edcd97380b34411.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--5dulb_sj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/nbmapp1gzb2bsh4l9nd3.JPG)
...
## [](#adding-the-movie-endpoint-to-the-query)向查询中添加电影端点
...
## [](#adding-the-custom-type-movietype)添加自定义类型 movieType
...
## [](#adding-the-query-and-type-for-director-endpoint)为导演端点添加查询和类型
...
## [](#the-speciality-of-directortype)导演类型的特殊性

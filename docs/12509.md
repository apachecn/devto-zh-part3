...
> 原文:[https://dev . to/just alever/understanding-active-record-migrations-5a1n](https://dev.to/justalever/understanding-active-record-migrations-5a1n)
...
### [](#creating-active-record-migrations)创建活动记录迁移
...
### [](#more-advanced-greatness)更高级的伟大
...
##### [](#up-and-down-instead-of-change)上下相反变化

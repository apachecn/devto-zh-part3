...
> 原文:[https://dev . to/dev team/contributors-wanted-night-mode-themes-on-dev-i8n](https://dev.to/devteam/contributors-wanted-night-mode-themes-on-dev-i8n)
...
### [](#you-can-see-existing-issues-tagged-night-mode-here)你可以在这里看到标注了夜间模式[的现存问题。](https://github.com/thepracticaldev/dev.to/issues?q=is%3Aissue+is%3Aopen+label%3Anightmode)
...
[![](../Images/ff7b8d5e06fbfb1312a21206c335fc01.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ZcaNvatr--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/2r2yjmnerl6ha85d9fbe.png)

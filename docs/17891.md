...
> 原文:[https://dev.to/serhatteker/git-adding-submodule-3a78](https://dev.to/serhatteker/git-adding-submodule-3a78)

### [](#adding-a-submodule-to-a-git-repository)向 Git 仓库添加子模块

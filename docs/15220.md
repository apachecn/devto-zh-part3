...
> 原文:[https://dev.to/justalever/lets-build-with-ruby-on-rails 评论博客-17lc](https://dev.to/justalever/lets-build-with-ruby-on-rails---a-blog-with-comments-17lc)

使用 Ruby on Rails 构建一个带有评论的博客是我为了更好地了解这个框架而进行的一个基础练习。在处理动态数据时，Ruby 和 Rails 一起工作，帮助我们生成一个基于 CRUD 方法的相当简单的 MVC 模式。

### [](#watch-the-entire-build)观察整个构建

[https://www.youtube.com/embed/XEkJ3vZb6-Q](https://www.youtube.com/embed/XEkJ3vZb6-Q)

### [](#kicking-things-off-with-a-blog)用博客拉开序幕
...
### [](#gems-used-in-the-project)项目中使用的宝石
...
## ![GitHub logo](../Images/292a238c61c5611a7f4d07a21d9e8e0a.png)[just alever](https://github.com/justalever)/[demo _ blog _ rails](https://github.com/justalever/demo_blog_rails)
...
[![Let's Build: With Ruby on Rails - Blog with Comments](../Images/6db1f828c6e0c523ad3df1f0680612bc.png)T2】](https://camo.githubusercontent.com/7ae96be3cf3de6f738fe961a1336e3fdb9e31c248725f8db3a67692825f7fb6f/68747470733a2f2f692e696d6775722e636f6d2f446b5a535465652e6a7067)

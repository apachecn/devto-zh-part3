...
> 原文:[https://dev . to/lbonanomi/dear-diary-recording-bash-session-as-github-gists-1 nga](https://dev.to/lbonanomi/dear-diary-recording-bash-session-as-github-gists-1nga)
...
### [](#first-a-few-words-about-security)首先，说几句关于安全的话

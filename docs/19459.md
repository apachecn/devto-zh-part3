...
> 原文:[https://dev.to/aghost7/developing-from-containers-42fp](https://dev.to/aghost7/developing-from-containers-42fp)
...
### [](#not-a-common-use-case-for-docker)不是 Docker 的常见用例
...
### [](#still-needs-some-glue-code)还需要一些胶水代码
...
## [](#anatomy-of-a-containerized-development-environment)剖析容器化的开发环境

### [](#0-pick-a-base-image)0。选择一个基础图像
...
### [](#3-multiplexing-optional)3。多路复用(可选)
...
### [](#4-install-your-editor-of-choice)4。安装您选择的编辑器
...
### [](#5-install-your-runtime)5。安装运行时

...
> 原文:[https://dev . to/Abdul basit 313/building-a-scalable-random-quote-app-in-react-461 e](https://dev.to/abdulbasit313/building-a-scalable-random-quote-app-in-react-461e)
...
### [](#calling-api-in-componentdidmount)在 componentDidMount 中调用 API
...
## [](#logic-1-pick-a-random-quote-from-api)逻辑 1:从 API 中随机选择一个报价
...
## [](#logic-2-share-on-twitter)逻辑二:在 Twitter 上分享
...
## [](#lets-talk-about-scaling-the-app)先说一下 app 的缩放

记住，我们总是以一种更容易发展、阅读和维护的方式来构建我们的项目。

## [](#reusable-quote-box)可重复使用的报价框
...
## [](#reusable-share-buttons)可重复使用的分享按钮

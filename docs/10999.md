...
> 原文:[https://dev . to/pigozzifr/let-play-with-redux-middleware-2d1f](https://dev.to/pigozzifr/lets-play-with-redux-middleware-2d1f)

## [](#source-of-inspiration)灵感的来源

在看了 Nir Kaufman 的这个视频后，我决定写这篇文章。不要被标题吓到，这是任何一个缺乏想象力和幽默感的开发者都能做到的。

## [](#what-is-a-redux-middleware)什么是 Redux 中间件？
...
## [](#pros-and-cons-about-using-one-or-more-custom-middleware)关于使用一个或多个定制中间件的利弊
...
[![](../Images/01156618777a6502eedcb5e80c319f92.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--1XcfmZrZ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://image.slidesharecdn.com/reduxpattens-180423104117/95/redux-pattens-jsheroes-2018-35-638.jpg%3Fcb%3D1524480297)
...
## [](#how-to-integrate-these-newly-created-middleware)如何整合这些新创建的中间件

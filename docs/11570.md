...
> 原文:[https://dev . to/jscrambler/create-a-file-storage-mobile-app-with-native script-5-18n 8](https://dev.to/jscrambler/create-a-file-storage-mobile-app-with-nativescript-5-18n8)
...
## [](#initializing-the-backend-project)初始化后台项目
...
### [](#starting-with-sequelize)以 Sequelize 开始
...
### [](#defining-the-users-route)定义用户路线
...
### [](#uploading-a-file-to-the-server)上传文件到服务器
...
### [](#increase-user-quota-route)增加用户配额路线
...
### [](#consuming-web-services)消费 Web 服务
...
[![Protect your NativeScript App with Jscrambler](../Images/9d69506bbe315bb2107af3996da56b46.png)T2】](https://blog.jscrambler.com/protecting-your-nativescript-source-code-with-jscrambler/)

### [](#uploading-files-from-a-device-to-a-server)将文件从设备上传到服务器
...
### [](#downloading-a-file-to-the-device)下载文件到设备
...
### [](#listing-downloaded-files)列出下载的文件
...
### [](#enforcing-storage-limit)强制存储限制

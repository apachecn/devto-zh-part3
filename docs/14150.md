...
> 原文:[https://dev . to/app signal/unraveling-classes-instances-and-meta classes-in-ruby-n71](https://dev.to/appsignal/unraveling-classes-instances-and-metaclasses-in-ruby-n71)
...
## [](#class-instances-and-instance-methods)类实例和实例方法
...
## [](#what-is-raw-self-endraw-)什么是`self`？
...
## [](#opening-the-metaclass)打开元类

我们已经知道类方法是类对象的元类中的方法。了解了这一点，我们将看看其他一些你以前可能见过的创建类方法的技术。

### [](#-raw-class-ltlt-self-endraw-)`class << self`
...
### [](#-raw-instanceeval-endraw-)`instance_eval`

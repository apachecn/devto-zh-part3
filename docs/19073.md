...
> 原文:[https://dev . to/circle ci/hey-open-source-maintainers-empower-your-contributors-with-continuous-integration-g8p](https://dev.to/circleci/hey-open-source-maintainers-empower-your-contributors-with-continuous-integration-g8p)

[![OpenSource_1.jpg](../Images/63865c1bf5b553b6796168c0f8e82240.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--5HaxHiQ6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://circleci.com/blog/media/OpenSource_1.jpg)
...
## [](#1-ci-will-actually-run-tests)1。CI 将实际运行测试
...
## [](#2-ci-build-failures-are-okay-use-them-as-a-teaching-point)2。CI 构建失败是正常的；把它们作为一个教学点
...
## [](#3-ci-allows-contributors-to-work-on-projects-they-may-otherwise-not-be-able-to)3。CI 允许贡献者从事他们可能无法从事的项目
...
## [](#4-dont-require-build-secrets-for-nondeployment-jobs)4。不需要为非部署作业构建机密

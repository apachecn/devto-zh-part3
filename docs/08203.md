...
> 原文:[https://dev . to/amberwilkie/higher-order-functions-what-es-and-a-react-example-1 ief](https://dev.to/amberwilkie/higher-order-functions-what-they-are-and-a-react-example-1ief)

#### [](#tech-jargon-series)科技术语系列

[![](../Images/3a4779e9693dbb29b04aaab2e6a6b7a5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--G-9qq9y_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2Ax4AH7NNM6KIASH0-9dOKOg.jpeg)
...
### [](#higherorder-functions-a-definition)高阶函数:一个定义
...
#### [](#passed-function)传递了功能

```
const myFunc = age =\> age \* 2 
```

#### [](#higherorder-function)高阶函数
...
[![](../Images/966cf732c38fc4ead73ce67c77519f94.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--cGF3OJhz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/942/1%2AhihD4HHej1EcMr04jctg9A.png) 

<figcaption>我们死了——简单高阶函数运行在终端</figcaption>

### [](#custom-example-with-react-components)自定义带有 React "组件"的例子
...
[![](../Images/6c98244f6d157c1b5a6e14406982df1f.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--M6SMHq_k--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/934/1%2ASV9bA8FBOWuGCmMBJ22-Jg.png) 

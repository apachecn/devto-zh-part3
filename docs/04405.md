...
> 原文:[https://dev . to/azure/improve-your-docker file-best-practices-5ll](https://dev.to/azure/improve-your-dockerfile-best-practices-5ll)

在 [Twitter](https://twitter.com/chris_noring) 上关注我，很乐意接受您对主题或改进的建议/Chris

# [](#%C2%A0a-deeper-look-at-the-dockerfile)深入查看 Dockerfile
...
## [](#%C2%A0what-we-know-about-dockerfile)我们所知道的 Dockerfile
...
## [](#our-dockerfile-sample)我们的 Dockerfile 样本
...
[![](../Images/d939e9debd1297707118a87dd20746a6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--LR8wu276--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ra3g0og49f0k8k6j22hd.png)

它的重量为 **899 MB**
好了，我们没有什么可以比较的，但是让我们将图像更改为一个名为`node:alpine`的图像，并重建我们的图像:

[![](../Images/19da5338e567d1d1fb25e208b5f99d90.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--M5dLGF_n--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/tjcuqacsn4i3s0qn7ur3.png) 
...
### [](#%C2%A0minimize-the-layers)最小化图层
...
## [](#%C2%A0rely-on-default-ports-with-expose)依赖默认端口，带 EXPOSE
...
## [](#be-explicit-use-copy-over-add)显式，使用复制覆盖添加

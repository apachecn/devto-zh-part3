...
> 原文:[https://dev . to/lad vien/creating-a-neural-network-web service-40ne](https://dev.to/ladvien/creating-a-neural-network-webservice-40ne)
...
你*应该*得到一个合适的回应:
[![local-curl-test-neural-net-webservice](../Images/edd1f271b22d9b3f9717db3593b66dfe.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--jeKPVeA_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/toxic-comment-detector-local-test.png)

### [](#nodejs-and-nodehttpproxy)NodeJS 和 node-http-proxy
...
[![neural-net-service-stack](../Images/04cfc20b953989263c3cf73d9ac66298.png)T5】](https://res.cloudinary.com/practicaldev/image/fetch/s--Ve726Pnu--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/nn_service_stack.png)
...
### [](#proper-flask-webservice-setup)“适当的”Flask 服务设置

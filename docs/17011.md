...
> 原文:[https://dev . to/aaronellington/importance-of-configuring-go-sqldb-connections-15bc](https://dev.to/aaronellington/importance-of-configuring-go-sqldb-connections-15bc)

## [](#background)背景

我最近开始从 PHP 切换到 Go，我错过了一些重要的东西(但现在看起来非常明显)。我第一次尝试技术博客是一个巨大的失败:

[![aaronellington](../Images/fd4f5b13b16f16714c41b783579a9529.png)](/aaronellington) [## 转到 sql。数据库周期性错误:无效连接

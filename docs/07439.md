...
> 原文:[https://dev.to/gcanti/getting-started-with-fp-ts-monad-6k](https://dev.to/gcanti/getting-started-with-fp-ts-monad-6k)
...
# [](#the-problem-nested-contexts)问题:嵌套上下文
...
[![two Kleisli arrows, what's their composition?](../Images/697ed5fd788f383f2d993bf572fc4b8d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--42hP0aU4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/gom0mol0h57jurvmy9n1.png)
...
[![above the TS category, below the K construction](../Images/d7ae117838dcf8e8f8951bbbb046ce66.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--HSu-fN2C--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/zz2xubsrhpizvq4slxxp.png)

<center>(above the *TS* category, below the *K* construction)</center>

那么 *K* 中的`f'`和`g'`会是什么构成呢？这就是下图中标有`h'`的虚线箭头

[![above the composition in the TS category, below the composition in the K construction](../Images/8d624d5b5a9cfd08d43c5dfd8f8a643b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--HMd3QDqf--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/339yozksu42ql1mfbsxf.png)
...
# [](#in-which-we-build-the-composition-step-by-step)我们在其中一步步构建作文

单子定义的要点(1)说`M`允许一个函子实例，所以我们可以将函数`g: (b: B) => M<C>`转化为函数`lift(g): (mb: M<B>) => M<M<C>>`(这里我使用它的同义词`map`)

[![where flatMap comes from](../Images/4db7bc8f6cd29060915d70c28418405b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--AZ_N1BYX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/tawvpqf52nxtrr3gv4jh.png)
...
[![where of comes from](../Images/758c9a0b099ae386a6c1617a045c3f73.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--sIGarPNM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/12810n5g8u9us00ic75m.png)
...
# [](#monads-in-raw-fpts-endraw-)单子在`fp-ts`

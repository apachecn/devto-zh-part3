...
> 原文:[https://dev . to/Samantha Ming/prevent-object-retrieval-type error-with-37b 7](https://dev.to/samanthaming/prevent-object-retrieval-typeerror-with--37b7)

[![Code Tidbit by SamanthaMing.com](../Images/b806a1d9a87777222e5a10501cade413.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--zoduAEt9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/tgrppxvcjz7elf7y1jxb.png)
...
## [](#understanding-the-ampamp-operator)理解& &运算符
...
## [](#refactoring-raw-if-endraw-conditionals-with-raw-ampamp-endraw-)用`&&`重构`if`条件句
...
## [](#proposal-optional-chaining)建议可选链接

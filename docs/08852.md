...
> 原文:[https://dev . to/bil/using-abort controller-with-react-hooks-and-type script-to-cancel-window-fetch-requests-1md 4](https://dev.to/bil/using-abortcontroller-with-react-hooks-and-typescript-to-cancel-window-fetch-requests-1md4)
...
## [](#react-hooks-and-typescript)React 钩子和 TypeScript？
...
### [](#gotcha-1-no-support-of-destructuring)陷阱#1:不支持析构

...
> 原文:[https://dev . to/django _ stars/building-a-location-based-app-with-react-native-8eg](https://dev.to/django_stars/building-a-location-based-app-with-react-native-8eg)
...
[![img1](../Images/8662c4d34c6e8796e848b93ac4c58204.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--QeUQIwnI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1000/0%2AV_j918VTUfiRuy96) 
...
## [](#tools-for-locationbased-application-development-react-native)基于位置的应用开发工具:React Native
...
*   你需要比 React 本地提供更多的 API。我特别不喜欢的一点是 React Native 支持的原生 API 数量有限。尽管如此，还是有足够的东西来构建一个基于位置的应用程序。如果您需要其他代码，您可以使用本机代码桥接它们。![img2](../Images/71648d8b90a80ff811abf429850a62c8.png)

## [](#how-to-gather-and-display-user-location)如何采集和显示用户位置

这一部分是关于收集和显示位置数据。根据你的应用程序的具体情况，你会选择一种特定的方式。

## [](#gathering-location-data)采集位置数据

我挑选了三种方法来收集设备位置。

*注意*:这是一个通用的概述，帮助您了解何时选择每种情况以及它们之间的差异。

## [](#using-react-native-api)使用 React 原生 API

有一个本地 JavaScript API 可以识别设备的位置。它很容易安装和使用，但有一个“但是”——它既不在后台工作，也不显示位置提供商(3G，Wi-Fi，GPS)。

## [](#reactnativebackgroundgeolocation)反应-原生-背景-地理定位
...
### [](#displaying-location)显示位置

位置数据并不总是精确的。你一定见过这样的:
[![img3](../Images/79c229a5ff0fcaa373d335f1068fc53b.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--PqLl6MXJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/0%2AT3XoCiek94nwjpw-)
...
### [](#a-few-words-about-design)关于设计的几句话

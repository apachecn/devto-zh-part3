...
> 原文:[https://dev.to/setevoy/nginx-access-logs-log-all-except-200-responses-426 o](https://dev.to/setevoy/nginx-access-logs--log-all-except-200-responses-426o)

[![](../Images/78085e4140d88b37a268ebde3e60aac9.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--r6fzzO2X--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://rtfm.co.ua/wp-content/uploads/2012/09/nginx_logo2.jpg) 任务是将所有请求保存到一个日志文件中，不包括来自 NGINX 的响应为 200 的请求。

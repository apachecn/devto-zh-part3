...
> 原文:[https://dev . to/collab nix community/multipass-micro k8-grafana-on-ma cosx-5f8o](https://dev.to/collabnixcommunity/multipass-microk8-grafana-on-macosx-5f8o)
...
# [](#download-multipass-vm-httpsgithubcomcanonicalltdmultipassreleases)下载多通 VM【https://github.com/CanonicalLtd/multipass/releases T2】
...
# [](#our-vm-has-an-ip-that-you-can-check-with)我们的虚拟机有一个 IP 地址，您可以通过它进行检查:
...
# [](#get-a-shell-inside-the-vm)获取 VM 内部的一个 shell:
...
# [](#enable-microk8-dashboard)启用 microk8 仪表盘
...
# [](#get-all-pod-and-services-details)获取所有 pod 和服务详细信息
...
# [](#you-can-verify-that-all-services-are-up-and-running-with-the-following-command)您可以使用以下命令验证所有服务都已启动并正在运行:

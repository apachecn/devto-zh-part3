...
> 原文:[https://dev . to/claire codes/how-to-create-a-polka-dot-background-with-CSS-23 m0](https://dev.to/clairecodes/how-to-create-a-polka-dot-background-with-css-23m0)

## [TL；博士](https://en.wiktionary.org/wiki/tl;dr)

这篇文章解释了如何使用 CSS 制作这个设计:

[![Final polka dot effect](../Images/915095dc0a9feeab954bb5213dd6aa11.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Qpc6G28h--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/qw8lywyj3cf0ge5cz5na.png)
...
[![Single CSS circle](../Images/23b2b665ac1bf73dd09de0f449243a0d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--zmJyWe11--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/9sr0os7q6wufh0u4nrxw.png)

*注意*:我使用 body 标签来应用样式，因为它是演示新网页效果的最简单的标签。这可能不适合您的用例，所以必要时用另一个 CSS 选择器替换`body`——只是不要忘记给它一个高度和宽度。

## [](#step-2-make-the-circle-repeat)第二步——让圆圈重复
...
[![Repeating circles](../Images/71ca76522d4c8c74e4b28ccbbc1e00fb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8pHX83R4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/fnr853b14lci3gdel771.png)
...
## [](#step-3-add-a-diagonal-row)第三步-添加对角线行
...
### [](#a-note-on-raw-background-endraw-and-shorthand)关于`background`的一个注释和速记

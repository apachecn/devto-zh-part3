...
> 原文:[https://dev . to/angular/you-pick-which-angular-bundles-to-preload-5l 9](https://dev.to/angular/you-pick-which-angular-bundles-to-preload-5l9)
...
## [](#setting-the-custom-optinpreloadstrategy)设置自定义 OptInPreloadStrategy

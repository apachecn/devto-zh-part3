...
> 原文:[https://dev . to/yoshiyukikato/tips-to-use-MySQL-80-on-kubernetes-m3l](https://dev.to/yoshiyukikato/tips-to-use-mysql-80-on-kubernetes-m3l)
...
## ![GitHub logo](../Images/a73f630113876d78cff79f59c2125b24.png) [吉行加藤](https://github.com/YoshiyukiKato)/[MySQL 8-k8s-举例](https://github.com/YoshiyukiKato/mysql8-k8s-example)

...
> 原文:[https://dev . to/booyaa/Gatsby-and-WordPress-netlify-or-die-2 FEC](https://dev.to/booyaa/gatsby-and-wordpress-netlify-or-die-2fec)
...
[![Advanced in Netlify](../Images/f6f03b252297c7a639ec29dc8116e4db.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--gMn8DcGU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://booyaa.wtf/img/gxw-netlify-1.png)

还记得我们在`gatsby-config.js`设置的那些环境变量吗？是时候把它们加起来了。

[![Environment Variables in Netlify](../Images/c51735ed185e6be74f214c46d1d4492d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--QMfpWEwK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://booyaa.wtf/img/gxw-netlify-2.png)

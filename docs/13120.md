...
> 原文:[https://dev . to/duranenmanuel/why-I-prefere-objects-over-switch-statements-4 emo](https://dev.to/duranenmanuel/why-i-prefer-objects-over-switch-statements-4emo)
...
### [](#the-curly-brackets-on-each-case-are-not-mandatory)每个案例上的花括号是*而不是*强制的。
...
## [](#objects-for-safer-lookups)更安全查找的对象
...
## [](#things-to-take-into-consideration)将事情考虑进去

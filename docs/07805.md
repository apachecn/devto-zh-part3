...
> 原文:[https://dev . to/mstrlaw/an-almost-comprehensive-guide-on-use-story book-with-nuxt-js-4e 00](https://dev.to/mstrlaw/an-almost-comprehensive-guide-on-using-storybook-with-nuxt-js-4e00)

[![Header Image](../Images/9d66ef2375af2910e69f9347e1d017cf.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--dwuDtsFP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/d2kbupccm8bbennxrwzc.png)
...
## [](#adding-our-first-story)添加我们的第一个故事
...
[![Storybook Running](../Images/139a0e4cc071018b88397594a45351cc.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--dxuSQdPF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2Ad6cv2jSy9nbStyQBMiq6qQ.gif)
...
## [](#enhancing-our-list-component-amp-adding-the-store)增强我们的列表组件&添加商店
...
### [](#adding-the-store-amp-api-calls)添加商店& API 调用
...
### [](#adding-listitem-component)添加 ListItem 组件
...
[![Style Lists](../Images/7f4f002eeac1ce0710fa662104f03934.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--LSDXmTdY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2A0bTjReOwpB6HG6O0J9ikhw.png) 
现在让我们实际使用我们的 *ListItem* 组件来迭代由我们的 API 返回的每个实体，并相应地设计它的样式。

### [](#adding-a-user-amp-comment-component)添加用户&评论组件
...
[![Styled Lists on Homepage](../Images/dde3a18007c73240526f574d727f7825.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--pIOzYE7v--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2A4HBbxw-SXLK8jDRN4cXdqQ.gif)

我们现在准备好进入故事书，看看会发生什么。

* * *

## [](#resolving-storybooks-complaints)解决故事书的抱怨

我们现在将解决运行 Storybook 时出现的每个问题，第一个问题是:

### 未找到 [](#module-not-found) 模块
...
### [](#module-parse-failed-handling-scss)模块解析失败:处理 SCSS
...
[![Undefined Store](../Images/dcbd116352f2a67c20441cb61dda1f2e.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--1VOsIy7A--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2A_lISfM-0ETI8g-UYQdJLEg.png)

## [](#using-vuex-with-storybook)使用 Vuex 与故事书
...
[![Storybook working with Nuxt](../Images/9adaf89c812171393afcb4ade8e9dbcd.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--1JX3qPpq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2APujMumU0V6bP2JFv-ExAcg.gif)

### [](#handling-nuxtlink)处理 *nuxt-link*

我们终于可以看到一些东西了！但是我们的链接不见了..

[![Unknown element nuxt-link](../Images/715ccd9e837a7fe54d7f4175a9d465a6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--7hajkbTe--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1200/1%2Ay1B1swYEHPFGfMd_jt-gAw.png)
...
[![Stories working with links](../Images/3e3e470f9a5aa812c80c945272c9d9ea.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--4J4g77F1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AFuyLvhnts56H_ohnfNmkBw.gif)

## [](#storybook-working-with-nuxt)故事书与 Nuxt 合作！
...
[![Netlify Build config](../Images/3a534a1f632aee29e00db07679de34cd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--IBV0gvNE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1200/1%2AlgA8GYXJJphIbHVc6klhmA.png)

然后你应该有你的故事书，并在你每次推送/合并到你的主分支时更新。[来看看](https://pensive-lichterman-edd576.netlify.com/?path=/story/lists--users)！

## [](#final-repo-amp-resources)最终回购&资源

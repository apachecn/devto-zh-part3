...
> 原文:[https://dev . to/borisschapira/measuring-interactive-with-tti-time-to-consistently-interactive-460 l](https://dev.to/borisschapira/measuring-interactivity-with-tti-time-to-consistently-interactive-460l)
...
[![Photo of a carousel in action. The rotational movement creates a fuzzy effect: it is impossible to know with certainty the speed of the merry-go-round.](../Images/3116c7861f8f36263f133d1c23d14141.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--V1iT4rwz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://res.cloudinary.com/borisschapira/image/fetch/c_limit%2Cf_auto%2Cq_auto%2Cw_760/https://boris.schapira.dev/assets/images/2019-05-16/carnival.jpg)
...
## [](#the-quest-for-a-new-metric)寻求新的度量

### [](#what-are-we-trying-to-measure)我们在努力测量什么？
...
there's a clear linear correlation ; the slope varies between 1.2 and 1.5.](../Images/23c5d469870a0fa04cdaf3013f4e3236.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--hSYGeQHi--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://res.cloudinary.com/borisschapira/image/fetch/c_limit%2Cf_auto%2Cq_auto%2Cw_760/https://boris.schapira.dev/assets/images/2019-05-16/rage.png)
...
### [](#lets-introduce-time-to-consistently-interactive)让我们介绍…时间到了(一致地)互动
...
[![Superposition of several photos of a dancer in movement. Each movement is captured and yet it is impossible to grasp the continuum on a static image.](../Images/0d18fef9341dc2b04adae6b1613129a8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--L3fhYy_l--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://res.cloudinary.com/borisschapira/image/fetch/c_limit%2Cf_auto%2Cq_auto%2Cw_760/https://boris.schapira.dev/assets/images/2019-05-16/danse.jpg)
...
[![A graph summarizing the above explanations.](../Images/c7bbb893b1de55277a941a434f463e50.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--MqL5hUvG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://res.cloudinary.com/borisschapira/image/fetch/c_limit%2Cf_auto%2Cq_auto%2Cw_760/https://boris.schapira.dev/assets/images/2019-05-16/tti_w.png)
...
## [](#common-misconception-about-time-to-interactive)关于时间互动的常见误解

### [](#time-to-interactive-is-not-the-time-until-a-page-is-interactive)交互时间不是页面开始交互之前的时间
...
### [](#in-the-tti-algorithm-the-network-quiet-subwindow-is-only-a-signal)在 TTI 算法中，“网络安静”子窗口只是一个信号
...
### [](#googles-tti-is-not-everyones)谷歌的 TTI 不是所有人的
...
### [](#time-to-interactive-is-not-easy-to-stabilize)互动的时间不易稳定
...
### [](#the-long-task-50ms-definition-creates-a-threshold-effect)长任务“50 毫秒”定义产生阈值效应

TTI 阈值具有提高对绩效预算重要性的认识的优点。TTI 是一种[性能预算](https://blog.dareboost.com/en/2015/10/performance-budget/):“主线程活动必须保持在 50 毫秒的预算之内”。

然而，任何阈值的定义都有影响。

[![Capture from WebPageTest. The evaluation of the ](../Images/e8485c3b30f1b13223b2db8b99b52e32.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--6mZS8w52--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://res.cloudinary.com/borisschapira/image/fetch/c_limit%2Cf_auto%2Cq_auto%2Cw_760/https://boris.schapira.dev/assets/images/2019-05-16/tti.png)
...
## [](#interactivity-measurement-is-tti-enough)交互性测量:TTI 够了吗？

### [](#tti-as-a-new-reference-metric)TTI 作为新的参考指标？
...
[![A microscope zooming on a sample.](../Images/0fe98becabe0122fe7121dd39c76c7c6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--cORYtqO3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://res.cloudinary.com/borisschapira/image/fetch/c_limit%2Cf_auto%2Cq_auto%2Cw_760/https://boris.schapira.dev/assets/images/2019-05-16/observe.jpg)
...
### [](#a-milestone-more-than-an-evaluation-of-a-continuum)一个里程碑多一个连续体的评价
...
First Page LongTask Time vs. Session Length (right)](../Images/4d154f52ecebdf017eeae059fcad9e31.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--hix1DECg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://res.cloudinary.com/borisschapira/image/fetch/c_limit%2Cf_auto%2Cq_auto%2Cw_760/https://boris.schapira.dev/assets/images/2019-05-16/nic.png)
...
## [](#more-about-interactivity-and-the-time-to-interactive)更多关于互动性和互动的时间:

### [](#a-touch-of-archaeology)一抹考古

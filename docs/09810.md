...
> 原文:[https://dev.to/dabit3/how-i-built-hypebeats-一个实时协作-beatbox-with-react-graph QL-29 i5](https://dev.to/dabit3/how-i-built-hypebeats---a-real-time-collaborative-beatbox-with-react-graphql-29i5)
...
> ![unknown tweet media content](../Images/487e62efd1c8837b1bf262a9d5af3259.png)![Play butt](../Images/980e9fb12d58fa9423fc94c33003fc4f.png)<video loop="" controls=""><source src="https://video.twimg.com/tweet_video/D1YQhJvWoAIJ1RC.mp4" type="video/mp4"></video>![Nader Dabit profile image](../Images/e5f4dbee552070447c02ae734d8d58cc.png)Nader Dabit[@ Dabit 3](https://dev.to/dabit3)![twitter logo](../Images/ad0c7b03deabfe1a161345efb2d537eb.png)我在 AWS AppSync 上用 GraphQL 订阅搭建了一个协同实时绘图 app！
> 
> 代码在[github.com/dabit3/appsync…](https://t.co/nmiR03Qaxm)
> 
> 我还写了一篇关于我如何在[dev.to/dabit3/real-ti…](https://t.co/DFYOdcgMxJ)
> 
> [#无服务器](https://twitter.com/hashtag/serverless)[# graph QL](https://twitter.com/hashtag/graphql)[# AWS](https://twitter.com/hashtag/aws)2019 年 3 月 11 日下午 12:54[![Twitter reply action](../Images/269095962147c28351274afdd5486a48.png)](https://twitter.com/intent/tweet?in_reply_to=1105089664040554496)[![Twitter retweet action](../Images/771160ecf06ae3d4d7a7815c29c819c2.png)](https://twitter.com/intent/retweet?tweet_id=1105089664040554496)
...
## ![GitHub logo](../Images/375dfcc32199b4dedf2b526645c27ff7.png) [肯惠勒](https://github.com/kenwheeler) / [钩-鼓-机](https://github.com/kenwheeler/hooks-drum-machine)
...
[![](../Images/0c5db0098ae93f4a6f31a383f113069f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--JfxtqtIZ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4r1v7qjtmvsrtj2iz88t.png)

使用步进序列器，您可以从左到右依次移动，步进序列中的每个项目。如果该项突出显示，将播放相关的声音。

[![](../Images/3b7a5ab947ff219d29d35b63eaefd9e3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--XNEPg3_u--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/32w5xy90uv0fja6gzl9a.gif)

鼓机为我们提供了节拍的初始状态，音序器中为每个节拍设置了一个数组:

[![](../Images/356279a3508bacfa934f472a686a8f38.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--p0zKV3Wv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/0wxsqf2i8abpy79es9y9.png)
...
## [](#making-it-collaborative-amp-realtime-with-graphql-subscriptions)通过 GraphQL 订阅实现实时协作&
...
## [](#contributing-next%C2%A0steps)投稿/后续步骤

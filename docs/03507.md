...
> 原文:[https://dev . to/billyjacoby/building-a-gatsbyjs-theme-part-two-7c 7](https://dev.to/billyjacoby/building-a-gatsbyjs-theme-part-two-7c7)

## [](#designing-and-configuring-our-layout)设计和配置我们的布局
...
### [](#create-a-layout-component)创建布局组件
...
### [](#configuring-our-layout-to-work-across-all-pages)配置我们的布局在所有页面上工作
...
### [](#create-a-header-component-that-uses-site-metadata)创建一个使用站点元数据的头组件
...
### [](#adding-our-header-to-our-layout)将页眉添加到布局中

...
> 原文:[https://dev . to/citizen 428/multi-stage-docker-builds-for-crystal-ECI](https://dev.to/citizen428/multi-stage-docker-builds-for-crystal-eci)
...
## [](#building-from-the-crystal-image)从水晶影像中构建
...
## [](#building-from-alpine)建筑来自阿尔卑斯山
...
## [](#multistage-build-from-alpine)阿尔卑斯山的多阶段建造

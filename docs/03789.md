...
> 原文:[https://dev . to/Ben/if-you-enable-lazy-loading-in-chrome-flags-your-dev-browsing-experience-will-medium-more-efficient-5982](https://dev.to/ben/if-you-enable-lazy-loading-in-chrome-flags-your-dev-browsing-experience-will-be-moderately-more-efficient-5982)

*更新:Chrome 最近发布的延迟加载*

[![yashints](../Images/0d36c7c282ebcf4aec1143e95bad3d39.png)](/yashints) [## 原生延迟加载登陆 Chrome🔥😍🔥
...
# [![GitHub logo](../Images/75095a8afc1e0f207cda715962e75c8d.png) 给一些图片添加 loading =‘lazy’属性 #2776](https://github.com/thepracticaldev/dev.to/pull/2776) 

[![benhalpern avatar](../Images/2b95d19f70b4d1ccc724ce3ad9480e00.png)](https://github.com/benhalpern) **[benhalpern](https://github.com/benhalpern)** posted on [<time datetime="2019-05-09T19:35:04Z">May 09, 2019</time>](https://github.com/thepracticaldev/dev.to/pull/2776)

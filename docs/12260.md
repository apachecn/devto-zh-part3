...
> 原文:[https://dev . to/tevko/quick-tip-managing-event-listeners-with-bound-callbacks-ji9](https://dev.to/tevko/quick-tip-managing-event-listeners-with-bound-callbacks-ji9)

## [](#always-remove-your-event-listeners)始终删除您的事件监听器

...
> 原文:[https://dev.to/edwinthinks/structured-rspec-for-ruby-rails-1cb](https://dev.to/edwinthinks/structured-rspec-for-ruby--rails-1icb)
...
### [](#what-are-you-going-to-raw-describe-endraw-and-what-is-your-raw-subject-endraw-)你打算`describe`什么是你的`subject`？
...
### [](#applying-it-to-ruby-on-rails-projects)将其应用于 Ruby On Rails 项目
...
#### [](#sideeffects-or-queueing-of-jobs)副作用或工作排队

...
> 原文:[https://dev.to/martyhimmel/javascript-es5-loops-289o](https://dev.to/martyhimmel/javascript-es5-loops-289o)

*此文最初于 2016 年 12 月 26 日发布在我的网站 [https://martyhimmel.me](https://martyhimmel.me) 。像 dev.to 上的许多其他人一样，我决定将我的技术博客帖子转移到这个网站。*

## [](#-raw-for-endraw-loops)`for`循环往复
...
## [](#-raw-forin-endraw-loops)`for…in`循环往复
...
## [](#-raw-while-endraw-loops)`while`循环往复
...
## [](#-raw-dowhile-endraw-loops)`do…while`循环往复

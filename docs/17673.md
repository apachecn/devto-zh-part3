...
> 原文:[https://dev . to/nickjj/my-favorite-vs code-extensions-and-settings-k5l](https://dev.to/nickjj/my-favorite-vscode-extensions-and-settings-k5l)
...
##### [](#github-plus-theme-elixir-adapted-light)GitHub Plus 主题仙丹改编[光明]
...
##### [](#dracula-official-dark)德拉库拉官方【黑暗】
...
##### [](#liquid-language-support)液态语言支持

Liquid Language 支持为 Liquid template 语言增加了语法高亮显示。

##### [](#markdown-preview-github-styling)降价预览 Github 造型
...
##### [](#vscodeelixir)vscode-elixir

vscode-elixir 为 elixir 编程语言增加了语法突出显示等功能。

##### [](#vscodegemfile)vscode-gemfile
...
#### [](#quickly-installing-these-extensions)快速安装这些扩展
...
#### [](#wait-where-are-the-python-and-ruby-language-extensions)等等，Python 和 Ruby 语言扩展在哪里？
...
#### [](#wait-what-about-debugging)等等，调试呢？

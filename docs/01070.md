...
> 原文:[https://dev . to/eheiberg/code-signing-a-windows-app-on-a-MAC-using-electron-builder-5 flm](https://dev.to/eheiberg/code-signing-a-windows-app-on-a-mac-using-electron-builder-5flm)
...
### [](#app-created-were-done-right)App 已创建！我们完了！对吗？
...
### [](#windows-on-the-other-hand-)Windows 则相反...
...
### [](#last-note-microsoft-smartscreen)最后一笔——微软 SmartScreen

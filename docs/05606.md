...
> 原文:[https://dev . to/hawk injs/levelling-Travis-ci-for-continuous-deployment-to-publish-compiled-binaries-to-github-2k 06](https://dev.to/hawkinjs/leveraging-travis-ci-for-continuous-deployment-to-publish-compiled-binaries-to-github-2k06)
...
## [](#what-is-crosscompilation)什么是交叉编译？
...
## [](#where-is-your-code)你的代码在哪里？

你可以在我的 GitHub 项目上看到我为这篇文章写的所有代码！

## ![GitHub logo](../Images/a73f630113876d78cff79f59c2125b24.png) [霍金斯](https://github.com/hawkins) / [看门狗](https://github.com/hawkins/watchdog)
...
<g-emoji class="g-emoji" alias="warning" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/26a0.png">⚠️</g-emoji> 观察文件系统的变化，然后运行一个命令
...
## [](#initial-travis-config)初始 Travis 配置
...
## [](#travis-releases-provider)特拉维斯发布提供者
...
## [](#testing-travis-changes)测试特拉维斯的变化
...
[![](../Images/adb81807a2532389add429aca058d785.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--D32L7urB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/bbas2erbge80zodm45me.png)
...
| 特拉维斯 | 开源代码库 |
| --- | --- |
| ![](../Images/6c73c555b24276a25229be1af0b4b82d.png) | ![](../Images/0ffee021bcc04b6fe84c826953388f14.png) |

...
> 原文:[https://dev . to/tryo labs/how-we-build-a-stand-in-robot-for-remote-workers-using-IOT-and-computer-vision-350 b](https://dev.to/tryolabs/how-we-built-a-stand-in-robot-for-remote-workers-using-iot-and-computer-vision-350b)
...
[![Hackathon team: Joaquín, Braulio, Javier and Lucas.](../Images/64ff7d6f3d4f3e5388aa3b495aebd989.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--vSczhLan--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/id9qrvvxuhmu5c689gvp.jpg) 
*黑客马拉松团队:华金、布拉乌利奥、哈维尔、卢卡斯。*

## [](#building-the-hardware-of-a-minirobot)建造微型机器人的硬件
...
## [](#enabling-the-robot-to-communicate-in-realtime)使机器人能够实时通信

当我们中的一些人继续在硬件上工作并组装部件时，团队的其他人开始构建控制上述所有组件的软件。

### [](#implementing-webrtc)实现 WebRTC
...
### [](#building-a-ui-to-manage-communication)构建 UI 来管理通信
...
## [](#remotely-control-the-robots-movements)遥控机器人的动作
...
## [](#adding-computer-vision-to-the-robot)给机器人添加计算机视觉

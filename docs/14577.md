...
> 原文:[https://dev . to/Samantha Ming/we b-basics-how-to-capital-a word-in-JavaScript-44p 8](https://dev.to/samanthaming/web-basics-how-to-capitalize-a-word-in-javascript-44p8)

[![Web Basics by SamanthaMing.com](../Images/c95dbd24b77cac04be7d06c9c6b97fd6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9Dj5ZGS7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/aoshe23g3fkeucscmu3s.png)
...
## [](#web-basics-raw-touppercase-endraw-)网络基础知识:`toUpperCase()`
...
### [](#web-basics-examples-raw-touppercase-endraw-)网络基础知识举例:`toUpperCase()`
...
## [](#web-basics-raw-charat-endraw-)网络基础知识:`charAt()`
...
### [](#web-basics-examples-raw-charat-endraw-)网络基础知识举例:`charAt()`
...
## [](#web-basics-raw-slice-endraw-)网络基础知识:`slice()`
...
### [](#web-basics-examples-raw-slice-endraw-)网络基础知识举例:`slice()`
...
## [](#web-basics-raw-tolowercase-endraw-)网络基础知识:`toLowerCase()`
...
### [](#web-basics-examples-raw-tolowercase-endraw-)网络基础知识举例:`toLowerCase()`

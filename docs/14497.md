...
> 原文:[https://dev . to/switowski/creating-magic-functions-in-ipython-part-1-387j](https://dev.to/switowski/creating-magic-functions-in-ipython---part-1-387j)

## [](#ipython-magic-functions)IPython 魔法函数
...
## [](#creating-line-magic-function)创建线条魔术功能

...
> 原文:[https://dev.to/brettmn/lwc 用闪电数据服务获取数据-20gl](https://dev.to/brettmn/lwc--getting-data-with-lightning-data-service-20gl)
...
## [](#using-lightning-data-service)使用闪电数据服务

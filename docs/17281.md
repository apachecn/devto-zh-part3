...
> 原文:[https://dev . to/ascorbic/pr-previews-for-your-static-site-with code build-and-lambda edge-2n 60](https://dev.to/ascorbic/pr-previews-for-your-static-site-with-codebuild-and-lambdaedge-2n60)
...
## [](#fixing-the-cache-headers)固定缓存头
...
## [](#fixing-the-mime-types)固定 mime 类型

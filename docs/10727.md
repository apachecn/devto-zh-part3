...
> 原文:[https://dev . to/vaidotas/building-weather-forecast-CLI-tool-part-1-2 mdj](https://dev.to/vaidotas/building-weather-forecast-cli-tool-part-1-2mdj)

[![](../Images/6cd78571ac30d7842ac71fbb5f25f3c5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--39KDMIgT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/w32hvyuoewtfii1eia9h.png)

## [](#the-goal-and-the-setup)目标和设置
...
## [](#requirements-for-our-app)对我们 app 的要求
...
## [](#step-a-program-init)步骤 A-程序初始化
...
## [](#step-b-indexts-first-lines-of-code)步骤 B - index.ts -第一行代码
...
## [](#step-c-everybody-do-the-shebang)步骤 C——每个人都做这个
...
## [](#step-d-set-and-get-api-keys)步骤 D -设置并获取 API 密钥

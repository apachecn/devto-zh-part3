...
> 原文:[https://dev . to/zellwk/what-not-to-save-into-a-git-repository-334](https://dev.to/zellwk/what-not-to-save-into-a-git-repository--334)
...
## [](#files-that-dont-belong-to-the-project)不属于项目的文件

像`.DS_Store`(用于 Mac OS)、`Thumds.db`(用于 Windows)、`.vscode`(用于代码编辑器)这样的文件与你的项目无关。

它们不应被检入。

## [](#files-that-are-automatically-generated)自动生成的文件

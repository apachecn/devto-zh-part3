...
> 原文:[https://dev.to/nishimura/tried-ffi-on-php-7-4-4nl9](https://dev.to/nishimura/tried-ffi-on-php-7-4-4nl9)

# [](#getting-php-74-and-check-the-launch)获取 PHP 7.4 并检查启动
...
# [](#make-shared-library-by-c-language-for-ffi)用 C 语言为 FFI 制作共享库
...
# [](#use-a-callback-function)使用回调函数
...
# [](#use-struct-of-c-language)使用 C 语言的 struct
...
## ![GitHub logo](../Images/a73f630113876d78cff79f59c2125b24.png) [西村](https://github.com/nishimura) / [ php_ffi_samples](https://github.com/nishimura/php_ffi_samples)

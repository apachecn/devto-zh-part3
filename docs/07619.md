...
> 原文:[https://dev . to/jam 3/managing-env-variables-for-temporary-builds-h37](https://dev.to/jam3/managing-env-variables-for-provisional-builds-h37)
...
#### [](#-raw-envdevelopment-endraw-and-raw-envproduction-endraw-)`.env.development`和`.env.production`

作为默认行为，这些文件将在没有配置的情况下提供。您甚至不必更新`package.json`中的脚本

#### [](#-raw-envstaging-endraw-)`.env.staging`

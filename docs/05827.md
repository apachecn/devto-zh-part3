...
> 原文:[https://dev . to/prasanthmj/creating-a-complete-web-app-on-Google-apps-script-using-Google-sheet-as-database-26o 8](https://dev.to/prasanthmj/creating-a-complete-web-app-on-google-apps-script-using-google-sheet-as-database-26o8)
...
## [](#webpack-to-create-the-bundle)Webpack 创建捆绑包
...
## [](#creating-a-rich-ui-for-the-apps-script-project)为 Apps 脚本项目创建丰富的 UI
...
[![Single Page Apps in Google Apps Script](../Images/57e4c066049c0dd34fc6fe0fa25c1dab.png)T2】](https://www.youtube.com/watch?v=g27PUdZkoYU)

代码分为两部分:“客户端”和“服务器端”。客户端文件夹包含 Vuejs、index.html 和 SCSS 模板，我们将所有这些组合在一起，创建一个捆绑包，即上传的 index.html 文件。

[![Folder Structure of Apps Curry](../Images/3aeb8d6f6c789b0191d04fe5540594b8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vb0IPsZ7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/fpmc1boz1l07pjs6ae0k.png)
...
[![Apps Curry Demo - cloning and creating an instance](../Images/c8a4f175660a6e8d2f7c3bdbbcc82927.png)T2】](https://www.youtube.com/watch?v=Vt6O4pf98VU)

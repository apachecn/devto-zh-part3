...
> 原文:[https://dev . to/setevoy/redis-replication-part-2-master-slave-replication-and-redis-sentinel-1 hoe](https://dev.to/setevoy/redis-replication-part-2-master-slave-replication-and-redis-sentinel-1hoe)

[![](../Images/f6d45197b0b18a1a39702233dbf5afe7.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--rqSEDlVy--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://rtfm.co.ua/wp-content/uploads/2018/05/redislogo.png) 第一部分——[Redis:复制，第一部分——概述。复制与分片。哨兵 vs 集群。雷迪斯拓扑](https://rtfm.co.ua/en/?p=20328)。
...
### [](#the-basic-masterslave-replication)基本主从复制
...
#### [](#redis-master-configuration)重定向主配置
...
#### [](#redis-slave-configuration)重定向从属配置
...
#### [](#changing-slave-gt-master-roles)改变奴隶= >主人的角色
...
[![](../Images/9ca15f6b0eb9551395c8bbf8e1add20d.png "Redis: репликация, часть 2 - Master-Slave репликация, и Redis Sentinel")T2】](https://rtfm.co.ua/wp-content/uploads/2019/03/redis-sentinel-800x450.png)
...
#### [](#redis-sentinel-automatic-failover)Redis Sentinel 自动故障转移

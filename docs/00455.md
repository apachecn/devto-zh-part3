...
> 原文:[https://dev . to/FD ocr/kubernetes-integration-with-rake-tasks-j0b](https://dev.to/fdocr/kubernetes-integration-with-rake-tasks-j0b)
...
## [](#objectives-amp-capabilities)目标&能力
...
## [](#how-to-deploy-and-rollback)如何部署和回滚
...
## [](#port-forward-services)港口转发服务

在我看来，这是 gem 中最有趣的功能。当使用 SOA/微服务时，您必须处理一个更复杂的系统，那么如果您想在您的试运行或开发环境中调试一个问题呢？

我将用下面的假设图来解释我们最常见的用例:

[![Port Forwarding](../Images/b8059a131490e4d77da6f344aa04b36f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--zm82L-NA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/dz4tit0mt3ovk610vdaf.png)
...
## [](#activek8s-roadmap)Activek8s 路线图

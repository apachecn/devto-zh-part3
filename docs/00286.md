...
> 原文:[https://dev.to/manzanit0/wtf-are-streams-1e9h](https://dev.to/manzanit0/wtf-are-streams-1e9h)
...
## [](#simplified-io-over-a-string-in-elixir)简化 I/O 超过一个字符串，在仙丹
...
## [](#io-on-a-file-in-cnet)对一个文件的 I/O，在 C#/中。网
...
### [](#why-do-streams-have-to-be-opened-or-closed)为什么流一定要打开或者关闭？
...
## [](#io-over-a-socket-in-java)通过套接字的 I/O，在 Java 中
...
## [](#seeking-a-stream-understanding-the-sideeffects-of-reading)寻找一个流——了解阅读的副作用

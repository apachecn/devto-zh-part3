...
> 原文:[https://dev.to/10secondsofcode/javascript-closures-375d](https://dev.to/10secondsofcode/javascript-closures-375d)
...
# [](#javascript-10secondsofcode-closures)javascript，# 10 秒代码，#闭包
...
> 原文:[https://dev . to/maybe bored/deploy-a-WordPress-website-using-AWS-ec2-the-absolute-初学者指南-2plf](https://dev.to/maybebored/deploy-a-wordpress-website-using-aws-ec2-the-absolute-beginners-guide-2plf)
...
### [](#step-1-set-up-your-aws-account)步骤 1 -设置您的 AWS 帐户
...
### [](#step-2-follow-this-aws-tutorial-to-set-up-a-wordpress-website)第二步——按照这个 [AWS 教程](https://aws.amazon.com/getting-started/tutorials/launch-a-wordpress-website/)建立一个 WordPress 网站。
...
[![3.1 security group](../Images/b4af4c81c6463c39a726de4caa226e23.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--_6eX33vB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/j1vhgwhrj6w88ato1nfh.png)

如果您成功创建了实例，但无法使用浏览器访问它，那么可能是因为您没有允许任何传入连接到您的实例。编辑您的安全组的入站规则以允许传入流量。这些规则描述了您的实例所允许的传入 web 流量的类型和来源。下图显示了我的规则。

[![3.2 my inbound rules](../Images/2212096f9ced8d134048d9f5512b2e60.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--bZQm4OYp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/0ouh2pcv6b174rt6cl03.png)
...
[![3.3 edit inbound rules](../Images/796669821abf9644f7d4022ac4eb7c47.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--l2V7kccG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/yn3wmyla9r7ykxtp67su.png)

...
> 原文:[https://dev . to/antonmelnyk/how-to-configure-web pack-from scratch-for-a-basic-website-46 a5](https://dev.to/antonmelnyk/how-to-configure-webpack-from-scratch-for-a-basic-website-46a5)

# [](#blossom-introduction)🌼介绍
...
# [](#balloon-our-goal)🎈我们的目标

我们将使用 Webpack 将 JavaScript、样式、图像和字体文件打包到一个 *dist* 文件夹中。

[![](../Images/8cbcd2f19cead2b66927453e8ab47912.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--X7SLgQkY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/9n9g3yr1v6lhjfg8roqc.png)
...
#### [](#2-create-entry-point-file)2。创建入口点文件

Webpack 从一个称为入口点的 JavaScript 文件开始工作。在 *javascript* 文件夹中创建 *index.js* 。你可以像`console.log('Hi')`一样在这里写一些简单的代码来确保它的工作。

[![](../Images/c9fc2a5fa56a489253009ae4318f2413.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--YJfSM_wN--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/tlt38mn2u385i06y4vzn.png)

#### [](#3-create-webpackconfigjs)3。创建网页包.配置. js
...
#### [](#4-add-npm-script-in-packagejson-to-run-webpack)4。在 *package.json* 中添加 npm 脚本来运行 Webpack
...
[![](../Images/326aafade321597dadb8c657d274de26.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--EGqsi6y---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8j9rn72esbfbvn27duz6.png)

如果你将`<script src="dist/bundle.js"></script>`添加到你的 HTML 文件中，你应该会在浏览器控制台中看到`Hi`！

# [](#microscope-loaders)🔬装载机
...
### [](#1-babelloader)1。[通天塔](https://github.com/babel/babel-loader)
...
### [](#2-sassloader)2。 [sass-loader](https://github.com/webpack-contrib/sass-loader)
...
[![](../Images/70713c4fb450cb0b45b0ec691279dac6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Ev5xY2Cl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ye1wwk5r7rvxcu9n0ylm.png)

Webpack 有大量不同用途的插件。你可以在你需要的时候在官方文档中探索它们。

# [](#microscope-more-loaders-images-and-fonts)🔬更多加载器:图像和字体
...
### [](#fileloader)[文件加载器](https://github.com/webpack-contrib/file-loader)

...
> 原文:[https://dev . to/modsognir/ml-class ification-on-short-strings-in-ruby-using-small text-5faa](https://dev.to/modsognir/ml-classification-on-short-strings-in-ruby-using-smalltext-5faa)
...
#### [](#libtrainclassifierrb)lib/train_classifier.rb

...
> 原文:[https://dev . to/mindsers/git flow-methodology-and-practice-142 l](https://dev.to/mindsers/gitflow-methodology-and-practice-142l)

GitFlow 就是我们所说的工作流，Git 的工作策略。还有很多其他的，但是 GitFlow 是最著名的一个。他被 nvie 认为。用它有什么意义？

## [](#why-is-it-important-to-have-a-git-strategy)为什么拥有 Git 策略很重要？
...
### [](#i-prepare-a-new-version-for-production)我准备制作新版本
...
## [](#gitflow-the-overlayer)GitFlow，覆盖层

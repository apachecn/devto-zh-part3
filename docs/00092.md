...
> 原文:[https://dev.to/gklijs/the-human-side-of-open-bank-mark-3o4b](https://dev.to/gklijs/the-human-side-of-open-bank-mark-3o4b)
...
## [](#what-is-openbankmark)什么是开户行标？

> ![Gerard Klijs profile image](../Images/a54acaecd6ec739565663dfaa634cc9f.png)杰拉德·克里吉斯[@ gklijs](https://dev.to/gklijs)![twitter logo](../Images/65e26e35707d96169ec8af6b3cbf2003.png)打开银行标记，使用 [#clojure](https://twitter.com/hashtag/clojure) 和 [#clojure](https://twitter.com/hashtag/clojure) 脚本构建，允许使用 [@confluentinc](https://twitter.com/confluentinc) 模式注册表对 [@apachekafka](https://twitter.com/apachekafka) 应用程序进行端到端测试。其中一个[#微服务](https://twitter.com/hashtag/microservices)也在[# rustlang](https://twitter.com/hashtag/rustlang)[# kotlin](https://twitter.com/hashtag/kotlin)中实现，使用 [#Docker](https://twitter.com/hashtag/Docker) 进行设置。[github.com/openweb-nl/ope…](https://t.co/2btZa0AK55)2019 年 5 月 20 日下午 16:51![Twitter reply action](../Images/269095962147c28351274afdd5486a48.png)[![Twitter retweet action](../Images/771160ecf06ae3d4d7a7815c29c819c2.png)](https://twitter.com/intent/retweet?tweet_id=1130516421677658114)2[![Twitter like action](../Images/c077611ab2a5e0b4cd0c826ee7ae1e48.png)](https://twitter.com/intent/like?tweet_id=1130516421677658114)14
...
## ![GitHub logo](../Images/a73f630113876d78cff79f59c2125b24.png) [ openweb-nl ](https://github.com/openweb-nl) / [开户行标志](https://github.com/openweb-nl/open-bank-mark)
...
[![Build Status](../Images/8669abd78afa4c6c4f3c3cf426cd86d3.png)T2】](https://travis-ci.com/openweb-nl/open-bank-mark)
...
## [](#kafka-platform-at-rabobank)荷兰合作银行的卡夫卡平台
...
## [](#rust-2018-edition-release-party)Rust 2018 版发布会
...
## [](#kafka-meetup-utrecht)卡夫卡会见乌特勒支
...
> ![unknown tweet media content](../Images/614541ccd4ef5f4c1fdf969f46dbf2b8.png)![Gerard Klijs profile image](../Images/a54acaecd6ec739565663dfaa634cc9f.png)Gerard kli js[@ gkli js](https://dev.to/gklijs)![twitter logo](../Images/65e26e35707d96169ec8af6b3cbf2003.png)[# rust lang](https://twitter.com/hashtag/rustlang)太牛逼了，编译成静态二进制这样一个 docker 镜像就可以从头做起了。生成的图像小于 10mb。Dockerfle 只是 github.com/gklijs/open-ba…的。现在试运行【travis-ci.com/openweb-nl/ope…】[# TravisCI](https://twitter.com/hashtag/TravisCI)。2019 年 5 月 25 日上午 09:44[![Twitter reply action](../Images/269095962147c28351274afdd5486a48.png)](https://twitter.com/intent/tweet?in_reply_to=1132220825912979457)[![Twitter retweet action](../Images/771160ecf06ae3d4d7a7815c29c819c2.png)](https://twitter.com/intent/retweet?tweet_id=1132220825912979457)0[![Twitter like action](../Images/c077611ab2a5e0b4cd0c826ee7ae1e48.png)](https://twitter.com/intent/like?tweet_id=1132220825912979457)3
...
> ![Scicloj profile image](../Images/58d81279b94d734f51caf3109e3cbb86.png)Scicloj@ Scicloj![twitter logo](../Images/65e26e35707d96169ec8af6b3cbf2003.png)一个用 [#clojure](https://twitter.com/hashtag/clojure) 和 [#clojure](https://twitter.com/hashtag/clojure) 脚本编写的事件源应用程序的现实开源示例，基于[@ confluent Inc](https://twitter.com/confluentinc)-[@ Apache Kafka](https://twitter.com/apachekafka)。它使用组件架构，Lacinia 用于 [#graphql](https://twitter.com/hashtag/graphql) ，Oz 用于 [#datavis](https://twitter.com/hashtag/datavis) ，Next-JDBC 用于数据库访问。
> 感谢分享， [@GKlijs](https://twitter.com/GKlijs) ！[twitter.com/GKlijs/status/…](https://t.co/lP3gxFKQfq)21:51PM-2019 年 5 月 29 日杰拉德·克利 js[@ gklijs](https://dev.to/gklijs)Open bank mark，用#clojure 和#clojurescript 构建允许使用@confluentinc 模式注册表对一个@apachekafka 应用进行端到端测试。其中一个#微服务也在#rustlang #kotlin 中实现，使用#Docker 进行设置。[![Twitter reply action](../Images/269095962147c28351274afdd5486a48.png)](https://twitter.com/intent/tweet?in_reply_to=1133853325164711936)[![Twitter retweet action](../Images/771160ecf06ae3d4d7a7815c29c819c2.png)](https://twitter.com/intent/retweet?tweet_id=1133853325164711936)9[![Twitter like action](../Images/c077611ab2a5e0b4cd0c826ee7ae1e48.png)](https://twitter.com/intent/like?tweet_id=1133853325164711936)17
...
## ![GitHub logo](../Images/a73f630113876d78cff79f59c2125b24.png) [ juxt ](https://github.com/juxt) / [症结](https://github.com/juxt/crux)

### 具有双时态图查询的文档数据库

<article class="markdown-body entry-content container-lg" itemprop="text">

[![Crux](../Images/85319408a7a579ef41ca26663f4ed285.png)T2】](https://raw.githubusercontent.com/juxt/crux/master/./docs/img/crux-logo-banner.svg)

[![project chat](../Images/10de4828ee31d633dc21a11cbc14bb68.png)T2】](https://juxt-oss.zulipchat.com/#narrow/stream/194466-crux)

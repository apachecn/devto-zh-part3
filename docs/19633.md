...
> 原文:[https://dev.to/risdenk/apache-solr-隐藏编辑-感知-属性-56ca](https://dev.to/risdenk/apache-solr---hideredact-senstive-properties-56ca)
...
### [](#apache-solr-and-hiding-sensitive-properties)Apache Solr 并隐藏敏感属性
...
### [](#apache-solr-and-hiding-metrics-properties)Apache Solr 和隐藏指标属性

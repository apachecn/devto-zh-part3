...
> 原文:[https://dev . to/Denise pen/cracking-algorithms-counting-unique-values-1a5n](https://dev.to/denisepen/tackling-algorithms-counting-unique-values-1a5n)

### [](#problem-given-an-array-of-integers-count-the-number-of-unique-values)问题:给定一个整数数组，统计唯一值的个数。
...
#### [](#first-solution-frequency-counter)第一种解决方案:频率计数器
...
#### [](#second-solution-multiple-pointers)第二种解法:多个指针
...
[![img](../Images/e07be652bda6547d6a809a9d7e9cae42.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--d8JMJOVu--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/UUJpmbB.png)

[![img](../Images/2e6ed193a44469d4e2ce49a9458ab67a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--k7F-liac--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/yo7Lobw.png)

在我们完全遍历完数组一次后，每个唯一值都位于数组的开头，而“I”位于最后一个唯一值的位置:

[![img](../Images/c843ead7873c608ffaa1815a816b4ad0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--uj9sneUw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/kvUCdF5.png)

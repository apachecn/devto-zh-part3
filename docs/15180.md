...
> 原文:[https://dev . to/living _ syn/validating-client-certificate-sans-in-go-i5p](https://dev.to/living_syn/validating-client-certificate-sans-in-go-i5p)
...
## [](#custom-client-cert-validation)自定义客户端证书验证

...
> 原文:[https://dev . to/rafnixg/crea-tu-blog-con-python-usando-github-pages-y-pelican-pbk](https://dev.to/rafnixg/crea-tu-blog-con-python-usando-github-pages-y-pelican-pbk)

当我开始重新思考创办博客的想法时，我想到了很多如何做到这一点的想法，比如使用著名的[【WordPress】](https://wordpress.org)，因为博客想这样做，是为了讲一点 python 的话，以及我将要了解和学习的技术，我决定更好地使用

## [](#qu%C3%A9-es-pelican)是鹈鹕吗？
...
## [](#qu%C3%A9-es-github-pages)Qué es GitHub 页数？
...
## [](#creando-nuestro-repositorio-en-github)在 GitHub 上创建我们的存储库
...
## [](#instalando-y-configurando-pelican)安装和配置鹈鹕
...
## [](#escribiendo-nuestro-primer-post)写我们的第一篇帖子
...
## [](#probando-nuestro-blog-en-local)在现场测试我们的博客
...
[![Hola mundo Pelican](../Images/15867eeca566232d506f1cb40a1782fe.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--DK0PcfPJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://rafnixg.github.io/images/hola-mundo-pelican.jpg)

## [](#subir-nuestro-blog-a-github-pages)Subir nuestro 博客 GitHub 页面

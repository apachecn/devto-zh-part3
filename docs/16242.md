...
> 原文:[https://dev.to/webdva/final-gemini-project-report-298g](https://dev.to/webdva/final-gemini-project-report-298g)
...
# [](#creating-3d-levels-with-metadata-using-blender)使用 Blender 使用元数据创建 3D 级别
...
## [](#creating-properties-for-the-objectsentities-in-a-3d-level)为 3D 级别的对象/实体创建属性
...
## [](#python-utility-for-exporting-entityproperty-mappings)用于导出实体-属性映射的 Python 实用程序
...
[![Click-to-move subsystem demonstration](../Images/2523a95bb16ed6b3e70af2be7e3cb3b0.png "Incorrect direction of travel in the click-to-move subsystem prototype")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--bO0kPdaA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/pymhhg7ovdr4efojqm6q.gif)

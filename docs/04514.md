...
> 原文:[https://dev . to/lexjacobs/installing-sendy-as-a-replacement-for-mailchimp-2019-version-4-update-the-complete-guide-with-49oc](https://dev.to/lexjacobs/installing-sendy-as-a-replacement-for-mailchimp-2019-version-4-update-the-complete-guide-with-49oc)

### [](#installing-sendy-as-a-replacement-for-mailchimp%E2%80%8A%E2%80%8A2019-version-4-update-the-complete-guide-with-automated-backups-to-s3-and-https-configuration)安装熊智娟作为 Mailchimp-2019 版本 4 更新的替代品，完整指南，自动备份到 S3，以及 https 配置

#### [](#this-information-is-compiled-from-many-sources-and-is-the-complete-record-of-my-successful-install-start-here-to-save-yourself-a-lot-of-time)这些信息是从许多来源收集的，是我成功安装的完整记录。从这里开始可以节省自己很多时间。
...
### [](#intro-and-motivation-for-the-change)变革的介绍和动机
...
[![](../Images/7e31b26d2f6a571c42ecd2715d89408c.png)T2】](https://cdn-images-1.medium.com/max/863/1*knqBax8wtKF8vVcupLhqGg.jpeg)
...
### [](#how-to%E2%80%8A%E2%80%8Astart-here)如何—从这里开始
...
### [](#sail-the-digitalocean-create-your-droplet-cloud-based-virtual-machine)航行数字海洋:创建你的水滴(基于云的虚拟机)
...
[![](../Images/d955bdc640699fba23da8e3569305a9e.png)T2】](https://cdn-images-1.medium.com/max/1024/1*D9a35tqzZqEbhA4Zxzh-ng.png)

下一个窗口将询问您:**将资源移动到新项目中？**点击**暂时跳过**

[![](../Images/512a853bfb36e82a3c78d7eb6d280999.png)T2】](https://cdn-images-1.medium.com/max/1010/1*ynuytaca0iVyMD8A9WS4MQ.png)

接下来，创建你的 droplet，我将在下面详细说明设置:

[![](../Images/ac384cefd4fcfdcd2439e4e6ff02d6a9.png)T2】](https://cdn-images-1.medium.com/max/536/1*Q86jeTB8V1ybHZy9XqvsEw.png)

单击蓝色按钮或绿色下拉菜单

[![](../Images/c5746b8fad8479e96a2712df410f7d95.png)](https://cdn-images-1.medium.com/max/628/1*eGpMmA8BWfLV859fdjy03w.png) 

<figcaption>点击水滴然后按照下面的说明进行设置</figcaption>

下一组选项是选择图像**。**选择市场

[![](../Images/84951e10faea287a22ca8242124bb946.png)](https://cdn-images-1.medium.com/max/1024/1*3VSjcXhWM8vk2xyBYWhMNQ.png) 
...
[![](../Images/cfbe38831ae07b4bef9e27004552035a.png)](https://cdn-images-1.medium.com/max/738/1*7k8tRHKAVv_5GjINRWPN9w.png) 

<figcaption>撰写时最新发布</figcaption>

[![](../Images/60f19159bf415141c63277aec21ce90f.png)](https://cdn-images-1.medium.com/max/1024/1*bLVE0BbvCK4_J8Kfo_hwsQ.png) 

<figcaption>选择标准计划</figcaption>

[![](../Images/86e9e49cba93b0c73ffaedaa2843cb9b.png)](https://cdn-images-1.medium.com/max/104/1*Fbiab4msR040mKAqbDitGg.png) 

<figcaption>选择左箭头查看更小的液滴尺寸</figcaption>

[![](../Images/976b079b3452d97619f53d6a80539e30.png)T2】](https://cdn-images-1.medium.com/max/372/1*4IaZyR9JWf9fpywsIuFxTg.png)
...
[![](../Images/b368363316306c09adf33be5fbfdca28.png)T2】](https://cdn-images-1.medium.com/max/704/1*Dqt8lg6sfrdtGHuNCqx8Gg.png)
...
[![](../Images/80f1edc2472bf87785a6426cd9dea8b0.png)T2】](https://cdn-images-1.medium.com/max/1024/1*jSBpKlGDqx6tY-534KCtvg.png)

点击“创建”按钮。然后你将被重定向到你的“项目”页面，并看到一个你的 droplet 创建进度的状态栏。需要几分钟。

[![](../Images/f307f50f9a34bbffa5b36b6e6d9d087a.png)T2】](https://cdn-images-1.medium.com/max/1024/1*Wy6kD5gCQd68DcSdaG9m3w.png)

成功创建后，您的登录详细信息和密码已通过电子邮件发送给您。

[![](../Images/f879fbc515d1e7e1fb0939d03436b5ce.png)T2】](https://cdn-images-1.medium.com/max/1024/1*EPhslJl3aKANZwfRPe-Z9w.png)

恭喜你，你的新创造正在云中运行。现在，通过在浏览器中输入 ip 地址来执行健全性检查，您应该会看到如下内容:

[![](../Images/794117148fb262b2447d8b51ef4c7c48.png)T2】](https://cdn-images-1.medium.com/max/1024/1*bWamT-2YYLby1oJgLO6N3g.png)

“快速”启动指南按钮[指向数字海洋网站上的这个文档](https://www.digitalocean.com/docs/one-clicks/lamp/#start)，它详细说明了您的一键安装包含哪些软件，以及一些配置信息。

#### [](#lets-log-into-the-new-droplet-and-set-it-up)让我们登录新的 droplet 并进行设置！
...
#### [](#update-the-list-of-available-software)更新可用软件列表
...
#### [](#upgrade-available-packages)升级可用包

# [](#aptget-upgrade)apt-get 升级
...
#### [](#next-create-new-virtual-host-files)接下来，创建新的虚拟主机文件
...
#### [](#create-the-directory-structure-for-the-files-to-be-served)为要服务的文件创建目录结构

```
# mkdir -p /var/www/contoso.com/public\_html 
```

#### [](#create-new-virtual-host-files)创建新的虚拟主机文件
...
#### [](#activate-the-virtual-host-file-and-deactivate-the-default-host-file)激活虚拟主机文件(并停用默认主机文件)
...
#### [](#reload-the-apache-server)重新加载 Apache 服务器
...
[![](../Images/10e9efa68484cf4e90ebd330cfc0df6e.png)T2】](https://cdn-images-1.medium.com/max/852/1*0hyK-SBJ57KhFMVwE5io3A.png)

这正是我们想要的。这是从标记内的 Options 指令中删除索引的结果。

**如果您看到类似这样的内容:**…

[![](../Images/8a69ccdba20a53f8b9ea2e45cc603771.png)T2】](https://cdn-images-1.medium.com/max/676/1*4AApNkI--SlfhmnN8u5T1w.png)

…然后选项指令没有正确更新。检查上面的语法。更正之后，用# systemctl reload apache2 重新启动 Apache

> 当您重新加载浏览器时，它应该会显示正确的禁止消息。这将防止公众在你安装熊智娟后窥视你的/uploads 文件夹。

#### [](#regarding-https-traffic-to-the-droplet)关于 HTTPS 交通的点滴
...
### [](#enable-https-with-ssp-certificate-installation-with-certbot)用证书机器人启用 HTTPS SSP 证书安装
...
[![](../Images/b611d0dbe23f5766bccba2032095a98a.png)](https://cdn-images-1.medium.com/max/172/1*8yQbWEAzfX2amtg6hxofwQ.png)T3】💥
...
### [](#installing-your-mysql-database)安装您的 Mysql 数据库
...
### [](#setting-up-your-sendy-configuration-file)设置您的熊智娟配置文件
...
### [](#uploading-sendy-to-your-server)上传熊智娟到你的服务器
...
[![](../Images/c7599dbbdc667286a4db769683c72107.png)](https://cdn-images-1.medium.com/max/1024/1*awTDewELFa5RTx1Byemuig.png)T3】💥

如果没有，也不用担心。您也可能会看到如下内容:

[![](../Images/79120ef4a2c7b36d9a0c0bac3d0aa4e7.png)T2】](https://cdn-images-1.medium.com/max/1024/1*Ube6hCFODiaYytYoKu8K6Q.png)

不用担心，不管缺什么，都很容易改正。按照说明，我们导航到:/_compatibility.php？i=1，看看需要安装什么。你的结果可能略有不同，但如果你从一开始就遵循这个指南，可能不会太多。

[![](../Images/ffb72e39283fc3e80eea5aa0a0dfaa06.png)](https://cdn-images-1.medium.com/max/818/1*Qkr327UIbw64Y5aPPpgoaQ.png)T3】🤔
...
[![](../Images/866c0dd4f6a45786459d33f9aecdc96d.png)](https://cdn-images-1.medium.com/max/698/1*21Ax0plWOoaGJ-8xbuMWtg.png)T3】😶
...
[![](../Images/132a440048d62673da3dd9a0fd56294f.png)T2】](https://cdn-images-1.medium.com/max/1024/1*vDgurnwxzJteeBkjnbqd0A.png)
...
[![](../Images/eab6ef67b83b5ae20e2fe56381a42c2f.png)T2】](https://cdn-images-1.medium.com/max/302/1*4ZkuvzQ6-zi9dH0lixfiIg.png)

如果您知道您不再处于“沙盒模式”，解决方法是进入/settings 并确保设置正确:

[![](../Images/7af6089d5fb72134e9aef7ecf8d2f040.png)](https://cdn-images-1.medium.com/max/580/1*HTm1NqUS7cj5x58JvAp7dA.png) 

<figcaption>撰写本文时 3 个可用地区选择</figcaption>

那还剩下什么？**让我们设置数据库的自动备份，并将备份自动传输到 AWS S3 容器中！**

### [](#things-go-wrong-protect-your-valuable-mailing-list-data-by-setting-up-automatic-backups-and-automating-cloud-storage-of-those-backups)事情不顺利。通过设置自动备份和自动云存储这些备份，保护您宝贵的邮件列表数据。

#### [](#setting-up-automatic-mysql-dumps)设置自动 Mysql 转储
...
[![](../Images/3c75ac40f3d6e5400cc31bbc261b742f.png)](https://cdn-images-1.medium.com/max/572/1*5hZGqnUmGduzmkN0wISlTQ.png) 
...
[![](../Images/deca11cd775fb2e5ed6bbfaef4ba0690.png)](https://cdn-images-1.medium.com/max/764/1*YzWjIvM9rA5appqDEAckbA.png)T3】点击带下划线的“下一步”展开显示
...
#### [](#setting-up-automatic-transfers-of-the-mysql-backups-to-the-s3-bucket)设置 Mysql 备份到 S3 存储桶的自动传输

首先，我们需要创建 AWS S3 存储桶，我们将把传输数据发送到这个存储桶中。从 S3 控制台，创建一个新的存储桶。区域是任意的，除非您有在特定区域托管数据的特定需求。

[![](../Images/77a333cd26e69ac1f01e8f949025923f.png)T2】](https://cdn-images-1.medium.com/max/308/1*XyIHLGHhOmF4_RcEmelwNA.png)

[![](../Images/39408dccfda3c85cc5785cc83575b579.png)](https://cdn-images-1.medium.com/max/428/1*jjVBZS3KEduXbxhOS3Gmrg.png) 

<figcaption>名称和地区设置</figcaption>

然后单击下一步

[![](../Images/881663596513dcdfeeae93e94c971833.png)T2】](https://cdn-images-1.medium.com/max/160/1*fSrH0qyEPr6JUuQoZGm0Ag.png)

我不需要在“配置选项”面板中做任何更改。

[![](../Images/f4e0b1aaceb4ab6b1bb48922f64a1483.png)](https://cdn-images-1.medium.com/max/197/1*BkukwiDOdcll9Sr5BNkdEA.png) 

<figcaption>再点击下一步</figcaption>

但是您需要适当地“设置权限”,以便能够上传到 bucket

[![](../Images/0d6b34779c0e8a081c1db3e88eaf3395.png)T2】](https://cdn-images-1.medium.com/max/169/1*rEDWhKmLq_NceOjKObx8gQ.png)

[![](../Images/bbeab5f583243f17f5990d07e27efddb.png)](https://cdn-images-1.medium.com/max/1024/1*iG3zDtqgqvW0azDZZOqEWA.png) 

<figcaption>取消选中所有这些选项</figcaption>

[![](../Images/96d8393bbb610405b7c1a7983f1f4217.png)T2】](https://cdn-images-1.medium.com/max/114/1*MeH7hagH2EUtdv2agpuXVg.png)

查看您的选项，然后按:

[![](../Images/9640f7b1207c22f321d96affb79426f1.png)T2】](https://cdn-images-1.medium.com/max/276/1*W-eW52bG5Tw6bdPi_aTt9Q.png)

[![](../Images/fd5329b25e6fe29f7ff5b86f53df9a48.png)T2】](https://cdn-images-1.medium.com/max/1024/1*FYtEgjGL237xW_HJ_Cq7DQ.png)

然后选择你的桶，选择**权限**，设置如下**访问控制列表:**

[![](../Images/bd4d810ef5aa624ed2142dcefd445d77.png)T2】](https://cdn-images-1.medium.com/max/996/1*YayL7V4CJJkDOtocQFiD7A.png)

[![](../Images/57e16ec8d783a8a21436af5579300f79.png)T2】](https://cdn-images-1.medium.com/max/340/1*NshnRDFD-YLVWMfUrBmxwQ.png)

[![](../Images/0615c7c5a5c9af1172ac4531402766bf.png)T2】](https://cdn-images-1.medium.com/max/717/1*DqJllc3TsdICu1UHZJcHCw.png)

[![](../Images/f85ae72ce4e7ca7d4cb1fb9f966d9a08.png)T2】](https://cdn-images-1.medium.com/max/520/1*ycP7kkYcZgMoCJgiRPilYw.png)

[![](../Images/c6bda519d3c118ff3bd16bc84bfbf4ac.png)](https://cdn-images-1.medium.com/max/1024/1*pSbdilPmxpMi-L9aXXwgnQ.png) 

<figcaption>【写对象】为所有人启用</figcaption>

然后选择“概述”选项卡并创建一个文件夹

[![](../Images/a63c1935c46c05dee65d9b92996c636e.png)T2】](https://cdn-images-1.medium.com/max/1013/1*YeVeq86o1ASEx-U04y_sOg.png)

[![](../Images/7d72f3c96f10b824d1efe05aff44feab.png)T2】](https://cdn-images-1.medium.com/max/160/1*xDgu2olMNPud0aC-KPHZ5g.png)

[![](../Images/74ecab7f969bc2c464837ae280ee17a2.png)T2】](https://cdn-images-1.medium.com/max/1024/1*2iEvsIE7RjRi7Yd1h7cJwQ.png)

将存储桶和文件夹名称放在手边，您很快就会用到它们。

这就是设置铲斗的全部内容。现在创建一个用户，并给他们适当的权限在您的存储桶中存储东西。

#### [](#setting-up-an-aws-user-in-iam-and-granting-them-permission-to-access-your-buckets)在 IAM 中设置 AWS 用户，并授予他们访问您的存储桶的权限

[![](../Images/006d9a859e05c9a74761f4ba0ce1c9ce.png)T2】](https://cdn-images-1.medium.com/max/438/1*IwspZylIJst2zVHs6XT4UQ.png)
...
[![](../Images/4c4cd1fc5c9a151bedb872732f460d7a.png)T2】](https://cdn-images-1.medium.com/max/109/1*vDoRHMhiY19FIiTjdoQAHg.png)

[![](../Images/e753ee6e03b0eeed097a4bf1782a22a6.png)T2】](https://cdn-images-1.medium.com/max/1024/1*3kjHx9aUjWjbLj-Eos2Bxw.png)

[![](../Images/ea3f25681b0dc5a9b992a57ac33b83ba.png)T2】](https://cdn-images-1.medium.com/max/196/1*IKH48fBirgqktYDrI1oeZw.png)

直接选择附加的现有策略

[![](../Images/924dd80d3e38298cefe0764b64fc8740.png)T2】](https://cdn-images-1.medium.com/max/804/1*fKMBZUPCtYrgyyBZxXs54Q.png)

在搜索框中输入:s3ReadOnly，并给用户 AmazonS3ReadOnlyAccess

[![](../Images/e24aa8e0c6bd0f0c4c860a43501c4eb9.png)T2】](https://cdn-images-1.medium.com/max/840/1*pOu54eDfbu9NtJgzCb05oA.png)

然后点击下一步:标签。我没有在这里输入任何内容。接下来，单击“下一步:审查”,如果一切正常，单击“创建用户”

[![](../Images/d2fa4acf4d67ea16804bba7561d16154.png)T2】](https://cdn-images-1.medium.com/max/127/1*btdKVLeHM8XdSBjtIo3IJg.png)

[![](../Images/bedf9205e367075fa4de5732763f848d.png)T2】](https://cdn-images-1.medium.com/max/147/1*Is-OA-HnhgwZEHBJnhOrNw.png)

[![](../Images/e29404bcdd85080e84248e235eb9cae7.png)T2】](https://cdn-images-1.medium.com/max/475/1*47ma5tdOVF99JX8GrjWeNA.png)

[![](../Images/c47c8fd81de209fca464bb02ecc6368f.png)T2】](https://cdn-images-1.medium.com/max/133/1*D03p3vYFHxxCchQ9BLtdFg.png)

记下访问密钥 Id 和秘密访问密钥值。您很快就会需要这些值，这是您可以访问秘密访问密钥的唯一时间，因此如果您以后需要该值，您必须为该用户创建一个新的密钥。

[![](../Images/c532a3b3c8ab01fcf1dd1df7d93a6a86.png)T2】](https://cdn-images-1.medium.com/max/902/1*VyDUok3zSRHN_SjAPN-d0g.png)

向终点冲刺！

#### [](#installing-aws-s3-utilities-on-your-droplet-to-handle-the-transfer-of-your-database-backups-to-the-s3-bucket)在您的 Droplet 上安装 AWS S3 实用程序，以处理您的数据库备份到 S3 存储桶的传输
...
[![](../Images/3fdc869485a24126a4dcd3536704546c.png)T2】](https://cdn-images-1.medium.com/max/1024/1*5xU_uKKipomxWncc4vQ1mA.png)
...
### [](#restoring-database-from-a-saved-backup)从保存的备份中恢复数据库
...
[![](../Images/352fdc03d38feea80cf6e9694a8eaf79.png)T2】](https://cdn-images-1.medium.com/max/318/1*f-SrhKJFVZ0egLpn5kit0Q.png)
...
### [](#lets-create-a-snapshot-of-the-droplet)让我们创建一个水滴的快照
...
[![](../Images/6708cbb36bdb10a3458c08a9a837a708.png)T2】](https://cdn-images-1.medium.com/max/106/1*yj4ZwLEYrsIGEtfwOj9vvA.png)

[![](../Images/3e81984bc70a1812050d71dd6d01f4f3.png)T2】](https://cdn-images-1.medium.com/max/116/1*N2H8RMKbQygr8BLb8olgIA.png)

单击“Snapshots”选项卡，为您的快照取一个合理的名称。然后单击拍摄快照，这将需要几分钟时间。

[![](../Images/4bb3c86c6e79251feabc20a17fffa4d3.png)T2】](https://cdn-images-1.medium.com/max/909/1*kmEnP_uDVq1f5H0eje455g.png)
...
[![](../Images/58de90e0fe065594206df79ccc566d78.png)T2】](https://cdn-images-1.medium.com/max/605/1*2CUtloFHlWA61O2ngW1m5Q.png)

***恭喜你，就是这样！*T3】**

### [](#please-comment-on-how-it-went-i-would-love-to-hear-how-your-process-went-and-if-this-guide-helped-you)请评论一下进行的如何！我很想听听你的过程如何，以及这个指南是否对你有所帮助。

...
> 原文:[https://dev . to/zim ski/a-little-of-elisp-to-improve-your-rails-testing-5fma](https://dev.to/zimski/a-little-of-elisp-to-improve-your-rails-testing-5fma)

## [](#why-spacemacs)为什么选择 spacemacs
...
## [](#testing-rails-inside-spacemacs-sucks)太空飞船内部测试轨道很烂
...
## [](#what-i-was-doing-before-the-help-of-elips)在得到 elips 的帮助之前，我在做什么
...
## [](#elisp-please-help-me-)Elisp，请帮帮我！
...
## [](#lets-explain-this-code)我们来解释一下这段代码

`(interactive)`:用`space space`
[![emacs call function](../Images/a6ab7563ade6e7f6a1a2f84ca3e6f0b0.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--YsHop4sd--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/kcocx45m3lkbq2zp1ji5.png) 使您的函数可调用
...
## [](#understand-the-code-by-yourself)自己理解代码
...
[![search for function](../Images/e07fbf834e685c1341df9d592d1868c3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--EZLHD7xF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/aowq9oo688wfpi4txxek.png)

哦看这个这个小可爱，打`enter`

[![the doc of the function](../Images/f649208372eae262d28622e04386beb1.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--n-_WiChf--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/jz0zxg7ktjyf2jacke2z.png) 
一切都有据可查！

现在让我们来看代码，将光标移到文件名上，然后点击 Enter
[![the code](../Images/8ee136b8cc26f32a5787cef5751889ee.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--PiCPhXOs--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/pyy2n44nr0aoh1200ivw.png)

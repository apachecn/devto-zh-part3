...
> 原文:[https://dev.to/vintharas/the-wizard-logs-第二部分-冒险-荣耀和不幸-写作-巫师-使用-vim-4hjm](https://dev.to/vintharas/the-wizard-logs---part-ii---the-adventures-glory-and-misfortunes-of-writing-wizards-use-vim-4hjm)
...
[![Introduction to Wizards Use Vim](../Images/db6034928641b63bde1af286e0b4b7d4.png "Introduction to Wizards Use Vim")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--mWjhXe2O--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.barbarianmeetscoding.com/images/wizards-use-vim-intro.jpg)

*   在前几章中，我已经添加了一些**代码样本和小练习**来帮助说明和强化概念。我希望他们是有趣的(和滑稽的),并将努力使他们更加有趣。下面是一个示例练习:

[![Wizards Use Vim sample exercise](../Images/1da63ff8fd24411a3bd8c1b69cc1f391.png "Wizards Use Vim sample exercise")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--wfbeawCT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.barbarianmeetscoding.com/images/wizards-use-vim-sample-exercise.jpg)
...
[![New Cover of Wizards Use VimCan't exit Vim](../Images/a149223747c49ce96070113c45fc6218.png "New Cover of Wizards Use Vim")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--UtLRr6zR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.barbarianmeetscoding.com/images/book-wizards-use-vim-draft-004.jpg)

我改进了颜色、灯光、祖母绿、背景，尝试了不同的皮革颜色。我还把 Vim 金属色作为最初的标志，但现在这件作品感觉不如以前和谐了。我需要重新考虑和实验。

[![Vim's core motions hjkl](../Images/8c29250dac6ba681b97ce07313cf4698.png "Vim's core motions")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--UnZF4m3G--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.barbarianmeetscoding.com/images/wizardsusevim-motions-hjkl.jpg)

耶！我已经改进了书法，无论是在主要艺术还是在脚本评论中。Wiho！

## [](#some-cool-ideas)一些很酷的想法
...
> ### [](#how-to-create-your-own-key-mappings-in-vim)如何在 Vim 中创建自己的键映射
> 
...
## [](#some-concerns-that-i-have)我有些担忧
...
## [](#random-pieces-of-advice-and-thoughts)乱七八糟的建议和想法

我开始用我的 iPad 用 iBooks 和 Apple pen 来评论这本书，我被这种美妙的体验震撼了。首先，把这本书看作是**的一本书**是非常值得的。第二，记笔记，圈圈东西，涂鸦，是一种不可思议的快乐:

[![Reviewing Wizards Use Vim on the iPad](../Images/ce0e6c3b14061f8ccadc042d151efe36.png "Reviewing Wizards Use Vim on the iPad")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--VXO48ath--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.barbarianmeetscoding.com/images/wizards-use-vim-reviewing.jpg)

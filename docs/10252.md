...
> 原文:[https://dev . to/sema text/a-crash-course-on-server less-with-AWS-centralized-logging-with-kinesis-and-lambda-ik7](https://dev.to/sematext/a-crash-course-on-serverless-with-aws-centralized-logging-with-kinesis-and-lambda-ik7)
...
## [](#using-cloudwatch-for-logs)使用 CloudWatch 获取日志
...
[![image4](../Images/1fef6f8d9628f780ba08cf7b2401bb23.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--o_Cenjk8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://github.com/adnanrahic/cdn/raw/master/centralized-logging-with-kinesis-lambda/cloudwatch-log.png) 让我们退一步，看看更大的图景。每个函数都会在 CloudWatch 中创建一个叫做**日志组**的东西。单击特定的日志组。

[![image3](../Images/4943c6e7ebdc725e70f4ffdf00b24270.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--p4J50zEF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://github.com/adnanrahic/cdn/raw/master/centralized-logging-with-kinesis-lambda/cloudwatch-log-groups.png)

这些日志组将包含**日志流**，这些日志流在字面上等同于来自特定功能实例的日志事件。

[![image2](../Images/fe07b25dab3e2a0782b7127245d3157c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--llyVdWtN--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://github.com/adnanrahic/cdn/raw/master/centralized-logging-with-kinesis-lambda/cloudwatch-log-streams.png)
...
## [](#creating-a-centralized-logging-solution)创建集中式日志记录解决方案
...
[![image6](../Images/6cf35106f3584c66202221ec272bdc4c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--PC4lqzdW--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://github.com/adnanrahic/cdn/raw/master/centralized-logging-with-kinesis-lambda/sematext-logsene-shipped.png)

比 CloudWatch 漂亮多了，而且实际上可以找到你要找的东西！

### [](#setting-up-the-serverless-project)设置无服务器项目

首先安装无服务器框架，配置您的 IAM 用户，并创建一个新项目。完整指南可以在 [](https://hackernoon.com/a-crash-course-on-serverless-with-node-js-632b37d58b44#422a) [这里找到](https://hackernoon.com/a-crash-course-on-serverless-with-node-js-632b37d58b44#422a)。
...
[![image1](../Images/fa28ad25d564946c3f4c213f20aa67cf.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--MyCjnLcE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://github.com/adnanrahic/cdn/raw/master/centralized-logging-with-kinesis-lambda/sematext-logsene.png)

添加应用程序名称和一些基本信息后，您会看到一个*等待数据*屏幕弹出。按下**集成向导**并复制您的令牌。

[![image5](../Images/53970406ecdb0e8c93a637a2b4df3505.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--FTlE9JT9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://github.com/adnanrahic/cdn/raw/master/centralized-logging-with-kinesis-lambda/sematext-token.png)
...
### [](#adding-the-subscriber-function)添加订户功能
...
### [](#adding-the-shipper-function)添加发货人功能
...
### [](#deploy-and-test-your-centralized-logging-solution)部署并测试您的集中式日志记录解决方案

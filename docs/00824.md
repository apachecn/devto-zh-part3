...
> 原文:[https://dev.to/delbussoweb/mongodb-rest-api-24np](https://dev.to/delbussoweb/mongodb-rest-api-24np)
...
#### [](#conectando-com-o-mongodb)连接蒙戈布
...
### [](#mas-e-o-spoiler-que-voc%C3%AA-prometeu)但是你答应的扰流板呢？

...
> 原文:[https://dev . to/lambdatest/fixing-JavaScript-跨浏览器-兼容性-问题-51pl](https://dev.to/lambdatest/fixing-javascript-cross-browser-compatibility-issues-51pl)
...
## [](#deep-diving-into-javascript)深度潜入 JavaScript
...
## [](#common-javascript-problems)常见 JavaScript 问题
...
[![](../Images/de867c0facb10da2f1390b374aa0c73b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--4pb5Ebgi--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2726/0%2ADmvIs2FqqkgJHyUu.jpg)
...
[![](../Images/eb860a1c468152e9faabedbc1158fae6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---R8Dn51q--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2000/0%2A5g9ehjQEBRWD3nun.png)

*   不正确地使用“循环内部的函数”,从而导致功能中断。

## [](#common-cross-browser-javascript-problems)常见的跨浏览器 JavaScript 问题
...
## [](#using-user-agents-and-browser-sniffing)使用用户代理和浏览器嗅探

每个浏览器都有一个用户代理字符串，用于标识用户用来访问您的网站/web 应用程序的浏览器。开发者使用**浏览器嗅探代码**来根据用户使用的浏览器调整 UI/UX/功能。下面提到了一些常见的用户代理字符串。

[![](../Images/04b2fb3e1773101dddf82283dbf2e985.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--wv68VPC8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2000/0%2Afb8xrHyQ1FScJFDW.jpg)

开发人员可以使用 navigator . user agent . index of(' user-agent ')，其中 user-agent 是用户代理字符串(如上表所述)。下面是一个代码的快照，开发者可以根据浏览器的类型来开发功能。

[![](../Images/e1d436d2e4b2e4b48baac19f2ba6e176.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--YLyDS8MU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2000/0%2AmlzRfswtsnBUou4i.jpg)

## [](#feature-detection-for-modern-javascript-features)针对现代 JavaScript 特性的特性检测
...
[![](../Images/56f91748e2d6ffce5820ffafc71007f6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--nGjp5waP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2690/0%2A6gZoncIyfA_ELLif.png)
...
[![](../Images/76a940b4f61b8229208f0d73a3c8c72d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--gX7UUOUt--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2000/0%2AvOHSaw0sdJYYDOqf.png)
...
[![](../Images/ff0a1f76b874f606fd0ad84a3b456622.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--1sEA9BH3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2000/0%2AxKIJfFpET-njYr7k.png)
...
[![](../Images/83b0f6f0a8a12c3458825372fbbedbea.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Pz6B-8Yg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2732/0%2AQqAWKSGPBelIOvHm.jpg)

开发人员还可以在开发阶段使用控制台 API 来打印日志。建议将不同种类的控制台日志用于不同的目的。例如，console.log()可用于调试，console.assert()可用于发布断言，console.error()可用于错误场景。

## [](#code-editor-plugins)代码编辑器插件
...
[![](../Images/7954a93e25fbcd11e70838fb5777a18a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--J4sd0fXv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2456/0%2AFd8rDGZ7Ch__pITx.jpg)
...
[![](../Images/76d0bdb4a5855b515d185c79c62ae530.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--QS1LIYhy--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2258/0%2AORTUltWSxlFP1wup.jpg)

## [](#solving-general-javascript-issues)解决一般的 JavaScript 问题
...
## [](#javascript-framework-for-overcoming-cross-browser-compatibility-issues)克服跨浏览器兼容性问题的 Javascript 框架

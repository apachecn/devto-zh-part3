...
> 原文:[https://dev . to/freekmurze/preventing-spam-submitted-through-forms-c9j](https://dev.to/freekmurze/preventing-spam-submitted-through-forms-c9j)

当向公共网站添加表单时，存在垃圾邮件机器人试图用假值提交表单的风险。我们最近发布了一个名为 [laravel-honeypot](https://github.com/spatie/laravel-honeypot) 的新包，可以检测这些垃圾请求。

## [](#how-honeypots-work)蜜罐如何工作

...
> 原文:[https://dev . to/the Karel/implementing-release-toggles-with-app knobs-react-CLI-3b 06](https://dev.to/thekarel/implementing-release-toggles-with-appknobs-react-cli-3b06)

<small>首发于[appknobs.io/blog](https://appknobs.io/blog/implementing-release-toggles-with-react-and-cli)T3】</small>

## [](#lets-add-a-release-toggle)让我们添加一个释放开关
...
## [](#create-a-new-project-optional)创建新项目(可选)
...
## [](#feature-flag-autodiscovery)特征标志自动发现
...
## [](#wrap-your-app-in-raw-ltappknobsgt-endraw-)把你的 app 包在`<Appknobs>`
...
[![yay feature visible](../Images/85b5cb39ea58ad3d322f99452605e818.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--N6UvB9Y2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/52urbdknj47hc05ol50f.png)

...
> 原文:[https://dev . to/oktadev/build-a-microservice-architecture-with-spring-boot-and-kubernetes-3j3k](https://dev.to/oktadev/build-a-microservice-architecture-with-spring-boot-and-kubernetes-3j3k)
...
## [](#requirements-for-spring-boot-and-kubernetes)对 Spring Boot 和库伯内特的要求
...
## [](#create-a-google-kubernetes-engine-project-with-istio)用 Istio 创建一个 Google Kubernetes 引擎项目
...
## [](#create-a-spring-boot-project-for-your-microservices)为您的微服务创建一个 Spring Boot 项目
...
## [](#deploy-the-mongodb-kubernetes-pod-for-your-spring-boot-app)为您的 Spring Boot 应用程序部署 MongoDB Kubernetes Pod
...
## [](#deploy-the-spring-boot-app-to-the-cluster)将 Spring Boot 应用部署到集群
...
## [](#test-the-deployed-google-kubernetes-engine-spring-boot-app)测试部署的 Google Kubernetes 引擎+ Spring Boot App
...
## [](#create-an-openid-connect-app-on-okta)在 Okta 上创建 OpenID Connect App
...
## [](#build-a-new-docker-image-and-push-to-the-gke-cluster)构建新的 Docker 映像并推送到 GKE 集群
...
## [](#generate-a-jwt-and-test-oauth-20)生成 JWT 并测试 OAuth 2.0
...
## [](#move-forward-with-spring-boot-microservices-and-kubernetes)与 Spring Boot 微服务和 Kubernetes 一起前进

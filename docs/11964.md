...
> 原文:[https://dev.to/jolvera/user-authentication-with-nextjs-4023](https://dev.to/jolvera/user-authentication-with-nextjs-4023)
...
### [](#login-page-and-authentication)[登录页面和认证](#login-page-and-authentication)
...
### [](#profile-page-and-authorization)[简介页面和授权](#profile-page-and-authorization)
...
#### [](#authorization-helper-function)[授权助手功能](#authorization-helper-function)
...
#### [](#authorization-high-order-component)[授权高阶组件](#authorization-high-order-component)
...
#### [](#page-component-with-authorized-requests)[页面组件带有授权请求](#page-component-with-authorized-requests)
...
### [](#logout-and-session-synchronization)[注销并会话同步](#logout-and-session-synchronization)
...
## [](#local-development)[地方发展](#local-development)

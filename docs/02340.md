...
> 原文:[https://dev . to/Levi VM/coding-best-practices-chapter-one-functions-4n 15](https://dev.to/levivm/coding-best-practices-chapter-one-functions-4n15)

我的目的不是说写代码的最好方法是什么，一些程序员有他们的方法，他们很好。我只是想和其他人分享我认为的代码最佳实践，以及如何改进几个方面，如就绪性、结构、组件、意义、调试、重构等。

# [](#chapter-1-functions)第一章:功能
...
## [](#sections-within-functions)函数内的节

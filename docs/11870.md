...
> 原文:[https://dev . to/awwsmm/Java-infer-column-widths-of-a-fixed-width-text-file-2hh 0](https://dev.to/awwsmm/java-infer-column-widths-of-a-fixed-width-text-file-2hh0)

## [](#delimited-files-and-fixedwidth-files)分隔文件和定宽文件
...
## [](#read-a-text-file-into-a-raw-listltstringgt-endraw-)将一个文本文件读入一个`List<String>`
...
## [](#count-the-number-of-nonwhitespace-characters-per-character-column)统计每个字符列中非空白字符的数量

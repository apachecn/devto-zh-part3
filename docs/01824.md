...
> 原文:[https://dev.to/ayelishaamoah/effective-debugging-5hd9](https://dev.to/ayelishaamoah/effective-debugging-5hd9)

### [](#what-is-a-bug)什么是 bug？
...
### [](#what-does-a-good-debugging-process-look-like)好的调试流程是什么样子的？

#### [](#1-tighten-the-loop)1。收紧环
...
#### [](#2-get-visibility-on-the-error)2。获得错误的可见性
...
#### [](#3-make-a-change-and-run-a-test)3。做出改变并运行测试

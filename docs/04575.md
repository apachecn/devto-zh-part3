...
> 原文:[https://dev . to/shavz/sending-multipart-form-data-using-spring-webtest client-2gb 7](https://dev.to/shavz/sending-multipart-form-data-using-spring-webtestclient-2gb7)
...
## [](#web-form-testing-with-webflux)用 Webflux 进行 Web 表单测试
...
[![](../Images/5cfb7f5feaa6eee1f742d59a02f0b81c.png)T2】](https://i.giphy.com/media/l0ErKDci4GgPkcAF2/giphy.gif)

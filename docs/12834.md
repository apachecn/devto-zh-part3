...
> 原文:[https://dev . to/renegade coder 94/how-to-check-if-a-file-exists-in-python-11om](https://dev.to/renegadecoder94/how-to-check-if-a-file-exists-in-python-11om)
...
### [](#check-if-a-file-exists-with-a-try-block)用 Try 块检查文件是否存在
...
### [](#check-if-a-file-exists-with-os-path)检查操作系统路径下是否存在文件
...
### [](#check-if-a-file-exists-with-a-path-object)检查文件是否存在路径对象

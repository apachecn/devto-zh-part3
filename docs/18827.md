...
> 原文:[https://dev . to/block stack/block stack-authentic ation-server-side-nodejs-3em 2](https://dev.to/blockstack/blockstack-authentication-server-side-nodejs-3em2)
...
### [](#catch%E2%80%8A%E2%80%8Aclock-skew-)* *Catch —时钟偏斜**

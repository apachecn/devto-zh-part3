...
> 原文:[https://dev . to/Helen Anders 26/AWS-series-which-ec2-is-right-for-you-3f 83](https://dev.to/helenanders26/aws-series-which-ec2-is-right-for-you-3f83)

Amazon EC2 在云中提供虚拟机，您只需为使用的存储量付费。您可以在满足不同用例的几种实例类型中进行选择。

* * *

## [](#what-do-the-letters-and-numbers-mean)字母和数字是什么意思？

[![EC2](../Images/8f1da25cb428d0f50a614f2815d44c9e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--FdPcU1XI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ipt4wuy6izwh2fsqajvg.png)
...
## [](#how-do-i-pick-an-instance-type)我如何挑选一个实例类型？

[![EC2a](../Images/4e8d2a1fc2c8b89696b4c1152995e417.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ZUfIcHEJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/a26fbwmmkw7yece553qf.PNG)
...
## [](#what-are-the-storage-options)有哪些存储选项？
...
## [](#how-does-security-work)安全是如何工作的？
...
[![totalcloudio](../Images/d9dc6438706387fccfbb89f09b7705f0.png)](/totalcloudio) [## AWS 安全组的 5 个不容忽视的最佳实践

...
> 原文:[https://dev . to/nab bisen/OpenSSH-configuration-to-keep-connection-alive-to-suppress-time out-3pa 6](https://dev.to/nabbisen/openssh-configuration-to-keep-connection-alive-to-suppress-timeout-3pa6)
...
[![openssh-logo](../Images/fc9efd1da5e5b65a008dc51b16a1673e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--d6rOTH5B--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://www.openssh.com/images/openssh.gif)
...
# [](#case-1-configuration-in-a-client)情况 1:在客户端配置
...
# [](#case-2-configuration-in-a-server)情况 2:服务器中的配置

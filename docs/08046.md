...
> 原文:[https://dev . to/pigozzifr/how-to-store-relational-data-inside-redux-el6](https://dev.to/pigozzifr/how-to-store-relational-data-inside-redux-el6)

[![](../Images/edfc777a88785f9b77b2fd31d58d9804.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Ux-xT9Nj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/wete0e9ivdsi5wjj6zm9.jpg)
...
## [](#an-inefficient-structure)低效的结构
...
## [](#an-efficient-structure)一个高效的结构
...
## [](#bonus-how-to-structure-selectors)加成:如何构造选择器

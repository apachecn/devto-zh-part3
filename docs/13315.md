...
> 原文:[https://dev . to/wes Grimes/auto-remove-all-unused-imports-in-a-typescript-project-19c 7](https://dev.to/wesgrimes/auto-remove-all-unused-imports-in-a-typescript-project-19c7)

[![Ultimate Courses](../Images/fe3747739b9b235e31105565d22ff033.png)T2】](https://ultimatecourses.com/topic/typescript/ref/wes.grimes/ "Ultimate Courses")
...
## [](#create-a-temporary-raw-tslint-endraw-config-file)创建一个临时的`tslint`配置文件
...
## [](#run-the-autofix-process)运行自动修复过程
...
## [](#doublecheck-your-files)仔细检查你的文件

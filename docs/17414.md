...
> 原文:[https://dev.to/lowmess/functional-first-accordions-4opn](https://dev.to/lowmess/functional-first-accordions-4opn)
...
## [](#the-beauty-is-in-the-details)美在细节
...
## [](#enchanting-progressive-enhancement)妖娆渐次增强
...
### [](#package-the-accordion-into-a-reusable-component)将 Accordion 封装成可重用的组件

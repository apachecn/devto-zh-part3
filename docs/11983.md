...
> 原文:[https://dev.to/gulshansaini/automate-npm-versioning-29k5](https://dev.to/gulshansaini/automate-npm-versioning-29k5)
...
[![React release](../Images/a24952f6cf925687a371dba9f7de0cce.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--IeQjGfHw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/gmuqogkaihicxp6991ih.png)

## [](#what-is-semantic-version)什么是语义版？
...
## [](#automate-semantic-version-with-npm-cli)用 npm cli 自动化语义版本？
...
### [](#lets-begin-by-creating-patch-release)让我们从创建补丁发布开始
...
### [](#now-lets-create-minor-release)现在，让我们创建次要版本
...
### [](#finally-lets-create-major-release)最后，让我们创建主要版本

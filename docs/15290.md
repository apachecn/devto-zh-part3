...
> 原文:[https://dev . to/juperala/review-your-test-automation-code-271 a](https://dev.to/juperala/review-your-test-automation-code-271a)
...
# [](#things-to-look-out-in-code-review)代码评审中需要注意的事情
...
## [](#issues-specific-to-test-code)特定于测试代码的问题
...
### [](#sleeps-and-fixed-delays)休眠和固定延迟
...
### [](#hardcoded-values-and-configurations)硬编码值和配置
...
### [](#wrong-level-of-abstraction)错误的抽象层次

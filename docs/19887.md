...
> 原文:[https://dev.to/gugadev/react-hooks-国家-5g64](https://dev.to/gugadev/react-hooks---state-5g64)

# [](#react-hooks-state)反应钩子-状态
...
### [](#qu%C3%A9-es-react-hooks)Qué es 反应钩？
...
## [](#hook-raw-usestate-endraw-)钩子`useState`

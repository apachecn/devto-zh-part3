...
> 原文:[https://dev . to/baran su/first-reason ml-production-app-learned-l3o](https://dev.to/baransu/first-reasonml-production-app-lessons-learned-l3o)
...
## [](#1-dont-be-afraid-of-bindings)1。不要害怕捆绑
...
## [](#2-render-props-using-letanything-and-bsepitath-are-awesome)2。渲染道具，用 let-everything 和 bs-epitath，很牛逼
...
## [](#3-create-more-modules-hiding-your-implementation-details)3。创建更多隐藏实现细节的模块。
...
## [](#4-reactnavigation-is-hard-but-with-reason-its-not-that-hard)4。反应——导航很难，但如果理智的话，也没那么难
...
## [](#5-dont-be-afraid-of-polymorphic-variants)5。不要害怕多态变体。
...
## [](#community-is-great-opensource-is-great)社区很棒，开源也很棒！

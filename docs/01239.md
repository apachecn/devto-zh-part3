...
> 原文:[https://dev . to/Laura gift 21/love-at-second-sight-with tailwindcss-23dc](https://dev.to/lauragift21/love-at-second-sight-with-tailwindcss-23dc)
...
[![tailwind](../Images/51537a1362c4d6cbd1535c583e4a854d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--mT4O6FSA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://res.cloudinary.com/lauragift/image/upload/v1558984626/image_preview_s8bbns.png)

## [](#introduction)简介

TailwindCSS 是一个实用的 CSS 框架，用于构建定制的用户界面设计。它是一个高度可定制的低级 CSS 框架，为您提供了构建定制设计所需的所有构件，而没有您必须努力克服的任何恼人的固执己见的风格。

## [](#why-tailwindcss)为什么是 TailwindCSS？
...
#### [](#using-tailwindcss-cli)使用 TailwindCSS CLI
...
### [](#example-1-creating-a-card)例 1:创建卡片
...
[![card](../Images/ecebaf5c7d1b73ffe8f1c5d3f791b804.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--M7q_G5QM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/0sxm0lavhep6rxvaufk0.png) 
下面是卡示例的 codepen 链接。
...
### [](#example-2-custom-buttons)例 2:自定义按钮
...
[![button](../Images/70104af0562f7c9b6abe337a6261c674.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9YdQJuyN--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/lisvz2yc589jn50xht4e.png)
...
## [](#extracting-utility-classes-as-components)提取工具类作为组件

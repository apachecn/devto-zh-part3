...
> 原文:[https://dev . to/baens/making-inspec-with-ssh-work-with-packer-on-the-Google-cloud-platform-16gm](https://dev.to/baens/making-inspec-with-ssh-work-with-packer-on-the-google-cloud-platform-16gm)
...
# [](#solving-problem-1-getting-the-ip-of-the-packer-vm-in-gcp)解决问题 1:获取 GCP 打包虚拟机的 IP
...
# [](#solving-problem-2-communicating-over-ssh)解决问题 2:通过 SSH 进行通信
...
# [](#the-resulting-packer-file-and-the-test-run)由此产生的打包文件和测试运行
...
[![Demo of the build](../Images/ebc171cca0674ab193930fd6fd776c86.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--UiIn9ByH--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://blog.baens.net/images/cloud-build.gif)

[链接到构建的 gif，开发到](https://blog.baens.net/images/cloud-build.gif)时出现了问题

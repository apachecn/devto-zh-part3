...
> 原文:[https://dev.to/brightdevs/i-am-hooked-on-react-1b6l](https://dev.to/brightdevs/i-am-hooked-on-react-1b6l)
...
# [](#react-hooks-restrictions)反应钩子限制
...
# [](#class-base-component-will-be-no-more-support)类基础组件将不再被支持？

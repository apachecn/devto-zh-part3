...
> 原文:[https://dev.to/johannestegner/docker-简介-1dde](https://dev.to/johannestegner/docker---introduction-1dde)
...
### [](#retrieving-prebuilt-images)检索预建图像
...
### [](#further-down-the-rabbit-hole)进一步深入兔子洞

...
> 原文:[https://dev . to/vzhou 842/can-you-find-the-bug-in-this-code-2k0h](https://dev.to/vzhou842/can-you-find-the-bug-in-this-code-2k0h)
...
## [](#wait-you-had-this-bug-once)等等，你也有过这种 bug？

没错。

## [](#why-would-you-ever-write-code-with-so-many-immediately-invoked-function-expressions-iife)为什么你要写这么多直接调用函数表达式的代码([life](https://developer.mozilla.org/en-US/docs/Glossary/IIFE))？

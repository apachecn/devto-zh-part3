...
> 原文:[https://dev . to/we make-services/announcing-dotenv-linter-a-tool-to-lint-your-env-files-3m1g](https://dev.to/wemake-services/announcing-dotenv-linter-a-tool-to-lint-your-env-files-3m1g)

我很高兴地宣布一个简单但非常有用的工具来 lint 你的`.env`文件。

## ![GitHub logo](../Images/a73f630113876d78cff79f59c2125b24.png)[we make-services](https://github.com/wemake-services)/[dotenv-linter](https://github.com/wemake-services/dotenv-linter)
...
[![wemake.services](../Images/af5f15014c9d41f5c2e76d01102852a9.png)](https://wemake.services)[![Build Status](../Images/b4c9d9c50f0bde6fd8f3b855d522d797.png)](https://github.com/wemake-services/dotenv-linter/actions?query=workflow%3Atest)[![codecov](../Images/0aeb9a07837a86b05e2732eae57cd0ed.png)](https://codecov.io/gh/wemake-services/dotenv-linter)[![Github Action](../Images/9190e6608b302a24e55a616e3459c350.png)](https://github.com/wemake-services/dotenv-linter/actions?query=workflow%3Adotenv)[![Python Version](../Images/f3cc9b539bd1e25c06eb511592db7947.png)](https://pypi.org/project/dotenv-linter/)[![Documentation Status](../Images/e28e5bbd7c044c41f513e92295a90275.png)](https://dotenv-linter.readthedocs.io/en/latest/?badge=latest)

* * *

用于`.env`文件的简单 linter。

[![dotenv-logo](../Images/c3f9d7c5ea5c4428afa20f344f3b954f.png)T2】](https://raw.githubusercontent.com/wemake-services/dotenv-linter/master/docs/_static/dotenv-logo@2.png)

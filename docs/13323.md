...
> 原文:[https://dev.to/revent/graphql-with-absinthe-59kb](https://dev.to/revent/graphql-with-absinthe-59kb)
...
## [](#gotcha-1-everything-is-a-field)骗到 1:一切都是场。
...
## [](#gotcha-2-fields-can-also-be-complex-structures-list-map)问题 2:字段也可以是复杂的结构(列表、映射)
...
### [](#gotcha-21-fields-can-also-be-complex-structures)明白 2.1:字段也可以是复杂的结构

...
> 原文:[https://dev . to/azure/start-contributed-to-nodejs-in-the-new-year-3d LH](https://dev.to/azure/start-contributing-to-nodejs-in-the-new-year-3dlh)

Node.js 项目是一个庞大的社区项目，涵盖 Node.js GitHub 组织中的 162 个存储库，不包括 Express 和 libuv GitHub 组织(这两个组织都是 Node.js 基金会下的项目)。

[![This is what it feels like sometimes when working in the Node.js GitHub org – caption: GIF of a file cabinet opening much further than it should](../Images/eb13074c51772f4a1101ecfa54fe6794.png)T2】](https://i.giphy.com/media/SuEFqeWxlLcvm/giphy.gif)
...
### [](#additional-context-about-the-organization)关于组织的附加上下文
...
## [](#contributing-to-wgs-initiatives-and-teams)为工作组、计划和团队做出贡献

Node.js 项目的各个部分的贡献者比他们需要的要少，并且总是在寻找更多的贡献者。

[![We need your help! caption: GIF of Daya from "Don't Let Me Down" by the Chainsmokers](../Images/90877dbac626dd94b62fe9e9c978d70d.png)T2】](https://i.giphy.com/media/l42Pz6bumqF4MpPWM/giphy.gif)
...
## [](#contributing-through-content)通过内容投稿
...
## [](#contributing-through-automation)通过自动化做出贡献
...
[![Please let the machines take over! caption: illustrated robots happy that machines have taken over](../Images/28036710ffb84e6cd9a618c92f94d210.png)T2】](https://i.giphy.com/media/4TtTVTmBoXp8txRU0C/giphy.gif)
...
[![Whatever happens, we're in this together! caption: GIF from The Next Step of "Together? Together."](../Images/284fa225386ebf1fa50153704e5d1c48.png)T2】](https://i.giphy.com/media/xT1R9Duym3N3mQL6aQ/giphy.gif)**
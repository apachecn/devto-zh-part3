...
> 原文:[https://dev . to/trends chau/creating-a-block-editor-with-markdown-and-vuejs-o14](https://dev.to/trendschau/creating-a-block-editor-with-markdown-and-vuejs-o14)
...
[![Block editing with markdown](../Images/5461e5bd948b75cc2691cc9af0655110.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--lRNi6AZ1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://typemill.net/media/demo-2.gif)
*typemill block 编辑截止 2018 年 11 月*

这是一个相当大的项目，所以我不能在这里展示太多的代码，但也许有一些关于 markdown 的块编辑的基本思想。

## [](#markdown-are-blocks-by-definition)根据定义降价是区块
...
[![Image Component of Typemill](../Images/1b09fec4f43bdd9835e0a30d205d9f41.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ljdP5yO0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://typemill.net/media/live/5c0a48b44a765-live.gif)

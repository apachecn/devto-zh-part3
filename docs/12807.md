...
[![](../Images/1bd0ac1637f02022dd1e396fcf52dac5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--6-y98ZLK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/tz0i2zy07vl7avbwnwzn.gif)
...
## [](#graphql-editor)GraphQL 编辑器

GraphQL 编辑器让理解 GraphQL 模式变得更加容易。通过链接可视块来规划模式，GraphQL 编辑器会将它们转换成代码。

[![](../Images/fbe940de7d89e024d4d807475811a937.png)T2】](https://graphqleditor.com/)
...
## [](#query-colocation)查询主机代管

GraphQL 最佳实践之一，将 GraphQL 查询放在与 app 组件的视图逻辑相同的位置。

## [](#query-whitelisting)查询白名单
...
## [](#schema-definition-language-sdl)模式定义语言(SDL)

...
> 原文:[https://dev . to/kball/Friday-frontend-diversion-into-design-edition-29nj](https://dev.to/kball/friday-frontend-diversion-into-design-edition-29nj)
...
##### [](#css-animation-101)[CSS 动画 101](https://github.com/cssanimation/css-animation-101)

一本关于 CSS 动画的优秀、全面的电子书，在 github 上免费发布。网页版也有很多 codepens 的链接，所以你可以点击试试。太好了！

##### [](#dry-switching-with-css-variables-the-difference-of-one-declaration)[用 CSS 变量干切换:一次声明的区别](https://css-tricks.com/dry-switching-with-css-variables-the-difference-of-one-declaration/)
...
##### [](#create-a-css-grid-image-gallery-with-blur-effect-and-interaction-media-queries)[创建 CSS 网格图库(带模糊效果和交互媒体查询)](https://webdesign.tutsplus.com/tutorials/create-a-css-grid-image-gallery-with-blur-effect-and-interaction-media-queries--cms-32287)

我对交互媒体查询知之甚少，但它们对本文探索的用例完全有意义:在悬停无意义的触摸屏设备上以不同的方式显示“悬停”内容。他们也有很好的浏览器支持。

#### [](#javascript)JavaScript

##### [](#typescript-type-predicates)[类型脚本:类型谓词](https://fettblog.eu/typescript-type-predicates/)
...
##### [](#react-16x-roadmap)[React 16.x 路线图](https://reactjs.org/blog/2018/11/27/react-16-roadmap.html)

世界上最流行的前端框架正在开发一些非常酷的东西。到现在为止，你们可能都听说过钩子，但是我认为即将到来的并发模式至少同样有趣。能够在主线程之外呈现复杂的组件将是用户体验的一大进步，尤其是在 cpu 速度较慢的移动设备上。

##### [](#comparing-javascript-http-requests-libraries-for-2019)[对比 2019 年 JavaScript HTTP 请求库](https://blog.bitsrc.io/comparing-http-request-libraries-for-2019-7bedb1089c83)
...
##### [](#a-complete-guide-to-routing-in-angular)[角状路由完全指南](https://www.smashingmagazine.com/2018/11/a-complete-guide-to-routing-in-angular/)
...
##### [](#just-use-focus-styles-damnit)[只需使用:焦点招式，该死](https://gomakethings.com/just-use-focus-styles-damnit/)
...
##### [](#difficulty-is-not-a-ux-dirty-word)[难度不是 UX 脏字](https://usabilitygeek.com/difficulty-not-ux-dirty-word/)
...
##### [](#microsoft-is-building-a-chromiumpowered-web-browser-that-will-replace-edge-on-windows-10)[微软正在开发 Chromium 浏览器，将取代 Windows 10 上的 Edge](https://www.windowscentral.com/microsoft-building-chromium-powered-web-browser-windows-10)
...
##### [](#consolerules)[Console.rules(💪)](https://itnext.io/console-rules-b30560fc2367)

...
> 原文:[https://dev . to/harshadranganathan/windows-subsystem-for-Linux-wsl-on-windows-10-4fi](https://dev.to/harshadranganathan/windows-subsytem-for-linux-wsl-on-windows-10-4fi)
...
## [](#install-linux-distribution)安装 Linux 发行版

1.  打开微软商店，选择您喜欢的 Linux 发行版。
2.  从发行版的页面中，选择“Get”来安装发行版。

[![](../Images/9747f611eb8e2114ed639666a687ce46.png)T2】](https://rharshad.com/assets/img/2019/03/ubuntu-windows-store.png)

如果您的公司策略禁止从 Microsoft store 安装，您可能会得到以下错误。

在这种情况下，[下载](https://docs.microsoft.com/en-us/windows/wsl/install-manual)发行版并手动安装它们。

[![](../Images/e874cf783640e8bb958af78a9b462a62.png)T2】](https://rharshad.com/assets/img/2019/03/ubuntu-windows-store-install-error.png)
...
## [](#install-git-node-amp-python)安装 Git，节点& Python

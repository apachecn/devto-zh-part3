...
> 原文:[https://dev . to/CJ brooks 12/monthly-orchid-update-post-holidays-edition-17nf](https://dev.to/cjbrooks12/monthly-orchid-update-post-holidays-edition-17nf)

怎么已经是一月过半了？我很抱歉更新这么晚，假期让我很忙，时间从我身边溜走了。但是这是软件开发，截止日期总是会错过，对吗？😜

总的来说，这个系列是一个关于兰花的每月时事通讯，兰花是 JVM 最新最好的静态站点生成器。越来越需要让社区了解有关兰花的最新消息，在这里我将分享兰花在上个月的进展！跟随本系列，了解兰花的最新特性，跟踪 Github 上的采用情况，并了解谁在使用兰花！
...
截至发稿时，兰花在 Github 上处于 127(或二进制 0b1111111)星！感谢所有的支持，让我们继续努力！

我还在兰花的[问题跟踪](https://github.com/JavaEden/Orchid/issues?q=is%3Aissue+is%3Aopen+sort%3Aupdated-desc)上看到了更多的活动，这意味着人们正在尝试它！我尽我所能在一天左右的时间内回答每个问题，如果你有问题或者发现了一个 bug，这是和我联系的最好方式，因为它也帮助了其他人。

# [](#whats-new)有什么新鲜事？

Orchid 现在的版本是 0.15.3 ，大部分的变化都是小的错误修正或者可用性的小改进。

然而，这个月的大部分时间都花在了编写新的教程上，以引导您了解兰花的最佳特性。这些教程的最新版本在 [Orchid 的文档网站](https://orchid.netlify.com/wiki/learn)上，但是你也可以在 Dev.to 上找到它们！

[![cjbrooks12](../Images/adbbc056394e593e037b38d18cc034cc.png)](/cjbrooks12) [## 兰花教程 05 -菜单上有什么？

### 凯西布鲁克斯 12 月 4 日 187 分钟阅读

#orchid #tutorials #static #webdev](/cjbrooks12/orchid-tutorial-05---whats-on-the-menu-4n0o)[![cjbrooks12](../Images/adbbc056394e593e037b38d18cc034cc.png)](/cjbrooks12) [## 兰花教程 06 -所有关于原型

### 凯西布鲁克斯 12 月 9 日 187 分钟阅读

#orchid #tutorials #static #webdev](/cjbrooks12/orchid-tutorial-06---all-about-archetypes-36ma)[![cjbrooks12](../Images/adbbc056394e593e037b38d18cc034cc.png)](/cjbrooks12) [## 兰花教程 07 -惊人的，自动记录管理面板

### 凯西布鲁克斯 12 月 15 日 188 分钟阅读

#orchid #tutorials #static #webdev](/cjbrooks12/orchid-tutorial-07---the-amazing-auto-documenting-admin-panel-47l4)

# [](#coming-soon)即将到来

作为兰花永无止境的追求成为代码文档最好的工具的一部分，我很兴奋地说，对 Groovy 代码文档的研究正在进行中！这在很大程度上仍处于探索阶段，但我希望在接下来的一个月左右，我能够完成其中的一大部分。请在这里继续关注它的最新进展！

我还在为我的公司做一个秘密项目，一个有趣的小型无服务器 SlackBot:
...
*   产品页面和帮助表格也由兰花管理
*   都是和格雷一起组装的
*   并且使用 Netlify 服务(虽然 Netlify 没有数据库，所以我使用 Firebase)

它还没有完全完成，但欢迎您随时预览 [CrederaBot](https://crederabot.netlify.com/) ！您甚至可以在自己的 Slack 团队中安装这个 bot，但是如果我需要更改 DB 模式，我不能保证我不会删除您的数据😇。

...
> 原文:[https://dev . to/berry _ clione/install-anaconda-into-MAC-OS-x-mojave-and-add-library-4fdh](https://dev.to/berry_clione/install-anaconda-into-mac-os-x-mojave-and-add-library-4fdh)
...
## [](#install-anaconda-by-pyenv)通过 pyenv 安装 anaconda
...
## [](#activate-python-of-anaconda)激活蟒蛇之蟒
...
## [](#add-library-into-anaconda)将库添加到水蟒中

1.  ## [](#search-a-library-you-want-to-install)搜索要安装的库。

    T2`$ anaconda search -t conda [library_name]`

2.  ## [](#get-install-command)获取安装命令。

    T2`$ anaconda show [Package the name you searched]`

3.  ## [](#enter-install-command-you-just-got)输入刚刚得到的安装命令。

    T2`$ conda install --channel [path] [package name]`

4.  ## [](#if-you-make-a-mistake-uninstall-it)出错了就卸载。

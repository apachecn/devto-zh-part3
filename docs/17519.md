...
> 原文:[https://dev.to/oktadev/build-simple-login-in-php-4ojb](https://dev.to/oktadev/build-simple-login-in-php-4ojb)
...
## [](#why-use-okta-for-authentication)为什么要用 Okta 进行认证？
...
## [](#create-a-free-okta-developer-account)创建免费的 Okta 开发者账户
...
[![The application running](../Images/1aa00b07d9269e80b5c180986a0501ca.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--IR9fFOWD--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://developer.okta.com/assets-jekyll/blog/php-simple-login/app-5c704b0476bced7d779ef6a869d20656c73c7d7b12380a233a0d0ed8b14cf254.png)

## [](#implement-okta-login-logout)实现 Okta 登录/注销
...
## [](#new-user-registration-through-the-okta-api)通过 Okta API 注册新用户
...
[![Validation and error handling](../Images/9bda1e0233ef87ec96d6452899684524.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--CazVcKNx--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://developer.okta.com/assets-jekyll/blog/php-simple-login/app-validation-a7c647503dc9774033cf2330dcedb5886c53484a57b9ce415c958c438bf7fd2d.png)

如果你去**用户** > **人**，你可以在你的 Okta 管理面板中看到新用户。

## [](#forgot-password-through-the-okta-api)通过 Okta API 忘记密码
...
## [](#learn-more-about-php-and-okta-oauth-20)了解 PHP 和 Okta OAuth 2.0 的更多信息

...
> 原文:[https://dev.to/quii/learn-go-with-tests 错误类型 4ng9](https://dev.to/quii/learn-go-with-tests---error-types-4ng9)
...
## [](#problems-with-this-way-of-testing)这种测试方式的问题

...
> 原文:[https://dev . to/twilio/how-to-control-and-record-voice-messages-with-node-js-server less-functions-272 l](https://dev.to/twilio/how-to-control-and-record-voice-messages-with-node-js-serverless-functions-272l)
...
[![Podbot preview in a browser window](../Images/328fa8be2a9f4ab07e35a3c32cd57cf0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--1AV3p0L5--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3.amazonaws.com/com.twilio.prod.twilio-docs/images/68he8yLdDsMp_AXDMeAZiQMsLe0wPJ5rK7Ov575PhY6PtT.width-800.jpg)

这个想法是这样的:要发布一个新的播客剧集，你所要做的就是打个电话。不需要麦克风设置，也不需要录制、存储或上传音频文件到播客平台。

## [](#requirements-for-a-voice-call-driven-podcast-site)对语音呼叫驱动的播客网站的要求
...
## [](#functiondriven-voice-calls-to-the-rescue)功能驱动语音呼叫救援
...
[![Graphic showing the call flow with serverless functions](../Images/f0febe9e5f83f4026cb4a058d2eb716d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--BmTOmdyl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3.amazonaws.com/com.twilio.prod.twilio-docs/images/sSm5imNV5rilVnwDdcchaXZnin3BhwF3rsVziYxcMhv_Cg.width-800.jpg)
...
### [](#the-creation-of-serverless-functions)无服务器功能的创建
...
### [](#the-serverless-entry-point-of-your-phone-calls)您电话的无服务器入口点
...
### [](#log-the-recording-and-say-goodbye)记录录音，说再见
...
## [](#run-twilio-functions-locally)本地运行 Twilio 函数
...
[![Terminal showing the local functions endpoints](../Images/dc623bf4464dd1a380c24acac2f5add6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--v43baM7v--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3.amazonaws.com/com.twilio.prod.twilio-docs/images/RHC243fddMbVU_UtU0crMb8sQyXm1yl3RrB8WYgkENpPJf.width-800.jpg)
...
[![Terminal showing the live endpoints of Twilio run](../Images/ed9240be100bbf1a56656e3c0af2a58e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--mpIsxh6x--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3.amazonaws.com/com.twilio.prod.twilio-docs/images/v5d1UZF7vPtFh8QC_6o3oXoD33MMnq3EEgYu9B2jQR9x9c.width-800.jpg)

提供的 URL 是您最终设置呼叫处理所需要的。

## [](#connect-your-twilio-number-with-serverless-functions)将您的 Twilio 号码与无服务器功能连接
...
[![Number configuration to call local function when I call comes in](../Images/34d42b09e6d45a1087e4646d14264352.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--AnY5MWoj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3.amazonaws.com/com.twilio.prod.twilio-docs/images/4dNh107dx4IMF69hk-8XwCFg8zyflUGZ7ZKI0hv2ZE1NWn.width-800.jpg)

当你拨打你的号码并告诉 PodBot 播客的标题时，你应该会看到`CallSid`、`RecordingUrl`和`TranscriptionText`记录在你的终端上。

[![Terminal showing the call logs including sid and transcript](../Images/d55fa1d6780f0498ab59a2d982e5f4ce.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--WC8GA1cT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3.amazonaws.com/com.twilio.prod.twilio-docs/images/jwO03-JbTJzDz3jr3bVyP0fS4eDqrsxp3IUwlEsUAR39-1.width-800.jpg)
...
[![Overview of pasted functions in Twilio console and set call handling in number configuration](../Images/702567fdb20c549185f199a34fa60956.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--tfhOf3XO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3.amazonaws.com/com.twilio.prod.twilio-docs/images/ucLO49bM_aJpSEOgGZwPHPbGRZMe0vAhFBS8OuXUdoPYqi.width-800.jpg)

...
> 原文:[https://dev . to/banana brann/express-routing-for-noobs-假装你是一台计算机-walkthrough-1ma4](https://dev.to/bananabrann/express-routing-for-noobs-pretend-youre-a-computer-walkthrough-1ma4)
...
## [](#what-happens-when-you-visit-a-website)**当你访问一个网站时会发生什么？**
...
## [](#become-a-computer-a-roadmap-routes)**成为电脑:路线图、路线**
...
### [](#our-journey-begins-setting-up-with-indexjs)我们的旅程从 index.js 开始
...
### [](#ground-zero-indexjs)地面零点，index.js
...
### [](#journey-to-the-routes-folder-routersindexjs)旅程路线文件夹，routers/index.js
...
### [](#stepping-into-routesbirdsjs)步入航线/birds.js
...
## [](#become-a-computer-a-roadmap-controller-example)**成为计算机:路线图，控制器示例**

### [](#arriving-at-the-magic-controllersbirdsjs)抵达魔都，控制器/birds.js

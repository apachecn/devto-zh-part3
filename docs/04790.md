...
> 原文:[https://dev . to/alvisesus/processing-with-long-running-http-requests-and-time out-in-phoenix-1824](https://dev.to/alvisesus/dealing-with-long-running-http-requests-and-timeouts-in-phoenix-1824)
...
[![timeout with chrome](../Images/f9ee1a7fb1ac574a42b7413fdcf44c6d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--lm67lBcg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.poeticoding.com/wp-content/uploads/2019/05/image.png)
...
## [](#simulate-a-longrunning-http-request)模拟一个长期运行的 HTTP 请求
...
## [](#how-can-we-solve-this)怎么才能解决这个？
...
## [](#linked-process-and-task)关联流程和任务
...
[![Erlang Observer - Two tasks sleeping](../Images/ab229d9de6313a820509b0a8aa76404e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--fVFMymHX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.poeticoding.com/wp-content/uploads/2019/05/erlang_observer_tasks_sleep.jpg)

由于这两个任务花费的时间都比默认的 60 秒长，Cowboy 关闭了连接。我们看到，一旦连接的进程终止，所有链接的进程都会终止，包括两个任务。

[![Erlang Observer - After Timeout](../Images/edc5287f0e71714f7a3cc46fd0862c5d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--oZNF9rSw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.poeticoding.com/wp-content/uploads/2019/05/erlang_obswerver_connection_closed-1.jpg)

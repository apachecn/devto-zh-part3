...
> 原文:[https://dev . to/nqcm/making-a-static-site-generator-with-python-part-1-3kn 3](https://dev.to/nqcm/making-a-static-site-generator-with-python-part-1-3kn3)

[![static Site Generators in Python](../Images/fa6d070164d9167a715f5af10d176562.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--OKRs0Eu5--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/k7sxavnuzyduny8g1src.jpg)
...
## [](#understanding-how-static-site-generators-work)了解静态站点生成器如何工作
...
## [](#converting-markdown-to-html)将 Markdown 转换为 HTML
...
## [](#creating-and-using-templates)创建和使用模板

...
> 原文:[https://dev . to/next tech/class ification-and-regression-analysis-with-decision-trees-jgp](https://dev.to/nexttech/classification-and-regression-analysis-with-decision-trees-jgp)

**决策树**是一种受监督的机器学习模型，用于通过从特征中学习决策规则来预测目标。顾名思义，我们可以把这个模型看作是通过提出一系列问题来做出决定，从而分解我们的数据。

让我们考虑下面的例子，其中我们使用决策树来决定某一天的活动:

[![](../Images/777314c6daa68630cc9885d0976d3961.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--NFD01EmD--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/720/1%2AWerHJ14JQAd3j8ASaVjAhw.jpeg)
...
##### [](#this-tutorial-is-adapted-from-next-techs-python-machine-learning-series-which-takes-you-through-machine-learning-and-deep-learning-algorithms-with-python-from-0-to-100-it-includes-an-inbrowser-sandboxed-environment-with-all-the-necessary-software-and-libraries-preinstalled-and-projects-using-public-datasets-you-can-get-started-here)*本教程改编自 Next Tech 的 **Python 机器学习**系列，带你通过 Python 从 0 到 100 的机器学习和深度学习算法。它包括一个浏览器内沙盒环境，预装了所有必要的软件和库，以及使用公共数据集的项目。这里可以开始[！](https://c.next.tech/2HkQ7tG)*

* * *

## [](#the-fundamentals-of-decision-trees)决策树的基本原理
...
## [](#maximizing-information-gain)信息增益最大化

为了在最具信息性的特征处分割节点，我们需要定义一个目标函数，我们希望通过树学习算法来优化该目标函数。这里，我们的目标函数是最大化每次分裂的信息增益，我们定义如下:

[![](../Images/04f92b1003f7def0ee3f1aa2195105f7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--zqQ2YggF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/720/1%2ACHsongM23EQUzvzzcWa2Pg.png)
...
[![](../Images/d62b10aeec331891484a0937b81bff10.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--iMXI4MFr--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/720/1%2ATrGRS0Y7nokqAggvbdEClA.png)
...
[![](../Images/4cf83e57e8358bbb5d7fdb88616b5b7c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--N6RievBz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/720/1%2A8BIEFvLcFv6e2WDC_P8gMA.png)
...
[![](../Images/e6d6c1c6ffc6e91c89b541d299cdd7cd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--_QNKnaTy--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/720/1%2Az4zWVweDtHJzq4Ky5eOAHg.png)
...
[![](../Images/0968cffcb77afcf5a1a9a0a4c26c42ff.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--S03agUJw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/720/1%2A1pSpTGA6A1rY4WCgIBUm0g.png)
...
[![](../Images/4e6eabbbd81c5381f2eb29968e5bf077.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--glYq_tmV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/720/1%2A6wRtInhGhxoX_Y7W9OR14Q.png)

这里，*n<sub>t</sub>T3】为节点 *t* 的训练样本数，*d<sub>t</sub>T9】为节点 *t* 的训练子集， *y <sup>(i)</sup>* 为真实目标值， *ŷ <sup>t</sup>* 为预测目标值(样本均值):**

[![](../Images/c52f56a94383167db4a81262441673ba.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--CF3PSom4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/720/1%2ADylF2sjY6k3Cw7HE8vtYrA.png)
...
[![](../Images/439465822f13beb0b6f8d59ad66f0202.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---RSxMHSQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/7g9yosjrnkbhatnldelw.png)

...
> 原文:[https://dev . to/hackersandslackers/making-API-requests-with-nodejs-3n DG](https://dev.to/hackersandslackers/making-api-requests-with-nodejs-3ndg)

[![Making API Requests with NodeJS](../Images/595c1987ef3bde6e5f8486b3193a5f6a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--TiFmk6Yi--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://hackers.nyc3.cdn.digitaloceanspaces.com/posts/2019/02/node-fetch.jpg)
...
## [](#library-of-choice-nodefetch)选择库:节点-获取
...
## [](#creating-a-nodefetch-request)创建节点提取请求
...
### [](#properties-of-a-response)响应的属性

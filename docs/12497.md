...
> 原文:[https://dev . to/sergiodxa/automatizacin-con-shell-scripts-5ch 7](https://dev.to/sergiodxa/automatizacin-con-shell-scripts-5ch7)
...
## [](#funci%C3%B3n-de-instalaci%C3%B3n)安装功能
...
## [](#funci%C3%B3n-de-ejecuci%C3%B3n)执行函数

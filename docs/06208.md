...
> 原文:[https://dev . to/amberwilkie/when-to-use-a-function-declaration-vs-a-function-expression-5fjb](https://dev.to/amberwilkie/when-to-use-a-function-declaration-vs-a-function-expression-5fjb)
...
[![](../Images/77483f1d19523f656a033c36ce0df3e0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--fNnY5AVh--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2Ai6ZBOiPaCeOTkUWhrb4TRw.jpeg)

### [](#the-first-difference-a-name)第一个区别:一个名字
...
### [](#the-case-for-function-expressions)函数表达式的情况

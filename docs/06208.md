...
> 原文：<https://dev.to/amberwilkie/when-to-use-a-function-declaration-vs-a-function-expression-5fjb>

#### 科技术语系列

您可能已经知道如何用这两种方式编写函数。函数 doStuff() {}和()=> {}是我们整天输入的字符。但是它们有什么不同，为什么要使用其中的一个？

**注:**JavaScript 中给出了例子。_Y_our _M_ileage _M_ay _V_ary 与其他语言。

[![](img/77483f1d19523f656a033c36ce0df3e0.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--fNnY5AVh--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2Ai6ZBOiPaCeOTkUWhrb4TRw.jpeg)
...
这是该系列的第二篇文章。第一个是[高阶函数](https://dev.to/amberwilkie/higher-order-functions-what-they-are-and-a-react-example-1ief)。当我去参加聚会和会议，假装知道我的技术伙伴们在谈论什么的时候，你会发现更多，但之后不得不回家去谷歌一下。

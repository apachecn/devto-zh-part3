...
> 原文：<https://dev.to/jaredwolff/how-to-make-an-amazing-looking-iot-dashboard-in-no-time-2l93>

在本帖中，我将向您展示如何开始使用在 Digital Ocean 上的 docker 容器中运行的 Grafana 和 InfluxDB。这样你就可以按需得到像这样的漂亮图表:

[![](img/b16383320d86a1c4dc0e310eea3d0eb9.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--0ewkQHML--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/how-to-make-an-amazing-looking-iot-dashboard-in-no-tiimg/Screen%2520Shot%25202019-05-05%2520at%252012.55.10%2520PM.png)
...
2.  转到`Account Settings` - > `Security`并确保您设置了 SSH 密钥。![](img/0bb40326c9d0460229f71ec650a08b16.png)
...
9.  从粒子设置卷曲
    ...
    [![](img/a7f681e50ad659bfdffd63d55c21a40f.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--tcL48emv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/how-to-make-an-amazing-looking-iot-dashboard-in-no-tiimg/Screen%2520Shot%25202019-05-04%2520at%25209.19.59%2520PM.png)

    **注:**见`QUERY PARAMETERS`下那个`db`正指向`particle`。这应该指向您在步骤 6 中设置的`INFLUXDB_DB`

    **第二个注意:**确保用户名和密码也是您在第 6 步中设置的。在本例中，用户名为`grafana`

    [![](img/4608d58cc9ac478b437a34463d29a21e.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--5zFZmuT0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/how-to-make-an-amazing-looking-iot-dashboard-in-no-tiimg/Screen%2520Shot%25202019-05-04%2520at%25209.19.54%2520PM.png)
...
13.  将 Grafana 连接到流入管(这应该是 Grafana 全新安装的首选方案之一)
    ...
    [![](img/100b0f1639eb2beec18de48dad8e9a76.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--PWsnoUjz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/how-to-make-an-amazing-looking-iot-dashboard-in-no-tiimg/Screen%2520Shot%25202019-05-04%2520at%25209.24.02%2520PM%2520copy.png)

    [![](img/8f1cf7949cbd7d5e29fae6151eb30fc4.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--_ipisHc8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/how-to-make-an-amazing-looking-iot-dashboard-in-no-tiimg/Screen%2520Shot%25202019-05-04%2520at%25209.25.39%2520PM%2520copy.png)
...
16.  创建图表！
    ...
    [![](img/e65a4113ce9269f7bf58b3f7d2c6f9c6.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--adhZQx1Z--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/how-to-make-an-amazing-looking-iot-dashboard-in-no-tiimg/Screen%2520Shot%25202019-05-07%2520at%25209.32.49%2520AM.png)

17.  选择`Add Query`

    [![](img/33c4493d504283175b4965ec578da0dd.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--V3HWJ7uO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/how-to-make-an-amazing-looking-iot-dashboard-in-no-tiimg/Screen%2520Shot%25202019-05-07%2520at%25209.33.58%2520AM.png)

18.  向下点击`select measurement`如果您的设备已经发布到您的数据库，您应该会看到一些值的选项。

    [![](img/3c135f62aa458069596c838a45ddb56b.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--SlUMk_dS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/how-to-make-an-amazing-looking-iot-dashboard-in-no-tiimg/Screen%2520Shot%25202019-05-07%2520at%25209.34.32%2520AM.png)

19.  在`fill(null)`下，将其更改为`fill(none)`。这应该给你一个很好的数据点之间的界限。

20.  您应该会看到图形出现！
    [![](img/6d8e4ba06373524264bc98a0c6c487b0.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--TpBOirM6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/how-to-make-an-amazing-looking-iot-dashboard-in-no-tiimg/Screen%2520Shot%25202019-05-07%2520at%25209.36.36%2520AM.png)

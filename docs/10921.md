...
> 原文:[https://dev . to/an war _ nairi/reduce-time-complexity-by-indexing-your-arrays-3ci 6](https://dev.to/anwar_nairi/reduce-time-complexity-by-indexing-your-arrays-3ci6)

# [](#indexing-in-a-database)数据库中的索引

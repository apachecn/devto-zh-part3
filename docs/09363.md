...
> 原文:[https://dev . to/janux _ de/report-about-updating-a-Java-project-from-JDK-8-to-JDK-11-2 klf](https://dev.to/janux_de/report-about-updating-a-java-project-from-jdk-8-to-jdk-11-2klf)
...
# [](#upgrading-the-java-project)升级 Java 项目

## [](#upgrade-dependencies)升级依赖关系
...
## [](#update-the-language-level-in-the-gradlefile)更新 Gradlefile 中的语言级别
...
## [](#use-jdk-11-in-the-ide)在 IDE 中使用 JDK 11

之后我们需要在 IntelliJ 中切换到 JDK 11 号。这可以通过进入菜单项“文件>项目结构”来完成。可以在 Project SDK 下拉菜单中选择新版本和语言级别。如果还没有，可以在“平台设置”部分添加。

[![Screenshot "Project structure" dialog](../Images/1c0b8873d91b8df8b2c329c0a6c5ec03.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ZVhBiqxT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/qv7kx40sv7gkdrugavt1.png)

另外，在“首选项”中检查正在使用的新编译目标:

[![Screenshot "Preferences" dialog](../Images/dce242513f87b9474fdc4216ea9473b2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--H0y2fVyC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/88bexvv97uxa0k0a41h7.png)

现在构建项目并运行单元测试。如果你幸运的话，没有错误。

## [](#use-jdk-11-on-the-terminal)在终端上使用 JDK 11
...
## [](#uninstall-via-homebrew)通过自制软件卸载

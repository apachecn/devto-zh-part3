...
> 原文:[https://dev . to/mikhailshilkov/from-YAML-to-typescript-developers-view-on-cloud-automation-1d0m](https://dev.to/mikhailshilkov/from-yaml-to-typescript-developers-view-on-cloud-automation-1d0m)
...
[![URL Shortener sample app](../Images/794bf7d29da389b9019ce830b81ebe94.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--iM11B_Uk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://mikhail.io/2019/02/from-yaml-to-typescript-developers-view-on-cloud-automation/url-shortener.png)
...
## [](#serverless-url-shortener)无服务器网址缩写
...
[![URL Shortener with AWS Lambda and DynamoDB](../Images/e1d0a781d650c386f8f23bb35857312d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--eo6J2OgX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://mikhail.io/2019/02/from-yaml-to-typescript-developers-view-on-cloud-automation/lambda-dynamodb.png)
...
[![API Gateway, Lambda, DynamoDB, and S3](../Images/e3e1a10ce72f13d948d84726548d6091.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--s7WTWm5D--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://mikhail.io/2019/02/from-yaml-to-typescript-developers-view-on-cloud-automation/apigateway-lambda-dynamodb-s3.png)
...
[![All cloud resources to be provisioned](../Images/85d837fe768ccdaa5381e84ce44146ac.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--4ne1CQDo--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://mikhail.io/2019/02/from-yaml-to-typescript-developers-view-on-cloud-automation/apigateway-lambda-dynamodb-s3-details.png)

<figcaption>All cloud resources to be provisioned</figcaption>

我们如何完成这项任务？

## [](#options-to-provision-the-infrastructure)配置基础设施的选项

供应云应用程序有多种选择，每一种都有其利弊。让我们快速浏览一下可能性列表，以了解这种情况。

## [](#aws-web-console)AWS Web 控制台

像任何其他云一样，AWS 有一个[网络用户界面](https://console.aws.amazon.com)来配置其资源:

[![AWS Web Console](../Images/a576e5491a8e2885a1b33c15d53e02d8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--1hw17SEl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://mikhail.io/2019/02/from-yaml-to-typescript-developers-view-on-cloud-automation/aws-web-console.png)
...
## [](#serverless-framework-and-sam)无服务器框架和 SAM
...
## [](#desired-properties-of-infrastructure-definition-tool)基础设施定义工具的期望属性
...
[![How Pulumi works](../Images/cff59f843e47fc189987d2ebe482cbc9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--p-RLYGDz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://mikhail.io/2019/02/from-yaml-to-typescript-developers-view-on-cloud-automation/how-pulumi-works.png)
...
## [](#standard-component-library)标准件库
...
[![Pulumi abstraction layers](../Images/5652c8ff1369e008c89df771586df901.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--uNfgWsuM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://mikhail.io/2019/02/from-yaml-to-typescript-developers-view-on-cloud-automation/pulumi-layers.png)

<figcaption>Pulumi abstraction layers</figcaption>

在云提供商的 API 和内部资源提供商之上工作，您可以选择以最大的灵活性使用原始组件，或者选择加入更高级别的抽象。在同一个程序中混合搭配也是可能的。

## [](#infrastructure-as-real-code)基础设施为实码

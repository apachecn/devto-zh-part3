...
> 原文:[https://dev . to/jbmoelker/Dropbox-paper-as-a-headless-CMS-361h](https://dev.to/jbmoelker/dropbox-paper-as-a-headless-cms-361h)
...
[![](../Images/d2e718921354f71cd8d28cad0359d0b6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--yIHfIRLl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/1aam3q8gvizr1yac2ht7.png)

## [](#organise-and-edit-content-on-dropbox-paper)整理和编辑 Dropbox 纸上的内容

我们首先从项目内容开始。通过熟悉的 Dropbox 纸质用户界面([paper.dropbox.com](paper.dropbox.com))，我们将内容写在纸质文档中，并将其组织到文件夹中:

[![](../Images/43047dd00842976976263aa4a4004429.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--hiEDD4p_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/rn1d0cr13y4xcm3ude8x.jpg)
...
## [](#gather-content-through-the-paper-api)通过纸质 API 收集内容
...
## [](#build-and-deploy-as-a-static-site)作为静态站点构建和部署
...
[![](../Images/3f129ae9356f83d62d12ec0680b7ad16.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--M1YVFK1_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/hyc1h2bmwidyacltimng.jpg)
...
[![/playbook command to publish from Slack](../Images/6f1a13e7155580f863c91089f288dedd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--QoWM2g6H--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4xn7p84119ll86q8sx6y.jpg)

就是这样，我们使用 Paper 作为 CMS，通过一种机制在一个定制的网站上发布我们的内容，具有我们想要的外观和感觉。

## [](#paper-api-limitations-and-drawbacks)论文 API 的局限性和弊端

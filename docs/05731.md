...
> 原文:[https://dev . to/oktadev/build-a-crud-app-with-ASP-net-core-2-2-and-SQL-server-3m 78](https://dev.to/oktadev/build-a-crud-app-with-asp-net-core-2-2-and-sql-server-3m78)
...
## [](#scaffold-your-aspnet-core-22-application)脚手架 ASP.NET 芯 2.2 应用
...
## [](#connect-sql-server-to-your-aspnet-core-22-mvc-application)将 SQL Server 连接到您的 ASP.NET 核心 2.2 MVC 应用程序
...
## [](#add-authentication-to-your-aspnet-core-22-mvc-sql-server-application)为您的 ASP.NET 核心 2.2 MVC + SQL Server 应用程序添加身份验证
...
## [](#configure-your-aspnet-core-22-mvc-application-for-authentication)配置您的 ASP.NET 核心 2.2 MVC 应用进行认证
...
## [](#learn-more-about-aspnet-core-22-and-sql-server)了解有关 ASP.NET 核心 2.2 和 SQL Server 的更多信息

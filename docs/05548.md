...
> 原文:[https://dev . to/Gary _ wood fine/using-server less-framework-environment-variables-net-core-lambda-5e9l](https://dev.to/gary_woodfine/using-serverless-framework-environment-variables-net-core-lambda-5e9l)
...
### [](#environment-variables-in-serverless-framework)无服务器框架中的环境变量
...
### [](#how-to-use-environment-variables-in-net-core)如何使用环境变量。网络核心
...
### [](#adding-environment-variables-to-dependency-injection)给依赖注入添加环境变量

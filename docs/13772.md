...
> 原文:[https://dev . to/chrishymes/getting-started-with-bulma-clean-theme-for-Jekyll-1p3d](https://dev.to/chrisrhymes/getting-started-with-bulma-clean-theme-for-jekyll-1p3d)
...
## [](#using-bulmacleantheme-with-github-pages)对 Github 页面使用 bulma-clean-theme

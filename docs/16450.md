...
> 原文:[https://dev . to/xiaket/drift-detection-in-cloud formation-a-first-look-107 p](https://dev.to/xiaket/drift-detection-in-cloudformation-a-first-look-107p)
...
## [](#run-drift-detection-with-python)用 Python 运行漂移检测
...
## [](#calling-raw-detectstackdrift-endraw-)来电`DetectStackDrift`
...
## [](#getting-drift-status-with-raw-describestackdriftdetectionstatus-endraw-)用`DescribeStackDriftDetectionStatus`获得漂移状态
...
## [](#other-minor-hiccups)其他轻微的打嗝

官方文档确实提到了一些限制。我建议先花点时间读一读。以下是我们观察到的一些其他问题:

### [](#empty-raw-propertydifferences-endraw-)空虚`PropertyDifferences`
...
### [](#altered-order-in-list-items)改变列表项的顺序

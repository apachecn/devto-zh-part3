...
> 原文:[https://dev . to/zephinzer/first-thinks-on-Apollo-graph QL-3gi 9](https://dev.to/zephinzer/first-thoughts-on-apollo-graphql-3gi9)
...
### [](#option-1-use-the-context)选项 1:使用上下文

所以我稍微探索了一下，找到了可以传递给`ApolloServer`构造函数的`context`选项。它公开了一个函数，该函数公开了传入请求和传出响应的属性。上下文可以用来注入普罗米修斯度量监听器吗？

### [](#option-2-use-the-apolloserver-as-a-middleware)方案二:使用 ApolloServer 作为中间件

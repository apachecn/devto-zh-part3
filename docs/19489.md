...
> 原文:[https://dev . to/oktadev/build-and-test-a-react-native-app-with type script-and-oauth-2-0-21on](https://dev.to/oktadev/build-and-test-a-react-native-app-with-typescript-and-oauth-2-0-21on)
...
## [](#create-a-react-native-project)创建一个 React 原生项目
...
[![Welcome to React Native!](../Images/1ca9d60d3b83ea2ff3b3e47a27a2bf00.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--AetKkgf4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://developer.okta.com/assets-jekyll/blog/react-native-testing/welcome-to-react-native-8f28b08a07e085a007eab5cf7b96333be1858b2feb2e2ce0ce63c434fd35f233.png)

## [](#create-a-native-application-in-okta)在 Okta 中创建原生应用
...
## [](#add-appauth-to-your-project)将 AppAuth 添加到项目中
...
## [](#test-your-react-native-application)测试你的 React 原生应用

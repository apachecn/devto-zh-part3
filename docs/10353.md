...
> 原文:[https://dev . to/Nielsen Jared/what-is-object-relational-mapping-how-roll-your-own-JavaScript-ORM-4ni 3](https://dev.to/nielsenjared/what-is-object-relational-mapping-how-to-roll-your-own-javascript-orm-4ni3)

[![Object-Relational Mapping](../Images/1fc0ec4489d4348751afb11001970bd6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--cvkHzgUC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/cyxo5eg87yw5xf41wve7.png)
...
## [](#what-is-objectrelational-mapping)什么是对象关系映射？
...
## [](#war-is-never-a-lasting-solution)战争永远不是长久之计
...
## [](#setup-the-mysql-database)设置 MySQL 数据库
...
## [](#all-the-cats-are-undefined)所有的猫都是未定义的
...
## [](#crud-cat-read-update-delete)CRUD: Cat 读取更新删除
...
## [](#orm-architectural-patterns)ORM +架构模式
...
## [](#refactoring-custom-objectrelational-mapping-for-variable-table-structures)重构变量表结构的自定义对象关系映射
...
## [](#refactoring-objectrelational-mapping-to-create-tables-via-model-instantiation)重构对象关系映射，通过模型实例化创建表格

...
> 原文:[https://dev . to/semuserable/simplest-typescript-project-using-visual-studio-code-1 lgl](https://dev.to/semuserable/simplest-typescript-project-using-visual-studio-code-1lgl)
...
[![Project structure](../Images/e7acebcf007dcaa9a3402617fd15d085.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--6wbloN3E--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/48xh1m5j1pc3ff1x4wi1.png)
...
让我们看看它的实际效果吧！
[![Node run](../Images/fa857bb75c87018664ea0964d850b451.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--ugPsiCqm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/mv2wbdpyucdt3iix9n76.gif)

好吧。我们喜欢命令行，并渴望尝试新的东西。让我们创建一个最小的`html`，并通过`TypeScript`改变页面的一些 DOM 属性。

# [](#working-with-dom)使用 DOM
...
[![Final project structure](../Images/3e50a380442ee3c4b2ed1f4e635da342.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--bic094XF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/2icj1g1je8mu5c24oar6.png)

按`Ctrl+Shift+B`查看`main.js`文件(只是好奇)。接下来，打开`index.html`，观察结果。哇！如此简单！

<figure>![Index html](../Images/b17d8b9130735c2026459be234230d90.png)
...
<figure>![Compiler error](../Images/48b32892adcf8788a83f8b814f8a79ce.png)

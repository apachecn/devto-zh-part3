...
> 原文:[https://dev . to/miloszpp/precise-domain-modeling-with-discribed-unions-in-typescript-3c8p](https://dev.to/miloszpp/precise-domain-modeling-with-discriminated-unions-in-typescript-3c8p)

在这篇文章中，我们将探讨 TypeScript 语言的一个有趣的特性。它被称为**有区别的联合**，也被称为**代数数据类型**。后一个名称来自函数式编程范例，其中这种类型被大量使用。

## [](#issues-with-enum-types)枚举类型的问题
...
## [](#discriminated-unions-to-the-rescue)受歧视的工会前来救援
...
## [](#working-with-discriminated-unions)与受歧视的工会合作

...
> 原文:[https://dev . to/jochemstoel/re-implementing-jquery-methods-in-the-html element-prototype-15b 9](https://dev.to/jochemstoel/re-implementing-jquery-methods-in-the-htmlelement-prototype-15b9)
...
## [](#nodelist-iteration)NodeList 迭代
...
## [](#innertext-and-innerhtml)innerText 和 innerHTML

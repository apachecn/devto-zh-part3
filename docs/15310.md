...
> 原文:[https://dev . to/rocksetcloud/running-fast-SQL-on-dynamo db-tables-4p7n](https://dev.to/rocksetcloud/running-fast-sql-on-dynamodb-tables-4p7n)
...
### [](#dynamodb-integration)**DynamoDB 积分**
...
### [](#connecting-dynamodb-to-rockset)**将 DynamoDB 连接到 Rockset**

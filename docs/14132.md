...
> 原文:[https://dev . to/CJ brooks 12/orchid-is-now-more-kotlin-than-Java-30bc](https://dev.to/cjbrooks12/orchid-is-now-more-kotlin-than-java-30bc)

只是想在这里分享一个快速的胜利。经过一年多慢慢地将兰花代码库从 Java 移植到 Kotlin，它正式成为一个 Kotlin 项目，而不是 Java 项目！

[![https://thepracticaldev.s3.amazonaws.com/i/qs5p7nkxymq9i2c26uwz.png](../Images/d2a3dd2f67d65be6fdf25db7dfdfed57.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--EDXdvyt1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/qs5p7nkxymq9i2c26uwz.png)

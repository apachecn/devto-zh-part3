...
> 原文:[https://dev . to/intrinate cloud/debugging-web driver io-tests-with-vs code-34p 0](https://dev.to/intricatecloud/debugging-webdriverio-tests-with-vscode-34p0)
...
## [](#vscode-configuration)VSCode 配置

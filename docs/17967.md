...
> 原文:[https://dev . to/惠晶/using-dev tools-to-understand-modern-layout-techniques-3j4o](https://dev.to/huijing/using-devtools-to-understand-modern-layout-techniques-3j4o)
...
[![](../Images/9cedbe8cec04811f1cd2205c4b8f8c69.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--8Dq_KK95--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://i.imgur.com/UC2NRLQ.gif) 
...
[![](../Images/8e6ddc51c6e2bb093680f28f0d17be2e.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--lvTcWU9v--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/BF6DwL1.png) 
...
## [](#box-alignment-visualised)框对齐可视化

flex overlay 也无意中成为各种框对齐属性的可视化工具，这主要是因为它的设计方式。可用空间由虚线和点组成的图案表示，这清楚地表明了当应用不同的值时，可用空间是如何分布的。

[![](../Images/0baba683d274021107db13baa57d6ceb.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--ucxA2Rst--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/8GhJytP.png) 
...
[![](../Images/e5b4df6c18b4fb06cdd55b2cbbf1466c.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--dyZArdKq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/K1e1KeE.png) 
...
[![Choose grid colour](../Images/98063452b7f3e2ee4fb82a365ae82203.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--HzHE2CH0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.chenhuijing.com/assets/images/posts/devtools-layout/grid-colour-640.jpg) 
...
[![Multiple grid overlays on the same page](../Images/badcb8ecd62b0725e1b63165c84787e4.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--lXecpBq---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.chenhuijing.com/assets/images/posts/devtools-layout/nested-grid-640.jpg) 
...
## [](#observing-varying-rates-of-change)观察变化的速率
...
[![](../Images/9bb1d1a8ab2ca0711b1bcd5387ee0db8.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--vc2RnEFr--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/QQmGJWo.png) 
...
### [](#strength-of-flexible-widths)弹性宽度的强度

强度可能是一种相当糟糕的表达方式，但是我想区分具有不同大小值的项目如何根据相同上下文中其他项目的大小值以不同方式保持其宽度。

[![](../Images/7a5eca269684579d3193c21a666b30a8.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--ukS-1d8G--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/ZqKVbcU.png) 
...
## [](#building-an-actual-design)建筑实际设计

...
> 原文:[https://dev . to/renegade coder 94/how-to-write-a-list-comprehension-in-python-n58](https://dev.to/renegadecoder94/how-to-write-a-list-comprehension-in-python-n58)
...
### [](#filter-and-modify-a-list)过滤和修改列表
...
### [](#generate-all-pairs-from-two-lists)从两个列表中生成所有对

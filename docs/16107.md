...
> 原文:[https://dev . to/miguelrodoma 95/tips-to-keep-your-Android-app-project-organized-361n](https://dev.to/miguelrodoma95/tips-to-keep-your-android-app-project-organized-361n)

## [](#the-importance-of-an-organized-code-structure)一个有组织的代码结构的重要性
...
### [](#organization-and-naming-tips)组织和命名提示
...
[![packages](../Images/9c4d92305bffefaf4d5828469723fe79.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--mzs1X03K--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/04hn3ylsxx0aunirap0l.png)

## [](#resource-files)资源文件

### [](#types-of-resource-files)资源文件的类型
...
### [](#resource-files-naming-tips)资源文件命名提示
...
[![layouts](../Images/4b19af3ce72c163cad2de0e3ce81ddfa.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--z67C5j7X--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/hr4s4ttuk8ytqb997yy3.png)

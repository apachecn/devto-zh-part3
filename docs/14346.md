...
> 原文:[https://dev.to/coreyja/devicon-lookup-二进制搜索-实验-1 线](https://dev.to/coreyja/devicon-lookup---binary-search-experiment-1ine)
...
### [](#binary-search-with-hashmap-cache)带 HashMap 缓存的二分搜索法

...
> 原文:[https://dev.to/dvddpl/serverless-days-hamburg-2019-日-2-1kii](https://dev.to/dvddpl/serverless-days-hamburg-2019---day-2-1kii)
...
## [](#debunking-serverless-myths-yan-cui)揭穿无服务器神话——崔琰
...
[![total cost of ownership](../Images/90d5da117367b088f859a9bd1c4a15b8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--90iXQApr--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/3gslcxw9fssnu2i2sfrl.jpg)

*   供应商锁定锁定的真正危险是潜在的数据锁定。回报是否值得冒险。是

[![but serverless still has servers](../Images/1fbf82b58fd6d212b78c7adcda62e335.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--6qwP81Hk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/rx15j98qmq1j0hu8cbcb.png) 
**它是无服务器的，就像 WiFi 是无线的** (Gojko Adzic)

* * *

## [](#devops-amp-serverless-with-aws-how-serverless-can-help-chatops-become-reality-selina-magnin)devops &带 aws 的无服务器/无服务器如何帮助聊天操作成为现实——Selina Magnin
...
[![serverless chat-ops app](../Images/07e8cec90a75bb552f22dcaa2d711ac0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---8oinSWw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/zny6olb4lzt4k035i99c.jpg)
...
### [](#tools-to-track-backend-errors)跟踪后端错误的工具

*   [x 射线](https://aws.amazon.com/it/xray/)
*   [泻药](https://epsagon.com/)

### [](#tools-to-track-frontend-errors)跟踪前端错误的工具
...
## [](#building-stateful-applications-with-serverless-tiru-marai)用无服务器构建有状态应用——Tiru Marai

### [](#patterns-for-delegating-state)模式为委托状态
...
## [](#serverless-is-more-than-you-think-michael-mcdonald)无服务器比你想象的多——迈克尔·麦克唐纳
...
[![stateful retrying](../Images/47ce00d3dbcccbb1500eb8a81297df0f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--wbwvOWlq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/iokwog2p0q9tpqlf635y.jpg)
...
### [](#available-strategies-when-somthing-goes-wrong)出现问题时可用的策略

*   分布式交易
*   补偿事务(中止/回滚应用程序级别)
*   道歉(检测并修复违反约束的情况)

[![unexpected outcome](../Images/f9dbdd933f112a92e9a77e5772eb59f8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--1_yso-Fs--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/7jzw25eem8ehefdymlbc.jpg)
...
### [](#saga-pattern-compensation-as-strategy)传奇模式/补偿作为策略

#### [](#event-driven-choreography)事件驱动编排
...
## [](#serverless-commmunities-michael-oshita)无服务器社区——迈克尔·大下
...
## [](#escape-the-lock-in-christoph-neijenhuis)逃脱锁定——克里斯托夫·内延豪斯
...
#### [](#use-hexagonal-architecture)使用六角形建筑

结构化代码，以便逻辑被隔离，并为每个云提供商的处理程序使用适配器。大多数情况下，只是事件/上下文和输入数据以不同的方式从一个供应商传递到另一个供应商。

#### [](#can-an-adapter-be-written-for-a-given-product)可以为给定的产品编写适配器吗？
...
## [](#serverless-testing-avishai-shafir)无服务器测试- Avishai Shafir

当转移到无服务器架构时，测试金字塔的组件/集成层变得更宽、更重要(金字塔看起来更像是玛雅金字塔)

[![serverless test pyramid](../Images/9a94b9e70747bdd3b4d8ead7ee02b8f3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--iXM5vNxC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/dkr3troudshpwshutc87.jpg)
...
## [](#zen-and-art-of-beer-fermentation-observability-ilia-lybin)禅宗与啤酒发酵艺术的可观察性——伊利亚·莱宾

有趣的谈话，他描述的是宠物项目。他将自己对家庭酿酒的热情与无服务器解决方案结合起来，开发了一个应用程序来监控啤酒发酵，并在发酵好的时候得到通知。

[![home brewing process](../Images/0964948aaafbb18d328ce290b8c44f47.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--y8BokNFv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/3ht20r5hqsg0q6eplamd.jpg)
...
[![Cartoonist - Sketchnoter](../Images/3decd474ae3c39ded494c7a964e2e84f.png) ](https://res.cloudinary.com/practicaldev/image/fetch/s--G8-UNfQj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://pbs.twimg.com/media/DzcBmlpW0AE5Jis.jpg:large) *写生笔记[千里眼](https://twitter.com/clairikine)*
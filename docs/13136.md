...
> 原文:[https://dev.to/apoorvadave/regression-in-machine-learning-第二部分-30bb](https://dev.to/apoorvadave/regression-in-machine-learning---part-2-30bb)
...
[![ml2](../Images/6c2ed147449075a06b3cd3897725157b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Aq4w2Kw_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/c24zzai3xf48ynqioy05.png)

y 代表薪水，X 是雇员的年龄，a 和 b 是等式的系数。所以为了在给定 X(年龄)的情况下预测 Y(工资)，我们需要知道 a 和 b(模型的系数)的值。

[![ml3](../Images/615c62cc874c06989f2c7ddd5e4a87d6.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--6Y4Lk9r6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/nep0aahp2c0fn1drvbrd.png) 
...
[![ml4](../Images/5ec1294e9bac85952c11735d69d25a03.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--I34A-46f--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/36yjgdojnannmvv2rlep.png)

它仍然是一个线性模型，但曲线现在是二次曲线，而不是直线。Scikit-Learn 提供了多项式特征类来转换特征。

[![ml5](../Images/64630f5208e5b1dcda2a5a2bdfb15d65.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--kfP9zcsV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/0m7kwnwqmocig4j4p6cl.png) 
...
[![ml6](../Images/3143267602b2e1e262bdf87b30370c72.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--VVw-sD_w--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/t28d6qw879txtv27ddd5.png) 
...
[![ml7](../Images/ad696aa5beafd8f8f544baf4c9fa9cec.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--7K-Zx0mV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/bubnvodn72o81pykv45a.png) 

<figcaption>标准差</figcaption>

根据不同属性分割数据集，并计算每个分支的标准差(目标和预测值的标准差)。分割前，从标准偏差中减去该值。结果是标准偏差减少。

[![ml8](../Images/c9da0775aa887686142544ba12e78e01.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--NHXN2886--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4k845b9n2jw5679onl66.png)

...
> 原文:[https://dev . to/dowenb/how-I-am-learning-to-test-the-internet-with-selenium base-32](https://dev.to/dowenb/how-i-am-learning-to-test-the-internet-with-seleniumbase-32)
...
## [](#go-learn-python-somewhere-else)去学 Python 吧！别的地方
...
## [](#follow-along-on-github)跟着一起走，上 GitHub
...
### [](#helper-urlpath-function)Helper _url(路径)函数

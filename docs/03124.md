...
> 原文:[https://dev . to/Google cloud/hitting-a-cloud-function-when-you-submit-a-Google-form-3hkn](https://dev.to/googlecloud/hitting-a-cloud-function-when-you-submit-a-google-form-3hkn)
...
## [](#writing-your-cloud-function)编写您的云函数
...
## [](#creating-your-google-form)创建您的谷歌表单

您创建的 Google 表单将和其他表单一样:您可以有多部分问题、多项选择问题、自由形式问题等。

## [](#creating-a-script-for-your-form)为您的表单创建脚本

我们可以从这里开始把这些点联系起来。首先，在编辑表单时，在菜单中选择三个点:

[![](../Images/701ad82763ba398230be9b6f020157bd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--2qayrScV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ngsowpgdyksnvgk7it7b.png)
...
## [](#adding-a-trigger)添加触发器

现在，从脚本编辑器中，点击**【编辑】** > **【当前项目的触发器】**。这将提示您为项目命名，然后带您到 G Suite Developer Hub，并向您显示项目的所有触发器(应该没有)。

在右下角，选择“+添加触发器”来添加新的触发器:

[![](../Images/9e9f9e9f545cdd74e7edf61755ab353c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--VN_AZ-qf--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/s442x9zvpqcdoo3o2mvo.png)

...
> 原文:[https://dev . to/eka FYI/using-Gatsby-themes-in-a-non-theme-starter-54c 7](https://dev.to/ekafyi/using-gatsby-themes-in-a-non-theme-starter-54c7)
...
### [](#2-import-the-theme)2。导入主题

```
yarn add gatsby-theme-blog-mdx 
```

### [](#3-add-the-theme-to-our-site)3。将主题添加到我们的网站
...
### [](#4-add-your-page-content)4。添加您的页面内容
...
### [](#5-create-an-author-list)5。创建作者列表
...
### [](#7-run-the-app)7。运行应用程序

运行`gatsby develop`。如果一切顺利，我们可以在浏览器中打开 [http://localhost:8000](http://localhost:8000) ，看到一个简单的页面，上面有一个标题和一个链接，链接到我们的帖子页面(*“见写”*)。

[![index page](../Images/795708de8da576d7b873836ba0337df2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8hXtP2k5--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/m6jlclwuraub23i7xzyb.jpg)

点击链接会把我们带到[http://localhost:8000/blog](http://localhost:8000/blog)，文章列表页面。我们可以看到我们的帖子标题，“你好，世界”。

[![blog/posts page](../Images/b0820afc7610ec300ebaccc0c435eae2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Fr63UT10--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/vlnc2nht6a6u78hbgl5m.jpg)
...
[![single post page](../Images/f32cef6480269a39f6b65f015d632b07.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--P54Iuxmm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/pzhnztom5a88vr8etnks.jpg)

在我们的`hello-world.mdx`中再添加一行，就可以看到页面自动更新了新的内容。

[![hello-world.mdx file with a new line](../Images/cfab2cf05f34999ba015c21bc118533a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--GA_Xi_5Q--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4szfpotdakpp4uxs68g6.png)

[![the single post page with the newly added line, reflecting the change from the mdx file](../Images/f3567236b535c9f2676b694bbab0b63f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--jcKp1vdS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/srzki2nrdg0vugwodwmj.jpg)

我们有自己的博客了！🎉

### [](#8-add-a-cat-optional)8。添加一只猫(可选)
...
[![the blog/post list page with TWO post items, the second post is "Happy Cat"](../Images/2453b4fe6c85a97f6814f59eca9c918a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--W5ke2aA8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/2s7prfoivh2jmgqo7c5y.jpg)

当我们打开帖子页面时，我们可以看到带有 SVG 猫图像的帖子。

[![single post page with content from cat.mdx, with a cartoon cat image](../Images/053f498f678551df821823649b59e4f7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Oy-u_psA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/wsd02nzaj26ab3wi49l5.jpg)
...
## [](#%E2%9B%88-the-winding-path)⛈弯弯曲曲的小路

### [](#-raw-gatsbythemeblog-endraw-the-one-who-got-away)`gatsby-theme-blog`，逃之夭夭的人
...
[![Animated GIF, Garfield the Cat chugging down coffee](../Images/ca8d7031dc83f54397b7d13f20504d7e.png)T2】](https://i.giphy.com/media/pHZ8BDWQhJrvLmL29M/giphy.gif)

<figcaption>A coffee later...</figcaption>

</figure>

### [](#-raw-gatsbythemeblogmdx-endraw-)`gatsby-theme-blog-mdx`

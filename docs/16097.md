...
> 原文:[https://dev . to/jtenner/optimizing-canvasrenderingcontext 2d-function-calls-using-assembly script-4i4b](https://dev.to/jtenner/optimizing-canvasrenderingcontext2d-function-calls-using-assemblyscript-4i4b)
...
## ![GitHub logo](../Images/a73f630113876d78cff79f59c2125b24.png)[jtenner](https://github.com/jtenner)/[canvas-as](https://github.com/jtenner/canvas-as)
...
一个由`AssemblyScript` <g-emoji class="g-emoji" alias="tada" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/1f389.png">驱动的小画布渲染框架🎉</g-emoji>T3】🎉 <g-emoji class="g-emoji" alias="tada" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/1f389.png">🎉</g-emoji>。
...
# [](#starting-from-the-ground-up)从地面开始上升
...
# [](#optimizing-canvasrenderingcontext2d-further)进一步优化 CanvasRenderingContext2D

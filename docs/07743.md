...
> 原文:[https://dev.to/dhilipkmr/imdb-rating-on-mouse-hover-ii-2oa5](https://dev.to/dhilipkmr/imdb-rating-on-mouse-hover-ii-2oa5)

[![](../Images/08de940372d44df2fad8b39e0d50c0e7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--qYIlCb6X--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/a4txwrjzdxt3lvq1xzyw.png)

请阅读第一部分[此处](https://dev.to/dhilipkmr/imdb-rating-on-mouse-hover-1ij6)了解连续性。

### [](#step-4-initiating-listener-in-the-dom-through-contentjs)第四步:通过 content.js 在 DOM 中启动监听器
...
### [](#step-5-find-the-text-inside-the-hovered-element)第五步:找到悬停元素内的文本
...
### [](#step-6-call-imdb-api-from-backgroundjs)第六步:从 background.js 调用 IMDb API
...
### [](#step-7-loading-the-popup)第七步:加载弹出窗口
...
[![](../Images/7dfd534ce3b30d21de885d97d225cfc7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--JzvX_GFd--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/uuhmi5khh4aax881zj51.gif)

关注我获取您订阅源中的有趣内容:)
[![](../Images/bd3469a5957bf738f0c8688211f818d5.png)](https://i.giphy.com/media/4GLrlgJAl9JHq/giphy.gif)

## [](#thats-all-folks-)那都是乡亲:)
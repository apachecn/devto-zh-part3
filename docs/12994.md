...
> 原文:[https://dev.to/damcosset/closures-in-javascript-5feo](https://dev.to/damcosset/closures-in-javascript-5feo)
...
#### [](#fact-one-in-javascript-you-can-refer-to-variables-defined-outside-of-the-current-function)事实一:在 Javascript 中，可以引用当前函数之外定义的变量。
...
#### [](#fact-two-functions-can-refer-to-variables-defined-in-outer-functions-even-after-those-outer-functions-returned)事实二:函数甚至可以引用定义在外层函数中的变量**在**那些外层函数返回之后！
...
#### [](#fact-three-closures-can-not-only-remember-the-variable-in-their-containing-scope-they-can-also-update-it)事实三:闭包不仅能记住其包含范围内的变量，还能**更新**它。

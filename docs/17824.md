...
> 原文:[https://dev.to/gustavo94/digest-of-papers 单子函数式编程-47fp](https://dev.to/gustavo94/digest-of-papers--monads-for-functional-programming-47fp)
...
#### [](#left-unitleft-identity)左单位/左身份
...
#### [](#right-unitright-identity)权利单位/权利身份

...
> 原文:[https://dev . to/morinoko/sending-email-in-rails-with-action-mailer-and-Gmail-35g 4](https://dev.to/morinoko/sending-emails-in-rails-with-action-mailer-and-gmail-35g4)
...
# [](#troubleshooting-email-sending-errors)排除邮件发送错误

由于谷歌的安全特性，上面的配置起初对我不起作用，我得到了`Net::SMTPAuthenticationError`错误。我是这样去上班的。

### [](#account-with-2step-verification)账户两步验证
...
### [](#account-without-2step-verification)账户无两步验证
...
### [](#rails-credentials-issue-with-heroku)Rails 凭证问题与 Heroku

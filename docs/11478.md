...
> 原文:[https://dev . to/mattgrayisok/a-craft-CMS-development-workflow-with-docker-part-1-local-development-24 c8](https://dev.to/mattgrayisok/a-craft-cms-development-workflow-with-docker-part-1---local-development-24c8)
...
[![Local Craft Image Source](../Images/ff52f94d8cd664964ee6e82fc5ca9e5a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--CG4uUYHL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://mattgrayisok.com/uploads/_postImage/231/Screenshot-from-2018-12-04-12-27-41.jpg)

这是非常标准的，只需注意文件系统路径，这是 Craft 将上传文件写入的 PHP 容器内的路径。

保存后，我们可以尝试将图像上传到新的资产源。

[![Local Craft Image Upload Error](../Images/fc58c9e72e5f58d43f612cc9b1cc304e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--tKPnpF4Z--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://mattgrayisok.com/uploads/_postImage/232/Screenshot-from-2018-12-04-12-34-56.jpg)

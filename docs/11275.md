...
> 原文:[https://dev.to/k_penguin_sato/react-hooks-for-noobs-3lao](https://dev.to/k_penguin_sato/react-hooks-for-noobs-3lao)
...
### [](#equivalent-class-component)等效类组件
...
### [](#functional-component-with-state-hook)功能组件与状态挂钩
...
### [](#example-functional-component-using-useeffect)使用 useEffect 的示例功能组件

...
> 原文:[https://dev . to/HANA chin/ruby-27-new-feature-method-reference-operator-38 L2](https://dev.to/hanachin/ruby-27-new-feature-method-reference-operator-38l2)

## [](#20191112-reverted)2019/11/12 已还原
...
## [](#method-reference-operator)方法引用操作符
...
## [](#what-is-raw-method-endraw-method)什么是`method`法？
...
## [](#what-is-raw-method-endraw-object)什么是`Method`对象？
...
## [](#what-is-the-differrence-between-method-reference-operator-raw-endraw-and-raw-method-endraw-method)方法引用操作符`.:`和`method`方法有什么区别？
...
## [](#is-it-possible-to-convert-refined-method-to-raw-method-endraw-)有没有可能将炼法转化为`Method`？
...
## [](#how-to-convert-the-unary-method-to-raw-method-endraw-)如何把一元法转换成`Method`？

...
> 原文:[https://dev . to/2nit/how-to-better-organize-your-git-commits-bkb](https://dev.to/2nit/how-to-better-organize-your-git-commits-bkb)
...
## [](#why-you-should-divide-your-changes-to-many-commits)为什么你应该把你的变更分成许多次提交
...
## [](#so-what-does-add-patch-do)那么 add - patch 是做什么的呢？
...
[![](../Images/7dfb737badd0566feb624ef7705f3313.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Y1ptemJt--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8duwok236ca910vl64qh.png)
...
[![](../Images/94fb3a40efcdca850ec9aea24af4a990.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--xVpX-nyq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/xar5lq87x03xut8yzszg.png)
...
[![](../Images/31f808002f3792d008afd80bd7fec45e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--T3r-0BRd--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/avg4musscsbhvsk20vxq.png)

又一个**猛男**。嗯，我们不要上演这个了，好吗？类型 **n**

[![](../Images/ee27fd6e020c36ec199a1773462c3157.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--bOKeQptP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/j41oq5tpmq39izy14jlq.png)

再说一次，我们不想要这个**大块**...我们现在不想要任何其他的**大块头**加入，我们已经加入了一个，对此我们很高兴。键入 q 表示我们应该跳过这个和所有其他还没有添加的**大块**。我们可以使用 **d** 只从当前文件中跳过**大块**。

[![](../Images/503d6e268cc11c38a5809e73b687d788.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--f2oj7fX2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/yjbdoryt9u9q35hh1j3w.png)

好的，我们有 4 个修改过的文件，其中一个是暂存的。让我们提交并查看我们的日志。

[![](../Images/7badf599dcf2474e56aade5349c4bf4e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--mFY9Td1L--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/fle8ggu3hstttvy9747e.png)

看起来不错，对吧？好的，让我们使用 **git add - patch** 提交所有其他的修改，看看我们的最终产品。

[![](../Images/75f01be3f8ec3d9f9ad01d3da38fd417.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--QVDG5ary--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/5x6w6c72qpdpafx03ft4.png)
...
[![](../Images/6cf04a9844a034aa7c351626eabefd50.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--P3UKIa-B--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/p6qfwwnpq1h1bnwnfsqu.png)
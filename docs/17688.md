...
> 原文:[https://dev . to/s _ anastasov/functional-hangman-in-kotlin-with-arrow-part-2-3knl](https://dev.to/s_anastasov/functional-hangman-in-kotlin-with-arrow-part-2-3knl)
...
## [](#writing-to-the-the-console)写入控制台
...
## [](#reading-from-the-console)从控制台读取
...
## [](#reading-from-the-console-2)从控制台#2 读取

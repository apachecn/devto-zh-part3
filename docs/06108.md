...
> 原文:[https://dev . to/robertohuertasm/AWS-lambda-functions-written-in-rust-3 bob](https://dev.to/robertohuertasm/aws-lambda-functions-written-in-rust-3bob)
...
## [](#lets-build-an-aws-lambda-function)我们来构建一个 AWS Lambda 函数吧！
...
### [](#youre-using-mac-osx)您正在使用 Mac OSX
...
## [](#deploying-the-function)部署功能

让我们通过浏览 [AWS Lambda 控制台](https://console.aws.amazon.com/lambda/home)来**创建一个新函数**。

一旦出现，确保你的屏幕看起来像下图，然后点击**创建功能**:

[![Create function](../Images/8e236863a2bff3ab3c8dafe31524f0e6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--G2cELC5W--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/mteeetd9u3oily28xoqs.png)

然后，在**功能码**部分，上传`.zip file`，按**保存**按钮。

[![Upload zip](../Images/5a3d601e2e9f3ffe5e07c929531d8d19.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--3TCA4RfQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/5gju2yq2dbztqa9obntk.png)
...
[![Test result](../Images/b82f80765f8bb0ae1fe4283306bca956.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--aK1u936e--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/9lc7zku8ji8ufogbw5w7.png)

## [](#exposing-the-function-through-an-api-gateway)通过 API 网关公开功能

现在我们要创建一个新的`API Gateway`，这样我们就可以从互联网上访问我们的功能。

在`Add triggers`部分，选择`API Gateway`。

[![API triggers](../Images/ebfecbc0a7f11ff3cbcdf7667f1a75fa.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--e9cAeZOY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/zwjbv71via02dnueeqm5.png)

然后这样配置触发器，点击`Add`和`Save`:

[![Configure triggers](../Images/764ad71a92d45f353d155f17943d6b36.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--EYolYJwG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/hwc70a7y7xl77u4c7mfj.png)

您应该会看到类似下图的内容:

[![Save API](../Images/e180e6decc7aa36aa762b8625bde3136.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--RCSXjIWJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/vneh40y6egahyawt2xuy.png)

...
> 原文:[https://dev . to/mitchartemis/creating-a-global-configurable-shortcut-for-MAC OS-apps-in-swift-25e 9](https://dev.to/mitchartemis/creating-a-global-configurable-shortcut-for-macos-apps-in-swift-25e9)
...
[![The finished app](../Images/29e9ed3fba5922daf3298c7d7aab6529.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ObhEbakt--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/v431jp7n0s135l91lhsv.gif)

本教程使用 Xcode 10.2 和 Swift 5。

## [](#creating-the-app-windows)创建应用窗口

首先，让我们在 Xcode 中创建一个新的 Mac 项目，我将它命名为`GlobalConfigKeybind`。我们需要确保“MacOS”和“Cocoa App”被选中。在第二个面板中，确保选择了“使用故事板”。

[![](../Images/fa24c91913f49efb5fa0b667614c96b1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Uzo24cFq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/f82lmoz8ul7y8x55kdg1.png)

随着应用程序的创建，我们需要创建首选项窗口。我们可以通过进入`Main.storyboard`，点击库按钮，搜索`Window View Controller`，然后在我们的主窗口旁边拖动一个新的`Window Controller`来完成。

[![Selecting the Window Controller from the Library](../Images/8e8a37d707a29236ab948517ddd207e6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--omA0Nl7w--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/kij3oliz00soiwu2bcdg.png)

[![The layout of the two window view controllers](../Images/e0abb0d1d88b4469e99186b128dfae12.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--paIS2Get--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/79ern54qqe291p8c2k80.jpg)

## [](#linking-the-main-app-window-to-the-preferences-window)将主应用程序窗口链接到偏好设置窗口
...
[![How the Main Window looks](../Images/34d3b99e1e7ae1b234cf56606cd0ae66.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--n_MRvEE0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://fullstackstanley.com/images/DraggedImage.65591179fdbe43dda79c621bd521ed39.jpg)

现在我们有了按钮，但我们需要让它做些什么。按住`ctrl`,同时点击并拖动按钮至新的首选项窗口。首选项窗口将高亮显示。松开鼠标，选择`Show`动作序列。

[![](../Images/f012568e65bd8968f9d21295404ae1a8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--hhdcxwJr--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://fullstackstanley.com/images/DraggedImage.7771b07949c24ea8853d23546efb7fd2.jpg)

现在，单击该按钮将打开首选项窗口。在我们测试它之前，让我们确保当按钮被按下不止一次时，它只打开一个窗口。点击窗口，在`Attributes inspector`中将`Presentation`更改为`Single`。

[![](../Images/16e5566c48134af127f96200fe6b939f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--pJXuzV0P--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://fullstackstanley.com/images/DraggedImage.8ef1b4607e5b44a281864509befff350.jpg)

此时，如果我们运行应用程序并按下 Preferences 按钮，新窗口将会出现。万岁！

[![](../Images/6d87948fa517e78e3d1ca2fc9f695695.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--h4RpFwWR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://fullstackstanley.com/images/Screen%2520Recording%25202019-04-07%2520at%252013.09.24.27cf15a6a98c4836b6f8cbcb7ff1efee.gif)

## [](#installing-hotkey)安装热键
...
[![](../Images/686b07a145a7cf53ff15beb03fc8d7e4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--V2a4iJiU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://fullstackstanley.com/images/DraggedImage.87a77cb71fa4464097a239ee363776fc.jpg)

[![Location of the Cartfile](../Images/4607118fc0346dfb1e3325f258e1852d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--esA6gPL6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://fullstackstanley.com/images/DraggedImage.62dcdf64d69a4ea0b3c45dff11e381cc.jpg)
...
[![Embedding HotKey binary](../Images/ce3febb5c1d091ec05f1c06d72134a04.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--dnSvuEsg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://fullstackstanley.com/images/DraggedImage.b0cd7fa6e2ca464c82adaa6e4c5cfe56.jpg)

## [](#creating-the-keybind-options-interface)创建 Keybind 选项界面。

在`Main.storyboard`中，将两个`Push Button`拖到首选项窗口上。将第二个按钮命名为`Clear`，将`State`设置为禁用。对于第一个按钮，在属性检查器中将标题设定为“设定快捷方式”。

[![](../Images/844e81396269f024bd623a6b8d5324ae.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--diBRwAu6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://fullstackstanley.com/images/DraggedImage.4bbf18458a2f40c689d4e3a5351d177b.jpg)

## [](#adding-the-key-bind-configuration-functionality)添加按键绑定配置功能
...
[![](../Images/5d661d828164cfe458421a07674780d2.png)T8】](https://res.cloudinary.com/practicaldev/image/fetch/s--IuqQCnod--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://fullstackstanley.com/images/DraggedImage.0f531d5af593430cb5a953df10b102ed.jpg)

需要在第一个应用程序窗口上设置`MainWindow`。这将在稍后我们需要将窗口置于最前面时使用。请注意，在下面的截图中，`Window`被突出显示，而不是`Window Controller`。

[![](../Images/ec39a8391ffa74e061e82d386e52a206.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--asZGZXmX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://fullstackstanley.com/images/DraggedImage.3196fb02ea1f4310a9fd142dc98d26d3.jpg)

...
> 原文:[https://dev.to/ferdaber/typescript-and-jsx-part-iii-为一个组件键入道具-1pg2](https://dev.to/ferdaber/typescript-and-jsx-part-iii---typing-the-props-for-a-component-1pg2)
...
#### [](#intrinsic-element-constructors)内在元素构造函数
...
#### [](#function-element-constructors)函数元素构造函数
...
#### [](#class-element-constructors)类元素构造函数

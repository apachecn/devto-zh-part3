...
> 原文:[https://dev . to/oktadev/use-schematics-with-vue-and-add-authentic ation-in-5-minutes-42cm](https://dev.to/oktadev/use-schematics-with-vue-and-add-authentication-in-5-minutes-42cm)
...
## [](#schematics-manipulate-projects-with-code)原理图:用代码操纵项目
...
## [](#build-schematics-with-vue)用 Vue 构建原理图
...
## [](#add-dependencies-with-schematics)添加与原理图的依赖关系
...
## [](#create-copy-and-update-files)创建、复制和更新文件
...
## [](#test-your-bootstrapvue-installer)测试您的 BootstrapVue 安装程序
...
## [](#verify-your-vue-schematic-works)验证您的 Vue 原理图作品
...
## [](#use-vue-schematics-to-add-authentication-with-openid-connect)使用 Vue Schematics 添加 OpenID Connect 认证

运行`vue create vb`，选择**手动选择功能**，选择**打字稿**、 **PWA** 、**路由器**。

[![Vue CLI features](../Images/0ea84288ad44619235c0396d6991d6ac.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--qqT5chyB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://developer.okta.com/assets-jekyll/blog/vue-schematics/vue-cli-features-f25068589b6ef5f056824403385796eaa398a4ab7f2fee4df2b8bdf9685d5ae8.png)

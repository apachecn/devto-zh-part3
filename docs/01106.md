...
> 原文:[https://dev . to/setevoy/AWS-iam-users-keys-rotation-ec2-iam-roles-and-Jenkins-4775](https://dev.to/setevoy/aws-iam-users-keys-rotation-ec2-iam-roles-and-jenkins-4775)

[![](../Images/9cf5c5b689deb4884e18a510f67d47cf.png)](https://res.cloudinary.com/practicaldev/image/fetch/s---dkzETw5--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://rtfm.co.ua/wp-content/uploads/2014/11/aws-logo-square-02-e1417012834176-1.png) 今天，我查看了我们的 IAM 用户,“突然”想起有时更新他们的证书是件好事:

[![](../Images/f91045a3934c0999c9de338c8ea86745.png)T2】](https://rtfm.co.ua/wp-content/uploads/2019/05/Screenshot_20190530_160010.png)
...
### [](#create-an-iam-role)创建一个 IAM 角色

创建一个角色，选择了 EC2 类型:

[![](../Images/cc0dd067af8b1999ef117f82590448e1.png "AWS: ротация ключей IAM пользователей, EC2 IAM Roles и Jenkins")T2】](https://rtfm.co.ua/wp-content/uploads/2019/05/Screenshot_20190530_132113.png)

附加任何策略，这里以*Amazon route 53 readonlyaccess*为例:

[![](../Images/5712a519d18e3b61fc1eb538d74d9479.png "AWS: ротация ключей IAM пользователей, EC2 IAM Roles и Jenkins")T2】](https://rtfm.co.ua/wp-content/uploads/2019/05/Screenshot_20190530_132142.png)

保存您的新角色:

[![](../Images/c3d7e4cf5b48b54dad96a2387c3b3f37.png "AWS: ротация ключей IAM пользователей, EC2 IAM Roles и Jenkins")T2】](https://rtfm.co.ua/wp-content/uploads/2019/05/Screenshot_20190530_132219.png)

### [](#run-ec2)运行 EC2

创建 EC2 实例并设置上面创建的 IAM 角色:

[![](../Images/5799aa5098d4a85be09a3c143cd27394.png "AWS: ротация ключей IAM пользователей, EC2 IAM Roles и Jenkins")T2】](https://rtfm.co.ua/wp-content/uploads/2019/05/Screenshot_20190530_132333.png)
...
[![](../Images/3d25f5c41543364b7415ecd23ad0055b.png "AWS: ротация ключей IAM пользователей, EC2 IAM Roles и Jenkins")T2】](https://rtfm.co.ua/wp-content/uploads/2019/05/Screenshot_20190530_132804.png)

附加先前创建的角色:

[![](../Images/5983944c9d10f3066f4222023a06bbae.png "AWS: ротация ключей IAM пользователей, EC2 IAM Roles и Jenkins")T2】](https://rtfm.co.ua/wp-content/uploads/2019/05/Screenshot_20190530_132822.png)
...
[![](../Images/583807db8f2e1812bfce9e69555a9907.png "AWS: ротация ключей IAM пользователей, EC2 IAM Roles и Jenkins")T2】](https://rtfm.co.ua/wp-content/uploads/2019/05/Screenshot_20190530_141355.png)

运行此作业:

[![](../Images/287252c74af0f9ce43654a369c10908c.png "AWS: ротация ключей IAM пользователей, EC2 IAM Roles и Jenkins")T2】](https://rtfm.co.ua/wp-content/uploads/2019/05/Screenshot_20190530_141456.png)
...
[![](../Images/7e079cfa6fb8be5e71532ac390cf23a3.png "AWS: ротация ключей IAM пользователей, EC2 IAM Roles и Jenkins")T2】](https://rtfm.co.ua/wp-content/uploads/2019/05/Screenshot_20190530_143720.png)

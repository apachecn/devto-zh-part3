...
> 原文:[https://dev.to/johnnymakestuff/cordova-hybrid-apps-如何构建你的代码库-1jpe](https://dev.to/johnnymakestuff/cordova-hybrid-apps---how-to-structure-your-codebase-1jpe)
...
### [](#normal-cordova-app)普通科尔多瓦 app

加载应用程序 UI 的通常方式是使用`file:///`协议在本地加载*。因此，您构建了一个静态网站，将其部署到设备上，WebView 从本地设备的文件夹中加载网站。通过 ajax/sockets 访问服务器。*

[![local](../Images/c8540b414e6d3528eff62fc7f80ad7fd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--iVPfBRGu--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.learningsomethingnew.com/cordova-hybrid/local-loading.png)

### [](#hybrid-cordova-app)混合科尔多瓦 app
...
[![remote](../Images/6b9db98b10c21e734ea6eac0a4ce9d8a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--FHJapV2u--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.learningsomethingnew.com/cordova-hybrid/remote-loading.png)

## [](#breaking-the-link)断链
...
### [](#why-you-dont-want-to-break-the-link)你为什么不想断开链接
...
## [](#a-suggested-architecture)一个建议的架构
...
[![edit](../Images/f1ff854092684a33da2e6f01aaa809d6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--JmiOcJZP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.learningsomethingnew.com/cordova-hybrid/edit-this.png)

### [](#the-generate-task)“生成”任务
...
### [](#comparison-with-embedded-webview-approach)与嵌入式 WebView 方法的比较

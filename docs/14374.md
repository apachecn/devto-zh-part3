...
> 原文:[https://dev . to/rpalo/using-python-to-make-art-with-math-5 add](https://dev.to/rpalo/using-python-to-make-art-with-math-5add)
...
## [](#the-recam%C3%A1n-sequence)雷卡曼序列
...
## [](#introducing-turtle-graphics)引入乌龟图形
...
[![Our first turtle example.  He goes straight and turns left.](../Images/83a6f246a6710ca24dc6f57145f888ca.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--k1fbNL1e--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://assertnotmagic.com/img/turtle-1.png)

*附注:如果你想要真实的、老式的徽标体验，你可以在代码中添加“joe.shape("turtle ")”，就在你定义“joe”的那一行下面他是不是很可爱？*

好了，现在你已经看到了“海龟”是怎么回事，让我们回到我们正在处理的序列。

## [](#coding-the-sequence)编码序列
...
[![Our turtle runs back and forth along a line.](../Images/84e34ce80b2ddbfb0ab27cac5d453d6e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--i-KIjvan--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://assertnotmagic.com/img/recaman1-results.png)
...
[![Our second attempt.  Our turtle spirals around the canvas, but the picture is tiny.](../Images/223bca119ba16fb280edaad7bd46fcbe.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--AWKGVDhk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://assertnotmagic.com/img/recaman2-results.png)
...
[![Our turtle spirals in beautiful, large, interesting circles.](../Images/476b25a5cda8636428687859cb492195.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--oPDsdZuS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://assertnotmagic.com/img/recaman3-results.png)

### [](#further-tweaking)进一步微调
...
## [](#other-incarnations-of-the-sequence)其他化身的序列

...
> 原文:[https://dev.to/lampewebdev/css-line-height-jjp](https://dev.to/lampewebdev/css-line-height-jjp)

CSS 属性定义了两个行内元素之间的间距。典型的用法是，分隔文本。你可以看到人们把它比作“leading ”, leading 是印刷术中使用的一个术语，指的是两行文本基线之间的空间。`line-height`作用不同。它增加了文本上下的空间。

[![leading vs line-height](../Images/3eff9c87314ba143b80b9cd76f26c1c6.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--H1HE9pmw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/lsrnzx1hin6mkqg6fagw.png) 
...
### [](#default-value-and-unitless-value)默认值和无单位值

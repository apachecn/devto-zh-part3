...
> 原文:[https://dev . to/watzon/do-crystal-3-types-types-5 GDF](https://dev.to/watzon/doing-crystal-3-types-types-types-5gdf)
...
## [](#static-vs-dynamic-typing)静态 vs 动态打字
...
## [](#type-declaration-in-crystal)晶体中的类型声明

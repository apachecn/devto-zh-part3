...
> 原文:[https://dev . to/jannikbuschke/exposure-a-query able-API-with-odata-14ef](https://dev.to/jannikbuschke/exposing-a-queryable-api-with-odata-14ef)
...
### [](#pragmatic-cqrs-with-aspnet-core-and-spas-series-overview)具有 ASP.NET 核心的实用 CQRS 和 SPAs -系列概述
...
## [](#adding-a-model-configuration-and-controller)添加型号、配置和控制器

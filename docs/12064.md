...
> 原文:[https://dev . to/renegade coder 94/how-to-sum-elements-of-two-lists-in-python-17c 7](https://dev.to/renegadecoder94/how-to-sum-elements-of-two-lists-in-python-17c7)
...
### [](#merge-two-lists-by-hand)手动合并两个列表
...
### [](#sum-elements-of-two-lists-with-a-comprehension)用一个理解对两个列表的元素求和
...
### [](#sum-elements-of-two-lists-with-a-mapping)用映射对两个列表的元素求和

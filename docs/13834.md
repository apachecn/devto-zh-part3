...
> 原文:[https://dev . to/progress telerik/better-tooling-with-the-new-vue-CLI-3e h8](https://dev.to/progresstelerik/better-tooling-with-the-new-vue-cli-3eh8)
...
## [](#extensible-plugin-system)可扩展插件系统
...
## [](#building-as-web-components)建筑作为 Web 构件
...
## [](#for-more-info-on-vue)有关 Vue 的更多信息:

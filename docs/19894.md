...
> 原文:[https://dev . to/akuryan/sitecore-jss-a-blue-green-node-js-server-configuration-4c2o](https://dev.to/akuryan/sitecore-jss-a-blue-green-node-js-server-configuration-4c2o)
...
## [](#vsts-release-configuration-to-deploy-to-staging-server-and-then-switch-it)VSTS 发布配置部署到暂存服务器，然后切换
...
### [](#cd-and-nodejs-delivery-stage)CD 和 Node.js 交付阶段

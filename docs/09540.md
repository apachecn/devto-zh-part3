...
> 原文:[https://dev.to/michi/let-key-id-0-rest-obj-destructing-to-the-limit-deo](https://dev.to/michi/let--key-id--0-rest---obj---destructuring-to-the-limit-deo)
...
## [](#how-i-ran-into-this-problem)我怎么会碰到这个问题？
...
### [](#assigning-new-variable-names)分配新的变量名
...
### [](#finally-computed-object-properties-names)最后，计算对象属性名称

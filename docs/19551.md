...
> 原文:[https://dev . to/jessicaschuller/write-the-first-script-in-selenium-web driver-Java-code-example-4 nal](https://dev.to/jessicaschuller/write-the-first-script-in-selenium-webdriver-java-code-example-4nal)

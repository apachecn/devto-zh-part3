...
> 原文:[https://dev . to/nphaskins/how-I-integrated-stripe-terminal-with-ruby-on-rails-33pg](https://dev.to/nphaskins/how-i-integrated-stripe-terminal-with-ruby-on-rails-33pg)
...
### [](#discover-readers-to-connect-to)发现读者连接
...
[![animation showing how readers are displayed](../Images/ce2d4252117254bad2e1755aa04bdd53.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--lQLhBeb7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/3hr7hvp3im6xsv1itkjm.gif)

### [](#connect-to-reader)连接阅读器
...
### [](#process-payment-previously-confirm-payment-intent-)处理付款(事先确认付款意向)

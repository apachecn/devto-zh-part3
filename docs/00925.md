...
> 原文:[https://dev . to/3 sanket 3/API-key-authentic ation-for-access-server less-API-at-AWS-API-gateway-lfd](https://dev.to/3sanket3/api-key-authentication-for-accessing-serverless-api-at-aws-api-gateway-lfd)
...
## [](#first-make-the-endpoints-private)首先，使端点私有
...
## [](#list-the-api-key-names-in-serverlessyml)列出 serverless.yml 中的 API 键名
...
[![specifying only api key names](../Images/c8ace1cb8460d62aa67e5360cf528a2a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8BOMobxK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/80i7jdxgurtk5jmpn4kn.png)

## [](#if-you-explicitly-want-to-specify-the-api-key)如果你明确想要指定 API 键
...
[![explicitly assigned value](../Images/fc4c10d4dc1aaeae1d0c519b53d1c510.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--o-u9M3HX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/obdvk2j8f7svruw89opq.png)
...
## [](#append-the-stage-to-the-api-key-name)将阶段追加到 API 键名
...
[![specify stage in api key name](../Images/857a93b2a621ec33c1f27d157cf00112.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--VrZGnFYw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/1fsea17skatrepuu7ijh.png)

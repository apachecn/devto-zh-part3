...
> 原文:[https://dev . to/azure/using-azure-pipelines-to-build-test-and-deploy-a-spring-boot-and-angular-application-3-7-593j](https://dev.to/azure/using-azure-pipelines-to-build-test-and-deploy-a-spring-boot-and-angular-application-3-7-593j)
...
## [](#deploying-a-spring-boot-application-to-azure)将 Spring Boot 应用部署到 Azure
...
## [](#creating-an-azurepipelinesyml-file)创建 azure-pipelines.yml 文件
...
## [](#deploying-automatically-with-azure-pipelines-to-azure-web-app)通过 Azure 管道自动部署到 Azure Web App
...
## [](#push-the-application-to-github-and-set-up-azure-pipelines)将应用推送到 GitHub，设置 Azure 管道
...
[![](../Images/0724d2268b53dc11e30b09ea921e1e63.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--XCnKNBfe--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/q27e3nh7d72rnwmzgsm1.png)

## [](#deploy-the-application-to-azure-web-app)将应用程序部署到 Azure Web App
...
[![](../Images/e6d93f5520ec9bacf5841db41778541d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Ct1BE3xr--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/rcmgox3wf7fpd10kf0zb.png)
...
[![](../Images/7dd14f7de20ca389d537b35d3a64d05a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--mJ_U9fp9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/5qd6s9271qoyq2z526xw.png)

现在，每次我们的构建通过时，我们的应用程序将被自动部署到生产中，在那里它将由 Azure Web Apps 自动管理。不再有生产问题，只需“git push”即可完成！

## [](#startup-time-considerations-and-budgets)启动时间的考虑和预算

...
> 原文:[https://dev . to/oktadev/easy-single-sign-on-with-spring-boot-and-oauth-2-0-13ig](https://dev.to/oktadev/easy-single-sign-on-with-spring-boot-and-oauth-2-0-13ig)
...
## [](#set-up-your-app-for-next-level-single-signon-with-oauth-and-openid-connect)使用 OAuth 和 OpenID Connect 为您的应用程序设置下一级单点登录
...
## [](#use-spring-boots-oauth-integration-for-single-signon)使用 Spring Boot 的 OAuth 集成进行单点登录
...
## [](#learn-more-about-secure-single-signon-oauth-20-and-spring-boot)了解有关安全单点登录、OAuth 2.0 和 Spring Boot 的更多信息

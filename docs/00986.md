...
> 原文:[https://dev . to/oktadev/simple-authentic ation-with-spring-security-n4c](https://dev.to/oktadev/simple-authentication-with-spring-security-n4c)
...
## [](#requirements-and-assumptions-for-authentication-with-spring-security)使用 Spring Security 进行认证的要求和假设
...
### [](#spring-security-authentication-with-okta)春天与 Okta 的安全认证
...
## [](#download-the-spring-security-example-apps)下载 Spring 安全示例应用程序
...
## [](#dive-into-basic-authentication-with-spring-security)深入了解 Spring Security 的基本认证
...
## [](#stepup-to-formbased-authentication-with-spring-security)升级到基于表单的 Spring 安全认证
...
## [](#finish-up-your-spring-boot-spring-security-app-with-authentication)完成 Spring Boot + Spring 安全应用的认证

...
> 原文:[https://dev.to/robbinespu/fedora-30-after-install-setup-f56](https://dev.to/robbinespu/fedora-30-after-install-setup-f56)
...
### [](#3-restore-bashrc-and-metadata-files)3。恢复 bashrc 和元数据文件
...
### [](#4-install-rpm-fusion-repository-and-get-most-recent-update)4。安装 RPM 融合存储库并获取最新更新
...
### [](#6-performance-monitoring-tools-for-linux)6。Linux 性能监控工具

[![](../Images/2f82a3e92d7cfb7d55a3e9dc38761a4d.png "Htop FTW")](https://res.cloudinary.com/practicaldev/image/fetch/s--XK5CdLP3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/WwGQ0Q4.png%23center)T3】Htop 监控工具
...
### [](#7-entertaiment-stuff-player-and-codecs)7。娱乐材料:播放器和编解码器
...
### [](#8-gnome-plugin-and-addons)8。Gnome 插件和附件
...
### [](#10-gnome-tweak-tool)10。Gnome 调整工具

有些功能是隐藏的，在标准设置中不可用，如自动启动(当机器打开时，您需要它来自动启动复印)。

[![](../Images/52c67df282635eb16ae92715ea50059e.png) ](https://res.cloudinary.com/practicaldev/image/fetch/s--XLTpBUrI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/fjTGiA6.png%23center) *开机时自动启动 CopyQ Fedora*
...
### [](#12-compression-and-archiever-tools)12。压缩和归档工具

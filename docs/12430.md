...
> 原文:[https://dev . to/geo cine/getting-started-with-gatsbyjs-and-WordPress-1k2k](https://dev.to/geocine/getting-started-with-gatsbyjs-and-wordpress-1k2k)
...
## ![GitHub logo](../Images/292a238c61c5611a7f4d07a21d9e8e0a.png) [盖茨比中央](https://github.com/GatsbyCentral) / [盖茨比-starter-wordpress](https://github.com/GatsbyCentral/gatsby-starter-wordpress)
...
## [](#connecting-to-our-wordpress-site)连接我们的 WordPress 网站
...
## [](#integrating-our-htmlcss-template)集成我们的 HTML/CSS 模板

...
> 原文:[https://dev . to/jast kand/how-to-stub-an-upload-request-to-Google-API-using-web mock-32oo](https://dev.to/jastkand/how-to-stub-an-upload-request-to-google-api-using-webmock-32oo)

...
> 原文:[https://dev . to/calvinal len/using-editor config-in-visual-studio-to-create-discovery-standards-4eei](https://dev.to/calvinallen/using-editorconfig-in-visual-studio-to-create-discoverable-standards-4eei)

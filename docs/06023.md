...
> 原文:[https://dev . to/hasura HQ/create-a-real-time-web-app-with-hasura-and-Gatsby-41fi](https://dev.to/hasurahq/create-a-real-time-web-app-with-hasura-and-gatsby-41fi)
...
# [](#integrating-hasura-graphql-into-gastby)将 Hasura GraphQL 集成到 Gastby 中

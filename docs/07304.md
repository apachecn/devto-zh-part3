...
> 原文:[https://dev . to/app signal/learning-by-building-a-background-processing-system-in-ruby-3 onb](https://dev.to/appsignal/learning-by-building-a-background-processing-system-in-ruby-3onb)
...
## [](#implementing-asynchronous-processing)实现异步处理
...
## [](#expanding-to-multiple-processes-and-machines)扩展到多个流程和机器
...
## [](#enjoy-responsibly-and-dont-use-this-in-production)负责任地享受，不要把这个用在生产上

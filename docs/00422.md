...
> 原文:[https://dev . to/Stephen Weiss/incremating-state-in-functional-components-5fka](https://dev.to/stephencweiss/incrementing-state-in-functional-components-5fka)
...
# [](#react-hooks-version)React 钩子版本
...
# [](#react-class-component-version)React 类组件版本

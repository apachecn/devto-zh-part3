...
> 原文:[https://dev . to/browser London/moderning-our-hosting-infra structure-what-we ve-learn-5c 75](https://dev.to/browserlondon/modernising-our-hosting-infrastructure-what-weve-learnt-5c75)
...
## [](#applying-discovery-to-hosting-infrastructure-changes)将发现应用于托管基础架构变更
...
<figure>[![A team stand around and watch a presentation about updating the Browser hosting platform and infrastructure](../Images/5d9ef843a8370d30e999adeaea3301cf.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--RUQkf3AX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://assets.browserlondon.com/app/uploads/2019/01/team-presentation-1024x768.jpg) 
...
#### [](#1-standardise-deployment-processes)1。标准化部署流程
...
#### [](#2-improve-efficiency-and-raise-performance)2。提高效率和性能

由于不同的项目依赖于不同的外部服务(及其版本)，我们的项目部署效率低下。由于特定软件版本的依赖性，一些项目需要他们自己的虚拟服务器，这分散了我们的主机预算，而不是为我们所有的客户部署更好的性能。

#### [](#3-create-opportunities-for-crosstraining-and-project-review)3。为交叉培训和项目评审创造机会
...
## [](#our-technical-approach)我们的技术方法
...
[![Docker logo blue on grey](../Images/5aa4068ce5ae79e4b94bc29682851206.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--HhRmQtC1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://assets.browserlondon.com/app/uploads/2019/01/Docker-logo-1024x444.png)
...
#### [](#improved-performance-amp-security)性能提升&安全

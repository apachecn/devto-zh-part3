...
> 原文:[https://dev . to/radix DLT/future-developments-decentralized-identity-2 emo](https://dev.to/radixdlt/future-developments-decentralized-identity-2emo)
...
# [](#cryptographic-identifier-cid)密码标识符(CID)

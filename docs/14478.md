...
> 原文:[https://dev . to/Marcel _ cremer/the-icon-evolution-and-how-I-switched-from-font-based-icons-to-SVG-11bm](https://dev.to/marcel_cremer/the-icon-evolution-and-how-i-switched-from-font-based-icons-to-svg-11bm)
...
### [](#the-evolution-of-icon-sets)图标集的演变
...
### [](#reasons-to-use-svg-based-icon-sets)使用基于 SVG 的图标集的原因
...
### [](#my-personal-decisions-javascript-vs-angular-implementation-vs-sprites)我个人的决定:JavaScript vs 角度实现 vs 精灵
...
```
<svg class="fi"><use xlink:href="/assets/feather/feather-sprite.svg#user" /></svg> 
```

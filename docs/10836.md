...
> 原文:[https://dev . to/kontrollanten/combine-coverage-reports-from-electronic-tests-1if 6](https://dev.to/kontrollanten/combine-coverage-reports-from-electron-tests-1if6)
...
# [](#coverage-report-with-jest)用笑话报道

因为 jest 有现成的覆盖支持，所以唯一需要的就是`yarn jest --coverage`。简单。

# [](#coverage-report-with-electronmocha)报道用电子摩卡
...
[![](../Images/7a4ed9e7b41b316c22caec8b0d38eeed.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--QTKlGJUC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8gi6wi6zbm81494rwg2d.png)

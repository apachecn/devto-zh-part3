...
> 原文:[https://dev.to/vitalipom/perl-handbook 变量数组列表哈希内存引用 44 - 13pk](https://dev.to/vitalipom/perl-handbook--variables-arrayslists-hashes-and-memory-references-44---13pk)

### [](#variables-arrayslists-hashes-and-memory-references)变量、数组/列表、散列和内存引用
...
## [](#dereferencingreferencing-closer-look)解除引用/引用仔细看
...
# [](#go-for-it-you-have-it)去争取吧，你拥有了！

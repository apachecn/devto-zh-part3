...
> 原文:[https://dev.to/mrturkmen/elasticsearch-performans-2d1f](https://dev.to/mrturkmen/elasticsearch-performans-2d1f)
...
[![](../Images/b56424445af2539398fc4c845dbbdb54.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ons-UmAr--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://mrturkmen06.github.io/assets/images/figure_1.png)
...
#### [](#paralel-bulk-indeksleme)并行批量索引
...
#### [](#swap-alan%C4%B1n%C4%B1-kald%C4%B1rmak-sunucu-%C3%BCzerindeki)移除交换空间。(伺服器上)
...
#### [](#jvm-heap-alan%C4%B1n%C4%B1-art%C4%B1rmak)JVM 堆空间的增加
...
#### [](#bu-%C3%A7al%C4%B1%C5%9Fma-esnas%C4%B1nda-yararlan%C4%B1lan-kaynaklar)此工作中使用的资源

...
> 原文:[https://dev . to/setevoy/arch-Linux-安装-故障排除-玩-eve-online-871](https://dev.to/setevoy/arch-linux-installation-troubleshooting-and-playing-eve-online-871)

[![](../Images/9784b61222c0d3b6a1a5320be0f28709.png)](https://rtfm.co.ua/wp-content/uploads/2018/04/archlinux_logo.png) 在我的新 Arch Linux 系统上成功安装 WoT 之后(参见[坦克世界:在 Arch Linux 上安装和运行](https://dev.to/setevoy/world-of-tanks-installing-and-running-on-arch-linux-ofo)帖子)我决定“实现下一个里程碑”——在线安装 eve。
...
### [](#installing-eve-online-for-linux)为 Linux 安装 EVE Online
...
[![](../Images/0ebdf59d29a0e23d5c201da524665bba.png "Arch Linux: установка, попытки фиксов и таки игра в EVE Online")T2】](https://rtfm.co.ua/wp-content/uploads/2019/03/Screenshot_20190302_201125.png)

[![](../Images/2d55cf35a9b6c0ff79d4c5a7e5d2d218.png "Arch Linux: установка, попытки фиксов и таки игра в EVE Online")T2】](https://rtfm.co.ua/wp-content/uploads/2019/03/Screenshot_20190302_201217.png)
...
#### [](#securityconnectorcc-could-not-get-default-pem-root-certs)security_connector.cc 无法获取默认 pem 根证书
...
#### [](#lutrisnet)lutris.net

通过耳朵，我找到了 lutris.net 项目，它也提供 EVE 在线安装，但是它对我来说并不奏效。

#### [](#path-override-failed-for-key-uidirlocales-and-path-homesetevoyqtwebengineprocess)关键字 ui::DIR_LOCALES 和路径“/home/setevoy/”的路径覆盖失败。' QtWebEngineProcess '
...
#### [](#wine-windows-xp-vulkan-and-directx11)Wine Windows XP、Vulkan 和 DirectX11

然后我在 Arch Linux 论坛上搜索了讨论和这个评论。

检查`wine`的设置——已经设置了 Windows XP 模式:

[![](../Images/cf802b9df4deac007b59d2cacbf79d05.png "Arch Linux: установка, попытки фиксов и таки игра в EVE Online")T2】](https://rtfm.co.ua/wp-content/uploads/2019/03/Screenshot_20190303_162504.png)
...
### [](#installation-with-evelauncher1456374exe-oo)安装用……EveLauncher-1456374.exe？哦哦
...
[![](../Images/9b8a25e742999f92380313b3842c8d11.png "Arch Linux: установка, попытки фиксов и таки игра в EVE Online")T2】](https://rtfm.co.ua/wp-content/uploads/2019/03/Screenshot_20190304_175842.png)

为此 EVE 的设置创建一个新目录:

[![](../Images/a02ee4c7d093711d529eecff37545fca.png "Arch Linux: установка, попытки фиксов и таки игра в EVE Online")T2】](https://rtfm.co.ua/wp-content/uploads/2019/03/Screenshot_20190304_175924.png)

[![](../Images/210f2de5a744644ff098f05b53f8e941.png "Arch Linux: установка, попытки фиксов и таки игра в EVE Online")T2】](https://rtfm.co.ua/wp-content/uploads/2019/03/Screenshot_20190304_180000.png)

登录:

[![](../Images/03c1e44953644631e6f2fbb80e002bc1.png "Arch Linux: установка, попытки фиксов и таки игра в EVE Online")T2】](https://rtfm.co.ua/wp-content/uploads/2019/03/Screenshot_20190304_180053.png)

而且——它有效！

[![](../Images/3c6e3fdf5a54f91962261d4150304c39.png "Arch Linux: установка, попытки фиксов и таки игра в EVE Online")T2】](https://rtfm.co.ua/wp-content/uploads/2019/03/Screenshot_20190304_180350.png)

...
> 原文:[https://dev.to/helenanders26/sql-series-from-a-to-z-2pk9](https://dev.to/helenanders26/sql-series-from-a-to-z-2pk9)
...
[![helenanders26](../Images/a0d1b41c96c04d34ab697b9304156601.png)](/helenanders26) [## 没有文氏图的 SQL 连接
...
[![johndougherty68](../Images/0043ba889cd873c9f48b01a93dddc770.png)](/johndougherty68) [## 数据库事务，就像你五岁时一样
...
[![chidioguejiofor](../Images/19574b109b5cbc2ec77b6d99d4bfa4a6.png)](/chidioguejiofor) [## CTE 怎么了
...
[![Alt Text](../Images/9ea2b38a225845716614784ff317c821.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Ue0J4VG2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://dev-to-uploads.s3.amazonaws.com/i/in90kvm3zj8rm9sbuafw.png)

<center>*Attribution: SqlPac at English Wikipedia*</center>

雪花是相似的，但是在维度上更进了一步。我们可能有一个城市、国家甚至邮政编码表，而不仅仅是一个位置表。所有的维度都变成了雪花上的点。

[![Alt Text](../Images/aaefd615cda358547974b368eab1bf11.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--tLvBWeFe--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://dev-to-uploads.s3.amazonaws.com/i/pqjymxanga0jkl2qlt62.png)

<center>*Attribution: SqlPac at English Wikipedia*</center>

阅读更多关于两者优缺点的信息:

[![pedrojmfidalgopt](../Images/2c5fdfba48d7c95128ff145e2df3d167.png)](/pedrojmfidalgopt) [## 星型模式与雪花型模式，以及为什么要关注它们
...
[![seattledataguy](../Images/27ac423e0a8e91e0b76c9274bcbec552.png)](/seattledataguy) [## 数据工程 101:从批处理到流
...
[![samuyi](../Images/53e2297a33965a1095c97fb052859ba6.png)](/samuyi) [## POSTGRESQL 存储函数(PL/pgSQL)入门
...
[![griffinator76](../Images/c898588ac84e1d5f368177abe44b78b9.png)](/griffinator76) [## SQL:像老板一样汇总
...
[![indexes1](../Images/f1573bf4e01b2204b0d8daabd0b3612d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--SzOdC3Hp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/y7yo2tivweq1dsu763ie.PNG)

*   **非聚集索引**就像一本书的索引，页面没有按照物理方式排列，但是你现在可以通过查找来更快地找到你需要的内容。

[![indexes2](../Images/601d19ac45105a538ede68a88d80fd5e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--lBIoytMy--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/cn0p49zsmec3x1zenlf5.PNG)

阅读这篇初学者友好的文章:

[![mdgale](../Images/2f449d785777cba23ed008fbce57fc9f.png)](/mdgale) [## 我们不都是 DBA:开发人员的索引
...
[![adammc331](../Images/b17625581ad7ee5ec94e763af93e7ee0.png)](/adammc331) [## 有效的数据库设计:第 1 部分
...
[![inner](../Images/327a48f7369b96ecfaadec612513413e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--RJnMgyP0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4awenpvfcedaz8t7ldx8.PNG)

当您希望在两个表之间查找匹配项时，可以使用左连接，但是如果右表中没有匹配项，则显示 NULL。右连接做同样的事情，但方向相反。

像内部连接一样，您需要一个列来连接。与内部连接不同，NULL 用于表示两个表之间不匹配。

[![outer](../Images/b45b75be4e8ef5257d3ab59ce4984403.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--qjtkFpj0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/rnhge20cokfe29jol171.PNG)

Katie 写了一篇关于“你需要的每一个连接”的很棒的文章，重点是 Oracle 语法。

[![katiekodes](../Images/91ff852c8568473209156ff5bd632209.png)](/katiekodes) [## 您需要的每一个 SQL 连接
...
[![leniquenoralez](../Images/574333027393fa56d2977cedcaa05f21.png)](/leniquenoralez) [## 面向应用开发的数据库管理系统:关系模型和关系数据库
...
[![Tech Elevator](../Images/60dbe8f82d6c8f731a7da84274458485.png)![](../Images/473bc229b0b018b279e2ae5abc6e8f95.png)](/techelevator) [## SQL Server 锁定
...
## [](#massive-parallel-processing)海量并行处理
...
[![gladuz](../Images/a86a25c07ca0d979bfbd13d3430aa391.png)](/gladuz) [## ELI5:什么是数据库规范化？
...
[![vikastwittes](../Images/7b1e35b2686bfa4ee9b0b53c9b96c431.png)](/vikastwittes) [## 借助内存 OLTP 系统革新 SQL Server 的性能
...
[![lmolivera](../Images/be7a526ea9e5e91fb5fc2972434333bc.png)](/lmolivera) [## 关于(关系)数据库您需要知道的一切
...
[![Alt Text](../Images/20269437327e2c8a8a6fc22aff00211f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--keCL0AKJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://dev-to-uploads.s3.amazonaws.com/i/22mek5y6qjzfp75qbo77.png)
...
[![calebhearth](../Images/c845d5d22659336c01028899f4871b04.png)](/calebhearth) [## 阅读 Postgres 解释分析查询计划
...
[![thamaraiselvam](../Images/cf85ba04c1dec24192332bb84df582e7.png)](/thamaraiselvam) [## 对数据库复制的需求
...
[![YugabyteDB](../Images/3e56bf34ce24f71b07b95e08a513c54c.png)![](../Images/c81482ddb7d73534223f440f3987388e.png)](/yugabyte) [## SQL 提示和技巧:计算行数
...
[![l0l0l0l](../Images/7be68838462225fc2e6db52b1dfd8aff.png)](/l0l0l0l) [## SQL-概述和命令类型
...
[![union](../Images/9de36b3538b5216a50fbfa816fa719e9.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--eEMklGVI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/76x161yx9qx01nw5wihc.PNG)T3】
...
[![unionall](../Images/07b6be913f48a1e9349a197a64ec163b.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--ewN3fWwl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/eypfji1dzlvquhhaccn0.PNG)T3】
...
[![thatjoemoore](../Images/6086d98e9b5d64e502c98e1ae3eb13a3.png)](/thatjoemoore) [## 数据库视图实际上并不存在
...
<svg width="20px" height="20px" viewBox="0 0 24 24" class="highlight-action crayons-icon highlight-action--fullscreen-on"><title>Enter fullscreen mode</title></svg> <svg width="20px" height="20px" viewBox="0 0 24 24" class="highlight-action crayons-icon highlight-action--fullscreen-off"><title>Exit fullscreen mode</title></svg>[![kaysauter](../Images/0800d6382fa6c16a9b92768ba0854528.png)](/kaysauter) [## SQL Server 上的窗口函数介绍
...
[![booyaa](../Images/0856925e87024eeeb56184e23bf8ed45.png)](/booyaa) [## SQL Developer 的新格式提示
...
[![Retool](../Images/496ea84da4a58c52ecd370a1c0992541.png)![](../Images/10bf284b0bb663cf55b0250389e66801.png)](/retool) [## SQL 中日期的格式化和处理
...
<svg width="20px" height="20px" viewBox="0 0 24 24" class="highlight-action crayons-icon highlight-action--fullscreen-on"><title>Enter fullscreen mode</title></svg> <svg width="20px" height="20px" viewBox="0 0 24 24" class="highlight-action crayons-icon highlight-action--fullscreen-off"><title>Exit fullscreen mode</title></svg>[![yuyabu](../Images/6ff4a9c2cf8493f7b3baba246fc475fc.png)](/yuyabu) [## SQL:如何在没有“IS NULL”运算符的情况下与 NULL 比较

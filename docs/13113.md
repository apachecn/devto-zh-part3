...
> 原文:[https://dev . to/xnimorz/dealing-with-event-handlers-in-react-540j](https://dev.to/xnimorz/dealing-with-event-handlers-in-react-540j)
...
### [](#part-1-event-handlers-caching-and-code-readability)第一部分。事件处理程序、缓存和代码可读性
...
#### [](#why-its-important-to-understand-how-functions-are-passed-to-the-prop)为什么理解函数如何传递给道具很重要？
...
### [](#part-2-using-event-handlers-in-function-components)第二部分。在函数组件中使用事件处理程序
...
### [](#part-3-synthetic-events)第三部分。合成事件

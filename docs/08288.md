...
> 原文:[https://dev . to/evil Marshall/active-storage-meets-graphql-direct-uploads-3n 38](https://dev.to/evilmartians/active-storage-meets-graphql-direct-uploads-3n38)

*Part 2 可用[此处](https://dev.to/evilmartians/active-storage-meets-graphql-pt-2-exposing-attachment-urls-2mdn)T3】*

## [](#happy-code-for-happy-people)快乐的代码给快乐的人
...
## [](#life-before-active-storage)主动储存前的寿命
...
[![direct uploads diagram](../Images/c7d0763208f141be563c003f6016bf83.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--pFzuQucc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/6rv1ggpwgqi307zzbwxh.png)
...
### [](#-raw-createdirectupload-endraw-mutation)`createDirectUpload`突变...

<figure>

[![mutation preview in GraphiQL](../Images/38e5649b7565075e252237306f53f35b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Zk74RICj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/re3jrbepmk0u4zxd0t97.png)
...
### [](#and-some-javascript)...和一些 JavaScript
...
## [](#in-conclusion-or-what-to-do-with-raw-signedblobid-endraw-)总之，还是怎么处理`signedBlobId`

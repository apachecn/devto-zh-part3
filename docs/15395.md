...
> 原文:[https://dev . to/yurkaniryan/let-fal-in-love-with-react-fiber-1fak](https://dev.to/yurkaninryan/lets-fall-in-love-with-react-fiber-1fak)
...
## [](#react-before-fiber-was-like-working-at-a-fast-paced-company-without-git)在光纤出现之前的反应就像是在一家快节奏的公司工作，没有 git。
...
## [](#react-internals-in-a-nutshell%C2%A0)概括地反应内部情况🥜

您创建了一个组件树。React 获取这棵树，遍历它，并创建最终结果的虚拟模型。也许你是渲染到 DOM，也许你是针对 native。此时，反应过来也没关系。

<figure>

[![](../Images/434eea735db86ce3ec1a0edfe7eacfd9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--GNdwUQj7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2ALZzl0FxVvinV2zLjqJQeaA.png)
...
## [](#how-does-it-work-at-a-high-level)(高层)如何运作？
...
[![](../Images/799d4fc411dc939be457fb209643573c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8kE7A8h0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/0%2AOoDfQ7pzAqg6yETH.)

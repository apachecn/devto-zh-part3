...
> 原文:[https://dev . to/sophiedebenedetto/understanding-recursion-with-elixir-11o 2](https://dev.to/sophiedebenedetto/understanding-recursion-with-elixir-11o2)
 ...
 *## [](#building-a-recursive-function-with-elixir)用仙丹构建递归函数
...
### [](#using-recursion-on-a-list)在列表上使用递归
...
### [](#defining-a-recursive-raw-deleteall2-endraw-function)定义一个递归`delete_all/2`函数

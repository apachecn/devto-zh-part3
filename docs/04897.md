...
> 原文:[https://dev.to/samerickson/sharing-your-dotfiles-448h](https://dev.to/samerickson/sharing-your-dotfiles-448h)

## [](#why-everyone-should-have-their-own-dotfile-repository)为什么每个人都应该有自己的点文件库
...
## [](#getting-started-with-dotfiles)点文件入门
...
### [](#step-1-install-my-dotfiles-repository-skip-if-you-prefer-to-use-your-own)第一步:安装我的点文件库(如果您喜欢使用自己的库，请跳过)
...
### [](#step-2-setting-up-your-personal-repository)第二步:设置个人存储库
...
### [](#step-3-adding-your-files)第三步:添加您的文件
...
### [](#step-4-setup-the-github-side-of-things)第四步:设置 Github 端的东西

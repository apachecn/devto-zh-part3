...
> 原文:[https://dev . to/davinaleong/resolutions-to-setup-issues-with-craft-on-ampps-2of 1](https://dev.to/davinaleong/resolutions-to-setup-issues-with-craft-on-ampps-2of1)

这是我关于**工艺介绍**的帖子的后续。

[![davinaleong](../Images/6bbb66b1fe2e3e8581ac733da5da702f.png)](/davinaleong) [## 工艺介绍
...
# [](#a-getting-craft-working-on-ampps-on-mac)答:让 Craft 在 Mac 上运行 AMPPS
...
*   将您在步骤(4)中复制的路径粘贴到**路径**字段中。填写后的表单应该是这样的:![AMPPS add new alias](../Images/7acf3ef8b96967a32c32a9c849eeba44.png)点击**创建别名**
*   要进行测试，请确保 AMPPS 正在运行，然后导航至`http://localhost/my-craft-project`。你可以看到欢迎页面，或者你的主页，如果你设置了的话。

* * *

# [](#b-plugin-store-fails-to-load)B:插件存储加载失败

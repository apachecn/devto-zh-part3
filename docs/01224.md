...
> 原文:[https://dev.to/pubnub/create-a-chat-app-in-react-5bb3](https://dev.to/pubnub/create-a-chat-app-in-react-5bb3)
...
T3![react hooks chat gif](../Images/d2b1295c4f8b523f8c683b036eadf2cd.png)T5】

## [](#pubsub-and-retrieving-history)发布/订阅并检索历史记录
...
### [](#how-to-install-reactjs-and-pubnub)如何安装 React.js 和 PubNub
...
## [](#why-use-react-hooks)为什么要用 React 钩子？
...
## [](#create-a-custom-react-hook)创建自定义 React 挂钩
...
## [](#designing-our-react-components)设计 React 组件
...
## [](#setting-up-app-component-state-with-react-hooks)设置 App 组件:用 React 钩子状态
...
## [](#setting-up-pubnub-in-react)在 React 中设置发布块
...
## [](#creating-react-event-handlers)创建 React 事件处理器
...
## [](#navigating-between-previous-channels)在之前的频道间导航
...
## [](#using-jsx-to-create-a-react-ui)使用 JSX 创建 React UI
...
### [](#log-and-message-design)日志和消息设计

...
> 原文:[https://dev . to/oktadev/build-a-rest-API-with-ASP-net-we b-API-3421](https://dev.to/oktadev/build-a-rest-api-with-asp-net-web-api-3421)
...
## [](#create-an-aspnet-web-api-2-project)创建一个 ASP.NET Web API 2 项目
...
## [](#create-a-resource-and-the-aspnet-web-api-actions)创建资源和 ASP.NET Web API 动作
...
## [](#secure-your-restful-aspnet-web-api)保护您的 RESTful ASP.NET Web API
...
## [](#register-the-client-application-for-your-rest-api)为 REST API 注册客户端应用程序
...
## [](#add-authentication-to-your-rest-api)向您的 REST API 添加认证
...
## [](#learn-more-about-rest-apis-and-aspnet-web-api)了解更多关于 REST APIs 和 ASP.NET Web API 的信息

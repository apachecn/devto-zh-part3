...
> 原文:[https://dev . to/water link/how-to-try-kot Lin-in-Java-back end-code base-without-risk-1ecc](https://dev.to/waterlink/how-to-try-kotlin-in-java-backend-codebase-without-risk-1ecc)
...
## [](#mixing-java-and-kotlin-code)混合 Java 和 Kotlin 代码
...
[![Open Find Action tool, type convert to kotlin, press enter, and see the file fully convert to kotlin automatically](../Images/b2175f3721414292c7afc32909932453.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--AkLHoOL_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://iwillteachyoukotlin.com/wp-content/uploads/2019/01/how-to-try-kotlin-simple-conversion.gif)
...
## [](#add-kotlin-support-to-gradle)给 Gradle 添加 Kotlin 支持
...
## [](#1-use-elvis-operator-instead-of-most-null-checks)1。使用 Elvis 运算符代替大多数空支票
...
## [](#2-convert-raw-optional-endraw-s-to-nullable)2。将`Optional` s 转换为可空
...
## [](#3-make-junit-test-names-more-readable)3。让 JUnit 测试名称更易读
...
## [](#4-use-raw-lateinit-endraw-instead-of-nullable)4。使用`lateinit`代替可空
...
[![a lot of warnings about unnecessary non-null (!!) assertion](../Images/932387c355da92ed379f42e9d766e4c3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--WCk2ZC_8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://iwillteachyoukotlin.com/wp-content/uploads/2019/01/how-to-try-kotlin-unnecessary-non-null-assertion-1024x497.png)

当然，我们可以手动修复它们，但这些是工具应该为我们修复的事情。

他们做到了，看:

[![use intent actions menu and select remove unnecessary non-null assertion, it removes !! automatically](../Images/7449d76ed087c6cfcadc80f483c124ec.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--bhFxvWqe--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://iwillteachyoukotlin.com/wp-content/uploads/2019/01/how-to-try-kotlin-remove-unnecessary-non-null-assertion.gif)

尽管如此，仔细检查每一次事件还是很烦人的。所以我们应该对整个文件进行代码清理:

[![use find action tool and type code cleanup, the tool window shows up, select a single file only there, and proceed, all unnecessary non-null assertions disappear from the whole file](../Images/d1efc8e278ef3d1e95ef8ecc23184f0f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Q345Mx9f--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://iwillteachyoukotlin.com/wp-content/uploads/2019/01/how-to-try-kotlin-code-cleanup.gif)

## [](#5-use-named-arguments-for-readability)5。使用命名参数以提高可读性
...
[![use intent actions menu and choose to add names to call arguments, every argument now is named](../Images/de6228a433ff40179e92b6d2f724aa08.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--2UJ237uv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://iwillteachyoukotlin.com/wp-content/uploads/2019/01/how-to-try-kotlin-add-names-to-call.gif)
...
## [](#6-there-is-so-much-more-you-can-improve)6+。你还有很多可以改进的地方！
...
## [](#trying-out-without-any-risks-whatsoever)没有任何风险的尝试

现在，如果我决定不切换到 Kotlin(例如，因为我仍然需要说服我的同事)，我可以使用 IDE 的`Local History`功能及时回到我开始玩 Kotlin 的时候:

[![local history tool window](../Images/73e849d766b76942c9f191e82452f16e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Y94kowtU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://iwillteachyoukotlin.com/wp-content/uploads/2019/01/how-to-try-kotlin-local-history-1024x548.png)

要在 IntelliJ 中打开该工具，您可以在项目结构工具中使用整个项目上下文菜单。这里有一个选项`Local History > Show History`:

[![right click on the project name in the project structure tool, choose Local History - Show History](../Images/25d65680475df91a7f26681f708743e8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--cPie50r1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://iwillteachyoukotlin.com/wp-content/uploads/2019/01/how-to-try-kotlin-local-history-menu-1024x463.png)

当您找到开始弹奏 Kotlin 的位置时，您可以恢复到第一个与 Kotlin 相关的更改，例如:

[![choosing revert option on a specific change in the past](../Images/302bdaa38fe93c2499a205e8d10f420e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--RgKXr7hp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://iwillteachyoukotlin.com/wp-content/uploads/2019/01/how-to-try-kotlin-local-history-revert.png)
...
## [](#thank-you-and-ask-for-you)谢谢，求求你！

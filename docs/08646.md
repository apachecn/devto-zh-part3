...
> 原文:[https://dev.to/bnevilleoneill/pro-node-js-tips-2l0o](https://dev.to/bnevilleoneill/pro-node-js-tips-2l0o)

#### [](#for-those-new-to-node)(针对新来节点)
...
### [](#serializing-javascript-objects)序列化 JavaScript 对象
...
### [](#using-jsonstringify-to-serialize-your-objects)使用 JSON.stringify 来序列化你的对象
...
### [](#tojson-method-of-complex-objects)对复杂物体的托杰森法
...
### [](#advanced-modules-in-case-you-need-extra-juice)高级模块(以防你需要额外的果汁)
...
### [](#reading-command-line-arguments-on-nodejs-scripts)读取 Node.js 脚本上的命令行参数
...
### [](#finding-the-current-scripts-file-path)查找当前脚本的文件路径
...
### [](#iterating-over-an-objects-attribute-just-like-you-do-over-array-items)遍历对象的属性，就像遍历数组一样
...
### [](#setting-up-nginx-as-a-reverse-proxy-for-your-nodejs-server)将 Nginx 设置为 Node.js 服务器的反向代理
...
[![](../Images/1e23378f296990a12c8319a6ececf75d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--xuyLpMVb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/908/0%2AKN9Ky0dj7KcWj2nH)
...
### [](#looping-over-a-list-of-async-functions-and-getting-the-results-back-without-using-extra-libraries)循环遍历异步函数列表并获取结果(不使用额外的库)
...
### [](#standard-out-and-error)标准输出和误差
...
### [](#printing-the-stack-trace)打印堆栈痕迹
...
### [](#logging-how-long-a-function-call-takes)记录一个函数调用需要多长时间

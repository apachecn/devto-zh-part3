...
> 原文:[https://dev.to/dwd/fibonacci-3cak](https://dev.to/dwd/fibonacci-3cak)
...
## [](#try-one-classic-recursion)试试一:经典递归。
...
## [](#try-two-constant-expression)试二:常量表达式。
...
## [](#try-five-template-functions)试五:模板功能
...
## [](#one-last-attempt-template-values)最后一次尝试:模板值

...
> 原文:[https://dev . to/azure/server less-from-the-beginning-part-ii-get-to-know-your-portal-ide-101k](https://dev.to/azure/serverless-from-the-beginning-part-ii-getting-to-know-your-portal-ide-101k)
...
## [](#getting-to-know-your-portal-ide)了解您的门户 IDE

一旦生成了函数，就该了解门户 IDE 了。看起来是这样的:

[![](../Images/8746901a526e3e0026dfbf941553c4bf.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--wU4TYeC6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2Agbl5ptIHPPmXm6ike56NSg.png)
...
[![](../Images/ce42bb44ce60eecb318a4862d718d81d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--iNvdD5Dk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/124/1%2AxRy4G_2danLGJG8HXcMgHg.png)

最后看起来是这样的:

[![](../Images/2b65a07d392fac7a5bc4de25f69b8cc5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--7_m_7aJc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/960/1%2AEAWgnLpeAiKaRHwbOxlJmA.png)

### [](#add-a-new-file-and-move-the-list-in-there)添加一个新文件并将列表移动到那里

好的，我们点击`+ Add`并以此结束:

[![](../Images/c8a4969a0302bf8a79a72a0b092a1857.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--xy9A9Y2u--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/406/1%2AKxf0XHtlHKceOO57yOkUQA.png)

我们填写我们的文件名`jokes.js`并移动来自`index.js`的内容，我们现在应该有:

[![](../Images/6bf059f83ff527621f25923e21384986.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--g-qTCdEX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AQcpH-pA1OIWkrq0llzOvTw.png)

> 不要忘记在`jokes.js`的末尾添加 module.exports = jokes，以确保我们可以正确导入我们的笑话列表。

### [](#import-our-jokesjs-file-as-a-node-module)导入我们的笑话. js 文件作为节点模块
...
### [](#move-remaining-static-content-to-separate-files)将剩余的静态内容移动到单独的文件
...
## [](#a-new-project-using-a-rest-endpoint)使用 REST 端点新建项目
...
[![](../Images/6438e1e4577aa0fe1063cd4219c154f1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--LuFHkjKh--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/478/1%2AewlMtEciveoyutMezOXymg.png)

然后当您看到触发器时，选择 HTTP 触发器:

[![](../Images/494218e79b8252b95fe35c499ab0f06b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8fMFfUjQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/986/1%2ARPkwTErISVx0AS1zpiiZhQ.png)

此后，将授权级别设置为 Anonymous，并将其命名为 CatsAsAService，如下所示:

[![](../Images/9216781cb330a403b0b33be25880b526.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--3TMGwuPX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/912/1%2ALii0rdxH-J5kTkuqRxjIZg.png)
...
[![](../Images/6cacc171efb9c4f98cf38922fbff37e4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--58xJVSBs--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1012/1%2AoC3V5-8srl1lxPJIbwC84w.png)

好了，让我们先点击命令`dir`，列出我们的文件，我们在 Windows 系统里面:)

[![](../Images/98dac2c064a1f8e2e3a1ecd46871fd8f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--BCtemH30--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/990/1%2ATEpOPKcnOkU6SdVpT3flCg.png)
...
[![](../Images/30962b31374e625cff81c8fb06022411.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--dMc0zVfL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/968/1%2AHcESWOk3U2Z1H9tC4UyGpw.png)

通过检查`package.json`我们还可以看到`node-fetch`已经安装:

[![](../Images/261d6a8caebcb53091d5abcb24b0430b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--P5vaqOI3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/404/1%2ASK2JsKzIse7GjxC5yg2_Lg.png)

很好，所以 node-fetch 就在那里，我们可以用它来进行 HTTP 调用。

### [](#working-with-logs)处理日志
...
[![](../Images/225105a76ff62027ede90f5fb9a85883.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--E3DRJ6e9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1004/1%2A1Or2qENQE8GNUEc3G1--jQ.png)
...
[![](../Images/2ad7c404aed70bc5a427968dc4d9e562.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---Bk2rarq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn-images-1.medium.com/max/355/1%2ApnfHD-Z1MSfizhmITuE1Lg.gif)
...
```
[  {  "breeds":  [  ],  "id":  "26k",  "url":  "[https://cdn2.thecatapi.com/images/26k.jpg](https://cdn2.thecatapi.com/images/26k.jpg)",  "width":  3817,  "height":  2553  }  ] 
```
...
[![](../Images/62a658c849cefaf7e9eaf2923784c38e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--mlieQK7K--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AG5P-Rhzj74nVJuy93gMUbQ.png)

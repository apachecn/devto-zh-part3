...
> 原文:[https://dev . to/nested software/convolutionary-neural-networks-an-intuitive-primer-k1k](https://dev.to/nestedsoftware/convolutional-neural-networks-an-intuitive-primer-k1k)
...
[![feature map](../Images/3f7749000826e69c8d0cc92bc680a1bf.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--3N1GH5HA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/95ix7dbm60k3cv57oy6t.png)
...
[![feature map neuron](../Images/63b8c9fffaaf7ca1ffb6375bea142789.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--QoPja0Q5--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4r1k6wskpkclp9dzdar1.png)
...
[![feature neurons for _3×3_ input with _2×2_ overlay](../Images/bbda37989c94b45ac2b720738cacc758.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--0V6BJg92--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/d9ozlga64618v41xez4c.png)
...
[![letter U](../Images/40cb43f531ef2ea6a01d88b014b5da17.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--JEix2lqW--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/yuzxnfax89dhnaxopy41.png)
...
## [](#backpropagation-through-a-feature-map)通过特征图进行反向传播
...
[![chain rule dc_db](../Images/00365fddc5dae4c9216e3b0ab894fce2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--2LHBjr7M--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/jshtp4d6293m0819y17b.png)

在这个上下文中，我们可以看到，对于每个特征神经元，我们可以将其*σ’(z)*值乘以其 *∂C/da* 值。这产生了一个 *2×2* 矩阵，它告诉我们每个特征神经元的 *∂C/db* 的值，即成本相对于偏差的导数。下图显示了这一结果:

[![dc_db for convolution](../Images/c24ccbc96354921a832eb0701f31ce3a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--xIUHFJpH--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4fuejk6fszlzcof12x8r.png)
...
### [](#weight-gradient)权重渐变

反向传播的下一步是计算*∂c/dw<sup>l</sup>T3】。链式法则告诉我们:*

[![chain rule dc_dw](../Images/40b5dd4ab37212d74d995115470aa29f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--PwAXmBVO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/rciq7sxoh8wwhrgyv0qg.png)
...
[![dc_dw for convolution](../Images/3101f5650ee52232faaeddfc0374fbf9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--SQdx9nP1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/d9w77c6sdwnis3do577e.png)
...
### [](#activation-gradient-for-previous-layer)前一层的激活渐变

反向传播的最后一步是计算*∂c/da<sup>l-1</sup>T3。从链式法则中，我们知道:*

[![chain rule dc_da_prev](../Images/8c262b480b0487c032ba20abf1702e18.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Jyzb0fQh--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/p8nbkgq8fz1z9y2ntkyz.png)
...
[![dc_da_prev for convolution](../Images/f60a3480c453f909eda14da1dd098ab8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---gdgmw1x--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/3pxq1dl2ppu55o0jy070.png)
...
[![convolve dc_db and w for dc_da_prev](../Images/18a503cb882f6464752942b3118ce773.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--irgDHgh9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/403sghu0k6fehix50zx5.png)
...
## [](#chaining-convolutional-layers)链接卷积层
...
[![chaining convolutional layers](../Images/350a23b7212b4df2b7b7de37f73f1e71.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--weAGOxes--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/vdquca3suwf7t1cu9co3.png)
...
[![max pooling](../Images/56f8bce0375ec000aa7bc9b99c3709a0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Xo7dMP-r--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/r90l2lnvraqju2n14vqm.png)
...
## [](#appendix-a-valid-vs-full-mode)附录 A:有效与完整模式
...
## [](#appendix-b-summing-2d-vs-3d-stack)附录 B:二维与三维叠加求和:

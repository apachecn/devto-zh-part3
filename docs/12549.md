...
> 原文:[https://dev . to/renegade coder 94/how-to-build-latex-with-Travis-ci-and-minted-39ff](https://dev.to/renegadecoder94/how-to-build-latex-with-travis-ci-and-minted-39ff)
...
## [](#how-to-automate-latex-build)如何自动化 LaTeX 构建
...
### [](#additional-build-scripts)附加构建脚本

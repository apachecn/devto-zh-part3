...
> 原文：<https://dev.to/selawsky/how-to-avoid-typical-mistakes-while-learning-java-emm>

[![learn Java](img/417dbf3aff0020ed086e44e377a032be.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--d7ItK_g3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/l1szh49ehjexro3kjtqc.png)

所以，你决定成为一名程序员。好主意，但是你现在应该做什么？
...
本文描述了那些想学习 Java 和初学 Java 的人(或任何其他编程语言的学生)的常见错误。我既是 Java 资深开发者，又是 Java 导师，所以对题目了解很多。
...
3.  在你的时间中，75%或更多的时间必须用于实践，25%或更少的时间用于理论。我将在下面更详细地分析这个典型的初学者错误。#错误 2:理论读得太多，实践不够想象一个а 2 岁的小家伙在试着说话。然而，他的妈妈和爸爸不让他做，因为他太小了，对这门学科一无所知。他们决定先向他解释语法规则，并雇佣一名语言治疗师(越快越好！).好吧，在所有这些措施之后，他们让他试试。嗯，这样的做法估计会有更多无语的人吧！

或者让我们想象一个想打冰球的大个子。“对不起，伙计。除非你读了或听了一些讲座，否则没有冰块给你，比如:
...
*   冰球运动员的团队合作心理
*   初学冰球运动员的创伤
*   如果其他曲棍球运动员的冰鞋不舒服地靠近你的脸，该怎么办？“好吧，”那人说，“我最好继续我的生活，不玩这个游戏。曲棍球一定很无聊很恐怖。太复杂了。"
...
1.  要掌握任何实践活动，就要去实践！
2.  编程是一项实践活动。
3.  1 和 2 的结论很明显吧？从最开始的步骤开始，找一个有很多编码任务的课程或者书，每天解决。如果你这样做了，你就省略了学习编程时最大的一个错误:过于注重理论。

我不是说你应该忽略理论。只是“更少的理论，更多的编码”，比例为 25:75。写代码是学习 Java 的最好方法。
...
你知道当一个专业的软件开发人员在试图用他们已经知道的可能的解决方案来解决一个任务时，他们会怎么做吗？他们去 Stack Overflow 问论坛上的其他人。亲爱的 Java 初学者，你为什么不这样做呢？
...
每一个——我是认真的——每一个初学编程的学生都至少失去过一次动力。在我身上发生过很多次。事实上，太频繁了。我所有的队友，以及我所有成功的学生，也经历了这一点。
...
[![CodeGym](img/9925661f7218406ebffd49bffc82a44f.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--Y8NOVron--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/aypc72rrbdh3msqed12h.png)
...
[![CodinGame](img/63f61418b0bbb1fd751c0deca1e5bc6e.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--5lGTZU8h--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/wx6m27ay9kw9m4p0os1g.jpg)

GeeksforGeeks 是一个面向极客的大型计算机科学门户网站。它包含了一些不同编程语言的学术课程，有很好的教学大纲和大量的实践任务、测验和谜题。你还可以找到与算法和数据科学相关的有用问题。

[![GeeksforGeeks](img/3ca95bb3f411bd20feb372706b6ee948.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--NeTgdi7---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/zwp0od6yzcb6zloo3kir.png)
...
*   Kathy Sierra 和 Bert Bates 的 Head First Java 是一本适合新手的好书。
*   凯·霍斯特曼的《核心 Java 第一卷和第二卷——基础知识》是最好的 Java 书籍之一，适合每一个 Java 学生。##自信地面对 Java 挑战，你并不孤单。所有初学 Java 的学生在掌握软件开发的道路上都面临着挑战。犯错没关系；你还在学习！

如果你在学习中停滞不前，也许你正面临着我上面提到的一个问题。记住，他们都有一个简单的解决方案。记住这一点，并以正确的方式练习。

别担心了，开始编码吧！

这篇文章最初是作为一篇客座文章发布在惊人的简单程序员博客上的。
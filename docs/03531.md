...
> 原文:[https://dev . to/chaituknag/a-simple-journal-app-using-react-local storage-and-fun-23j 8](https://dev.to/chaituknag/a-simple-journal-app-using-react-localstorage-and-fun-23j8)

# [](#premise)前提

我使用 React、Bootstrap、Moment.js 和 localStorage 作为数据库，构建了一个类似于初级 Journal 应用程序的 CodePen 应用程序。

# [](#what-this-post-is-about)这个帖子是关于什么的

我只想分享几个你可能感兴趣的重要概念。

## [](#jsonstringify-and-jsonparse)JSON.stringify 和 JSON.parse
...
## [](#deleting-an-entry-using-arrayprototypeslice)使用 Array.prototype.slice 删除条目
...
## [](#higher-order-delete-entry-click-handler)高阶删除条目点击处理程序
...
## [](#textarea-in-focus-on-page-load)Textarea 在页面上加载焦点
...
## [](#momentjs-fromnow-usage)等一下。js。fromNow usage(立即使用)
...
## [](#custom-hook-usejournal)自定义挂钩(useJournal)

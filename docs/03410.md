...
> 原文:[https://dev . to/logic mason/asdf-the-package-manager-for-all-your-languages-20mg](https://dev.to/logicmason/asdf-the-package-manager-for-all-your-languages-2omg)

## [](#why-use-asdf)为什么用 ASDF？
...
## [](#install-the-plugin-dependencies)安装插件依赖项
...
## [](#verify-you-have-what-you-need)验证你有你需要的东西

```
asdf current 
```

## [](#installing-the-phoenix-framework)安装凤凰框架

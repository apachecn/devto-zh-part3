...
> 原文:[https://dev.to/yashints/image-optimisation-3ic9](https://dev.to/yashints/image-optimisation-3ic9)
...
| ![Average bytes per page](../Images/15f4691bd19aee527c2adc4c42217d58.png) |
| --- |
| 【2018 年每页平均字节数 |

## [](#what-does-image-optimisation-mean)图像优化是什么意思
...
### [](#choose-the-right-format)选择正确格式
...
### [](#size-vs-compression)大小 vs 压缩

这是压缩前后的图像示例。注意质量是如何受到影响的(你在猫身上看不到，但在它周围看得到):

**之前**
[![Cat](../Images/fda2a46ea486aa5e83664381586315d3.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--DCFNNqc_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://yashints.dev/static/f418272fbe68058ad6a67edb674ebd63/b4133/cat-lg.jpg)

[![Cat](../Images/3e5f2e219eade0477b680c6c9c9bd0af.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--s5XGO42d--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://yashints.dev/static/90e74e99d64dfa1db5e3ee84560be56e/b4133/cat-sm.jpg) 后

 **出于同样的原因，你无法找出第一个和第二个图像之间的猫本身的差异，这是安全的压缩图像到这种程度。只是让你知道第一个图像是 4mb，第二个只有 27kb。🤷‍

### [](#lossy-vs-lossless-optimisation)有损与无损优化
...
## [](#using-the-right-dimension)使用正确的尺寸
...
[![Cat picture using srcset](../Images/f0075e18e03d787e805b3a969c0ef08e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--zSgTXYpY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/9xxjf6bmdnpel4r2ryti.png)
...
| **JPEG** |
| --- |
| ![JPG](../Images/7e763fd68cc929352a8a2ab65c795ce2.png) |
| 大小:81.4KB |

| **PNG** |
| --- |
| ![PNG](../Images/ce09ecffd2fec8ba1937b2e224800144.png) |
| 大小:85.1KB |
...
### [](#lazy-loading-techniques)偷懒装载技巧
...
### [](#using-intersection-api)使用交集 API

...
> 原文:[https://dev . to/darthknoppix/react-suspend-the-essentials-5d io](https://dev.to/darthknoppix/react-suspenseload-the-essentials-5dio)

[![](../Images/4437fe9a91ff566cc558036e89edcf6d.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--hE2AyN6c--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/0%2ArwSz0MzOyUwc9kAp) 
...
## [](#how-to-leverage-codesplitting-easily-in-react-16)如何在 React 16 中轻松利用代码拆分

由于 React 团队在悬念方面所做的工作，代码拆分现在比以往任何时候都更容易。如果您今天没有进行代码拆分，那么让我们来看看为什么您可能想要拆分代码，这意味着什么，以及如何快速轻松地实现它。

### [](#why-use-codesplitting)为什么要用代码分割？
...
### [](#how-do-i-use-codesplitting)如何使用代码分割？

从 React 16.6.0 开始，代码分割比以往任何时候都更容易。它现在内置在 React 中，只需很少的设置就能提供出色的体验。我们需要包装我们想要延迟加载的组件。然后我们需要做一些细微的改变。

[![](../Images/ed86f0109f2651824afdbe2f88310924.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--BVVpXv5a--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2Am4zz5MucZR_NITn4D1t3rQ.png) 
...
#### [](#react-suspense-lazy-loading-example)**反应悬疑懒装例子**

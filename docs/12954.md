...
> 原文:[https://dev . to/kelli/how-to-self-host-Google-fonts-on-your-own-server-d4i](https://dev.to/kelli/how-to-self-host-google-fonts-on-your-own-server-d4i)

谷歌建议你使用他们在网站上提供的代码，在他们的 [FAQ](https://developers.google.com/fonts/faq) 中使用谷歌字体，但是如果你想完全控制显示的字体，在你自己的服务器上自托管谷歌字体是一个选择。

## [](#why-selfhost-google-fonts)为什么要自宿主谷歌字体
...
## [](#where-to-get-google-fonts-for-selfhosting)从哪里获得自托管的谷歌字体
...
## [](#steps-for-selfhosting-google-fonts)自托管谷歌字体的步骤
...
### [](#take-care-to-follow-the-font-license)注意遵循字体许可

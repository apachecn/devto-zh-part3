...
> 原文:[https://dev . to/faizanbashir/building-python-data-science-container-using docker-3f8p](https://dev.to/faizanbashir/building-python-data-science-container-usingdocker-3f8p)
...
# [](#python-data-science%C2%A0packages)Python 数据科学包
...
# [](#building-the-data-science-container)构建数据科学容器

Python 正迅速成为数据科学家的首选语言，因此我们将使用 Python 作为构建数据科学容器的首选语言。

### [](#the-base-alpine-linux%C2%A0image)基地阿尔卑斯 Linux 镜像

Alpine Linux 是一个小型的 Linux 发行版，是为重视安全性、简单性和资源效率的高级用户设计的。

正如[阿尔卑斯](https://alpinelinux.org)所宣称的:

> ## [](#small-simple-secure-alpine-linux-is-a-securityoriented-lightweight-linux-distribution-based-on-musl-libc-and-busybox)is small. Simple. Safe. Alpine Linux is a security-oriented lightweight Linux distribution based on musl libc and busybox.
...
### [](#talk-is-cheap-lets-build-the-dockerfile)空谈是廉价的让我们建立 Dockerfile
...
### [](#building-and-tagging-the%C2%A0image)构建并标注图像
...
## ![](../Images/375dfcc32199b4dedf2b526645c27ff7.png) [费赞巴希尔](https://github.com/faizanbashir) / [ python-datascience](https://github.com/faizanbashir/python-datascience)

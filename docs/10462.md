...
> 原文:[https://dev . to/kelin 1003/utilizing-WordPress-media-library-for-uploading-files-2b 01](https://dev.to/kelin1003/utilising-wordpress-media-library-for-uploading-files-2b01)

## [](#the-blah-blah-grimacing)诸如此类😬
...
## [](#pencil2-the-post)✏️邮报

### [](#setting-up-the-media-library)**设置媒体库**
...
[![With frame set to select](../Images/5ff67dd8538bda676c79c275a793b8ed.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8tlPg9W7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/q6anix6ajmnna53h99qf.png)

<figcaption>frame: select</figcaption>

或者，如果您希望包括更多选项，如创建多媒体资料、创建音频播放列表、创建视频播放列表等，请使用`frame: 'post'`。

[![With frame set to post](../Images/e6df416ac460740075d85e527639b6a5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ni5YbD3R--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/aoy9wkc6ovmdf2yedxxp.png)

<figcaption>frame: post</figcaption>

### [](#for-opening-the-media-libary)**用于打开媒体库**
...
### [](#for-handling-the-selected-images)**用于处理选中的图像**
...
### [](#for-preselecting-the-images-when-media-library-is-opened)**用于打开媒体库时预选图像**
...
### [](#some-other-events-methods)**其他一些事件/方法**

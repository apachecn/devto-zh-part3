...
> 原文:[https://dev . to/Hugo _ _ df/post-frequency-from-prototype-to-production-with-vue-node-27e 5](https://dev.to/hugo__df/post-frequency-from-prototype-to-production-with-vue--node-27e5)
...
### [](#load-some-scripts-only-on-production)仅在生产时加载一些脚本
...
### [](#load-scripts-only-if-not-prerendering-raw-injectx-endraw-using)仅在*未使用*预渲染`injectX`时加载脚本:
...
## [](#pass-service-urls-using-raw-envenvironment-endraw-files)使用`.env.${ENVIRONMENT}`文件传递服务 URL
...
### [](#meta-description-opengraph-tags)Meta 描述，OpenGraph 标签
...
[![accountableblogging.com 23/10 to 30/10 page views graph](../Images/3ba5ee9325e5056f05427df589fd70fb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--oIBLUV1b--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/iqfFJWP.png)
...
[![accountableblogging.com 29/10 to 23/11 page views graph](../Images/9f37404a91d79434c7bc9b778026bd74.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--P6qtrs2r--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/AP27VWy.png)

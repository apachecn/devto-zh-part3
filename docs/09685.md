...
> 原文:[https://dev . to/Anders Jr 1984/firestore-database-structure-and-security-3 gdb](https://dev.to/andersjr1984/firestore-database-structure-and-security-3gdb)
...
![Sub-Collection Document Get Request](../Images/b917648b207cda9e5631af95b833f15b.png)
...
![Initial DB Structure](../Images/ed424e5baf84dbb7ef6c4ea3569579cc.png)
...
![Order Structure](../Images/271d1757377a26593778cd7b93a0bd36.png)
...
![DB Structure of a Previous Orders](../Images/97095a8b23f523b118104256e294dd69.png)
9.  我的应用程序有一个以前订单的侦听器，它会在数据库中用户以前订单的任何更新时更新应用程序帐户页面的状态。以下是完成订单示例后的代码和帐户页面:
![Previous Order Listener](../Images/d0b41e6e8353bd5629556a8ae86a0ef2.png)
![Review Orders](../Images/c5de3b45a3df25d7a44823988177d4ca.png)
...
![Firestore Rules](../Images/30f902dee6d79b7748ead38e5bedf70c.png)
...
![Simulated Prices update command](../Images/a310ee833ee800fbc0afd355022c2c34.png)
![Simulated Prices get command](../Images/1076d48b2f12427fa1a10f604a343dcc.png)
...
![Previous Orders Update Test](../Images/dad73eff4b6dfa8b090dfa0a303fb36c.png)
...
![Order Data Initial Update Test](../Images/511f409d68416e88e978e4d381206999.png)
...
![Order Data Final Update Test](../Images/811ae5cc87e41cd098764c54160fa0a6.png)
13.  我们删除了第 16 行中的通配符，但是我们希望确保 shipmentInfo 和 Images 可以被创建和更新。让我们做个测试来确定。哇哦！它工作了。
![Images Write Test](../Images/cef13e1866011ebd17b5a127ace9ffbd.png)
15.  让我们看看默认地址，以确保用户可以读取、创建和更新他们的默认地址。
![Default Address Test](../Images/af0929a4679eca2a98f8639bcb3e6a0b.png)
17.  现在我们要确保 mal1 不能访问 uid1 的 sweet 数据，让我们在模拟器中使用通配符！
![Malicious User Test](../Images/9cdd08407a1aa9a745b8449bff960e97.png)
![Malicious User Test](../Images/9b3824a1430d4ac4c46ec03082f26492.png)

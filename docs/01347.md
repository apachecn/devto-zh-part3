...
> 原文:[https://dev . to/andyhaskell/JavaScript-regular-expressions-in-action-make-a-relative-time-parser-in-js-5bn 1](https://dev.to/andyhaskell/javascript-regular-expressions-in-action-make-a-relative-time-parser-in-js-5bn1)
...
## [](#the-format-were-parsing)我们正在解析的格式
...
## [](#getting-parts-of-the-regular-expression)获取部分正则表达式
...
## [](#adding-in-hours-and-milliseconds)添加小时和毫秒
...
[![Three-toed sloth climbing in a low branch in a tree](../Images/cf10ac67261d837278295f6e2498c9a2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--gwTW1EWv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/nchtgk9ko3aq3286d4cx.jpg)

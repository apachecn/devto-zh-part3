...
> 原文:[https://dev . to/drewtownchi/setting-up-tailwind-and-purge CSS-with-grid some-with-use-any-plugins-5666](https://dev.to/drewtownchi/setting-up-tailwind-and-purgecss-with-gridsome-without-using-any-plugins-5666)
...
# [](#create-a-tailwind-configuration-file)创建顺风配置文件
...
# [](#purgecss-configuration)Purgecss 配置

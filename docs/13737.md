...
> 原文:[https://dev . to/vmesel/what-the-heck-are-python-generator-expressions-and-list-comprehensions-55hh](https://dev.to/vmesel/what-the-heck-are-python-generator-expressions-and-list-comprehensions-55hh)
...
## [](#what-are-generator-expressions)什么是生成器表达式？
...
## [](#checking-out-the-assembly-of-both-of-them-to-see-the-differences)检查两者的装配情况，看看有什么不同

### [](#assembly-instructions-from-python-disassambler)来自 Python 反汇编程序的汇编指令

...
> 原文:[https://dev . to/on myway 133/how-to-test-publish subject-in-rx swift-57b 9](https://dev.to/onmyway133/how-to-test-publishsubject-in-rxswift-57b9)
...
## [](#use-homemade-raw-recorder-endraw-)用自制的`Recorder`
...
## [](#make-raw-expectation-endraw-less-cumbersome)让`expectation`不那么繁琐

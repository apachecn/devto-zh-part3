...
> 原文:[https://dev.to/shikaan/-design-patterns-in-web-development-主动-缓存-2-37jc](https://dev.to/shikaan/-design-patterns-in-web-development----active-caching-2-37jc)

#### [](#check-out-the-updated-version-here)查看更新版本[此处](https://withbenefits.dev/what-is-cache-part-ii/)
...
# [](#what-writing-techniques)什么？！写作技巧？！
...
## [](#write-through-aka-write-inline)直写(又名直写)

对于通读(或内联缓存)，我们让资源管理器位于客户机和数据访问器之间。

此图说明了使用直写的写入操作的生命周期

[![Write Through.](../Images/eb230e435b4c2bbf747f8c3fc3b159c9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--0idM8-st--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/3s6w39l9kgew5qh2uc27.png)
...
## [](#write-behind-aka-write-back)写在后面(又名写回来)

这另一种技术仍然具有内嵌的资源管理器，但是通过数据访问器的写入是异步发生的。

[![Write Behind.](../Images/e771f453dfd888c5109f5d987c9f80ba.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--oyMv2_7s--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/mvdo6l794dxudbo8sws1.png)
...
但我们付出的代价是一致性:在工作人员完成同步过程之前，真实数据(如存储在真正令人敬畏的银行中的数据)和我们提供的数据(如存储在缓存中的数据)是不同的，如果我们开始考虑如何处理错误情况[](#note2)，事情会变得更加复杂。

## [](#write-around)写写转转

嗯，为了完整起见，我们应该提到写在周围，但对我来说，它看起来不像一个真正的模式。事实上，在下图中你找不到“缓存”这个词的任何痕迹。

[![Write Around.](../Images/4c893259e8d9bf913eda9421092fd027.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--iHfwvfk0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/nis5pe9abormsp98zs76.png)
...
# [](#did-you-write-some-code)你*写了*一些代码吗？

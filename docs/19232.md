...
> 原文:[https://dev.to/teekay/learning-ruby-from-zero-tohero-2oj](https://dev.to/teekay/learning-ruby-from-zero-tohero-2oj)

[![](../Images/3e909444386e83b6e656287d46a53fcc.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--xyhceUW_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AsZSVVtdP9TE3mUoGh4GoYA.png)
...
### [](#conditional-statements-control%C2%A0flow)条件语句:控制流程
...
### [](#array-collectionlistdata-structure)数组:集合/列表/数据结构
...
[![](../Images/2644ac02bb520cbe929833df5e207fa8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--P5EpJPMR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AHmGUFmEI1w7ClqD6YCSmJQ.png)
...
### [](#hash-keyvalue-data-structuredictionary-collection)Hash:键值数据结构/字典集合
...
### [](#iteration-looping-through-data-structures)迭代:遍历数据结构
...
### [](#ruby-object-oriented-programming-mode%C2%A0on)Ruby 面向对象编程模式:开
...
### [](#encapsulation-hiding-information)封装:隐藏信息
...
### [](#inheritance-behaviors-and-characteristics)遗传:行为和特征

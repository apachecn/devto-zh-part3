...
> 原文:[https://dev . to/Alex MacArthur/remember-to-possible-target-a-empty-object-with-object-assign-3274](https://dev.to/alexmacarthur/remember-to-probably-target-an-empty-object-with-object-assign-3274)

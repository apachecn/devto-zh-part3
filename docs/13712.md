...
> 原文:[https://dev . to/vint haras/boost-your-coding-fu-with-visual-studio-code-and-vim boost-your-coding-fu-with-visual-studio-code-and-vim-502h](https://dev.to/vintharas/boost-your-coding-fu-with-visual-studio-code-and-vimboost-your-coding-fu-with-visual-studio-code-and-vim-502h)
...
## [](#installing-vim-inside-visual-studio-code)在 Visual Studio 代码内部安装 Vim
...
[![VSCodeVim plugin inside VSCode](../Images/e8f88396814a77f18e214ca5c3b07b6c.png "VSCodeVim plugin inside VSCode")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--MK7XfKVG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.barbarianmeetscoding.com/images/vscodevim-plugin.jpg)

现在，安装完扩展后，您可能需要重新启动 Visual Studio 代码以使更改生效。 <sup id="fnref1">[1](#fn1)</sup>

重启了吗？从您最新的项目中打开一个代码文件，并查看光标。它看起来像长方形吗？什么事？**欢迎来到 Vim**

## [](#baby-steps-in-vim)维姆中的婴儿步伐
...
## [](#moving-blazingly-fast-with-the-core-vim-motions)随着核心 Vim 动作快速移动
...
## [](#editing-like-magic-with-vim-operators)用 Vim 操作符像变魔术一样编辑
...
> ### [](#noticed-how-motions-and-command-keys-make-a-lot-of-sense)注意到了动作和命令键是如何很有意义的吗？
> 
...
### [](#editing-up-a-notch-with-text-objects)用文本对象编辑一个缺口
...
## [](#inserting-text-a-la-vim)插入文本 a la Vim
...
## [](#selecting-text-in-visual-mode)在可视模式下选择文本
...
## [](#splits-tabs-and-switching-between-them)拆分、标签以及它们之间的切换
...
[![Splits in Vim](../Images/8528bbc15ca8b79983cf2bd41a5c93b3.png "Splits in Vim")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--KLV4nsS2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.barbarianmeetscoding.com/images/vim-window-splitting.jpg)

> ### [](#typing-a-command)键入命令
> 
...
## [](#surrounding-things-with-vim-surround)用 Vim 环绕周围的事物
...
## [](#moving-even-faster-with-vimsneak-and-vimeasymotion)使用 vim-sleek 和 vim-EasyMotion，移动速度更快
...
[![Vim-Easymotion labeling motions](../Images/25de65ee2b2ac57a9fb49a63c66ac6bf.png "Vim-Easymotion labeling motions")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--6ULgJMWm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.barbarianmeetscoding.com/images/vscodevim-easymotion.jpg)

### [](#some-handy-visual-studio-code-only-key-mappings)一些方便的 Visual Studio 代码只有键映射:
...
## [](#where-should-i-go-from-here)我该何去何从？
...
[![Boost Your Coding Fu With Visual Studio Code and Vim](../Images/4563f598eee3a2197bf9fea2fd4e99d2.png)T2】](https://leanpub.com/boostyourcodingfuwithvscodeandvim)

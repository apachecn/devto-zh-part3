...
> 原文:[https://dev . to/ananyaneogi/accessible-and-expressive-html-semantics-43 h1](https://dev.to/ananyaneogi/accessible-and-expressive-html-semantics-43h1)
...
## [](#text-level-semantics)文本层次语义

### [](#1-phrasing-emphasis)1。措辞强调
...
### [](#2-extending-html-tags-to-be-accessible)2。将 HTML 标签扩展为可访问
...
### [](#3-hide-content-from-screen-readers-to-reduce-cognitive-load)3。对屏幕阅读器隐藏内容以减少认知负荷
...
## [](#creating-clear-navigation)创建清晰的导航

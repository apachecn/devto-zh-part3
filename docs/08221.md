...
> 原文:[https://dev . to/jaredwolff/自制粒子动力室内空气质量传感器-2gb](https://dev.to/jaredwolff/homemade-particle-powered-indoor-air-quality-sensor-2ggb)
...
[![All the parts needed](../Images/62b482d1f5cf8521d10db24f11e69c04.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--GptvxMA0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/homemade-indoor-air-quality-sensor/images/ingredients.jpg)
...
## [](#wiring-it-all-together)把这一切连接在一起
...
[![Fritzing Hookup Diagram](../Images/e551e46cd524f9cb7c0fc8f483ed06cd.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--Fznd-7D---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/homemade-indoor-air-quality-sensor/images/particle-squared-hookup-diagram.jpg) 
...
[![Particle sensor pinout](../Images/b984ed254007b79d39dc2ecbaf4afde9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--tXovUa-J--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/homemade-indoor-air-quality-sensor/images/Screen%2520Shot%25202019-03-23%2520at%252012.31.03%2520PM.png)
...
[![Everything assembled on breadboard](../Images/400dd84617e1a33e09e217edde2f0b39.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--uwAul1gC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/homemade-indoor-air-quality-sensor/images/DSC01397.jpg)

另一个重要的注意事项是，我修改了 HPMA 的电缆，使它们在末端有公引脚。这使得它很容易插入无焊料试验板。这是一张放大的照片:

[![Soldered pin](../Images/d6abc8f614558ce893db8bc9811b912c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--6NXLQaYq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/homemade-indoor-air-quality-sensor/images/DSC01370.jpg)

当您购买 PM2.5 传感器的电缆时，它预装了 8 根电线。为了使事情变得简单，你可以去掉 4 根不用的线。最好的方法是拿一个尖尖的工具(牙签、缝纫针等)放在我在下面用红色标出的夹子下面:

[![Clips holding the wires in](../Images/19539743c073a21e2dbec54989a096e2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Tim_1WQN--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/homemade-indoor-air-quality-sensor/images/DSC01371.jpg)

然后，一旦你把锋利的工具放在下面，用力拉电线，它就会滑出来。

现在你少了电线，少了头痛。您可以使用这种技术来修改任何类似 Molex 的连接器。

## [](#plumbing-the-firmware)安装固件
...
[![Si7021 pinout](../Images/e5743fb0ca5f143db80cdcb4dc9d33a5.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--ItfnrwfN--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/homemade-indoor-air-quality-sensor/images/Screen%2520Shot%25202019-03-23%2520at%25201.18.21%2520PM.png) 
(直接从 Si7021 文档中复制)
...
[![CCS811 pinout](../Images/6e096f01d2693af4b8202a0463cba63f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--VWQkO82X--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/homemade-indoor-air-quality-sensor/images/Screen%2520Shot%25202019-03-23%2520at%25202.34.14%2520PM.png)
...
[![Holding HPMA115S0](../Images/7ee0f6182e6f82f186def46d3dfb129e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Qd7FaKWy--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/homemade-indoor-air-quality-sensor/images/DSC01372.jpg)

我最初选择这个传感器是因为它的封闭性。在我看来，整合更容易。我的电子工程师大脑不想处理复杂的东西。给我一个盒子，我们走吧。

## [](#getting-everything-working)让一切运转起来
...
### [](#changing-wifi-credentials)更改 Wifi 凭证
...
### [](#recovering-when-things-go-awry)出了差错时挽回
...
## [](#monitoring-on-the-command-line)命令行上的监控
...
## [](#publishing-to-google-docs-using-a-webhook)使用 Webhook 发布到 Google Docs
...
1.  转到`Tools` - > `Script Editor`。这将弹出一个脚本窗口。![Script Editor in Google Sheets](../Images/45381624eda0e8b652c2654474652f9d.png)
2.  创建新脚本。并把我写的内容抄在下面:
...
1.  然后我去了`Publish` - > `Deploy as web app` ![Publish](../Images/f5e748dff4452bb8959b96ca53835733.png)
...
4.  在粒子控制台中，转到`Integrations`部分并创建一个新的`Webhook`
    ...
    [![Particle Webhook Builder](../Images/f1edcc38cae2ee083967e58fc7c2d824.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--wDeKq4qG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/homemade-indoor-air-quality-sensor/images/Screen%2520Shot%25202019-03-19%2520at%25208.49.57%2520AM.png)
...
[![Graphed Data](../Images/5abd373cdaac061527e1e6ea912d2552.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--l313Ny71--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/homemade-indoor-air-quality-sensor/images/Screen%2520Shot%25202019-03-19%2520at%25205.41.15%2520PM.png)
...
## [](#another-way-using-adafruit-io)另一种方式:使用 Adafruit IO

1.  在这里创建一个账户:[https://io.adafruit.com](https://io.adafruit.com)
2.  下一步是为每种数据类型创建提要。我们总共需要 6 个。
    [![Create a feed in Adafruit IO](../Images/2837e5272024b6a277d108780bfc4009.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--1UWIovNY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/homemade-indoor-air-quality-sensor/images/Screen%2520Shot%25202019-03-19%2520at%25206.47.38%2520PM.png)

3.  对于每个提要，添加一个 Webhook。
    [![Add a webhook for data](../Images/8519b4c1844983e35cae339c2e6b7141.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--QNjM1iIV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/homemade-indoor-air-quality-sensor/images/Screen%2520Shot%25202019-03-19%2520at%25206.45.27%2520PM.png)
...
[![List of Feeds](../Images/19be8f37a4e01dc2c33d979685acd1b9.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--ITHR4XhK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/homemade-indoor-air-quality-sensor/images/Screen%2520Shot%25202019-03-19%2520at%25207.04.16%2520PM.png)
[![Graphs of Feeds](../Images/ab7de5ef5b41cddee997c7010f6287d4.png)T6】](https://res.cloudinary.com/practicaldev/image/fetch/s--lNN1TqZr--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/homemade-indoor-air-quality-sensor/images/Screen%2520Shot%25202019-03-19%2520at%25207.16.17%2520PM.png)
...
## [](#making-sense-of-the-readings)解读读数
...
如果你想要一些已经组装好的可用的东西，你应该看看 Particle^2(发音为粒子平方)。它什么都有，包括开关 HPM 粒子传感器的能力。你甚至可以用电池运行它！所以把它放在任何你想放的地方。点击这里查看。
 ...
 [![Holding Particle Squared](../Images/0e44cc49e68d8e1b26662f6b69bc2387.png)
T4】](/store/particle-squared/)

以下是入门的简单方法:

### [](#particle2-setup)Particle^2 设置

1.  插上你的
    [![Pluggin in Particle Squared to Argon](../Images/d158cb89e923ee24a039c5cfc3973b57.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--TtH0am_A--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/homemade-indoor-air-quality-sensor/images/UNADJUSTEDRAW_largepv_2fff.jpg)

2.  连接 HPMA115S0 粒子传感器
    [![Plugging in the HPMA115S0](../Images/e5ba67e324afdee82e9835fcfee95bab.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--UdoXFJmE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/homemade-indoor-air-quality-sensor/images/UNADJUSTEDRAW_largepv_2ffe.jpg)

3.  开机
    [![Powered up](../Images/c0ce0f62161e30fb52cd4c364723b3b7.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--wEi_TJZq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.jaredwolff.com/homemade-indoor-air-quality-sensor/images/UNADJUSTEDRAW_largepv_2ffd.jpg)

4.  还有程序！(下面是代码的更多细节)

## [](#code-and-source)代码和来源

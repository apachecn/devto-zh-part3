...
> 原文:[https://dev.to/grohsfabian/start-web-scraping-with-nodejs-4l 62](https://dev.to/grohsfabian/start-web-scraping-with-nodejs--4l62)
...
## [](#1-initial-request-and-parsing)1。初始请求和解析
...
[![first](../Images/7b551ea7a57b91f8dc69bf1daec26fb8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--OZnAfEsN--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/tGaV8o0.png)

很酷吗？ **让我们更进一步👁**

## [](#2-getting-more-data)2。获取更多数据
...
### [](#so-before-going-any-further)所以，在更进一步之前..
...
### [](#going-a-bit-deeper)深入一点。

这里有一些有趣的信息，对初学者来说可能有点难度，但仍然是一个很好的练习。

[![second](../Images/c982bffd5edc0f6914793d47c134838f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--H1NRJ_8P--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/nvXQ9Yv.png)
...
### [](#getting-another-round-of-details)获取又一轮细节
...
[![image](../Images/36f9392ccba083efefef87c69c39d0b7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--EDUKoKgU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/Ryma7w0.png)

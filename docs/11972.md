...
> 原文:[https://dev.to/gvetri/que-es-android-jetpack-5g3](https://dev.to/gvetri/que-es-android-jetpack-5g3)

今年谷歌 I/O 2019 彩票已经开始。这使我想起了去年的事态发展，其中最引人注目的是 Android Jetpack，但很多人还不知道它。所以我想到了写一篇关于这是什么的小文章。

# [](#que-es-android%C2%A0jetpack)Que es Android Jetpack？
...
[![Android Jetpack image](../Images/c3faf2d02e4fb4b3e167b87c8406d3bb.png "Android Jetpack Libraries")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--j_r473oH--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/qae2h1ir6kefa4kw67xz.png)

## [](#que-librer%C3%ADas-est%C3%A1n-dentro-de-android%C2%A0jetpack)书店在 Android Jetpack 里面吗？
...
## [](#como-migrar-de-las-librer%C3%ADas-appcompat-a%C2%A0jetpack)来自由港的移民申请喷气背包
...
2.  使用 Android Studio 提供的 refactor 选项，Android studio 会检查您的设计，然后在屏幕上显示要进行的更改列表。接受并希望很多东西不会损坏，不应该
    [![Android Studio refactor option](../Images/df71ca246993b0613f2c782e504b5c89.png "Android Studio Refactor Option")](https://res.cloudinary.com/practicaldev/image/fetch/s--u-cNwWir--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ffmltmtkz5ig49wvtf3l.png)

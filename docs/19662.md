...
> 原文:[https://dev . to/Apium _ hub/improving-testability-of-cllocationmanager-3d1g](https://dev.to/apium_hub/improving-testability-of-cllocationmanager-3d1g)
...
## [](#improving-testability-of-cllocationmanager)提高 CLLocationManager 的可测试性
...
## [](#if-you-found-this-article-about-cllocationmanager-interesting-you-might-like)如果您觉得这篇关于 CLLocationManager 的文章很有趣，您可能会喜欢…

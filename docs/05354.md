...
> 原文:[https://dev.to/cookrdan/using-git-on-ios-1l1n](https://dev.to/cookrdan/using-git-on-ios-1l1n)

# [](#using-git-on-ios)在 iOS 上使用 Git
...
编辑:这是 ipad 上的截图
[![git on ios](../Images/9692689829fd3babd83a0a10c37b7c29.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--a4f3nUOn--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ejxzog4s81or0ocz67sd.png)
...
> 原文:[https://dev . to/neutrino 2211/we B- components-for-when-vuejs-is-under-much-8em](https://dev.to/neutrino2211/web-components-for-when-vuejs-is-too-much-8em)
...
### [](#step-1-define-our-component)第一步:定义我们的组件
...
### [](#step-2-element-lifecycle)第二步:元素生命周期
...
### [](#step-3-lets-make-something)第三步:做点东西
...
### [](#step-5-reactive-state)第五步:反应状态

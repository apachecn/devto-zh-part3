...
> 原文:[https://dev . to/we make-services/python-exceptions-considered-an-anti-pattern-17o 9](https://dev.to/wemake-services/python-exceptions-considered-an-anti-pattern-17o9)
...
## [](#problems-with-exceptions)出现异常的问题

首先，我们必须证明异常有缺点。嗯，通常很难在你每天使用的东西中找到“问题”,因为在某些时候它们开始看起来像是你的“特性”。

让我们重新审视一下。

### [](#exceptions-are-hard-to-notice)异常情况很难被注意到
...
### [](#restoring-normal-behavior-inplace-is-impossible)原地恢复正常行为是不可能的
...
### [](#execution-flow-is-unclear)执行流程不明
...
[![IDE debugger](../Images/fe30543e8b25ec9b2a26c63133c87050.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--G7DKH59C--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/838vfxwo8cdbankvb8x5.png)

异常就像臭名昭著的`goto`语句，撕裂了我们程序的结构。

### [](#exceptions-are-not-exceptional)例外不例外
...
### [](#how-to-work-with-wrapped-values)如何使用包装值？
...
### [](#but-how-to-unwrap-values-from-containers)但是如何从容器中解开值呢？
...
### [](#how-not-to-care-about-these-unwrapfailederrors)如何不去在意这些 UnwrapFailedErrors？
...
## [](#wrapping-all-together)将所有的包裹在一起
...
## [](#usecases-and-limitations)用例与限制

显然，你不能这样写所有的代码。对于大多数情况来说，它太安全了，而且与其他库/框架不兼容。但是，你应该明确地写出你的业务逻辑中最重要的部分，就像我上面展示的那样。它将增加系统的可维护性和正确性。

## ![GitHub logo](../Images/a73f630113876d78cff79f59c2125b24.png) [干蟒](https://github.com/dry-python) / [返回](https://github.com/dry-python/returns)

### 让你的函数返回一些有意义的、有类型的、安全的东西！

<article class="markdown-body entry-content container-lg" itemprop="text">

[![Returns logo](../Images/4786a2f8ee5bd340a9f15915bf5c2d21.png)T2】](https://github.com/dry-python/returns)

* * *

[![Build Status](../Images/780a40a019d76786bcbb7d08c21f57e4.png)](https://github.com/dry-python/returns/actions?query=workflow%3Atest)[![codecov](../Images/c18695a0a4ed73ce9500adb842ac38a7.png)](https://codecov.io/gh/dry-python/returns)[![Documentation Status](../Images/4e60fa155ff3e1ce19d35534b40986f0.png)](https://returns.readthedocs.io/en/latest/?badge=latest)[![Python Version](../Images/a462ad4161584ce6556db135795afeac.png)](https://pypi.org/project/returns/)[![wemake-python-styleguide](../Images/29fd18d70d1bbea101ed0c3c08584cba.png)](https://github.com/wemake-services/wemake-python-styleguide)[![Checked with mypy](../Images/6ec93f42bec659eaba6481b26a802b06.png)](http://mypy-lang.org/)

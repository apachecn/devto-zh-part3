...
> 原文:[https://dev.to/pesse/100codeexamples-utplsql-cursor-comparison-with-user-defined-types-25nm](https://dev.to/pesse/100codeexamples--utplsql-cursor-comparison-with-user-defined-types-25nm)

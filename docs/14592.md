...
> 原文:[https://dev . to/twilio/intro-to-Markov-models-with-swift-29i 8](https://dev.to/twilio/intro-to-markov-models-with-swift-29i8)

[![rickroll histogram](../Images/291aa48a1bce3753ccf3d24cb516c72a.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--7_PhiqD9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://lh5.googleusercontent.com/GH0KkWl0ec1r_keK69bMzNRGWHx-7-CMn9Xlz4DsDzS_ZNqScRqkwqjhGe7n05XlrRubN4qoaO8Ymvj0iThpYhLbZOgfTCJlVXLcGhKSC9_zHf-7xcyp1m4keloA851WT9hE5FHG) 
...
# [](#what-are-markov-chains-and-markov-models)什么是马尔可夫链和马尔可夫模型？
...
[![ice cream gif](../Images/e7f5a0d893d86a0fb8cacc1c6d4d462f.png)T2】](https://i.giphy.com/media/r8Kn8NaNM3xba/giphy.gif)
...
> 永远不会让你失望。
> [![rickroll gif](../Images/cef50d7c7275d3d81e6bb057a8fe4807.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--iau7ueCv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://lh6.googleusercontent.com/MYBpqYiHnqfR_WV4Zw2g9hIJXyXGE5U3APUqowKsX6_Pr43H6dyfSFFng96H1ZpB-6vifiW0iwUj2GB8UK5g2u_NwgDDwW2rL46YvdonHOmDChZlGfwTgAs26ptPIWGp-Y33lNq8)

这有十七个单词(也称为令牌)和八个唯一的单词(也称为密钥。)加权分布是一个键将出现的百分比。它基于密钥出现的总次数除以令牌总数。“从不”、“将要”和“你”的加权分布都是 2/10，如下直方图所示。
[![rickroll histogram](../Images/291aa48a1bce3753ccf3d24cb516c72a.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--7_PhiqD9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://lh5.googleusercontent.com/GH0KkWl0ec1r_keK69bMzNRGWHx-7-CMn9Xlz4DsDzS_ZNqScRqkwqjhGe7n05XlrRubN4qoaO8Ymvj0iThpYhLbZOgfTCJlVXLcGhKSC9_zHf-7xcyp1m4keloA851WT9hE5FHG)

直方图是表示加权分布的简单方法。这些键或单词也可以代表状态。每个键都可以指向另一个键:这称为转换。

## [](#transitioning-between-states)状态间的转换

让我们想象一下每个键是如何与跟在该键后面的一组可能的标记相匹配的。
[![rickroll chart](../Images/46e7ec5e63f3f86aa4e67d53710ae017.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--xWzbmx4H--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://lh6.googleusercontent.com/zn9ktrUCuoNcgdj_fCl6MnBwxaMhSAnvcNSVNYiNQdcXsNVvXkilXYtwmyAD7agdOUQ7lL1diwmE74NWhi5on5AFOP6jksp_3bwrLPQEAoUlvhZ0BmTB181Ukl5GOzZZXgIgdvma)

这里，令牌成对组织，一个状态对应于它后面的可能状态。这如何更好的可视化？
[![rickroll arrows](../Images/493b86f7bc4f31f636ca1598b54eca78.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--GI1f9Ydn--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3.amazonaws.com/com.twilio.prod.twilio-docs/images/nevergonnalines.width-500.png)

在上图中，每个单词代表一个键或一个状态，箭头指向它后面的潜在状态。对应的色标句子看起来是这样的:
[![color-coded sentence](../Images/4dfdfbf03bbbaf88ffb7e72aca11fa10.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--iGDMv4y2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3.amazonaws.com/com.twilio.prod.twilio-docs/images/nevergonnacolor.width-1000.png)

但是等等！还有呢！
[![Billy Mays but wait there's more!](../Images/659fa2f0f77bb2ccfcbd50335f18b7b3.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--ClwR3WY_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://lh6.googleusercontent.com/iaOUckV4UA9PQhQ9XQqOSVhBnzJ52GPInqK92lhidPwy49-BkpnDFu1FIm5YTcR6RFSYi9wuvNkaTng1Wl2a9P0v_QH67WYtpN2_e7vArSkl9kVuMCgGcAgN6daCACUYCZe602n9)

让我们尝试添加加权分布，这样每个箭头都有可能被选择作为到下一个状态的转移。

[![rickrolling with states](../Images/d6617184491b0ae43e0975a534fb0626.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--GqBCRpV2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3.amazonaws.com/com.twilio.prod.twilio-docs/images/nevergonnagiveyouupwithprob.width-500.png)

## [](#using-cocoapods-with-swift-playgrounds)使用带有迅捷操场的椰子
...
[![playground video](../Images/3b72d4a5aab4ded5c6a378b613e9d991.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--1qDcwM6F--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.youtube.com/watch%3Fv%3DujxYr15ahro)
...
## [](#markov-models-with-swift)马尔可夫模型与 Swift
...
哪个输出
[![markov model output](../Images/bea5f21cd1ce865d86be6404046fe0f2.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--DsZWsEdK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3.amazonaws.com/com.twilio.prod.twilio-docs/images/playgroundmarkov.width-1000.png)

## [](#whats-next)接下来是什么？

[![thank u next gif](../Images/827a03fbce714ca6bd248e2ac6ae060b.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--vDkXfsu2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://s3.amazonaws.com/com.twilio.prod.twilio-docs/original_images/thankunext.gif) 

...
> 原文:[https://dev.to/martyhimmel/javascript-es5-functions-第一部分-1h3l](https://dev.to/martyhimmel/javascript-es5-functions---part-1-1h3l)
...
## [](#function-parameters-and-arguments)函数参数和自变量

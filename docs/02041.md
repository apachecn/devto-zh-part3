...
> 原文:[https://dev . to/bertilmuth/implementing-a-hexagonal-architecture-1 kgf](https://dev.to/bertilmuth/implementing-a-hexagonal-architecture-1kgf)
...
[![poem-springboot hexagon](../Images/2934e7b80da5b2aefa25031d6a054516.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--pe3abT6l--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://dev-to-uploads.s3.amazonaws.com/i/4qzez6aor7higv4wxw9a.PNG)
...
## [](#from-a-user-story-to-ports-amp-adapters)从用户故事到端口&适配器
...
[![poem-hexagon](../Images/89e77665c2e5a4054b5fae27ca78a71c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--4a_F9pCz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/02hr6f652yran0dz38h1.PNG)
...
[![poem-hexagon: driven side up next](../Images/7793ab2bed06d78fcd2717f3592f2ccd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--cMUjGG4H--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8vsbpug5fjfjzs8sfs2y.PNG)
...
[![poem-hexagon: inside up next](../Images/e9e77bee97a9f801ce765f8a6daaa847.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---tA0dZqp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/efcfrsrwb9jei5uik63k.PNG)

## [](#command-handlers-inside-the-hexagon)命令处理程序(内六角)
...
## [](#tying-commands-to-command-handlers)将命令绑定到命令处理程序
...
## [](#plug-adapters-into-ports-and-thats-it)将适配器插入端口，就这样
...
[![hexagon-poem the completed application](../Images/07e06fb3aefbfec5d9f76b51418e0e73.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--PDHorQ0r--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/6pe5yam3xe68m11bojff.PNG)

## [](#switching-to-spring)切换到春季

该团队决定将 poem 应用程序转变为 web 应用程序。并将诗歌储存在真实的数据库中。他们同意使用 Spring 框架来实现它。在开始编码之前，团队开会并绘制了下图:

[![poem-springboot hexagon](../Images/a227b5eefe5439afc1a8b1a17b8505a7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--wwZoHjf---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://dev-to-uploads.s3.amazonaws.com/i/id1k29sxyxxn8sthzxsr.PNG)

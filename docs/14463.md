...
> 原文：<https://dev.to/anastasionico/why-warren-buffett-would-invest-in-php-and-you-should-too-26p8>

大约一年前，发生了一件令我震惊的事情，我相信它永远改变了我的生活。
...
[![Screen%20Shot%202019-01-30%20at%2015.22.45.png](img/b9a8b72e373194aba9221095342ade70.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--6fX2SdXI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn.filestackcontent.com/j2mlMnyTSfa1CRJ4a6Ec)
...
当不同的观点从“比特币只是一时的投机”到“有一天我的侄子们将使用加密货币和区块链系统进行日常购物”时，关于一个主题有太多的话要说。
...
尽管如此，
**我的一个同事还是花了大概一个月的工资去买比特币，Etherium 之类的好东西。**
...
投资是“投入金钱、精力、时间等的行为。为赚钱、努力、时间等而投资。，用来做这个”。
...
[![Screen%20Shot%202019-01-30%20at%2015.24.43.png](img/9ecff2f88e230cee763a08ea9e276681.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--fdgozGyE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn.filestackcontent.com/UoLsN0zvQzKKVkuIjmjI)
...
我会用投资者的眼光来审视 PHP，以及竞争对手中谁值得“购买”。

我们开始吧...

## ROI -投资回报

我们今天的目标是回答这个问题:“2019 年最好学的编程语言是什么？”。
...
[![phpJobData.jpg](img/205624d7ca03a71c0fd892688b3663fa.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--puuW136t--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn.filestackcontent.com/NP8tsNpSRKWuAWRkWkTr)
...
正如你所看到的，尽管现在有新的“流行”语言，PHP 在过去的 10 年里没有任何下降

事情看起来稳定了。

[![phpJobVacancyTrend.jpg](img/a3d48c2a95e70c08afd3c4e89db1d32f.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--EEgZvFtT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn.filestackcontent.com/YzKPT0u7T8u7dsT6CKeB)

## 竞赛(Python、Ruby、Java、Go)
...
**脚本语言**，这里我们找到了 PHP、Python、Ruby、Nodejs 这样的语言。

**函数式语言**，以 Scala、Elixir、Haskell 等而闻名。

**高性能语言**这里我们讨论 Go、Rust、Java
...
[![Scripting5YChart.jpg](img/00d1a05328dc0226b17d390f9cc95c2b.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--kmZNh6-2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn.filestackcontent.com/WiXAtPEpQWCduRiHfzcL)
...
在黄色和绿色的末尾，我们分别有 Ruby 和 NodeJs。

这两种语言被认为是所有开发人员的未来，但多年来只是水平移动。

扩大我们的视野，考虑属于后端的其他类型的语言，我附上了另一个图表。

[![back5YChart.jpg](img/9db9ab9b15d5b8b14723fc5f6b65a2ea.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--NVi_7h6a--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn.filestackcontent.com/qN6yak0SvOSOE56goDHw)

这一次，它包含了蓝色的 PHP，红色的 Go，黄色的 Java，最后，有史以来最重要和最著名的语言之一:绿色的 C ++。

正如您很容易发现的那样，Java 显然是所有语言中最流行的语言，
...
在本文中，我实际上已经回顾了超过 24 个 PHP 开发框架。
...
Python 的创造者吉多·范·罗苏姆已经成功地创造了一种很酷的语言，它具有简单的语法，非常适合 TDD(测试驱动开发)。
...
Uday Hiwarale 在这里解释了学习围棋的第一步是什么
...
[![Screen%20Shot%202019-01-30%20at%2015.15.55.png](img/5e8adbf77524097e11380dcd9b5dd3cc.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--Y0rb69ZS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn.filestackcontent.com/A6FNLmSeQLeZzUcILuYS)
...
**我们为什么要用 GitHub 和 StackOverflow 作为参考？**
...
Python 被认为是非常容易学习的，尤其是对初学者来说，因为它的语法简单，可读性高。

PHP 稍微复杂一点，但对于入门级来说仍然非常简单，鉴于其性质，当使用 OOP 和设计模式时，事情会变得复杂得多。

对于 Java，我们开始提高门槛，对于还没有其他语言经验的人来说，这并不简单。
...
它们被称为框架，在某种程度上，尽管学习核心语言和它的框架看起来是违反直觉的，但这将使对所选语言的基本理解更加简单。
...
没有“2019 年最佳编程语言”的迹象，如果它存在，也不会持续这么久，因为每天都有新的编程语言发布。
...
[![https://cdn-images-1.medium.com/max/800/1*QdIYTO1rGhnba7opzHDvRw.jpeg](img/327c35aece085e16f86df30d2b6bfdc1.png)
T3】](http://eepurl.com/dIZqjf)

如果你喜欢这个内容，并且你渴望更多，加入脸书的社区，我们在这里分享信息和新闻，就像这个一样！T3】
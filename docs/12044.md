...
> 原文:[https://dev . to/web maxru/work box-4-implementing-refresh-to-update-version-flow-using-the-work box-window-module-4e3c](https://dev.to/webmaxru/workbox-4-implementing-refresh-to-update-version-flow-using-the-workbox-window-module-4e3c)

[![](../Images/b3bef4b2ff120dfc464e38f25e140c73.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--fOOVBgMc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AL0WSeQSNj3Q6kzNv5rN4bg.png)
...
### [](#refreshtoupdateversion-101)刷新-更新-版本 101
...
### [](#workbox-v3-options-to-have-refreshtoupdateversion-flow)Workbox v3 选项有刷新到更新版本流程

...
> 原文:[https://dev . to/angular/the-7-pro-tips-to-get-productive-with-angular-CLI-schematics-157m](https://dev.to/angular/the-7-pro-tips-to-get-productive-with-angular-cli-schematics-157m)

<figure>[![](../Images/4ead794ce64daf9f9d5ab833cf722b44.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--K8dl6ySM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2ABmpWBv6AoWdbs3wffmIz_g.jpeg) 
...
### [](#1-use-shortcuts-they-are-much-faster)1。使用快捷方式，它们要快得多！🏎️
...
### [](#2-skip-creation-of-an-initial-application)2。跳过初始应用程序的创建

Angular CLI 在单个工作区中提供了对多个应用程序和库的强大支持。此功能很容易被忽略，因为默认情况下，Angular CLI 将使用默认应用程序直接在。/src/ folder。

<figure>[![](../Images/3f812cba7eafa52c8800245050d7ff4e.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--9hlW449i--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2A-e6CBz404bTglnA0jw60HA.png) 
...
<figure>[![](../Images/4b0c28b49994dd3fbecc49abcc76a71b.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--pHwk8cXZ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2ABYmxYVe_5xZxzKODdz3X7Q.png)

<figcaption>Angular CLI 生成的最小工作空间与 ng new CLI-test--create application = false</figcaption>

</figure>

### [](#3-generate-multiple-applications-and-libraries-to-promote-code-reuse)3。生成多个应用程序和库以促进代码重用
...
#### [](#how-can-we-generate-entities-in-different-apps-and-libraries)如何在不同的 app 和库中生成实体？
...
<figure>[![](../Images/ab0cab219502a0a49b6c072e1dd475ce.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--oe9fHoOp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AukDwmZbV6NQJe1kQVNypCw.png)
...
### [](#4-use-schematics-from-3rd-party-npm-packages)4。使用第三方 npm 包中的原理图
...
#### [](#specify-schematics-package-name-in-the-generate-call)在生成调用中指定 schematics 包名
...
<figure>[![](../Images/84cee969256967bfd3fd3f82815a409d.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--mmhH4zBv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2A8AwHrDJ1Bq8aNeWj-hzXQg.png) 

<figcaption>对比使用**ng g**vs**原理图**</figcaption>

</figure>

#### [](#run-schematics-without-the-help-from-angular-cli)不借助 Angular CLI 运行原理图
...
### [](#5-set-schematics-defaults-in-angularjson-file-so-that-we-dont-need-to-specify-all-the-flags-all-the-time)5。在 angular.json 文件中设置 schematics 默认值，这样我们就不需要一直指定所有的标志
...
<figure>[![](../Images/53ff6082175e71bb5e67aa85234bd0cc.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--kua-B-LI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AwpRttbmXcePCFJ21F-a8tg.png) 
...
#### [](#overriding-of-the-default-schematics-collection)覆盖默认 schematics 集合
...
<figure>[![](../Images/669fb9bd99be8f04e373286577d73048.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--jVFSbRum--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2A2IibJvp53-pjk1HryMiMUQ.png) 
...
### [](#6-generate-services%E2%80%8A%E2%80%8Aprovidedin-root-vs-module-flag-scoping-to-lazyloaded-modules)6。生成服务—提供:“根”与模块标志(作用域为延迟加载的模块)

服务生成已更改，默认情况下，Angular CLI 6+生成的服务使用新的 provided in:“root”语法。

<figure>[![](../Images/ea379d2547fdc1eff58987869e6307de.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--78CTSL-X--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AXcMX6I8tbWnxewntwiX4-g.png) 
...
<figure>[![](../Images/fae98edb8ac9cd6ee4821a6fa6c71d02.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--rFQs2JER--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AWaA3qo0dIPKtmJVqWDWnIQ.png) 

<figcaption>调整服务依赖注入注册，将其作用域调整到懒加载模块</figcaption>

</figure>

### [](#7-use-ng-add-to-add-libraries-like-angular-material-or-others)7。使用“ng add”添加像 Angular Material(或其他)这样的库
...
<figure>[![](../Images/3a11f5ae21bd8919960d6c122d9c57b8.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--hit1g9gg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AkufIo62SC3s-OLSBMj-k-w.gif) 
...
### [](#bonus-useful-commands)🎁额外收获:有用的命令

#### [](#run-schematics-without-angular-cli)不带角度 CLI 运行原理图
...
#### [](#list-all-available-schematics)列出所有可用的原理图
...
<figure>[![](../Images/82faba88d11cb1e85902ecb8f7f1c272.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--gbQEO1wp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2A9GlG7m2HdN9eiqCqBvD5iQ.png)
...
<figure>[![](../Images/4d6638362e9fe88b928021f91a564536.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--Hr4h0Qur--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/931/1%2Ao1_I_cjC-k8c9TFvH5atgw.png)
...
<figure>[![](../Images/7286fc8736d88e688177a9a2a39d7fd0.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--wXgohQnw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2Ajny3NETBblGCQW0EYKAMNQ.png) 
...
<figure>[![](../Images/7d5e37738747dc6d63e91efbcfabd39d.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--2jF0UJzY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2ADd6jbdxJApsdWlgvadHR0g.jpeg) 

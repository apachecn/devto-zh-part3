...
> 原文:[https://dev . to/Kyle Galbraith/the-curious-case-of-nvarchar-and-varchar-in-entity-framework-9nj](https://dev.to/kylegalbraith/the-curious-case-of-nvarchar-and-varchar-in-entity-framework-9nj)
...
### [](#entity-framework-to-raw-sql)实体框架到原始 SQL
...
### [](#be-explicit-when-necessary)必要时予以明确

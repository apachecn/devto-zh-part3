...
> 原文:[https://dev.to/evandeaubl/why-do-these-文件-保持-改变-停止-文件变动-xcode-with-a-git ignore-file-1c 96](https://dev.to/evandeaubl/why-do-these--files-keep-changing-stop-the-file-churn-in-xcode-with-a-gitignore-file-1c96)

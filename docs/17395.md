...
> 原文:[https://dev . to/matmooredev/can-you-host-a-read-only-API-on-github-pages-1 jib](https://dev.to/matmooredev/can-you-host-a-read-only-api-on-github-pages-1jib)
...
# [](#storing-the-data-as-version-controlled-csvs)将数据存储为版本控制的 CSV
...
# [](#creating-restful-routes)创建宁静路线

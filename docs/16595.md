...
> 原文:[https://dev.to/kenbellows/why-we-need-css-subgrid-53mh](https://dev.to/kenbellows/why-we-need-css-subgrid-53mh)
...
# [](#scenario-a-bunch-of-cards-with-numbers-on-them)场景:一堆上面有数字的卡片

今天的场景:我希望在我的个人网站上有一个部分显示我最近的 Dev 文章，以及它们的反应计数。让我们做一个模型。

[![Basic card mockup](../Images/37eb8cf50cffb5afa4722f90a248651d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Ay9Exanv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/v8f9etg9hsmg71slvkgm.png)
...
[![Mockup with alignment lines](../Images/74ca6a4c278d2ce60a07c6394a2edc98.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--o67SjYVm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/x1nholc5t10mcl7b9ajq.png)
...
[![Michael Jordan says, "Stop it. Get some help."](../Images/77e7e8fba8841bce220692f4493adab1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--XQCkuwvi--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://i.imgur.com/y8Ea8jB.gif)
...
> ## [](#a-brief-aside-about-tables)略述表外之事
> 
...
# [](#v2-css-grid-and-raw-display-contents-endraw-)v2: CSS 网格和`display: contents`
...
[![Subgrid demo expected output](../Images/162cbacaaa78a18890c37d6f2a27b900.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Kih1MCQX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/km92lsc9ung7adf76u24.png)
...
# [](#more-thoughts-on-subgrid)关于子网格的更多想法
...
### [](#endnote-1-correction-about-double-axis-subgrids)**尾注 1:** 关于双轴子网格的修正！
...
> ![Rachel Andrew profile image](../Images/a8f6b9fd9267b82c01ca1acf1c8bd45a.png)瑞秋安德鲁@瑞秋德鲁![twitter logo](../Images/ad0c7b03deabfe1a161345efb2d537eb.png)[@ ken _ bellows](https://twitter.com/ken_bellows)没错。可以做一个也可以两个都做，这就是单轴的意思。双轴意味着你必须两个都做，没有机会只做一个。2019 年 1 月 09 日下午 16:15[![Twitter reply action](../Images/269095962147c28351274afdd5486a48.png)](https://twitter.com/intent/tweet?in_reply_to=1083034514262278144)[![Twitter retweet action](../Images/771160ecf06ae3d4d7a7815c29c819c2.png)](https://twitter.com/intent/retweet?tweet_id=1083034514262278144)0[![Twitter like action](../Images/c077611ab2a5e0b4cd0c826ee7ae1e48.png)](https://twitter.com/intent/like?tweet_id=1083034514262278144)1
...
### [](#endnote-2-css-tables)**尾注 2:** CSS 表格

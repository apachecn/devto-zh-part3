...
> 原文：<https://dev.to/bertilmuth/implementing-a-hexagonal-architecture-1kgf>
...
[![poem-springboot hexagon](img/2934e7b80da5b2aefa25031d6a054516.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--pe3abT6l--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://dev-to-uploads.s3.amazonaws.com/i/4qzez6aor7higv4wxw9a.PNG)
...
[![poem-hexagon](img/89e77665c2e5a4054b5fae27ca78a71c.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--4a_F9pCz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/02hr6f652yran0dz38h1.PNG)

因此`SimulatedUser`向`IReactToCommands`端口发送命令。它要求用英语和德语写诗。这是代码，可以在 [Github](https://github.com/bertilmuth/poem-hexagon) 上找到。

*诗/简单/驱动 _ 适配器/[SimulatedUser.java](https://github.com/bertilmuth/poem-hexagon/blob/master/src/main/java/poem/simple/driver_adapter/SimulatedUser.java)T3* 
...
*诗/命令/[AskForPoem.java](https://github.com/bertilmuth/poem-hexagon/blob/master/src/main/java/poem/command/AskForPoem.java)T3* 
...
[![poem-hexagon: driven side up next](img/7793ab2bed06d78fcd2717f3592f2ccd.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--cMUjGG4H--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8vsbpug5fjfjzs8sfs2y.PNG)
...
*诗/简单/驱动 _ 适配器/[HardcodedPoemLibrary.java](https://github.com/bertilmuth/poem-hexagon/blob/master/src/main/java/poem/simple/driven_adapter/HardcodedPoemLibrary.java)T3* 
...
*诗/简单/驱动 _ 适配器/[ConsoleWriter.java](https://github.com/bertilmuth/poem-hexagon/blob/master/src/main/java/poem/simple/driven_adapter/ConsoleWriter.java)T3* 
...
[![poem-hexagon: inside up next](img/e9e77bee97a9f801ce765f8a6daaa847.png)](https://res.cloudinary.com/practicaldev/image/fetch/s---tA0dZqp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/efcfrsrwb9jei5uik63k.PNG)
...
*诗/边界/内部/命令 _ 处理程序/[DisplayRandomPoem.java](https://github.com/bertilmuth/poem-hexagon/blob/master/src/main/java/poem/boundary/internal/command_handler/DisplayRandomPoem.java)T3* 
...
`Boundary`类是`IReactToCommands`端口的实现。
它使用[库](https://github.com/bertilmuth/requirementsascode)创建了一个行为模型。行为模型将每种命令类型映射到一个命令处理程序。
然后，一个行为根据行为模型调度命令。

*诗/界/[Boundary.java](https://github.com/bertilmuth/poem-hexagon/blob/master/src/main/java/poem/boundary/Boundary.java)T3* 
...
*诗/简单/[Main.java](https://github.com/bertilmuth/poem-hexagon/blob/master/src/main/java/poem/simple/Main.java)T3* 
...
[![hexagon-poem the completed application](img/07e06fb3aefbfec5d9f76b51418e0e73.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--PDHorQ0r--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/6pe5yam3xe68m11bojff.PNG)

## 切换到春季

该团队决定将 poem 应用程序转变为 web 应用程序。并将诗歌储存在真实的数据库中。他们同意使用 Spring 框架来实现它。在开始编码之前，团队开会并绘制了下图:

[![poem-springboot hexagon](img/a227b5eefe5439afc1a8b1a17b8505a7.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--wwZoHjf---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://dev-to-uploads.s3.amazonaws.com/i/id1k29sxyxxn8sthzxsr.PNG)

现在有一个`PoemController`代替了`SimulatedUser`，它向六边形发送命令。

*诗/跳羚/司机 _ 适配器/[PoemController.java](https://github.com/bertilmuth/poem-springboot/blob/master/src/main/java/poem/springboot/driver_adapter/PoemController.java)*
...
*诗/羚羊/边界/[SpringMvcBoundary.java](https://github.com/bertilmuth/poem-springboot/blob/master/src/main/java/poem/springboot/boundary/SpringMvcBoundary.java)T3* 
...
像以前一样，对`reactTo()`的调用将命令发送到边界。
在六边形的右边，`SpringMvcPublisher`为 Spring MVC 模型添加了一个属性`lines`。这是百里香用来将行插入网页的值。

*诗/跳羚/被驱动 _ 适配器/[SpringMvcPublisher.java](https://github.com/bertilmuth/poem-springboot/blob/master/src/main/java/poem/springboot/driven_adapter/SpringMvcPublisher.java)*
...
*诗/跳羚/被驱动 _ 适配器/[PoemRepositoryAdapter.java](https://github.com/bertilmuth/poem-springboot/blob/master/src/main/java/poem/springboot/driven_adapter/PoemRepositoryAdapter.java)*
...
最后更新于 2021 年 7 月 30 日。你有问题吗？在 Gitter 上与我[聊天。如果你想了解我正在做的事情或给我留言，请在](https://gitter.im/requirementsascode/community)[开发到](https://dev.to/bertilmuth)、 [LinkedIn](https://www.linkedin.com/in/bertilmuth/) 或 [Twitter](https://twitter.com/BertilMuth) 上关注我。或者访问我的 [GitHub 项目](https://github.com/bertilmuth/requirementsascode)。
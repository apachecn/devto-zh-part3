...
> 原文:[https://dev . to/wolk software/why-typescript-a-better-option-when-it-to-functional-programming-3m P0](https://dev.to/wolksoftware/why-typescript-is-a-better-option-than-javascript-when-it-comes-to-functional-programming-3mp0)

在这篇文章中，我想讨论静态类型在函数式编程语言中的重要性，以及为什么在函数式编程中，由于 JavaScript 中缺少静态类型系统，TypeScript 是比 JavaScript 更好的选择。

[![drawing](../Images/574292ea0613f377e71c65a97c170aa3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--68tmMUx9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/gmmmx4nebcdw15qvsghb.png)

## [](#life-without-types-in-a-functional-programming-code-base)生活中没有类型的函数式编程代码库
...
## [](#life-with-types-in-a-functional-programming-code-base)生活用函数式编程代码库中的类型
...
[![](../Images/930ac47de31b7c781c5417957d42c9e2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--oR1ihWM6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8sjf3foelt23tofqsnym.png)

然后我们可以尝试调用`isEligibleToVote`函数，我们的 IDE 会告诉我们需要传递一个类型为`Person`的对象作为参数:

[![](../Images/27a406c6fa828463cfa6408d222d019e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--IA0rVM2p--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/uil57b9gpav1a0dl1ozj.png)

如果我们试图传递一个对象文字，我们的 IDE 将显示所有属性和`Person`类型以及它们的类型:

[![](../Images/20e5be4e933e5672d961baca369c4993.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ld2lLRoH--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/tm2p82yf1aalx7pjdne5.png)
...
## [](#about-types-in-functional-programming-languages)关于函数式编程语言中的类型
...
[![](../Images/a7901eed1d0abbd986daee84227a32ae.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--b6t79U_g--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/91ajqn8adctk9i0tua1u.png)
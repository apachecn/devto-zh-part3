...
> 原文:[https://dev . to/Joe nas/matrix-home server-synapse-v 09911-with-trae fik-35ja](https://dev.to/joenas/matrix-homeserver-synapse-v09911-with-traefik-35ja)

[![Matrix homeserver (Synapse v0.99.1.1) with Traefik](../Images/137fe668b02c087604eabf8b073b17e4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--BFfOR3h---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://jonnev.se/content/images/2019/02/create-matrix-account-2.jpg)
...
### [](#register-account-and-login)注册账号并登录

如果一切正常，您现在可以使用 [Riot](https://riot.im/app) 创建一个帐户并登录。您需要选择“高级”,然后将主服务器 URL 更改为您自己的 URL。

[![create-matrix-account-1](../Images/47cbb79bfc562617fdade483c1668652.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--nGoqrHV2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://jonnev.se/content/images/2019/02/create-matrix-account-1.jpg)

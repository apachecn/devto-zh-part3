...
> 原文:[https://dev . to/eyassh/angular-component-subscription-vs-async pipe-use-pipes-when-possible-e9c](https://dev.to/eyassh/angular-component-subscription-vs-asyncpipe-use-pipes-when-possible-e9c)
...
# [](#subscribing-in-components)订阅组件
...
# [](#-raw-asyncpipe-endraw-can-take-care-of-that-for-you)`AsyncPipe`可以替你照顾那

...
> 原文:[https://dev . to/Kyle Galbraith/how-pulumi-comparates-to-terraform-for-infra structure-as-code-434j](https://dev.to/kylegalbraith/how-pulumi-compares-to-terraform-for-infrastructure-as-code-434j)
...
### [](#getting-started-with-pulumi)普鲁米入门
...
### [](#using-pulumi-with-amazon-web-services)通过亚马逊网络服务使用 Pulumi
...
### [](#using-pulumi-to-provision-our-static-website-infrastructure)使用 Pulumi 供应我们的静态网站基础设施

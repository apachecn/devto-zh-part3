...
> 原文:[https://dev . to/ksu Shiva/integrate-stripe-in-your-ruby-on-rails-app-3d C4](https://dev.to/ksushiva/integrate-stripe-in-your-ruby-on-rails-app-3dc4)
...
## [](#creating-a-user-with-devise)用 Devise 创建用户
...
## [](#integrating-stripe)积分条纹

### [](#adding-the-stripe-credentials)添加条纹凭证

首先，你必须在 Stripe 上注册。
然后，你可以在仪表盘上的 **developers = > API keys** 下找到 Stripe 的开发和生产密钥。您现在将看到的密钥是用于生产的。点击**“查看测试数据”**，查看开发密钥。
[![alt text](../Images/39efedc9ea885d358e0ef5f31734feef.png "Stripe dashboard")T8】](https://res.cloudinary.com/practicaldev/image/fetch/s--2X8ynPZn--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/zhx43ftdoei1u36otcwu.png)

现在，我们将密钥添加到 rails 加密凭证中。为此，我使用默认安装在 MacOS 和 Linux 上的 GNU nano 编辑器。

`$ EDITOR=nano rails credentials:edit`

[![alt text](../Images/951978ad987943efed8f326ee97b1027.png "Nano editor")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--MJoILq-Z--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/21dkny3ugee7r0l7xq8t.png)
...
### [](#linking-a-card-to-a-user)将卡链接到用户
...
[![alt text](../Images/399acb301dccc45a9c39bccdcd21f63c.png "Almost there!")](https://res.cloudinary.com/practicaldev/image/fetch/s--Q8UFNfXU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/7qtebr3t26ncx6e0lty9.png)
...
T3![alt text](../Images/190eb1537bf5b089bd6e0bfa6cbfb8f0.png "Stripe -> Customers")T5】

...
> 原文:[https://dev . to/auto idle/run-laravel-scheduled-jobs-on-heroku-2ah 6](https://dev.to/autoidle/run-laravel-scheduled-jobs-on-heroku-2ah6)

#### Heroku 上的 Laravel 提示 3

[![](../Images/ea67aa151c3302d84ef608142f4ca1cc.png)](https://cdn-images-1.medium.com/max/1024/0*FkjnO3CTtwSUseXT) 

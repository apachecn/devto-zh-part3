...
> 原文:[https://dev . to/dev _ nope/create-a-form builder-component-in-react-native-part-3-1 AIB](https://dev.to/dev_nope/create-a-formbuilder-component-in-react-native-part-3-1aib)
...
# [](#part-3-create-custom-form-input-and-button-components)第 3 部分:创建自定义表单输入和按钮组件
...
### [](#create-a-custom-formbutton-component)创建自定义 FormButton 组件
...
### [](#create-a-custom-formtextinput-component)创建自定义 FormTextInput 组件
...
### [](#update-our-raw-appjs-endraw-file)更新我们的`App.js`文件

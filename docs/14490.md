...
> 原文:[https://dev.to/joshhadik/ruby-vs-elixir-菲兹巴兹-34la](https://dev.to/joshhadik/ruby-vs-elixir---fizzbuzz-34la)
...
### [](#1-elixir-encourages-declarative-programming)**1。Elixir 鼓励声明式编程**
...
### [](#2-elixir-encourages-better-abstraction)**2。药剂鼓励更好的抽象**
...
### [](#3-elixir-works-better-backwards)**3。仙丹“倒着用”效果更好**
...
### [](#4-ruby-is-more-likely-to-cause-unexpected-side-effects)**4。Ruby 更容易引起意想不到的副作用**

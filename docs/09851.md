...
> 原文:[https://dev.to/robmatyszewski/graphql-tutorial-for-newbies 模式定义 7dm](https://dev.to/robmatyszewski/graphql-tutorial-for-newbies---schema-definition-7dm)
...
[![](../Images/c0a4d6dbd57ca9d6813f5032a13e87af.png)T2】](https://app.graphqleditor.com/demo/blog-sample)

## [](#interface)界面

GraphQL 的类型系统以接口为特色。接口公开了一组特定的字段，类型必须包含这些字段来实现接口。例如，我们可以将一个发布界面表示为一本书或一本杂志。这些类型有共同的特征，包括标题和发布日期。

[![](../Images/3dd54169d5684ccdba969d15a579e472.png)T2】](https://app.graphqleditor.com/demo/blog-sample)
...
[![](../Images/e0d6536883520122528cfddc5970065e.png)T2】](https://app.graphqleditor.com/demo/blog-sample)

## [](#declaration-scheme)申报方案

...
> 原文:[https://dev . to/get ghostic/build-laravel-web-applications-比以往任何时候都更快的易于安装-轻松定制-3km2](https://dev.to/getspooky/build-laravel-web-applications-faster-than-ever-easy-to-install-effortless-to-customize-3km2)

Laravel 是由 Taylor Otwell 构建的一个令人难以置信的框架，它结合了强大的 web 开发功能、丰富的文档和活跃的社区。在本教程中，我们将使用 laravelDash 构建一个带有管理面板的 fullstack 应用程序。

## [](#what-is-laravel-dashboard-)什么是 Laravel Dashboard？
...
## [](#minute-1-create-the-laravel-application)第 1 分钟:创建 Laravel 应用程序
...
## [](#minute-2-configuration)第二分钟:配置
...
## [](#minute-3-install-and-configure-laraveldash)第 3 分钟:安装并配置 laravelDash
...
## [](#minute-4-running-migrations-and-defining-relationships)第 4 分钟:运行迁移并定义关系
...
## [](#minute-5yah-youre-on-laraveldash-)第 5 分钟:耶！你在 LaravelDash 上！

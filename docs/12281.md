...
> 原文:[https://dev.to/cassiozen/kotlin-for-js-devs-part-1-5bld](https://dev.to/cassiozen/kotlin-for-js-devs-part-1-5bld)
...
[![Node in Spacesuite](../Images/1409f63e2bbc8bed775d935a5d3d65de.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--sv6FqVTO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/qbro8smi626q9q5nbzgs.png)
...
# [](#ok-but-why-kotlin)好吧，但为什么是科特林？

[![Why Kotlin](../Images/47ea6aac558b6c5767cb82961f184435.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--fBK0KGn8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ev3v5ocbr3l38kcsk985.png)
...
# [](#quick-language-reference-from-js-to-kotlin)快速语言参考(从 JS 到 Kotlin)
...
### [](#single-and-multiple-line-strings)单行和多行字符串
...
### [](#function-expressions-lambdas)函数表达式(Lambdas)
...
### [](#arrays-in-this-case-meaning-lists-of-stuff-that-can-grow-dynamically)数组(在这种情况下意味着“可以动态增长的东西的列表…”)
...
### [](#objects-in-this-case-meaning-keyvalue-maps)对象(在这种情况下意味着“键值映射”)

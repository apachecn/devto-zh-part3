...
> 原文:[https://dev . to/grande mayta/JavaScript-DOM-manipulation-to-improve-performance-459 a](https://dev.to/grandemayta/javascript-dom-manipulation-to-improve-performance-459a)

我写这篇文章是为了用例子向您展示，在用普通 Javascript 开发 Web 应用程序时，如何避免性能问题。

### [](#use-selector-instead-nested-elements)使用选择器代替嵌套元素
...
### [](#avoid-dom-manipulations-inside-loops)避免循环内的 DOM 操作
...
### [](#dont-use-dom-values-inside-loops)不要在循环中使用 DOM 值
...
### [](#use-css-classes-instead-inline-styles)使用 css 类代替内联样式
...
### [](#appending-dom-is-the-most-expensive-operation-choose-the-right-approach)追加 DOM 是开销最大的操作，选择正确的方法

...
> 原文:[https://dev . to/matthewbdaly/understanding-query-objects-4g 42](https://dev.to/matthewbdaly/understanding-query-objects-4g42)
...
# [](#creating-a-query-object-class)创建查询对象类
...
# [](#what-about-repositories)那么存储库呢？
...
# [](#when-to-use-query-objects)何时使用查询对象

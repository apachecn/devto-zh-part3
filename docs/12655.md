...
> 原文:[https://dev . to/Barak plasma/effectively-using-the-chrome-JavaScript-console-66c](https://dev.to/barakplasma/effectively-using-the-chrome-javascript-console-66c)
...
### [](#get-the-average-text-length-for-given-post)获取给定帖子的平均文本长度

...
> 原文:[https://dev . to/oktadev/secure-service-to-service-spring-micro services-with-https-and-oauth-2-0-2889](https://dev.to/oktadev/secure-service-to-service-spring-microservices-with-https-and-oauth-2-0-2889)
...
## [](#develop-a-microservices-stack-with-spring-boot-spring-cloud-and-spring-cloud-config)利用 Spring Boot、Spring Cloud 和 Spring Cloud Config 开发微服务堆栈
...
### [](#create-openid-connect-apps-on-okta)在 Okta 上创建 OpenID Connect 应用
...
## [](#start-your-spring-microservices-stack-with-docker-compose)使用 Docker Compose 启动您的 Spring 微服务堆栈
...
### [](#make-local-tls-easy-with-mkcert)使用 mkcert 简化本地 TLS
...
### [](#https-with-spring-boot)HTTPS 与 Spring Boot
...
## [](#using-https-with-docker-compose)用 HTTPS 用 Docker 作曲
...
## [](#use-http-basic-auth-for-secure-microservice-communication-with-eureka-and-spring-cloud-config)使用 HTTP Basic Auth 与 Eureka 和 Spring Cloud Config 进行安全微服务通信
...
## [](#enhance-your-knowledge-about-spring-microservices-docker-and-oauth-20)增强您对 Spring 微服务、Docker 和 OAuth 2.0 的了解

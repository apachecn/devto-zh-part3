...
> 原文:[https://dev . to/setevoy/go-checking-public-repositories-list-in-github-go-slices-comparison-the-first-golang-experience-1 DDM](https://dev.to/setevoy/go-checking-public-repositories-list-in-github-go-slices-comparison-the-first-golang-experience-1ddm)

[![](../Images/16e8310c93f925081d728c221199ea64.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--cxvuWL-R--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://rtfm.co.ua/wp-content/uploads/2018/04/golang-color-icon2.png) 任务是编写一个工具，它将由一个 cron 从一个 Jenkin 的工作中启动，并将检查 Github 中一个组织的公共存储库列表。
...
### [](#getting-repositories-list-from-github)从 Github 获取存储库列表
...
### [](#comparing-lists-in-go)比较 Go 中的列表
...
[![](../Images/14dcbe60bb158710313de4de6763e405.png "Go: проверка списка публичных репозиториев в Github и уведомления в Slack. Первый опыт с Golang.")T2】](https://rtfm.co.ua/wp-content/uploads/2019/04/Screenshot_20190413_142710.png)

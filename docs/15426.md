...
> 原文:[https://dev.to/swyx/supervised-learning-neural-networks-mpo](https://dev.to/swyx/supervised-learning-neural-networks-mpo)
...
## [](#neurons-and-perceptrons)神经元和感知器

看，一个神经元。希望你有一些这样的东西。

[![https://upload.wikimedia.org/wikipedia/commons/thumb/b/b5/Neuron.svg/1200px-Neuron.svg.png](../Images/f90cd0f496dae735860d795c15b7487f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--sVLuUgaP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://upload.wikimedia.org/wikipedia/commons/thumb/b/b5/Neuron.svg/1200px-Neuron.svg.png)
...
[![https://upload.wikimedia.org/wikipedia/commons/thumb/6/60/ArtificialNeuronModel_english.png/600px-ArtificialNeuronModel_english.png](../Images/da257e1155a478bfebf2c5e2512a77fa.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--osY_vGfj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://upload.wikimedia.org/wikipedia/commons/thumb/6/60/ArtificialNeuronModel_english.png/600px-ArtificialNeuronModel_english.png)

一个输入向量被输入到神经元，神经元将它们乘以一个权重向量并求和。如果总和高于某个触发阈值，神经元被激活并触发输出 1。如果未激活，则输出为 0。

## [](#how-powerful-is-a-perceptron-unit)感知器单元有多强大？
...
## [](#perceptron-rule)感知器法则

设置单个单元，使其与训练集相匹配。

[![https://slideplayer.com/slide/5098348/16/images/13/Perceptron+Training+Rule.jpg](../Images/474edf9a6678db18cd8cdee3c525fb09.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--IGMiNYwp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://slideplayer.com/slide/5098348/16/images/13/Perceptron%2BTraining%2BRule.jpg)
...
[![http://www.ece.utep.edu/research/webfuzzy/docs/kk-thesis/kk-thesis-html/img40.gif](../Images/377d5d2c0ee277e322a924c60d8141b7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--zyZ8fcRE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/http://www.ece.utep.edu/research/webfuzzy/docs/kk-thesis/kk-thesis-html/img40.gif)

然而，如果数据集不是线性可分的(我们没有办法提前知道，尤其是在多维空间)，感知器规则就会陷入无限循环。我们需要更结实的东西。

## [](#gradient-descent)渐变下降

[![https://upload.wikimedia.org/wikipedia/commons/thumb/f/ff/Gradient_descent.svg/700px-Gradient_descent.svg.png](../Images/19e746cbb0c15324af07d14b14b35356.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--_p3WbzMc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://upload.wikimedia.org/wikipedia/commons/thumb/f/ff/Gradient_descent.svg/700px-Gradient_descent.svg.png)

与感知器规则相反，梯度下降抛弃了阈值的概念。它使用相同的增量更新机制，但使用偏导数代替。事实上，这些公式看起来非常相似:

[![https://pedropb.github.io/machine-learning-nanodegree/classes/supervised-learning/images/comparison-of-learning-rules.png](../Images/9db2b411d55f9e004ccac8faa77a2bcd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--xIUxbk1s--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://pedropb.github.io/machine-learning-nanodegree/classes/supervised-learning/images/comparison-of-learning-rules.png)

...
> 原文:[https://dev.to/conw_y/three-tests-for-accessibility-1hep](https://dev.to/conw_y/three-tests-for-accessibility-1hep)
...
### [](#test-1-screenreaderonly)测试 1:仅屏幕阅读器

[![Drawing of a human ear](../Images/3a6f02b490feba77c621fd09126b9e46.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--QwLjexPe--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/t2yjmjrerlhldhurw9cd.png)
...
### [](#test-2-keyboardonly)测试 2:仅键盘

[![Drawing of a human hand](../Images/8902d1dcefdf9d8af9a5fa1b33d4af7f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Eg04AyjN--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/jmzyfd0qpbgrej15468l.png)
...
### [](#test-3-automated-test)测试 3:自动化测试

[![Drawing of a checklist and a wrench](../Images/43aee126bf4fb550e1711a2229f20880.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--_v7rdOWP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/itrji1klpvvwiv1f9pov.png)
...
## [](#benefits-of-manual-testing)手工测试的好处

您会注意到三个测试中有两个是完全手动的，并且不依赖于自动化工具。虽然手动测试比运行自动化工具更难，但我认为它提供了两个关键优势:

### [](#1-it-uncovers-errors-that-no-automated-tool-can-capture)1。它揭示了任何自动化工具都无法捕捉的错误
...
### [](#2-it-puts-us-in-the-shoes-our-users)2。它让我们站在用户的角度考虑问题

手工测试鼓励我们与用户产生共鸣。这种换位思考的心态是良好可用性的重要组成部分，因为它影响我们如何构建、构建什么以及我们优先考虑什么。

## [](#play-well-with-assistive-technologies)玩好辅助技术
...
[![Photo of a person putting their finger on a braille reading device](../Images/364fa921ebc53cda5d9d03676ccec514.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9z-uTaX2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://upload.wikimedia.org/wikipedia/commons/4/4a/Plage-braille.jpg)

[![Photo of a person using a mouth-held stylus to operate a screen](../Images/c6eae7c4ddf9149f6a58300c6a96298b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--3N81HpNy--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.pinimg.com/originals/8f/11/23/8f11237b7a530bdfca68f34c5c051952.jpg)

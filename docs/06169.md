...
> 原文:[https://dev . to/benhaugen/quick-review-of-slice-and-splice-156g](https://dev.to/benhaugen/quick-review-of-slice-and-splice-156g)
...
[![alt text for accessibility](../Images/42258185ef7215f904579b1fcd98c402.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--g4MUu-dP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4ap2vqa3l2ckathpuypb.png)

如果我们不定义第二个参数，从给定索引开始的每个元素都将从数组中移除。看看下面的例子。我们从第二个索引开始切片，只剩下前两个元素。

[![alt text for accessibility](../Images/416684cba110e56eecd3b2632e2ff29c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--28cSPxYl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4r4a20lo32d0wmswrtfu.png)

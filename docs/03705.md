...
> 原文:[https://dev . to/IBM developer/saving-money-and-time-with-node-js-worker-threads-in-server less-functions-d0n](https://dev.to/ibmdeveloper/saving-money-and-time-with-node-js-worker-threads-in-serverless-functions-d0n)
...
### [](#nodejs-v12-runtime-image)node.js v12 运行时图像
...
## [](#worker-threads-in-serverless-functions)无服务器函数中的工作线程
...
### [](#porting-the-code-to-use-worker-threads)移植代码使用工作线程
...
#### [](#how-to-initialise-worker-threads)如何初始化工作线程？
...
#### [](#how-many-worker-threads)有多少工作线程？
...
### [](#nonworkers-performance)非工作人员表现
...
### [](#workers-threads-performance)工作者线程性能

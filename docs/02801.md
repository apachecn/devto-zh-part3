...
> 原文：<https://dev.to/h_polatyuruk/the-most-important-skill-a-programmer-can-learn-5gpf>
...
> 知道什么时候不编码可能是程序员能学到的最重要的技能。— [可读代码的艺术](https://www.amazon.com/Art-Readable-Code-Practical-Techniques/dp/0596802293)
...
> 
> 你有越多的代码，就有越多的地方可以隐藏 bug。签出或编译花费的时间越长。新员工理解你的系统需要的时间越长。如果你不得不重构，会有更多的东西需要移动。
> 
> 此外，更多的代码通常意味着更少的灵活性和功能。这是违反直觉的，但是很多时候，一个简单、优雅的解决方案比一个不太有天赋的程序员编写的一堆代码更快、更通用。
> 
> 代码是由工程师产生的。制造更多的代码需要更多的工程师。工程师有 n 个通信成本，他们添加到系统中的所有代码，在扩展其功能的同时，也增加了一篮子成本。
...
> 了解你的软件的目的和它的核心定义是知道什么时候不编码的第一步。
...
[![](img/9ba079d8821283ca36c88c29fe6a2403.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--OvXcfMiq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/0%2AFXiJvr_jr-a-J4ss.png)

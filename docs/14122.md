...
> 原文:[https://dev . to/blaze phoenix/web scraping-in-python-with-flask-and-beautiful soup-4-1 pkl](https://dev.to/blazephoenix/webscraping-in-python-with-flask-and-beautifulsoup-4-1pkl)

[![](../Images/530fae1d0354e74b752aa61d5974c747.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--kP6u5z7b--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/vlb3nw2civ5iyd3ats4w.jpg)
...
## [](#installing-python-skip-if-already-installed)安装 Python(如果已经安装，跳过)
...
## [](#installing-vscode-skip-if-already-installed)安装 VSCode(如果已经安装，跳过)

...
> 原文:[https://dev . to/azure/using-azure-application-insights-with-angular-5-7-4k EJ](https://dev.to/azure/using-azure-application-insights-with-angular-5-7-4kej)
...
## [](#azure-application-insights-and-angular)Azure 应用洞察与棱角分明
...
## [](#installing-application-insights-for-angular)为 Angular 安装应用洞察
...
## [](#using-application-insights-to-track-users)利用应用洞察跟踪用户

由于我们跟踪用户会话和登录，我们可以获得关于用户行为的非常详细的信息，也可以更好地了解我们的应用程序的性能问题。

你可能要做的第一件事就是检查你网站上的用户和会话:

[![](../Images/d88215509af1542f86aa1fb59afb4a12.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--FBd-gMyk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/t9dxbkglzlzv1459r7sa.png)

但是您还可以做更多的事情，例如，您可以检查应用程序中的用户流量:

[![](../Images/c7967ba82a1122851cb7597dd1c04cd2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--W5krhT2K--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/34ztw56e7h55r6xycsr4.png)

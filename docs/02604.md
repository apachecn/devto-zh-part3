...
> 原文:[https://dev . to/freekmurze/caching-the-whole-response-of-a-laravel-app-2kan](https://dev.to/freekmurze/caching-the-entire-response-of-a-laravel-app-2kan)

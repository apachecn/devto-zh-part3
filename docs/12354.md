...
[![](../Images/897d3057c2fcf89c837bdcde54860ea3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--YjTYbYOw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.kinisoftware.com/content/images/2019/02/Screen-Shot-2019-02-23-at-19.04.15.png)
...
[![](../Images/9d4d18794de02b474f7efa0403bb8d4f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--VXIsXySd--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.kinisoftware.com/content/images/2019/02/Screen-Shot-2019-02-23-at-19.15.59.png)
...
[![](../Images/c16dabbfd8cfcec2917f5ef6ef5235ef.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--mV943LVr--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.kinisoftware.com/content/images/2019/02/Screen-Shot-2019-02-23-at-20.16.43.png)
...
### [](#bola-extra-utterance-profiler)Bola Extra:话语剖析器

Alexa 开发者控制台在我做这项技能时没有的一项功能是，

[![](../Images/df4be9fc541c3ba0685a72c8fae49121.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--npcR_7su--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.kinisoftware.com/content/images/2019/02/Screen-Shot-2019-02-25-at-11.57.21.png)

您可以使用此工具，从螺帽编辑视窗本身测试螺帽的范例提示行为。当我们有插槽来查看它的价值时尤其有用。

我在这里给你们留一个视频链接[德国 Viscuso](https://twitter.com/germanviscuso) 讲述如何使用。

## [](#probando-el-back-desde-la-consola-de-aws-lambda)从 AWS Lambda 控制台测试后端

我已经告诉你了，我们正在测试 E2E 技能，无论是正面还是背面，我们可以留在那里。就我而言，为了了解更多 AWS Lambda，我一直在研究如何测试部署的后端，而无需经过模拟器。

[![](../Images/9ca9c5f772016b37714c341531f47298.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--45dGh55M--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.kinisoftware.com/content/images/2019/02/Screen-Shot-2019-02-23-at-20.37.51.png)

我们可以配置不同类型的“`test events`”帮助我们分别测试后端。在这些类型中，我们可以使用预定义的 Alexa 技能模板创建一个新类型。

[![](../Images/d54a7b52e23d1b16091f16126b9f7e29.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--4ZFwaC8b--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.kinisoftware.com/content/images/2019/02/Screen-Shot-2019-02-23-at-20.40.49.png)

一个简单的例子就是创建一个事件来模拟我们在前面的步骤中看到的‘t0’。为此，我们可以使用 Amazon Alexa Start Session 模板，为其命名，然后保存它，而不需要触摸其他任何内容。

[![](../Images/a7d0d11787ebaf8cd57f6bbbc50323d7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--tZFY5KqE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.kinisoftware.com/content/images/2019/02/Screen-Shot-2019-02-23-at-20.44.38.png)

...
> 原文:[https://dev . to/justinribeiro/experimental-barcode-reader-web-component-released-38pm](https://dev.to/justinribeiro/experimental-barcode-reader-web-component-released-38pm)

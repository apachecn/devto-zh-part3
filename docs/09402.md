...
> 原文:[https://dev . to/jamoyjamie/given-my-article-when-a-reader-reads-then-the-reader-writes-better-tests-16df](https://dev.to/jamoyjamie/given-my-article-when-a-reader-reads-it-then-the-reader-writes-better-tests-16df)

# [](#given-a-developer-who-hates-writing-tests)给一个讨厌写测试的开发者

我不擅长测试，我最常用的副业项目只有大约 5%的测试覆盖率就是证明。我不能让自己辛苦地完成并编写我正在编写的代码的每个测试用例，尤其是当我没有太多的时间去做兼职项目的时候。

# [](#when-placed-in-a-software-house-that-likes-testing)放在喜欢测试的软件屋
...
# [](#and-can-apply-them-anywhere)并且可以在任何地方应用它们

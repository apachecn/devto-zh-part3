...
> 原文:[https://dev . to/alexhyettdev/application-emails-with-Amazon-simple-email-service-4l5o](https://dev.to/alexhyettdev/application-emails-with-amazon-simple-email-service-4l5o)
...
## [](#what-is-amazons-simple-email-service)亚马逊的简单邮件服务是什么？

Amazon SES 是一个基于云的电子邮件发送服务，面向数字营销人员和开发人员，用于发送营销、通知和交易电子邮件。对于低容量的电子邮件，即使不能免费使用，也非常便宜。

## [](#what-does-amazon-ses-cost)亚马逊 SES 要多少钱？
...
## [](#how-to-set-up-amazon-ses)如何设置亚马逊 SES

你显然需要一个 AWS 账户来开始。我不打算在这里详述。登录后，您需要在搜索栏中搜索简单电子邮件服务。

[![Amazon Simple Email Service](../Images/4a8664ea8dd4ee916172db07466f8000.png)T2】](///static/970a3a5e781be92c47cc9e165466f842/e7aec/amazon-ses.png)

### [](#verify-your-domain)验证您的域名

要开始，您需要添加您计划发送电子邮件的域。从菜单中单击身份管理下的域，然后单击验证新域。

[![Verify New Domain](../Images/329332e9d0e1b1dcd2a1caf36e979520.png)T2】](///static/f1190aa2bffbe3bacca41d8111cae1fc/c655d/verify-domain.png)
...
如果你进入发送统计页面，你可能会看到类似这样的内容: [![Amazon SES Sandbox Mode](../Images/a961aac40c9e9d6308eeb41e58489244.png)](///static/1f7795f95d9c2674005cf447a7a9a7a2/d3d45/amazon-ses-sandbox.png)
...
[![Amazon SES SMTP](../Images/254433c378db6d530963923f8b505a8a.png)T2】](///static/78357100c8e2e64dd10c847cf1b75098/636d3/amazon-ses-smtp.png)

创建后，您将获得一个用户名和密码，可以用来发送电子邮件。将它插入您的应用程序，您就可以开始工作了。

## [](#sending-emails-in-a-net-core-application)在. NET 核心应用程序中发送电子邮件

...
> 原文:[https://dev . to/omaiboroda/three-way-to-name-i18n-translation-keys-2 fed](https://dev.to/omaiboroda/three-ways-to-name-i18n-translation-keys-2fed)

团队要么从一开始就进行应用程序的国际化，要么在交付主要语言之后进行。通常，翻译流程如下所示:

[![Translation flow](../Images/7648623cd0723f76454a37e3085a36f2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--CtyObERt--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/zbnBkXs.png)
...
### [](#option-1%E2%80%8A-interesting)选项 1 -有趣
...
### [](#option-2%E2%80%8A-%E2%80%8A-bulletproof)选项 2 -防弹
...
### [](#option-3-straightforward)选项 3——直截了当。

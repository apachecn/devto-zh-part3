...
> 原文:[https://dev . to/jacobknaack/building-a-progressive-blog-app-with-Apollo-and-cosmic-js-1g1g](https://dev.to/jacobknaack/building-a-progressive-blog-app-with-apollo-and-cosmic-js-1g1g)
...
### [](#01-libraries-and-packages)0.1 库和包
...
## [](#10-setting-up-our-project)1.0 设置我们的项目
...
### [](#11-installing-javascript-libraries)1.1 安装 Javascript 库
...
### [](#12-configuring-environment-variables)1.2 配置环境变量

...
> 原文:[https://dev . to/briwa/how-strict-is-typescript-s-strict-mode-311 a](https://dev.to/briwa/how-strict-is-typescript-s-strict-mode-311a)
...
## [](#1-raw-noimplicitany-endraw-)1。`noImplicitAny`
...
## [](#2-raw-noimplicitthis-endraw-)2。`noImplicitThis`
...
## [](#3-raw-strictnullchecks-endraw-)3。`strictNullChecks`
...
## [](#4-raw-strictpropertyinitialization-endraw-)4。`strictPropertyInitialization`
...
## [](#5-raw-strictbindcallapply-endraw-)5。`strictBindCallApply`

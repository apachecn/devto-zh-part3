...
> 原文:[https://dev . to/rem bou 1/manage-cosmosdb-objects-stored-procedure-functions-triggers-with-this-nu get-package-5gpk](https://dev.to/rembou1/manage-cosmosdb-objects-stored-procedure-functions-triggers--with-this-nuget-package-5gpk)

# [](#manage-cosmosdb-objects-stored-procedure-functions-triggers-with-this-nuget-package)管理 CosmosDB 对象(存储过程、函数、触发器...)使用这个 Nuget 包
...
## [](#reading-he-embedded-ressources)阅读他嵌入的资源

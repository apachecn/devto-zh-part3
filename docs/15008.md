...
> 原文:[https://dev . to/tylerlwsmith/simplification-WordPress s-functions HP-with-OOP-part-2-5933](https://dev.to/tylerlwsmith/simplifying-wordpresss-functionsphp-with-oop-part-2-5933)
...
## [](#thinking-in-objectoriented-programming)面向对象编程中的思维

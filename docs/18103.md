...
> 原文:[https://dev . to/damn Jan/when-PHP-framework-sucks-series-business-logic-free-controllers-46gj](https://dev.to/damnjan/when-php-framework-sucks-series-business-logic-free-controllers-46gj)

### [](#business-logic-in-controller)控制器中的业务逻辑
...
### [](#half-of-our-code-now-have-a-unit-tests)我们一半的代码，现在有一个单元测试🤩🤩🤩🤩🤩🤩

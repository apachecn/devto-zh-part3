...
> 原文:[https://dev . to/strapijs/a-true-story-about-strapi-and-the-new-netlify-beta-dev-CLI-4g gn](https://dev.to/strapijs/a-true-story-about-strapi-and-the-new-netlify-beta-dev-cli-4ggn)

[![](../Images/af547348bff1d889bd9fb763eaf36bf9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--WI5UB11b--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/9p9wllra7rtw1k188agg.png)
...
##### [](#1-install-netlify-cli-dev-and-login-to-your-account)1。安装 Netlify CLI Dev 并登录到您的帐户:
...
##### [](#2-authorize-the-sync-by-pressing-one-button)2。按下一个按钮即可授权同步。

##### [](#3-initialize-and-setup-you-project)3。初始化并设置您的项目:
...
##### [](#4-git-push-the-additional-netlify-config-files-and-open-your-site)4。Git 推送附加的 Netlify 配置文件并打开您的站点:

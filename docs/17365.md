...
> 原文:[https://dev . to/swim burger/crawling-through-um braco-with-robots-iab](https://dev.to/swimburger/crawling-through-umbraco-with-robots-iab)
...
## [](#what-is-the-robots-file)什么是 Robots 文件？
...
## [](#robotstxt-basics)Robots.txt 基础知识
...
## [](#robotstxt-and-sitemaps)Robots.txt 和 sitemaps
...
## [](#implementing-robotstxt-in-umbraco)在 Umbraco 中实现 robots.txt
...
### [](#adding-a-new-sitemap-custom-document-type)添加新的站点地图自定义文档类型
...
[![Robots Umbraco Document type](../Images/2515255fe56e05213905e3564b801da0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--_XjxjOpD--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.swimburger.net/media/1095/robots-content-type.png)

在我们添加 Robots 内容之前，我们需要允许它被添加到主页下。

[![Allow Robots Document Type under home](../Images/bb67df41ea384723925d5d64e09f9d63.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--hVzMG-o5--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.swimburger.net/media/1093/allow-under-home.png)

让我们在主页下添加机器人内容，并禁止一些 URL。

[![Disallow URL's using Robots document type](../Images/738f85f208c1adb94208c1b40846a80c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Kh-vS6n3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.swimburger.net/media/1094/disallow-urls.png)

### [](#generating-the-robotstxt-file)生成 Robots.txt 文件
...
### [](#setting-up-a-rewrite-rule-to-robotstxt)设置重写规则到/robots.txt
...
## [](#what-is-the-robots-meta-tag)什么是 robots meta 标签？
...
### [](#implementing-the-robots-meta-tag-in-umbraco)在 Umbraco 中实现机器人元标签
...
[![Add index and follow checkbox properties to base page document type](../Images/ab2e2323bbfb06947c50036283db0e00.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--wcu3esTc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.swimburger.net/media/1092/add-index-and-follow-properties-to-basepage.png)

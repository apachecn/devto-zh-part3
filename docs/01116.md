...
> 原文:[https://dev . to/bnevilleoneill/useful-tools-and-techniques-to-minimize-your-CSS-2d a6](https://dev.to/bnevilleoneill/useful-tools-and-techniques-to-minify-your-css-2da6)

[![](../Images/50b900bb7b9ffeb3c11983d7bd93858c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--kZEbhHsQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AHKAZTPFvBHIVSj52K5TitA.jpeg)
...
### [](#what-does-minification-actually-do)缩小实际上是干什么的？
...
### [](#importance-of-minifying-project-files)缩小项目文件的重要性
...
### [](#ways-to-minify-project-files)缩小项目文件的方法

既然我们都同意缩小项目文件对我们最有利，那么让我们更仔细地看看我们可以采取的方法。

#### [](#manual-minification)手动缩小
...
#### [](#online-minifiers)在线微缩器

有些网站允许你复制你的 CSS 文件并粘贴进去，他们会自动缩小粘贴的代码并给你一个完全缩小的输出。一个很好的例子是我们在本文前面使用的 [CSS Minifier](http://cssminifier.com) 。

[![](../Images/ea31501b3e5d8c3fecdf6e354c0ddd93.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Q1Uode7Q--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/0%2AIL9K1vfvm-rVfhZO.png)

还有 [CSS Compressor](https://csscompressor.com/) 网站，它做的事情和我们上面看到的 minifier 一模一样:它取一个源文件，为你输出一个压缩版本。您可以复制精简的代码或将其作为文件下载。

[![](../Images/4ba535be879854637e8d3724d793b658.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--XFSoMfHv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/0%2AgvAs_ExBzdufwTsN.png)

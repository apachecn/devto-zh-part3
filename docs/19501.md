...
> 原文:[https://dev . to/jmarhee/running-atlassian-bit bucket-server-on-kubernetes-58ko](https://dev.to/jmarhee/running-atlassian-bitbucket-server-on-kubernetes-58ko)
...
#### [](#creating-the-bitbucket-deployment-and-service)**创建位桶部署和服务**
...
#### [](#creating-the-postgres-deployment-and-service)创建 Postgres 部署和服务

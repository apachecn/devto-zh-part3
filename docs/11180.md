...
> 原文:[https://dev . to/Allen Woods/JavaScript-a-primer-for-ruby ists-3hep](https://dev.to/allenwoods/javascript-a-primer-for-rubyists-3hep)

[![Do the thing](../Images/5958c7a868ed05c0814e0cffde8764e2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--I9izNysk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://memeguy.com/photos/images/you-can-do-the-thing-114423.jpg)
...
[![Returns must be explicit](../Images/524fdc0027c9540c092422fcf9983638.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--1yffofl0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ikmuov8tyt5vhqtzjalb.png)
...
# [](#do-or-do-not-there-is-no-pry)做或不做，没有撬
...
[![Do the thing](../Images/29d914039f2ba47b8231163fabf43ee0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--bb7f-6jM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/3vvj1hqb5v77mt51h2g3.png)
...
### [](#curly-boys-to-the-rescue)卷发男生来救援了

有些情况仍然需要使用`do end`语法，比如将逻辑嵌入到`.erb`文件中。但是在大多数情况下，我发现开发跨语言肌肉记忆的最好方法是尽可能使用花括号在 Ruby 中传递块。

[![Curly braces save the day](../Images/b7c0aee940cb3678b2a03bf139b4f069.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--xCDiIvFU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/knk367hfe3z2xkdumwzf.png)

采用这种语法的另一个好处是，在遵循函数可读性的规则可以灵活地将逻辑写成单行的情况下，它为方法链接提供了可能性。

[![There can be only one](../Images/8d4481fcd053a193d53ca66040ae9e4a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--gnxMYyCY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/kwji503cd9naimt57bw0.png)
...
### [](#its-better-than-bad-its-good)总比不好，好

[![All devs love log](../Images/affc9804d663ef141ee0a2ed55fa4769.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--bGwZJbpD--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/pJag78s.jpg)

对`console.log()`如何工作的最简单的解释是，它是一个实用函数，将字符串参数的副本打印到浏览器的控制台窗口。通过使用模板文字将变量插入到字符串中，可以实现与`pry`类似的行为；尽管不是用户友好的。

[![Console's log...](../Images/75048e301c79b5e4433bc2e2d61e9e25.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--WOgSTvs9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/48yiopxzd5zpddowvs5e.png)
...
[![Literally the value](../Images/594de75839808a19874857085a6074bf.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Uyc9x0Yg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/vkxixxjb3ilmui7t55zl.png)

有趣的事实:“反勾”字符的类型叫做“音调符号”,反勾字符本身的名字是“坟墓”。为了记住 JavaScript 中哪种类型的字符串引用允许插入，您可以使用心理联想:

> *“变量插值非常重要”*

# [](#inverted-instantiation)反向实例化
...
[![The new New](../Images/ce56aaef9596d5f9f7278b17bac5e39e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--DLNPanz7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/oqoiezf0yo5wbmoa2r0g.png)
...
[![Appending is easy](../Images/f62d5bc7be4f0e404110b35d68699383.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--3XL4JHyf--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4eho4hpzpg4shnas6hiv.png)

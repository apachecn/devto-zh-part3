...
> 原文:[https://dev.to/llagerlof/quickauthphp-一个用于网络认证的脚本-多用户-不需要数据库-5fa2](https://dev.to/llagerlof/quickauthphp--one-script-for-web-authentication-multi-user-no-database-required-5fa2)

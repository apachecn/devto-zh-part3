...
> 原文:[https://dev . to/hrbrmstr/two-new-ways-to-make-DNS-over-https-queries-in-r-2hn 7](https://dev.to/hrbrmstr/two-new-ways-to-make-dns-over-https-queries-in-r-2hn7)
...
### [](#a-tale-of-two-or-more-queries)两个(或更多)查询的故事

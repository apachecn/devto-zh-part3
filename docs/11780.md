...
> 原文:[https://dev . to/akash _ Raj vanshi/setting-up-man jaro-Linux-从头开始-55n](https://dev.to/akash_rajvanshi/setting-up-manjaro-linux-from-scratch-55n)

<figure>[![](../Images/c52c98457948568c97b45adde9e77de7.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--rSvfFGwf--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AenMY7zrq6lHiaSDRwq1Qhg.png) 

<figcaption>我的曼哈罗桌面</figcaption>

</figure>

### [](#step-1-download-an-image-file)**第一步:下载镜像文件**
...
### [](#step-3-install-yaourt-in-manjaro)第三步:在曼哈罗安装**雅古尔**
...
#### [](#1-using-custom-repository-)**1。使用自定义存储库。**
...
<figure>[![](../Images/8609ae57eaa669f74228e0e7928dc009.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--7iwfHRjA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/845/1%2ALSD0D21FSotbi7n5Z48Vrw.png) 

<figcaption>在 Octopi 中启用 yaurt</figcaption>

</figure>

<figure>[![](../Images/4f6902e511f7572668220c36c5462e31.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--HhmvUgPC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/846/1%2AKPcDGRP6SfRjv6WWJca3Lw.png) 
...
### [](#step-5-get-all-the-apps-of-kdeplasma)第五步:获取 KDE-等离子的所有 app
...
### [](#step-6-system-configuration)第六步:系统配置
...
#### [](#some-important-settings-)一些重要设置:-
...
### [](#step-7-mount-2nd-storage-driveto-increase-storage)第七步:安装第二个存储驱动器(增加存储容量)
...
#### [](#partition-formatting-and-mounting)分区、格式化和挂载
...
### [](#step-8-create-a-backup-of-system-via-timeshift)第 8 步:通过 TimeShift 创建系统备份
...
### [](#step-9-clean-tmp-regularly)第九步:定期清理 Tmp
...
### [](#step-10-configure-ohmyzsh-terminal)第十步:配置 oh-my-Zsh 终端
...
<figure>[![](../Images/8276a2214857c13f03d63aa131b527d0.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--hozq4Gf3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/984/1%2Aca_Q6hA9q4yT5_k4t0fhvA.png)

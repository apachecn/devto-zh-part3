...
> 原文:[https://dev.to/alephnaught2tog/empty-title-x-1-47ng](https://dev.to/alephnaught2tog/empty-title-x-1-47ng)
...
## [](#attempt-1-raw-map-endraw-)尝试 1: `.map`
...
## [](#attempt-2-raw-for-let-index-endraw-)尝试二:`for (let index ... )`
...
## [](#attempt-3-raw-for-of-endraw-)尝试三:`for ... of`
...
## [](#attempt-4-raw-for-in-endraw-)尝试四:`for ... in`
...
## [](#a-notsowellknown-symbol)一个不太知名的符号

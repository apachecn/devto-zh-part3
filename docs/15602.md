...
> 原文:[https://dev . to/marina mosti/-formatting-and-modificing-JavaScript-dates-with-date-fns-3d F2](https://dev.to/marinamosti/-formatting-and-modifying-javascript-dates-with-date-fns-3df2)
...
# [](#calculating-the-number-of-days-between-two-dates)计算两个日期之间的天数

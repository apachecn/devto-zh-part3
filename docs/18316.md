...
> 原文:[https://dev . to/rem bou 1/how-to-create-a-nu get-package-for-blazor-assembly-with-azure-devo PS-263 o](https://dev.to/rembou1/how-to-create-a-nuget-package-for-blazor-assembly-with-azure-devops-263o)

# [](#how-to-create-a-nuget-package-for-blazor-assembly-with-azure-devops)如何用 Azure DevOps 为 Blazor assembly 创建 Nuget 包
...
## [](#azure-devops-and-upload-to-nuget)Azure DevOps 并上传到 nuget

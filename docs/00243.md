...
> 原文:[https://dev . to/swim burger/bulk-add-IP-access-restrictions-to-azure-app-service-using-az-powershell-1fj 6](https://dev.to/swimburger/bulk-add-ip-access-restrictions-to-azure-app-service-using-az-powershell-1fj6)
...
## [](#bulk-insert-ip-access-restrictions-using-az-powershell-script)使用 Az PowerShell 脚本批量插入 IP 访问限制

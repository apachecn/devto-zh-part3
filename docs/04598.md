...
> 原文:[https://dev.to/kball/friday-frontend-gratitude-edition-327n](https://dev.to/kball/friday-frontend-gratitude-edition-327n)
...
##### [](#digging-into-the-display-property-box-generation)[挖掘到显示属性:框生成](https://www.smashingmagazine.com/2019/05/display-box-generation/)
...
##### [](#how-to-build-a-filtering-component-in-pure-css)[如何在纯 CSS 中构建过滤组件](https://webdesign.tutsplus.com/tutorials/how-to-build-a-filtering-component-in-pure-css--cms-33111)

使用`:checked` pseudoselector 和一系列同级选择器构建过滤组件的有趣练习，不需要一点 JavaScript。

##### [](#relative-sizing-with-em-units)[相对尺寸用 EM 单位](https://andy-bell.design/wrote/relative-sizing-with-em-units/)
...
##### [](#securing-gatsby-with-auth0)[用 Auth0 保护盖茨比](https://auth0.com/blog/securing-gatsby-with-auth0/)
...
##### [](#how-to-use-getters-and-setters-in-javascript)[如何在 JavaScript 中使用 Getters 和 Setters】](https://www.developerdrive.com/2019/04/javascript-getters-setters/)
...
##### [](#understanding-mixins-in-vue-js)[了解 Vue JS 中的 mixin](https://blog.bitsrc.io/understanding-mixins-in-vue-js-bdcf9e02a7c1)
...
##### [](#getting-to-know-the-mutationobserver-api)[了解变异观察器 API](https://www.smashingmagazine.com/2019/04/mutationobserver-api-guide/)
...
##### [](#svelte-3-rethinking-reactivity)[苗条 3:反思反应能力](https://svelte.dev/blog/svelte-3-rethinking-reactivity)
...
##### [](#last-day-udemy-courses-for-1199)[最后一天:11.99 美元的 Udemy 课程](http://click.linksynergy.com/fs-bin/click?id=hIdOL5Z4eK4&offerid=507388.10135&type=3&subid=0)

Udemy 正在进行另一次销售，据我所知，现在只剩下一天了。庆祝新的一个月，今天就给自己一个承诺，开始新的课程。

#### [](#other-awesomeness)其他牛气

##### [](#7-adorable-web-development-tricks)[7 个萌 web 开发招数](https://areknawo.com/7-adorable-web-development-tricks/)

一套使用 JavaScript 和 CSS 的小技巧。有些很有趣，但基本上没用，而有些我每天都在用。值得一看。

##### [](#why-page-speed-scores-can-be-dangerous)[为什么网页速度分数会很危险](https://www.machmetrics.com/speed-blog/why-page-speed-scores-can-be-dangerous/)

最近，人们越来越重视 JavaScript 的成本和提高 web 性能，我认为这总体上是一件非常好的事情，但这篇文章强调了过于关注页面速度分数的一些危险。把你的眼睛放在奖品上:一个快速和可用的网站，让工具成为一个向导而不是目标。

##### [](#naming-things-to-improve-accessibility)[命名事物提高可达性](https://hiddedevries.nl/en/blog/2019-04-18-naming-things-to-improve-accessibility)
...
##### [](#building-an-amp-website-with-react-amp-nextjs)[用 React 建一个 AMP 网站& Next.js](https://reacttricks.com/building-an-amp-website-with-react-and-next/)

有趣的是，像 Next.js 这样的高级框架正致力于简化使用现代 JavaScript 框架构建 AMP 页面的工作，无论是独占还是与整个页面并行。

##### [](#a-designers-guide-to-better-decisions)[设计师更好决策指南](https://www.smashingmagazine.com/2019/04/designers-guide-better-decisions/)

...
> 原文:[https://dev . to/oktadev/a-quick-guide-to-spring-boot-log in-options-5fjo](https://dev.to/oktadev/a-quick-guide-to-spring-boot-login-options-5fjo)
...
## [](#build-http-basic-login-in-spring-boot)在 Spring Boot 建立 HTTP 基本登录
...
[![Form Login](../Images/523324bcc229912825f175c4b5ce9bff.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--6Aw_nDIY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://developer.okta.com/assets-jekyll/blog/spring-boot-login-options/form-login-3cd57690ea325b0b82c2f3bd2eeba730dbd8e00b9212aaa212fa576c63cac4ee.png)

## [](#customize-the-spring-boot-login-form)自定义 Spring Boot 登录表单
...
[![Custom Login Form](../Images/dcc74c6d98371d07c80e27d0c9357b66.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--WZSdD5-z--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://developer.okta.com/assets-jekyll/blog/spring-boot-login-options/custom-login-form-e63639954be8694c09fb8ddd5c799e86321cab93246c42a323f9fc408e097d84.png)

使用`user:pass`再次登录，你会看到我们的成功屏幕说，“你成功了！”

## [](#spring-boot-oauth-20-login-using-github-and-single-signon)Spring Boot OAuth 2.0 登录使用 GitHub 和单点登录
...
## [](#simplify-your-spring-boot-app-login-with-github-single-signon)使用 GitHub 单点登录简化您的 Spring Boot 应用程序登录
...
## [](#add-oauth-20-login-with-okta-to-your-spring-boot-app)将 OAuth 2.0 登录 Okta 添加到您的 Spring Boot 应用程序
...
## [](#learn-more-about-spring-boot-login-options-and-secure-authentication)了解有关 Spring Boot 登录选项和安全认证的更多信息

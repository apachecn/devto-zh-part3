...
> 原文:[https://dev.to/5anthosh/an-introduction-to-javascript-31nc](https://dev.to/5anthosh/an-introduction-to-javascript-31nc)

这篇文章最初发表在我的博客上，在这里找到原文

让我们看看什么是 Javascript，我们可以用它实现什么，以及 Javascript 的局限性。

[![JavaScript](../Images/e7de51fe27cb0473f8a0c01470293c24.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Uw-s0jfE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://msatechnosoft.in/blog/wp-content/uploads/2017/04/JavaScript-in-web-design-Basics-Advantages-Limitations-Form-Validation-MSA-Technosoft.png)

...
> 原文:[https://dev . to/devblackops/using-a-powershell-azure-function-to-send-automated-blog-post-tweets-4 MBO](https://dev.to/devblackops/using-a-powershell-azure-function-to-send-automated-blog-post-tweets-4mbo)
...
> ![Brandon Olin [1x Engineer] profile image](../Images/61f6fedc5fe60420728cdf73383779b0.png)布兰登奥林【1x 工程师】[@ devblackops](https://dev.to/devblackops)![twitter logo](../Images/65e26e35707d96169ec8af6b3cbf2003.png)来自博客存档:基础设施测试与纠缠和运营验证框架
> 
...
## [](#blog-post-json-feed)博文 JSON 提要

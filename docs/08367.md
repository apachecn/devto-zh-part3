...
> 原文:[https://dev . to/paultofunmi/develop-and-deploy-your-rest-API-using-MySQL-and-heroku-a61](https://dev.to/paultofunmi/develop-and-deploy-your-rest-api-using-mysql-and-heroku-a61)

在 Rest API 的第一部分中，我们使用 Spring Boot 和赫罗库构建了一个虚构的列表，列出了我们希望在有生之年去旅游或参观的地方。但是，存储桶不存储在数据库中。这意味着每当我们重启服务器时，我们的桶信息都会丢失。

[![Photo by Fabian Grohs on Unsplash](../Images/6f94e5f0b4cf8baa28174ab57759e54b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--45ncqtea--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/pf0fk2mc68lif2n171c3.jpg)
...
[![Project setup](../Images/52b95728183da35b795bcb5920c4f2c7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--_6dpwOKX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/873/1%2Aw17Mgb_34zW-o1HXY8ZTbg.png)

[![Maven dependency](../Images/ecd97edf1a0a7c12ab5020991ed60fe1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vOBzsxCx--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/873/1%2AGzXgjOngiyXWBmAaETk_XA.png)
...
下面是我的文件夹结构的样子
[![Folder structure](../Images/73654e6be6a570940072a44f9e90210f.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--HuJ_JO9T--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/873/1%2A0KppgN1ZwRwCeQ6sK0s2UA.png)
...
[![Add buckets](../Images/33627ee396b87a181cf903b773254039.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--DhG80rQG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/873/1%2AH7OzLP2erz5Mt0eGF2JFnw.png)
...
您应该会看到与下面的
[![All buckets](../Images/8c2f5f5bdad72b62d749071f13821607.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--DQ4IpkqL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/873/1%2A7zAFa2PvEPJps1GxdDbE5A.png) 类似的响应

**测试 3:获取单个桶列表**

[http://localhost:9009/bucket？id=1](http://localhost:9009/bucket?id=1)
[![All buckets](../Images/b2f3188ee0a0465c5c45274340c8f96a.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--UovfWv-w--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/873/1%2AEsTN3uen_PxSfmzMhXGtHQ.png)

**测试四:更新桶**
[http://localhost:9009？name =拜访](http://localhost:9009?name=Visit)大本钟更新&description =我的第一份名单& id=1

[![All buckets](../Images/f6e8198d7c7a119a39096aaede170021.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--qFUlm13X--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/873/1%2AMmW27rXn9--TmoV2cVD7NQ.png)

**测试 5:删除存储桶**

[http://localhost:9009？id = 2](http://localhost:9009?id=2)
[![All buckets](../Images/26d50e6a8f93341b781ea08fd1788776.png)T5】](https://res.cloudinary.com/practicaldev/image/fetch/s--aZDGNRN3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/873/1%2Ao3ZrriYb6R2zxRQ5T_MbrQ.png)

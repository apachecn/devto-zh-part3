...
> 原文:[https://dev . to/practical programming/we-need-a-new-document-markup-language-here-is-why-5d4c](https://dev.to/practicalprogramming/we-need-a-new-document-markup-language---here-is-why-5d4c)

[![markup code](../Images/85c9498b93ddca59daaf2df963746a6f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--wY7Zyary--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/grkzr5qg2xa7n6kjeoit.png)

# [](#introduction-whats-the-problem)简介:有什么问题？
...
# [](#inconveniences-part-1)不便之处/第 1 部分
...
## [](#popular-for-big-documents)流行用于大文件
...
# [](#practical-markup-language-pml)实用标记语言(PML)
...
# [](#inconveniences-part-2)不便之处/第二部分
...
### [](#part-of-a-sentence-in-italics)句子的一部分用斜体表示
...
### [](#part-of-a-word-in-italics)一个词的斜体部分
...
[![HTML chapters](../Images/43a76cda8b8df22de0803068b1c22c50.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--s-11o4FJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/1ir1lgotlffcchcefpl4.png)
...
[![Asciidoctor chapters](../Images/8359d8708c70809ace4596f35459a3c2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--XLOAAFQb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/veu8xvt712r9xte180fe.png)

同样，我们必须更改三个子章节的标记:`==`必须更改为`===`

注意:章节之间的空行是必需的，否则文档不能正确呈现。

### [](#restructuredtext)重构文本

[![reStructuredText chapters](../Images/bf611046fadae0724e2ac3d453b0e375.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--pQBM5Rvx--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/o8gpno4e6wtj9e0mtghx.png)
...
[![PML chapters](../Images/efb66da87f8fe6e785a8b305d14a0f30.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vD8MfIbO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/g3kvbn6xdswwbkvlb4ji.png)
...
## [](#whitespace-and-indentation)空格和缩进

...
> 原文:[https://dev . to/dnasir/azure-functions-node-js-typescript-web pack-a3m](https://dev.to/dnasir/azure-functions-node-js-typescript-webpack-a3m)
...
## [](#webpack-all-the-things)Webpack 所有的东西！

[![Meme image of Webpack All The Things!](../Images/9d1483ac3014b02888e3925b47f78237.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--1Hsym6n4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.dnasir.com/assets/img/2019/webpack-all-the-things.jpg)
...
### [](#-raw-librarytarget-endraw-)`libraryTarget`
...
### [](#-raw-tsconfigpathswebpackplugin-endraw-)`tsconfig-paths-webpack-plugin`
...
### [](#update-project-npm-scripts)更新项目 NPM 脚本

...
> 原文:[https://dev . to/bnevilleoneill/7-bad-excuses-for-not-use-typescript-638](https://dev.to/bnevilleoneill/7-bad-excuses-for-not-using-typescript-638)
...
### [](#1-the-learning-curve-is-too-steep)1。学习曲线太陡了
...
### [](#2-but-javascript-is-standard-typescript-is-not)2。但是 JavaScript 是标准的，TypeScript 不是
...
### [](#3-it-kills-the-dynamic-nature-of-javascript)3。它扼杀了 JavaScript 的动态本质
...
### [](#4-its-not-going-to-be-around-in-5-years)4。五年后它将不复存在
...
### [](#5-its-not-communitydriven)5。这不是社区驱动的
...
[![](../Images/67fa127d0c064a243487596b07dbf989.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--flZuZCiu--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1006/0%2AgxKfxr1C8_pB60Gt)
...
### [](#6-converting-an-existing-project-is-too-much-work)6。转换现有项目的工作量太大
...
### [](#7-but-all-of-the-libraries-i-use-are-in-javascript)7。但是我使用的所有库都是 JavaScript 的

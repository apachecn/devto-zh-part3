...
> 原文:[https://dev . to/moesif/rest-API-design-best-practices-for-sub-and-nested-resources-2m8a](https://dev.to/moesif/rest-api-design-best-practices-for-sub-and-nested-resources-2m8a)
...
### [](#multiple-database-queries)多个数据库查询

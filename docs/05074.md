...
> 原文:[https://dev . to/peterj/using-super gloo-to-install-istio-and-route-traffic-3e3a](https://dev.to/peterj/using-supergloo-to-install-istio-and-route-traffic-3e3a)
...
## [](#installing-supergloo)安装 SuperGloo
...
## [](#installing-istio-with-supergloo)用 SuperGloo 安装 Istio
...
## [](#traffic-routing-with-supergloo)用 SuperGloo 进行交通路由
...
## [](#enable-grafana-and-jaeger-with-supergloo)用 SuperGloo 启用 Grafana 和 Jaeger

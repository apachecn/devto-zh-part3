...
> 原文:[https://dev . to/mehmetseckin/re commendations-on-git-commits-and-pull-requests-4 NLD](https://dev.to/mehmetseckin/recommendations-on-git-commits-and-pull-requests-4nld)

# [](#recommendations-on-git-commits-and-pull-requests)关于 Git 提交和拉取请求的建议
...
### [](#write-good-commit-messages)写好提交消息
...
#### [](#treat-the-first-line-of-your-commit-message-as-the-subject-line)将提交消息的第一行视为*主题行*
...
##### [](#use-imperative-mood-in-the-subject-line)在主题行中使用祈使语气
...
##### [](#do-not-end-the-subject-line-with-a-period)主题行不要以句号结尾
...
#### [](#add-a-body-to-explain-the-context-and-details-of-your-change)添加正文，解释你的变化的背景和细节
...
##### [](#separate-the-body-from-the-subject-line-with-a-blank-line)用空行将正文与主题行分开
...
##### [](#use-the-body-to-explain-what-and-why-instead-of-how)用身体解释*什么*和*为什么*而不是*如何*
...
##### [](#add-references-to-tasks-or-bugs-at-the-end-of-the-body)在正文末尾添加对任务或 bug 的引用
...
### [](#keep-pull-requests-as-small-as-possible)保持拉取请求尽可能小

拉取请求中的变更越多，理解它就越困难，审查它就需要越长的时间。

将您的工作分解为多个逻辑上分离且独立的拉式请求，以简化审查过程，尽早发现 bug 并减少代码味道。

### [](#apply-single-responsibility-principle)适用单一责任原则
...
### [](#the-pull-request-title-should-be-short-and-selfexplanatory)拉取请求的标题应该简短明了
...
### [](#the-description-should-contain-as-much-detail-as-possible)描述应包含尽可能多的细节

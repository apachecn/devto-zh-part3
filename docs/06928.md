...
> 原文:[https://dev . to/sergiosouzalima/the-new-hello-world-for-faastruby-the-server less-platform-for-ruby-crystal-part-2-29pk](https://dev.to/sergiosouzalima/the-new-hello-world-for-faastruby-the-serverless-platform-for-ruby-crystal-part-2-29pk)
...
### [](#creating-the-hello-world-project)创建 Hello World 项目
...
### [](#folder-amp-files-explanation)文件夹&文件解释
...
### [](#starting-faastruby-local)启动 faastRuby local
...
### [](#creating-your-first-function)创建你的第一个函数
...
### [](#starting-the-local-server-again)再次启动本地服务器。

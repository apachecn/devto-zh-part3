...
> 原文:[https://dev.to/kartik2406/types-in-javascript-25ol](https://dev.to/kartik2406/types-in-javascript-25ol)

[![Scope](../Images/f4a3b23407782fc1bc38ed628dcee176.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--87wXHbTQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/v1/./https://thepracticaldev.s3.amazonaws.com/i/o75igcwodrs7ug6hry01.jpg)

数据可以是不同的形式，数字，字符串，布尔等。编程语言的类型系统帮助我们存储各种数据。在这篇文章中，我们将讨论类型化语言的类型，Javascript 中的类型和类型，一些有用的特性。

### [](#how-do-different-languages-handle-types)不同语言如何处理类型？

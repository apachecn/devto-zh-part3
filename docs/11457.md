...
[![Captura de pantalla de una comparación de revisiones de un artículo](../Images/0b3736e5a3eaf0a4e102f8bd4a9c0aeb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--DFRRlZmq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://kungfupress.com/wp-content/uploads/2019/03/revisiones-entrada-baja.png)
...
## [](#c%C3%B3mo-deshabilitar-las-revisiones-de-art%C3%ADculos-desde-c%C3%B3digo)**如何禁用代码**中的文章修订
...
## [](#c%C3%B3mo-no-deshabilitar-las-revisiones-de-art%C3%ADculos-con-un-plugin-cuidado-lee-hasta-el-final)**如何(否)通过插件禁用文章修订。读完！**
...
[![](../Images/652c4ee6af23f23298937423dad54716.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--lRxYHYh5--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://kungfupress.com/wp-content/uploads/2019/03/disable_post_revision.png)

安装此外挂程式、设定此外挂程式并查看其运作方式后，我感到惊讶的是，虽然无法从「控制台」存取修正程式，但仍会继续记录修正程式。也就是说，外挂程式移除了您存取修补程式的优势，并继续让您留着棕色的允许将其储存在错误的资料库中！如果你想安装它！

## [](#c%C3%B3mo-quitar-revisiones-antiguas-en-un-sitio-existente-con-un-plugin)**如何使用**插件删除现有站点的旧修订
...
## [](#como-quitar-revisiones-antiguas-desde-c%C3%B3digo)**如何从代码中删除旧修订。**

...
> 原文:[https://dev . to/Steve blue/setup-a-redirect-on-github-pages-1k 7](https://dev.to/steveblue/setup-a-redirect-on-github-pages-1ok7)
...
## [](#setup-a-new-repository)设置新的存储库

...
> 原文:[https://dev . to/oktadev/build-spring-micro services-and-dockerize-them-for-production-1i4g](https://dev.to/oktadev/build-spring-microservices-and-dockerize-them-for-production-1i4g)
...
## [](#understand-a-modern-microservice-architecture)了解现代微服务架构
...
## [](#build-microservices-in-spring-with-docker)用 Docker 打造春季微服务
...
## [](#the-school-service-microservice)学校服务微服务
...
## [](#the-springbased-school-ui-microservice)基于 Spring 的学校 UI 微服务
...
### [](#use-service-discovery-to-communicate-between-microservices)使用服务发现在微服务之间进行通信
...
### [](#change-school-ui-to-use-spring-cloud-config-and-oauth-20)更改学校 UI 使用 Spring Cloud Config 和 OAuth 2.0
...
### [](#add-docker-compose-to-run-everything)添加 Docker 撰写运行一切
...
## [](#use-spring-profiles-to-modify-your-microservices-configuration)使用 Spring Profiles 修改您的微服务配置
...
## [](#learn-more-about-microservices-spring-docker-and-modern-application-security)了解有关微服务、Spring、Docker 和现代应用安全的更多信息

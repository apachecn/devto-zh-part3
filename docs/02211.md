...
> 原文:[https://dev . to/xab adu/getting-started-with-web-performance-3phi](https://dev.to/xabadu/getting-started-with-web-performance-3phi)
...
### [](#why-should-i-care-about-performance)我为什么要在乎性能？
...
### [](#make-a-plan-for-gradual-improvements-510-at-a-time)制定一个逐步改进的计划(一次 5-10%)
...
#### [](#lighthouse-web-cli-ci)灯塔(Web、CLI、CI)
...
[![Lighthouse in Google's Web Dev site](../Images/238d419a7ba10ae3ed0a70c12f14e105.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--b_zV0d7J--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/rt5kfvu0dfv2yyy4z4lg.png)

<figcaption>Lighthouse in Google's Web Dev site</figcaption>

</figure>

[![Lighthouse in Chrome Dev Tools](../Images/fb2b08a689f064bd2f2f945eb91ea59c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--g7ha8pbQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/v428jozl6c0tdsjey3zb.png)
...
[![PageSpeed Insights](../Images/8b7d778a1d96a8bca8111c4bd567109d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--K7iuSqtT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/mfozflm2qfqae9gp4wll.png)
...
[![Pingdom Website Speed Test](../Images/04b830f15c818ad7ec82f107ac7eac90.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Az3aii1E--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ujsvycj1extpavl8bxi8.png)
...
[![Performance Tab in Chrome Dev Tools](../Images/39a3b420329a370727dc515d9c7d44db.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--7b3DI7Ve--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ei8grylyfeduebi9mt9e.png)

<figcaption>Performance Tab in Chrome Dev Tools</figcaption>

</figure>

### [](#prioritize-issues-and-define-the-bigger-impact)区分问题的优先级并定义更大的影响
...
### [](#figure-out-how-to-fit-performance-into-your-planning-the-good-ol-20)找出如何将绩效融入你的计划中(好的占 20%)
...
### [](#test-everything-and-everywhere)随时随地考验一切
...
[![How to throttle CPU in Chrome Dev Tools](../Images/b481667528748aaa0fc624ca357142b2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--oL2_cSrl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/225jvqiaf1q7tg9dfmx1.png)

<figcaption>How to throttle CPU in Chrome Dev Tools</figcaption>

</figure>

#### [](#throttle-network)节流网络

<figure>

[![How to throttle the network in Chrome Dev Tools](../Images/41e7ccccbd559e192d6aef6a2fb6dadd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--BXNsNTPF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ec9vm7pypa6buey0eyxy.png)
...
### [](#get-data-about-your-users-devices-browsers-and-see-what-theyre-using-and-what-you-should-be-thinking-of)获取你的用户(设备、浏览器)的数据，看看他们在用什么，你应该考虑什么
...
## [](#and-now-lets-get-to-work)现在:我们开始工作吧！

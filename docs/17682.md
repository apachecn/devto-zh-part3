...
> 原文:[https://dev . to/k _ penguin _ sato/graph QL-ruby class-based-API-523n](https://dev.to/k_penguin_sato/graphql-rubyclass-based-api-523n)
...
# [](#graphql-with-ruby-on-rails)GraphQL 与 Ruby on Rails
...
# [](#utilizing-resolvers-directory)利用解析器目录

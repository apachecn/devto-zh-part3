...
> 原文:[https://dev.to/learnbyexample/ruby-regexp-part-1-简介-5c77](https://dev.to/learnbyexample/ruby-regexp-part-1---introduction-5c77)

# [](#preface-amp-prerequisites)前言&先决条件
...
[![find and replace](../Images/15a8160f1f5a885319bc4fe5959d0ccb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--I4iF-c8s--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://learnbyexample.github.io/Ruby_Regexp/images/find_replace.png)

另一个真实的用例是密码验证。下面的截图来自 GitHub 注册页面。执行多种检查，比如字符串长度和允许的字符类型是正则表达式的另一个核心特性。

[![password check](../Images/6afb67c2817537d4afab48b4f867b8fe.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--p32EgQ_X--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://learnbyexample.github.io/Ruby_Regexp/images/password_check.png)
...
## [](#regexp-documentation)Regexp 文档
...
## [](#regexp-literal-reuse-and-interpolation)Regexp 文字重用和插值
...
## [](#sub-and-gsub-methods)sub 和 gsub 方法

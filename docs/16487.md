...
> 原文:[https://dev . to/lukaszkuczynski/clustering-零食和蔬菜-48an](https://dev.to/lukaszkuczynski/clustering-snacks-and-vegetables-48an)

## [](#supervised-vs-unsupervised)有人监督 vs 无人监督:
...
## [](#kmeans-and-sklearn)K-Means 和 sklearn
...
## [](#use-case-veggies-vs-snacks)用例:蔬菜 vs 零食。

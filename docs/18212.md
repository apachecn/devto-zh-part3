...
> 原文:[https://dev.to/antogarand/xss-in-ghost-2o6j](https://dev.to/antogarand/xss-in-ghost-2o6j)
...
# [](#unauthenticated-xss-in-subscriber-page)订户页面中未经认证的 XSS
...
下面是可视化的工作流程:
[![Ghost routes workflow](../Images/c037f448eb6c59b02af3ea5055ff2fb4.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--xvgawzsq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/iep0l10ql9fh9f2m77bp.png)
...
## [](#patch-and-partial-bypass)补丁和部分旁路

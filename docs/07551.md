...
> 原文:[https://dev . to/Dane _ Stevens/building-the-react-image-optimization-component-for-tueri-io-1p2k](https://dev.to/dane_stevens/building-the-react-image-optimization-component-for-tueri-io-1p2k)

[![Low-quality image placeholders](../Images/18d47db413ef8c9343b5cbd1386822e0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--XGTvl-bM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn.tueri.io/274877906967/low-quality-image-placholder.jpg)
...
## [](#building-the-react-image-optimization-component-for-tueriio)为 Tueri.io 构建 React 图像优化组件
...
## [](#this-is-what-we-came-up-with)这是我们想到的:
...
## [](#calculating-the-image-size)计算图像尺寸:
...
## [](#use-the-best-possible-image-format)使用最好的图像格式:
...
## [](#automatic-image-lazy-loading)自动图像惰性加载:
...
## [](#automatic-lowquality-image-placeholders-lqip)自动低质量图像占位符(LQIP):

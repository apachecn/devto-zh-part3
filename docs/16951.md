...
> 原文:[https://dev . to/monty 5811/parsing-bible-references-with-elm-3029](https://dev.to/monty5811/parsing-bible-references-with-elm-3029)
...
## [](#whats-a-reference-look-like)参考是什么样子的？
...
## [](#how-do-we-do-parsing-in-elm)我们如何在 Elm 中做解析？
...
### [](#getting-a-list-of-statements)获取报表列表
...
### [](#validating-the-list-of-statements)验证报表列表
...
## ![GitHub logo](../Images/292a238c61c5611a7f4d07a21d9e8e0a.png)[【monty 5811】](https://github.com/monty5811)/[【elm-bible】](https://github.com/monty5811/elm-bible)

<article class="markdown-body entry-content container-lg" itemprop="text">

# 榆树-圣经

[![Build Status](../Images/c31d68a8ccd07dc7cd56f31b2888475e.png)T2】](https://semaphoreci.com/monty5811/elm-bible)

...
> 原文:[https://dev.to/swyx/supervised-learning-regression-4d17](https://dev.to/swyx/supervised-learning-regression-4d17)
...
## [](#regression-amp-function-approximation)回归&函数逼近

我们现在把注意力转向连续变量，而不是离散变量。我们在[统计](https://en.wikipedia.org/wiki/Regression_analysis)这个词的意义上使用了**回归**这个词。

[![https://upload.wikimedia.org/wikipedia/commons/thumb/3/3a/Linear_regression.svg/440px-Linear_regression.svg.png](../Images/e2bdd0fe61f51b4a5bf7992363499757.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--0eO8gqg3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://upload.wikimedia.org/wikipedia/commons/thumb/3/3a/Linear_regression.svg/440px-Linear_regression.svg.png)
...
## [](#errors-vs-polynomial)误差 vs 多项式

交叉验证对于防止过度拟合的有用性在这里很有帮助:

[![https://cdn-images-1.medium.com/max/1600/1*Y2ahYXQfkLioau03MLTQ1Q.png](../Images/a3f8bf89694c9526a5c02ed43aeaf680.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--qLuoG0Ce--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AY2ahYXQfkLioau03MLTQ1Q.png)

最初，两个过程开始时在低阶多项式上有中等误差。(数据为**欠拟合**)。随着这个数值的增加，拟合度会越来越好。然而，超过某个点后，多项式继续越来越好地拟合训练集，但在 CV 集上表现较差。这是你知道你已经开始**过度适应**的地方。

## [](#other-input-spaces)其他输入空格

到目前为止，我们已经讨论了具有连续输出的标量输入，但是同样的方法也可以应用于具有更多输入特征的矢量输入。如果你想听起来自命不凡，你可以称之为超平面:

[![https://cdn-images-1.medium.com/max/1600/1*ZpkLQf2FNfzfH4HXeMw4MQ.png](../Images/abcb3a6adf752ebd549add719cf0b8db.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--3TvzbKBl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AZpkLQf2FNfzfH4HXeMw4MQ.png)

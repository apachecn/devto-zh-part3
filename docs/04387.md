...
> 原文:[https://dev . to/sane mat/let-s-build-browser-engine-in-typescript-vol 6-CSS-shortcut-1958](https://dev.to/sanemat/let-s-build-browser-engine-in-typescript-vol6-css-shortcut-1958)

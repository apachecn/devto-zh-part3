...
> 原文:[https://dev . to/ADI/simple-solution-for-generating-forms-in-laravel-58f 0](https://dev.to/adi/simple-solution-for-generating-forms-in-laravel-58f0)
...
首先，这是一个默认的引导表单元素。
[![A Bootstrap email input](../Images/4d52c6b29cebe089384ea9d089055e38.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--RqoymZf8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://imgur.com/K0MYH6Z.png)
...
[![Adding customization to basic input](../Images/543768074189d208b3329ffbe2a9618c.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--wcb6XM5C--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://imgur.com/DxU2qR9.png) 
...
[![Setting default values for the variables](../Images/a034abd03d38aad683679cb5a3e18076.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--7pBB5-ui--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://imgur.com/9vWYawp.png)

你可能已经注意到我省略了`$n`和`$l`，因为它们很重要，我们需要知道如果它们没有被设置，表单不会在没有设置的情况下提交。

下面是一个我如何在表单中使用这个组件的例子。
[![Using the components in a form](../Images/7f66832c0bea63f48692b6b91eeb223e.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--xehi909T--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://imgur.com/nF0lW3R.png)

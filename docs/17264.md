...
> 原文:[https://dev . to/rossta/seven-reasons-learn-vuejs-in-2019-2n9o](https://dev.to/rossta/seven-reasons-learn-vuejs-in-2019-2n9o)

我喜欢在 Vue.js 中构建应用程序，这就是为什么我认为框架及其社区的未来是光明的。

### [](#1-no-build-step-required)1。不需要构建步骤
...
### [](#2-a-worldclass-command-line-interface)2。世界级的命令行界面
...
### [](#3-friendly-learning-curve)3。友好学习曲线
...
[![Vue is a Progressive JavaScript Framework](../Images/818cf619c2969fd0c0802890e14e4716.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Ao7M8RNa--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/jlme30ylv1zzv9vo9mr0.png)

不需要学习整个 API 就能上手 Vue，不需要像 JSX 一样学习新的语法；入门只需要基本的 HTML、CSS、JS 知识。

### [](#4-a-solid-ecosystem)4。坚实的生态系统
...
### [](#6-vue-3-lands-this-year)6。Vue 3 今年登陆
...
### [](#7-an-amazing-community)7。一个了不起的社区
...
### [](#bonus-its-just-plain-fun)奖金。这只是单纯的乐趣

...
> 原文:[https://dev.to/vonagedev/sending-an-sms-with-phoenix-20od](https://dev.to/vonagedev/sending-an-sms-with-phoenix-20od)
...
## [](#starting-your-phoenix-server)启动你的凤凰服务器
...
[![Phoenix welcome](../Images/84818a11753ae9a5ca83243a90b71e17.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--aBJQCELe--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/m8yyucnj82n2vbqmjbnx.jpg)
...
### [](#getting-api-credentials)获取 API 凭证
...
[![Nexmo Dashboard API credentials](../Images/cdb1f76a0eb90568ed06ea6375e5ccbe.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--tzXOm33X--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8gun9xogjgrddu4386k9.png)

### [](#buying-a-virtual-number)购买虚拟号码
...
## [](#configuring-your-phoenix-app)配置您的凤凰 App
...
### [](#defining-the-controller-methods)定义控制器方法
...
### [](#adding-httpoison-dependency)添加 HTTPoison 依赖
...
### [](#configuring-environment-variables)配置环境变量
...
[![Success](../Images/e7fbb8e5424cc74a02f3f8cdde81a8be.png)T2】](https://i.giphy.com/media/11sBLVxNs7v6WA/giphy.gif)

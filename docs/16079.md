...
> 原文:[https://dev . to/fteem/understanding-the-basics-of-elixirs-concurrency-model-35e 5](https://dev.to/fteem/understanding-the-basics-of-elixirs-concurrency-model-35e5)
...
## [](#receiving-messages-in-processes)在流程中接收消息
...
### [](#what-if-we-never-receive-a-message)如果我们永远收不到消息怎么办？
...
### [](#wtf-you-mean-by-an-infinite-loop)WTF 你说的“无限循环”是什么意思？！
...
### [](#longrunning-processes-continued)长时间运行的流程，续
...
## [](#keeping-state-using-processes)使用流程保持状态
...
### [](#getting-a-dump-of-the-store)把商店翻个底朝天

...
> 原文:[https://dev . to/c33s/add-the-web-data-user-to-another-group with puppet-19a](https://dev.to/c33s/adding-the-web-data-user-to-another-group-with-puppet-19a)

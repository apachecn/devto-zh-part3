...
> 原文:[https://dev.to/michi/vue-vs-traditional-html-可重用性-组件-初学者-指南-49a1](https://dev.to/michi/vue-vs-traditional-html---reusability--components---beginners-guide-49a1)
...
### [](#passing-data-as-props)传递数据作为道具

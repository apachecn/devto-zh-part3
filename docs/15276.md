...
> 原文:[https://dev . to/on myway 133/curry-in-swift-and-JavaScript-1 ok](https://dev.to/onmyway133/curry-in-swift-and-javascript-1cok)

[![](../Images/69d5fef4148370713af16ff033552152.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--sJvb7oya--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2600/0%2AMlDvDUWN7C4AwXA-)

日常代码中可能会遇到库里而不自知。下面是我对 curry 以及如何在 Javascript 和 Swift 中应用它的一点思考。

## [](#taking-one-parameter-in-haskell)在 Haskell 中取一个参数
...
## [](#curry-in-swift-for-predicate)库里在雨燕中作谓语
...
## [](#using-curry-for-partial-application-in-uikit)在 UIKit 中使用 curry 进行部分应用

...
> 原文:[https://dev.to/tomoyukikashiro/amp-to-pwa-for-gatsby-1pn0](https://dev.to/tomoyukikashiro/amp-to-pwa-for-gatsby-1pn0)

**这篇文章最初是在 [AMP to PWA 为盖茨比](https://blog.tomoyukikashiro.me/post/amp-to-pwa-for-gatsby)发表的。**

## [](#whats-amp-to-pwa)什么是 AMP to PWA
...
## [](#prepare-amp-generation)准备 AMP 生成
...
## [](#add-service-worker-installer-in-amp-for-nonamp-page)在 AMP 中为非 AMP 页面添加维修工人安装程序
...
## [](#add-amp-validation-in-test)在测试中添加放大器验证

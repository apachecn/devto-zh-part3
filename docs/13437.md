...
> 原文:[https://dev . to/nzakas/computer-science-in-JavaScript-double-linked-lists-2pdh](https://dev.to/nzakas/computer-science-in-javascript-doubly-linked-lists-2pdh)
...
## [](#the-design-of-a-doubly-linked-list)双向链表的设计
...
[![Doubly linked list diagram by Lasindi - Own work, Public Domain](../Images/59202f5b45930adc8030c4715f70b3c6.png)T2】](https://commons.wikimedia.org/w/index.php?curid=2245165)
...
### [](#removing-data-from-a-doubly-linked-list)从双向链表中删除数据
...
### [](#creating-a-reverse-iterator)创建反向迭代器

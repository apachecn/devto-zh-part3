...
> 原文:[https://dev . to/foodogsquared/freebies-hunt-my-personal-list-of-free-and-open-resources-3m0d](https://dev.to/foodogsquared/freebies-hunt-my-personal-list-of-free-and-open-resources-3m0d)
...
## [](#personal-experience-and-challenges)个人经历和挑战

作为一个预算只有几百元 PHP(或 10 美元的 T2)和一堆你能在街机上找到的代币的学生，在我解决这个问题之前有一些障碍:

### [](#limited-free-database-service)有限的免费数据库服务
...
### [](#ease-of-creating-and-updating-data)易于创建和更新数据
...
[![The workflow of the data](../Images/fac9c79f8f68b21eac8cb5c3c655f97e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--gE47pskT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/foo-dogsquared/freebies-hunt-api/master/docs/assets/freebies-hunt-api-workflow.png)
...
[![eekayonline image](../Images/bc542afa81a83f572f2d0060fe9de318.png)](/eekayonline) [## 如何为副业寻找灵感

### 埃德温·克莱斯曼 3 月 20 日 192 分钟阅读

#sideprojects #ideas #tips #learning](/eekayonline/how-to-find-side-projects-4hkn)

### [](#choosing-the-right-tool)选择合适的工具
...
## [](#the-site-itself)[网站本身](https://freebies-hunt.netlify.com)
...
## ![GitHub logo](../Images/a73f630113876d78cff79f59c2125b24.png) [ foo-dogsquared ](https://github.com/foo-dogsquared) / [免费赠品-狩猎](https://github.com/foo-dogsquared/freebies-hunt)
...
[![Freebies Hunt logo](../Images/dce25d9603345896d731cb8dd6130d4a.png)T2】](https://raw.githubusercontent.com/foo-dogsquared/freebies-hunt/master/./docs/assets/freebies-hunt-logo.svg)
...
## ![GitHub logo](../Images/a73f630113876d78cff79f59c2125b24.png)[foo-dog squared](https://github.com/foo-dogsquared)/[freeies-hunt-API](https://github.com/foo-dogsquared/freebies-hunt-api)
...
[![Freebies Hunt logo](../Images/452928e7c2dfa7e0a9f8e2c25c9723cc.png)T2】](https://raw.githubusercontent.com/foo-dogsquared/freebies-hunt-api/master/./docs/assets/freebies-hunt-logo.svg)
...
不管怎样，这也代表了我个人使用(或以前使用过)的工具和资源，尽管我承认至少现在还没有全部使用。如果你想给我反馈，不管是关于资源还是网站，请随意。只要确保建议的资源在法律上是免费的<g-emoji class="g-emoji" alias="eyes" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/1f440.png">👀</g-emoji>并且免费使用(尽可能免费如在自由言论，而不是免费啤酒)。还有…

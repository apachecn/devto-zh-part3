...
> 原文:[https://dev . to/eder chrono/swipe-gallery-using-vue-js-tail wind-wotw-4 AKC](https://dev.to/ederchrono/swipe-gallery-using-vue-js-tailwind-wotw-4akc)
...
[![wotw-reference](../Images/4c8f738e92f63886d0740996308fef05.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--VgIPBQ2q--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/tb86mk1j5l3tin33g5vu.gif)
...
### [](#creating-the-mobile-viewport)创建移动视口
...
现在我们应该有这样的东西:
[![container](../Images/b78d8fcf75b69381e6c06585d286a5cb.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--8DgUtmLt--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/3z9rsbrmai7gy1kt1dzk.png)
...
[![diagram-1](../Images/c32252e15bb8c7da02fd37a1ad7afe4f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--kLbaih7E--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/nx3hsowvs9km15m9x944.png)

每当我们浏览图片时，我们最多只能看到这三张图片，所以我们将对它们做一些“魔术”，让它们看起来像是无限的。

当滑动时有两个结果，你向右拖动当前图像并显示前一个`or`拖动下一个图像到当前图像之上:

[![diagram-2](../Images/198ddff1fa16092e6977e50a88ce2e5f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--HLuBxm-F--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/m0gmj01m7csiistzfyej.png)

将拖动的图像释放到任一侧后，我们需要决定图像是停留在中心，还是离开视口:

[![diagram-3](../Images/e0a36447002a304de62025623c0570eb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--kNEvLors--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/0uzrxhooytq8xhg1qwx8.png)

为此，我们将采取图像位置，如果它的一半以上是在视口内，它停留，如果不是，它离开。此外，为了继续使用相同的三幅图像，我们应该相应地交换它们。

### [](#setup-the-images)设置图像
...
### [](#animate-image-after-dropping-it)放下图像后制作动画
...
[![ederchrono](../Images/f52959ed0f92204efeff016985b92748.png)](/ederchrono) [## 带有 Vue.js 和 GSAP - WotW 的极简导航菜单

### eder díaz Apr 24 ' 198min read

#webdev #vue #tutorial #wotw](/ederchrono/minimalistic-nav-menu-with-vue-js-and-gsap-wotw-1m3k)[![ederchrono](../Images/f52959ed0f92204efeff016985b92748.png)](/ederchrono) [## 制作一个交互式密码验证器- WotW

### eder díaz Jul 31 ' 188min read

#webdev #vue #tutorial #wotw](/ederchrono/making-an-interactive-password-validator---wotw-1md0)[![ederchrono](../Images/f52959ed0f92204efeff016985b92748.png)](/ederchrono) [## 制作动画滑块- WotW

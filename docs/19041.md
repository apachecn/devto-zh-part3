...
> 原文:[https://dev.to/pesse/100codeexamples-一个挑战-学习-教学-初级复制-查找-knk](https://dev.to/pesse/100codeexamples--a-challenge-to-learn-and-teach-primaryreplica-lookup-knk)
...
# [](#example-primarysecondary-lookup)示例:主要/次要查找

...
> 原文:[https://dev . to/girlie _ MAC/reiwa-JavaScript-international-date-format-and-Japan-s-new-imperial-era-2 plj](https://dev.to/girlie_mac/reiwa-javascript-international-date-format-and-japan-s-new-imperial-era-2plj)
...
## [](#using-datetimeformat)使用 DateTimeFormat

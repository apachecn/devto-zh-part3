...
> 原文:[https://dev.to/databasesponge/rails-value-objects-一个验证者-统治所有人-4769](https://dev.to/databasesponge/rails-value-objects--one-validator-to-rule-them-all-4769)
...
# [](#solution-the-valid-validator)解:有效的验证器

...
> 原文:[https://dev . to/keta code/lessons-learned a-year-going-fully-less-in-production-3mh 8](https://dev.to/ketacode/lessons-learneda-year-of-going-fully-serverless-in-production-3mh8)

# [](#lessons-learned-a-year-of-going-fully-serverless-in-production)经验教训——生产“完全无服务器化”的一年
...
### [](#2-api-server-on-serverless)**#2。无服务器上的 API 服务器**
...
### [](#3-packing-for-serverless)**#3。无服务器包装**
...
### [](#5-local-testingdevelopment)**#5。本地测试/开发**
...
### [](#8-environment-variables-and-secrets)**#8。环境变量和秘密**
...
### [](#9-performance-and-cold-starts)**#9。性能和冷启动**
...
### [](#10-no-parallel-requests)**#10。没有并行请求**

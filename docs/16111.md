...
> 原文:[https://dev.to/kubadlo/spring-security-with-jwt-3j76](https://dev.to/kubadlo/spring-security-with-jwt-3j76)
...
[![Spring Initializr screenshot](../Images/0fcdf50bda679b715af20ab9e9118f30.png "Screenshot of Spring Initializr with new application details")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vJn5Oert--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://jakublesko.com/images/blog/2019-01-14-spring-initializr.png)
...
#### [](#request-to-public-api)请求公共 API
...
#### [](#request-to-private-api-with-token)用令牌请求私有 API
...
#### [](#request-to-private-api-without-token)对私有 API 的请求没有令牌

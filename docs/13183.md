...
> 原文:[https://dev . to/duranenmanuel/the-低估了 matchmedia-31ep 背后的力量](https://dev.to/duranenmanuel/the-underestimated-power-behind-matchmedia-31ep)
...
## [](#introducing-matchmedia-api)介绍 matchMedia API
...
## [](#mediaquerysensor-a-powerful-and-lightweight-solution-to-the-rescue)MediaQuerySensor，一款强大而轻便的救援解决方案

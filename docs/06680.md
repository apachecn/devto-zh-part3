...
> 原文:[https://dev . to/cmendibl 3/aks-and-application-gateway-expose-than-one-service-in-a-ingress-resource-4cf 0](https://dev.to/cmendibl3/aks-and-application-gateway-expose-more-than-one-service-in-an-ingress-resource-4cf0)

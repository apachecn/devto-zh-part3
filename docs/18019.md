...
> 原文:[https://dev . to/group docs/add-metadata-signatures-to-pdf-documents-using-the-Java-e signature-API-4863](https://dev.to/groupdocs/add-metadata-signatures-to-pdf-documents-using-the-java-esignature-api-4863)

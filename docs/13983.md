...
> 原文:[https://dev . to/revskill 10/what-do-a-ui-component-mean-finally-13nl](https://dev.to/revskill10/what-does-a-ui-component-mean-finally--13nl)
...
## [](#but-is-this-raw-mvc-endraw-)但是，这是`MVC`？

是啊！`behavior`就是`controller`的确切含义。

## [](#so-is-a-raw-component-endraw-the-same-as-raw-mvc-endraw-)那么，a `Component`和`MVC`是一样的吗？

...
> 原文:[https://dev.to/walkingriver/what-the-177l](https://dev.to/walkingriver/what-the-177l)
...
# [](#use-command-output-raw-)使用命令输出``命令
...
# [](#ctrlr-search-history)Ctrl+R 搜索历史

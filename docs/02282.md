...
> 原文:[https://dev . to/papaponmx/progressive-enhancement-respecting-web-browser-preferences-in-a-post-es6-world-p4o](https://dev.to/papaponmx/progressive-enhancement-respecting-web-browser-preferences-in-a-post-es6-world-p4o)
...
## [](#respecting-web-browser-preferences)尊重网络浏览器偏好

即使您没有意识到，浏览器也暴露了用户偏好的信息，所以让我们浏览一下其中的一些。

### [](#font-system-default)字体系统默认
...
### [](#default-to-user-preferred-language)默认为用户首选语言
...
### [](#user-raw-preferscolorscheme-endraw-)用户`prefers-color-scheme`
...
### [](#user-raw-prefersreducedmotion-endraw-)用户`prefers-reduced-motion`

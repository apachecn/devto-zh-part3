...
> 原文:[https://dev.to/yamalight/outstated-基于简单钩子的状态管理-用于反应-1ji1](https://dev.to/yamalight/outstated---simple-hooks-based-state-management-for-react-1ji1)
...
#### [](#-raw-ltprovidergt-endraw-)`<Provider>`

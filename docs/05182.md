...
> 原文:[https://dev . to/thugdebugger/fixing-the-past-is-hard-how-reduxdevtools-and-reselect-can-help-3516](https://dev.to/thugdebugger/fixing-the-past-is-hard-how-reduxdevtools-and-reselect-can-help-3516)

[![back to the future mini gif](../Images/0fd7467ef8f305aeb0fb5e59c1698205.png)T2】](https://i.giphy.com/media/l0NwQEjAS77JyRvig/source.gif)
...
[![flux capacitor getting ready](../Images/02261107b0c166322a0da5bab7ccb534.png)T2】](https://i.giphy.com/media/149gVqjyvMnV72/giphy.gif)
...
<figure>[![states are equal in Redux-DevTools Extension](../Images/1fb9491cf6aee3d08468e26c37cfa11c.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--QognpF7k--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/icgujgkcjnkckovuy7bu.JPG)
...
You should notice on the top row of the extension an option to switch the view from **"diff"** to **"action"**. If you were to switch the view you can now see the action itself which includes the type and payload (if applicable) as seen below. ![action view in Redux-DevTools](../Images/ec028d47cfef7b840715d97eb1bb266a.png)
...
[![Legend of Zelda - Dont go alone gif](../Images/833f4fc23e529fcaa0073a3283e7516b.png)T2】](https://i.giphy.com/media/ElSNi8FdSB7RS/giphy.gif)
...
[![back to the future 88mph](../Images/ad48558a44382e144547d07bdcdf7b3e.png)T2】](https://i.giphy.com/media/xsF1FSDbjguis/giphy.gif)
...
<figure>**[![diff replay on Redux-DevTools](../Images/c7f6c85858e7edfc9c9cecaa486602ee.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--rDEs31PQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/r0ti9f9btgrf83v0k8jx.gif) 

<figcaption>嘿 DJ，拿回来！</figcaption>** </figure>

 ****亲提示:**还记得我们前面的**【图表】**子选项吗？您也可以选择该选项进行时间旅行，这将在回放过程中发生突变时实时重新绘制图表。你可以在下面见证这一点。 [![chart replay on Redux-DevTools](../Images/9d5c3a2c6258d9144877f74ee7a2d933.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--NtygfNgm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/842ly8bak7tdrxodqt2l.gif) 
...
[![Dr.Emmett Brown from Back to the Future](../Images/566231b267e8e50899d3ce1a093200c0.png)T2】](https://i.giphy.com/media/Vqvr9BGv1vhDi/giphy.gif)
...
[![Crazy Dr.Brown from Back to the Future](../Images/89c692a83b5d1076feba03ac949d3ff5.png)](https://i.giphy.com/media/yPO3Yxx3jRSlG/giphy.gif) 
...
虽然这是一个快速的概述，可以帮助您改进 Redux 动作和状态的调试，但是我鼓励您继续扩展您对上述工具和库的了解，以改进您的代码库。我也鼓励你在谷歌上快速搜索更多关于这个主题的信息/教程，比如 Onsen UI & Monaca 团队的这篇很棒的教程，更深入地介绍了 Redux-DevTools 和时间旅行。感谢你回到另一个，但不是最后一个教程；欢迎为我的下一个教程留下任何评论、建议、想法和反馈。【T2![](../Images/ed2d45321739642fa4eb7476527e1c21.png "keep challenging yourself")
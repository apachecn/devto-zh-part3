...
> 原文:[https://dev . to/animir/non-atomic-increments-in-nodejs-or-how-I-found-a-vulnerable-in-express-brute-package-1ncj](https://dev.to/animir/non-atomic-increments-in-nodejs-or-how-i-found-a-vulnerability-in-express-brute-package-1ncj)
...
## [](#check-twice-and-then-once-again)检查两次。然后再一次。
...
## [](#increment-atomically-especially-in-asynchronous-environment)原子级递增。尤其是在异步环境中。
...
## [](#stop-theory-give-us-real-numbers)停止理论，给我们实数。
...
## [](#it-is-important-not-only-for-banks)这不仅对银行很重要
...
[![Example of migration](../Images/90a7c58e0fd5a1046b04e93fcf63063e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--cfwCDuMa--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ttno0t6gvrb807qftnvy.png)

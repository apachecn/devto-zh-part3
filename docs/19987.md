...
> 原文:[https://dev . to/neo/create-a-cryptocurrency-tracking-app-with-push-notifications-using-swift-and-laravel-part-2-the-IOs-app-251 a](https://dev.to/neo/create-a-cryptocurrency-tracking-app-with-push-notifications-using-swift-and-laravel---part-2-the-ios-app-251a)
...
## [](#setting-up-your-client-application)设置您的客户端应用
...
## [](#building-the-ios-application)构建 iOS 应用

### [](#creating-our-storyboard)创建我们的故事板

我们需要做的第一件事是为应用程序设计故事板。这是我们希望故事板完成后的样子。

[![](../Images/45a6ee37676ea9ec6f1a440a5d2f8ff5.png)T2】](//images.ctfassets.net/1es3ne0caaid/3CgFeKuZnyMkQ0Kseaw2Gk/9e4a0a12e87fe5685f30c563d9f3ea8d/ios-cryptocurrency-part-2-storyboard.png)
...
### [](#creating-your-controllers)创建您的控制器
...
### [](#creating-other-supporting-classes)创建其他支持类
...
### [](#updating-the-settings-for-the-device)更新设备的设置
...
### [](#adding-realtime-cryptocurrency-update-support)增加实时加密货币更新支持
...
### [](#adding-push-notifications-to-our-ios-new-application)向我们的 iOS 新应用添加推送通知
...
[![](../Images/9a4a88b2752b3555f34d60b3f570f38f.png)T2】](//images.ctfassets.net/1es3ne0caaid/7wLtGQ4Y00EUWiKgw6oQoE/8eb22b60c3271e6d0e47646c6423a7ad/ios-cryptocurrency-part-2-enable-push.png)

这将在项目的根目录下创建一个授权文件。至此，您已经为您的应用程序提供了完全接收推送通知的能力。

### [](#allowing-our-application-to-connect-locally)允许我们的应用程序本地连接

如果你打算使用本地服务器测试应用程序的后端，那么我们还需要做最后一件事。打开`info.plist`文件并向`plist`文件添加一个条目，以允许连接到我们的本地服务器:

[![](../Images/76a51d549bea00ea00f7b3a46d2627ed.png)T2】](//images.ctfassets.net/1es3ne0caaid/5SXadC36VOcMs22Ooayw44/a7272c2b7126b3195878e1bcfad3e57b/ios-cryptocurrency-part-2-local-connection.png)

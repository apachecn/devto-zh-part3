...
> 原文:[https://dev . to/charlesstover/the-fetch-API-and-asynchronous-redux-state-1 fgk](https://dev.to/charlesstover/the-fetch-api-and-asynchronous-redux-state-1fgk)
...
## [](#what-is-an-asynchronous-action%C2%A0)什么是异步动作？🐌
...
## [](#the-states-of-the-fetch-api)获取 API 的状态🎌
...
## [](#cant-most-of-this-be-automated)这大部分不能自动化吗？🤖

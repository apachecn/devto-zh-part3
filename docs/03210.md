...
> 原文:[https://dev . to/ksivamuthu/terra form-tiller less-helm-deployment-5bhc](https://dev.to/ksivamuthu/terraform-tillerless-helm-deployment-5bhc)
...
## [](#install-tiller-amp-helm-locally)就地安装舵柄&舵
...
## [](#terraform-script-to-do-tillerless-helm-deployment)地形脚本做无舵舵部署

...
> 原文:[https://dev . to/busy peoples/notes-on-typescript-pick-exclude-and-higher-order-components-40cp](https://dev.to/busypeoples/notes-on-typescript-pick-exclude-and-higher-order-components-40cp)

### [](#introduction)简介

这些注释应该有助于更好地理解`TypeScript`，并且在需要查找如何在特定情况下利用 TypeScript 时可能会有帮助。所有示例都基于 TypeScript 3.2。

### [](#pick-and-exclude)挑选并排除

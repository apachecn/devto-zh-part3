...
> 原文:[https://dev . to/oktadev/upgrading-spring-security-oauth-and-JUnit-tests-through-of-a-Java-hipster-bn3](https://dev.to/oktadev/upgrading-spring-security-oauth-and-junit-tests-through-the-of-a-java-hipster-bn3)
...
## [](#logout-with-oauth-20-and-oidc)用 OAuth 2.0 和 OIDC 注销
...
## [](#upgrade-spring-securitys-oidc-support)升级春天安全的 OIDC 支持
...
## [](#how-to-mock-an-authenticatedprincipal-with-an-id-token)如何用 ID 令牌模拟 AuthenticatedPrincipal
...
## [](#how-to-pass-an-oauth-20-access-token-to-downstream-microservices-with-zuul)如何用 Zuul 将 OAuth 2.0 访问令牌传递给下游微服务
...
## [](#how-to-handle-oidc-discovery-in-spring-boot-integration-tests)如何处理 Spring Boot 集成测试中的 OIDC 发现
...
## [](#running-endtoend-tests-on-jhipster-microservices-that-are-secured-with-oauth-20)在使用 OAuth 2.0 保护的 JHipster 微服务上运行端到端测试
...
## [](#upgrade-to-spring-security-51-and-its-firstclass-oidc-support)升级到 Spring Security 5.1 及其一流的 OIDC 支持
...
## [](#use-jhipster-6-to-generate-a-spring-boot-react-app-with-oidc-for-auth)用 JHipster 6 生成一个 Spring Boot + React 的 app，用 OIDC 进行 Auth
...
### [](#why-okta-instead-of-keycloak)为什么是 Okta 而不是 Keycloak？
...
### [](#register-your-secure-spring-boot-application)注册您的安全 Spring Boot 应用
...
## [](#learn-more-about-spring-security-spring-boot-and-jhipster)了解更多关于 Spring Security、Spring Boot 和 JHipster 的信息

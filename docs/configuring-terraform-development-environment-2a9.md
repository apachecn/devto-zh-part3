...
> 原文：<https://dev.to/documentednerd/configuring-terraform-development-environment-2a9>
...
### 步骤 1:在你的 Windows 10 机器上安装 Windows 子系统

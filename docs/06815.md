...
> 原文:[https://dev . to/setevoy/redis-replication-part-4-writing-an-ansi ble-role-fore-the-master-slave-replication-with-redis-sentinel-provisioning-468 p](https://dev.to/setevoy/redis-replication-part-4-writing-an-ansible-role-fore-the-master-slave-replication-with-redis-sentinel-provisioning-468p)

[![](../Images/f6d45197b0b18a1a39702233dbf5afe7.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--rqSEDlVy--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://rtfm.co.ua/wp-content/uploads/2018/05/redislogo.png) 下一篇帖子来自 Redis 复制系列。
...
[![](../Images/01b0e7af56783757ad85e10f0c26d15a.png "Redis: репликация, часть 4 - написание Ansible роли")T2】](https://rtfm.co.ua/wp-content/uploads/2019/04/1_7AfXYNub6eC9j21-JZ-f-A.png)
...
#### [](#testing-sentinel-failover)测试哨兵故障转移

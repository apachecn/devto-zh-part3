...
> 原文:[https://dev.to/bnevilleoneill/new-features-in-webpack-5-49a](https://dev.to/bnevilleoneill/new-features-in-webpack-5-49a)

[![](../Images/c0f30acc42a2ac0c33c73df2544d4c6c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--brOaXoIu--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/400/1%2A92BokALSOmNQ40kn57LeDg.png)
...
### [](#automatic-nodejs-polyfills-removed)**自动 Node.js 多填充移除**
...
### [](#deterministic-chunk-and-module-ids)**确定性组块和模块 id**
...
### [](#splitchunks-and-module-sizes)**分割块和模块大小**

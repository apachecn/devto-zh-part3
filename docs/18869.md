...
> 原文:[https://dev.to/pesse/100codeexamples-单元测试-初级次级-用光标查找-比较-1fci](https://dev.to/pesse/100codeexamples--unit-tests-for-primarysecondary-lookup-with-cursor-comparison-1fci)

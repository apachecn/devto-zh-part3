...
> 原文:[https://dev . to/jaken Herman/creating-firebase-cloud-functions-in-typescript-3mob](https://dev.to/jakenherman/creating-firebase-cloud-functions-in-typescript-3mob)
...
## [](#what-are-cloud-functions)什么是云函数？

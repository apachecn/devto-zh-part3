...
> 原文:[https://dev . to/azure/the-most-minimal-server less-function-3c m1](https://dev.to/azure/the-most-minimal-serverless-function-3cm1)
...
### [](#publishing-our-functions)发布我们的功能
...
## [](#reducing-the-boiler-plate)减少锅炉板

虽然我们可以轻松地手动创建非常简单的函数，但有一些工具可以帮助我们完成所有这些步骤，这样我们就不必自己编写所有的样板文件。

### [](#creating-an-azure-function-project)创建 Azure 功能项目
...
### [](#creating-a-function-app-in-azure)在 Azure 中创建功能 App

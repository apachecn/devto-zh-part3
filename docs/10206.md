...
> 原文:[https://dev . to/azure/typescript-for-JavaScript-developers-by-refactoring-part-2-of-2-EDA](https://dev.to/azure/typescript-for-javascript-developers-by-refactoring-part-2-of-2-eda)
...
<figure>[![](../Images/45eec975218d557e301c9a2fce208d92.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--snDwE05B--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/859/1%2AKHfeiolG6Ip9bKJWC5Rziw.png) 

<figcaption>样本代码</figcaption>

</figure>

### [](#10-simple-refactoring)10。简单重构
...
### [](#13-format-the-print-output)13。格式化打印输出
...
### [](#14-key-types-to-the-rescue)14。救援的关键类型
...
### [](#18-compilation-targets)18。编译目标

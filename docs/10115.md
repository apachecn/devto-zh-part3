...
> 原文:[https://dev.to/thepassle/ing-网络-组件-aef](https://dev.to/thepassle/ing--web-components-aef)

# [](#ing-web-components)ING ❤️网页组件
...
### [](#componentbased-architecture)基于组件的架构

CBA(基于组件的架构)的工作方式是将你界面的各个部分分离成独立的组件，强调可重用性和单一责任。界面可以由不同类型的组件组成:从简单的“叶子”组件，如按钮或输入，到更复杂的复合组件，如登录表单，它本身由许多其他组件组成。

[![button component](../Images/b1ba6ea613cec51d158a4c507edde174.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--yzOuYSsV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2Az2Y7Bar0Q1SR2s0Op5zmMQ.png)

> 一个简单的 UI 按钮组件，用作:`<ing-button>`

通过这种方式，像应用程序视图这样的全部功能可以被定义为它们自己的组件，同时消费和重用更简单的组件。

[![feature debits component](../Images/ff4b89bcef267441b290d129a9be19bb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--RhUgDz-8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2A7r4xPmi2jJ6Pxs3zso_G3A.png)
...
## [](#ing-browser-standards)ING ❤️浏览器标准
...
## [](#ing-browser-support)ING ❤️浏览器支持

随着 Edge 宣布他们打算采用 Chromium 引擎，很快所有主流浏览器都将支持 Web 组件🎉。

[![browser support](../Images/877a610fc6d8efe56f2bc20f3ed76589.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--mYvbWB3e--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2Akm__Z06XweMFH38XkvVEJQ.png)

幸运的是，Web 组件是完全可填充的，这使得我们可以向后兼容那些不支持 Web 组件的旧浏览器，比如 Internet Explorer。但是，这可能会降低多填充浏览器的性能。

## [](#ing-practical-demos)ING ❤️实用演示！

好了，关于标准和规范的讨论已经够多了，是时候动手看看代码了！

下面是一个我们如何编写一个非常简单的 Web 组件的例子:

[![code example](../Images/32bec3a48f4308544611c0496e99c705.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--nUArGvhs--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/htBJ7c1.png)

我们现在可以像这样简单地使用我们的组件:

[![demo](../Images/c815ae1726852b88f181de73db1313c9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--85Y6NLjv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AQtil0digniyZQdiC1TJ8yw.png)

它将在 DOM 中显示为:

[![ing loves web components](../Images/194436496e0de2085f6332fd71de2124.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--xS6sq-ZG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2Aj0HaRy0CRyqwbzvi2q9ktw.png)

关于 Web 组件的一个常见的误解是它们只能接受字符串属性来传递数据。虽然由于 HTML 规范的限制，属性只能是字符串，但幸运的是，如果我们想传递一些丰富的数据，如对象和数组，我们可以简单地实现 getters 和 setters，如下所示:

[![props](../Images/3425ceaab88d6fdb0daccd663921b9ed.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--udyM_UoM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AjiKAPYBovfp9V3Eo1d7t8Q.png)

然后我们可以使用 javascript 设置该属性:

[![set props](../Images/55830ba2583e50c85ddf0a20aa4d7d09.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--TcUDTVLk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AFizXPYfLTVkCIZY8RPF3QA.png)
 ...
 *## [](#ing-the-polymer-project)ING ❤️聚合物项目
...
[![lit](../Images/bf7b828a04326a6b9519cf10b1762bfc.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--T8v4Al_V--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AdlGPLmojovwifG7IqI3Cvw.png)
...
## [](#%C2%A0additional-resources)附加资源

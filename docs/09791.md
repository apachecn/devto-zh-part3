...
> 原文:[https://dev . to/evil mars on/cables-vs-malloctrim-or-that-another-ruby-memory-usage-benchmark-3 emo](https://dev.to/evilmartians/cables-vs-malloctrim-or-yet-another-ruby-memory-usage-benchmark-3emo)

## [](#single-line-big-promise)单线，大有出息
...
## [](#-and-the-benchmark)...基准呢

<figure>

[![benchmark is running](../Images/d0cabe430ae744ce5c11ba0ed1384097.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ld7-50Is--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/srjesjc4yp2x2qaqunn9.gif)
...
[![RTT](../Images/3c9eaea52d57ede9bbad329b3483cb4e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--e-Trgjfu--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/6opzfexmn2mspgfbedmi.png)
...
### [](#ready-steady-run)🏁准备，稳住，跑！

以下是基线的内存配置文件:

<figure>

[![Action Cable memory usage, Ruby 2.6.2, default VM settings](../Images/212a0b37e1dc9f31d28f362dda10a636.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Ogtz5BRL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/l0l61zo5rsdkb2ajq1pa.png)
...
[![Action Cable RTT, Ruby 2.6.2](../Images/e9b1f55eff0ed0b067551d25c8943a82.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ePF_P4PL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/dujv4bxaml4i9rnml46o.png)
...
**注**:为什么不是 [*单调*](http://mathworld.wolfram.com/MonotonicSequence.html) ？多半是由于[](https://en.wikipedia.org/wiki/Outlier)*(见灰色“Max”线)。这是什么原因造成的？我们只能猜测，我们会的，所以继续读下去。*

 *### [](#action-cable-raw-mallocarenamax2-endraw-)动作索+ `MALLOC_ARENA_MAX=2`

首先，内存使用:

<figure>

[![Action Cable memory usage, Ruby 2.6.2, MALLOC_ARENA_MAX=2](../Images/dacfbf1d05b7a6f3203fe1db8aaf07cf.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ovmTuQxy--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/shlb4prye0eiannv0xi8.png)
...
[![Action Cable RTT, Ruby 2.6.2, MALLOC_ARENA_MAX=2](../Images/5601f54adea4bea1865d7396490c434a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--RX5XZ3ef--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/prdr398pexhcc9zg737n.png)
...
### [](#action-cable-raw-malloctrim0-endraw-)动作索+ `malloc_trim(0)`

最后，让我们尝试一下补丁程序(它启发我首先运行所有这些基准):

<figure>

[![Action Cable memory usage, Ruby 2.7-dev, malloc_trim patch](../Images/a489584f2474f65a224a99e313655999.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--J7ApPemc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/mhdvx7e630zvphpyzg2r.png)
...
[![Action Cable RTT, Ruby 2.7-dev, malloc_trim patch](../Images/06abe01ad1a692ec0ccdadf7b432cff8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--HI2rYTzj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ipzmcmqm1mo0q074ey26.png)
...
## [](#so-what-should-i-do-with-action-cable)那么，行动索该怎么办呢？
...
[![AnyCable memory usage](../Images/09724fff908fbfcb8920d18d18996c56.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--kBrRxO99--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4bvvue3tmyj5cfrmbsms.png)
...
[![AnyCable RTT](../Images/85eaac10a48b65c85f270ccfb8e6257d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--nKu1ZYG---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/0h0ynw4su5xt01bjk8yj.png)

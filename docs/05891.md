...
> 原文:[https://dev . to/therealdanvega/how-to-run-multiple-NPM-scripts-in-parallel-3b0p](https://dev.to/therealdanvega/how-to-run-multiple-npm-scripts-in-parallel-3b0p)
...
## [](#running-your-npm-scripts-in-parallel)并行运行您的 npm 脚本

...
> 原文:[https://dev . to/dholth/how-to-use-docker-inst-of-virtualbox-on-OS x-without-change-the-world-4 ack](https://dev.to/dholth/how-to-use-docker-instead-of-virtualbox-on-osx-without-changing-the-world-4ack)
...
#### [](#what-does-vagrant-require-from-a-container)流浪汉对集装箱有什么要求？

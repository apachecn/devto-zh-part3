...
> 原文:[https://dev . to/Samantha Ming/styling-placeholder-text-with-CSS-2he 0](https://dev.to/samanthaming/styling-placeholder-text-with-css-2he0)

[![Code Tidbit by SamanthaMing.com](../Images/5b38c42a918321db60a051af71191ca2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--K8nG9idH--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/tw4xmdref245fm9q79k5.png)
...
### [](#pseudoelement-vs-pseudoclass)伪元素 vs 伪类
...
### [](#firefox-placeholder-default-opacity)Firefox 占位符默认不透明度
...
### [](#css-handling-invalid-selectors)CSS 处理无效选择器
...
## [](#automatically-add-vendorprefixes)自动添加厂商前缀

...
> 原文:[https://dev . to/kagundajm/office-add-in-using-vs code-and-MK cert-private-trusted-ca-fo4](https://dev.to/kagundajm/office-add-in-using-vscode-and-mkcert-private-trusted-ca-fo4)
...
### [](#install-yeoman-toolset)安装约曼工具集
...
### [](#update-the-manifest-file)更新清单文件
...
### [](#install-local-certification-authority-ca)安装本地认证机构(CA)
...
*   打开您的网络浏览器并导航至**[https://localhost:3000/](https://localhost:3000/)**
    ...
    [![alt="office add-in welcome screen"](../Images/6a2ad407709c08546c527b2fba4789dd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--N_gTFyGI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/vr6cqazk39q019dl58u3.png)

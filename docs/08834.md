...
> 原文:[https://dev . to/twilio/build-a-Facebook-messenger-bot-with-twilio-auto pilot-functions-and-send grid-in-node-js-272 b](https://dev.to/twilio/build-a-facebook-messenger-bot-with-twilio-autopilot-functions-and-sendgrid-in-node-js-272b)

[![image with Spectra Hackathon organizers, Autopilot, SendGrid](../Images/7735f2a4f7b7b58371d30107a568c041.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--StW3meM9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3.amazonaws.com/com.twilio.prod.twilio-docs/images/sendgridspectraautopilot.width-1616.png)
...
[![Autopilot logo](../Images/a15cbd0a241203cebd94d73616e4008a.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--9wgDNIMP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3.amazonaws.com/com.twilio.prod.twilio-docs/images/QRMhIBzZcCW81UIhirA8o6BjMWdoLZ4SiDem128IBJKYcR.width-500.png)
...
[![Use in programmable SMS inbound](../Images/078ca1edced660feb372892af9a138d5.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--4XY19uwB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3.amazonaws.com/com.twilio.prod.twilio-docs/images/ncYN3tC6q-fskqXTsG-LjHXeCiIuYQnk9xmAUggsVRIxy.width-1000.png) 
向下滚动到*凭证*部分，点击*脸书登录*按钮进行链接。按照指示将你的脸书页面与你的 Twilio 帐户链接，直到你看到这样一个页面:
[![linked Twilio Autopilot to Messenger image](../Images/c119a636685adb88906ea6ba16ed870e.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--vQRa7g2e--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3.amazonaws.com/com.twilio.prod.twilio-docs/images/8faACmoC2fkldY9lGpqCpQIRM_YligDDpxUn1hAxH9HxX.width-1000.png) 
...
[![Configuration URL img](../Images/0d1b2412f09247db53c9634b129ae662.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--MPfNbFxj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3.amazonaws.com/com.twilio.prod.twilio-docs/images/uDn-jN-Ayu5UJl1KkbsfpoCqWVqKhO_ATdXjueRcFTiEP.width-1000.png) 
...
[![This is your new task img](../Images/b39693abc5df27ddd5b8888275642aba.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--a_Sjjz-x--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3.amazonaws.com/com.twilio.prod.twilio-docs/images/IF6aifFAmJW1-LIPbyHVrxgn53ErivhuYwFLO7sJInDlc.width-1000.png) 
...
[![SendGrid API key configuration](../Images/2d5878573257a6f4eb9ee3239de5fc7c.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--J-kkct9J--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3.amazonaws.com/com.twilio.prod.twilio-docs/images/g9BJdoZi-CcAiJmoq6kIJzM97jbaRs6dj-5KElib9_gVw.width-1000.png) 
现在它可以在你的任何 Twilio 函数中被`context.SENDGRID_API_KEY`引用。

## [](#make-your-first-task)制定你的第一个任务
...
[![modify then view samples img](../Images/68599b4fe255f70260b6ba26511360d3.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--v8cmG5ed--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3.amazonaws.com/com.twilio.prod.twilio-docs/images/DzY_kCfbGToaF74Uq8clRBgEn1wD-6IqwkCv8FrOL6PFx.width-1000.png) 
然后点击文本字段旁边的*展开*按钮，一次在不同行添加多个样本。
[![expand button](../Images/4debd5bc602b7682fd7c28b8c92205a5.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--C0JY7wN6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3.amazonaws.com/com.twilio.prod.twilio-docs/images/Screen_Shot_2019-03-27_at_11.02.37_AM.width-1600.png) 
随意添加你想要的任何例句或复制如下:
 `What page is this
hi
What is spectra
...
[![red plus button](../Images/a8acbe8848e09e3e9d0cd64f9ced9e2e.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--gy7i_V4E--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3.amazonaws.com/com.twilio.prod.twilio-docs/images/Screen_Shot_2019-03-27_at_11.04.12_AM.width-1000.png) 
在对自动驾驶助手做了所有这些改动之后，我们需要创建一个新的模型。转到自然语言路由器下的 Build Models 选项卡，创建一个新的模型构建，名称类似于“v0.1”。
[![model build](../Images/f99af053071329a962407babadf8b906.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--thhlVG3I--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3.amazonaws.com/com.twilio.prod.twilio-docs/images/image.width-1000.png) 
您可以使用与上述相同的说明为我们的 Facebook Messenger bot 添加其他静态任务。现在让我们继续做一个动态任务。
T31![flexible dog gif](../Images/238c49d3493eab145c7b4b7e8794fe7d.png)T33】

## [](#make-a-dynamic-task)制作动态任务
...
[![email gif](../Images/d8b18cdd702b848ea9235c8aa29f574e.png)T3】](https://i.giphy.com/media/3oriNUctGOi5sTtvGg/giphy.gif)
...
T3![FB Messenger bot in action](../Images/1fe3424ae697b1400c1598b63ebb8082.png)T5】

## [](#whats-next)接下来是什么

[![Baymax gif](../Images/d388768a8af35ebd3412901f800f1f35.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--BJxOXRCX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3.amazonaws.com/com.twilio.prod.twilio-docs/original_images/DZNiTolJIThVbuYQGZlwZspyIjC6kJKNmwDZaR_rgdvcCkciOVdEq5WJnZ5zhXw4N7Cc0MAV-2VV01) 

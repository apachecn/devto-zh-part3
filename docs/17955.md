...
> 原文:[https://dev . to/oktadev/build-a-simple-crud-app-with-python-flask-and-react-30k 5](https://dev.to/oktadev/build-a-simple-crud-app-with-python-flask-and-react-30k5)
...
## [](#create-a-rest-api-with-python)用 Python 创建 ReST API
...
### [](#define-the-python-model-schemas)定义 Python 模型模式
...
### [](#python-rest-api-persistence-with-mongodb)Python ReST API 持久性与 MongoDB
...
### [](#define-your-rest-api-middleware)定义你的 ReST API 中间件
...
### [](#define-your-rest-api-endpoints)定义你的 ReST API 端点
...
## [](#create-the-react-clientside-app)创建 React 客户端 App
...
### [](#add-authentication-to-your-react-app-with-okta)使用 Okta 为您的 React 应用程序添加认证
...
[![login button](../Images/91565931eef9051cea8f93fe793b95b6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Hnq654by--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://developer.okta.com/assets-jekyll/blog/python-react/app-login-button-40782929265b11b95fb375defb3a52c3b6d379ee52c180a0cfb3918d2fc34dc6.png)

在登录组件中，您使用 Okta React SDK 来检查用户是否已经登录。如果用户已经登录，他们应该被重定向到`/home`路线，否则他/她可以点击`Login With Okta`被重定向到 Okta，验证并被发送到主页。

[![login page](../Images/746f7d6c34fd5212eb8ff193e98d165c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--fY17-Cql--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://developer.okta.com/assets-jekyll/blog/python-react/app-login-0a7959211c7cf87c6831e805465116e67c19bc1f285f6d217b230c2d29190614.png)

目前，主页是空白的，但最终您会希望主页看起来是这样的:

[![home page](../Images/c79bcdca3077a05f52c39e256dee97ae.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---xw9nC5R--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://developer.okta.com/assets-jekyll/blog/python-react/app-home-page-424e1d03eb87ee19319ab76a89eb92edd4397af6234e1855a87f06bfe337ad8f.png)
...
[![final running app](../Images/b4ccbec2432fa8f57e81f0aced6bbd03.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--b5e0vd53--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://developer.okta.com/assets-jekyll/blog/python-react/final-running-app-533712d704c661e6aceee0f5788d20e61b17974483006a861d607c51b49f062d.gif)

## [](#learn-more-about-python-flask-and-react)了解关于 Python、Flask 和 React 的更多信息

...
> 原文:[https://dev . to/mkhy 19/detect-your face-through-image-or-video-camera-in-python-55em](https://dev.to/mkhy19/detect-your-face-through-image-or-video-camera-in-python-55em)

## [](#human-face-detection-and-recognition-is-an-important-technology-used-in-various-applications-such-as-students-attendance-in-the-classroom-which-is-my-graduation-project)人脸检测与识别是一项重要的技术，应用于各种应用中，比如我的毕业设计——学生在教室里的考勤。
...
## [](#first-detect-your-face-through-image)首先，通过图像检测你的脸
...
### [](#here-is-the-repo-you-can-find-the-source-code-in-python)[这里的](https://github.com/mkhy19/Crash-courses/tree/master/Computer%20vision/face%20detection%20-%20openvc)是回购，可以在 python 中找到源代码。
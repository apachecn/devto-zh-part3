...
> 原文:[https://dev . to/ms H5/start-d b-schema-migration-with-goose-bhg](https://dev.to/msh5/start-db-schema-migration-with-goose-bhg)
...
## [](#what-is-schema-migration-)什么是“模式迁移”？

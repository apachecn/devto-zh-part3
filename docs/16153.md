...
> 原文:[https://dev . to/zealot 128/simple-but-realistic-elastic search-load-test-before-deployment-jd8](https://dev.to/zealot128/simple-but-realistic-elasticsearch-load-test-before-deploying-jd8)
...
## [](#preparation-gather-good-queries-for-test)准备-为测试收集好查询
...
## [](#build-new-test-cluster)建立新的测试集群

一个提示(如果尚未使用):使用存储库+快照(S3)快速为新集群播种生产级数据。

## [](#test-the-oldnew-cluster)测试(旧/新)集群
...
## [](#bonuspoints-quick-chart-with-asciicharts)要点:带 ascii 字符的快速图表
...
## [](#anecdote-results-for-our-smallish-cluster)趣闻:我们小小星团的结果

...
> 原文:[https://dev . to/krofdrakula/searching-through piles-without-break-the-bank-PBA](https://dev.to/krofdrakula/searching-through-piles-without-breaking-the-bank-pba)
...
### [](#values-variables-and-references)值、变量和引用
...
## [](#keeping-track-of-references-using-raw-set-endraw-)使用 [`Set`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Set) 记录参考文献
...
[![](../Images/6539016fe9a495dfc6984f2b5efe8421.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--d4FQ8C_v--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/92r2phjrtjutmylcpq81.PNG)
...
### [](#when-to-use-raw-set-endraw-)什么时候用`Set`
...
## [](#creating-associations-between-values-with-raw-map-endraw-)与 [`Map`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Map) 之间产生联想
...
[![](../Images/4cd46f1ebddd2e529d8918e19b7db676.png)T2】](https://i.giphy.com/media/nC1toglzIfNFC/giphy.gif)

### [](#when-to-use-raw-map-endraw-)什么时候用`Map`
...
### [](#caveats-to-consider-when-dealing-with-json-data)处理 JSON 数据时要考虑的注意事项
...
[![krofdrakula](../Images/80973c515f9b0cdf2ea5de3f411cdc0d.png)](/krofdrakula) [## 为了乐趣和利润而扩展 JSON

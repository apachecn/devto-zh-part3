...
> 原文:[https://dev.to/geojow/deploying-an-ios-app-with-travisci-试飞-1naa](https://dev.to/geojow/deploying-an-ios-app-with-travisci--testflight-1naa)
...
# [](#certificates-amp%C2%A0profiles)证书&简介

## [](#apple-worldwide-developer-relations-certification-authority)苹果全球开发者关系认证机构
...
## [](#iphone-distribution-certificate-private%C2%A0key)iPhone 分发证书+私钥
...
# [](#ios-provisioning-profile-distribution)iOS 预置描述文件(分发)
...
# [](#publishing-to-itunesconnect-testflight)发布到 iTunesConnect (TestFlight)
...
# [](#update%C2%A0travisyml-file)更新. travis.yml 文件

...
> 原文:[https://dev . to/crai overflow/how-to-enable-open shift-service-catalog-components-in-minishift-be5](https://dev.to/craicoverflow/how-to-enable-openshift-service-catalog-components-in-minishift-be5)

...
> 原文:[https://dev . to/Samantha Ming/better-array-check-with-array-is array-a17](https://dev.to/samanthaming/better-array-check-with-array-isarray-a17)

[![CodeTidbit by SamanthaMing.com](../Images/008378ba63deb15f5178e76007a6a8e2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--dMiP4bbR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/2vl16vmr13v5wbfyiif5.png)
...
## [](#array-is-not-a-true-array)数组不是真正的数组
...
## [](#arrayisarray-demo)Array.isArray 演示

好的，让我们在其他值上试试这个方法，看看我们会得到什么👩‍🔬

### [](#these-are-all-arrays-and-will-return-raw-true-endraw-)这些都是数组，会返回`true`
...
### [](#these-are-not-arrays-and-will-return-raw-false-endraw-)这些不是数组，将返回`false`

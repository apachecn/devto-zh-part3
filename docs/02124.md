...
> 原文:[https://dev . to/hamatti/make-your-function-calls-more-readable-12 n1](https://dev.to/hamatti/make-your-function-calls-more-readable-12n1)
...
### [](#a-quick-primer-on-object-destructuring)对象析构快速入门
...
## [](#further-improvement-with-typescript)用 Typescript 进一步改进

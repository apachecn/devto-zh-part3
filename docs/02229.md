...
> 原文:[https://dev . to/ispirett/how-CSS-preprocessors-save-you-time-and-money-published-false-1g 09](https://dev.to/ispirett/how-css-preprocessors-save-you-time-and-money-ublished-false-1g09)
...
[![Joy](../Images/0353e64dd7bcf3f2a8e04a2f95117914.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--thByDwn_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2AFn8e4JC6VD1HqzicHUY5CQ.gif) 
...
#### [](#2-in-your-working-directory-add-your-sass-or-scss-file-ex-mainscss-then-and-run-this%C2%A0command)2 在你的工作目录下添加你的 SASS 或者 SCSS 文件 ex: main.scss 然后运行这个命令。
...
## [](#further-your-knowledge-with-these%C2%A0links)通过这些链接加深你的知识。

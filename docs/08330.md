...
# [](#o-que-n%C3%A3o-%C3%A9-graphql)什么不是图形 SQL？
...
## [](#graphql-n%C3%A3o-%C3%A9-um-banco-de-dados)GraphQL 不是数据库
...
## [](#graphql-n%C3%A3o-%C3%A9-um-framework)图 QL 不是*框架*

这不是另外一个框架，其图形 SQL 本质上是一个规范，它具有[多种语言的实现](https://graphql.org/code/)。

## [](#graphql-n%C3%A3o-%C3%A9-exclusivo-para-httpapis)GraphQL 不是 HTTP/APIs 专用的
...
# [](#o-que-%C3%A9%C2%A0graphql)什么是图形 SQL？
...
## [](#tipos-e%C2%A0schema)Tipos e 模式
...
[![](../Images/97a51a37bc35b64657332742790439c1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--jTqbzo1k--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/5e6qqhkteavvl78ws294.png)
...
[![](../Images/8ee4e29397bc44079f7eda55e55c4b5c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--XwhpPCpN--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/f0xgw1spj8ud3047xarx.png)
 ...
 *[![](../Images/d74cf30a92f723a67e46e9b34639829d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--B6kP7lSq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/7pqx9cswkisbo7drhltz.png)

以*查询*为例，消耗资源***【user】***，传递为引数***【uuid】***。根据 *field* 的签名，如果未返回 **User** 类型，则图 QL 将报告错误。

甚至在此之前的例子中，在*【用户】* 中，参数***【page】***也收到了作为参数的类型，作为回答，我们没有列出

 **[![](../Images/4e2e524c8e59a5c5be3f831999976d3c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--cXScosOB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/bvajzjg8i4mr2aufjqnc.png)
...
[![](../Images/933799bdc15b829f47af320e254f2de0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--f_KpGroC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/uqpn0h8zaw4lxhc2fk2s.png)
...
[![](../Images/159f59445dd5eaf15e025254289fe65f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--loD49bfc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/fjes71jpwqn0wzj950yp.png)
...
[![](../Images/2f9ca835d6e18b97b4fa4a6bea3fdd45.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---KqppMsE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/zevwhlo83toydh7bptco.png)
...
[![](../Images/e95c758bd2f475092b4487f97891fa38.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--nl509rKc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/g9o8bn5361drlt0k72a3.png)
...
[![](../Images/a0be47804a767db7db8a84ac380bac1e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--I6zcdqlH--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ml8jtsl7y9olm8uw2dur.png)
...
# [](#iniciando-com%C2%A0graphql)从 GraphQL 开始

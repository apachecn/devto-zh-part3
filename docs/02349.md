...
> 原文:[https://dev . to/the burning monk/icmi-five-updates-you-ve-missing-about-server-step-functions-3 MMC](https://dev.to/theburningmonk/icmi-five-updates-you-ve-missed-about-serverless-step-functions-3mcm)

在过去的 6 个月里，我们已经使[无服务器步进函数](https://github.com/horike37/serverless-step-functions)插件变得更好更有用。以下是最有影响力的变化，以防你错过！

### [](#support-for-intrinsic-function)支持固有功能
...
### [](#integration-with-nonlambda-services)与非 Lambda 服务集成
...
### [](#lambdaproxy-request-template)LAMBDA_PROXY 请求模板
...
[![](../Images/c27f8830d62b672b40ed6e9054d114ef.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--rLDrmNRj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://feeds.feedburner.com/%257Er/theburningmonk/%257E4/Edcz8ICPhyU)
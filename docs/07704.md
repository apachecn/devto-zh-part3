...
> 原文:[https://dev.to/samwho/api-design-in-the-wild-83p](https://dev.to/samwho/api-design-in-the-wild-83p)

我们已经在以前的帖子中探索了一些指导原则，但是我们还没有使用我们新发现的技能。让我们休息一会儿，看看你能在今天使用的真实世界代码中找到的一些例子，以及我们如何改进它们。

# [](#gos-raw-mathbig-endraw-package)围棋的`math/big`包
...
## [](#-raw-setstring-endraw-returns-a-boolean-not-an-error)`SetString`返回一个布尔值，而不是错误
...
## [](#confusing-use-of-function-receivers)混淆功能接收器的使用
...
# [](#javas-old-raw-fileexists-endraw-method)爪哇的古老`File.exists()`法
...
# [](#apaches-raw-entityutilsconsume-endraw-)阿帕奇`EntityUtils.consume()`
...
# [](#assert-equal-in-most-languages)在大多数语言中断言相等

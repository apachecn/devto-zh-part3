...
> 原文:[https://dev . to/seif _ ghe zala/reason ml-for-production-react-apps-part-2-362 b](https://dev.to/seif_ghezala/reasonml-for-production-react-apps-part-2-362b)

我喜欢时不时地去看理性的路线图，对即将被烹饪的东西感到兴奋。每当我访问该页面时，我都会情不自禁地注意到这两点:

[![ReasonML Roadmap](../Images/69f62591be3c1aaf1ea30d9df0b1beb8.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--EeohSTev--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4w5vix6ye46qjbtv9ku1.png) 
...
[![Final Resul](../Images/9aad52cbd25224eae20c2d5e1426c9d9.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--W2DB8rfW--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/kqhk965ppigtor0dlppk.gif) 
...
# [](#iteration-1-separate-the-words-counter-into-its-own-component)迭代#1:将单词 counter 分离成它自己的组件
...
# [](#iteration-2-add-a-router)迭代 2:添加路由器
...
# [](#iteration-3-build-the-login-page-interface)迭代 3:构建登录页面界面
...
[![Login page](../Images/ebcb4bf8b77990102d455c8154bed2bf.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--EXCbgBHp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ebknfeeju7pwnr2fdxe5.png) 
...
# [](#iteration-4-add-error-handling)迭代 4:添加错误处理
...
# [](#iteration-5-creating-a-wrapper-for-fetch)迭代 5:为获取创建一个包装器
...
## [](#iteration-6-using-the-request-module-in-the-login-page)迭代#6:在登录页面中使用请求模块
...
[![Final Login form](../Images/9aad52cbd25224eae20c2d5e1426c9d9.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--W2DB8rfW--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/kqhk965ppigtor0dlppk.gif) 

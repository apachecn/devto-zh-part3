...
> 原文:[https://dev . to/Google cloud/moving-your-cron-job-to-the-cloud with Google-cloud-functions-1ecp](https://dev.to/googlecloud/moving-your-cron-job-to-the-cloud-with-google-cloud-functions-1ecp)
...
# [](#moving-our-script-to-the-cloud)将我们的脚本移动到云端
...
# [](#scheduling-our-script-in-the-cloud)在云端调度我们的脚本

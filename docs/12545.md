...
> 原文:[https://dev . to/bnevilleoneill/choosing-between-babel-and-typescript-1 lja](https://dev.to/bnevilleoneill/choosing-between-babel-and-typescript-1lja)

[![](../Images/9b89931285e3fcec9e7c48e982daf5cf.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ubIVOjwC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2A_5aQ6zHEfTrrNP_rohrkSQ.png)
...
### [](#the-differences-between-babel-and-typescript)巴别塔和打字稿的区别

使用 TypeScript 和将 TypeScript 与 Babel 一起使用有一些主要区别。

在这篇文章中，我们将看看四个最重要的区别。

#### [](#1-no-type-checking)1。没有类型检查
...
#### [](#3-decorators-amp-metadata)3。装饰者&元数据
...
#### [](#4-custom-transformations)4。自定义转换
...
### [](#other-incompatibilities-amp-inconsistencies)其他不兼容&不一致

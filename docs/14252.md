...
> 原文:[https://dev . to/vzhou 842/building-a-better-profanity-detection-library-with-scikit-learn-3b7f](https://dev.to/vzhou842/building-a-better-profanity-detection-library-with-scikit-learn-3b7f)

几个月前，我需要一种方法来检测用户提交的文本字符串中的亵渎内容:

[![](../Images/3d6d30b961cb6859812d74fe06e1a6b3.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--NqEJ0ql3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2Ai2fk4aGvplR7le_3PPajAA.png) 
...
## [](#profanity-betterprofanity-and-profanityfilter)亵渎，更好的亵渎，亵渎过滤器
...
[![](../Images/756d3b4c4624874b97bba4b95183bac3.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--tMhbBYcF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2000/1%2A0lTbmHR5WE7HZ8wCvLpqtg.png) 
...
[![xkcd 290](../Images/82a89107079ec25619a534b42a7a6d67.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Eapd_ELP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://victorzhou.com/static/b0cc99529a0fad11e9353fc7ff189e2f/b8b3f/xkcd-290.png)

<figcaption>Fucking Blue Shells. source: [xkcd](https://xkcd.com/290/)</figcaption>

已经排除了 3 个库，我把希望放在了第 4 个也是最后一个:`profanity-filter`。

## [](#profanityfilter)脏话-过滤
...
[![](../Images/e14e4f1570ec08e4de479cb9e30b0008.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--IWtaUBbc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AKRJEl4YHfSTk9PmmScIcUA.png)

我需要能够实时执行许多预测，而`profanity-filter`甚至还不够快。但是，嘿，也许这是一个经典的速度与准确性的权衡，对不对？

没有。

[![](../Images/dc786dc595bc24c9af89058ed6f25f17.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--kKiTADjE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2ALYOeGE6vTXTAKhJ_W1fZgQ.png)

我在 PyPI 上找到的库都不能满足我的需求，所以我自己建了一个。

## [](#building-profanitycheck-part-1-data)建筑物亵渎检查，第 1 部分:数据
...
[![](../Images/2ea42f47f56d3f777c9a1b82bf6f38c8.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--CQUVsJ4J--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2ABw_we8cbs-WOpWXOCxzSTg.png) 
...
## [](#building-profanitycheck-part-2-training)建筑亵渎-检查，第二部分:培训
...
### [](#vectorization-bag-of-words)矢量化:文字袋
...
[![](../Images/e6083ebeaafccd0898ef58b31d8fd1cf.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--iQt0gsbq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2Asbnts1u_QFB_V-X5DSC3pg.png) 

<figcaption>【坐在帽子里的猫】——>【2，1，1，1，1】</figcaption>

`???`代表任何未知单词，对于这个句子来说就是`in`。任何句子都可以这样表示为`the`、`cat`、`sat`、`hat`、`???`的计数！

[![](../Images/331acf142cd0b3736a1cf73ebabd6fd6.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--85uri1WU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2A-wONWZDab2gNQP3Rfdpt_A.png) 

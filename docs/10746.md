...
> 原文:[https://dev . to/sel bekk/refactoring-a-small-next-app-to-use-hooks-2 agj](https://dev.to/selbekk/refactoring-a-small-next-app-to-use-hooks-2agj)
...
## ![GitHub logo](../Images/a73f630113876d78cff79f59c2125b24.png) [塞尔贝克](https://github.com/selbekk) / [反应——圣诞节](https://github.com/selbekk/react-christmas)
...
## [](#refactoring-a-backgroundimage-component)重构 BackgroundImage 组件

...
> 原文:[https://dev . to/dabrorius/building-a-memo ization-module-in-ruby-1g8e](https://dev.to/dabrorius/building-a-memoization-module-in-ruby-1g8e)
...
## [](#the-nongeneric-solution)非通用解决方案
...
## [](#generic-memoization-method)类属记忆方法
...
## [](#extracting-memoization-method-to-a-module)提取一个模块的记忆方法

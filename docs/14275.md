...
> 原文:[https://dev . to/rmt work/how-to-full-customize-rails-transactional-emails-device-24ac](https://dev.to/rmtwrk/how-to-fully-customize-rails-transactional-emails-devise-24ac)
...
### [](#method-1-simple-customization-of-devises-default-emails)方法一:简单定制 Devise 的默认邮件
...
### [](#method-2-customizing-the-layout-and-templates-used-by-devise-for-sending-emails)方法二:定制 Devise 发送邮件时使用的“布局”和“模板”
...
### [](#method-3-overriding-how-devise-sends-emails-to-use-an-api-instead-of-smtp)方法 3:覆盖 Devise 发送电子邮件的方式，使用 API 而不是 SMTP

...
> 原文:[https://dev . to/jrtibbetts/decoding-formatted-JSON-dates-in-swift-20db](https://dev.to/jrtibbetts/decoding-formatted-json-dates-in-swift-2odb)
...
[!["Sunrise, Sunset"](../Images/660ea374b8d6e252b4028dff913be99a.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--iE6YC8tv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://content.internetvideoarchive.com/content/photos/7223/30337512_.jpg) 
...
## [](#approach-1-the-na%C3%AFve-approach-aka-how-it-should-work)方法#1:天真的方法，也就是*应该如何*工作
...
## [](#approach-2-storing-the-dates-as-raw-string-endraw-s)方法 2:将日期存储为`String` s
...
## [](#approach-3-keep-the-raw-string-endraw-properties-and-add-corresponding-computed-raw-date-endraw-properties)方法三:保留`String`属性，并添加相应的计算过的`Date`属性
...
## [](#approach-4-using-custom-raw-codingkeys-endraw-)方法四:使用自定义`CodingKeys`
...
## [](#approach-5-raw-datedecodingstrategy-endraw-with-a-custom-raw-dateformatter-endraw-)方法五:`dateDecodingStrategy`用自定义`DateFormatter`
...
## [](#approach-6-using-a-custom-raw-datedecodingstrategy-endraw-block)方法 6:使用定制的`dateDecodingStrategy`块
...
[![Nerdvana, according to Dilbert](../Images/59e01151ae38f0c8a79270d783d2a730.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--PsJ0MyRG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://assets.amuniversal.com/a200ff809c43012f2fe400163e41dd5b) 
...
[![That's Wrigley Field!](../Images/724ee06b8f4bf5985b48520603ac6cf8.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--OCopg3gu--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://pbs.twimg.com/media/CEBcz0DUUAAREzb.jpg)
...
> 原文:[https://dev . to/dev team/dev to-repo-recap-from-the-past-week-22jg](https://dev.to/devteam/devto-repo-recap-from-the-past-week-22jg)
...
*   在[@ link 2 twenty](https://dev.to/link2twenty)[@ Ben](https://dev.to/ben)的一个建议后，推高了崩溃评论的能力。查看更新日志，了解更多详情。
    ...
    *   [链接到 PR](https://github.com/thepracticaldev/dev.to/pull/1484)[![ben](../Images/fe64a787b888dfb20fc13ad1e466da3d.png)](/ben) [## Changelog:折叠评论（通过"详细信息" HTML 标签)
...
[![aspittel](../Images/45a8d86fe0ff981bf7cdb45b471a3c5c.png)](/aspittel) [## 新的一年和新的开始:我将加入开发团队！
...
*   [@vnbrs](https://dev.to/vrnbs) 请求作为标签版主合并相似标签的能力。我们在技术上有这个功能，但是还没有工具。如果你是一个标签版主，看到了一个应该合并的标签，请随时在连接频道告诉我们。谢谢，@vnbrs！
    ...
    # [![GitHub logo](../Images/75095a8afc1e0f207cda715962e75c8d.png) 能够合并相似的标签 #1469](https://github.com/thepracticaldev/dev.to/issues/1469) 

    [![vnbrs avatar](../Images/f04e4c6c2b846107b3b897730697bcc4.png)](https://github.com/vnbrs) **[vnbrs](https://github.com/vnbrs)** posted on [<time datetime="2019-01-06T07:43:13Z">Jan 06, 2019</time>](https://github.com/thepracticaldev/dev.to/issues/1469)
...
*   [@peter](https://dev.to/peter) 提出了用户名中的下划线会阻止@-提及正确链接的问题。这在某种程度上可以用降价技术来解决，但是我们也想实现一个解决方案来处理这个问题。
    ...
    # [![GitHub logo](../Images/75095a8afc1e0f207cda715962e75c8d.png) 用户名中成对下划线防止@提及链接不当 #1491](https://github.com/thepracticaldev/dev.to/issues/1491) 

    [![pkfrank avatar](../Images/a6281578f8aad0af41d10413c0790fd2.png)](https://github.com/pkfrank) **[pkfrank](https://github.com/pkfrank)** posted on [<time datetime="2019-01-08T18:12:24Z">Jan 08, 2019</time>](https://github.com/thepracticaldev/dev.to/issues/1491)
    ...
    **截图** [![example GIF showing the issue in action](../Images/38a3381775956b9abe07a814fb54a2c6.png)](https://camo.githubusercontent.com/9348cec9657b42b697612c395084ff4e7465dc70/68747470733a2f2f636c2e6c792f6462623364373231333136322f53637265656e2532305265636f7264696e67253230323031392d30312d3038253230617425323030312e3037253230504d2e676966)
...
*   我们提出了允许用户配置他们自己的降价呈现的讨论。请随意在这个问题上发表意见。发布者[@杰斯](https://dev.to/jess) :
    ...
    # [![GitHub logo](../Images/75095a8afc1e0f207cda715962e75c8d.png) 允许用户配置降价效果图 #1492](https://github.com/thepracticaldev/dev.to/issues/1492) 

    [![jessleenyc avatar](../Images/22db1a894eb262344cf13b7781b35cdd.png)](https://github.com/jessleenyc) **[jessleenyc](https://github.com/jessleenyc)** posted on [<time datetime="2019-01-08T18:29:46Z">Jan 08, 2019</time>](https://github.com/thepracticaldev/dev.to/issues/1492)
...
*   [@link2twenty](https://dev.to/link2twenty) 讨论了调整移动视图中折叠评论的外观。谢谢安德鲁。
    ...
    # [![GitHub logo](../Images/75095a8afc1e0f207cda715962e75c8d.png)【UI】可折叠移动评论 #1498](https://github.com/thepracticaldev/dev.to/issues/1498) 

    [![Link2Twenty avatar](../Images/1ba74938c13a54803539141f2e9d13e2.png)](https://github.com/Link2Twenty) **[Link2Twenty](https://github.com/Link2Twenty)** posted on [<time datetime="2019-01-08T22:20:05Z">Jan 08, 2019</time>](https://github.com/thepracticaldev/dev.to/issues/1498)

    在移动设备上，可折叠的评论箭头和摘要有点小。

    [![Screenshot](../Images/d28ace11027ac7f52c5b37832557c886.png)T2】](https://user-images.githubusercontent.com/3534427/50861979-47119b80-1392-11e9-8e26-abea89a78e6d.png)

    Reddit 也有可折叠的评论，通过在手机上没有可折叠的评论来解决这个问题，而是只显示基本级别的评论和一个显示回复的按钮。

    [![Reddit](../Images/d1c6a80a117f856664714b1a21634b70.png)T2】](https://user-images.githubusercontent.com/3534427/50862375-63fa9e80-1393-11e9-937d-f9ca1a7221d5.png)
...
*   [@vinistock](https://dev.to/vinistock) 请求了一个功能，让你可以在仪表盘上看到你的每篇帖子的评论的反应总数。谢谢， [@vinistock](https://dev.to/vinistock) ！
    ...
    # [![GitHub logo](../Images/75095a8afc1e0f207cda715962e75c8d.png) 添加评论反应计数到仪表盘 #1505](https://github.com/thepracticaldev/dev.to/issues/1505) 

    [![vinistock avatar](../Images/10d6a84d064363ff1c88df1a83d6d40d.png)](https://github.com/vinistock) **[vinistock](https://github.com/vinistock)** posted on [<time datetime="2019-01-09T18:18:45Z">Jan 09, 2019</time>](https://github.com/thepracticaldev/dev.to/issues/1505)
...
*   @maestromac 提出了拥有更好的液体标签错误处理的问题。
    ...
    # [![GitHub logo](../Images/75095a8afc1e0f207cda715962e75c8d.png) 佳液标签错误处理 #1511](https://github.com/thepracticaldev/dev.to/issues/1511) 

    [![maestromac avatar](../Images/285ef83c821e1c27f7d5dff77822d657.png)](https://github.com/maestromac) **[maestromac](https://github.com/maestromac)** posted on [<time datetime="2019-01-10T17:32:05Z">Jan 10, 2019</time>](https://github.com/thepracticaldev/dev.to/issues/1511)
...
*   [@wuz](https://dev.to/wuz) 请求了一个可以在 dev.to 中创建投票的功能。谢谢，Conlin！
    ...
    # [![GitHub logo](../Images/75095a8afc1e0f207cda715962e75c8d.png) 实施民意调查 #1512](https://github.com/thepracticaldev/dev.to/issues/1512) 

    [![wuz avatar](../Images/a8ed219d69ddc6b3e97a003959da42f8.png)](https://github.com/wuz) **[wuz](https://github.com/wuz)** posted on [<time datetime="2019-01-10T19:11:30Z">Jan 10, 2019</time>](https://github.com/thepracticaldev/dev.to/issues/1512)
...
*   @kurtz1993 提出了一个问题，在 Safari 的阅读器模式下 Twitter 和 Github 的链接太大。谢谢， [@kurtz1993](https://dev.to/kurtz1993) ！
    ...
    # [![GitHub logo](../Images/75095a8afc1e0f207cda715962e75c8d.png)  Twitter 和 Github 在 safari 阅读视图上链接太大 #1517](https://github.com/thepracticaldev/dev.to/issues/1517) 

    [![Kurtz1993 avatar](../Images/098d8973c2da45d817658039a9c81434.png)](https://github.com/Kurtz1993) **[Kurtz1993](https://github.com/Kurtz1993)** posted on [<time datetime="2019-01-11T05:11:37Z">Jan 11, 2019</time>](https://github.com/thepracticaldev/dev.to/issues/1517)
    ...
    **截图** [![f2dc5134-9f10-4e0f-a432-126e85bf7043](../Images/e2bfb1f6477fff69534939c98c226e45.png)](https://user-images.githubusercontent.com/5412470/51014462-63960b00-152d-11e9-943d-b69d3e113335.png)
...
*   [@jess](https://dev.to/jess) 提出了通知中 Tag liquid tag 溢出评论框的问题。
    ...
    # [![GitHub logo](../Images/75095a8afc1e0f207cda715962e75c8d.png) 标签通知中液体标签溢出评论框 #1520](https://github.com/thepracticaldev/dev.to/issues/1520) 

    [![jessleenyc avatar](../Images/22db1a894eb262344cf13b7781b35cdd.png)](https://github.com/jessleenyc) **[jessleenyc](https://github.com/jessleenyc)** posted on [<time datetime="2019-01-11T17:44:50Z">Jan 11, 2019</time>](https://github.com/thepracticaldev/dev.to/issues/1520)

    **描述 bug** 液体标签的样式被剪掉/没有正确最小化。

    **截图** [![](../Images/47bc5e3051996edf23d5e6d763658e2b.png)](https://camo.githubusercontent.com/21a69e05148a7efe8a5165a7b5c7f88e99a550be/68747470733a2f2f636c2e6c792f3066326531363332313137312f646f776e6c6f61642f496d616765253230323031392d30312d3131253230617425323031322e34322e3534253230504d2e706e67)
...
*   [@artemix](https://dev.to/artemix) 讨论了移动展开/折叠指示器进行评论。谢谢@artemix！
    ...
    # [![GitHub logo](../Images/75095a8afc1e0f207cda715962e75c8d.png) 移动展开/折叠勾成评论卡 #1518](https://github.com/thepracticaldev/dev.to/issues/1518) 

    [![Arteneko avatar](../Images/8c1b5ba90ff802268b0d3dee8d35a1e6.png)](https://github.com/Arteneko) **[Arteneko](https://github.com/Arteneko)** posted on [<time datetime="2019-01-11T16:01:37Z">Jan 11, 2019</time>](https://github.com/thepracticaldev/dev.to/issues/1518)
    ...
    **附加上下文**
    ...
    [![](../Images/1ee1e14d60c61675db48c49923c0c802.png)T2】](https://camo.githubusercontent.com/7f85ff9e245d8a7406443e93c421f970118d46f1/68747470733a2f2f7069782e77617463682f34464c45755a2f486441474d372e706e67)

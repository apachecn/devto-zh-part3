...
> 原文:[https://dev.to/joaofbantunes/episode-009-MVC-filters-aspnet-core-from-0-to-over kill-277k](https://dev.to/joaofbantunes/episode-009---mvc-filters---aspnet-core-from-0-to-overkill-277k)
...
[![filter pipeline overview](../Images/cf29229ac0a6988e3607b1df7f88c437.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--oLq_ehqJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/jzi49zdeb50fsjy81ocj.png)
...
[![filter pipeline closeup](../Images/75c564f7c4a4606a5b45ef9fd004b98f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--jJy6n0jC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/fhspjw4wb6n1hcv3qigd.png)

在这篇文章中，我们将只使用动作和异常过滤器，以及如何实现和使用它们的选项。其他过滤器在实现和使用方面应该是相似的，当然有不同的原因。

## [](#application-wide-filter)应用广泛的过滤器
...
## [](#decorating-a-controller-or-action-with-a-filter-attribute)用过滤器属性修饰控制器或动作
...
## [](#filter-attribute-with-dependencies)过滤具有依赖关系的属性
...
### [](#using-servicefilterattribute)使用 ServiceFilterAttribute
...
### [](#using-a-custom-filter-factory)使用定制过滤器工厂

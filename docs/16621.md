...
> 原文:[https://dev . to/app signal/bindings-and-lexical-scope-in-ruby-27o 1](https://dev.to/appsignal/bindings-and-lexical-scope-in-ruby-27o1)
...
## [](#inherited-scopes-and-proc-bindings)继承的作用域和过程绑定

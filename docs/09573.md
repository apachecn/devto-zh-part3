...
> 原文:[https://dev . to/berniwittmann/my-approach-on-vue-router-architecture-and-nested-routes-2k mo](https://dev.to/berniwittmann/my-approach-on-vue-router-architecture-and-nested-routes-2kmo)

使用嵌套路径可能会很麻烦...

[![](../Images/2d2b701dea1f8ee7db0cf758e912a8f4.png)T2】](https://i.giphy.com/media/fnspESRmMpwwUGS9hs/giphy.gif)
...
### [](#step-1-add-an-raw-emptyrouterview-endraw-component)第一步:添加一个`EmptyRouterView`组件
...
### [](#step-3-nesting-routes)第三步:套料路线
...
### [](#step-4-deep-nesting-routes)第四步:深度嵌套路线

我们还可以在嵌套路由中嵌套路由。某种路线观念

[![](../Images/7501e0f381b36c53abe51e986986ac5d.png)T2】](https://i.giphy.com/media/cNWU2Zeh54VJC/giphy.gif)
...
## ![GitHub logo](../Images/292a238c61c5611a7f4d07a21d9e8e0a.png)[【bernwittmann】](https://github.com/BerniWittmann)/[vista 路由器体系结构](https://github.com/BerniWittmann/vue-router-architecture)
...
### [](#short-spoiler-modals)短剧透:Modals

在这个关于 Vue 路由器架构的小系列的下一部分，我想谈谈用 Vue 路由器处理模态。我上面解释的方法还有另一个优点。它使得处理对话框变得非常容易(这些弹出窗口/模态，我从来不知道该怎么称呼它们🙄).在这里找到第 2 部分:

[![berniwittmann](../Images/b45ff2fe33d445969954b573cd077fe0.png)](/berniwittmann) [## 使用 Vue 路由器处理对话
...
[![Peace Out](../Images/3abf9d1ed543bffce842f27d5c20000b.png)T2】](https://i.giphy.com/media/XJc7H1ne2pc9lPyVkL/giphy.gif)
...
> 原文:[https://dev . to/setevoy/AWS-rds-logs-export-to-the-cloud watch-logs-and-cloud formation-template-5f9b](https://dev.to/setevoy/aws-rds-logs-export-to-the-cloudwatch-logs-and-cloudformation-template-5f9b)

[![](../Images/561b8490de4ebd015401f8bc5a20bd1a.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--eCoKOfdn--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://rtfm.co.ua/wp-content/uploads/2014/11/aws-logo-square-02-e1417012834176.png) 我们有一堆与 MariaDB 的 AWS RDS。
...
### [](#db-parameter-groups-enabling-logs)数据库参数组–启用日志
...
[![](../Images/f177dfcaf9b5c518621893bb677c6975.png "AWS: RDS логи, сбор в CloudWatch Logs и CloudFormation")T2】](https://rtfm.co.ua/wp-content/uploads/2019/03/Screenshot_20190307_105835.png)

添加必要的选项:

[![](../Images/b9cd09dc6d69d04d320463b5b2e0c763.png "AWS: RDS логи, сбор в CloudWatch Logs и CloudFormation")T2】](https://rtfm.co.ua/wp-content/uploads/2019/03/Screenshot_20190307_105955.png)
...
[![](../Images/b2ee76ccf6cbcc0cea75b57b92a58b37.png "AWS: RDS логи, сбор в CloudWatch Logs и CloudFormation")T2】](https://rtfm.co.ua/wp-content/uploads/2019/03/Screenshot_20190307_110859.png)

保存更改。

### [](#cloudwatch-logs-export)CloudWatch 日志导出

转到 RDS 实例并点击*修改*:

[![](../Images/0e69c8ad4375aa76d84faaab7b82056f.png "AWS: RDS логи, сбор в CloudWatch Logs и CloudFormation")T2】](https://rtfm.co.ua/wp-content/uploads/2019/03/Screenshot_20190307_105659.png)

列表到底部，并选择要导出到 CloudWatch 的日志:

[![](../Images/a236362516da7e515c82b5e1141b4c70.png "AWS: RDS logs, export to the CloudWatch Logs and CloudFormation template")T2】](https://rtfm.co.ua/wp-content/uploads/2019/03/Screenshot_20190307_111710.png)

按*继续*，查看需要更新的设置列表，点击*修改 DB 实例*:

[![](../Images/807389eae54277761888ecec99a44040.png "AWS: RDS логи, сбор в CloudWatch Logs и CloudFormation")T2】](https://rtfm.co.ua/wp-content/uploads/2019/03/Screenshot_20190307_111753.png)

等待几分钟:

[![](../Images/f32ca7f1958d63b4c5a1b04e219e1091.png "AWS: RDS логи, сбор в CloudWatch Logs и CloudFormation")T2】](https://rtfm.co.ua/wp-content/uploads/2019/03/Screenshot_20190307_111819.png)

查看 CloudWatch 日志——瞧:

[![](../Images/fd6d64837da108435f75a6e8e8fd9d9a.png "AWS: RDS логи, сбор в CloudWatch Logs и CloudFormation")T2】](https://rtfm.co.ua/wp-content/uploads/2019/03/Screenshot_20190307_112043.png)

日志数据:

[![](../Images/32c556d14f89119f8a7896c8f815b299.png "AWS: RDS логи, сбор в CloudWatch Logs и CloudFormation")T2】](https://rtfm.co.ua/wp-content/uploads/2019/03/Screenshot_20190307_112231.png)

### [](#cloudformation-template)云生成模板
...
[![](../Images/a6b96901988b10a5e8535f7291146f25.png "AWS: RDS логи, сбор в CloudWatch Logs и CloudFormation")T2】](https://rtfm.co.ua/wp-content/uploads/2019/03/Screenshot_20190307_115129.png)

检查日志组:

[![](../Images/8ebd01d2c8af6ee9b04e7d6451cca4fd.png "AWS: RDS логи, сбор в CloudWatch Logs и CloudFormation")T2】](https://rtfm.co.ua/wp-content/uploads/2019/03/Screenshot_20190307_120934.png)

...
> 原文:[https://dev . to/aspose cells/format-excel-cell-numbers-to-currency-in-CNET-683](https://dev.to/asposecells/format-excel-cell-numbers-to-currency-in-cnet-683)
...
# [](#format-excel-cell-numbers-to-currency-using-microsoft-excel)使用 Microsoft Excel 将 Excel 单元格数字格式化为货币
...
[![Format Excel Cell Numbers to Currency using Microsoft Excel.](../Images/cb1173296aca15adb0ea7f757e788c58.png "Format Excel Cell Numbers to Currency using Microsoft Excel.")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--A0WaQXit--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/AsposeCells/AsposeCells-Screenshots-and-Sample-Files/master/Format-Excel-Cell-Numbers-to-Currency/Format-Excel-Cell-Numbers-to-Currency-Microsoft-Excel.png)

# [](#currency-custom-number-format-strings-of-cell)货币单元格自定义数字格式字符串
...
# [](#format-excel-cell-numbers-to-currency-using-asposecells)使用 Aspose 将 Excel 单元格数字格式化为货币。细胞
...
[![Currency formats will be applied on Input Excel file Cells using Aspose.Cells API.](../Images/f4bc3247b9f8b8e9fc9658bd448ee885.png "Currency formats will be applied on Input Excel file Cells using Aspose.Cells API.")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9bDnxV4G--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/AsposeCells/AsposeCells-Screenshots-and-Sample-Files/master/Format-Excel-Cell-Numbers-to-Currency/Input-Excel-File-Format-Excel-Cell-Numbers-To-Currency.png)

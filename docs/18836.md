...
> 原文:[https://dev . to/youknowfordevs/getting-control-of-your-dockerignore-files-50m 4](https://dev.to/youknowfordevs/getting-control-of-your-dockerignore-files-50m4)
...
# [](#approach-1-build-from-a-single-directory)方法 1:从单个目录构建
...
## [](#ignoring-with-raw-dockerignore-endraw-)无视与`.dockerignore`
...
## [](#problems-with-approach-1)方法 1 的问题
...
# [](#approach-2-a-richer-raw-dockerignore-endraw-file)途径二:更丰富的`.dockerignore`文件
...
## [](#problems-with-approach-2)方法 2 的问题
...
# [](#approach-3-define-inclusions-not-exclusions)方法#3:定义*包含*，而不是*排除*
...
## [](#only-include-those-files-referenced-in-raw-dockerfile-endraw-)仅包括`Dockerfile`中引用的文件
...
## [](#problems-with-approach-3)方法 3 的问题

...
> 原文:[https://dev . to/jonlunsford/elixir-building-a-small-JSON-endpoint-with-plug-cowboy-and-poison-1826](https://dev.to/jonlunsford/elixir-building-a-small-json-endpoint-with-plug-cowboy-and-poison-1826)
...
#### [](#1-create-a-new-supervised-elixir-app)1。创建一个新的、受监督的 Elixir 应用程序:
...
#### [](#2-add-plug-cowboy-and-poison-as-dependencies)2。将 Plug、Cowboy 和 Poison 添加为依赖项
...
#### [](#4-implement-applicationex)4。实现 application.ex
...
#### [](#5-implement-webhookprocessorendpoint)5。实现 WebhookProcessor。端点
...
#### [](#6-make-the-endpoint-configurable)6。使端点可配置

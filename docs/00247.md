...
> 原文:[https://dev . to/morin oko/adding-recaptcha-v3-to-a-rails-app-without-a-gem-46jj](https://dev.to/morinoko/adding-recaptcha-v3-to-a-rails-app-without-a-gem-46jj)
...
## [](#method-for-verifying-recaptcha-tokens)验证 reCaptcha 令牌的方法
...
## [](#helper-methods-for-the-recaptcha-javascript)用于 reCaptcha JavaScript 的 Helper 方法
...
## [](#adding-recaptcha-to-the-view-files)向视图文件添加 reCaptcha
...
## [](#verifying-the-submitted-recaptcha-token-in-the-controller)在控制器中验证提交的 reCaptcha 令牌
...
[![](../Images/eff3008b3a3e5bbb1e4db7d21fd72cf0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--DvH1wAMO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/hybuwh9zf357f4z4eaei.png)

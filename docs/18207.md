...
> 原文:[https://dev . to/graphic beacon/write-your-first-web-scraper-with dart-3nn 4](https://dev.to/graphicbeacon/write-your-first-web-scraper-with-dart-3nn4)
...
## [](#what-is-a-web-scraper)什么是 Web 刮刀？

网页抓取器指的是执行从网站提取数据的任务的脚本。这通常是通过对网页执行 GET 请求，然后解析 HTML 响应以检索所需内容来实现的。

* * *

## [](#1-generate-a-console-project)1。生成控制台项目
...
[![Generated with Stagehand](../Images/71f3d410efcdb4002e6c8eb0f02acd1d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--j8TuCbe_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/7u1010djxf6mt1syb5ii.png)

## [](#2-implement-the-script)2。实现脚本
...
[![Firefox inspect Hacker News markup](../Images/1bff23757f8cad4b997c4ac5bc733861.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--7fNroTQW--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/qp2s6gl4u051ladda4hw.png)
...
## [](#3-write-the-unit-tests)3。编写单元测试
...
[![All tests pass](../Images/74b97145f79ba08a1d0cd218f16cbe54.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--I4yFi0zR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/vu8lngo0exjncqkip9xv.png)

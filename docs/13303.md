...
> 原文:[https://dev . to/django tricks/how-to-export-data-to-xlsx-files-1dj 0](https://dev.to/djangotricks/how-to-export-data-to-xlsx-files-1dj0)

[![](../Images/fb5bb7e842ea37ef775a61020e525624.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--L2zViE2g--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://1.bp.blogspot.com/-isH4SKIR1No/XGYHR4fL36I/AAAAAAAAB8c/21tlFQt5RJYeNuKWZKReVRyRY0CULZcUwCLcBGAs/s1600/how-to-export-data-to-xlsx-files.png)
...
## [](#installing-openpyxl)安装 openpyxl
...
## [](#creating-more-worksheets)创建更多工作表
...
## [](#freezing-rows-and-columns)冻结行和列
...
## [](#fully-customized-export-view)完全定制的导出视图

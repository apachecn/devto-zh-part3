...
> 原文:[https://dev . to/coffee craft code/finding-inspiration-and-creating-SVG-3m7b](https://dev.to/coffeecraftcode/finding-inspiration-and-creating-svg-3m7b)
...
[![Screenshot and layer overlay in Affinity designer](../Images/7b48d07a97a187767a5c95b3ba68b2bb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--BSYrcatT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/0asb60voxttwryhwty84.png)

这就是钢笔工具成为你最好的朋友的地方。创建一个 SVG 就像用钢笔工具在图像上“描摹”一样简单。
[![Tracing over SVG in Affinity Designer with Pen tool](../Images/1efc275aea36dd00b9888cc0020cc72f.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--BADAGEab--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/tia01veg2k1v0uexo9jb.png) 
...
[![Adding Groups and ID's in Affinity Designer](../Images/a801e3e3df483eb8b1fb3f940a0165b5.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--kPLoTUJB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3-us-west-2.amazonaws.com/s.cdpn.io/780593/Screen%2520Shot%25202019-03-16%2520at%252010.53.05%2520AM.png) 
...
## [](#exporting-and-optimizing)导出并优化

开始制作动画前的最后一步是导出和优化。我导出为 SVG。在 Affinity Designer 中，这非常简单。我选择整个图像，然后去文件，点击导出。我选择导出为带背景的 SVG(这有助于有一个更大的视图框来制作动画。)
[![exporting an SVG in Affinity Designer](../Images/9e247ced9f1efa3f3fdc08ae3e2a5f54.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--H7WtaB2a--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4p4qe9xgsejkgxqlewfk.png)

导出后，我抓取了所有的 SVG 代码，并将其放入[SVGOMG](https://jakearchibald.github.io/svgomg/)
[![optimizing SVG code in SVGOMG](../Images/070920e06d6f6102e6949cd5d4e33f83.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--9LbGuX9T--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/cmrt4k3e8183ih71h6fe.png)

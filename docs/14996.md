...
> 原文:[https://dev . to/swyx/supervised-learning-instance-based-learning-and-k-nearest-neighbors-kge](https://dev.to/swyx/supervised-learning-instance-based-learning-and-k-nearest-neighbors-kge)
...
## [](#what-is-instance-based)什么是“基于实例”？
...
## [](#-raw-k-endraw-nearest-neighbors)`K`最近的邻居

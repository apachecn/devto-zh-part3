...
> 原文:[https://dev . to/sane mat/let-s-build-browser-engine-in-typescript-vol 8-specification-1c4c](https://dev.to/sanemat/let-s-build-browser-engine-in-typescript-vol8-specificity-1c4c)

...
> 原文:[https://dev . to/bnevilleoneill/the-beginner-s-guide-to-mastering-react-props-295g](https://dev.to/bnevilleoneill/the-beginner-s-guide-to-mastering-react-props-295g)

[![](../Images/83816d4fd3c2a236123a4b16738087da.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ezDrxPbo--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2Ab3XCMVTro6APEBYkmUjJIA.png)
...
### [](#props-in-a-function-component)功能组件中的道具
...
### [](#code-reuse-with-props-and-state)代码复用带道具和状态
...
### [](#proptypes-and-defaultprops)属性类型和默认属性
...
### [](#passing-data-from-child-components-to-parent-components)将数据从子组件传递到父组件
...
### [](#prop-drilling-and-how-to-deal-with-it)支柱钻孔及如何处理

...
> 原文:[https://dev . to/oktadev/is-the-oauth-2-0-implicit-flow-dead-4el 8](https://dev.to/oktadev/is-the-oauth-2-0-implicit-flow-dead-4el8)
...
## [](#the-oauth-20-implicit-flow-for-existing-apps)现有应用的 OAuth 2.0 隐式流程
...
## [](#does-the-authorization-code-flow-make-browserbased-apps-totally-secure)授权代码流是否让基于浏览器的应用完全安全？
...
## [](#start-using-the-implicit-flow-with-pkce-in-javascript-today)今天开始在 JavaScript 中使用 PKCE 的隐式流
...
### [](#set-up-the-html-structure)设置 HTML 结构
...
### [](#begin-the-pkce-request)开始 PKCE 的请求
...
### [](#get-an-access-token-using-the-authorization-code)使用授权码获取访问令牌
...
## [](#learn-more-about-oauth-20-the-implicit-flow-and-secure-authentication)了解关于 OAuth 2.0、隐式流程和安全认证的更多信息

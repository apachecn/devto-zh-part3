...
> 原文:[https://dev . to/tee Kay/understanding-the-basics-of-ruby-on-rails-SQL-databases-and-how-they-work-1k 15](https://dev.to/teekay/understanding-the-basics-of-ruby-on-rails-sql-databases-and-how-theywork-1k15)
...
[![](../Images/4635f23a1dde4a69a3a7224d79dbdcf0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--LF11qXRW--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2Ap1Yw2imC4HhUPaEfssliXw.gif)
...
[![](../Images/079fafd672638ad662e87eb94ae01cd2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--DQE_QMRd--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AQzMTJf39jdsi_alIWlGxig.jpeg)
...
### [](#how-about-get-delete-insert-and-update%C2%A0data)获取、删除、插入、更新数据怎么样？
...
### [](#using-conditions-in-our%C2%A0queries)在查询中使用条件
...
#### [](#relationship-between%C2%A0tables)表格间的关系
...
#### [](#using-the-rails%C2%A0console)使用 Rails 控制台
...
### [](#relationships-on%C2%A0rails)铁轨上的关系
...
#### [](#author-hasmany%C2%A0posts)作者有 _ 多篇帖子
...
#### [](#post-belongsto-an%C2%A0author)帖子属于某作者

...
> 原文:[https://dev.to/bnevilleoneill/css-selectors-level-4-15go](https://dev.to/bnevilleoneill/css-selectors-level-4-15go)

[![](../Images/09beb3387c77103fd2a8412f3d915d05.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--mg52qjY_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AeYS388NUetsDByxTD4EEfw.png)
...
### [](#logical-combinations)逻辑组合

这一类别包括通过组合其他选择器来工作的选择器。

#### [](#notselector1-selector2-):非(选择器 1，选择器 2，…)
...
#### [](#isselector1-selector2-):是(选择器 1，选择器 2，…)
...
#### [](#whereselector1-selector2-):其中(选择器 1，选择器 2，…)
...
#### [](#hasrelativeselector1-relativeselector2-):has(相对选择器 1，相对选择器 2，…)
...
[https://codepen.io/eh3rrera/embed/pGjVEg?height=600&default-tab=result&embed-version=2](https://codepen.io/eh3rrera/embed/pGjVEg?height=600&default-tab=result&embed-version=2)T2】
...
[https://codepen.io/eh3rrera/embed/yZYjbJ?height=600&default-tab=result&embed-version=2](https://codepen.io/eh3rrera/embed/yZYjbJ?height=600&default-tab=result&embed-version=2)T2】

### [](#linguistic-pseudoclasses)语言伪类
...
[https://codepen.io/eh3rrera/embed/GzpdwV?height=600&default-tab=result&embed-version=2](https://codepen.io/eh3rrera/embed/GzpdwV?height=600&default-tab=result&embed-version=2)T2】

#### [](#langzh-hant):lang(zh，" *-hant ")
...
[https://codepen.io/eh3rrera/embed/YByjzp?height=600&default-tab=result&embed-version=2](https://codepen.io/eh3rrera/embed/YByjzp?height=600&default-tab=result&embed-version=2)T2】

### [](#location-pseudoclasses)位置伪类
...
[https://codepen.io/eh3rrera/embed/vbNaeJ?height=600&default-tab=result&embed-version=2](https://codepen.io/eh3rrera/embed/vbNaeJ?height=600&default-tab=result&embed-version=2)T2】
...
[https://codepen.io/eh3rrera/embed/GzpBwG?height=600&default-tab=result&embed-version=2](https://codepen.io/eh3rrera/embed/GzpBwG?height=600&default-tab=result&embed-version=2)T2】

### [](#user-action-pseudoclasses)用户动作伪类
...
仅当元素通过键盘跳转获得焦点时才应用。
[https://codepen.io/eh3rrera/embed/KJdbMp?height=600&default-tab=result&embed-version=2](https://codepen.io/eh3rrera/embed/KJdbMp?height=600&default-tab=result&embed-version=2)T2】

### [](#input-pseudoclasses)输入伪类

这个类别包括应用于接受用户输入的元素的选择器。

#### [](#readwrite-and-readonly):读写；只读
...
[https://codepen.io/eh3rrera/embed/JxGXWw?height=600&default-tab=result&embed-version=2](https://codepen.io/eh3rrera/embed/JxGXWw?height=600&default-tab=result&embed-version=2)T2】

#### [](#placeholdershown):占位符-显示
...
[https://codepen.io/eh3rrera/embed/yZeaBL?height=600&default-tab=result&embed-version=2](https://codepen.io/eh3rrera/embed/yZeaBL?height=600&default-tab=result&embed-version=2)T2】

#### [](#valid-and-invalid):有效和:无效
...
[https://codepen.io/eh3rrera/embed/xMZEjp?height=600&default-tab=result&embed-version=2](https://codepen.io/eh3rrera/embed/xMZEjp?height=600&default-tab=result&embed-version=2)T2】

#### [](#inrange-and-outofrange):范围内和范围外
...
[https://codepen.io/eh3rrera/embed/QYyGRQ?height=600&default-tab=result&embed-version=2](https://codepen.io/eh3rrera/embed/QYyGRQ?height=600&default-tab=result&embed-version=2)T2】

### [](#treestructural-pseudoclasses)树形结构伪类

这个类别包括选择器，这些选择器允许基于文档树中的信息进行选择，但这些信息不能由其他选择器表示，例如元素相对于其父元素的位置。

#### [](#nthchildn-of-selector-and-nthlastchildn-of-selector):第 n 个孩子(n[选择器]？)和:n-last-child(n[选择器]？)
...
### [](#gridstructural-selectors)网格-结构选择器
...
#### [](#nthcolanb-and-nthlastcolanb):第 n 列(An+B)和第 n 列(An+B)
...
[https://codepen.io/eh3rrera/embed/RvrLwm?height=600&default-tab=result&embed-version=2](https://codepen.io/eh3rrera/embed/RvrLwm?height=600&default-tab=result&embed-version=2)T2】

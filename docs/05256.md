...
> 原文:[https://dev . to/xuhaibahmad/inter-process-communication-in-Android-learning-1p6n](https://dev.to/xuhaibahmad/inter-process-communication-in-android-lessons-learnings-1p6n)
...
## [](#understanding-the-architecture)了解架构
...
### [](#implementation-of-the-aidl-interface)实现 AIDL 接口
...
[![Oh well!](../Images/61c3bf9e8e9663e4d147e43f0404c222.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--KVbNHmuM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://media.giphy.com/media/26u4cIC1w7AKK9LJ6/giphy.gif%23center)
...
[![My eyes bleed](../Images/75ccb1f4b1b3751e7f21c3c6fc5279cf.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--xADsjeHd--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://media.giphy.com/media/84BjZMVEX3aRG/giphy.gif%23center)
...
### [](#hooking-the-service-to-the-client)将服务挂钩到客户端

最后一步是将服务器应用程序中的`AdditionService`绑定到客户端应用程序，并远程启动它。我有一个非常基本的活动，客户端应用程序的用户界面如下:

[![Client App Screenshot](../Images/aab9fe97cd1fb9a7c36d2571d078e67f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--HUu_lrKZ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://zuhaibahmad.com/assets/images/posts/aidl_demo_ui.png%23center)

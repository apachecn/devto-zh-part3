...
> 原文:[https://dev . to/rohovdmytro/10-things-I-have-learn-open-sourcing-a-react-hook-without-going-crazy-287g](https://dev.to/rohovdmytro/10-things-i-have-learned-open-sourcing-a-react-hook-without-going-crazy-287g)
...
## [](#2-testing-with-reacthookstestinglibrary)#2。用 react-hooks 测试-测试-库
...
## [](#3-fighting-with-raw-npm-link-endraw-)#3。与`npm link`战斗
...
## [](#4-better-raw-npm-publish-endraw-)#4。更好的`npm publish»`

更好的 npm 发布。这个标题在一段时间前一直伴随着我。我从来没有检查过它，但是做一个快速的谷歌搜索发现了一个叫做 np 的[工具来自动化包发布过程。](https://github.com/sindresorhus/np)

[![](../Images/9203d2c90043dd283c25997272bfeb6b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--dpsGhsdE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/oav1ojgwiv3ygkorw336.gif)
...
## [](#5-fighting-myself-annoying-bug)#5。自己与~~战斗~~烦人的臭虫
...
## [](#6-fighting-async-nature-of-a-react-hook)#6。对抗 react 挂钩的异步特性
...
## [](#7-lets-steal-an-api-from-reactapollo)**#7 让我们从 react-apollo 偷一个 API**
...
## [](#8-i-need-a-reset-action)#8。我需要一个 reset()操作
...
## [](#9-zero-config-many-builds)#9。零配置，多版本
...
## [](#10-exposing-your-work-teaches-you)#10。曝光你的作品教会你

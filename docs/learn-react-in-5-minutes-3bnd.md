...
> 原文：<https://dev.to/scrimba/learn-react-in-5-minutes-3bnd>

本教程将通过构建一个非常简单的应用程序让你对 React 有一个基本的了解。我将省去**所有我认为不是核心的东西**。

如果它激发了你的兴趣，并且你想了解更多，你可以在 Scrimba 上查看我们的[免费反应课程](https://scrimba.com/g/glearnreact?utm_source=dev.to&utm_medium=referral&utm_campaign=glearnreact_5_minute_article)。
...
React 中的所有东西都是一个组件，它们通常采用 JavaScript 类的形式。您通过扩展`React-Component`类来创建一个组件。让我们创建一个名为`Hello` :
的组件
...
[![](img/49f04929b0468fb9ea64fe1718c6de9f.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--kpOwSO9s--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AT-bmSzg0KlijyB3dG1M-ow.png)
...
为了实现这种类型的可重用性，我们将添加一些道具。这就是你如何把道具传递给一个组件:
...
这个道具叫做`message`，有“我的朋友”的数值。我们可以通过引用`this.props.message`来访问 Hello 组件中的这个道具，就像这样:
...
[![](img/546ce56d281c1c79e9631d56dfacf211.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--5yUkKCZx--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AM0-2Ct0K3SARZLSwIzgdJw.png)
...
[![](img/5868cb32e64b23980901ab1e668f67a1.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--0aptHt-I--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/v2sblyfk5axax0sv77m9.gif)

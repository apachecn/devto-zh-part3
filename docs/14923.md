...
> 原文:[https://dev . to/Hugo _ _ df/async-JavaScript-history-patterns-and-gotchas-53d 6](https://dev.to/hugo__df/async-javascript-history-patterns-and-gotchas-53d6)
...
### [](#nodestyle-callbacks-problems)节点式回调:问题

#### [](#1-callback-hell)1。回调*地狱*
...
#### [](#3-duplicated-error-handling)3。重复错误处理
...
### [](#promise-gotchas)许诺抓到你

#### [](#nesting-them-is-tempting)筑巢引凤很诱人
...
### [](#onrejected-callback)onRejected 回调
...
### [](#example-loop-through-sequential-calls)示例:循环顺序调用
...
### [](#example-share-data-between-calls)举例:通话间共享数据
...
### [](#example-error-handling)举例:错误处理
...
### [](#promises-evaluate-eagerly)许诺热切地评价✨
...
### [](#running-promises-in-parallel)并行许诺🏃
...
### [](#delay-execution-of-a-promise)延迟履行诺言
...
### [](#separate-synchronous-and-asynchronous-operations)分开同步和异步操作
...
### [](#running-promises-sequentially)按顺序运行承诺
...
### [](#passing-data-in-sequential-async-calls)在顺序异步调用中传递数据
...
### [](#callbackifying-a-promisebased-api)“回调”——使用基于承诺的 API
...
### [](#getting-data-in-parallel-using-callbacks-the-pain)使用回调并行获取数据:痛苦
...
### [](#promisifying-a-callbackbased-api)“承诺”——基于回调的 API
...
### [](#why-we-dont-mix-async-and-sync-operations)为什么我们不混合异步和同步操作

...
> 原文:[https://dev . to/mfahlandt/scaling-proper-a-stateful-app-like-WordPress-with-kubernetes-engine-and-cloud-SQL-in-Google-cloud-27jh](https://dev.to/mfahlandt/scaling-properly-a-stateful-app-like-wordpress-with-kubernetes-engine-and-cloud-sql-in-google-cloud-27jh)
...
## [](#why-is-it-so-hard-to-scale-stateful-apps)为什么扩展有状态应用如此困难？
...
## [](#cloudsql-so-secure-so-much-beauty)CloudSQL 如此安全如此美丽
...
[![Google Cloud Webinterface](../Images/e9b0f389b3f23027e12d4427929e6377.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--RvVqHBCK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/asxhc94ljkr8biweuqrf.png) 

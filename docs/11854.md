...
> 原文:[https://dev . to/rexeze/how-to-build-a-real-time-chat-app-with-nodejs-socket io-and-MongoDB-2k ho](https://dev.to/rexeze/how-to-build-a-real-time-chat-app-with-nodejs-socketio-and-mongodb-2kho)

## [](#how-to-build-a-realtime-chat-app-with-nodejs-socketio-and-mongodb)如何用 NodeJS，Socket 搭建实时聊天 App？IO 和 MongoDB

在本教程中，我们将使用 NodeJS、Express、Socket.io 和 MongoDB 构建一个实时聊天应用程序。

下面是我们将要构建的内容的截图:

[![alt text](../Images/31e2a0a0f2bf0d0550a957a9725b3363.png "Chat Screen Shot")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--F0VZS_EG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/1v827419k0axq56duj9k.gif)
...
### [](#setting-up-our-express-server)设置我们的快递服务器:
...
## [](#setting-up-our-frontend-code)设置本方前端代码
...
### [](#connection-to-the-mongodb-database)连接到 mongodb 数据库
...
### [](#insert-messages-into-the-database)将消息插入数据库
...
### [](#display-messages-on-the-frontend)在前端显示消息

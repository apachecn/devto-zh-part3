...
> 原文:[https://dev . to/Hugo _ _ df/connect-to-MongoDB-on-dokku-with-your-local-command-line-or-robo 3t-47oc](https://dev.to/hugo__df/connect-to-mongodb-on-dokku-with-your-local-command-line-or-robo3t-47oc)

Dokku mongo 插件提供了一个`mongo:connect`命令，该命令打开一个到 Dokku 上 MongoDB 实例的隧道连接。这就是如何使用您选择的工具连接到您的数据库，示例将使用 Robo3T。

## [](#prerequisites)先决条件

### [](#dokkumongo-is-installed)dokku-mongo 已安装
...
### [](#you-have-a-database-to-play-with)你有数据库可以玩
...
## [](#connect-to-your-remote-mongodb-instance-on-dokku)连接到 Dokku 上的远程 MongoDB 实例
...
### [](#dokkus-behaviour-around-access-of-mongodb)Dokku 围绕 MongoDB 访问的行为
...
### [](#exposing-our-mongodb-instance)公开我们的 MongoDB 实例
...
### [](#connecting-with-robo3t)与 Robo3T 连接
...
[![](../Images/85ce8aafaa27113b9d06f6ec2b0899eb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--EDeSbxjA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://d2mxuefqeaa7sj.cloudfront.net/s_5F4BC56CEE8442961498E30A88107FB43112E81DEC4BBA7ABD2A9A1388573B9B_1546270597650_image.png)
...
[![](../Images/4bff24ee11bb160e8180496a623566e9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--b4iZQbPI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://d2mxuefqeaa7sj.cloudfront.net/s_5F4BC56CEE8442961498E30A88107FB43112E81DEC4BBA7ABD2A9A1388573B9B_1546270788604_image.png)

*   你现在可以点击“测试”，它应该会告诉你一切正常
*   您可以“保存”并“连接”到这个新数据库

## [](#testing-out-the-connection)测试出连接

创建一个新集合“最新公共空间”

[![](../Images/679867bf75d84bf5bde33629874cbde5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9r_S5VFG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://d2mxuefqeaa7sj.cloudfront.net/s_5F4BC56CEE8442961498E30A88107FB43112E81DEC4BBA7ABD2A9A1388573B9B_1546271101758_image.png)

[![](../Images/91e84b81de7eb787a2ad56d14f257baf.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--axzHIm_z--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://d2mxuefqeaa7sj.cloudfront.net/s_5F4BC56CEE8442961498E30A88107FB43112E81DEC4BBA7ABD2A9A1388573B9B_1546271148845_image.png)

插入一些数据

[![](../Images/8f503bd07e5ceb6a9e9638acfc26894f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Y5UF6bQM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://d2mxuefqeaa7sj.cloudfront.net/s_5F4BC56CEE8442961498E30A88107FB43112E81DEC4BBA7ABD2A9A1388573B9B_1546271216423_image.png)

[![](../Images/416beae58cfe0dfb3e862dbca7ba75ee.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--PoQYhrzN--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://d2mxuefqeaa7sj.cloudfront.net/s_5F4BC56CEE8442961498E30A88107FB43112E81DEC4BBA7ABD2A9A1388573B9B_1546271218792_image.png)

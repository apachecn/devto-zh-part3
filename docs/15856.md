...
> 原文:[https://dev.to/masonite/masonite-lessons 使用工厂模式 o6p](https://dev.to/masonite/masonite-lessons---using-the-factory-pattern-o6p)
...
# [](#the-problem-real-world-example)问题-现实世界的例子

...
> 原文:[https://dev.to/kritner/microsoft-orleansobservables-ed8](https://dev.to/kritner/microsoft-orleansobservables-ed8)

### [](#microsoft-orleans%E2%80%8A%E2%80%8Aobservers)微软奥尔良—观察家
...
#### [](#new-interface-implementing-igrainobserver)实现 IGrainObserver 的新接口
...
#### [](#new-grain-interface-for-observables)新增可观察颗粒界面
...
#### [](#a-class-to-manage-registered-observers)一个管理注册观察员的类

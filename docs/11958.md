...
> 原文:[https://dev.to/this_mkhy/do-you-know-es6-第一部分-387 米](https://dev.to/this_mkhy/do-you-know-es6---part-1-387m)

* * *

### [](#es6-its-js-es6-is-about-the-next-generation-of-javascript)ES6 其 JS，ES6 是关于下一代 Javascript 的。
...
## [](#modules-exports-amp-imports)模块(出口&进口)
...
## [](#important-notes-on-classes-properties-and-methods)关于类、属性和方法的重要注释

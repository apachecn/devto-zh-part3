...
> 原文:[https://dev . to/nikoheikkila/serving-Gatsby-site-with-docker-multi-stage-build-57ep](https://dev.to/nikoheikkila/serving-gatsby-site-with-docker-multi-stage-build-57ep)
...
## [](#stage-1-building-the-gatsby-site-with-node)第一阶段:用 Node 构建盖茨比站点
...
## [](#stage-2-serving-the-site)第二阶段:服务现场

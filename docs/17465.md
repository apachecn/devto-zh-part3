...
> 原文:[https://dev.to/garfbradaz/episode-2-JSON-API-using-aspnet-core-docker-MongoDB-docker-part-I-docker files-2o8i](https://dev.to/garfbradaz/episode-2---json-api-using-aspnet-core-docker--mongodb-docker-part-i-dockerfiles-2o8i)

## [](#previously-on-dcoding)前情提要

在第 2 集中，我建立了项目目录结构。今天的节目是 **Docker Part 1: DockerFiles** 。

## [](#lets-talk-about-docker)我们来说说 Docker
...
## [](#develop-first-dockerfile)开发第一个 Dockerfile
...
[![docker-net-layers](../Images/85cb685c566654d279f697a11a994e07.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--l-fp-q6G--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://garfbradaz.github.io/assets/img/posts/docker-net-layers.PNG)

如果您再次运行`docker images`，您将会看到您的映像已经构建好了(加上。网络核心图像):

[![dotnet-net-images](../Images/40620e5b685d9c68c253950b8dd6f8e9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Qesfcd7y--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://garfbradaz.github.io/assets/img/posts/dotnet-net-images.PNG)

### [](#run-the-image-as-a-container)将图像作为容器运行

...
> 原文:[https://dev . to/some dood/please-dont-over chain-array-methods-49fa](https://dev.to/somedood/please-dont-overchain-array-methods-49fa)
...
# [](#combine-your-math-operations)结合你的数学运算
...
# [](#use-compound-boolean-expressions)使用复合布尔表达式
...
# [](#take-advantage-of-operand-omission)利用操作数的省略

...
> 原文:[https://dev . to/code mouse 92/dead-simple-python-list-comprehensions-and-generator-expressions-2mb 5](https://dev.to/codemouse92/dead-simple-python-list-comprehensions-and-generator-expressions-2mb5)
...
# [](#list-comprehensions-vs-generator-expressions)列表理解与生成器表达式
...
# [](#structure-of-a-generator-expression)构造一个生成器表达式
...
## [](#nested-list-comprehensions)嵌套列表理解
...
## [](#conditions-in-generator-expressions)生成器表达式中的条件
...
## [](#1-they-get-unreadable-fast)1。它们很快就变得不可读了
...
## [](#2-they-dont-replace-loops)2。它们不能代替循环
...
## [](#3-they-can-be-hard-to-debug)3。它们可能很难调试

...
> 原文:[https://dev . to/teroauralinna/setting-up-web pack-4-for-a-project-5f5e](https://dev.to/teroauralinna/setting-up-webpack-4-for-a-project-5f5e)
...
## [](#following-tasks-are-covered)涵盖以下任务
...
## [](#setup-webpackdevserver-and-npm-build-scripts)设置 webpack-dev-server 和 npm 构建脚本
...
## [](#add-indexhtml-and-generated-javascript-bundle)添加 index.html 并生成 Javascript 包
...
## [](#add-webpack-alias-to-make-it-easier-to-import-files)添加 webpack 别名使导入文件更容易
...
## [](#transform-es6-to-es5-with-babel)用巴别塔将 ES6 转化为 ES5
...
## [](#import-and-inject-css-code)导入和注入 CSS 代码
...
## [](#extracting-all-css-into-a-single-file)将所有 CSS 提取到一个文件中
...
## [](#import-images-by-fileloader)通过文件加载器导入图像
...
## [](#apply-css-vendor-prefixes-by-postcssloader-and-autoprefixer)通过 postcss-loader 和 autoprefixer 应用 CSS 厂商前缀
...
## [](#optimize-css-and-javascript-assets-by-minifying)通过缩小优化 CSS 和 Javascript 资产
...
## [](#use-typescript-with-babelpresettypescript)配合@babel/preset-typescript 使用 TypeScript
...
## [](#separate-dev-and-prod-environments)分离开发和生产环境

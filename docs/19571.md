...
> 原文:[https://dev.to/brob/refactoring-css-into-a-sass-mixin-59m2](https://dev.to/brob/refactoring-css-into-a-sass-mixin-59m2)
...
## [](#step-1-identify-potential-sass-variables)第一步:识别潜在的 Sass 变量
...
## [](#step-2-identify-and-refactor-repeated-code-with-extends)第二步:用@extends 识别并重构重复代码
...
## [](#step-4-move-border-functionality-into-a-mixin)第四步:将边框功能移入 mixin
...
## [](#step-5-declare-the-mixin-in-the-selectors-you-need-it)第五步:在你需要的选择器中声明 mixin
...
## [](#using-this-for-other-examples)用此举其他例子

...
> 原文:[https://dev . to/learn byexample/ruby-regexp-part-6-character-class-24ig](https://dev.to/learnbyexample/ruby-regexp-part-6-character-class-24ig)

# [](#character-class)人物类

本章将讨论如何创建自己的自定义占位符来匹配有限的字符集和字符类中适用的各种元字符。您还将学习各种预定义的字符集。

## [](#custom-character-sets)自定义字符集
...
## [](#matching-metacharacters-literally)逐字匹配元字符
...
## [](#escape-sequence-character-sets)转义序列字符集

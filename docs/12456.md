...
> 原文:[https://dev . to/nilo Miranda/creating-an-API-using-adonisjs-part-1-2mk 0](https://dev.to/nilomiranda/creating-an-api-using-adonisjs-part-1-2mk0)

# [](#bulding-an-api-with-adonisjs)用 AdonisJS 构建 API
...
## [](#the-building-blocks-first)先搭积木

让我们首先确保安装了 Adonis CLI:

### [](#installing-adonisjs)安装 AdonisJS
...
## [](#creating-a-new-application)创建新的应用程序
...
### [](#setting-up-our-database)设置我们的数据库
...
[![sqlpro-database](../Images/e3a2c9e22792fe5377c0e7b841f0c7d8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--qp3WbhCy--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/wxf7chh2js00dv0cpqi8.png)
...
[![insomnia-opened](../Images/aa483fa5ed2b9eb9ea8673f85fed3a91.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vx-bEVDS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/lfl4ytundh1r93yj0cks.png)

让我们从创建一个新的工作区开始，这样我们就可以创建并存储我们配置的请求:

只需点击“失眠”旁边的向下箭头。

[![insomnia-new-workspace](../Images/d3cfb341747d6aa37b0132a489edc3ea.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--nGJi3ITs--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8wqwve6zyke5hc8055x6.png)

现在在下拉菜单中选择“新工作区”

[![new-workspace](../Images/c0c66e77a5e1323cdddbaf9119d848be.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---YeCpNYX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/3rw2rlvhcb1n7pbue8uf.png)

[![workspace-name](../Images/4ce5a063698eafd5903f269a8ef6f548.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--CrGFh8AW--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ok5wxzeqydfia2ue13be.png)

我将把我的工作区称为“schedulerAPI”

现在点击“cookies”正下方的“加号”:

[![new-folder](../Images/882695bcffc68539d5d4e4d8c4fa6fa9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--svYsfOop--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/b84e6hhv23ig4sp8fjxe.png)

我将创建一个名为“User”的文件夹，并创建一个名为“store”的新 post 请求

要更改请求的类型，点击`GET`并在下拉菜单中选择`POST`

[![change-request](../Images/c173fe37a982ed28c7077a8ee67552ea.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Y50J7V6q--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/1xi4ml0a3jjijnddou8p.png)
...
[![request-address](../Images/50c42d28b5843c2b2d6d82e5bd3d1898.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--goZQnJ8j--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8u9iqm7n96qz8y4sa07d.png)

为了使我们的生活更容易，所以我们不需要键入每个新的请求，我们创建完整的地址 [http://127.0.0.1:3333](http://127.0.0.1:3333) ，让我们设置一个可以在失眠症内部使用的环境变量:

[![manage-environment](../Images/073bd32639821836636aceb4642c2e36.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--rkLRctSa--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/tlmmghfyz8dkk61ubzo1.png)
...
[![request-address-done](../Images/6e43308dee92f7f64c2b3781bf29a03e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--5UV5NHmq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/qxmkminph13n5kjooa4u.png)

现在点击`Send`发送我们的请求

您将在失眠症的右侧看到，我们的请求返回了创建的用户，就像我们告诉它的那样:

[![request-succes](../Images/1ba1705fed66075d783a446a7dda1dab.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--jbVXBIKL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/525svq79d0uyus4dcvt5.png)

让我们测试我们已经创建的用户。如果我用同一封邮件再次发送请求，它会返回一个错误:

[![request-error](../Images/d7b1645bb0c831b6f602dbad82083841.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--o1pGmxZ_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/kywzr6iaalyf39ycdq20.png)

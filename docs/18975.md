...
> 原文:[https://dev . to/Mike EUS/vue-spa-with-rails-JSON API-using-graphiti-3k0m](https://dev.to/mikeeus/vue-spa-with-rails-jsonapi-using-graphiti-3k0m)
...
## [](#set-up-rails-api-with-webpacker)用 Webpacker 设置 Rails API
...
## [](#setup-rails-to-serve-static-content)设置 Rails 来提供静态内容
...
## [](#create-models-on-client)在客户端创建模型

...
> 原文:[https://dev . to/jonrimmer/a-react-hook-to-handle-state-with-dependencies-2dl 1](https://dev.to/jonrimmer/a-react-hook-to-handle-state-with-dependencies-2dl1)

...
> 原文:[https://dev . to/wasmer/embedding-web assembly-in-your-rust-application-33n 4](https://dev.to/wasmer/embedding-webassembly-in-your-rust-application-33n4)
...
[![Rust-Wasmer](../Images/448a3a1efa4fc3508e4951fa0133eb6a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--iwed5Ge1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ls54gl9rt8ndpyti0378.png)

本教程讲述了如何制作一个简单的 wasm 应用程序，并使用 wasmer-runtime 运行它！

# [](#creating-a-wasm-application)创建 Wasm 应用程序
...
# [](#embedding-webassembly-using-wasmer)使用 Wasmer 嵌入 WebAssembly！

...
> 原文:[https://dev.to/saadbashar/react-native-animated-inputs-4cfn](https://dev.to/saadbashar/react-native-animated-inputs-4cfn)

这是一个非常直接的探索，关于我如何在我的 react 原生形式中做动画输入。演示如下:

[![](../Images/5e4f8e060efa27c3fd255a42055bc7fc.png "made at imgflip.com")T2】](https://imgflip.com/gif/2rtnqt)

...
> 原文:[https://dev . to/dandyvica/lists-arrays-vectors-linear-containers-in-python-ruby-and-rust-part-3-19jc](https://dev.to/dandyvica/lists-arrays-vectors-linear-containers-in-python-ruby-and-rust-part-3-19jc)
...
## [](#looping-through-a-vector)循环遍历一个矢量
...
## [](#some-useful-functions-on-vectors)向量上的一些有用函数
...
## [](#no-vector-comprehensions)没有矢量理解
...
## [](#using-the-collect-method-on-an-iterable)在可迭代对象上使用 *collect()* 方法

...
> 原文:[https://dev . to/robertcoopercode/using-eslint-and-beauty-in-a-typescript-project-53jb](https://dev.to/robertcoopercode/using-eslint-and-prettier-in-a-typescript-project-53jb)
...
## [](#setting-up-eslint-to-work-with-typescript)设置 ESLint 以使用 TypeScript
...
## [](#adding-prettier-to-the-mix)更漂亮
...
## [](#automatically-fixing-code-vs-code)自动修正代码(VS 代码)

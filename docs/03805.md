...
> 原文:[https://dev . to/julienkervizic/become-a-pro-at-pandas-python-s-data-manipulation-library-2161](https://dev.to/julienkervizic/become-a-pro-at-pandas-python-s-data-manipulation-library-2161)

[![](../Images/ed121a1aa62ebad44a94e856ee34e16b.png)T2】](https://medium.com/analytics-and-data/become-a-pro-at-pandas-pythons-data-manipulation-library-264351b586b1?source=rss----5bbc46989439---4)

pandas 库是 python 中最流行的数据操作库。它提供了一种简单的方法来通过它的…

## [](#understanding-the-pandas-library)了解熊猫图书馆
...
## [](#numpys-panda-efficient-pandas)Numpy 的熊猫——高效熊猫
...
### [](#apply-amp-vectorized-operations)应用&矢量化运算
...
[![](../Images/2b7f06975a12407504c2dcb26202da77.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--3KGdGMNX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/i24rqfxlr848vy0fwsoz.png) 
从上图可以看出，用向量化操作处理(3.53 毫秒)和用 apply 循环做加法(27.8 秒)之间的性能差异是巨大的。通过直接调用 numpy 的数组和 api 可以获得额外的效率，例如:

[![](../Images/be36155ef923122f5056c3d452f05d44.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--oq50r-0F--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/7ovdsppfccnwuq2dbrhk.png)
...
### [](#efficient-data-storing-through-dtypes)通过数据类型高效存储数据
...
[![](../Images/1af9d3ccb08ff1c67fb072e0ea84ad5a.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--23vtni0v--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/5n6yxvep3tq96dv41j03.png)
...
[![](../Images/462e884d783e52911c233733bcd1700a.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--nsARiZls--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/03mr9qqq9zdhyt2n96v4.png) 
在我们的示例中，仅通过更改数据类型，数据帧的整体大小就下降了 3 倍多:
[![](../Images/f72baf2d60988df912379a4f56cc218c.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--StMa61qM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/cdkrb6qh24ob8getaaln.png) 
使用正确的数据类型不仅允许您在内存中处理更大的数据集，而且还使一些计算变得更加高效。在下面的例子中，我们可以看到使用分类类型将 groupby / sum 运算的速度提高了 3 倍。
[![](../Images/4388eec8516ae8a23c21cb1127b0c132.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--56oZpesz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/oozf7jnk2ujas0j8mwl6.png) 
...
### [](#handling-large-datasets-with-chunks)用组块处理大型数据集

Pandas 允许按块加载数据帧中的数据，因此有可能将数据帧作为迭代器处理，并能够处理比可用内存大的数据帧。

[![](../Images/8ec34469f942b7f759a713b93bccd27b.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--4BlapKmh--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ixt4ujgpp0qxcpdbiryu.png) 
...
## [](#sql-alchemys-pandas-database-pandas)SQL Alchemy 的熊猫—数据库熊猫
...
[![](../Images/0f99388348d7bbea84d47b71365762f1.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--dpEa9EeL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4ofsslfxahr40wy0m5ff.png)

#### [](#prettypandas)类型要求

[PrettyPandas](https://github.com/HHammond/PrettyPandas) 是一个库，它提供了一种简单的方法来格式化数据帧并向其中添加表格摘要:
[![](../Images/5befc9e2b20739863402e280ddf797cd.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--xVjja9eG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/73ituvg6fufcgczbpm52.png)

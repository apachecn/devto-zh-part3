...
> 原文:[https://dev . to/eka FYI/tribute-to-Swiss ted-part-ii-scraping-and-parsing-data-with-cheerio-1m2a](https://dev.to/ekafyi/tribute-to-swissted-part-ii-scraping-and-parsing-data-with-cheerio-1m2a)
...
[![Gif of person typing away on a keyboard that emits smoke](../Images/df0110a00750adb56a3e146975fdbac3.png)T2】](https://i.giphy.com/media/l378gxtNQaXcsqY7K/giphy-downsized.gif)
...
## [](#0-install-the-prerequisites)0。安装必备组件
...
## [](#1-design-the-data-model)1。设计数据模型
...
[![data model diagram showing relation between poster and recreation](../Images/e64ea699b382702fc017fa0a9d819590.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--eUsS_Oz4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ppjs9t2oq30ajjfgcie7.png)

一张*海报*包括:

[![Screenshot of a poster page from the Swissted website, marked with poster fields described below](../Images/23bc992935ec591bb1b970e0b36ba20f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--u5kX5HD4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/gumg3x9ymx0ltb7pf02i.png)
...
## [](#2-prepare-and-process-our-data)2。准备和处理我们的数据
...
## [](#3-display-data-in-html-with-nunjucks)3。用 Nunjucks 在 HTML 中显示数据
...
[![Page displaying titles of posters](../Images/aed823c756a5794c26288cc4207fef5a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--IUOWPXPY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/kvxg3rz34eydjc6f3gh1.png)
...
[![](../Images/199c95db6ea2e76dcedb0b0a0cfed014.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--D3yL8S1f--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/z0ujx026efwacd0tr0dd.png)

## [](#4-scrape-and-parse-posters-data-with-cheerio)4。用 Cheerio“抓取”和解析海报数据
...
[![](../Images/8dcf2232a74b4714a43f4618f2caefac.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--LnR01RpB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4xhzd26twtizs0d6vxe4.png)
...
#### [](#4b-parse-and-process-data)4b)解析和处理数据
...
## [](#5-scrape-and-parse-recreations-data-with-cheerio)5。用 Cheerio“抓取”和解析娱乐数据
...
[![](../Images/adfbbaaf446d9ee6856096add35c3735.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--IpyfCCHM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/kd5g36ncpfoy1hoy52xz.png)
...
#### [](#5b-parse-and-process-data)5b)解析和处理数据
...
## [](#6-modify-recreations-data)6。修改娱乐数据
...
#### [](#6a-create-a-route-that-returns-recreations-data)6a)创建一个返回娱乐数据的路由
...
[![](../Images/c4b1b5d40d9e77c59020d8c8aeca03db.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--IZq48MIr--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/pl89ceqzg0fz0l0xvje7.png)

#### [](#6b-create-duplicate-recreations-data-and-add-raw-posterid-endraw-)6b)创建重复的娱乐数据并添加`posterId`
...
#### [](#6c-add-recreations-to-posters-data)6c)给海报数据添加娱乐活动
...
## [](#7-render-data-from-the-view-template)7。从视图样板渲染数据
...
[![](../Images/b825429aa2bf31253ab271e57900df34.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--XhZbuG1L--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/nv4y0ggydi1xx4rc0ni0.png)

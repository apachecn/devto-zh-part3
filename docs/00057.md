...
> 原文:[https://dev . to/charlesstover/manage-global-state-with-react-hooks-2692](https://dev.to/charlesstover/manage-global-state-with-react-hooks-2692)
...
# [](#global-state-differences)全局状态差异🆚
...
# [](#instantiating-the-global-state)实例化全局状态🌞
...
# [](#can-i-access-the-entire-global-state)我可以访问整个全局状态吗？👪

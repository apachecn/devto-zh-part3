...
> 原文:[https://dev . to/michi/demystemizing-dependency-injection-inversion-of-control-service-containers-and-service-providers-5e 72](https://dev.to/michi/demystifying-dependency-injection-inversion-of-control-service-containers-and-service-providers-5e72)
...
### [](#avoids-useless-abstractions)避免无用的抽象
...
### [](#avoids-relative-require)避免相对要求
...
## ![GitHub logo](../Images/75095a8afc1e0f207cda715962e75c8d.png)/[IOC-node](https://github.com/MZanggl/ioc-node)

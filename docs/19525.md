...
> 原文:[https://dev . to/scotthannen/how-I-learn-to-stop-worry-and-love-the-service-locator-4a 32](https://dev.to/scotthannen/how-i-learned-to-stop-worrying-and-love-the-service-locator---4a32)

服务定位器是一种反模式。它们是我们在学习依赖注入之前使用的。如果你已经知道什么是服务定位器，为什么它是有害的(解释一个而不解释另一个是不道德的)，那么跳过第一个标题。

### [](#why-service-locators-are-evil)为什么服务定位器是邪恶的
...
### [](#when-we-need-a-service-locator)当我们需要服务定位器时
...
### [](#dependency-injection-with-defaults)依赖注入与默认值
...
### [](#inserting-our-service-locator)插入我方服务定位器

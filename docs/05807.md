...
> 原文:[https://dev . to/johndemian/dash bird-is-a-great-cloud watch-alternative-3a 65](https://dev.to/johndemian/dashbird-is-a-great-cloudwatch-alternative-3a65)

我在这篇文章中会有偏见，但这没关系，因为我相信你将在这篇文章中读到的所有信息都是 100%正确的，对双方都是公平的。

### [](#lets-look-at-cloudwatch-first)我们先来看 Cloudwatch。

不要误会我的意思，Cloudwatch 无论如何都不是一个坏工具。事实上，如果你花时间去理解它的复杂性，它对于跟踪你的 AWS 栈中正在发生的事情是相当不错的。这是一个 goto 工具，用于监视 AWS 中的云资源，并允许您一起跟踪所有资源。

[![](../Images/052f5ac31c1872ac78e798f1e443354a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--xR9EZrJt--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/cxd9oddsphtqcxw7vi1g.PNG)
...
### [](#what-dashbird-does-right)大鸟做的对！

另一方面，Dashbird 并没有重新发明轮子。它只是让开发人员更容易调试他们基于 Lambda 的应用程序，而没有过于复杂的 UI 和拥挤的屏幕信息。

[![](../Images/c1d33ed0125508f712b74a1a7e98512f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Ab-sJ0Ha--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/j7to0v5b2pog1gk3as8y.png)

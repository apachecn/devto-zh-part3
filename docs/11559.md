...
> 原文:[https://dev . to/bnevilleoneill/the-best-static-websites-generators-comparated-5e8g](https://dev.to/bnevilleoneill/the-best-static-websites-generators-compared-5e8g)

[![](../Images/a4a88c2677e0691ef64d8f9ab363bf9d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--g5lAMPV0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/900/1%2AGU0H_237pNqwG2XrLYYPvw.png)

如果你没有跟上静态网站炒作的脚步，我会说你正在正确的时间阅读这篇文章。静态网站或所谓的 **JAMstack** 最近变得相当流行。为什么？为什么老派的 HTML + CSS + JS 以其重新设计和重命名的形式获得如此多的关注？在这篇文章中，我们将探究 JAMstack 到底是什么以及它有什么好大惊小怪的，然后我们将看看一些最好的静态网站生成器！

[![](../Images/2063f22e152ef36aa267c13ae9842601.png)T2】](https://logrocket.com/signup/)

### [](#jamstack)[JAMstack](https://jamstack.org/)

[![](../Images/e24c71ada4f4a3c3f452c4b1d7a77d30.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--qB6nHhJA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/0%2ALK-KrB7sRYcDtCLX.png) 

<figcaption>贾姆斯塔克</figcaption>
...
### [](#gatsbyjs)[盖茨比](https://www.gatsbyjs.org)

[![](../Images/37b8fe53c2e3a56c608d1c3a03adfd4d.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--o2gxhiCP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/0%2AJMxnGYe7AoIg9oUh.png) 

<figcaption>盖茨比登陆页面</figcaption>
...
[![](../Images/dfe12c6c30cf6e3486c45965ba5bf350.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--Pxxog0Hp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/0%2Ak6DhQGiRU7xC-K_p.png)T3】next . js 登陆页面
...
谈到[社区](https://github.com/zeit/next.js/stargazers)，Next 显然是赢家。大概就是**[**最流行的**](https://www.npmjs.com/package/next) **React 框架**。正因为如此，无论何时你需要帮助，你都可以很容易地找到。Next 也是由 [**Zeit**](http://zeit.co) 制造，这家公司也创造了 [**现在**](https://zeit.co/now) (无服务器部署平台)。这就是(以及上面提到的各种原因)为什么我认为 Next 总体上有很大的支持和后盾。**

 **### [](#vuebased)基于 Vue

### [](#gridsome)[网格](https://gridsome.org)

[![](../Images/e31811a4a6f09eeb991a92fda3806c8c.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--lBpwLHqV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/0%2ANBN2HQriIa0yd9uh.png) 

<figcaption>Gridsome 登陆页面</figcaption>
...
### [](#nuxtjs)[Nuxt.js](https://nuxtjs.org)

[![](../Images/5c0334d02c98ba57c26cff613a35263c.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--SY6pZPFL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/0%2Agwcf7SbE1un7uVSO.png) 

<figcaption>Nuxt.js 登陆页面</figcaption>
...
当然，如果你喜欢这篇文章，可以考虑分享一下，看看我的 [**个人博客**](https://areknawo.com) ，关注我的 [**推特**](https://twitter.com/areknawo) 和我的 [**脸书页面**](https://www.facebook.com/Areknawos-Blog-770620059945105) 了解更多有趣的内容。

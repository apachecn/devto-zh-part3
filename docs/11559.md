...
> 原文：<https://dev.to/bnevilleoneill/the-best-static-websites-generators-compared-5e8g>

[![](img/a4a88c2677e0691ef64d8f9ab363bf9d.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--g5lAMPV0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/900/1%2AGU0H_237pNqwG2XrLYYPvw.png)
...
[![](img/e24c71ada4f4a3c3f452c4b1d7a77d30.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--qB6nHhJA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/0%2ALK-KrB7sRYcDtCLX.png) 
...
[![](img/37b8fe53c2e3a56c608d1c3a03adfd4d.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--o2gxhiCP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/0%2AJMxnGYe7AoIg9oUh.png) 
...
您将在 Gatsby 项目中使用的所有数据都来自于**来源。如果你不知道的话，GraphQL 是一种由脸书开发的用于查询数据的查询语言。它与 React 集成在一起，总体来说非常健壮和出色。但是，如果你真的不喜欢 GraphQL，那么还有一个绕过 **it** 的 [**方法。当然，这需要省略盖茨比的数据层，从而使一些东西感觉不那么…精致。但是，无论如何，有一个选择是好的。**](https://www.gatsbyjs.org/docs/using-gatsby-without-graphql/)**

 **最后，《盖茨比》最重要的一个方面是它的生态系统。更具体地说，我说的是大约 700 个插件**，它们都在那里，列在官网上，随时可以使用。而且，虽然主动维护的数量可能会少一些，但这使得 Gatsby 的开发容易得多。这些插件可以处理各种事情，如数据源(如 headless CMS 等)、自定义功能(如 PWA 功能、自定义网站搜索)和构建优化(如调整图像大小)。安装一个插件，然后继续你的工作，这种便利真是太棒了。**
...
[![](img/dfe12c6c30cf6e3486c45965ba5bf350.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--Pxxog0Hp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/0%2Ak6DhQGiRU7xC-K_p.png)T3】next . js 登陆页面
...
[![](img/e31811a4a6f09eeb991a92fda3806c8c.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--lBpwLHqV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/0%2ANBN2HQriIa0yd9uh.png) 
...
[![](img/5c0334d02c98ba57c26cff613a35263c.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--SY6pZPFL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/0%2Agwcf7SbE1un7uVSO.png) 

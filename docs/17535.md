...
> 原文:[https://dev . to/bong 0/limiting-docker-containers-log-size-in-coreos-running-但不限于-xenserver-7-3gjo](https://dev.to/bong0/limiting-docker-containers-log-size-in-coreos-running-but-not-limited-to-xenserver-7-3gjo)

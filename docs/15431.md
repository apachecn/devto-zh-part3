...
> 原文:[https://dev . to/codingcatdev/angular-material-dynamic-navigation-using-firestore-4ea 4](https://dev.to/codingcatdev/angular-material-dynamic-navigation-using-firestore-4ea4)
...
# [](#angular-material-dynamic-navigation-using-firestore)使用 Firestore 进行角度素材动态导航
...
## [](#add-angular-firebase-service)添加角火基服务
...
## [](#update-firstore-service)更新 Firstore 服务
...
### [](#expansion-panel-for-booklist)书单展开面板
...
### [](#populating-the-expansion-panel)填充扩展面板
...
### [](#reference-booktree-inside-bookdrawer)书柜内的参考书树
...
## [](#breaking-down-the-dynamic-tree)分解动态树

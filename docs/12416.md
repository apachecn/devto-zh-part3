...
> 原文:[https://dev . to/the jaredwilcurt/angular-CLI-and-nwjs-for-development-49gl](https://dev.to/thejaredwilcurt/angular-cli-and-nwjs-for-development-49gl)

[![Angular, NW.js, and Angular-CLI Logos](../Images/f362a9b4729b3b73865831342e8c1644.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--RYLpNEo7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/qim6c92bwih0ws7imjgw.jpg)
...
## [](#step-2-verify-angular-cli-worked)步骤 2:验证角度 CLI 是否正常工作
...
## [](#step-3-adding-in-nwjs)第三步:在 NW.js 中添加
...
## [](#step-4-verifying-nwjs-loads)第四步:验证 NW.js 载荷

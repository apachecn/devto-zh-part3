...
> 原文:[https://dev . to/duranenmanuel/another-approach-to-media-queries-with-the-power of-sass-3g HF](https://dev.to/duranenmanuel/another-approach-to-media-queries-with-the-power-of-sass-3ghf)
...
## [](#a-step-in-the-good-direction)向好的方向迈出的一步

...
> 原文:[https://dev.to/stuartblang/miscellaneous-c-async-tips-3o47](https://dev.to/stuartblang/miscellaneous-c-async-tips-3o47)

有很多很棒的异步技巧，这里是我在过去几年里收集的一些，我没有看到太多关于它们的文章。

### [](#use-discards-with-raw-taskrun-endraw-for-fire-and-forget)用弃用`Task.Run`为火而忘
...
## [](#replace-raw-taskfactorystartnew-endraw-)替换`Task.Factory.StartNew`

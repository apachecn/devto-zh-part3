...
> 原文:[https://dev . to/oieduardorabelo/svelte-3-come cando-com-svelte-3-2em 3](https://dev.to/oieduardorabelo/svelte-3-comecando-com-svelte-3-2em3)
...
# [](#iniciando-um-projeto-svelte-3)启动快速项目 3
...
# [](#partes-de-um-aplicativo-svelte)部分快速应用程序

我喜欢知道所有的文件是如何适应一个项目的，很快就没有什么不同了，为了了解整体的情况，让我们打破东西:

# [](#nosso-packagejson)Nosso package.json
...
# [](#construindo-um-componente)构造构件
...
# [](#vinculando-valores-bidirecionais)链接双向值
...
# [](#compilando-para-produ%C3%A7%C3%A3o)编译生产用

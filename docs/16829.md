...
> 原文:[https://dev . to/green stage/using-react-central-state-to-simplify-your-app-5f 44](https://dev.to/greenstage/using-react-central-state-to-simplify-your-app--5f44)
...
### [](#updating-and-reading-from-the-central-state)从中央状态更新和读取:

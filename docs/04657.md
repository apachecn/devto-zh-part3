...
> 原文:[https://dev . to/steadbytes/AOC-2018-day-5-alchemical-reduction-1 beg](https://dev.to/steadbytes/aoc-2018-day-5-alchemical-reduction-1beg)
...
## [](#-using-python-lists-as-stacks)- [使用 Python 列表作为堆栈](https://docs.python.org/3.1/tutorial/datastructures.html#using-lists-as-stacks)
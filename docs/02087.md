...
> 原文:[https://dev . to/mandrew cito/lazy-pub-sub-python-implementation-3fi 8](https://dev.to/mandrewcito/lazy-pub-sub-python-implementation-3fi8)

## [](#a-brief-explanation)简要说明

首先，在开始编码之前。你必须阅读这篇文章，这是一篇很好的文章，解释了发布订阅和观察者之间的区别。如果你不想看这篇文章，我认为这张图片足够了
[![pub sub vs. observer](../Images/3c8ecd24cfe962d8483b9b75d403cc65.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--vZ1GvZYI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2ANcicKEqwUaI8VEc-Ejk6Dg.jpeg)

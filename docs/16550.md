...
> 原文:[https://dev . to/obniz _ io/tensorflowjs-and-puppet-with-pose net-50ng](https://dev.to/obniz_io/tensorflowjs-and-puppet-with-posenet-50ng)

[![](../Images/5e4212c24679da53c849dc377238781d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ECqQEOQE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://storage.obniz.io/images/ac5407ab305a9cb81533282666979)
...
## [](#operation-confirmation-of-the-inertial-sensor)惯性传感器的操作确认
...
[![](../Images/3185572e3830d07bd180af8044024bb7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--dTNNn4xq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://storage.obniz.io/images/8457e055b8556aa31533282734579)

## [](#how-to-make-software)如何制作(软件)

## [](#mode-selection)模式选择

其类别被指定为“视图-内容-1，2，3”的元素仅在每种模式下显示。您可以使用选择元件从 1 到 3 选择模式。当使用 PoseNet 和开始姿势估计时，按下 SET 按钮根据当时选择的模式值切换显示，并执行 bindPage()。

## [](#getting-inertial-sensor-values)获取惯性传感器值
...
## [](#pose-estimation-with-posenet)用 PoseNet 进行姿态估计
...
## [](#driving-of-the-servo-motors)伺服电机的驱动

...
> 原文:[https://dev.to/mmenestret/anatomy-of-a-type-class-440j](https://dev.to/mmenestret/anatomy-of-a-type-class-440j)
...
# [](#how-can-it-be-done-in-scala-)如何在 Scala 中实现？
...
# [](#type-classes-bonus)类型班级奖金

## [](#a-posteriori-subtyping)后验子型

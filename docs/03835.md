...
> 原文:[https://dev.to/bnevilleoneill/what-s-new-in-chrome-74-4g6f](https://dev.to/bnevilleoneill/what-s-new-in-chrome-74-4g6f)
...
### [](#public-class-fields-meet-private-class-fields)**公类领域，遇私类领域**
...
### [](#listen-for-css-transition-events)**监听 CSS 转换事件**
...
### [](#take-control-with-feature-policy-apis)**通过功能策略 API 进行控制**

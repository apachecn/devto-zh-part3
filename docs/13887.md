...
> 原文:[https://dev . to/codingcatdev/angular-material-reactive-forms-update-firestore-5a 72](https://dev.to/codingcatdev/angular-material-reactive-forms-update-firestore-5a72)
...
# [](#angular-material-reactive-forms-update-firestore)角状物质反应形态更新 Firestore
...
# [](#firestore-current-book-value-to-form)凡士多当前账面价值形成

## [](#subscribing-to-book-from-id)从 Id 订阅图书
...
## [](#building-or-rebuilding-angular-form)建造(或重建)有棱角的形体
...
### [](#form-control-using-form-builder)使用表单生成器的表单控件
...
### [](#form-field-errors)表格字段错误

像魔术一样(好的编程)，如果一个字段验证不正确，你会看到一个错误出现。
[![Form Field](../Images/9dc1f5870cc1e621335cd24439161a3f.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--7dir-aJb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://res.cloudinary.com/ajonp/image/upload/v1553629225/ajonp-ajonp-com/12-angular-material-from-firestore/sr7u3gojyeztganortmm.png)
...
### [](#form-submit-only-pristine)表单只提交原始的
...
在数据输入之前，我们只有取消的选择。
[![No Data](../Images/62510788a30c3c71f1b344e1ff5dd1d0.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--D1DzUtb0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://res.cloudinary.com/ajonp/image/upload/v1553629673/ajonp-ajonp-com/12-angular-material-from-firestore/u2cngx79xvpu9h1hfybp.png)

输入数据后，如果无效，我们只能恢复。
[![Bad Data](../Images/a4ccae08c8d4ec7ab7400544cbd83edf.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--h8mQ-wDj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://res.cloudinary.com/ajonp/image/upload/v1553629709/ajonp-ajonp-com/12-angular-material-from-firestore/jafwiibebcbqn7digvhe.png)

我们终于可以保存好数据了。
[![Good Data](../Images/e31ba6b451491c9dc6c1f0eca49994c5.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--NQceCSjj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://res.cloudinary.com/ajonp/image/upload/v1553629744/ajonp-ajonp-com/12-angular-material-from-firestore/fqqrn4hsnytvcadwag51.png)

## [](#submit-and-save-data)提交并保存数据

# 在 Kotlin 中使用“assertFailsWith”测试异常

> 原文：<https://dev.to/lankydandev/testing-exceptions-in-kotlin-with-assertfailswith-5cl0>
...
如果你对[Kotlin Docs-assertfails with](https://kotlinlang.org/api/latest/kotlin.test/kotlin.test/assert-fails-with.html)感兴趣，可以在这里找到`assertFailsWith`的官方文档。

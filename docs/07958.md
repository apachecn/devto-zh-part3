...
> 原文:[https://dev . to/vorillaz/tab sub-creating-a-simple-messaging-library-3d 14](https://dev.to/vorillaz/tabsub-creating-a-simple-messaging-library-3d14)

在很多情况下，开发人员希望在应用程序中发布或收听消息。跨不同的浏览器上下文发布消息可以极大地提高性能和用户体验。显示带有消息和 pop 通知的队列、同步陈旧的 web 视图或者甚至同时从所有活动窗口注销用户是这种方法的不同用例。

## [](#demo)演示

> ![unknown tweet media content](../Images/3abd5c549a821e09c9eda58d644945c6.png)![Play butt](../Images/980e9fb12d58fa9423fc94c33003fc4f.png)<video loop="" controls=""><source src="https://video.twimg.com/ext_tw_video/1113758463463706625/pu/pl/WiHGUgjEFq3CDWK-.m3u8?tag=8" type="application/x-mpegURL"></video>![vorillaz profile image](../Images/78582d66e21374bd2084a5e870ccd488.png)vorillaz[@ vorillaz](https://dev.to/vorillaz)![twitter logo](../Images/65e26e35707d96169ec8af6b3cbf2003.png)【hello world】来自 BroadcastChannel API。2019 年 04 月 04 日上午 11:01[![Twitter reply action](../Images/269095962147c28351274afdd5486a48.png)](https://twitter.com/intent/tweet?in_reply_to=1113758606976061440)[![Twitter retweet action](../Images/771160ecf06ae3d4d7a7815c29c819c2.png)](https://twitter.com/intent/retweet?tweet_id=1113758606976061440)0[![Twitter like action](../Images/c077611ab2a5e0b4cd0c826ee7ae1e48.png)](https://twitter.com/intent/like?tweet_id=1113758606976061440)0

## [](#the-broadcast-channel-api)广播频道 API
...
## [](#using-localstorage-as-an-elegant-fallback)使用 localStorage 作为优雅的后备方案
...
## [](#bringing-everything-together)汇集一切

...
> 原文:[https://dev . to/hweecat/accelerating-batch-processing-of-images-in-python-with-gsutil-numba-and-concurrent-futures-59ah](https://dev.to/hweecat/accelerating-batch-processing-of-images-in-python-with-gsutil-numba-and-concurrent-futures-59ah)

#### [](#how-to-accelerate-batch-processing-of-almost-a-million-images-from-several-months-to-just-around-a-few-days)如何从**几个月**到**几天**的时间内加速批量处理近百万张图像
...
#### [](#step-1-using-wget-command-to-download-large-image-datasets)步骤 1:使用 wget 命令下载大型图像数据集
...
#### [](#step-2-upload-image-files-to-google-cloud-storage-using-gsutil-cp)第二步:使用 gsutil cp 上传图片文件到 Google 云存储
...
<figure>[![](../Images/362f03377f5258c949167a470d39a5dd.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--A0odNfFP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2A2vmUe8ClFeJL7dbt6XUU6Q.jpeg) 

<figcaption>我们存储桶中的所有 4 个文件夹—成功！</figcaption>

</figure>

#### [](#step-3-import-each-image-file-from-cloud-storage-to-colab)第三步:将每个图像文件从云存储导入到 Colab
...
#### [](#step-4-convert-each-image-to-standardized-numpy-array)第四步:将每幅图像转换成标准化的 *numpy 数组*
...
### [](#speed-up-with-numba-and-concurrentfutures)加速用 *numba 和 concurrent.futures*

在本节中，我将介绍两个 Python 模块，它们有助于加速计算密集型函数，如循环——*numba*和 *concurrent.futures* 。我还将记录我的代码实现背后的思考过程。

#### [](#jit-compilation-with-numba)用 numba 进行 JIT 编译
...
#### [](#parallel-processing-and-concurrentfutures)并行处理
...
<figure>[![](../Images/10f4f604c9492de1ee8808e93a9fd1f6.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--l7H3Yevj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AxdfCfJgR8ttCyXMnnFXhjQ.png) 
...
### [](#some-reflections-and-takeaways)一些反思和外卖

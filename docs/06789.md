...
> 原文:[https://dev . to/ampli fr/dockerize-the-multi-services-application-for-local-development-2 oig](https://dev.to/amplifr/dockerize-the-multi-services-application-for-local-development-2oig)
...
## [](#benefits-of-the-local-containerization)当地集装箱化的好处
...
[![Overall Amplifr's services map](../Images/2ae5f8b276cfb964084cadbad69de90f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--_G7FOi9_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/zaqzt4xuskx9u1nam6ka.png)
...
[![Frontend-backend integration](../Images/b3e8cbb99420ce2164a101aadedec4f1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--B68SHOYL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/wjjtclqlnm2kzb0tgjvw.png)

### [](#logux-server)Logux 服务器
...
[![Logux-backend integration](../Images/221e16a31f2e4133edc5fb7eff759fdb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--g3vz7uwI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/6alt0cl5v8imhd7potfs.png)

### [](#link-shortener)【链接缩短器】

link shortener 是一个特定的 web 服务，用 Golang 编写。它的目标是缩短链接，扩展链接，并管理链接扩展的总体统计数据。
[![Link shortener server integration with backend](../Images/50ceec156c37f98c540ae6ab3df33983.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--9Uua15Fc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/7zrnonica8z9dpu6fo2y.png)

### [](#preview-service)【预览】服务
...
## [](#components-dependents)组件依赖关系

大多数组件本身是复杂的 web 服务，依赖于底层组件，如 Postgres、Redis 和其他服务低级系统服务。
[![Internals of the backend component and how we are going to dockerize it](../Images/17ce83d180f3f2e21d40bc68275fe6c4.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--AIQEeykP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/jsiwcvh1dls5wjh6tx06.png)

### [](#containarization)容器化
...
[![](../Images/b33099492365442ccbbccef3c77b0739.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--SZh8WON6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/k9cq82dh8p3vcf5yo4il.png)

### [](#dockerize-ruby-backend)Dockerize Ruby 后端
...
### [](#describe-the-baseservice-to-inherit-from-it)形容基-务从中继承
...
[![Service inheritance](../Images/2c7e3f5ae0a72d3116c7a932491a4394.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--sPsHqHzL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ww54ehqf8cwua1fnasre.png)
...
### [](#compose-the-sidekiq)撰写 Sidekiq
...
### [](#compose-redis-and-postgres)作文《论文集》
...
[![Service startup sequence in case of depencencies](../Images/9434667a36b11ad28a96d60a619e2ddb.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--f0RU0nwh--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/0rx3p8a5v84e6yl4eztj.png)
...
## [](#dockerize-nodejs-frontend-server)Dockerize Node.js(前端服务器)
...
### [](#dockerize-the-logux-server)对接 Logux 服务器
...
## [](#dockerizing-golang-link-shortener-web-service)Dockerizing Golang(链接缩短 web 服务)

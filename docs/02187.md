...
> 原文:[https://dev . to/oktadev/Java-micro services-with-spring-cloud-config-and-jhipster-14ji](https://dev.to/oktadev/java-microservices-with-spring-cloud-config-and-jhipster-14ji)
...
## [](#java-microservices-with-spring-cloud-config)采用 Spring Cloud 配置的 Java 微服务
...
## [](#use-jhipster-to-generate-a-java-microservices-architecture)使用 JHipster 生成一个 Java 微服务架构
...
### [](#create-docker-images-for-microservice-apps)为微服务应用创建 Docker 映像
...
### [](#run-your-java-microservices-stack-with-docker-compose)使用 Docker Compose 运行您的 Java 微服务堆栈
...
### [](#jhipster-registry-for-service-discovery-with-java-microservices)JHipster Registry 通过 Java 微服务进行服务发现
...
### [](#create-a-web-application-in-okta)在 Okta 中创建一个 Web 应用
...
## [](#configure-your-openid-connect-settings-with-spring-cloud-config)使用 Spring Cloud Config 配置您的 OpenID Connect 设置
...
### [](#create-groups-and-add-them-as-claims-to-the-id-token)创建组并将它们作为声明添加到 ID 令牌中
...
## [](#learn-more-about-spring-cloud-config-java-microservices-and-jhipster)了解更多关于 Spring Cloud Config、Java 微服务和 JHipster 的信息

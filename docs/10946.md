...
> 原文:[https://dev.to/olegchursin/upgrade-to-webpack-4-1fm5](https://dev.to/olegchursin/upgrade-to-webpack-4-1fm5)
...
### [](#step-1-upgrade-webpack-and-install-webpackcli)第一步。升级 webpack 并安装 webpack-cli:
...
### [](#step-2-add-respective-modes-in-raw-webpackconfigdevjs-endraw-and-raw-webpackconfigprodjs-endraw-)第二步。在`webpack.config.dev.js`和`webpack.config.prod.js`中添加各自的模式
...
### [](#step-3-add-forktscheckernotifierwebpackplugin)第三步。添加 fork-ts-checker-notifier-web pack-plugin
...
### [](#step-41-update-htmlwebpackplugin)Step 4.1 更新 html 网页包插件
...
### [](#step-42-adjust-the-plugin-order-in-raw-webpackconfigdevjs-endraw-and-raw-webpackconfigprodjs-endraw-)步骤 4.2 调整`webpack.config.dev.js`和`webpack.config.prod.js`中的插件顺序
...
### [](#step-5-update-raw-tsloader-endraw-raw-urlloader-endraw-and-raw-fileloader-endraw-)第五步。更新`ts-loader`、`url-loader`和`file-loader`
...
### [](#step-6-update-reactdevutils)第六步。更新反应-开发工具
...
### [](#step-8-update-and-reconfigure-raw-uglifyjswebpackplugin-endraw-)第八步。更新和重新配置`uglifyjs-webpack-plugin`

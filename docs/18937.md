...
> 原文:[https://dev . to/oktadev/build-a-basic-crud-app-with-laravel-and-react-1fp 9](https://dev.to/oktadev/build-a-basic-crud-app-with-laravel-and-react-1fp9)
...
## [](#add-okta-for-authentication)添加 Okta 进行认证
...
## [](#set-up-your-okta-dev-account)设置您的 Okta 开发账户
...
## [](#create-a-laravel-api)创建一个 Laravel API
...
## [](#install-react-and-set-up-the-react-frontend)安装 React 并设置 React 前端
...
## [](#add-authentication-and-basic-routing-to-react)添加认证和基本路由反应
...
## [](#display-your-players-list-using-react)使用 React 显示你的玩家名单
...
## [](#add-authentication-to-your-laravel-api)向您的 Laravel API 添加认证
...
## [](#create-a-new-player-component-in-react)在 React 中创建新的玩家组件
...
## [](#add-a-delete-player-button-to-react)添加一个删除玩家按钮来反应
...
## [](#add-the-trivia-service-to-react)添加琐事服务反应过来
...
## [](#add-buttons-to-indicate-right-and-wrong-answers)添加按钮表示正确和错误的答案
...
## [](#learn-more-about-laravel-react-and-okta)了解更多关于 Laravel、React 和 Okta 的信息

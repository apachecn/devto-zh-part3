...
> 原文:[https://dev . to/emmabostian/creating-a-custom-accessible-drop-down-3g mo](https://dev.to/emmabostian/creating-a-custom-accessible-drop-down-3gmo)
...
[![What we want vs. what we get](../Images/b6da748aebc58e3bf5b165e77a95c15a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--yWttxC1F--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://user-images.githubusercontent.com/7671983/53564458-44901e80-3b57-11e9-81af-ac25c9a34e34.png)
...
### [](#creating-a-custom-select)创建自定义选择
...
### [](#making-the-custom-element-accessible)使自定义元素可访问
...
*   `<svg>`元素需要额外的信息来描述它是什么。因此，我们可以添加一个`<title>Open drop down</title>`作为 SVG 的第一个子节点。
...
### [](#implementing-keyboard-accessibility-with-javascript)用 JavaScript 实现键盘辅助功能

...
> 原文：<https://dev.to/bnevilleoneill/discovering-the-shadow-dom-48ec>

[![](img/b229dad5d8cbc2c22886d78b34a78a12.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--c8U1LbbD--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/958/1%2Act_7DotEJPOAOavhtBtqpA.jpeg)
...
[![](img/c9e434092625cf9727352bcd921b106f.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--CsCspQf3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/457/0%2Az51BvlckXakaHUP8)
...
[![](img/c3e22002bd954fa204ea66e0524b4ab0.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--jNtOPIdA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/496/0%2Att3ZTMmUffZH8YFO)
...
[![](img/b3ed80c65f13a580f820564d8f086c89.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--fumlVxuj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/427/0%2AjBl7ZOGbjRWG1FEY)

由于 DOM 是一个全局实体，上面显示的 CSS 规则影响页面中的任何 *h4* 元素，甚至是从外部脚本动态添加的元素。你无法保护在构建搜索框时定义的特定的 *h4* 元素。如果你仅仅依赖于 DOM，你不能封装它。

但是这个问题不仅仅与 CSS 规则应用程序有关。想象一下，如果在页面的某个地方有以下 JavaScript 语句会发生什么:
...
[![](img/82128470f32bc2491c2f6b2f55f15045.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--v2vGzEvu--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/397/0%2AURUIaci4BwoQPIHK)
...
与前一版本相比，第一个区别是创建了一个 iframe 元素:

```
const iframe = document.createElement("iframe"); 
```

第二个区别是将表示搜索框的 DOM 部分附加到外部元素的方式。使用这种方法，您不需要直接将 box 元素附加到外部元素上。将 iframe 元素附加到外部元素，然后将 box 元素附加到与 iframe 相关联的文档主体。代码应该是这样的:
...
[![](img/426e9c287750be7e4088056c9b45fdd8.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--lD-N_6D0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/415/0%2A0E4mbRkKhgSWDRIK)
...
然而， *Shadow DOM* 对外界是公开的，所以它的元素可以通过 JavaScript 访问。换句话说，你可以从任何一个类似于
的页面访问搜索框的*影子 DOM*

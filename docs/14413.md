...
> 原文:[https://dev . to/dex ygen/quick-and-dirty-aspect-oriented-AOP-JavaScript-with-a-two-打代码行-484b](https://dev.to/dexygen/quick-and-dirty-aspect-oriented-aop-javascript-with-a-couple-dozen-lines-of-code-484b)

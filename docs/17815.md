...
> 原文:[https://dev . to/aurelkurtula/playing-with-graphql-yoga-and-mongose-f4f](https://dev.to/aurelkurtula/playing-with-graphql-yoga-and-mongoose-f4f)
...
## [](#connecting-to-mongo-database)连接到 mongo 数据库
...
### [](#mongo-and-graphql)Mongo 和 GraphQL

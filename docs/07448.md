...
> 原文:[https://dev . to/manly coffee/elegant-JavaScript-with-generators-1720](https://dev.to/manlycoffee/elegant-javascript-with-generators-1720)
...
## [](#iterables-and-iterators)迭代器和迭代器
...
## [](#other-examples-of-iterables)其他可重复项的例子

...
> 原文:[https://dev . to/fteem/validate-your-passwords-using-elixir-and-haveibeenpwnedcoms-API-1718](https://dev.to/fteem/validate-your-passwords-using-elixir-and-haveibeenpwnedcoms-api-1718)
...
## [](#reader-meet-haveibeenpwnedcom)看官，认识一下 haveibeenpwned.com
...
## [](#using-the-pwned-passwords-api)使用 pwned 密码 API
...
## [](#manipulating-the-password)操纵密码
...
## [](#sending-request-to-an-api)向 API 发送请求
...
## [](#returning-a-meaningful-result)返回有意义的结果

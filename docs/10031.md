...
> 原文:[https://dev . to/dev _ nope/create-a-form builder-component-in-react-native-part-5-535h](https://dev.to/dev_nope/create-a-formbuilder-component-in-react-native-part-5-535h)
...
# [](#part-5-enabledisable-form-buttons-onthefly)第 5 部分:动态启用/禁用表单按钮
...
### [](#modify-our-raw-formbutton-endraw-component)修改我们的`FormButton`组件
...
### [](#enabledisable-the-raw-calculate-endraw-button)启用/禁用`Calculate`按钮
...
### [](#enabledisable-the-raw-reset-endraw-button)启用/禁用`Reset`按钮
...
[![Salary Calculator V3](../Images/0bf6ac4b7622da9e5c60d3637597425e.png "Salary Calculator V3")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8EpQ4JSD--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/6avr8hw11r6a3l9yxyci.gif)

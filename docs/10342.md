...
> 原文:[https://dev . to/cube js/building-an-analytics-dashboard-with-node-express-and-cube js-1 oje](https://dev.to/cubejs/building-an-analytics-dashboard-with-node-express-and-cubejs-1oje)
...
[![](../Images/fef54116d333877a878455b8ad2a5d04.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Xuv0hlND--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://media.graphcms.com/hSWmTK9hQgyFh2eISUdL)

## [](#getting-a-sample-dataset)获取样本数据集
...
## [](#alternative-setup-run-cubejs-in-serverless-mode)备选设置:在无服务器模式下运行 Cube.js
...
## [](#building-analytics-dashboard)构建分析仪表板
...
[![](../Images/3052955d876b327b1637a4c74fdeefa3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Eiz6sxHm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/statsbotco/cube.js/master/docs/old-was-vs-cubejs-way.png)

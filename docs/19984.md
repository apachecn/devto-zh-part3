...
> 原文:[https://dev.to/rrampage/git-tags-from-command-line-103l](https://dev.to/rrampage/git-tags-from-command-line-103l)
...
### [](#how-to-use-raw-git-tag-endraw-better)如何使用`git tag`更好

#### [](#checkout-code-to-the-tag)结账码为标签
...
#### [](#make-your-tag-more-informational)让你的标签更信息化！

您可以使用 **`git tag -a TAG_NAME -m 'MESSAGE'`**
添加更多信息，无需使用 **`git show TAG_NAME`** 检查标签即可查看标签信息。

#### [](#create-tag-at-a-particular-commit)在特定提交时创建标签

...
> 原文:[https://dev . to/pxyup/how-I-build-a-super-fast-js-framework-4a GB](https://dev.to/pxyup/how-i-built-a-super-fast-js-framework-4agb)

# [](#how-do-other-frameworks-operate)其他框架如何操作？

如果我们根本不使用虚拟 DOM，而是使用真实 DOM 会怎么样？要回答这个问题，我们首先需要了解大多数框架是如何工作的，为了更好地说明这一点，我举了一个小例子。

[![img](../Images/af533b4f57d957a73bd0cb60fa6a874e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--f12E6t6l--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/g25b38qhbuf2se3ultxp.png)
...
# [](#utopia-way-of-doing-this)乌托邦的做法

但是我想告诉你，在我的头脑中，它应该是这样工作的，不需要微分，不需要迭代，也不需要节点。

[![img](../Images/9817fd439ff513eb415fece0ac57e34c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--4rJ8sRi6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/dqb4xxm4q2w1w4oemihe.png)
...
# [](#benchmark-application)基准程序

[游乐场](https://stackblitz.com/edit/typescript-p35cgr)

## [](#another-frameworks)另一个框架

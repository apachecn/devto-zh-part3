...
> 原文:[https://dev . to/zejnilovic/building-Hadoop-native-libraries-on-MAC-in-2019-1 iee](https://dev.to/zejnilovic/building-hadoop-native-libraries-on-mac-in-2019-1iee)
...
## [](#building-native-libraries)构建原生库

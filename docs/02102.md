...
> 原文:[https://dev . to/brendanlobuglio/welcome-to-rabbit-hell-reliable-ai-locomotion-with-TDD-97e](https://dev.to/brendanlobuglio/welcome-to-rabbit-hell-reliable-ai-locomotion-with-tdd-97e)
...
[![Virtual rabbits navigating a series of "unit test" obstacle courses](../Images/b3448d601f6368429722a6678d23acf9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--CihPbLuo--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://i.imgur.com/5r4UjhJ.gif)

# [](#the-basics-of-testdriven-development)测试驱动开发的基础知识
...
# [](#tdd-application-in-game-development)游戏开发中的 TDD 应用
...
# [](#unit-tests-vs-debug-levels)单元测试与调试级别

在我开始我的 TDD 实践之前，我想区分自动化单元测试和传统的“调试级别”gamedev 中的一个常见做法是创建带有人造环境的隐藏场景，允许程序员和 QA 专业人员见证特定事件。

<figure>

[![A secret debug level full of different objects in The Legend of Zelda: The Wind Waker](../Images/b716f857f07bbcd29727760fc5a634e0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--XCOMHSi7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/j78ohyvo42jhz4qec28q.png)
...
# [](#welcome-to-rabbit-hell)欢迎来到兔子地狱！
...
[![Top-down view of the Rabbit Hell unit test scene](../Images/9ba998dae251c9e840c5ba5cfb4b28d5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--IVMD1hMM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://i.imgur.com/YA4Gc7x.gif)
...
[![1, 2, 3: Unobstructed Movement, Static Obstacles, and Dynamic Obstacles](../Images/72d53a8c52c6b28e1fe960b1fc8ce2ca.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--VBIkI40v--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://i.imgur.com/reiIDMF.gif)
...
[![8 & 9: Even slopes, and Uneven Terrain](../Images/0cc9b74f522e30443eb449177c5eb0b2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--cr2alFkN--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://i.imgur.com/zjMDu3W.gif)
...
[![10: "Navmesh Magnet" failsafe for floating creatures](../Images/e40d9565f5061e2a4e68116780fe91c4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--mvdISASr--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://i.imgur.com/6W1xe9z.gif)
...
[![13: Reproduction for a bug where creatures would infinitely circle around nearby targets](../Images/a5e94d387d4e687a0eb77031fc5af814.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--HPadTn_g--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://i.imgur.com/145AMEz.gif)
...
[![14 & 15: Step-Up ability on flat and complex ledges](../Images/5e0a235d982784906c1b9d8df17c1549.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--BtNumqxi--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://i.imgur.com/WULLMCI.gif)
...
[![This galloping Mossmork requires a little more room to turn than a rabbit](../Images/e9d872b66c003d2a7d40c5700428ee82.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--WDlm3m-L--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/z6w1nvgt3yn1d7m51566.png)

<figcaption>This galloping Mossmork requires a little more room to turn than a rabbit</figcaption>

</figure>

# [](#evaluation-is-testdriven-development-right-for-you)评价:测试驱动开发适合你吗？
...
## [](#1-are-your-test-cases-timeconsuming-to-produce-manually)1。手动生成测试用例是否很耗时？

在花时间进行自动化测试之前，我们需要检查我们是否可以用常规的游戏控件来评估一个特性。如果你想确保你的钥匙打开门，产生一个钥匙，用它打开一扇门！为这个特性创建单元测试是不负责任的时间浪费，因为手动测试只需要几秒钟。

## [](#2-are-your-test-cases-difficult-to-produce-manually)2。你的测试用例很难手工生成吗？
...
## [](#3-do-you-know-the-desired-results-wont-change)3。你知道预期的结果不会改变吗？
...
## [](#4-are-regressions-likely-to-go-unnoticed)4。回归有可能被忽视吗？
...
## [](#5-whats-the-the-worstcase-cost-of-having-tests-and-whats-the-worstcase-cost-of-not-having-tests)5。做测试的最坏成本是多少，不做测试的最坏成本是多少？
...
## [](#the-limits-of-automation)自动化的极限

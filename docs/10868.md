...
> 原文:[https://dev.to/dbanisimov/automatic-firestore-backups-16bh](https://dev.to/dbanisimov/automatic-firestore-backups-16bh)
...
[![Backup reminders in Google Calendar](../Images/9b9a402d1630c59ab2a33dac21a049c1.png "Backup reminders in Google Calendar")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--PgWFKPr1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/0a8tzlxd6gg3rzy300zs.PNG)
...
# [](#firestore-rest-api-permissions)Firestore REST API 权限
...
# [](#testing-everything-together)一起测试一切

一旦一切都设置好了，你可以通过点击“立即运行”按钮从[云调度控制台](https://console.cloud.google.com/cloudscheduler)触发整个过程

[![Cloud Scheduler console](../Images/4453c036c4c7177ad2101a873c30d9e1.png "Cloud Scheduler console")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--pTRLYxbj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/m4hv55j0jk8c0d1zqalf.PNG)

检查 Firebase 控制台或堆栈中的日志驱动程序
[![Backup function logs](../Images/6abee626d70ba37a9e5d75f9032c6048.png "Backup function logs")](https://res.cloudinary.com/practicaldev/image/fetch/s--BX-X0Ezg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/d1v9vozkp5cj3cy8ji7m.PNG)
...
最后检查备份桶中的
[![Backup folder in the bucket](../Images/fba2539af4585c706d6f0677a6bc702c.png "Backup folder in the bucket")](https://res.cloudinary.com/practicaldev/image/fetch/s--JpDpo_ws--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/nch8xx21dxchp0dti8pp.PNG)

...
> 原文:[https://dev . to/progress/platform-specific-development-with-native script-dd1](https://dev.to/progress/platform-specific-development-with-nativescript-dd1)
...
### [](#blocks-of-markup-within-a-view)视图内的标记块
...
### [](#one-css-file-multiple-platforms)一个 CSS 文件，多个平台
...
## [](#customizing-javascripttypescript-code-behind)自定义后面的 JavaScript/TypeScript 代码

每个 NativeScript 视图在 JavaScript 文件后面都有相应的代码来处理应用程序的逻辑。

### [](#separate-javascript-files)分离 JavaScript 文件
...
## [](#platformspecific-resources)特定平台的资源
...
[![android drawable folder structure](../Images/d331acc36a51977fde6876b0e5f2f12d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vGpBfdP2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/rdlauer/articles/master/nativescript/platform-specific/android-drawable.png)

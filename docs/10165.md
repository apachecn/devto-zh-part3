...
> 原文:[https://dev . to/riter/server less-approach-to-integrate-git lab-web hooks-with-graph QL-API-4k gi](https://dev.to/riter/serverless-approach-to-integrate-gitlab-webhooks-with-graphql-api-4kgi)
...
## [](#requirements-to%C2%A0the-initial-data)对初始数据的要求

...
> 原文:[https://dev.to/aoemerson/i-科特林-内联-功能-版本-2f25](https://dev.to/aoemerson/i--kotlin-inline-function-edition-2f25)
...
### [](#enter-raw-inline-endraw-generic-function-with-lambda)输入`inline`带 lambda 的通用函数
...
### [](#what-is-raw-inline-endraw-)什么是`inline`？

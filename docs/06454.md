...
> 原文:[https://dev . to/bnevilleoneill/react-hooks-cheat-sheet-unlock-solutions-to-common-problems-56ci](https://dev.to/bnevilleoneill/react-hooks-cheat-sheet-unlock-solutions-to-common-problems-56ci)

[![](../Images/a6b129d596f67b240e092f76cb4d5955.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--foiD78Gn--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AbJ9worNcj8ST9CQ4RVE_0Q.png)
...
#### [](#update-state-variable)**更新状态变量**

更新状态变量就像调用 useState 调用返回的 updater 函数一样简单。

`const [stateValue, updaterFn] = useState (initialStateValue);`

[![](../Images/07630ac4cf5afcdce62b5d5d694b4595.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--pSeShKKz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn-images-1.medium.com/max/882/1%2AxKBiQT_91AU-PlNLGjv0Yg.gif) 
...
#### [](#multiple-state-variables)**多个状态变量**

可以在一个功能组件中使用和更新多个状态变量，如下所示:

[![](../Images/2d29f344de77d5c24dc0b2cd0929e9de.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--njRB983d--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2A1MFDgE1LQuAc1_wyBgyVNQ.gif)T3】
...
#### [](#use-object-state-variable)**使用对象状态变量**
...
[![](../Images/c4a393dd33cf42bc2ed7f58e70040a70.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--EC_LahGq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AwYJuoTiiarplOkwoG36I2A.gif) 
...
#### [](#initialize-state-from-function)**从功能**初始化状态
...
[![](../Images/06a912b7f74de4f6c435d221e34403af.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--guGWR5qE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AuAEGQN-IESENc82FnkJUfA.gif) 
...
#### [](#basic-side-effect)**基本副作用**

[![](../Images/b5176f165130a3dfc988f94353cf3e26.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--mkDQWOQI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2ARdkmsjpFV1_KRxtk1pRFlw.gif) 
...
#### [](#skipping-effects-array-dependency)**跳过效果(数组依赖)**
...
[![](../Images/d321b002dd5ae51495e8297446d1da3d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--o8JHLUl7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AmSqiFgHeY6k84us2RBnLkg.gif)

#### [](#skipping-effects-empty-array-dependency-)**【跳过效果(空数组依赖)**
...
[![](../Images/c391d4cdc8af75dd9e6a991bd1726677.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--FXQEIIIX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AVVxa13t8u8oobG_1GIM1Qw.gif)

#### [](#skipping-effects-no-array-dependency)**跳过效果(无数组依赖)**
...
[![](../Images/b1fbe3c03e5b7fb855691415884787d9.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--a1eLJ7Fn--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/962/1%2AsJEVsJmB2vHc8vqqP4nAJA.png)T3】
...
#### [](#similar-usage-as-useeffect)**类似用法如 useEffect**

下面是用 useLayoutEffect 构建的 useEffect 的相同示例:

[![](../Images/922f54121ba0efc88ab84a539c5a7c67.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--48uVo8XR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2Aa7MsYcXko93rq_9KtjiXpg.gif)T3】
...
[![](../Images/7e579ba0d8c711e54b48833bc4f51d5d.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--SJGomZ4r--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2ABSkGtn-NIHGDIwd67NZoYQ.gif) 
...
#### [](#initialize-state-lazily)**初始化状态**

useReducer 接受第三个函数参数。你可以从这个函数初始化 state，从这个函数返回的任何东西都作为 state 对象返回。将使用 initialState(第二个参数)调用该函数。

[![](../Images/7270a9c358441dda94cdd8bbbf186ffd.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--R0aS9_jX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2Aa39ldAuvYbSZ8Ney_sXaYg.gif) 
...
#### [](#imitate-thissetstates-behavior)**模仿 this.setState 的行为**
...
[![](../Images/a157135f802a16715c1fdd3d36d43f80.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--dmZomQsH--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AWbbJWr-_PGYXndcFEZVQUw.gif) 
...
#### [](#starter-example)**首发示例**

下面的例子将构成后面的解释和代码片段的基础。

[![](../Images/181e7a65668d7d6feb6ea0b66bfaf98f.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--wgr2SgN5--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AIy316AxOQNNXEcMHKeGw7w.gif)T3】
...
#### [](#usecallback-with-referenced-function)**使用被引用函数的回调**
...
#### [](#usecallback-with-inline-function)**用内嵌函数使用回调**
...
[![](../Images/20c56e00335ad15ab2b576d78e361aa8.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--7LFpKyta--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/916/1%2AjlGFv-2D2Yu6VoSGx5Fu3w.png)T3】
...
#### [](#accessing-the-dom)**访问 DOM**

考虑下面的示例应用程序:

[![](../Images/f8d65dc3d99b14a7e5d2aff21ee44fa7.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--WxoWixra--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AHpWEeuuijusQkO9mT5ohXw.gif) 
...
#### [](#instancelike-variables-generic-container)**【类实例变量(泛型容器)**

除了保存 DOM 引用,“ref”对象还可以保存任何值。考虑下面一个类似的应用程序，其中 ref 对象保存一个字符串值:

[![](../Images/f6ff9bbfe27bc015db5c519fad5f2a40.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--o1EcNJ6o--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AjLxqYWFdw0LDl8_axo5hMw.gif)T3】
...
[![](../Images/0eda6a6c20ee9723df0ca9a34c74da5c.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--_Zp55TTm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2Asr9I9TkSj8GCgSI411rGPA.gif)T3】
...
[![](../Images/dbac5df176ee10572e5f863edf2cf635.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--rZw_sMN9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2Aag8EVnHaBiQECo2yXC49Mw.png) 

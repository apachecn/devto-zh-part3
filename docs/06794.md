...
> 原文:[https://dev . to/moesif/debug-server less-AWS-lambda-functions-locally-with-Sam-CLI-and-vs code-2c 17](https://dev.to/moesif/debug-serverless-aws-lambda-functions-locally-with-sam-cli-and-vscode-2c17)
...
### [](#linking-the-debug-ui)链接调试界面

我这里就用 VSCode 内置的调试 UI。

首先，我们必须在要调试的文件中设置一个断点。在我们的例子中，这是`hello-world/app.json`。

[![VSCode Breakpoint Screenshot](../Images/da84764fecc84c0f494bde6c377331d3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--4-P1Dx4W--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.moesif.com/images/posts/technical/sam-cli-debug/breakpoint.png)

我们还可以添加观看表情。该表达式有助于立即从深度嵌套的对象中获取值，而无需在侧面的*变量*选项卡中导航到它们。

[![VSCode Watch Expression Screenshot](../Images/8709aec1b3224de949c03c039cea182d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ZTysnpzK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.moesif.com/images/posts/technical/sam-cli-debug/watch.png)
...
[![VSCode Debugger Screenshot](../Images/77d3aafcd3dbdcbadd2641cbb0744609.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--49K3CzkK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.moesif.com/images/posts/technical/sam-cli-debug/debugger.png)

如果我们单击“run”按钮，VSCode 应该会将其自身附加到 SAM CLI 进程，这由 VSCode 底部的红色信息栏来指示。

VSCode 突出显示了断点所在的行。

[![VSCode Breakpoint Highlight Screenshot](../Images/9a83b2a3581effd0b73e9d6470321cc1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--zTP6OYKV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.moesif.com/images/posts/technical/sam-cli-debug/breakpoint-highlight.png)

VSCode 中的调试器侧栏应该显示当前作用域的变量，如`event`和`context`。

[![VSCode Debugger Sidebar Screenshot](../Images/ceae42cd655f96190f7db0e6f099e00b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--MCwMKbMp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.moesif.com/images/posts/technical/sam-cli-debug/variables.png)

## [](#bonus-npm-script)奖励:NPM 剧本

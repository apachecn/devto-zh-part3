...
> 原文:[https://dev . to/veronikaro/data-visualization-and-web-reporting-in-angular-project-2d6f](https://dev.to/veronikaro/data-visualization-and-web-reporting-in-angular-project-2d6f)

### [](#problem-amp-motivation)问题&动机
...
[![Thinking](../Images/8fd5670e7a17632d4d47d50b8d3acae5.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--ARKGixmK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/75fvgcsu4te537cnhv6d.gif) 
...
### [](#what-is-flexmonster)**什么是 Flexmonster**

[![Flexmonster Pivot Grid](../Images/0ba08b70c78a7303321db6b8e1af31d2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--v8v-qn2y--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/u0g3ji9e92f1pxkwj7az.gif)
...
### [](#how-to-integrate-a-pivot-table-with-angular)**如何将数据透视表与有角度的**整合

就我个人而言，我觉得整个过程就像复制粘贴一样简单。这里有一个[教程](https://www.flexmonster.com/doc/integration-with-angular/?r=dv2)帮助我开始。

### [](#dashboards-amp-data-visualization)**仪表盘&数据可视化**
...
[![Stacked Column Chart](../Images/4fad271f1becde46ff836bae918b39d1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--DgbXXbpa--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8dcf9uohyv02q3w82n3u.gif)
...
### [](#how-to-load-data-in-charts)**如何加载图表中的数据**
...
### [](#google-charts-in-angular-app)**谷歌排行榜中的 Angular app**

Google Charts 也兼容 Angular 我已经在 npm 上找到了它的包装器。

这是带有 Flexmonster 和 Google 图表的**仪表板**的样子:

[![Stacked Column Chart](../Images/c770f91c1306be2470537a909bf8521c.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--nT_0QMMj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/050nnsv0xxfnlwhotxq2.PNG) 
...
您可以随意使用它来处理您的数据:)
[![Edit Flexmonster Angular](../Images/0b3f0135583496627e3621355d8e9248.png)](https://codesandbox.io/s/y0rxj9vz29?fontsize=14) (我建议在新的标签页/窗口中打开带有仪表板的网页，因为该 IDE 中的嵌入式浏览器并不总是能正确显示结果)

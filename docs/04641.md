...
> 原文:[https://dev . to/Steve blue/redux-with-observable-stores-in-angular-1b3b](https://dev.to/steveblue/redux-with-observable-stores-in-angular-1b3b)
...
[![NgRx kinda felt like this](../Images/b30cb6dd53c6658db91c779c2c18044a.png)T2】](https://i.giphy.com/media/l1KVcPKdsU0sRSSt2/giphy.gif)
...
[![](../Images/2e40153b3e10447fff46c807c8209c4f.png)T2】](https://i.giphy.com/media/WnCAPfflyfZjG/giphy.gif)
...
## [](#using-state-in-components)在组件中使用状态
...
[![](../Images/c554956300f54451e2d3e5c921cf18a1.png)T2】](https://i.giphy.com/media/l46C5MHNo0z9vXzvW/giphy.gif)

除了状态之外，还有更多的东西可以还原。如果您想用 redux 中的 action 和 reducer 模式来管理您的状态，但是是在这个定制的实现中，该怎么办呢？

## [](#actions-and-reducers)动作和减速器
...
## [](#but-dont-take-my-word-for-it)但不要相信我的话。

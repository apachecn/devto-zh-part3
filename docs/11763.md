...
> 原文:[https://dev.to/asanchez/from-php-to-go-arrays-3cfg](https://dev.to/asanchez/from-php-to-go-arrays-3cfg)
...
## [](#5-iterate-over-arrays-slices-and-maps-in-go)5。在 Go 中迭代数组、切片和地图
...
## [](#6-subarrays-with-different-types)6。不同类型的子阵列

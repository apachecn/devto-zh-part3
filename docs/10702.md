...
> 原文:[https://dev . to/Estrada 9166/testing-graph QL-on-the-front-end-and-back-4c 42](https://dev.to/estrada9166/testing-graphql-on-the-front-end-and-backend-4c42)
...
### [](#used-queries-and-mutations)常用查询和突变:
...
### [](#example-using-jest-and-easygraphqltester-assertion)使用 Jest 和 easygraphql-tester - assertion 的例子。
...
### [](#example-using-jest-and-easygraphqltester-mock)使用 Jest 和 easygraphql-tester - mock 的例子:

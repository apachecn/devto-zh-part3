...
> 原文:[https://dev.to/michaeldscherr/drupal-8x 所学 3ldi](https://dev.to/michaeldscherr/drupal-8x---what-ive-learned-3ldi)
...
## [](#best-practices-from-my-experience)最佳实践(根据我的经验)
...
### [](#install-drupal-core-w-composer)安装 Drupal 核心 w/ Composer
...
### [](#install-modules-w-composer)用 Composer 安装模块
...
### [](#use-the-raw-drupal-console-endraw-amp-raw-drush-endraw-executables)使用`Drupal Console` & `Drush`可执行文件

#### [](#installation-instructions-use-composer)安装说明(使用 Composer)
...
### [](#setup-drupal-for-local-development)为本地开发设置 Drupal

[遵循本教程](https://www.drupal.org/node/2598914)让您的本地开发变得更加容易。

### [](#use-view-modes)使用视图模式

...
> 原文:[https://dev . to/Yaser/when-TDD-donts-click-something-else-should-click-harder-2h9h](https://dev.to/yaser/when-tdd-doesnt-click-something-else-should-click-harder-2h9h)
...
### [](#in-case-you-dont-know-what-tdd-is)以防你不知道 TDD 是什么

TDD(测试驱动开发)是一种通过首先编写测试来开发软件的方法。

### [](#huh-tests-first)嗯...先测试？！

是的，在编写实际代码之前编写测试，否则你就不是在进行 TDD。

### [](#why-even-bother-with-tdd)何苦还要 TDD 呢？

鲍勃叔叔说，你不能重构你的代码:

> 你害怕你创造的东西，你失去了对它的控制...现在它控制了你；你不再是主人了！

### [](#buuut-tdd-never-worked-for-me)Buuut...TDD 从来没有为我工作过😓
...
[![longman](../Images/b7fbf804a8eb1fa73cb468373fbbbf0b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--17ReDGRd--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/44tazmi8butcdnyknx89.png)

所以，我会引用我自己的话(不确定是否有效😁):

> 当有人提到“务实的方法”这个词时，确保他不是指“肮脏的方法”。

### [](#so-whats-the-pragmatic-approach-when-it-comes-to-tdd)那么，谈到 TDD，有什么务实的做法呢？
...
### [](#fk-tdd-it-seems-not-working-give-me-the-solution)F#$k TDD，看来**不行了**，给我解决方案！！
...
### [](#opinionated-tips)固执己见的提示

[![opinions](../Images/c8b580a8584386919b76027a62a1c753.png)T2】](https://i.giphy.com/media/5XNEIKcohVG8w/giphy.gif)

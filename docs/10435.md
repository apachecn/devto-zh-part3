...
> 原文:[https://dev . to/sandordargo/the-circularly-recurring-template-pattern-crtp-46j 7](https://dev.to/sandordargo/the-curiously-recurring-template-pattern-crtp-46j7)
...
#### [](#adding-numerical-functions-to-a-class-by-johnathan-baccara)给一个类添加数值函数(张克帆·芭卡拉)

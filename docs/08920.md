...
> 原文:[https://dev . to/attacomsian/data-type-conversions-in-Java-5ag 6](https://dev.to/attacomsian/data-type-conversions-in-java-5ag6)
...
## [](#date-to-iso-8601-string)日期到 ISO 8601 的字符串

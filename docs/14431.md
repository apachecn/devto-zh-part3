...
> 原文:[https://dev . to/fridanyvall/how-to-implementation-variable-fonts-on-the-web-51li](https://dev.to/fridanyvall/how-to-implement-variable-fonts-on-the-web-51li)
...
## [](#adding-a-variable-font-to-a-web-page)给网页添加可变字体

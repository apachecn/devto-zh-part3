...
> 原文:[https://dev . to/crenshaw _ dev/when-the-browser-can-t-take-a-pre connect-hint-6dn](https://dev.to/crenshaw_dev/when-the-browser-can-t-take-a-preconnect-hint-6dn)
...
## [](#preconnect-without-crossorigin)无交叉原点预连接
...
[![WebPageTest waterfall chart showing one connection to the external domain starting immediately after the first chunk of HTML is parsed, but the other one beind delayed](../Images/11c5f8f4a1d708c33e83466348ae0615.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--FyUjLM6y--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/hepu3jq6uha0s699rej6.png)
...
## [](#preconnect-with-crossorigin-and-without)有交叉原点和无交叉原点的预连接

...
> 原文:[https://dev.to/singhdigamber/what-is-typescript-jig](https://dev.to/singhdigamber/what-is-typescript-jig)

这篇文章介绍了 TypeScript 以及它是如何工作的？
最早出现在 [positronX.io - Learn 全栈开发](https://www.positronx.io)

# [](#1-what-is-typescript)1 什么是 TypeScript？
...
### [](#type-checker-or-type-resolver)类型检查器或类型解析器
...
### [](#typescript-to-javascript-using-typescript-playground)使用 TypeScript Playground 将 TypeScript 转换为 javascript

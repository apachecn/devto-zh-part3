...
> 原文:[https://dev . to/siegerts/creating-a-vue-js-component-library-part-iv-documentation-with-vue press-56 H5](https://dev.to/siegerts/creating-a-vue-js-component-library-part-iv-documentation-with-vuepress-56h5)
...
## ![GitHub logo](../Images/292a238c61c5611a7f4d07a21d9e8e0a.png)[siegerts](https://github.com/siegerts)/[vue-组件-库-模板](https://github.com/siegerts/vue-component-library-template)
...
### [](#steps-to-achieve-requirements)达到要求的步骤
...
## [](#customize-raw-configjs-endraw-)自定义`config.js`
...
[![Alt Text](../Images/6b385aaf4ada53c3f70cfa9801622a47.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--B8JUSL3R--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://dev-to-uploads.s3.amazonaws.com/i/l00luwvmrvx8aog511do.png)

`/components`路线将暂时显示一个`404`页面。这没关系，因为我们将在下一节中解决这个问题。

很好，现在让我们添加组件库插件。

## [](#register-the-component-plugin)注册组件插件
...
#### [](#-raw-enhanceappjs-endraw-)`enhanceApp.js`
...
## [](#visualize-and-document-the-components)可视化并记录组件
...
[![Alt Text](../Images/850252c09b6457798cb9c07b0645c46b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--nQHxNQRG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://dev-to-uploads.s3.amazonaws.com/i/n62xp1zbctjrnngjob4a.png)
...
### [](#creating-raw-demovue-endraw-)创造`Demo.vue`
...
### [](#creating-raw-sourcecodevue-endraw-)创造`SourceCode.vue`
...
### [](#adding-the-first-documentation-page)添加第一个文档页面
...
[![Alt Text](../Images/05a3f81226440ec1c68439593bdd1d6f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--GdhICFBH--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://dev-to-uploads.s3.amazonaws.com/i/ss1lc4o1vl1j5wu2uxcn.png)

[![Alt Text](../Images/50d652bd9146eaacfd4ded25856c152e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--fEB9KSoJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://dev-to-uploads.s3.amazonaws.com/i/zker0tsxigb1xfqx2nii.png)

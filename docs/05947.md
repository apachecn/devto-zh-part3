...
> 原文:[https://dev . to/terceranexus 6/introduction-to-Linux-hardening-5aj 1](https://dev.to/terceranexus6/introduction-to-linux-hardening-5aj1)

有段时间了！我最近一直在做这么多项目，但其中最重要的一个是与 **Linux 硬化**相关的。本周我将做一个关于它的演讲，我想先分享一些。

首先，Linux 加固是为了增强系统的安全级别，大多是通过低级命令来检查和编辑基本/默认 OS 值。

[![](../Images/62f2b9045bb84579e4a2149082a0c517.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--idLTKQKu--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://img.webme.com/pic/i/ilja-spb/tux_the_warrior_1.png)

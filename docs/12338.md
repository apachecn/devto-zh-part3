...
> 原文:[https://dev . to/jkettmann/4-ways-to-handle-local-state-when-using-Apollo-and-graph QL-3ehl](https://dev.to/jkettmann/4-ways-to-handle-local-state-when-using-apollo-and-graphql-3ehl)
...
## [](#handling-clientside-state-with-apollo)用 Apollo 处理客户端状态
...
## [](#handling-global-client-state-with-react-context)用 React 上下文处理全局客户端状态
...
## [](#component-state-for-simple-usecases)组件状态为简单用例
...
## [](#thirdparty-state-management-solutions)第三方状态管理解决方案

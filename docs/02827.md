...
> 原文:[https://dev . to/lankydandev/corda-extending-flow-to-customize-transaction-validation-5akj](https://dev.to/lankydandev/corda-extending-flows-to-customise-transaction-validation-5akj)

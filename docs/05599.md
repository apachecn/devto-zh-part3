...
> 原文:[https://dev . to/azure/auto-away-assist-for-nest-thermostat-1b2m](https://dev.to/azure/auto-away-assist-for-nest-thermostat-1b2m)
...
*   实际调用嵌套 API 的服务。我们将使用一个无服务器的 Azure 函数来调用 Nest API，当事件通过前面提到的 Azure IoT Hub 到达时，该函数将被触发。下面提供了概述整体架构的图表:![Diagram](../Images/2d65a43ff44a46a893c0145e222f99c6.png)*Hardware =>particle . io =>Azure IoT HuB =>Azure Function =>Nest API*

## [](#obtaining-an-oauth-token-to-access-the-nest-api)获取 Oauth 令牌以访问嵌套 API
...
[![Settings](../Images/1252669f55d8ae2c05b6dc1b270c8aa4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--1wXoAkWJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/6zz24v7vtkhduu6k0wio.jpg)

3.从下面的屏幕中获取 OAuth 客户端的授权 URL 值，然后选择“允许”。在允许你的申请后，你会收到一个个人识别码，请务必将它复制下来。授权 URL 可以从 OAuth 客户端的概览屏幕中获得，如下所示。

[![Settings2](../Images/f328e566db82c6b1a0cc58d15068b4ff.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ArR5kBYf--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/j1qi0pgoeylem764x0h2.jpg)
...
## [](#constructing-the-hardware)构造硬件
...
[![Schematic](../Images/da4de0bfcecb67149280bbe546f9b4e1.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--i8wrpeQA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/u156vidutumdtlmisz48.jpg)
[![Prototype](../Images/c09416d07131884f2491b373c4f29959.png)T6】](https://res.cloudinary.com/practicaldev/image/fetch/s--KlUhDPaU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/gpq97unuz03gozopm65e.jpg)
...
## ![GitHub logo](../Images/a73f630113876d78cff79f59c2125b24.png) [ toolboc ](https://github.com/toolboc) / [自动离巢辅助恒温器](https://github.com/toolboc/Auto-Away-Assist-for-NEST-Thermostat)
...
[![Hardware Prototype](../Images/fbd372652170057c00514ea0e27d747c.png)T2】](https://raw.githubusercontent.com/toolboc/Auto-Away-Assist-for-NEST-Thermostat/master//Assets/prototype.png)

</article>

[View on GitHub](https://github.com/toolboc/Auto-Away-Assist-for-NEST-Thermostat)

## [](#setup-particle-integration-to-forward-events-to-an-azure-iot-hub)设置粒子集成，将事件转发到 Azure 物联网中心
...
[![Create IoT Hub](../Images/3ab6b6fa10baec95385ddcb5af8a6295.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--uHlugMhb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/rjnt1i07wvtp9eiy4wtp.jpg)
...
[![Enable Integration](../Images/85337504485670a35c8c8efaf72decae.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--bNIVCefE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/5p6o9oqio0tnddg4f4z1.png)

现在在 nestmotion.ino 中调用`Particle.publish("motion", "true", PRIVATE);`时，事件会被发送到 Particle.io，然后转发到你的 Azure Iot Hub。

## [](#set-nest-away-status-with-azure-function)用 Azure 函数设置 Nest 'Away '状态
...
[![Eventhub-Compatible-Endpoint](../Images/4ed406baab9a8538a4086728294cd1f4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--yemX_9xh--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/hobp7leqrms5v7nbcvgk.png)

您现在可以调试和测试 Azure 功能了。当粒子设备发送运动事件时，您应该会看到函数触发。

[![Azure Function Debugging](../Images/1412a161f7de61e2d4e4c3e499899533.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--qj5ALkdj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/p156pi8sk7m78i37wyq5.png)
...
[![AppSettings](../Images/70ee97783a1097cb8588f05070baf3f7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---oxVmaMC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8nm6r061c9aanzuyv37z.png)
...
[![Azure Portal Test](../Images/a7a7faeba4ce7f56d29f942d9f8b455f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--KMQJ5rhX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/78hs7cpt15g8ue3zr3k3.png)
...
[![Particle Monitor](../Images/23134270d4843302f8e052bb08bffacd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--FoWSOsCd--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/7biw3k2tc8qilnttohf7.png)

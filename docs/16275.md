...
> 原文:[https://dev . to/demetrakopetros/what-is-the-difference-my websitecom-and-wwwmywebsitecom-nel](https://dev.to/demetrakopetros/what-is-the-difference-between-mywebsitecom-and-wwwmywebsitecom-nel)
...
### [](#regarding-dns-and-cname-records)关于 DNS 和 CNAME 的记录

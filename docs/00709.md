...
> 原文:[https://dev . to/English Craig/docker-django-react-building-assets-and-deployment-to-heroku-24jh](https://dev.to/englishcraig/docker-django-react-building-assets-and-deploying-to-heroku-24jh)
...
## [](#use-whitenoise-to-serve-our-frontend-assets)使用 WhiteNoise 服务我们的前端资产

### [](#update-settings-for-different-environments)针对不同环境更新设置
...
### [](#add-production-settings-with-whitenoise)添加带有白化的生产设置
...
### [](#add-home-url-for-production)为生产添加主页网址
...
## [](#create-a-production-dockerfile)创建生产文档文件
...
## [](#create-an-app-on-heroku)在 Heroku 上创建 app

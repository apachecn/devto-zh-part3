...
> 原文:[https://dev . to/mandrew cito/singlar-core-python-client-ii-authentic ation-3k 59](https://dev.to/mandrewcito/singlar-core-python-client-ii-authentication-3k59)
...
## [](#quick-fix-memory-database)快速修复，记忆数据库
...
## [](#create-user-on-the-web)在 web 上创建用户

[![Register](../Images/ab4c355cd449d8787772e48761129b3e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9tWBRXGK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/2fa9q035n0n34e1u45if.PNG)

# [](#client-side)客户端

## [](#first-get-auth-token)首先，获取 auth 令牌
...
## [](#build-connection-and-add-signalr-event-handlers)建立连接并添加信号事件处理程序

...
> 原文:[https://dev . to/maximrouiller/how-to-build-a-stage-docker file-for-spa-and-static-sites-1cck](https://dev.to/maximrouiller/how-to-build-a-multistage-dockerfile-for-spa-and-static-sites-1cck)
...
## [](#build-stage-nodejs)构建阶段(Node.js)
...
## [](#building-the-dockerfile)构建 Dockerfile
...
## [](#running-the-docker-container-locally)本地运行 Docker 容器

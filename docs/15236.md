...
> 原文:[https://dev . to/kmelve/how-to-fast-set-a-gatsbyjs-jam stack-website-with-a-headless-CMS-4inh](https://dev.to/kmelve/how-to-quickly-set-up-a-gatsbyjs-jamstack-website-with-a-headless-cms-4inh)
...
## [](#clone-or-fork-the-repository-on-github)克隆或分叉 Github 上的库
...
## [](#install-the-sanity-cli)安装 Sanity CLI
...
## [](#set-up-sanityio-as-a-headless-cms)设置 Sanity.io 为无头 CMS
...
## [](#start-the-local-development-server)启动本地开发服务器
...
[![Company Info in Sanity Studio](../Images/06527df8ef6a858979da5d7309f1ce85.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Ylnqaipp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn.sanity.io/images/3do82whm/production/476ae6eb772c1ce97e0515fb0bfd1cfe28c41f32-2196x1952.png)
...
## [](#try-out-watch-mode-for-gatsby)为盖茨比尝试手表模式
...
[![Demonstrating watch mode in the gatsby source sanity plugin](../Images/e2701bd4bf59360402bbb2b12623c8ea.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--UGO9cK7A--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn.sanity.io/images/3do82whm/production/fab24a742319a8e2395202d433e386593d8bedd4-1338x1022.gif)

## [](#add-token-to-see-all-changes)添加令牌查看 _ 所有 _ 变更
...
[![Watch mode with drafts enabled](../Images/7ef84028620defa7b4503afbe5737b44.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--95y9UfTI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn.sanity.io/images/3do82whm/production/61ab9c832f4fbeb0b6ef4883e983f6a60a2cfb16-1338x1022.gif)
...
[![Setting up the Sanity.io powered Gatsby.js website on Netlify](../Images/d90f26904176c8d947aa28f6ea8f843f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--PMKQbJGc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn.sanity.io/images/3do82whm/production/0f5e131d88b8eb024e83ab25366e13d4fa2b5d5f-2380x2220.png)
...
### [](#trigger-new-netlify-builds-on-content-changes)根据内容变化触发新的网络构建
...
## [](#bonus-content-preview-online-on-heroku)奖励:Heroku 上的在线内容预览
...
### [](#add-gatsbycli-as-a-devdependency)添加 gatsby-cli 作为开发依赖项

...
> 原文:[https://dev . to/flexdinesh/deploy-Gatsby-sites-to-github-pages-eed](https://dev.to/flexdinesh/deploy-gatsby-sites-to-github-pages-eed)
...
## [](#deploy-gatsby-sites-anywhere)在任何地方部署 Gatsby 站点
...
## [](#deploy-gatsby-sites-to-github-pages)将 Gatsby 站点部署到 GitHub 页面

...
> 原文:[https://dev.to/melezhik/portable-profiles-with-tomtit-298e](https://dev.to/melezhik/portable-profiles-with-tomtit-298e)
...
# [](#sparrowdo-dsl-and-extensions)Sparrowdo DSL 及其扩展
...
# [](#placeholders-and-configurations)占位符和配置
...
# [](#using-profile-by-tomtit)通过 Tomtit 使用 profile

...
> 原文:[https://dev . to/oba hareth/从与 web pack-and Abel-1 knc 的一年斗争中吸取的教训](https://dev.to/obahareth/lessons-learned-from-a-year-of-fighting-with-webpack-andbabel-1knc)

我使用 React 已经一年多了，很多时候都出了问题，降低了我们的构建速度，并且在我移植的浏览器中无法工作。我决定分享我学到的经验，希望它们能帮助别人。

## [](#be-very-careful-with-importing-large-libraries)导入大型库时要非常小心
...
## [](#inspect-your-bundle-with-webpack-bundle%C2%A0analyzer)使用 Webpack bundle analyzer 检查您的捆绑包

[![](../Images/b091913ae0bb56988977896a7e614981.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--gGdoLm3G--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/uw90hpp9pwc1xq132nl0.png)
...
## [](#add-escheck-to-your-ci-pipeline-early%C2%A0on)尽早将 es-check 添加到您的 CI 渠道中
...
## [](#transpiling-a-nodemodule)传输节点模块
...
[![](../Images/edc81259649936bb8e9478533097b6e5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9B4Rj-tv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/2g93tl5ilquhwni8fmtw.png)

## [](#use-browserslist-to-specify-your-target%C2%A0browsers)使用浏览器列表指定你的目标浏览器
...
## [](#use-babelconfigjs-over%C2%A0babelrc-for-babel-%E2%89%A5%C2%A070)使用 babel.config.js 结束。babelrc(适用于 Babel ≥ 7.0)
...
[![](../Images/a45d8ba89f17b2914a063f7d6fd6ae0f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--gdbWeyPq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4kjmpngvc7gtkbb6kfk0.png)
...
## [](#what-i-hope-to%C2%A0see)我希望看到什么

...
> 原文:[https://dev . to/nick Parsons/react-native-chat-with-chuck-Norris-3h7m](https://dev.to/nickparsons/react-native-chat-with-chuck-norris-3h7m)
...
## [](#1-configure-chat-by-stream)1。按流配置聊天

前往 [https://getstream.io](https://getstream.io) ，点击网站右上角的“注册”按钮。按照提示进行操作。

[![Stream](../Images/44e2c9817b5bdff7f38490d47957b05c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ZVUUde_B--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/r8aJ5Mx.png)

一旦你被重定向，前往[https://getstream.io/chat/#pricing](https://getstream.io/chat/#pricing)并点击“开始试用”按钮——这将为你的帐户启用试用聊天(14 天)。一旦审判开始，你就快成功了！

[![Stream Pricing](../Images/46839d28e0378c5adfb5a277d8e17f7b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9lbjbaQe--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/Zoqwf0X.png)

回到仪表板，单击您的应用程序。仪表盘默认为“Feeds”，所以请点击顶部的“Chat”按钮。

[![Stream Dashboard](../Images/cb067209d4e318c022f8af6db62061f8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--n0Nz5Ty8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/26rfcMT.png)
...
[![Serverless Dashboard](../Images/4deedb7d46e2acf7279b1bac4c1cafa3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--eQrMU0IV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/Gij33L9.png)

## [](#3-create-a-react-native-app-with-expo)3。使用 Expo 创建一个 React 本机应用程序
...
[![Terminal](../Images/1697874d72f2836d09294c2985fe872b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--oyPcK25L--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/OK7nMQ4.png)

一切就绪！👏

## [](#4-add-chat-sdk-to-react-native-chat)4。添加聊天 SDK 以反应本地聊天
...
## [](#5-add-default-message)5。添加默认消息
...
## [](#6-add-routing-amp-screens-to-react-native)6。添加路由&屏幕反应原生
...
## [](#7-add-serverless-directory-amp-files)7。添加无服务器目录&文件
...
[![AWS CLI](../Images/e09c0acf7da60681d77953552fd35ae4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--WwJjpS8d--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/InY9WGK.png)

> *第一次需要安装 aws-cli？在 macOS 上超级简单。只需运行 brew 安装 aws-cli 和家酿将照顾你的休息！*

干得好！🕺

## [](#9-deploy-your-serverless-build)9。部署无服务器版本
...
[![SLS Deploy](../Images/e332fc2f303bc0b0a8078bba11093ed2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--t1WOEDGo--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/Xb9NFdO.png)

> 遇到问题？请在文章末尾的评论中留下详细信息，我会帮你解决的！

嘣！💥

## [](#10-enable-api-gateway-to-start-serving-requests)10。启用 API 网关以开始服务请求
...
[![AWS Dashboard – API Gateway](../Images/9201a342e298b43d0d5aede82081560b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--TtsT82W8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/ZFzXwl1.png)
...
[![AWS Dashboard – API Gateway Resources](../Images/ca5fa8de54c6df95e0a496645fc2aab0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--m_8HsdIm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/yvl5ps7.png)

选择顶部根资源后，单击“Actions”下拉菜单并选择“Deploy API”。

[![API Gateway – Deploy](../Images/884c5a4d7335c763958ac951172e1096.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ufk6yO0q--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/aCA9GED.png)
...
[![API Gateway – Deploy](../Images/4f2473c7d28c1fb53132e78d8ca57d64.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--pls8c8qL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/HM4gBc6.png)

点击“部署”，您的 API 将被部署到 API Gateway！现在，只需捕获调用 URL 并保存它以供下一步使用！

[![API Gateway – Stage Editor](../Images/101c613afac5e3aa71acfad361a31415.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--4MI-omuI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/KSyp8gp.png)

快到了！🏎

## [](#11-specify-init-endpoint-in-chatjs)11。在 Chat.js 中指定 Init 端点
...
[![Chat.js](../Images/d91350bcabde734a9ea678ac6582e83a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--FlIe2Tix--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/Tr1Ti6S.png)

> *您的端点当前未受到 API 密钥的保护。如果您想要启用 API 密钥，可以在 API 网关内逐个路由地完成。*

答对了。🎲

## [](#12-set-the-webhook-reply-url)12。设置 Webhook 回复 URL
...
[![Stream Dashboard – Webhooks](../Images/7b715c577d991ae86de07fe87f51d6d7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--h47Yc79a--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/xZPDtAk.png)
...
## [](#13-fire-chat-up-locally)13。火本地聊起来！
...
[![Expo Debugger](../Images/c9d747d6ef6ea4700388d5468e1a8a56.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ExKzvgtD--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/uqGrdtm.png)

应用程序应该加载到 iOS 模拟器中，您应该会看到登录屏幕！

[![iOS – Login](../Images/69e7910d6e7f4ec29889b0f05806c721.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--fJYrpz-q--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/nhjDSZN.png)

键入您的姓名和电子邮件，然后单击底部的“与 Chuck 聊天”按钮。该应用程序将向服务器发出请求，并在流中检索您的应用程序提供的有效用户令牌。从这里开始，一切都是为了开心！

[![iOS – Chat](../Images/06f4ce74ddc60133ec2fa878e224203b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--02tql-g5--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/YbIN0Kb.png)

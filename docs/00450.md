...
> 原文:[https://dev . to/joaomarcusc/using-svelve-for-plone-add-ons-536h](https://dev.to/joaomarcusc/using-svelve-for-plone-add-ons-536h)
...
# [](#handson-using-svelte-inside-an-addon)动手:在一个附加组件内使用苗条
...
## [](#create-a-sample-addon-product)创建一个样品附加产品
...
## [](#add-the-initial-structure)添加初始结构
...
## [](#create-the-svelte-project)打造苗条项目
...
## [](#add-the-svelte-component-to-the-view)给视图添加苗条的组件

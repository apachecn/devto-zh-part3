...
> 原文:[https://dev.to/masonite/masonite-orm-orator-3bh0](https://dev.to/masonite/masonite-orm-orator-3bh0)
...
# [](#mysql-and-postgres)MySQL 和 Postgres
...
### [](#getting-the-first-record)获取第一条记录
...
### [](#updating-several-records)更新多条记录
...
# [](#creating-new-records)创建新记录

创造新记录也非常简单。通过简单地创建一个新的模型实例，我们可以创建新的记录。

### [](#creating-new-records-with-properties)创建带有属性的新记录
...
### [](#creating-new-records-with-raw-create-endraw-method)用`create`方法创造新记录

...
> 原文:[https://dev . to/hasura HQ/real time-chat-app-with-vue-and-hasura-202h](https://dev.to/hasurahq/realtime-chat-app-with-vue-and-hasura-202h)

所以在 VueConf 之前，我认为将我们的 React 实时聊天应用程序重写为 VueJS 是一个很好的主意，它具有登录、实时聊天收件箱、输入指示器、在线用户等功能

[![](../Images/0ff61075312cfdb45dac5286a49f0a8b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--4DwNscIt--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/cmilix7370rc3txufb48.png)
...
# [](#1-add-login-functionality-to-vue-router)1。为 Vue 路由器添加登录功能:
...
# [](#2-setup-apollo-client-with-subscriptions)2。用订阅设置 Apollo 客户端。
...
# [](#3-getting-online-users)3。获取在线用户
...
# [](#4-subscribing-to-messages)4。订阅消息
...
简单地说，就是这样。我用 VueJS 创建了这个应用程序，这是一次令人惊奇的经历，关于我在编写这个应用程序时是如何以及做了什么决定的更多信息，你可以在我的[github](https://github.com/vnovick/vue-realtime-chat)T2】或者在 Hasura 示例应用程序[存储库](https://github.com/hasura/graphql-engine/tree/master/community/sample-apps)中查看
...
> 原文:[https://dev.to/goyder/automatic-reporting-in-python-part-3-packaging-it-up-1185](https://dev.to/goyder/automatic-reporting-in-python---part-3-packaging-it-up-1185)
...
[![](../Images/5c20fb4f4b3f196cd4167f7ebf3a5096.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--FswGSC1Z--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/9nu22hxwy0qhyhh51bgp.png)
...
## [](#step-seven-improving-the-aesthetics)第七步——提高审美

对 HTML 页面有所了解的人可能知道接下来会发生什么:级联样式表，通常被称为 CSS。

### [](#taking-your-first-steps-down-a-path)迈出人生道路上的第一步
...
[![](../Images/4dff4fbcb2ef17eca0eeb3e8c6b73b23.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--tzYh59ax--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/qd69w9m656yttbcdtupa.png)

### [](#being-a-bit-more-mercenary)变得更加唯利是图
...
[![](../Images/0c869c8f43195ac954403e30c5c265e8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--JBUPBlJ8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/hiynq39nr7j4vu6yddc9.png)

但是我们注意到这里还有一些不太对的地方——首先，为什么页面(尤其是表格)总是占据整个窗口的宽度？为什么这个在手机上看起来不太对？

事实证明，仅仅添加一堆`.css`文件是不够的。我们需要确保我们的`.html`页面的布局符合`.css`页面的预期。

### [](#html-layouts)HTML 布局
...
### [](#proof-that-this-works)证明这行得通

运行`autoreporting.py`并检查报告——在全屏和[模拟移动屏幕](https://developers.google.com/web/tools/chrome-devtools/device-mode/)下尝试。

[![](../Images/aad6cd02ef61167e7585d87cbce45635.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--eg7DMKdR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/cjgumoiu4xixcf26st13.png)
...
## [](#step-eight-making-our-tables-interactive)第八步——让我们的桌子互动
...
[![](../Images/17ee805bd849e6322b0a8c73d807e43d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--a3ueuhNM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/1sssls51ujht3gjulihl.png)

### [](#implementing-datatables)实现数据表
...
#### [](#importing-the-relevant-files)导入相关文件
...
#### [](#adding-raw-id-endraw-tags-to-the-tables)给表格添加`id`标签
...
#### [](#calling-the-datatables-function)调用数据表函数
...
[![](../Images/a0fc503d4970306d6ef7b94e267cad58.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--6IRrqIDm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/djq67ud0lfhs6wxv0ao4.png)
...
## [](#step-nine-packaging-it-up)第九步——打包
...
[![](../Images/d07dba127b1d1eac64be616b8a1d3ba8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--767vByDW--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ma484b0jm9oxskzryoh7.png)

### [](#implementing-raw-argparse-endraw-)实施`argparse`
...
[![](../Images/909dc6f66fba96ee6e7c962a31fcd52e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--mlxNq1ox--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/gpweb7hcoobs1m3w7afl.png)
...
### [](#a-thankyou-and-a-call-to-action)一句感谢和一个行动号召

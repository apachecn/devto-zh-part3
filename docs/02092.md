...
> 原文:[https://dev . to/idered/host-story book-with-circle ci-and-github-deployments-4eoj](https://dev.to/idered/host-storybook-with-circleci-and-github-deployments-4eoj)
...
*   推送至存储库
*   CircleCI 构建被触发
*   [GitHub 部署](https://developer.github.com/v3/repos/deployments/)被创建![Pending Deployment](../Images/ba01f6843ef604ddcc5d0be5cdb1587f.png)
*   安装依赖项
*   构建故事书
*   将生成的文件保存为 CircleCI 工件
*   如果整个过程成功，添加成功部署状态![Success Deployment](../Images/d4e8faafc4628b1b10c185c418a18687.png)
*   如果整个过程不成功，添加错误部署状态
*   我们可以在[部署页面](https://github.com/Idered/storybook-circleci-github-deployments/deployments) ![](../Images/3c0eb222de3e01de3f6d80fafb09292b.png)上看到生成文件的链接
*   我们可以在相关的[拉取请求](https://github.com/Idered/storybook-circleci-github-deployments/pull/1) ![](../Images/33dfa723b864215b2affb91062344a6d.png)中看到生成文件的链接

## [](#setting-up-circleci)设置 CircleCI

转到 [CircleCI 仪表板](https://circleci.com/dashboard)并添加您的项目。开始构建过程-一开始会失败，但我们会在接下来的步骤中修复它。

### [](#create-circleci-config-file)创建 CircleCI 配置文件
...
### [](#configure-github-access-token)配置 GitHub 访问令牌

...
> 原文:[https://dev . to/trent yang/who-is-the-most-liked-on-dev to-analysis-of-top-500-post-2kg](https://dev.to/trentyang/who-is-the-most-liked-author-on-devto---analysis-of-top-500-posts-2kg)
...
[![drumroll](../Images/8de7b134b2d15612005de64c9bc60e3e.png)T2】](https://i.giphy.com/media/ogGmxeqA8L3sA/giphy.gif)

## [](#which-author-is-the-most-liked)最喜欢哪位作者？
...
## [](#which-author-gets-the-most-comments)哪位作者获得的评论最多？
...
## [](#which-tag-is-used-most-frequently)哪个标签使用频率最高？
...
[![lightbulb](../Images/78df7fbeeae5ee114435bb0c7ed20762.png)T2】](https://i.giphy.com/media/MJW59l6PiMfew/giphy.gif)
...
## [](#do-popular-posts-have-numbers-in-their-title)热门帖子标题里有数字吗？

在排名前 500 的帖子中，大约有 100 个在标题中有数字。文章标题中的数字和受欢迎程度之间似乎没有任何强有力的关联。

## [](#vim-vs-emacs)我是来对付 emacs 的吗？

500 强中有 6 #vim 和 0 #emacs 岗位。对于所有 vim 用户，我想说**我们是 dev.to 的冠军**！

[![we are the champion](../Images/f3ecc87309f5282a1eb4ff669018a9bb.png)T2】](https://i.giphy.com/media/3o7TKC2QtRON2JhUfS/giphy.gif)

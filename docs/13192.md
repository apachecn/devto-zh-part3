...
> 原文:[https://dev . to/lankydandev/asynchronous-RDBMS-access-with-spring-data-r2dbc-2811](https://dev.to/lankydandev/asynchronous-rdbms-access-with-spring-data-r2dbc-2811)
...
### [](#creating-a-spring-data-repository)创建 Spring 数据仓库
...
### [](#a-very-quick-look-at-the-entity)快速浏览实体
...
### [](#seeing-it-all-in-action)在行动中看到一切

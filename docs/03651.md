...
> 原文:[https://dev . to/lacolaco/network-aware-preloading-strategy-for-angular-lazy-loading-4 hae](https://dev.to/lacolaco/network-aware-preloading-strategy-for-angular-lazy-loading-4hae)

这篇文章解释了如何使*网络感知*预加载策略用于角度路由器的延迟加载。

无论用户的网络状况如何，它都可以通过延迟加载来改善用户体验。

[![](../Images/001550550a50c7aec296a8122689c4ee.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--BInkreHU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/t6o2d6hv9v3jjbtx5pkl.png)

# [](#what-is-preloading)什么是预压？
...
# [](#preloading-problem-cost-of-networking)预压问题:联网成本
...
# [](#using-network-information-api)使用网络信息 API
...
## ![GitHub logo](../Images/292a238c61c5611a7f4d07a21d9e8e0a.png) [拉科拉科](https://github.com/lacolaco) / [网络-信息-类型](https://github.com/lacolaco/network-information-types)
...
[![npm version](../Images/5d5e4fb15fdc7b4a9139cbec0e6347e4.png)T2】](https://badge.fury.io/js/network-information-types)
...
# [](#making-networkaware-preloadingstrategy)制定网络感知预加载策略
...
## [](#detecting-save-data-mode)检测“保存数据”模式
...
## [](#detecting-2g-connection)检测“2G”连接

...
> 原文：<https://dev.to/cheahengsoon/configure-security-for-data-infrastructure-5fc4>
...
6.  使用 Azure AD 身份连接到数据库![Alt text of image](img/425e3197e8833772b516de712a5622d0.png)
...
*   实现基于 SAS 的场景:
    *   前端代理服务
    *   SAS 提供商服务![Alt text of image](img/8499ef62dcfabe9fb16be7b3f3f83afd.png) ![Alt text of image](img/91510c447d9bfbe28e1f7710b2d3ea82.png)
...
*   授权:
    *   RBAC
    *   配置单元策略
*   数据安全:静态加密![Alt text of image](img/c3aaa4e8039b8acc7b86a761d06d8c81.png)
...
*   基于钥匙的访问控制:
    *   万能钥匙
    *   只读键![Alt text of image](img/a5976d2c3f143f77968c0eceeb052e0e.png)

...
> 原文:[https://dev . to/Christopher kade/building-a-CLI-with-yargs-ip8](https://dev.to/christopherkade/building-a-cli-with-yargs-ip8)
...
## [](#deploying-our-cli-to-npm)将我们的 CLI 部署到 NPM

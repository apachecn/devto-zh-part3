...
> 原文:[https://dev . to/ATA pas/my-machine-learning-journey-528n](https://dev.to/atapas/my-machine-learning-journey-so-far-528n)
...
# [](#the-new-approach)新方法

我采取了另一种学习方法。这个博客就是关于这段旅程的。

## 以我的速度完成一个课程

[![andewng.png](../Images/55f7b2aa90c0e4c4731762499749ed48.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Z-hTd1xM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn.hashnode.com/res/hashnode/image/upload/v1556436256816/20xTTyv2T.png)
...
## [](#stay-connected-to-know-ml)保持连接了解 ML

[![OCDevel.png](../Images/bc68491351db856fb95f8bf08cfe2a31.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---yarbOur--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn.hashnode.com/res/hashnode/image/upload/v1556436373552/VR4iCkA9f.png)
...
# [](#a-piece-of-motivation)一块动力

以上提到的都不仅仅是作为*一次性参考*。每当我有需要的时候，我都试着去查阅这些参考资料。

我的笔记本是我最大的动力😊😊😊。它经常被掸掉灰尘。我清洗它，阅读它，对我迄今为止的旅程感觉良好！
[![read.gif](../Images/1d6f5b0e0f2f4dc29125eff3346a9eff.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--5RMMLr4---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn.hashnode.com/res/hashnode/image/upload/v1556364304674/L2BryBdR_.gif)

# [](#programming-languages-and-tool)编程语言和工具

...
> 原文:[https://dev.to/shaikhul/hamcrest-让你的测试-断言-更多-声明-4mm](https://dev.to/shaikhul/hamcrest---make-your-test-assertion-more-declarative-4mme)
...
Hamcrest-php 可以使用[composer](https://packagist.org/?query=hamcrest-php)T2】安装
...
#### [](#quick-use-case-raw-assertthat-endraw-)快速用例- `assertThat`
...
#### [](#give-a-nice-optional-description)给出一个好听的可选描述
...
#### [](#add-a-decoratorsugar-raw-is-endraw-)添加装饰师/糖- `is`
...
#### [](#asserting-negation-raw-not-endraw-)断言否定- `not`

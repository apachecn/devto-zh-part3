...
> 原文:[https://dev . to/progress telerik/how-to-use-basic-react-hooks-for-state-and-effects-4bld](https://dev.to/progresstelerik/how-to-use-basic-react-hooks-for-state-and-effects-4bld)
...
## [](#so-what-are-hooks-how-do-we-use-them)那么什么是钩子，我们如何使用呢？
...
[![Functional vs Class](../Images/1b7471a03bdf8887b1005e98e3f45b14.png "State and Effect (Hooks)")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--G6SKtkKQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://d585tldpucybw.cloudfront.net/sfimages/default-source/default-album/reactstatehook-04n054a108f6e739248898fad28d2ed3da9c6.gif%3Fsfvrsn%3D137e3710_1)

### [](#sidebyside-example-of-raw-usestate-endraw-)并列`useState`的例子
...
### [](#sidebyside-example-of-raw-useeffect-endraw-)并列`useEffect`的例子
...
## [](#call-raw-usestate-endraw-and-raw-useeffect-endraw-as-much-as-you-want)想怎么叫`useState``useEffect`就怎么叫！
...
[![Functional vs Class](../Images/d75588d33b104334e889e89e2e9682ae.png "State and Effects (Hooks)")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--xNKjjeDM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://d585tldpucybw.cloudfront.net/sfimages/default-source/default-album/reactstatehook-06n07.gif%3Fsfvrsn%3D18e0cae0_1)
...
## [](#early-documentation-and-articles-on-hooks)早期文献和挂钩文章:
...
## [](#video-resources-on-hooks)视频资源上勾

...
> 原文:[https://dev . to/MK Baldwin/introduction-to-kot Lin-part-1-variables-types-and-functions-193k](https://dev.to/mkbaldwin/introduction-to-kotlin-part-1-variables-types-and-functions-193k)
...
[![Java + Kotlin = Heart](../Images/84a1f97d21f0767457c220cc5fe6c705.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--7LdGL5gc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://dev-to-uploads.s3.amazonaws.com/i/v2opraung3zfnwdmjkfu.png)

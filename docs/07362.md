...
[![DApp types](../Images/db6ef54f58b2af1763473c7c333f396a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9QT1u5bz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/tklg8diwkq3ns11nhzr1.png)

# [](#10-block)10 块

块由块标题中包含的几个信息组件组成。所有这些信息将汇总为整个块的散列值。因此，链中的每个块都是唯一的。

[![BlockHeader](../Images/d5ad0978834da3f0199ad44c01733bfd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--SERKz5l2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/xzq3knexuxjj846flvwm.png)
...
# [](#11-genesisblock)11 - GenesisBlock

genesisblock 就像普通的块一样。只不过 genesisblock 知道自己是块链中的第一个块。

# [](#12-kettenstruktur)12 链结构

块具有引用以前块散列值的预测散列值。此过程将对每个新附着的块执行。这样就形成了链结构。

[![blockchain](../Images/f8940023fbdd5f2fec4a2f8e9c0c48f3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--XulutPFf--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/t7j4hmxj9vooen2iisq8.png)
...
# [](#14-interplanetary-file-system-ipfs)14 -星际文件系统(IPFS)
...
# [](#17-privatekey-und-publickey)17 -私钥与公钥

...
> 原文:[https://dev . to/angular/building-an-AOT-friendly-dynamic-content-outlet-in angular-217k](https://dev.to/angular/building-an-aot-friendly-dynamic-content-outlet-inangular-217k)

[![](../Images/76710bf93c198bd0beba5390592aae1b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--1XO2U3LW--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://wesleygrimes.com/assets/post_headers/dynamic_content_outlet_header.png)

# [](#overview%E2%80%8A%E2%80%8Adynamic-content%C2%A0outlet)概述—动态内容出口
...
# [](#what-were-going-to%C2%A0do)我们要做什么
...
## [](#lets-build-our-dynamic-content%C2%A0outlet)让我们建立我们的动态内容出口

假设您有一个现有的 Angular 6+ CLI 生成的项目，让我们通过以下步骤来构建构成这个新的动态内容出口的必要部分。

### [](#generate-the-dynamic-content-outlet-module)生成动态内容出口模块
...
### [](#build-the-dynamic-content-outlet-registry)建立动态内容出口注册表
...
### [](#build-the-dynamic-content-outlet-error-component)构建动态内容出口错误组件
...
### [](#build-the-dynamic-content-outlet-service)构建动态内容出口服务
...
### [](#build-the-dynamic-content-outlet-component)构建动态内容出口组件
...
### [](#finish-wiring-up-parts-to-the-dynamic-content-outlet-module)完成零件到动态内容出口模块的接线
...
## [](#lets-use-our-new-dynamic-content%C2%A0outlet)让我们使用新的动态内容出口

唷！深呼吸，抓起一杯咖啡(法国新闻公平贸易有机暗烤)。艰苦的工作已经过去了。接下来，我们将介绍实际使用这个新模块的过程！

[![](../Images/187cb06eb3306e10cebdd5f77c26798e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--h1UqQVSE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2A8BhahXd-DWmGj_n-mhP-gA.jpeg)

对于您想要动态呈现的任何组件，您需要执行以下四个步骤。 ***这些步骤必须完全遵循*** *。*

### [](#1-prepare-your-module-for-dynamic-import)1。为动态导入准备模块
...
### [](#2-add-your-dynamic-components-to-the-registry)2。将动态组件添加到注册表中
...
#### [](#example-component-mapping)示例组件映射
...
### [](#3-add-your-dynamic-modules-to-the-lazymodules-array)3。将动态模块添加到 lazyModules 数组中
...
### [](#wire-up-the-dynamic-content-outlet%C2%A0module)连接动态内容出口模块
...
#### [](#example-of-addition-to-the-raw-imports-endraw-array)添加到`imports`数组的例子
...
## [](#realworld-complex-example)真实世界的复杂例子

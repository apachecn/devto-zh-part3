...
> 原文:[https://dev . to/ge shan/follow-these-logging-best-practices-to-get-the-out-of-the-most-the-application-level-logging slides-3p8j](https://dev.to/geshan/follow-these-logging-best-practices-to-get-the-most-out-of-application-level-loggingslides-3p8j)
...
[![geshan](../Images/f724cb1237dbfdd187cdbecb5a07b2f5.png)](/geshan) [## 登录应用程序的重要性，今天就开始登录吧
...
[![Why log from the application level](../Images/7680e765d4b8b45ca517ce5b1b711f7d.png) ](https://res.cloudinary.com/practicaldev/image/fetch/s--Z_9MuIXQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2560/1%2AzLX0WLL48iM8WTFBgD5n4A.jpeg) *为什么从应用层登录*

## [](#logging-best-practices-at-a-glace)在冰川上记录最佳实践

以下是日志记录的主要最佳实践:

### [](#1-log-information-optimally)1。最佳记录信息
...
### [](#4-write-logs-carefully-dont-hamper-performance)4。小心地写日志(不要影响性能)
...
### [](#5-use-the-right-tools-for-the-job)5。为工作使用正确的工具

...
> 原文:[https://dev . to/berniwittmann/handling-dialogs-with-vue-router-29ji](https://dev.to/berniwittmann/handling-dialogs-with-vue-router-29ji)
...
[![](../Images/1ec3302a51c43303e681b9796351f97e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--kMz3XVs9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ti1j95m95u9oafo4qbx3.png)

[![](../Images/938fa768b344f7fcaf2aefad6c8f9f8d.png)T2】](https://i.giphy.com/media/1M9fmo1WAFVK0/giphy.gif)

通过使用 vue router 处理对话框的可见性，我们可以通过导航到相应的 URL 来轻松切换它们。在我看来，这会产生一个更干净的代码库。那么我们该怎么做呢？

### [](#step-1-update-our-raw-emptyrouterview-endraw-component)步骤 1:更新我们的`EmptyRouterView`组件
...
### [](#step-2-create-a-component-for-our-dialog)第二步:为我们的对话框创建一个组件
...
### [](#step-3-update-the-route-config)第三步:更新路由配置

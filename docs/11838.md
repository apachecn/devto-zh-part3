...
> 原文:[https://dev . to/luch filip/making-git-commit-messages-useful-with-jira-Jenkins-and-scopes-5759](https://dev.to/luchfilip/making-git-commit-messages-useful-with-jira-jenkins-and-scopes-5759)

[![](../Images/79079dea11927624dda427a5e6251071.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Jtf1wsIv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/xj0ia55pg9pjdwsx7xp2.jpg)
...
## [](#the-commit-message-format)提交消息格式
...
#### [](#the-information-in-subject)主题中的信息
...
### [](#commit-message-examples)提交消息示例
...
## [](#taking-it-to-a-next-level)更上一层楼

...
> 原文:[https://dev . to/restore dev/building-my-personal-site-with go-and-tail wind CSS-5bhn](https://dev.to/restoreddev/building-my-personal-site-with-go-and-tailwindcss-5bhn)
...
## [](#backend-in-go-with-gin)后端在跟杜松子酒一起走
...
## [](#frontend-with-tailwindcss-simplemde-stimulus-and-prism)前端带尾翼 CSS、SimpleMDE、激励和棱镜

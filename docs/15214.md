...
> 原文:[https://dev.to/apium_hub/feature-flag-pattern-in-java-2og9](https://dev.to/apium_hub/feature-flag-pattern-in-java-2og9)
...
## [](#feature-flag-pattern-to-the-rescue)特色旗帜图案救驾！
...
这个服务只有管理控制台来创建特性，还有一个插件通过 rest 来公开它。为了简化示例，它配置为存储在内存中，没有任何安全性(不适用于生产环境 [![😜](../Images/c73bf606a2a3a219e922a14c9fc808c8.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--iNMHH3Bq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s.w.org/images/core/emoji/2.2.1/72x72/1f61c.png) )。
...
## [](#conclusion-feature-flag-pattern-in-java)结论:java 中的特征标志模式
...
## [](#bibliography-feature-flag-pattern-in-java)参考书目:java 中的特性标志模式

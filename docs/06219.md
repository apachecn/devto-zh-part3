...
> 原文:[https://dev . to/bnevilleoneill/interfaces-in-typescript-what-them-and-how-do-we-use-them-PPO](https://dev.to/bnevilleoneill/interfaces-in-typescript-what-are-they-and-how-do-we-use-them-ppo)

[![](../Images/0a563e1c9b2ef3a2b09671718b328dcb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--6CefJWua--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AvK1lTdXqCjv7ob_j0TePLQ.png)
...
### [](#how-to-use-an-interface)如何使用一个接口
...
### [](#how-to-define-optional-properties-in-interfaces)如何定义界面中的可选属性
...
### [](#readonly-properties-in-interfaces)界面中的只读属性
...
### [](#indexable-properties-in-interfaces)界面中的可索引属性
...
### [](#how-to-define-function-types-in-interfaces)如何在接口中定义函数类型
...
### [](#how-to-use-interfaces-with-classes)如何使用类的接口
...
### [](#different-types-of-variables-in-a-class)一个类中不同类型的变量
...
### [](#how-are-type-aliases-different-from-interfaces)类型别名和接口有什么不同？
...
### [](#hybrid-types-in-interfaces)接口中的混合类型
...
### [](#how-to-use-generics-in-interfaces)如何在接口中使用泛型
...
[![](../Images/639ac44072ff7eb38e553d8d487b6fa3.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--u6f_NhTx--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/384/0%2AJkU1Rz6RwShucBQt.png) 
...
### [](#how-to-use-interfaces-with-react)如何与 React 一起使用接口
...
[https://stackblitz.com/edit/react-ts-pokemon?embed=1&view=both&](https://stackblitz.com/edit/react-ts-pokemon?embed=1&view=both&)T2】

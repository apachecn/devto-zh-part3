...
> 原文:[https://dev . to/expecho/reporting-metrics-using-net-core-event source-and-event counter-23dn](https://dev.to/expecho/reporting-metrics-using-net-core-eventsource-and-eventcounter-23dn)
...
# [](#introducing-eventcounters)介绍事件计数器
...
## ![GitHub logo](../Images/a73f630113876d78cff79f59c2125b24.png) [ Expecho ](https://github.com/Expecho) / [博客](https://github.com/Expecho/Blog)
...
# [![GitHub logo](../Images/a73f630113876d78cff79f59c2125b24.png) 增加通过日志记录报告应用指标的支持 #708](https://github.com/aspnet/Logging/issues/708) 

[![anurse avatar](../Images/8f078a30b7107c205cbe2ad74e32becd.png)](https://github.com/anurse) **[anurse](https://github.com/anurse)** posted on [<time datetime="2017-09-19T21:09:47Z">Sep 19, 2017</time>](https://github.com/aspnet/Logging/issues/708)
...
### [](#why-add-to-ilogger)为什么加到`ILogger`？
...
### [](#loggermetricsextensions)`LoggerMetricsExtensions`
...
### [](#metricvalueextensions)`MetricValueExtensions`
...
## [](#scopes-and-property-bags)范围和属性包
...
## [](#impact-on-existing-providers)对现有供应商的影响

...
> 原文:[https://dev . to/azure/get-started-with-the-new-kotlin-azure-functions-archetype-and-intellij-idea-33h](https://dev.to/azure/get-started-with-the-new-kotlin-azure-functions-archetype-and-intellij-idea-33h)

# [](#get-started-with-the-new-kotlin-azure-functions-archetype-and-intellij-idea)开始使用新的 Kotlin Azure 函数原型和 IntelliJ 理念
...
## [](#3-create-a-kotlin-azure-function-project)3。创建一个 Kotlin Azure 函数项目
...
6.  确认 Maven 项目设置，选择**下一步**。
    T3![Maven summary](../Images/3f669e0975abae8fa0d31dd85faea9e9.png)T5】

7.  确认项目名称和位置，选择**完成**。
    [![create new kotlin project](../Images/d95db15cd707488e995049b505b4e98f.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--Xzip6dgI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gloveboxes/Create-a-Kotlin-Azure-Function-with-IntelliJ/master/resources/create-new-project-confirmation.png) 
    项目结构将被创建。
...
## [](#4-enable-autoimport)4。启用自动导入

[![create new kotlin project](../Images/853c872c60c3cf532ab123dbc26c2768.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--w62uKvhC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gloveboxes/Create-a-Kotlin-Azure-Function-with-IntelliJ/master/resources/create-new-project-enable-auto-import.png)

## [](#5-azure-configuration)5。天蓝色配置
...
[![create new kotlin project](../Images/c57fef3ab680f7307b891f4ab1c2dbbd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--y-aWlj8R--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gloveboxes/Create-a-Kotlin-Azure-Function-with-IntelliJ/master/resources/create-new-project-skelton.png)

## [](#6-open-the-default-http-trigger)6。打开默认的 Http 触发器

Azure Functions Maven 原型将创建一个示例 Http 触发器。您将通过导航 **src** 项目目录找到它。

[![create new kotlin project](../Images/bf44f795f27b4abc1828b427c364e560.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--_GqAW48w--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gloveboxes/Create-a-Kotlin-Azure-Function-with-IntelliJ/master/resources/project-default-http-trigger.png)

## [](#7-clean-and-package-the-project)7。清理并打包项目

从 Maven 弹出选项卡中，展开**生命周期**，然后运行**清理**，接着运行**打包**命令。这将构建 Kotlin 项目。

[![](../Images/f5bcf14a9a7c439f9c9017496184f159.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--J2q2UFYf--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gloveboxes/Create-a-Kotlin-Azure-Function-with-IntelliJ/master/resources/project-clean-package.png)

## [](#8-execute-azure-functions-run)8。执行 Azure 功能运行
...
[![create new kotlin project](../Images/c72f9f6eee788493c04ec5c9c131daa6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--LMCWkqa0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gloveboxes/Create-a-Kotlin-Azure-Function-with-IntelliJ/master/resources/project-test-http-trigger.png)
...
## [](#10-stop-the-function)10。停止功能

单击停止图标停止运行该功能。

[![create new kotlin project](../Images/5600177d73e19da101bc4ef8ffedee92.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--QIwDMe4q--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gloveboxes/Create-a-Kotlin-Azure-Function-with-IntelliJ/master/resources/project-azure-functions-stop.png)

## [](#11-enable-debugging)11。启用调试

鼠标右键点击 **azure-functions:运行** Maven 原型并选择**创建‘手套箱-功能’...**

[![create new kotlin project](../Images/733554c0672f63b9a09f59bf68d1d439.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--BU87-eH_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gloveboxes/Create-a-Kotlin-Azure-Function-with-IntelliJ/master/resources/project-enable-debug-azure-function-maven-debug.png)

## [](#12-create-rundebug-configuration)12。创建运行/调试配置

1.  重命名配置以突出显示**包**将在 azure-functions:run 之前运行。
2.  将 **-DenableDebug** 添加到命令行。

[![create new kotlin project](../Images/ff3ff30b298f58ad832b982ae69928bd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--m6ziYrH3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gloveboxes/Create-a-Kotlin-Azure-Function-with-IntelliJ/master/resources/project-enable-debug-azure-function-maven-debug-configure.png)

添加**包**

[![](../Images/fe0528acd8f9b5e19401e68b255f4a4f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9T_55cbS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gloveboxes/Create-a-Kotlin-Azure-Function-with-IntelliJ/master/resources/project-run-edit-configurations-add-package.png)

点击**确定**。

[![](../Images/85e1fd4f7b7d0cfd20055ba22a5566c3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--jnxjQWtl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gloveboxes/Create-a-Kotlin-Azure-Function-with-IntelliJ/master/resources/project-run-edit-configurations-completed.png)

点击**确定**

## [](#13-enable-jvm-debugger-attach)13。启用 JVM 调试器附加

从**运行**菜单，选择**编辑配置**

[![create new kotlin project](../Images/98be3410f751410c8fec640827cb9b63.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--uRE9g0Pt--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gloveboxes/Create-a-Kotlin-Azure-Function-with-IntelliJ/master/resources/project-run-edit-configurations.png)

## [](#14-add-new-configuration)14。添加新配置

点击 **+** 符号，然后选择**遥控**。

[![create new kotlin project](../Images/70ce8aa9f5cb65b0289d03b2ab288202.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--khc0Nvds--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gloveboxes/Create-a-Kotlin-Azure-Function-with-IntelliJ/master/resources/project-run-edit-configurations-add-remote-config.png)

## [](#15-name-the-new-configuration)15。命名新配置

在这种情况下，该配置被命名为**附加调试器**

[![create new kotlin project](../Images/41f17a39b8cb684a847b2fd040ce8e9e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--XJz7oJOV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gloveboxes/Create-a-Kotlin-Azure-Function-with-IntelliJ/master/resources/project-run-edit-configurations-add-remote-attach-debugger.png)

点击**确定**

## [](#16-set-a-breakpoint-in-the-kotlin-azure-function-source)16。在 Kotlin Azure 函数源码中设置断点

[![create new kotlin project](../Images/e95d9f81ff643b5a965808aa948ed1bc.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--5z48qMTE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gloveboxes/Create-a-Kotlin-Azure-Function-with-IntelliJ/master/resources/project-debug-set-breakpoint.png)

## [](#17-run-debugger-enabled-configuration)17。运行调试器启用配置

从**运行/调试配置选择器**中选择 Maven azure-functions:运行配置。然后单击绿色的开始图标或按 Shift+F10。

[![create new kotlin project](../Images/796ed61bb4f64fa0d163fe42ff0c79fb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--P6MsDK1y--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gloveboxes/Create-a-Kotlin-Azure-Function-with-IntelliJ/master/resources/project-debug-run-debug-enabled-maven.png)

## [](#18-attach-the-debugger)18。附上调试器

从**运行/调试配置选择器**中选择**附加调试器**配置，点击绿色启动调试器图标或按 Shift+F9。

[![create new kotlin project](../Images/7b5a736c09f5329bf527a99453533e43.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--wtjH6l2z--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gloveboxes/Create-a-Kotlin-Azure-Function-with-IntelliJ/master/resources/project-debug-debugger-attached.png)

## [](#19-initiate-the-http-trigger-in-debug-mode)19。在调试模式下启动 Http 触发器

1.  选择**运行**选项卡。

2.  点击[http://localhost:7071/API/Http Trigger-Kotlin](http://localhost:7071/api/HttpTrigger-Kotlin)链接，启动 Http 触发器。

[![create new kotlin project](../Images/447284c8c7b46267ae5aad49b9541189.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ftOcQiiM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gloveboxes/Create-a-Kotlin-Azure-Function-with-IntelliJ/master/resources/project-debug-switch-to-run.png)

## [](#20-step-through-the-http-trigger-azure-function-with-the-debugger)20。用调试器单步调试 Http 触发器 Azure 函数

使用调试器控件，逐句通过 Azure 函数代码。

[![kotlin debugging](../Images/fc354dd43790fdc525faea8512a83069.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--xFrrNmq0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gloveboxes/Create-a-Kotlin-Azure-Function-with-IntelliJ/master/resources/project-debug-step-through-code.png)

## [](#21-stop-the-debugger-and-azure-function)21。停止调试器和 Azure 功能

单击停止图标分离调试器并停止 Azure 功能

[![create new kotlin project](../Images/3be9740d0ffe6d6425be0d3ca4e584e2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--pVcoAwfp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gloveboxes/Create-a-Kotlin-Azure-Function-with-IntelliJ/master/resources/project-debugger-stop.png)

## [](#22-adding-new-azure-function-triggers)22。添加新的 Azure 函数触发器
...
[![Azure functions add](../Images/69e3dbd6b870872e09846bdc7b689a90.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--JdGW5k3J--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gloveboxes/Create-a-Kotlin-Azure-Function-with-IntelliJ/master/resources/azure-function-add.png)

## [](#23-deploying-kotlin-azure-functions-to-azure)23。将 Kotlin Azure 功能部署到 Azure
...
[![Azure functions deploy](../Images/5ca374975fb44178dbaf3578b8903eb4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--uY26gKYF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gloveboxes/Create-a-Kotlin-Azure-Function-with-IntelliJ/master/resources/azure-function-deploy.png)

## [](#congratulations)祝贺你

你已经创建了你的第一个基于 Kotlin 的 Azure 函数

[![Congratulations](../Images/4c5a7a0b44c783f55e72e8cc7ef93b24.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---Ky_kICb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gloveboxes/Create-a-Kotlin-Azure-Function-with-IntelliJ/master/resources/congratulations.jpg)
...
[![Building a Serverless IoT Solution with Kotlin Azure Functions and SignalR](../Images/ca15d3e63d92d9ee2e73a24b3d3d44c8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--QEScOovI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gloveboxes/Create-a-Kotlin-Azure-Function-with-IntelliJ/master/resources/iot-solution-architecture.png)
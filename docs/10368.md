...
> 原文:[https://dev.to/zellwk/my-css-reset-jbp](https://dev.to/zellwk/my-css-reset--jbp)
...
## [](#removing-margins-and-paddings)删除页边距和填充

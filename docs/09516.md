...
> 原文:[https://dev . to/rsanchezp/double-equals-vs-triple-equals-in-JavaScript-34fp](https://dev.to/rsanchezp/double-equals-vs-triple-equals-in-javascript-34fp)

与其他语言不同，JavaScript 有两种方法来确定等式。对于像我这样来自 Java 或 C++之类的类型化语言的人来说，这可能相当令人困惑。我的目标是通过定义和例子，简明扼要地解释==和===这两个词。

### [](#tripe-equals-strict-equality)爆肚等于(严格相等)
...
### [](#double-equals-loose-equality)双倍相等(宽松相等)

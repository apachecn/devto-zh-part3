...
> 原文:[https://dev . to/piczmar _ 0/server less-git-repo-history-analysis-4k jp](https://dev.to/piczmar_0/serverless-git-repo-history-analysis-4kjp)
...
[![Webhook configuration](../Images/1866a9bce45a7e19be51129e59391051.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--p5lW4fYL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ol0ies0oj8cccvqyqk0e.png)

配置需要的是一个端点，我们将使用无服务器框架和 AWS API Gateway + Lambda 开发，以及一个名为“Secret”的随机令牌

[![Webhook creation](../Images/3755cc47104e485eb0cfded65b4f68b3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--kFuGskzN--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/npsg378mhltslbgtii9d.png)

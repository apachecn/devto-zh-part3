...
> 原文:[https://dev . to/areknawo/a-different-approach-to-CSS-in-js-58ol](https://dev.to/areknawo/a-different-approach-to-css-in-js-58ol)
...
那么，**你觉得**的字体怎么样？你喜欢这种有点不同的 CSS-in-JS 方法吗？请在**下面的评论区**让我知道。此外，如果你喜欢这篇文章，可以考虑给**留下一个反应**、**评论**或**对未来帖子的建议**。更多最新内容，在 Twitter 上**关注我**[](http://twitter.com/areknawo)**[**我的脸书页面**](http://facebook.com/areknawoblog) 或通过 [**我的个人博客**](https://areknawo.com) 。我希望你喜欢这个，并祝你今天过得愉快！**
...
> 原文:[https://dev . to/vukhanhtruong/things-to-remember-when-reinstall-Ubuntu-5c 91](https://dev.to/vukhanhtruong/things-to-remember-when-reinstall-ubuntu-5c91)

这只是我在机器上重装软件时的清单。希望这对你有用。

## [](#backup-the-essential-things)备份必不可少的东西。
...
## [](#after-finishing-installing-ubuntu)安装完 Ubuntu 后
...
##### [](#thats-it-if-you-have-anything-to-share-feel-free-to-leave-your-comment)就是这样。如果你有什么要分享的，请随时留下你的评论。
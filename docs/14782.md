...
> 原文:[https://dev . to/attacomsian/-7-ways-to-make-http-requests-in-nodejs-2 ljm](https://dev.to/attacomsian/-7-ways-to-make-http-requests-in-nodejs-2ljm)
...
## [](#1-http-standard-http-library)1。HTTP —标准 HTTP 库

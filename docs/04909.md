...
> 原文:[https://dev.to/mlennox/ast-selectors-rule-286i](https://dev.to/mlennox/ast-selectors-rule-286i)

我的上一篇关于抽象语法树的文章对语法树以及如何操作它们做了一个快速但相对宽泛的概述。

第二篇文章将向您展示如何使用抽象语法树的基础知识，通过添加仅使用 AST 选择器实现的简单 ESlint 规则来实施代码标准，不需要使用 javascript！

## [](#rule-norestrictedsyntax)规则-‘无-限制-语法’
...
[![abstract syntax tree of variable declaration showing attribute kind is var](../Images/626a07e7d7b26481563dcc90226a88e0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--7fDfDJxE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/j9fbjahqwcfg73c7rd5n.png)
...
[![](../Images/9a0bec06b299405739d664653afdbcf3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--G7-yTgN3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/om6gj1zt7o4unfhfavjd.png)
...
[![](../Images/3d0ac6dd732a93f5da77d1258bc5ff15.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--U61vCSgV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8zbfspimejvf1wclakt5.png)

更复杂的例子呢？

## [](#react-jsx-internationalisation-formattedmessage)反应 JSX 国际化—格式信息
...
### [](#ast-explorer-jsx-problem)AST 探险家+ JSX =问题

曾经有用的 [AST 浏览器](https://astexplorer.net/)不处理`JSX`，所以我们需要使用不同的方法来可视化抽象语法树。

#### [](#babel-parser-with-jsx-plugin)带有 jsx 插件的巴别塔解析器
...
### [](#visualising-the-tree-structure)可视化树形结构
...
[![](../Images/171c6feb627b188bd1db0a4c5cb82139.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--m8NPXKQc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/9ixzbmw8wnjdc8wis59n.png)
...
#### [](#constructing-the-selector-approach-1-jsxelement-has-no-child-elements)构造选择器-方法 1 : JSXElement 没有子元素
...
#### [](#constructing-the-selector-approach-2-jsxopeningelement-is-selfclosing)构造选择器-方法 2 : JSXOpeningElement 是自关闭的

...
> 原文:[https://dev . to/Dan quak/caching-spas-for-SEO-with-lamdbaedge-24ba](https://dev.to/danquack/caching-spas-for-seo-with-lamdbaedge-24ba)

从构思开始，Tournamentmgr.com 的搜索引擎优化表现就一直很差。当分析谷歌抓取的页面数量时，平均每天不到 40 个。

[![Pre implementation](../Images/bddf35c4786eccec9ed7093df182b2f2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--KmCAA024--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/pdhidd0ksuo4hoswqlgi.png)

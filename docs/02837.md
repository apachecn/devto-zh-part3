...
> 原文:[https://dev . to/edezekiel/looping-using-es6-syntax-JavaScript-4 B1](https://dev.to/edezekiel/looping-using-es6-syntax-javascript-4b1)

[![](../Images/833badce589c054db6bf67c731b8e3e1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--DdMcrsMP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AXCvcHF70YhwT6wReeG1_MA.jpeg)

### [](#javascript-loops-using-forof-and-forin)JavaScript 循环使用 for...的和为的...英寸
...
### [](#looping-through-elements-in-a-string-using-forof)使用 for 循环遍历字符串中的元素...关于
...
### [](#are-forof-and-forin-interchangeable)均为...的和为的...可互换的？
 ...
 **### [](#what-is-an-iterable-object)什么是可迭代对象？
...
### [](#what-are-enumerable-properties-of-an-object)什么是对象的可枚举属性？

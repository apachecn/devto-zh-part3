...
> 原文:[https://dev . to/datre eio/10-insannely-useful-git-commands-you-wish-existing-and-their-alternatives-8e 6](https://dev.to/datreeio/10-insanely-useful-git-commands-you-wish-existed-and-their-alternatives-8e6)
...
### [](#how-to-create-a-branch-with-git-checkout)如何用 git checkout 创建分支:
...
### [](#how-to-overwrite-local-changes-with-git-pull)如何用 git pull 覆盖本地更改:
...
### [](#how-to-remove-untracked-files-and-dirs)如何删除未被跟踪的文件和目录:
...
### [](#how-to-unstage-files-from-index)如何从索引中卸载文件:
...
### [](#how-to-abort-cancel-a-merge-and-maintain-all-committed-history)如何中止(取消)合并并维护所有已提交的历史:
...
### [](#how-to-remove-files-from-commit)如何从提交中删除文件:
...
### [](#how-to-uncommit-undo-the-last-commit)如何取消提交(撤销)上一次提交:
...
### [](#how-to-get-the-diff-between-two-branches)如何得到两个分支之间的差异:
...
### [](#how-to-delete-tag-by-removing-it-from-branch)如何通过从分支中删除标签来删除标签:
...
### [](#how-to-rename-branch-name-after-it-was-created)分支机构名称创建后如何重命名:

...
> 原文:[https://dev . to/jamiemccarville/how-to-open-files-and-file-explorer-from-the-command-line-windows-17a 7](https://dev.to/jamiemccarville/how-to-open-files-and-file-explorer-from-the-command-line---windows--17a7)

## [](#terminal-upgrade)终端升级
...
## [](#opening-files-and-file-explorer)打开文件和文件浏览器
...
### [](#open-a-file-explorer)打开文件浏览器

[![](../Images/61e12072b41bc64be48d518cde74cddb.png)T2】](https://cl.ly/ff63b5fe222e)

### [](#open-a-file-explorer-in-current-directory)打开当前目录下的文件浏览器

[![](../Images/47d8f76643a2b170ca6ebbef272676e4.png)T2】](https://cl.ly/0ddd8e6db00e)

### [](#open-a-file-with-the-default-program)用默认程序打开文件

[![](../Images/3876370255b1350d8ed811e8ec521c7b.png)T2】](https://cl.ly/944244a932e0)

### [](#open-a-file-with-vscode)用 VSCode 打开文件

*命令不同但功能相似
[![](../Images/18e6af90e400b0cde90491010f14ec29.png)](https://cl.ly/4e27b1347331)

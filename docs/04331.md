...
> 原文:[https://dev . to/nitishk 72/understanding-streams-in-flutter-dart-2pb 8](https://dev.to/nitishk72/understanding-streams-in-flutter-dart-2pb8)

# [](#understanding-streams-in-flutter-dart)了解溪流在颤动(飞镖)
...
> # [](#there-are-two-kinds-of-streams-)There are two kinds of flows:
...
> # [](#lets-understand-this-with-examples)We use examples to understand this
...
[![](../Images/d93d4170fbad0e872c9f667b38e24b39.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9U5dZ0J6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn-images-1.medium.com/max/2000/1%2ApJDmkYh_6i6EVYzMl6wkDA.gif)
...
## [](#here-is-the-final-code)这里是最终代码。
...
2.  流生成器
    ...
    > # [](#if-you-have-any-doubts-about-the-stream-you-can-ask-i-would-love-to-answer-your-question)If you have any questions about this stream, you can ask. I'm happy to answer your questions.

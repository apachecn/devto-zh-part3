...
> 原文:[https://dev . to/iyanuashiri/getting-started-with-path lib-33n 4](https://dev.to/iyanuashiri/getting-started-with-pathlib-33n4)

## [](#introduction)简介

本教程将指导你如何使用 Pathlib 模块来处理文件系统路径，好处，并理解它所解决的问题，因为 Python 标准库已经包含了`os.path.`

## [](#how-is-it-better-than-ospath)怎么比 os.path 好
...
## [](#using-path-classmethods)使用路径类方法
...
## [](#opening-a-file-in-a-path)打开路径中的文件

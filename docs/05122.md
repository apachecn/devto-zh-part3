...
> 原文:[https://dev . to/lex lohr/unit-testing-with-jest-typescript-hands-on-session-345 o](https://dev.to/lexlohr/unit-testing-with-jest-typescript-hands-on-session-345o)

# [](#or-how-to-prepare-a-handson-session)<small>或者:如何准备一次实践课</small>
...
## [](#initial-thoughts-and-preparations)最初的想法和准备
...
## [](#running-into-problems)遇到问题

正如你可能想象的那样，它并不像我想象的那样顺利。让我们来看看突然出现的问题。

### [](#the-first-task)第一个任务

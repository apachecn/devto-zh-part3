...
> 原文:[https://dev . to/flicher/laravel-rest-API-passport-authentic ation-for-ionic-app-3370](https://dev.to/flicher/laravel-rest-api-passport-authentication-for-ionic-app-3370)

[![Laravel Rest API Passport Authentication for Ionic App](../Images/451539a23559526708661b64c94f39bf.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9C90pa-I--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.flicher.net/wp-content/uploads/2019/02/laravel-ionic-auth-1280x640.png)
...
![laravel-auth-database](../Images/78ba91ee99695536d96df7189bc5e11a.png)
...
[![laravel-ionic-register](../Images/3df768e4fd01146f1fb06b3a96c898ee.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--eYN3K4hK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.flicher.net/wp-content/uploads/2019/02/laravel-ionic-register-1024x464.png)

现在我点击注册按钮。如果用户成功创建，我会收到我之前设置为响应的消息。如果我现在检查我的数据库，我的数据库中应该有新用户。

[![](../Images/9acd1d0917f3814001e3ffcab90e5add.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--eSpFLtFR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.flicher.net/wp-content/uploads/2019/02/laravel-auth-users-1024x128.png)
...
[![laravel-ionic-login](../Images/892efd62f32f41b9f53c238465bce65d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9nElMtEb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.flicher.net/wp-content/uploads/2019/02/laravel-ionic-login-1024x464.png)

正如你所看到的，当我尝试登录时，我得到了令牌。我可以将这个令牌存储在手机或网络浏览器的本地存储器中。我们将使用这个令牌来获取所有受 API 认证中间件保护的用户数据。

现在这个令牌也存储在 **oauth_access_tokens** 表中。

[![](../Images/b0567a20ead99be176153406af04a90e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--L0T9Ka1V--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.flicher.net/wp-content/uploads/2019/02/laravel-auth-token-1024x131.png)
...
[![laravel-ionic-user](../Images/6c7cf692ce3e0664cde785645cf2b272.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8iHRchUa--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.flicher.net/wp-content/uploads/2019/02/laravel-ionic-user-1024x461.png)

正如您所看到的，当我向 http://localhost/API/auth/user 发送 GET 请求时，使用了我之前获得的授权头作为令牌。我正在从数据库中获取用户的详细信息。

[![laravel-ionic-headers](../Images/9d7ca571ff6d82786d210f87aa85c9ce.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--oQG89EM1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.flicher.net/wp-content/uploads/2019/02/laravel-ionic-headers-1024x461.png)
...
[![laravel-ionic-logout](../Images/8c514e67febcea39a62ce7d88c7ce795.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--mmMYzoaM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.flicher.net/wp-content/uploads/2019/02/laravel-ionic-logout-1024x461.png)

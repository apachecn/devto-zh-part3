...
> 原文:[https://dev . to/app signal/fibers-and-enumerators-in-ruby-turning-blocks-inside-out-2d1a](https://dev.to/appsignal/fibers-and-enumerators-in-ruby-turning-blocks-inside-out-2d1a)
...
## [](#suspending-blocks-and-chained-iteration)暂停块和链式迭代
...
## [](#turning-blocks-inside-out)将积木翻转过来
...
## [](#controlling-data-emission-rates)控制数据发射率

...
> 原文:[https://dev . to/bgord/simplify-repetitive-jest-test-cases-with-test-each-310m](https://dev.to/bgord/simplify-repetitive-jest-test-cases-with-test-each-310m)

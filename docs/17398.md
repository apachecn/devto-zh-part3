...
> 原文:[https://dev . to/jalerson/automating-code-checks-with-over commit-1c C3](https://dev.to/jalerson/automating-code-checks-with-overcommit-1cc3)
...
# [](#recommended-builtin-hooks)推荐内置挂钩

本节描述的挂钩是我目前正在使用和推荐的。你也可以在钩子标题的括号中找到钩子在哪个动作中被执行。

## [](#rubocop-precommit)[RuboCop](https://docs.rubocop.org/) (预提交)
...
## [](#bundleaudit-precommit)[联邦审计](https://github.com/rubysec/bundler-audit)(预提交)
...
## [](#bundlecheck-precommit)[联邦检查](https://github.com/brigade/overcommit/blob/master/lib/overcommit/hook/pre_commit/bundle_check.rb)(预提交)
...
## [](#forbiddenbranches-precommit-and-prepush)[禁止分支](https://github.com/brigade/overcommit/blob/master/lib/overcommit/hook/pre_commit/forbidden_branches.rb)(预提交和预推送)
...
## [](#fasterer-precommit)[更快](https://github.com/DamirSvrtan/fasterer)(预提交)
...
## [](#customscript-precommit)自定义脚本(预提交)
...
## [](#bundleinstall-postcheckout-postmerge-and-postrewrite)[BundleInstall](https://github.com/brigade/overcommit/blob/master/lib/overcommit/hook/post_checkout/bundle_install.rb) (后结帐、后合并和后重写)
...
# [](#other-probably-useful-builtin-hooks)其他(大概)有用的内置钩子

...
> 原文:[https://dev . to/eojthebrave/read write-JSON-files-with-nodejs-58e 4](https://dev.to/eojthebrave/readwrite-json-files-with-nodejs-58e4)

# [](#readwrite-json-files-with-nodejs)用 NodeJS 读/写 JSON 文件

[![Photo by Patrick Tomasso on Unsplash](../Images/c6a522e5d29b9cf87d300e477c4ecbb6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ztwMtNzI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://d2mxuefqeaa7sj.cloudfront.net/s_792F4E89A8BA29B00D0171E7988A150253BE3C8514EFBBF8C15D90EEE7BDE9AE_1539096615415_patrick-tomasso-71909-unsplash.jpg)
...
## [](#work-with-files-with-raw-fs-endraw-)用`fs`处理文件
...
## [](#writing-to-a-file-with-raw-fswritefile-endraw-)用`fs.writeFile`写入文件

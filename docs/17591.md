...
> 原文:[https://dev . to/an war _ nairi/using-API-first-and-TDD-for-your-next-library-49 C2](https://dev.to/anwar_nairi/using-api-first-and-tdd-for-your-next-library-49c2)

我使用这种技术来帮助我创建更多相关的单元测试，我想与您分享它。

如果 TDD 对你来说听起来不熟悉，请快速查看这篇文章:

[![eljayadobe](../Images/21260f63a131a3a7fa0a4c50f207d01b.png)](/eljayadobe) [## TDD 测试
...
# [](#api-first-to-the-rescue)API 第一个出手相救
...
# [](#next-level-coverage-amp-mutations-testing)下一级:覆盖率&突变检测

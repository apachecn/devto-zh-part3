...
> 原文:[https://dev . to/santypk 4/防弹-节点-js-项目-架构-4epf](https://dev.to/santypk4/bulletproof-node-js-project-architecture-4epf)
...
# [](#3-layer-architecture)3 层架构🥪

这个想法是使用**关注点分离原则**将业务逻辑从 node.js API 路由中移走。

[![3 layer pattern](../Images/4391a8d2e05a465c771ab2d1533b738c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--NBWarb6c--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8ujhfk47a3ciluri0wfx.png)

因为有一天，您会希望在 CLI 工具上使用您的业务逻辑，或者在一个重复的任务中不走远。

并从 node.js 服务器对自身进行 API 调用，这不是一个好主意...

[![3 layer pattern for node.js REST API](../Images/c47e8ea59874147b1731bbbb76069f82.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8tp11HUq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/9u6xqmp6yi7exa33th0e.png)

## [](#dont-put-your-business-logic-inside-the-controllers)☠️不要把你的商业逻辑放在控制器里面！！☠️
...
# [](#use-a-pubsub-layer-too)使用 Pub/Sub 层太🎙️
...
## [](#using-dependency-injection-with-expressjs-in-nodejs)在 Node.js 中使用 Express.js 的依赖注入
...
# [](#cron-jobs-and-recurring-task)Cron 作业和周期性任务⚡
...
# [](#configurations-and-secrets)配置和秘密🤫
...
# [](#see-the-example-repository-here)[参见此处的范例库](https://github.com/santiq/bulletproof-nodejs)
...
[![santypk4 image](../Images/3da502abc622980763f568f315d67060.png)](/santypk4) [## 🛑你不需要 passport . js-node . js 认证指南✌️
...
### [](#dont-forget-to-visit-my-blog-to-get-more-awesome-posts-like-this-softwareontheroadcom)别忘了访问我的博客，获得更多类似这样的精彩帖子【softwareontheroad.com
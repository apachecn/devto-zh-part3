...
> 原文:[https://dev . to/canderson 93/on-the-edge-finding-and-fixing-cross-browser-issues-1g8c](https://dev.to/canderson93/on-the-edge-finding-and-fixing-cross-browser-issues-1g8c)
...
### [](#the-functionality-doesnt-exist)该功能不存在
...
### [](#the-functionality-is-inconsistent)功能不一致

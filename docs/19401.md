...
> 原文:[https://dev . to/contentful/a-loosely-coupled-approach-to-creating-mailchimp-campaigns-with-contentful-web hooks-18ne](https://dev.to/contentful/a-loosely-coupled-approach-to-creating-mailchimp-campaigns-with-contentful-webhooks-18ne)

[![Creating MailChimp campaigns with Contentful webhooks](../Images/ad96830f2bc1e780b14337c540cac135.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--XbXxLJnw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://images.ctfassets.net/fo9twyrwpveg/3sFayiWPLakGoKMmcw0GAK/f9436b3a64bb727a755e43efe0cc7885/20181127-mailchimp-webhooks.png)
...
## [](#creating-the-mailchimp-template)创建 MailChimp 模板

我们解决方案的一个关键目标是保持设计和代码分离。我们希望能够使用 MailChimp 接口对模板进行更改。如果您不是管理模板设计的人，这一点尤其重要。

为了实现这种分离，我们需要以一种特殊的方式创建一个 MailChimp 模板。

[![An aim of our solution is to keep design and code separate](../Images/047afecc45c77a8668f347b4ffdda462.png)T2】](//images.ctfassets.net/fo9twyrwpveg/bveM8Nk3uwY4yc6uKwqse/f4fdd11e96f81ffc99e1dd3b8b1f041e/image_0.png)

### [](#a-mailchimp-editable-sections-primer)一个 MailChimp 可编辑章节的初级读本
...
### [](#mailchimp-mustache)MailChimp +小胡子
...
## [](#contentful-to-mailchimp)心满意足的去 MailChimp
...
### [](#capturing-the-publish-event-with-a-webhook)用 webhook 捕获发布事件
...
[![Setting up to only trigger the webhook on the publishing of a specific content type](../Images/54be7f1d0356697122f3bdc0ea439ab3.png)T2】](//images.ctfassets.net/fo9twyrwpveg/63TTpQevC0UMOO2CwAaOES/32711724b09c2838ef0818e1234330d0/image_1.png)

### [](#only-creating-a-campaign-once)仅创建一次活动
...
[![Reformat the payload so that our Contentful webhook provides just the data that our cloud function needs in the format that it needs](../Images/8e5a880823d1c9cbb23f0191baa0ba25.png)T2】](//images.ctfassets.net/fo9twyrwpveg/bDXSs4lEDQw4cSuKCisCE/c029d4b031e09787898fd94dac9ddbcb/image_2.png)
...
### [](#create-the-campaign-in-mailchimp)在 MailChimp 中创建活动
...
### [](#setting-the-campaign-content)设置活动内容
...
### [](#sending-scheduling-and-testing)发送、调度和测试
...
[![Email campaign workflow with Contentful and MailChimp](../Images/ee890af72fa390f874075ef6c348e2cc.png)T2】](//images.ctfassets.net/fo9twyrwpveg/42v9I1TQ3KAago2uS8GyyC/bb339478c9f08d1224d1a517ce2105c9/20181127-DIAGRAM_mailchimp-webhooks.png)

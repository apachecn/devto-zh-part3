...
> 原文:[https://dev . to/Byron Ruth/the-semantics-of-elastic searchs-nested-datatype-and-query-operator-gbf](https://dev.to/byronruth/the-semantics-of-elasticsearchs-nested-datatype-and-query-operator-gbf)

...
> 原文:[https://dev . to/gro dier/array-methods-the-gateway-to-functional-programming-f29](https://dev.to/grodier/array-methods-the-gateway-to-functional-programming-f29)
...
## [](#manipulating-data-as-a-starting-point)以操纵数据为起点
...
## [](#manipulating-data-with-array-methods)用数组方法操作数据
...
## [](#point-free-style-closures-and-currying-with-array-methods)点自由样式、闭包和数组方法
...
## [](#starting-small-to-learn-big)从小开始学大

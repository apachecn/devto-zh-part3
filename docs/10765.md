...
> 原文:[https://dev.to/mollynem/git-github-工作流程-基础知识-5496](https://dev.to/mollynem/git-github--workflow-fundamentals-5496)
...
### [](#workflow-amp-commonly-used-commands)工作流&常用命令

让我们回顾一个简单的项目工作流和帮助我们从一个步骤进入下一个步骤的 CLI 命令。下面是一个包含 Git 和 Github 的工作流程图。这个图表最接近地代表了我的小组项目的流程。

[![Simple Git Workflow](../Images/eff895e77591036effbac0dcea9a52bf.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--M_fHUEqA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/128hsgntnsu9bww0y8sz.png)
...
[![Diagram of Pushing Branches to Branches in GitHub](../Images/e876f7e6123b8621b0966db5df955d97.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--zGTf-eR6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/7z3xw1g2mt3sy9dastza.png)
...
[![Image of Pull Request example from GitHub](../Images/4092ab0bbcf3289182881764c30d201e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--lQ8jc6NS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/9bnyij60y484dgk1wg2g.png)
...
[![Justin Beiber Gif - I learned from that ](../Images/bb18f16585a72a8eb6facb4ad4fac750.png)T2】](https://i.giphy.com/media/ZIqbJ5Tbm6N0I/giphy.gif)

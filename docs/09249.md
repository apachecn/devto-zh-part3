...
> 原文:[https://dev . to/gle bec/property-testing-with-js verify-part-I-3 one](https://dev.to/glebec/property-testing-with-jsverify-part-i-3one)
...
# [](#part-i-what-is-property-testing)第一部分:什么是属性测试？
...
## [](#adhoc-property-testing-via-dynamic-assertions)通过动态断言进行专门的属性测试
...
## [](#firstclass-property-testing-with-jsverify)用 JSVerify 进行一流的性能测试
 ...
 **### [](#but-wait-theres-more%E2%84%A2-check-out-this-one-weird-trick%E2%84%A2)但是等等，还有！看看这个奇怪的把戏
...
## [](#summary-amp-try-it-yourself)总结&自己试试

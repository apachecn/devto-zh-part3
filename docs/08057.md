...
> 原文:[https://dev . to/reversent Mike/I-received-10gb 的磁盘空间-来自节点模块-oal](https://dev.to/irreverentmike/i-reclaimed-10gb-of-disk-space-from-node-modules-oal)

# [](#i-really-dont-like-my-laptop)我*真的*不喜欢我的笔记本电脑。
 ...
 *# [](#turtles-all-the-way-down)一路海龟下来🐢🐢🐢
...
[![bye bye, birdie](../Images/9f4e4bafeb8a4e6dd039d46be2583956.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--4GnRz0C1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/gzfuc5um1vnk5d5fqmn9.png)

# [](#what-did-it-break)它破了什么？

我这样做已经一周了，到目前为止，唯一的一点不好的地方是，当我重新访问我正在积极工作的项目时，我需要运行`yarn install`在那里重新创建`node_modules`目录。我很擅长这个。

[![A week later, I'm back up to 1209 node_modules directories](../Images/dfb7d5f59a6e13750e09cdc7ae60ef56.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--BSqj4v3H--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/m6m6zjyv8b91p94y82li.png)

# [](#can-we-do-better)我们能做得更好吗？

还有一个`npm`和`yarn`的替代品叫做 [`pnpm`](https://pnpm.js.org/) ，号称是“快速、磁盘空间高效的包管理器”。它的主要特点看起来很有希望:

[![one version of each module sounds great](../Images/190ec2220875dfcc0f2847e4c620e2aa.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--UCwWw5et--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/szmzxo3udkslxkorgijk.png)

...
> 原文:[https://dev . to/Alex mourer/sharing-data-between-components-invu ejs-48me](https://dev.to/alexmourer/sharing-data-between-components-invuejs-48me)

在本教程中，我们将探索在一个组件中生成数据，并在 [Vue.js](https://vuejs.org/) 中将它传递给另一个组件。

**TL；这里是一个工作代码沙箱的例子

[![working-example](../Images/f0d1d13cb1df3af0afd19f0664587a1d.png "working example")](https://res.cloudinary.com/practicaldev/image/fetch/s--kDFN9M84--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/2n8ll0586j6qtn0wdp8v.gif)**

#### [](#why-would-we-need-to-do-this)我们为什么需要这样做？
...
[![file structure](../Images/59f091bbcfb30fb5745d71ab78d78eea.png "Vue.js file structure")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--5ceoK4iW--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/d4qvos4gv2jrrtqasse6.JPG)

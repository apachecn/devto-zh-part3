...
> 原文:[https://dev . to/terrier script/build-AWS-lambda-function-with-type script-only-use-parcel-bundler-426 a](https://dev.to/terrierscript/build-aws-lambda-function-with-typescript-only-use-parcel-bundler-426a)

...
> 原文:[https://dev . to/terabytetiger/crash-course-web dev-buzz words-19 L3](https://dev.to/terabytetiger/crash-course-webdev-buzzwords-19l3)
...
### [](#reactangularvueember)反应/角度/角度/余烬
...
#### [](#gatsby-amp-friends)盖茨比&的朋友

[![yo dawg, I heard you like frameworks, so we put frameworks in your frameworks](../Images/00ed0f97baeeaf032da1c78c7e7af607.png)T2】](//images.ctfassets.net/2ou7t1spiiyz/5y9PhbbjxtIvoU27qOCE9m/31a1948b2da87fa60cfe2ef4ce3061b6/frameworksOnFrameworks.jpg)
...
#### [](#npm-node-package-manager)npm(节点包管理器)
...
### [](#electronnativescriptreact-native)电子/原生/反应原生
...
### [](#pwa-progressive-web-app)PWA(渐进式网络应用)

...
> 原文:[https://dev . to/Simon bauemer/my-first-open-source-project-super-simple-CLI-testing-tool-gcd](https://dev.to/simonbaeumer/my-first-open-source-project-super-simple-cli-testing-tool-gcd)
...
## [](#why-using-raw-commander-endraw-)为什么用`commander`？
...
## [](#a-full-raw-commanderyaml-endraw-example)一个完整的`commander.yaml`例子
...
## [](#define-default-test-configs)定义默认测试配置

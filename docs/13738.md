...
> 原文:[https://dev.to/areknawo/how-not-to-lint-your-code-53mh](https://dev.to/areknawo/how-not-to-lint-your-code-53mh)
...
# [](#one-config-to-rule-em-all)一个配置统治一切
...
## [](#for-in-amp-index-signature)为...在&指数签名

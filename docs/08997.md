...
> 原文:[https://dev . to/teroauralinna/global-http-request-and-response-handling-with-the-axios-interceptor-30ae](https://dev.to/teroauralinna/global-http-request-and-response-handling-with-the-axios-interceptor-30ae)
...
## [](#the-demo-is-available-at-codepen)演示可在 [CodePen](https://codepen.io/teroauralinna/pen/vPvKWe) 获得
...
## [](#making-http-request-handler-configurable)使 HTTP 请求处理程序可配置
...
## [](#axios-request-interceptor)Axios 请求拦截器

### [](#add-request-handler)添加请求处理程序
...
### [](#enable-request-interceptor)启用请求拦截器
...
## [](#axios-response-and-error-interceptors)Axios 响应和错误拦截器

### [](#add-response-handlers)添加响应处理程序

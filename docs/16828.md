...
> 原文:[https://dev . to/loizoskounios/blog-comments-powered-by-github-3dp 2](https://dev.to/loizoskounios/blog-comments-powered-by-github-3dp2)
...
### [](#create-public-github-repository)创建公共 GitHub 资源库

第一步是[创建一个公共的 GitHub 库来存放我博客的评论](https://github.com/loizoskounios/blog-comments-tracker)。

[![Repository](../Images/b605ecdb50a86f926170c4a400a23f47.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Tem0vcYI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/len8xhxcjct2tsmoyl19.png)

### [](#install-utterances-app)安装话语 App

然后我必须将[话语 GitHub 应用](https://github.com/apps/utterances)安装到我上面创建的存储库中。

[![Utterances installation](../Images/397f3450cd4d54d9ec090feb1e2ec0d4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--xW8SVqPl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/dlam2q3vplaa9ppsypzl.png)

### [](#generate-script-tag)生成脚本标签
...
[![A post with an Utterances comment section](../Images/679fe01861bdc98a9c9b09d535feac66.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--uCk9fp9S--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/sw2beq6w3d5s5s4miipg.png)

...
> 原文:[https://dev.to/hamed_farag/upgrade-a-react-project-46mc](https://dev.to/hamed_farag/upgrade-a-react-project-46mc)

[![Atlas hold the react logo](../Images/85817f082fb686ebbcff54b8abb3ca40.png "Atlas hold the react logo")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---3jjiisw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/cbunolmw5m6ffz8ms2l3.jpg)
...
## [](#1-upgrade-react-and-react-dom)1-升级 React 和 React DOM
...
## [](#2-install-proptypes-package)2-安装 PropTypes 包
...
## [](#3-upgrade-most-of-packages)3。升级大多数软件包
...
### [](#31-reduxform-533)3.1 还原形式 5.3.3
...
#### [](#of-course-there-are-some-crashes-after-this-upgrade-i-upgraded-some-packages-too-like-reactdropzone-and-so-on-due-to-some-configurations-changes-and-its-usage)当然这次升级后也有一些崩溃，我升级了一些包太像 react-dropzone 之类的由于一些配置的变化和它的用法。

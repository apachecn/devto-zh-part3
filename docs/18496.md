...
> 原文:[https://dev . to/sahya/try-to-the-SAML-authentic ation-of-growi-using-key cloak-4 fkh](https://dev.to/sahya/try-to-the-saml-authentication-of-growi-using-keycloak-4fkh)
...
1.  在 Growi 上，开放式管理(管理)和管理员授权。
    ...
    *   网站网址:[https://wiki.examle.com](https://wiki.examle.com)
        *   这是一个重要的设置，因为它也作为环境变量在 SAML 的安全设置中使用。![image.png](../Images/adf0f1b9e7610036573725fe2b4a76cf.png)
    *   安全设置
        *   护照认证(認証機構):启用(有効化)
        *   开着
2.  在 Growi 上，按[刷新(更新)].
3.  在格罗威，记下卡尔巴克·url(コールバックurl).![image.png](../Images/2dc28f6ec3b865a1af2c1370c6f8740d.png)

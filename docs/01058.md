...
> 原文:[https://dev . to/mandrew cito/fast-pub-sub-python-implementation-threading-ii-1k HP](https://dev.to/mandrewcito/fast-pub-sub-python-implementation-threading-ii-1khp)
...
### [](#making-publisher-nonblocking)使发布者无阻塞

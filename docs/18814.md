...
> 原文:[https://dev . to/star BIST/building-an-animated-sticky-header-with-custom-offset-2o 60](https://dev.to/starbist/building-an-animated-sticky-header-with-custom-offset-2o60)

[![Making a website with Hugo cover](../Images/62c00e9167367e560f64e62a66fe960d.png)T2】](https://www.silvestar.codes/articles/building-an-animated-sticky-header-with-custom-offset/)

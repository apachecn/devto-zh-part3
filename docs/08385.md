...
> 原文:[https://dev . to/Ganesh/day-5-100-days-100-python-scripts-challenge-14hg](https://dev.to/ganesh/day-5-100-days-100-python-scripts-challenge-14hg)

要了解全部挑战，请点击此链接。

[点击此处阅读 100 天 100 个 Python 脚本挑战](https://dev.to/ganesh/100-days-100-python-scripts-challenge-3fc)

## [](#day-5-appendreadme)第五天:追加 _ 阅读 _ 我

...
> 原文:[https://dev . to/setevoy/openvpn-let-s-encrypt-DNS-verification-on-AWS-route 53-and-openvpn-access-server-SSL-certificate-auto-update-2h 81](https://dev.to/setevoy/openvpn-let-s-encrypt-dns-verification-on-aws-route53-and-openvpn-access-server-ssl-certificate-auto-update-2h81)
...
### [](#aws-iam-and-certbotuser)AWS IAM 和 certbot 用户

我们的域由 AWS Route53 提供服务，所以在这里使用 [certbot-dns-route53](https://certbot-dns-route53.readthedocs.io/) 。

获取您的区域 ID:

[![](../Images/48b3227fceeeed482d3f7d3a4345ab12.png "OpenVPN: Let's Encrypt DNS verification и обновление сертификата в OpenVPN Access Server")T2】](https://rtfm.co.ua/wp-content/uploads/2019/05/Screenshot_20190524_131355.png)
...
[![](../Images/763930d196809b69d43194db98835bae.png "OpenVPN: Let's Encrypt DNS verification и обновление сертификата в OpenVPN Access Server")T2】](https://rtfm.co.ua/wp-content/uploads/2019/05/Screenshot_20190524_124141.png)

[![](../Images/73b4e9f6a851fdee55d8ae0c47cee037.png "OpenVPN: Let's Encrypt DNS verification и обновление сертификата в OpenVPN Access Server") ](https://rtfm.co.ua/wp-content/uploads/2019/05/Screenshot_20190524_124251.png) *(后来我认为在策略或用户名中添加区域名称是个好主意，这样更具描述性，因为区域/用户可以访问这里唯一的一个区域)*

创建一个拥有*编程访问权限*的新用户:

[![](../Images/a1bdb2ac2144bed762e0b2e78482e80d.png "OpenVPN: Let's Encrypt DNS verification и обновление сертификата в OpenVPN Access Server")T2】](https://rtfm.co.ua/wp-content/uploads/2019/05/Screenshot_20190524_124410.png)

在*权限*中选择了*直接附加现有策略*并附加上面创建的策略:

[![](../Images/573a91673e57f5e4fa952fdc48597743.png "OpenVPN: Let's Encrypt DNS verification и обновление сертификата в OpenVPN Access Server")T2】](https://rtfm.co.ua/wp-content/uploads/2019/05/Screenshot_20190524_124508.png)
...
### [](#certbot-dns-verification)certbot DNS 验证
...
[![](../Images/56e60466e8528eb753c19e20fcb2755d.png "OpenVPN: Let's Encrypt DNS verification и обновление сертификата в OpenVPN Access Server")T2】](https://rtfm.co.ua/wp-content/uploads/2019/05/Screenshot_20190524_131922.png)
...
### [](#openvpn-access-server-ssl-update)OpenVPN 接入服务器 SSL 更新
...
[![](../Images/800fe05c6e8f4b7151562b99331d8c33.png "OpenVPN: Let's Encrypt DNS verification и обновление сертификата в OpenVPN Access Server")T2】](https://rtfm.co.ua/wp-content/uploads/2019/05/Screenshot_20190524_133817.png)

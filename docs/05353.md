...
> 原文:[https://dev . to/claire codes/styling-list-bullets-with-e moji-1733](https://dev.to/clairecodes/styling-list-bullets-with-emoji-1733)
...
[![Unstyled list of six items](../Images/955a343b3d3a2a5db1ab8c6b9b5ffde4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--aNi349-q--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/bx1tggf4d6k3c1ls4jtx.png)

对此:

[![Cat, dog and unicorn emoji in cyclical pattern for six list counters](../Images/5a8175e5eab07b79abd290f730cb73b6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--T2ra1rs---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/clc8rolsp30bi86ahkdd.png)

**注意**:为了保持简短，下面的代码示例是用 Sass 编写的，以利用嵌套。

## [](#method-1-raw-counterstyle-endraw-atrule)方法一:`@counter-style` at-rule
...
### [](#counterstyle-rule-example)反式规则示例
...
## [](#method-2-raw-before-endraw-pseudoelement)方法二:`::before`伪元素
...
[![Bear emoji for list counters](../Images/c47d55d35b6f6a49d66153e33f9f0b07.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--AVGCNCsZ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/9appmtgfo9shk5zxfetf.png)
...
[![Cat, dog and unicorn emoji in cyclical pattern for six list counters](../Images/b5277605f6d40a3db848e24aa94a6738.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--cUhDPrmd--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/7zk5ozn4ko4n24cfcirm.png)
...
## [](#emoji-bullet-point-codepen-example)表情符号要点码笔示例

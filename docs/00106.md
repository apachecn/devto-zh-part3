...
> 原文:[https://dev . to/p0ooker/using-graph QL-queries-to-separate-pages-and-blog-posts-in-Gatsby-1ke 2](https://dev.to/p0oker/using-graphql-queries-to-separate-pages-and-blog-posts-in-gatsby-1ke2)
...
# [](#excluding-pages-from-blog-posts)从博客文章中排除页面
...
# [](#querying-the-correct-page)查询正确的页面

...
> 原文:[https://dev . to/hasura HQ/hasura-authentic ation-explained-2c 95](https://dev.to/hasurahq/hasura-authentication-explained-2c95)

正如你可能从 [blog.hasura.io](//blog.hasura.io) 上的各种其他博客文章中所知道的，hasura 支持各种类型的认证，在下面的博客文章中，我想列出在生产中使用 Hasura 时有哪些认证选项。

[![](../Images/194b46cfa67bab16d9e738fc7561e2d6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--plNNVMmg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8qbcqnju140d1idkzj1v.jpg)
...
## [](#securing-your-graphql-endpoint)保护您的 GraphQL 端点

当创建 Hasura engine 的新实例时，您可能已经看到**在控制台顶部保护您的端点**:

[![hasura secure endpoint pic](../Images/9fd65de1cb0b3059ba0f15f7cdb6a97f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--aLSD987x--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/6hty5icfrafqyq6z3hrp.png)
...
[![](../Images/0a756739cf71a98f8c7291c27fd9f341.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--J-YSA6DN--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/pboxriw7rdoive30swvq.png)
...
### [](#how-we-get-started-with-our-custom-webhook)我们如何开始定制 webhook？
...
[![](../Images/412aa71ffe0afd73c867ebb5c11fde9a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--cEyfBA4n--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/tkskfz30evzc4dcn8g62.png)

正如您可以看到的,`users`表是在我们运行 knex 迁移时创建的，当时我们设置了 passport-js 样板文件，但是我们也想从我们的 GraphQL API 中使用它，所以请确保您单击了`Track`按钮，现在您将能够查询您的用户:

[![](../Images/36f96854693f16312a4642955bf65de4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--1AnV-HDR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/a9e2qatti7azxemoh56n.png)
...
### [](#setting-up-hasura-with-auth-webhook)用 auth webhook 设置 Hasura
...
[![](../Images/42b4ed33390cc3f66526b5ed69c47f5c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--5WhTqzT4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://docs.hasura.io/1.0/_images/webhook-auth1.png)
...
[![](../Images/436535641e4aa916b8138dd96f331d2e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--RRzMAxZZ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://docs.hasura.io/1.0/_images/jwt-auth1.png)
...
[![](../Images/663c1dd2312ce88780b35960a1805112.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--h8T66PAj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/hxl7n0htmzpjxx9fjyij.png)
...
[![](../Images/1343a920cd369fd22cadd12172e02844.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--W5f_LE-T--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/zx75n0ok2i4983jfr0fl.png)

让我们来看看我们可以使用的常见身份验证技术。

### [](#custom-jwt-server)自定义 JWT 服务器
...
[![](../Images/36a781f7f88eca22e4d2128913fe6d0a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--nRsdX1UB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/2xdyb2ix5ugnt7ri1di6.png)
...
# [](#hasura-permission-system)哈苏拉权限系统

Hasura 有一个非常精细的评估权限的方法。在上面的章节中，我列出了使用 Hasura 进行认证的不同方法，虽然这些方法各不相同，但结果都是一样的。`X-Hasura-*`变量传递给 Hasura 权限系统。

[![](../Images/210c8554ea91d9feb9fb8b28c6568788.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--xIjbyy_x--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/urf5fl50vs1on83xnqrg.png)
...
[![](../Images/c6afcbeb59d0d9cbc84ae6278aba01da.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ZgMGITHo--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/wbflnw7uh7bm6tzn4m1c.png)

正如您在本例中所看到的，我们正在检查帖子内容是否为“custom_value ”,只有当它为“custom _ value”时，我们才允许用户选择字段。这意味着只有当帖子内容等于“自定义值”时，用户才能看到帖子

或者，我们可以这样设置:

[![](../Images/d72e16e5acceef1d6cc2d16ba59e7bdf.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--AYj24Mwy--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/p00snj2yggkgszt7ab3t.png)

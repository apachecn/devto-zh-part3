...
> 原文:[https://dev . to/Raoul Meyer/reducing-http-request-overhead-in-PHP-5343](https://dev.to/raoulmeyer/reducing-http-request-overhead-in-php-5343)
...
$request = new Client\Request('GET', 'https://www.google.com/images/branding/googlelogo/1x/googlelogo_color_272x92dp.png');

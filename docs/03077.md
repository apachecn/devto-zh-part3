...
> 原文:[https://dev.to/oktadev/angular-authentication-with-jwt-31b0](https://dev.to/oktadev/angular-authentication-with-jwt-31b0)
...
## [](#session-vs-jwt-authentication-in-angular)会话 vs JWT 角中认证
...
## [](#implement-a-jwt-server-and-client-with-node-and-angular)用 Node 和 Angular 实现一个 JWT 服务器和客户端
...
### [](#build-a-jwt-authentication-server)建立 JWT 认证服务器
...
### [](#add-an-angular-client-with-jwt-authentication)添加带 JWT 认证的 Angular 客户端
...
## [](#build-secure-jwt-authentication-in-angular-and-express)在角状和快递中建立安全的 JWT 认证

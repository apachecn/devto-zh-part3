...
> 原文:[https://dev.to/rob117/how-to-use-rest-clients-native-apps-to-make-shrine-client-uploads-and-S3-work-for-you-no-JavaScript-just-back end-322h](https://dev.to/rob117/how-to-use-rest-clients--native-apps-to-make-shrine-client-uploads-and-s3-work-for-you-no-javascript-just-backend-322h)

# [](#shrine-and-aws)神社和 AWS
...
## [](#the-set-up-the-break-down)设定-分解
...
### [](#quick-overview-of-how-it-all-works)快速概述其工作原理
...
### [](#before-we-even-start)甚至在我们开始之前
...
### [](#using-that-response-to-save-the-file)使用该响应保存文件

...
> 原文:[https://dev . to/neutrino 2211/using-CSS-selectors-in-JavaScript-3 HLM](https://dev.to/neutrino2211/using-css-selectors-in-javascript-3hlm)

在 CSS 中，选择器是用来选择你想要样式化的元素的模式，但是从上面的标题中你可以看出，选择器在 javascript 中也是有用的，下面是一些如何使用它们的例子。

### [](#basics)基础知识

#### [](#using-a-selector-in-javascript)在 javascript 中使用选择器
...
#### [](#replicating-raw-getelementbyid-endraw-and-raw-getelementsbytagname-endraw-)复制`.getElementById`和`getElementsByTagName`
...
#### [](#using-multiple-selectors)使用多个选择器
...
### [](#more-with-elements)多带元素

在上面的例子中，我们进行了基本的查询，但是也可以做其他的事情，比如按顺序或父元素获取元素。

#### [](#getting-element-children)获取元素子元素
...
#### [](#getting-elements-by-order)按顺序获取元素
...
### [](#getting-elements-by-attribute)按属性获取元素
...
#### [](#more-with-attribute-values)多带属性值

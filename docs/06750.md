...
> 原文:[https://dev.to/0xshetty/jwt-in-dotnet-core-9bg](https://dev.to/0xshetty/jwt-in-dotnet-core-9bg)

保护 API 的方法之一是使用 JWT。这就是它的工作方式，我们将创建一个具有 AllowAnonymous 操作的控制器。确保所有控制器都有 Authorize 属性，否则就会有潜在的漏洞。

[![jwt flow diagram](../Images/9062f3480b101e3b6a32c3add669045c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--uNJU9B7G--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/rr05xjzsnoi44ehhz8sx.png)

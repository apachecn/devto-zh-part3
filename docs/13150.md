...
> 原文:[https://dev . to/tonymet/writing-custom-metrics-to-stack driver-in-golang-2 ohb](https://dev.to/tonymet/writing-custom-metrics-to-stackdriver-in-golang-2ohb)
...
## [](#1-create-the-metric-descriptor)1。创建度量描述符

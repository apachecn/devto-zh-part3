...
> 原文:[https://dev . to/oktadev/build-a-rest-API-with-node-and-postgres-4g1e](https://dev.to/oktadev/build-a-rest-api-with-node-and-postgres-4g1e)
...
## [](#set-up-your-node-postgres-dependencies)设置你的节点+ Postgres 的依赖关系
...
## [](#fetch-movie-titles-with-node)用节点取电影片头
...
## [](#interact-with-postgres-using-node)使用节点与 Postgres 交互

此时，您应该有了一个简单的 API，可以获取关于电影标题的信息。现在是时候将 Postgres 集成到您的应用程序中，以便您可以跟踪这些电影。

### [](#create-node-service-routes)创建节点服务路线
...
### [](#create-node-title-routes)创建节点标题路线
...
## [](#add-user-authentication-to-your-node-api)将用户认证添加到您的节点 API
...
## [](#node-postgres-api-takeaways)节点+ Postgres API 外卖

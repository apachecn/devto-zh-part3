...
> 原文:[https://dev . to/joemasilotti/I-just-deleted-from-production-4bh 7](https://dev.to/joemasilotti/i-just-deleted-thousands-of-records-from-production--4bh7)
...
## [](#exportimport-raw-json)导出/导入原始 JSON
...
### [](#the-exporter-run-in-development)出口国，发展中运行
...
### [](#the-importer-task-run-in-production)导入器任务，在生产中运行
...
## [](#fixes-and-looking-forward)修正和期待

...
> 原文:[https://dev . to/juliensimon/Amazon-ec2-c5n-and-p3dn-more-network-bandwidth-for-deep-learning-3k ko](https://dev.to/juliensimon/amazon-ec2-c5n-and-p3dn-more-network-bandwidth-for-deep-learning-3kko)

### [](#aws-reinvent%E2%80%8A%E2%80%8Aamazon-ec2-c5n-and-p3dn-more-network-bandwidth-for-deep-learning)AWS re:Invent —亚马逊 EC2 c5n 和 p3dn:更多网络带宽用于深度学习

训练深度学习模型不仅仅是一项计算密集型任务:还需要大量的 I/O。我们来看看为什么。

[![](../Images/26e827cffbe42329d152979d17fe434a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--oxe7gbV_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/852/1%2ANhigyAYDlXCVGXACdlTa7Q.jpeg)

#### [](#loading-training-and-inference-data)加载训练和推理数据
...
#### [](#exchanging-information-during-distributed-training)分布式训练时交换信息
...
#### [](#c5n-and-p3dn-100-gbit-networking-on-amazon-ec2)c5n 和 p3dn:亚马逊 EC2 上的 100 Gbit 联网

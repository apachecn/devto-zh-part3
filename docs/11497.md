...
> 原文:[https://dev . to/star BIST/custom-WordPress-theme-development-with-spro-bgd](https://dev.to/starbist/custom-wordpress-theme-development-with-spro-bgd)

[![Just My Routine As A Remote Worker](../Images/e9e683477043d7662ab8fea79d4200c5.png)T2】](https://www.silvestar.codes/articles/custom-wordpress-theme-development-with-spro/)
...
## [](#the-video-lesson)视频课

如果你更喜欢看视频而不是阅读文章，你可以继续[我为此录制的技能分享课程](https://skl.sh/2EcUlRt)。

[![SPRO Skillshare course](../Images/f0bdc826d9d63e635c4d93d184d7ff04.png)T2】](https://skl.sh/2EcUlRt)

## [](#the-project-structure)项目结构

在这种情况下，我将使用一个默认的 WordPress 安装作为我的起点。我使用飞轮的本地版本作为我的 WordPress 开发工具。

[![Local by FlyWheel](../Images/0029d1ddb0cae01611e9f75fec6e94bb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vAklDBML--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/xbwp6imwhm45ygpnotoo.jpg)

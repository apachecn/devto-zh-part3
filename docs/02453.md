...
> 原文:[https://dev . to/robmatyszewski/getting-started-with-react-graph QL-part-ii-532g](https://dev.to/robmatyszewski/getting-started-with-react-graphql-part-ii-532g)
...
# [](#1-extensive-react-app)[1。丰富的 React 应用程序](https://github.com/rwieruch/react-graphql-github-apollo)

### [](#a-react-apollo-graphql-github-client)一个 React + Apollo + GraphQL 的 GitHub 客户端

## ![GitHub logo](../Images/375dfcc32199b4dedf2b526645c27ff7.png) [【路对图 QL】](https://github.com/the-road-to-graphql)/[【反应图 QL-github-Apollo】](https://github.com/the-road-to-graphql/react-graphql-github-apollo)
...
[![Build Status](../Images/4781e84ce4a75b59ae2b02bdf1d0e30d.png)](https://travis-ci.org/the-road-to-graphql/react-graphql-github-apollo)[![Slack](../Images/97a2e79095b2f2817d2e1e81f6728f81.png)](https://slack-the-road-to-learn-react.wieruch.com/)[![Greenkeeper badge](../Images/08f09475e68a0e189ffa6fcbbd7c5278.png)](https://greenkeeper.io/)

[![](../Images/9364f585e743db9351da8dfe33fc46f5.png)T2】](https://user-images.githubusercontent.com/2479967/35777369-14a2d1ae-09ad-11e8-80c6-7a3ddeabb716.gif)
...
[![](../Images/4c9f445b543066cfcd19aa9d351331d4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--XByOg583--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/359i2n7b986j08jyrqfw.gif)
...
# [](#2-react-graphql-vanillajs)[2。React GraphQL vanilla.js](https://github.com/rwieruch/react-graphql-github-vanilla)

### 使用 GitHub 的 GraphQL API 和 vanilla JS 的 React GraphQL 示例

## ![GitHub logo](../Images/375dfcc32199b4dedf2b526645c27ff7.png)/[react-graph QL-github-vanilla](https://github.com/the-road-to-graphql/react-graphql-github-vanilla)
...
[![Build Status](../Images/77cbb96ca2eb034e76af9bd76e042f73.png)](https://travis-ci.org/the-road-to-graphql/react-graphql-github-vanilla)[![Slack](../Images/97a2e79095b2f2817d2e1e81f6728f81.png)](https://slack-the-road-to-learn-react.wieruch.com/)[![Greenkeeper badge](../Images/b8a47b5c63972776bc328c2fc9051db4.png)](https://greenkeeper.io/)
...
# [](#3-react-app-with-local-state-management)[3。将应用程序与本地状态管理进行反应。](https://github.com/rwieruch/react-apollo-link-state-example)

### [](#a-react-application-using-apollo-client-with-apollolinkstate-for-local-state-management)一个 React 应用程序，使用带有 apollo-link-state 的 Apollo 客户端进行本地状态管理。

## ![GitHub logo](../Images/375dfcc32199b4dedf2b526645c27ff7.png) [【道路到图表】ql ](https://github.com/the-road-to-graphql) / [反应-阿波罗-链接-状态-实例](https://github.com/the-road-to-graphql/react-apollo-link-state-example)
...
[![Build Status](../Images/8854ee958641a8646f5a298b1bcd3901.png)](https://travis-ci.org/the-road-to-graphql/react-apollo-link-state-example)[![Slack](../Images/97a2e79095b2f2817d2e1e81f6728f81.png)](https://slack-the-road-to-learn-react.wieruch.com/)[![Greenkeeper badge](../Images/117af131e8cdcf38ef1448db1b401961.png)](https://greenkeeper.io/)
...
# [](#4-whatsapp-clone)[4。WhatsApp 克隆](https://github.com/srtucker22/chatty)

### React Native 和 Apollo 的 WhatsApp 克隆

## ![GitHub logo](../Images/375dfcc32199b4dedf2b526645c27ff7.png) [ srtucker22 ](https://github.com/srtucker22) / [健谈](https://github.com/srtucker22/chatty)
...
# [](#5-react-native-hello-world)[5。反应原生《hello world》](https://github.com/apollographql/frontpage-react-native-app)

## ![GitHub logo](../Images/375dfcc32199b4dedf2b526645c27ff7.png)[apolographql](https://github.com/apollographql)/[front page-react-native-app](https://github.com/apollographql/frontpage-react-native-app)
...
# [](#6-pokedex-react-native-app)[6。Pokedex React 原生 App](https://github.com/learnapollo/pokedex-react-native)

## ![GitHub logo](../Images/375dfcc32199b4dedf2b526645c27ff7.png)[learnapollo](https://github.com/learnapollo)/[pokedex-react-native](https://github.com/learnapollo/pokedex-react-native)
...
[![](../Images/d47dae9394df9f1aef08b75bc0b94ec8.png)T2】](https://camo.githubusercontent.com/55add6eb6dafa52672470ab08622f2363d10a974/68747470733a2f2f692e6779617a6f2e636f6d2f61646363343637356364343636313935616466373237626138613332623534342e676966)
...
完成该步骤后，您可以通过查看各自的文件夹，将您的结果与官方解决方案进行比较。如果您找到了与我们提议不同的解决方案，请随时[告诉我们](http://slack.graph.cool/)您的解决方案。<g-emoji class="g-emoji" alias="bulb" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/1f4a1.png">💡</g-emoji>

## 帮助与社区 [![Slack Status](../Images/22bd641ec9660bf2cd412a704dddac14.png)](https://slack.graph.cool)
...
### [](#live-demo-httpdemolearnapollocom)现场演示:【http://demo.learnapollo.com T2】

[![](../Images/14443dc35801ce5e2e5126edf6cc7778.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--n-uce96---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://i.gyazo.com/adcc4675cd466195adf727ba8a32b544.gif)

# [](#7-realtime-offline-aws-appsync)[7。实时、离线 AWS AppSync](https://github.com/aws-samples/aws-mobile-appsync-events-starter-react-native)

### [](#graphql-starter-application-with-realtime-and-offline-functionality-using-aws-appsync)GraphQL starter 应用程序，使用 AWS AppSync 实现实时和离线功能

## ![GitHub logo](../Images/375dfcc32199b4dedf2b526645c27ff7.png)[AWS-samples](https://github.com/aws-samples)/[AWS-mobile-app sync-events-starter-react-native](https://github.com/aws-samples/aws-mobile-appsync-events-starter-react-native)
...
[![EventDetails](../Images/dfae821dd829a1561c966ce361daed51.png)T2】](https://raw.githubusercontent.com/aws-samples/aws-mobile-appsync-events-starter-react-native/master/media/DeleteEvents.png)
...
[![](../Images/079ece8c3073462f0a85c5602f9e9984.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--pC6u8jPC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/2rkf6dkpytxc9d9hosw5.png)
...
# [](#8-starter-fullstack-app)[8。Starter fullstack 应用](https://github.com/graphql-boilerplates/react-fullstack-graphql/)

## ![GitHub logo](../Images/375dfcc32199b4dedf2b526645c27ff7.png)[graph QL-样板文件](https://github.com/graphql-boilerplates)/[react-full stack-graph QL](https://github.com/graphql-boilerplates/react-fullstack-graphql)
...
[![](../Images/fc82d6874627cc6151fae5cba9000e77.png)T2】](https://camo.githubusercontent.com/cb8e64e5802d8523883fed4fae290fa2853fcc62/68747470733a2f2f696d6775722e636f6d2f6f7573795161432e706e67)

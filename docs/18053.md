...
> 原文:[https://dev . to/jpdias/indoor-sensing-hub-power-by-Mozilla-things-framework-5e4m](https://dev.to/jpdias/indoor-sensing-hub-powered-by-mozilla-things-framework-5e4m)

*物联网*旨在以一种真正开放、灵活、可扩展的方式构建物联网，使用 Web 作为其应用层。为了实现这一想法，Mozilla 一直在为物联网标准而努力，为最常见的语言提供了网关实现和库。在这篇博文中，我们将经历*将*变成物联网设备的过程。

[![](../Images/f0f784b5dff2034010ccdd13ed5286f7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--HjWnK0zU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://jpdias.me/images/indoorsensing/mozilla_iot_wordmark.png)
...
### [](#3d-printed-sensing-hub-box)3D 打印传感集线器盒
...
[![](../Images/3e08ca63a63827b3cfbf77cd0698ac74.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--GL7ddXLR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://jpdias.me/images/indoorsensing/3d1-min.jpg)

[![](../Images/2cbbfb0b68d795153a51b8adf3e4402e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--6sZQjhnT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://jpdias.me/images/indoorsensing/3d2-min.jpg)

[![](../Images/a3c543adf453d9b69c110e367b13f756.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--gq4dt4Bx--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://jpdias.me/images/indoorsensing/3d3-min.jpg)

打印后对该模型进行了一些修改，以便将试验板安装到 *Base_NodeMCU* 中。所有的打印都是用 Anet A8 打印机完成的。

### [](#parts-and-circuits)零件和电路
...
[![Circuit](../Images/36b71729c39fcee27d962a9c260c8cfd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--RmfACOJU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://jpdias.me/images/indoorsensing/indoorsensing_circuit.png)

[烧结原理图下载](///images/indoorsensing/indoorsensing_circuit.fzz)
...
### [](#setting-up-the-internet-connection)设置互联网连接
...
### [](#creating-a-new-webthingadapter-our-web-thing)创建一个新的 WebThingAdapter(我们的 *web thing*
...
### [](#adding-components-to-our-adapter)向我们的适配器添加组件
...
#### [](#reading-data-from-dht)从 DHT 中读取数据
...
#### [](#connecting-the-oled-screen)连接有机发光二极管屏幕
...
[![](../Images/8ca6b57f454418ca0fb63cb863e576d1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--qjDTYAEI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://jpdias.me/images/indoorsensing/final1-min.jpg)

[![](../Images/9233604c7139750ac0944c5e0913151b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--LtaW7jN5--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://jpdias.me/images/indoorsensing/final2-min.jpg)

[![](../Images/b3b4a78a88046d8ff101e58093c32858.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--fmK8R9RV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://jpdias.me/images/indoorsensing/final3-min.jpg)

### [](#resulting-json-schema)生成 JSON 模式

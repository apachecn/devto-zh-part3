...
> 原文:[https://dev . to/rinstarskykujat/set-up-your-own-endpoint-using-the-WP-rest-API-3 OOB](https://dev.to/rinstarskykujat/set-up-your-own-endpoint-using-the-wp-rest-api-3oob)

# [](#set-up-your-own-endpoint-using-the-wp-rest-api)使用 WP REST API 设置自己的端点。

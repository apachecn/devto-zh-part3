...
> 原文:[https://dev . to/heroku/ten-way-to-secure-your-applications-48df](https://dev.to/heroku/ten-ways-to-secure-your-applications-48df)
...
## [](#1-ensure-dependencies-are-uptodate)1。确保依赖关系是最新的
...
## [](#2-explicitly-declare-acceptable-user-payloads)2。显式声明可接受的用户负载
...
## [](#3-assert-safe-regular-expressions)3。断言安全正则表达式
...
## [](#4-prevent-abusive-requests)4。防止滥用请求
...
## [](#5-align-your-code-to-be-securefirst)5。将您的代码调整为安全第一
...
## [](#6-store-credentials-outside-your-codebase)6。将凭据存储在您的代码库之外
...
## [](#7-deny-http-requests)7。拒绝 HTTP 请求
...
## [](#8-enable-certificate-checking)8。启用证书检查
...
## [](#9-log-and-monitor-suspicious-behavior)9。记录和监控可疑行为
...
[![UML of AppSensor](../Images/25ebbbbfd48ee1ff0ebd512e9ffca305.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--iC4-1Enw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://image.slidesharecdn.com/10-mistakes-devoxx-181115073417/95/10-mistakes-hackers-want-you-to-make-87-638.jpg%3Fcb%3D1542267300)

看一看[app sensor 检测点列表](https://www.owasp.org/index.php/AppSensor_DetectionPoints)，以潜在地确定您的应用程序需要改进入侵检测的地方。

## [](#10-limit-your-own-access)10。限制您自己的访问

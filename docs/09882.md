...
> 原文:[https://dev.to/copperwall/-why-transducers-are-cool-1a7f](https://dev.to/copperwall/-why-transducers-are-cool-1a7f)
...
## [](#composing-mapping-functions)构成映射功能
...
## [](#trying-to-compose-filter-and-reduce)试图构成过滤和减少
...
## [](#enter-transducers)输入传感器

### [](#using-reduce-for-map-and-filter)使用 reduce 进行贴图和滤镜
...
[![debugging reduceFilter](../Images/e17abe14b17dbb1bfdf8236a2b1ca2cf.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--pclTFDIo--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3-us-west-2.amazonaws.com/copperwall-blog-images/copperwall-dev/debug1.png)

用 **2** 再次调用过滤归约器，过滤归约器调用合并器，合并器触发*归约映射*中的断点。此时，映射器函数是传递给*transducer map*的已命名的 *addOne* 函数，本例中的组合器是 *listCombine* 函数。

[![debugging reduceMap](../Images/9315fbf6e404e3e729f5930dafe8ee1d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--501qNKVo--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3-us-west-2.amazonaws.com/copperwall-blog-images/copperwall-dev/debug2.png)

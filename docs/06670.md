...
> 原文:[https://dev . to/Gary _ wood fine/making-API-calls-with-httpclientfactory-in-console-applications-541d](https://dev.to/gary_woodfine/making-api-calls-with-httpclientfactory-in-console-applications-541d)
...
### [](#what-is-the-httpclient)什么是 HttpClient
...
## [](#what-is-the-httpclientfactory)什么是 HttpClientFactory
...
### [](#how-to-use-the-httpclientfactory)如何使用 HttpClientFactory

...
> 原文:[https://dev . to/cube js/vue-dashboard-tutorial-using-cube-js-6 H5](https://dev.to/cubejs/vue-dashboard-tutorial-using-cube-js-6h5)
...
## [](#setting-up-the-dashboard)设置仪表板

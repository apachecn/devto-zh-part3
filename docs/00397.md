...
> 原文:[https://dev.to/trezy/on-dropdown-menu-transitions-2bp2](https://dev.to/trezy/on-dropdown-menu-transitions-2bp2)
...
## [](#the-long-and-the-short-of-it)其长其短
...
## [](#transitions-swing-both-ways)转场双向摇摆
...
### [](#-raw-stepsnumberofsteps-direction-endraw-)`steps(number_of_steps, direction)`
...
### [](#-raw-cubicbezierx1-y1-x2-y2-endraw-)`cubic-bezier(x1, y1, x2, y2)`

...
## [](#spinners-o-indicadores-de-carga-y-progreso)纺纱机或负荷和进度指标
...
[![Imagen animada de un spinner de tipo borde giratorio](../Images/726580632ba1a55d16dad354beb59285.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--uMUO415y--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://www.campusmvp.es/recursos/image.axd%3Fpicture%3D/2019/1T/bootstrap42/bootstrap42-spinner-border.gif)

*   **增长点**:它使用了一个从无到有逐渐增长的点。

[![Imagen animada de un spinner de tipo punto creciente](../Images/8117d663e9f3045e1ad0cf659fca668e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--eK2YSPcE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://www.campusmvp.es/recursos/image.axd%3Fpicture%3D/2019/1T/bootstrap42/bootstrap42-spinner-grow.gif)
...
[![Imagen animada de un spinner de tipo borde giratorio dentro de un botón de color azul](../Images/9b03a46804330918d0b8ada7f8fe8f32.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--OcXThzA---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://www.campusmvp.es/recursos/image.axd%3Fpicture%3D/2019/1T/bootstrap42/bootstrap42-spinner-boton.gif)
...
[![Imagen animada de un spinner de tipo borde giratorio con un texto dentro](../Images/80e46b2c097624e62c064874c4b21456.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--EMFuIEES--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://www.campusmvp.es/recursos/image.axd%3Fpicture%3D/2019/1T/bootstrap42/bootstrap42-spinner-contenido.gif)

在这种情况下，这是一个有点“chuckle”，但它会给你一个机会。

使用 JavaScript，我们可以通过简单地放置或删除相应的类来启动和停止它们。所以它没有什么神秘之处，而且非常容易使用。

### [](#accesibilidad-de-los-spinners)【纺丝机】的无障碍性
...
## [](#notificaciones-de-tipo-toast)类型的通知“吐司”
...
[![Aspecto de la notificación anterior una vez mostrada](../Images/bcdb8a2fd3cd43c507e0490e44f0c786.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--rJEIs7xb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.campusmvp.es/recursos/image.axd%3Fpicture%3D/2019/1T/bootstrap42/bootstrap4.2-notificacion.png)
...
## [](#interruptores-estilo-ios)中断时间估计

表格中通常包含勾选方块，以标记「是」或「否」选项。默认情况下，它们是非常阳极的正方形，您可以选中或取消选中它们，但在配置选项方面，您会发现苹果在其 iPhone 上设置的那种时尚开关更为常见。就像这样:

[![El interruptor de Boostrap 4.2 en acción](../Images/856781565ba41902e700b3adfe86744b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--jEuLjufk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://www.campusmvp.es/recursos/image.axd%3Fpicture%3D/2019/1T/bootstrap42/bootstrap42-interruptor.gif)
 ...
 *## [](#otras-novedades-de-bootstrap-42)引导程序的其他新功能 4.2

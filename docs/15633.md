...
> 原文:[https://dev . to/river sun/introduction-of-floating-window-library-jsframejs-14ho](https://dev.to/riversun/introduction-of-floating-window-library-jsframejs-14ho)
...
[![ex00](../Images/0cb3a6cd37d311dc164f95dcde4e4c82.png)T2】](https://riversun.github.io/jsframe/examples/v150/preset_yosemite_auto.html)
...
[![ex00](../Images/26d4329c2e4f291636fa992b8a7b22d8.png)T2】](https://riversun.github.io/jsframe/examples/v150/simple.html)
...
## [](#show-specified-url-as-content-of-window)显示指定的 URL 作为窗口内容
...
[![ifrmae](../Images/7439524a5052315f9ba0b85952da09b2.png)T2】](https://riversun.github.io/jsframe/examples/v150/iframe.html)

**提示**

*   你也可以在页面中获取 DOM 元素，显示为由 url(iframe)指定的窗口内容区域，你可以调用 like frame。$('#my_element ')。

## [](#show-window-as-a-modal-window)显示窗口为模态窗口
...
[![modal](../Images/124b420ff56dbd43c5e254bc35a940df.png)T2】](https://riversun.github.io/jsframe/examples/v150/modal.html)
...
[![styling](../Images/1429512227d32a576beb5ec491eeb2cc.png)T2】](https://riversun.github.io/jsframe/examples/v150/styling.html)
...
**成绩**
[![event](../Images/d28b50524fa0ce7087816b417945d860.png)](https://riversun.github.io/jsframe/examples/v150/event_handling.html)

## [](#show-toast-messages)显示祝酒辞。
...
[![toast](../Images/ef9b27e31d02b3d36eff31cb7b09d305.png)T2】](https://riversun.github.io/jsframe/examples/v150/toast.html)
...
[![toast](../Images/4ff14da1a436853d9cdbdeb8273ffbd3.png)T2】](https://riversun.github.io/jsframe/examples/v150/toast.html)

【演示】
[https://riversun.github.io/jsframe/examples/v150/toast.html](https://riversun.github.io/jsframe/examples/v150/toast.html)

# [](#window-operation-helper)窗口操作助手

## [](#determine-position-by-anchor-with-framesetposition)用**框#设定位置**确定锚位
...
## [](#focus-window-and-pull-up-to-the-front)聚焦窗口(并拉起至最前面)
...
## [](#frame-creation-initialization-parameters)帧创建初始化参数

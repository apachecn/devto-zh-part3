...
> 原文:[https://dev . to/benny powers/let-build-web-components-part-7-hybrids-187 l](https://dev.to/bennypowers/lets-build-web-components-part-7-hybrids-187l)
...
距离我们的上一部已经有一段时间了(原因我保证与《荒野之息》或《空心骑士》无关)，但是一旦你看到我们的作品，我想你会同意这是值得等待的。今天，我们正在检查我们迄今为止最不寻常和(依我拙见)有趣的 web 组件库-[](https://hybrids.js.org)**。当我们从简单的对象定义和组合组件时，准备好获得功能，并且只在需要时注册它们。**
...
### [](#hybrids-prefers-properties-to-attributes)混血儿更喜欢属性
...
### [](#binding-to-raw-class-endraw-and-raw-style-endraw-)绑定到`class`和`style`
...
## [](#final-component)最终组件

[https://stackblitz.com/edit/hybrids-lazy-image?](https://stackblitz.com/edit/hybrids-lazy-image?)T2】
...
## ![GitHub logo](../Images/75095a8afc1e0f207cda715962e75c8d.png)[hybrids js](https://github.com/hybridsjs)/[hybrids](https://github.com/hybridsjs/hybrids)

### 非凡的 JavaScript UI 框架，具有独特的声明性和功能性架构

<article class="markdown-body entry-content container-lg" itemprop="text">

# [![hybrids](../Images/8d74ae79c379cf59e26eb3206bea6a0d.png)T2】](https://raw.githubusercontent.com/hybridsjs/hybrids/main/docs/assets/hybrids-full-logo.svg?sanitize=true)

[![build status](../Images/15a5aa15be2ca9132802a84fa4bba0e4.png)](https://github.com/hybridsjs/hybrids/actions/workflows/test.yml?query=branch%3Amain)[![coverage status](../Images/bcf398742c8f6ce7ac3db3999bbc0c46.png)](https://coveralls.io/github/hybridsjs/hybrids?branch=main)[![npm version](../Images/e38aed3fd42d3a246ff244f63d653e08.png)](https://www.npmjs.com/package/hybrids)
...
[![smalluban image](../Images/6861718a2fd849252ddb6888604c411f.png)](/smalluban)

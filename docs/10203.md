...
> 原文:[https://dev.to/vnglst/using-react-hooks-with-canvas-gn8](https://dev.to/vnglst/using-react-hooks-with-canvas-gn8)

[![badly drawn letters spelling HOOKS](../Images/45891b41a067c0cd6e06d2f9e4cfc61f.png "the app does not compensate for my lack in drawing skills")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--mscVdS3y--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.koenvangilst.nl/static/e89cbdada082f09ff410cfedcc5584f0/f743c/hooks.png)
...
## [](#1st-hook-useref)1st hook: useRef
...
## [](#1st-custom-hook-usepersistentstate)第一个自定义钩子:usePersistentState
...
## [](#2nd-custom-hook-usepersistentcanvas)第二个自定义挂钩:usePersistentCanvas

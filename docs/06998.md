...
> 原文:[https://dev . to/zellwk/how-to-ignore-files-from-your-NPM-package-2fbm](https://dev.to/zellwk/how-to-ignore-files-from-your-npm-package-2fbm)
...
## [](#excluding-files-with-gitignore)用 gitignore 排除文件
...
## [](#blacklisting-files-with-npmignore)用 npmignore 将文件列入黑名单
...
## [](#whitelisting-files-with-the-files-property)使用文件属性将文件列入白名单

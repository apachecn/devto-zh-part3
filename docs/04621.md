...
> 原文:[https://dev . to/tkthetechie/handling-open fin-inbound-events-from-the-hybrid-cloud-5ab 0](https://dev.to/tkthetechie/handling-openfin-inbound-events-from-the-hybrid-cloud-5ab0)

[![](../Images/363227b4229dfb70a8544e6a3f38ce7c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--pfllVhqu--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://solace.com/wp-content/uploads/2018/10/LIGHT_Kafka-Summit-2018-Insights.png)
...
## [](#what-is-an-inbound-event)什么是进站事件？
...
## [](#dealing-with-inbound-events)处理呼入事件
...
## [](#provide-the-openfin-app-with-a-unified-subscriber-model)为 OpenFin App 提供统一的用户模型
...
### [](#events-from-webbased-services)网络服务事件
...
[![A diagram of web originated events to OpenFin through the Solace PubSub+ broker](../Images/bfe95df8aac5b20ccead3b72cf5e825b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--j1UsOXgf--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://solace.com/wp-content/uploads/2019/04/openfin-blogpost-4-image-1.png)

### [](#events-from-a-nonweb-service)事件来自非 Web 服务
...
[![A diagram of OpenFin Subscribe to Topic using the PubSub+ advanced event broker](../Images/c6342f4cf8baafa6ff03e273c7856c0f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Bk0y-Fio--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://solace.com/wp-content/uploads/2019/04/openfin-blogpost-4-image-3.png)

### [](#events-from-all-of-the-above)事件来源于“上述的一切”

当您有数据来往于许多服务时，代理是最有用的。在大型 OpenFin 安装中，许多源和许多应用程序需要自由交换信息是非常常见的。

[![A diagram titled "All Inbound OpenFin Events Through a Broker."](../Images/64990827d6b6a87e53182f7bd3155f47.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--H0h13Zuv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://solace.com/wp-content/uploads/2019/04/openfin-blogpost-4-image-4.png)

## [](#coordinating-inbound-events-with-a-multiprotocol-broker)用多协议代理协调入站事件

...
> 原文:[https://dev . to/steel wolf 180/building-restful-API-with-flask-postman-pytest-part-3-read-time-20-mins-26ha](https://dev.to/steelwolf180/building-restful-api-with-flask-postman--pytest---part-3-read-time-20-mins-26ha)

[![Photo by Rachael Gorjestani on Unsplash](../Images/ee27000829f8fd25318cdd79e52a2fc4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--0XfsjAQv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/x0j4u0q0fm8twxlshtt4.jpg)
...
## [](#endpoints-to-create)端点创建

现在是本系列的最后一部分，我们将介绍只使用 **GET** HTTP 请求方法的 **CRUD** 函数。

既然**放**、**贴**和**删**端点的创建是一样的，那就不如介绍一下 **Pytest** 的使用。

### [](#the-endpoints-and-api-documentation-the-final-part)端点和 API 文档最后部分:
...
### [](#creating-a-project-folder)创建项目文件夹
...
### [](#installing-python-packages)安装 Python 包
...
## [](#creating-your-first-flask-app)创建你的第一个烧瓶应用程序
...
### [](#executing-your-flask-app)执行您的 Flask 应用程序
...
[![happy giphy](../Images/8e3f4ba0ed9a5097e19cdc9617e3deb7.png)T2】](//images.ctfassets.net/ly2f59p4unnn/76Ku1K7YENHrA550LOPLAU/0ea27c050c07c43c7bb1dbe7331ad510/happy_giphy.gif)

### [](#development-mode-in-flask)烧瓶中的发育模式
...
## [](#creating-your-first-rest-api-endpoint)创建您的第一个 REST API 端点
...
[![mic drop giphy](../Images/13a675dabda654596de150b18468db6e.png)T2】](//images.ctfassets.net/ly2f59p4unnn/4J8cA5UWpCyxyNiofVcdO1/830f9326a4a7903cb21f067ccfd5f91a/mic_drop_giphy.gif)

## [](#creating-bash-script-for-configuration-settings)为配置设置创建 Bash 脚本
...
## [](#creating-your-first-test-case)创建你的第一个测试用例

现在我们将开始为您的 flask API 端点创建第一个测试用例。

我们将通过检查 **index.page** 是否提供 HTTP 响应来测试 flask 应用程序是否正在运行。

### [](#creating-testendpointspy)创建 test_endpoints.py
...
### [](#executing-the-testendpointspy)执行 test_endpoints.py
...
[![sad giphy](../Images/d16d224d792a7c7a7010266883f605d4.png)T2】](//images.ctfassets.net/ly2f59p4unnn/2HwQC1oQFu1LkzUtGZT4Ez/3f3b4d42900bf4a53486a9d8f40af17c/sad_giphy.gif)

[![pytest1](../Images/08019a376aae5e948c11d7b72ce6188b.png)T2】](//images.ctfassets.net/ly2f59p4unnn/31VfT8yB4gryosbrlv0aSX/07f297cf539e71f8de50b426ad3218e9/pytest1.png)
...
### [](#create-your-index-endpoint)创建你的索引端点
...
[![pytest2](../Images/6119c7ff9af74c198426ee893ea3c515.png) ](//images.ctfassets.net/ly2f59p4unnn/3wjoHfbNiV7N4WUFmhhdm7/ac0e91696436e819cb9f5da62259977d/pytest2.png) [ ![happy giphy](../Images/19ec2eecfa54bb90639f30b55e2b1942.png)](//images.ctfassets.net/ly2f59p4unnn/3NQcfgJZ1CxNspBPkS3eBz/4f5a92c82b156560d247ee8b7375ded0/happy_giphy.gif)

## [](#creating-expenses-manager-endpoints)创建费用管理器端点

因为您已经开始使用 **Pytest** 在 **Flask** &测试用例中创建您的第一个端点。

让我们回顾一下创建 expanses manager 需要创建的 API 列表:

### [](#list-of-api-to-create)要创建的 API 列表:
...
### [](#get-list-of-transactions)获取交易列表

现在从第一个 **GET** 端点开始，它提供了一个事务列表。

我们需要创建什么样的**最小测试**来检查它是否有效？

#### [](#creating-user-stories)创建用户故事

[![foo fighters storie](../Images/2fd87a14917c72b621eb831ac8a08a06.png)T2】](//images.ctfassets.net/ly2f59p4unnn/2IQ1LTkNyWQihoFSlIS4NR/1a9ae6b1daf415383ecdd90b4e146c66/foo_fighters_storie.gif)
...
#### [](#creating-test-case-for-balance-in-the-expenses-manager)在费用管理器中创建平衡测试用例
...
#### [](#have-you-completed-the-user-story)用户故事完成了吗？
...
#### [](#get-number-of-transactions-in-transactions-endpoint)获取交易端点中的交易数量
...
#### [](#checking-the-fields-of-an-individual-transaction)检查单笔交易的字段

[![book checking efteling](../Images/4803b1e6d7a4ab374025e77268fb9ae1.png)T2】](//images.ctfassets.net/ly2f59p4unnn/5IWyUCc83CrmrSvlcVaOqw/8ff28ccab673a056463302b528b2ccef/book_checking_efteling.gif)
...
#### [](#refactoring-to-a-single-class)对单个类进行重构
...
### [](#basics-of-test-driven-development)测试驱动开发的基础

[![practice makes perfect](../Images/98f323ec58fe3cce8b87f09a34ac7fff.png)](//images.ctfassets.net/ly2f59p4unnn/01lKoShJbMJQYoEs44XtoQ/f8f8e819316599990d13108b01b412b2/practice_makes_perfect.gif) 
...
### [](#remaining-endpoint-stories)剩余端点故事
...
### [](#expanses-manager-source-code)[Expanses Manager 源代码](https://github.com/steelwolf180/expanses_manager)

### [](#api-documentation-in-postman)[邮递员中的 API 文档](https://documenter.getpostman.com/view/4542874/RztitA2G)

### [](#writing-test-cases-form-user-stories-from-acceptance-criteria)[根据验收标准编写测试用例形成用户故事](https://blog.testlodge.com/writing-test-cases-from-user-stories-acceptance-criteria/)

### [](#user-story)[用户故事](https://www.scaledagileframework.com/story/)

### [](#test-driven-development-what-it-is-and-what-it-is-not)[测试驱动开发:是什么，不是什么。](https://medium.freecodecamp.org/test-driven-development-what-it-is-and-what-it-is-not-41fa6bca02a2)

### [](#python-testing-with-pytest)[用 Pytest 测试 Python](https://www.amazon.com/Python-Testing-pytest-Effective-Scalable/dp/1680502409)

### [](#flask)[烧瓶](http://flask.pocoo.org/)

### [](#pytest)[PyTest](https://docs.pytest.org/en/latest/)

### [](#http-request-method)[HTTP 请求方式](https://developer.mozilla.org/en-US/docs/Web/HTTP/Methods)

### [](#http-status-codes)[HTTP 状态码](https://www.restapitutorial.com/httpstatuscodes.html)

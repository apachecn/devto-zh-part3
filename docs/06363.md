...
> 原文:[https://dev . to/bnevilleoneill/why-you-should-use-focus-styles-6 F5](https://dev.to/bnevilleoneill/why-you-should-use-focus-styles-6f5)

[![](../Images/b8c31bf85f10a27a3422febf882b0e85.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--hbM8JtPg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AHqrhJCteIYrKACTJHyHavQ.png)

人们会以多种方式使用你的网站。有些使用鼠标，有些使用触摸设备，有些使用屏幕阅读器，有些只使用键盘。在这篇文章中，你将学习所有关于焦点指示器的知识，如何设计它们，以及为什么它们对许多用户来说很重要。

### [](#what-are-focus-indicators)什么是专注指标？

聚焦输入元素时见过蓝色轮廓吗？这是浏览器用来指示元素被聚焦的本机焦点样式。

[![](../Images/905f5f2de68723332e81a2eb54725b43.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--jsjrIFMD--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/600/0%2A6WY1P39fcvRunlPa)
...
### [](#why-focus-styles-are-important-for-accessibility)为什么焦点样式对可访问性很重要
...
#### [](#people-with-limited-mobility)行动不便的人

有些人不会用鼠标。他们可能会使用类似于嘴棒的东西来操作标准键盘，或者模拟键盘的开关。

#### [](#people-with-low-vision-or-cognitive-disabilities)视力低下或认知障碍的人

有些人使用屏幕阅读器，它主要是通过键盘控制的。

此外，还有很多人暂时依靠一个键盘。例如，鼠标坏了的人。

### [](#change-the-style-of-focus-indicators)改变焦点指示器的样式
...
### [](#focuswithin%E2%80%8A%E2%80%8Ahow-to-style-the-parent-element-of-a-focusable-element):焦点在内——如何设置可聚焦元素的父元素的样式
...
### [](#dont-show-focus-styles-when-interacting-with-a-mousepointer%E2%80%8A%E2%80%8Athe-focusvisible-pseudo-class)与鼠标/指针交互时不显示焦点样式——focus-visible 伪类

...
> 原文:[https://dev.to/vintharas/typescript-javascript-类型-牛逼-开发者-生产力-1048](https://dev.to/vintharas/typescript-javascript--types--awesome-developer-productivity-1048)
...
## [](#you-shall-only-use-types)只能使用类型！
...
## [](#javascript-types-awesome-dev-productivity)JavaScript +类型=出色的开发效率
...
## [](#any-javascript-is-valid-typescript)任何 JavaScript 都是有效的 TypeScript

> ### [](#experiment-javascriptmancer)实验 JavaScriptmancer！！
> 
...
## [](#so-what-are-the-advantages-and-disadvantages-of-typescript)那么，TypeScript 的优缺点是什么？
...
## [](#setting-up-a-simple-typescript-project)设置一个简单的 TypeScript 项目
...
## [](#cool-typescript-features)超酷的打字稿功能

除了类型注释，TypeScript 还通过 ESnext 特性和它自己的一些特性改进了 JavaScript。

> ### [](#typescript-brings-you-a-lot-of-esnext-features)TypeScript 带给你很多 ESnext 的特性
> 
...
#### [](#why-do-i-get-a-typescript-error-when-writing-an-es6-class-isnt-it-valid-javascript)为什么我写 ES6 类的时候会出现 TypeScript 错误？不是有效的 JavaScript 吗？
...
### [](#still-prefer-strings-check-this-string-literal-types)还是更喜欢字符串？检查此字符串文字类型
...
### [](#object-spread-and-rest)物体分散而静止
...
## [](#type-annotations-in-typescript)在 TypeScript 中键入注释
...
### [](#typescript-helps-you-with-type-annotations)TypeScript 帮助你进行类型标注
...
### [](#from-interfaces-to-classes)从接口到类
...
### [](#advanced-type-annotations)高级类型注释
...
#### [](#intersection-and-union-types)交集和并集类型
...
## [](#working-with-typescript-in-real-world-applications)在现实世界应用中使用 TypeScript
...
### [](#typescript-and-third-party-libraries)TypeScript 和第三方库
...
> 
> ### [](#earn-some-time-a-wall-of-ice)赚点时间！一堵冰墙！
> 
...
> ```
> 
> ### [](#empower-your-companions-with-enchantments)用附魔来给同伴赋能！
> 

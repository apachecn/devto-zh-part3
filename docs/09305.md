...
> 原文:[https://dev . to/dacog/how-to-find-files-using-regex-regular-expressions-in-GNU-Linux-and-MAC OS-command-line-and-do-something-ne](https://dev.to/dacog/how-to-find-files-using-regex-regular-expressions-in-gnu-linux-and-macos-command-line-and-do-something-ne)
...
## [](#enter-regular-expressions-)输入正则表达式:)
...
### [](#find-all-the-jpg-and-png-files-which-have-300x200-or-400x220-in-their-filenames)找到所有文件名中有 *300x200* 或 *400x220* 的 jpg 和 png 文件。
...
### [](#find-all-the-png-and-jpg-files-with-raw-sam-endraw-somewhere-in-the-filename)**查找文件名中某处带有`SAM`的所有 png 和 jpg 文件**

`'.*(SAM).*\.(jpg|png)'`
这将找到以下文件

[![Files found by previous expression](../Images/091519dffdc40e773896d4c583aa50ee.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--4T2zxBJT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://dev-to-uploads.s3.amazonaws.com/uploads/articles/im84wv6zhqvqwa4316vc.png)
...
## [](#now-lets-learn-raw-xargs-endraw-)现在我们来学习`xargs`

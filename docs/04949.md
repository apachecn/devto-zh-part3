...
> 原文:[https://dev . to/eice blue/create-and-read-word-document-in-Java-kcm](https://dev.to/eiceblue/create-and-read-word-document-in-java-kcm)

## [](#introduction)简介

Word 文档是我们日常工作中最常用的文件类型之一，而创建和阅读 Word 文档是使用 Word 文档时最常见的需求。在本文中，我们将学习如何用 java 以编程方式创建一个 word 文档并读取 Word 文档中的文本内容。

## [](#the-word-processing-library-we-need)我们需要的文字处理库
...
[![Create Word](../Images/d04e7221f66b1412293b8f7c2dd33d7f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---y7VSwaR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/edlva46lsnymb7jc8bbc.png)

## [](#read-text-content-in-a-word-document)读取 Word 文档中的文本内容
...
[![Read Word Document](../Images/42e31f2c2c4b48f33c290972e3f1fcb8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--JVhlVkxr--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/j021apwanm5pbtn6dvhr.png)

...
> 原文:[https://dev . to/harshadranganathan/setting-up-kubernetes-on-windows-with-minikube-2pp 6](https://dev.to/harshadranganathan/setting-up-kubernetes-on-windows-with-minikube-2pp6)
...
## [](#install-virtualbox)安装 VirtualBox
...
## [](#running-kubernetes-cluster-in-virtualbox)在 VirtualBox 中运行 Kubernetes 集群

### [](#start-minikube)启动 Minikube
...
## [](#running-kubernetes-cluster-in-hyperv)在 Hyper-V 中运行 Kubernetes 集群

### [](#create-vswitch)创建 vSwitch
...
[![](../Images/528036d8cb4443e3fe5b9e47e4a8ce5c.png)T2】](https://rharshad.com/assets/img/2018/11/hyper-v-manager-vswitch.png)
...
[![](../Images/0b8be66a2fefa0c9fef60f980090965c.png)T2】](https://rharshad.com/assets/img/2018/11/windows-wifi-properties.png)
...
## [](#interacting-with-your-cluster)与你的集群互动

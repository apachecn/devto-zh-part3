...
> 原文:[https://dev . to/am2/using-powershell-to-tidy-up-CSV-files-3kno](https://dev.to/am2/using-powershell-to-tidy-up-csv-files-3kno)

[![](../Images/5cfe71155e25b640663c99aa73be972e.png)](https://www.youtube.com/watch?v=ptM7FzyjtRk) 我最近在为一个列数不一致的 CSV 文件而烦恼。呃。有一堆历史数据有 4 列，然后最近的数据有一个新的属性，增加了 5 列。我花了几分钟时间诅咒该为此负责的人，然后继续前进。
...
<figure>[![](../Images/b9a9d3703bd6c561c055eca3396f5b37.png)](http://am2.co/wp-content/uploads/Csv-PowerShellFirst3.png) 
...
[![](../Images/141b427241ce790345de84ffde0059a5.png)](http://am2.co/wp-content/uploads/CSV-FlatFileImportSuccess.png) 

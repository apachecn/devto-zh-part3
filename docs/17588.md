...
> 原文:[https://dev . to/tzemanovic/abstraction-levels-in-functional-programming-5cd 2](https://dev.to/tzemanovic/abstraction-levels-in-functional-programming-5cd2)
...
1.  [超快的 html](https://elm-lang.org/blog/blazing-fast-html-round-two)T2】↩

2.  [小资产无头痛](https://elm-lang.org/blog/small-assets-without-the-headache)T2】↩

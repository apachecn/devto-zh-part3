...
> 原文:[https://dev.to/pbnj/demystifying-stride-threat-models-230m](https://dev.to/pbnj/demystifying-stride-threat-models-230m)
...
## [](#what-is-a-threat-model)什么是威胁模型？

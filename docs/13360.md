...
> 原文:[https://dev . to/vncz/security-in-your-open API-specification-422g](https://dev.to/vncz/security-in-your-openapi-specification-422g)

## [](#importance-of-security-during-the-api-design-phase)安全性在 API 设计阶段的重要性
...
## [](#openapi-history-what-why-when)OpenAPI 历史:什么，为什么，什么时候
...
## [](#openapi-20)OpenAPI 2.0

### [](#format-overview)格式概述
...
### [](#format-overview-and-improvements-over-openapi-20)格式概述及对 OpenAPI 2.0 的改进
...
## [](#handson-designing-a-secure-api)动手操作:设计安全的 API
...
### [](#create-an-openapi-specification)创建一个 OpenAPI 规范
...
### [](#integrate-your-openapi-security-specification-in-auth0)在 Auth0 中集成您的 OpenAPI 安全规范

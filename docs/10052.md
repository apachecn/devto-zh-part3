...
## [](#graphql-servers-whats-happening)GraphQL 服务器-发生了什么
...
#### [](#typedefs-schemagraphql)typeDefs (schema.graphql)
...
## [](#prepping-the-schema-and-resolvers)准备模式和解析器
...
### [](#2-schemagraphql)2。schema.graphql
...
### [](#-raw-userid-id-user-endraw-)`user(id: ID!): User`
...
### [](#-raw-createusername-string-user-endraw-)`createUser(name: String!): User!`
...
### [](#3-mutationjs-mutation-resolvers)3。突变. js(突变解析器)
...
### [](#4-queryjs-query-resolvers)4。Query.js(查询解析器)
...
## [](#creating-the-graphql-server)创建 GraphQL 服务器

终于！创建我们的服务器的一切都已就绪。这(可以说)是容易的部分。我们将逐步解决这个问题。

### [](#1-create-an-indexjs-in-your-root-folder)1。在你的根文件夹中创建一个 *index.js* 。

### [](#2-install-the-dependencies)2。安装依赖项:
...
### [](#3-import-everything-you-need-into-indexjs)3。将您需要的所有内容导入 index.js
...
### [](#4-create-db-using-prisma-client-constructor)4。使用 Prisma 客户端构造函数创建数据库
...
## ![GitHub logo](../Images/a73f630113876d78cff79f59c2125b24.png) [瑞安姆道尔](https://github.com/ryanmdoyle) / [普里斯马-graph QL-教程](https://github.com/ryanmdoyle/prisma-graphql-tutorial)

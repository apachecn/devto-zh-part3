...
> 原文:[https://dev . to/gruberb/intro-to-web-programming-in-rust-for-nodejs-developers-LP](https://dev.to/gruberb/intro-to-web-programming-in-rust-for-nodejs-developers-lp)
...
[![os_difference_node_rust](../Images/cdf5c13567e25b912d2e0a9da6c09bbc.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--GlOGwyn3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gruberb/web-programming-in-rust/master/assets/rust.png)

### [](#how-much-web-is-in-rust)到底有多少“网”在生锈？

Rust 中不包含标准 http 库是一个设计决策[。因此，OSI 层的覆盖范围有所不同:](https://users.rust-lang.org/t/announcing-the-http-crate/12123)

[![osi_layer_rust_node](../Images/8668c27f5952e0ec3036282c2af76d05.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ft65Gc-I--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gruberb/web-programming-in-rust/master/assets/rustnode.png)
...
### [](#asnyc-programming-aka-promises-aka-futures)Asnyc 编程又名承诺又名期货
...
### [](#heads-up-undefined-borrowing-and-types)平视:未定义、借用和类型

为了在我的下一篇文章之前不感到沮丧，这里有你必须习惯的关于 Rust 的四件主要事情(过一段时间后会很棒)。

[![updated_reqwest_example](../Images/9c51164d4b34b0d1200fd63e8efe11b4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--0Onwtnkz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gruberb/web-programming-in-rust/master/assets/code.png)

...
> 原文:[https://dev . to/lleonardogr/how-to-create-an-evolve-architecture-from-legacy-databases-pt-2-2d F9](https://dev.to/lleonardogr/how-to-create-an-evolutive-architecure-from-legacy-databases-pt-2-2df9)
...
[![Schemas](../Images/e37dd880167b9f559834fc6a8c8cd5e5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--emLUwaPH--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://encaixandoblocoshome.files.wordpress.com/2019/03/schemas-e1553652631259.png)
...
### [](#3-remember-the-normal-forms)3。记住标准形式

随着时间的推移，我们发现创建完全符合我们要求的数据库的过程是很自然的，这样，我们就可以忘记数据库规范化的重要性。

### [](#4-structure-your-stored-procedures-and-jobs)4。构建您的存储过程和作业

[![StoredProcedures](../Images/527173b1f24d7f05c839ee27e2630128.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--qgF6sQRj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://encaixandoblocoshome.files.wordpress.com/2019/03/storedprocedures-1.png)

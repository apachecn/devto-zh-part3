...
> 原文:[https://dev . to/coder _ blvck/possible-ways-to-reduce-your-web pack-bundle-size-js-secrets-550](https://dev.to/coder_blvck/possible-ways-to-reduce-your-webpack-bundle-size-js-secrets-550)

[![Promotional Image](../Images/650496206315fb2aea5cf887d44ae9c9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--D_GSwpKK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/proxy/1%2AmMApZzre4jYR5owWyF8Vug.jpeg)
...
### [](#use-webpack-4-in-production)生产中使用 WEBPACK 4
...
### [](#use-lodashwebpackplugin)使用 lodash web pack 插件
...
### [](#use-a-bundle-analyzer-tool)使用捆绑包分析器工具

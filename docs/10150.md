...
> 原文:[https://dev.to/gcanti/getting-started-with-fp-ts-monoid-ja0](https://dev.to/gcanti/getting-started-with-fp-ts-monoid-ja0)
...
## [](#monoids-for-type-constructors)用于类型构造函数的幺半群

...
> 原文:[https://dev . to/vintharas/exploring-vim-the-10 or-so-things-you-need-to-go-through-dip-2dj](https://dev.to/vintharas/exploring-vim-the-10-or-so-things-you-need-to-know-to-go-through-the-dip-2dj)
...
[![Getting Through The Vim Dip](../Images/6431e18a6d002aa9bca8e9049bf1a62e.png "Getting Through The Vim Dip")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--bxH36xHu--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.barbarianmeetscoding.com/images/getting-through-the-vim-dip.jpg)
...
[![Getting Through The Vim Dip Quote](../Images/c01ffea5586724f173f43f2f966b0cb9.png "Getting Through The Vim Dip")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--PtjNu1EE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/f0p0lo4zl0tpab921s80.jpg)
...
## [](#opening-creating-and-saving-files-in-vim)在 Vim 中打开、创建和保存文件
...
> ### [](#overwhelmed-by-all-the-commands)被所有的命令淹没？
> 
...
## [](#moving-swiftly-inside-a-file-with-vim-motions)以 Vim 动作在文件内快速移动

> ### [](#are-you-a-touch-typist)你是触摸打字员吗？
> 
...
> ### [](#why-map-stuff-early-on)为什么要早早地绘制地图？
> 
...
> ### [](#vimrc-leader-map-and-noremap)vimrc？领导？Map 和 Noremap？
> 
...
> ### [](#not-seeing-any-highlights-when-searching)搜索时看不到任何亮点？
> 
...
## [](#text-editing-like-theres-no-tomorrow)文字编辑喜欢没有明天
...
> ### [](#copy-and-pasting-characters-vs-lines)复制粘贴字符 vs 线条
> 
...
> ### [](#an-amazing-way-to-extend-vim)扩展 Vim 的惊人方法...
> 
...
## [](#inserting-code-aka-writing-code)插入代码又称编写代码
...
## [](#abbreviations-they-sound-boring-but-they-are-awesome)缩写。他们听起来很无聊，但他们很棒
...
## [](#windows-and-tabs-wizardry)窗口和标签向导
...
[![Splitting windows in vim](../Images/8528bbc15ca8b79983cf2bd41a5c93b3.png "Splitting windows in vim")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--KLV4nsS2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.barbarianmeetscoding.com/images/vim-window-splitting.jpg)
...
## [](#the-one-thing-you-should-learn-about-visual-mode)关于视觉模式你应该了解的一件事
...
## [](#a-very-useful-ex-command)一个非常有用的 Ex 命令
...
### [](#creating-a-habit-of-improving-vim)养成改善 Vim 的习惯
...
### [](#learning-to-use-vims-help)学习使用 Vim 的帮助
...
> ### [](#cant-exactly-find-what-you-want)找不到自己想要的东西？
> 
...
[![Vim's awesome help](../Images/e433542e153d01216b4b8168120c592d.png "Vim's awesome help")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--NgY3BL_l--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.barbarianmeetscoding.com/images/vim-help.jpg)
...
[![Vim's awesome help includes plugins](../Images/209ab249fe1b7de81cb7fb355ed74967.png "Vim's awesome help includes plugins")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--wkkFa19Z--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.barbarianmeetscoding.com/images/vim-plugin-help.jpg)

### [](#vimtutor-at-least-once)Vimtutor 至少一次

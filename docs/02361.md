...
> 原文:[https://dev . to/tsalikispk/uploading-an-Android-library-on-jcenter-2d df](https://dev.to/tsalikispk/uploading-an-android-library-on-jcenter-2ddf)
...
[![TargetLayout animation](../Images/e851ec0b98b19a3f686da2ddf955026e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--dnbbU7yX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://www.droidship.com/gifs/targetlayout.gif)
...
# [](#adding-ci-on-your-opensource-library)在您的开源库上添加 CI
...
## [](#explaining-the-travisyml)讲解. travis.yml
...
# [](#updating-gradle-versions-and-moving-on-androidx)更新 gradle 版本，在 AndroidX 上移动
...
## [](#lets-build-and-publish-locally)让我们在本地构建和发布
...
## [](#so-where-should-we-upload-then)那么我们应该上传到哪里呢？

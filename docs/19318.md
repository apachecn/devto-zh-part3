...
> 原文:[https://dev.to/andercodes/security-htpp-headers-30c 6](https://dev.to/andercodes/security--htpp-headers-30c6)

> ### [](#do-you-know-most-the-security-vulnerabilities-can-be-fixed-by-implementing-necessary-headers-in-response-header)“您知道大多数安全漏洞可以通过在响应报头中实现必要的报头来修复吗？”
> 
> -钱丹·库马尔

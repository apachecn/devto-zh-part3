...
> 原文:[https://dev . to/kh4l 33 l/intro-to-PHP-for-初学者-模块-1-1m7b](https://dev.to/kh4l33l/intro-to-php-for-beginners-module-1-1m7b)

# [](#1-introduction-to-php)1。PHP 简介
...
[![](../Images/796ed0864c5300cd63d7ccf82103667a.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--2hF1JRuP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/k7o2me0ckn7yck14m5cg.jpg) 
...
# [](#availability-across-multiple-platforms)跨多个平台的可用性

用户可以在 Windows、Linux 或 MAC 上使用 PHP。

# [](#installing-as-a-module-for-apache-web-server)作为 Apache Web 服务器的模块安装

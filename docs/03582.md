...
> 原文:[https://dev.to/voidjuneau/java-regex-cheat-sheet-ob0](https://dev.to/voidjuneau/java-regex-cheat-sheet-ob0)
...
#### [](#if-there-is-a-match-exist)如果有匹配存在。

...
> 原文:[https://dev.to/hertz4/rust-impl-trait-for-programmers-k15](https://dev.to/hertz4/rust-impl-trait-for-programmers-k15)

[![Header](../Images/8448656d5d0fb41ca2a8e3d3f4d0c28e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--a1Nn5Cm1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/65m72cdmjuuor8r8rzqy.png)
...
## [](#argument-impl-trait)自变量 impl Trait
...
## [](#relationship-to-dyndynamic-types)与 dyn/动态类型的关系
...
## [](#applied-example-return-position)应用示例(返回位置)

...
> 原文:[https://dev . to/sirech/mock-verification-in-kot Lin-using-mock-and-atrium-glk](https://dev.to/sirech/mock-verification-in-kotlin-using-mockk-and-atrium-glk)
...
## [](#mockk-and-atrium-a-powerful-combo)莫克和中庭，一个强大的组合
...
### [](#testing-the-wrapped-request)测试被包装的请求

...
> 原文:[https://dev.to/joaofbantunes/episode-016-身份认证-与-剃刀-页面-aspnet-core-from-0-to-over-kill-82k](https://dev.to/joaofbantunes/episode-016---authentication-with-identity-and-razor-pages---aspnet-core-from-0-to-overkill-82k)
...
## [](#main-options-to-implement-authentication)实现认证的主要选项
...
### [](#1-new-web-application-with-identity-preconfigured)1。预配置了身份的新 web 应用程序
...
### [](#2-adding-identity-to-an-application-using-the-scaffolding-tool)2。使用脚手架工具向应用程序添加身份
...
### [](#3-add-identity-to-an-application-manually)3。手动向应用程序添加身份
...
### [](#4-ignore-identity-roll-our-own)4。无视身份，滚自己的
...
## [](#creating-the-web-application)创建 web 应用

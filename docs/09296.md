...
> 原文:[https://dev.to/dhilipkmr/creating-a-cycliccarousel-3j16](https://dev.to/dhilipkmr/creating-a-cycliccarousel-3j16)

[![](../Images/119dd8a37d1cecc4beba031ba024843c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--31fkQ50V--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/eml2hzya6ekkcwmcgqsx.png)
...
[![](../Images/d56885684eeef1e6d77ef123878179ce.png)T2】](https://i.giphy.com/media/aLKXj8KO0WB8c/giphy.gif)

### [](#what-are-we-going-to-build)我们要造什么？

我们的最终产品如下图所示:

[![](../Images/43cde09bd1d6fb095ec4b30bd96bfe73.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--bXubxsrM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/trjo2h7qchnwi3wcp8vt.gif)

## [](#application-outline)应用概要:
...
## [](#stepping-into-carousels)步入旋转木马…
...
## [](#understanding-the-declared-variables)理解声明的变量。
...
## [](#carousel-static%C2%A0css)轮播静态 Css:
...
### [](#understanding-how-changing-the-center-and-image-cycling-works)了解改变中心和图像循环的工作原理:
...
### [](#on-clicking-the-image-execution-of-changecenter-begins)点击图像，开始执行 changeCenter
...
## [](#constructing-visible-items%C2%A0props)构造可见物品的道具:
...
[![](../Images/5f2e41241acc421cee9bdefbbd453956.png)T2】](https://i.giphy.com/media/gS2l5jPcE0F4A/giphy.gif)
...
[![](../Images/e6101fcfc9151995b8529ca7ff6eb796.png)T2】](https://i.giphy.com/media/113PoJxEaRxKbm/giphy.gif)
...
> 原文:[https://dev . to/flying nobita/how-do-I-deploy-a-machine-learning-we B- app-525 f](https://dev.to/flyingnobita/how-do-i-deploy-a-machine-learning-web-app-525f)
...
## [](#why-does-deployment-matters)为什么部署很重要？
...
## [](#where-should-inference-take-place)推理应该发生在哪里？
...
## [](#mobile-device-implementation)移动设备实现
...
<figure>[![Server Implementation Spectrum](../Images/5a7e5eb36b72bd1c88380ff68ea51d34.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--PAgi9RRS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://res.cloudinary.com/flyingnobita/image/fetch/c_limit%2Cf_auto%2Cq_auto%2Cw_768/https://flyingnobita.com/assets/images/posts/machine_learning_deployment__server_implementation_spectrum.webp) 
...
### [](#vps-virtual-private-servers)VPS -虚拟专用服务器
...
### [](#ml-paas-machine-learning-platform-as-a-service)ML PaaS -机器学习平台即服务

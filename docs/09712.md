...
> 原文:[https://dev . to/bnevilleoneill/a-complete-guide-to-threads-in-node-js-25np](https://dev.to/bnevilleoneill/a-complete-guide-to-threads-in-node-js-25np)

[![](../Images/7a29ec601d8d149a848630c367230a24.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--7MgV7LSs--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AQTODd4nr6g7PNcLKqrlfCg.jpeg)
...
### [](#introducing-workerthreads)简介:*工作者 _ 线程*
...
### [](#exchanging-data-between-threads)线程间交换数据
...
#### [](#sharing-memory-between-threads)线程间共享内存
...
#### [](#creating-a-channel-for-communications)创建沟通渠道
...
### [](#two-ways-of-using-workers)工人的两种使用方式
...
### [](#implementing-settimeout)实现 setTimeout
...
### [](#implementing-a-worker-pool)实现一个工人池

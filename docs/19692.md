...
> 原文:[https://dev . to/matt conn/text-based-level-editing-and-phaser-js-124 o](https://dev.to/mattconn/text-based-level-editing-and-phaser-js-124o)
...
### [](#the-roomrendering-function-abridged)房间渲染功能(删节)

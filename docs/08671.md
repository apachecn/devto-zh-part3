...
> 原文:[https://dev . to/lambdatest/it-s-2019-let-s-end-the-debate-on-icon-fonts-vs-SVG-icons-21k](https://dev.to/lambdatest/it-s-2019-let-s-end-the-debate-on-icon-fonts-vs-svg-icons-21k)
...
## [](#a-brief-history-of-web-icons)网络图标简史
...
[![](../Images/3ca3bd254d8c737404faa56647210bdc.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--H_cN9Nw3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2000/0%2ACmH1EHHQA1sGHrz0.png)
...
[![](../Images/1749555956f35289f534dada1a1efa83.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--t7dOhTLg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2000/1%2AottwRNBxTw0jRVQk_f44FQ.png)
...
## [](#revolutionary-icon-fonts)革命图标字体！
...
[![](../Images/03e77372e8e6c2e9250e9254d4e574cd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--wEHJ04um--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2398/1%2Anjq7KqRhOKye6lb7MSPjwQ.png)
...
## [](#dazzling-svg-icons)眼花缭乱的 SVG 图标！
...
[![](../Images/06b8f8f1d131aaf872d5421e8c662057.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--k09tlAI4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2000/1%2AQZiHyVHSpyg_Pbh3Au6E8Q.png)
...
## [](#comparing-icon-fonts-vs-svg-icons)比较图标字体与 SVG 图标
...
## [](#8-cross-browser-compatibility)8。跨浏览器兼容性
...
[![](../Images/001810351bb43bf11278bde14979a8b7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--OU-ayBoi--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/3168/0%2Ab8pxvo9ByfDQ9MGb.png)

如果我们着眼于大规模实现 SVG，那么跨浏览器兼容性将是一个重大挑战。例如:

HTML 的 SVG 效果

[![](../Images/997b823fd8dfe9272aa832ab6ff3d5ca.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--bjcWfXSN--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2690/0%2AX-_G1g35WCZNZwP8.png)
...
[![](../Images/10c46af304ccee15b89ae36235da984f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--KBb_k2d---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2610/0%2AJIYCvWrK_Gb6z9NG.png)

→或者，即使我们谈论 **SVG SMIL 动画**。众多浏览器版本仍然面临着浏览器兼容性问题。

[![](../Images/dab21d6c3e795ce5f92b99f4a92a1b67.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--AIu4qbHc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2640/0%2AZ-2bG3T8ZgpBSjrD.png)
...
## [](#how-to-build-your-svg-icon-system)如何构建你的 SVG 图标系统？
...
## [](#step-1-converting-woffttfotf-into-svg)步骤 1 —将 WOFF/TTF/OTF 转换成 SVG

将 WOFF/TTF/OTF 格式的图标字体转换成 SVG 图标的最佳工具是[在线字体转换工具](https://onlinefontconverter.com/)。访问网站，选择输出字体类型为 SVG。

[![](../Images/569d6266d6c0bcb6836f6e0259470d23.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--5onhOzEk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2000/0%2AZTi41AaIPMlE3Hxc.png)

现在提取 zip 文件，并将 svg 图标(SVG 扩展名)文件放在 fonts 文件夹中。将你所有的图标字体转换成 SVG 字体。

## [](#step-2-build-your-svg-icon-system)步骤 2 —构建您的 SVG 图标系统
...
[![](../Images/e4a107f3c415db568185f0f51cf5c7dc.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Ql1zpQwx--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2000/0%2A8EVr8vV8J75WL1bk.png)
...
[![](../Images/97a2b5558a04b9a796c60d0f8b5cc659.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--E7ZJsd-O--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/3200/0%2AugoINxWFm_nVfeD6.png)

## [](#step-3-using-your-svg-icon-system)步骤 3 —使用您的 SVG 图标系统
...
## [](#step-4-how-to-style-svg-icons)步骤 4 —如何设计 SVG 图标的样式

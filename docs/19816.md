...
> 原文:[https://dev . to/mokkapps/why-a-good-frontend-developer-should-care-web-accessibility-545m](https://dev.to/mokkapps/why-a-good-frontend-developer-should-care-about-web-accessibility-545m)
...
# [](#tools-which-can-assist-in-browsing-a-website)可以辅助浏览网站的工具
...
[![Screen Reader Video](../Images/b2a89ec77a7e0d4a8813553d133d8b14.png)T2】](https://www.youtube.com/watch?v=xpP_Km5L46E)
...
[![HTML5 Doctor](../Images/d2b8d78174c7725b7686bf8633800926.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--WUgY3qGr--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.mokkapps.de/static/9878e326739b304f6d4e5c8a03b8c07f/44d6a/html5-doctor.png)
...
# [](#is-it-really-so-timeconsuming-to-implement-accessibility)实现无障碍真的这么费时间吗？

是的，如果项目已经处于后期阶段，或者您有一个遗留代码库，有大量的可访问性问题，您现在需要修复。

不会，如果你能从项目一开始就考虑易访问性，并在整个开发过程中关心它。

# [](#why-an-accessible-website-is-a-good-website)为什么易访问的网站是好网站

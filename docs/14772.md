...
> 原文:[https://dev . to/lambdatest/CSS-with-feature-detection-for-cross-browser-compatibility-3 ADH](https://dev.to/lambdatest/css-with-feature-detection-for-cross-browser-compatibility-3adh)
...
### [](#why-browsers-render-content-inconsistently)为什么浏览器呈现内容不一致？

[![](../Images/33a40041034d909e7413e89756e8c42b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--sll03opJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/01/pasted-image-0-7-2.png)
...
[![](../Images/8f053acf389657e0b62e1bc27b83fcbf.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--QHaCRPz6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/01/pasted-image-0-8.png)

每个前端开发者最可怕的敌人就是浏览器之间不一致的特性支持。这意味着网站在开发阶段可以在开发者选择的浏览器上完美地出现和运行，但在最终测试阶段可能在其他浏览器上看起来完全杂乱无章。

### [](#browser-preference-bias)浏览器偏好偏差
...
T3![](../Images/8547ab7f5e912b51663884102d8f0668.png)T5】

### [](#need-for-cross-browser-compatible-css)需要跨浏览器兼容的 CSS
...
[![](../Images/6f56e2c9413a1468c8571087ad3b6ab0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--WKjo1gTn--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/01/pasted-image-0-10.png)

*   任何最新版本的 Firefox 都不支持 CSS 属性

[![](../Images/33126371a1ca125eaf69275778d1197e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Gg1i9HGF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/01/pasted-image-0-11-1.png)

*   **任何最新版本的谷歌浏览器都不支持 CSS 属性**

[![](../Images/cd564aabeeee3a9bd7b1d8e6ce8dc22d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--xD1aVcVR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/01/pasted-image-0-12.png)

*   **任何最新版本的 Opera 都不支持 CSS 属性**

[![](../Images/f88a7d3972355363c150deac0a3fc76c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--7Y2Mg2qK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/01/pasted-image-0-13-1.png)

除此之外，一些浏览器甚至不支持一些 HTML 元素和属性。例如，IE 的任何版本都不支持表单属性“placeholder ”,甚至 Edge 也不支持。虽然 Chrome 和 Firefox 都支持。

### [](#approaches-to-counter-uneven-browser-support)应对不均衡浏览器支持的方法

有两种截然相反的开发理念被开发者们普遍用来应对不均衡的浏览器支持，并确保用户在所有浏览器中享有一定程度的一致性——适度的降级和渐进的增强。

[![](../Images/43a79d4afd2c8c13b760a821b83eb3f9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--nb4t8kON--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/01/pasted-image-0-14-1.png)
...
### [](#what-is-css-fault-tolerance)什么是 CSS 容错？
...
[![](../Images/c7d0c7959b123a8fd0ca510ae17b0b55.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--P-BolLn8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/01/pasted-image-0-15-1.png)
...
### [](#drawbacks-of-browser-detection-)浏览器检测的弊端:
...
### [](#browser-detection-and-feature-detection-comparison)浏览器检测和特征检测对比

考虑下面的测试场景。在这两种情况下，我们都为缺少浏览器支持做好了准备。
[![](../Images/351820731044049bc39c5ba25eb46ef4.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--U4q5O4WZ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/01/pngbase6486c4d8a5d7c3afbd-1.png)

如果浏览器配置已知，并且用户代理按预期工作并成功检测到，则这两种方法都有效。
[![](../Images/0d35a91f5f4af5610e0eb9ff7750a54d.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--LJ8EEjIX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/01/pngbase6434320a3c650405a1-1.png)
...
[![](../Images/5134022f38bb95fb73adc05a7506e28f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--5SNgFlkb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/01/pngbase64a8a18fe099647df4-1.png)

### [](#cross-browser-css-feature-detection-supports-feature-query)跨浏览器 CSS 特征检测—@支持特征查询
...
### [](#supports-detection-using-javascript)支持使用 Javascript 检测
...
### [](#using-css-supports-to-create-fallback-for-css-grid)使用 CSS @supports 为 CSS 网格创建回退

我们现在可以利用功能查询为画廊或作品集部分创建一个全功能的迷你布局。我们可以通过渐进式增强方法做到这一点，首先创建一个基本的布局版本，然后添加对 flexbox 和 CSS grid 的浏览器支持。

```

    ![](../Images/f21b1443760d41a892c96da26f52be3f.png)

## 网格卡 1

人们认为肥胖是一个问题。ipsam amet laudantium maxime suscipit。配给，eos。

    ![](../Images/25506dcba780632997da40127aa93ead.png)

## 网格卡 2

Lorem ipsum dolor，这是肥胖精英的共识。从自愿者的角度来看。

    ![](../Images/105e05d2df260f2e49b314f0ec743577.png)

## 网格卡 3

人们认为肥胖是一个问题。Quisquam ipsam accusantium voluptas！远见卓识，无所不能！

    ![](../Images/9b510529edde0c9504c56c801c3fd883.png)

## 网格卡 4

Lorem ipsum dolor，这是肥胖精英的共识。事实上，这种授权是无效的！

    ![](../Images/1fae1b5e2a2a64723b69c94b5006acb1.png)

## 网格卡 5

Lorem ipsum dolor，这是肥胖精英的共识。建筑师兼临时建筑师！Explicabo？

    ![](../Images/c15a094e2287cd8c102033765fe4ee37.png)

## 网格卡 6

人们认为肥胖是一个问题。因为事实上，没有法官的最高意见。

    ![](../Images/913c73147e7abc8e6ccd706c6f47f7ce.png)
...
[![](../Images/0947294d91aaf4938ee149cfc72b7ec1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--TD5_ZgfN--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/01/pasted-image-0-16-1.png)

[![](../Images/8f108bb3b9a3d2ce68415e255be0885c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--_d3emVSo--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/01/pasted-image-0-17-1.png)

**浏览器支持功能查询**

使用@supports 特性查询的一个症结是在一些旧的浏览器中缺乏浏览器支持。

[![](../Images/3fa9780b3567cac2304a6127c7d38122.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--NoINaMNS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.lambdatest.com/blog/wp-content/uploads/2019/01/pasted-image-0-18-1.png)
...
### [](#cross-browser-css-feature-detection-using-modernizr)使用 Modernizr 进行跨浏览器 CSS 特征检测
...
### [](#modernizr-feature-detection-using-javascript)使用 Javascript 进行 Modernizr 特征检测
...
### [](#cross-browser-testing-being-indispensable)跨浏览器测试必不可少

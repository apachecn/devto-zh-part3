...
> 原文:[https://dev . to/hrbrmstr/assumptions-matter-than-dependencies-94k](https://dev.to/hrbrmstr/assumptions-matter-more-than-dependencies-94k)
...
### [](#warning-will-robinson)警告【ING】威尔罗宾逊！
...
### [](#to-error-is-definitely-human-when-assumptions-are-flawed)错误肯定是人类在假设有缺陷时产生的

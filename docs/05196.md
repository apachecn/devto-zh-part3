...
> 原文:[https://dev . to/aaronpowell/how-to-delete-all-local-git-branch-merged-into-the-current-branch-4n 73](https://dev.to/aaronpowell/how-to-delete-all-local-git-branches-merged-into-the-current-branch-4n73)

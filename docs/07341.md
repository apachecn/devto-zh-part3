...
> 原文:[https://dev . to/gadimbaylisahil/custom-bin stub-for-rubo COP-to-run-only-on-changed-files-fcg](https://dev.to/gadimbaylisahil/custom-binstub-for-rubocop-to-run-only-on-changed-files-fcg)

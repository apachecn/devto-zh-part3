...
> 原文:[https://dev . to/circle ci/deploy-applications-using-circle ci-docker-hashi corp-terra form-and-Google-cloud-10l 8](https://dev.to/circleci/deploy-applications-using-circleci-docker-hashicorp-terraform-and-google-cloud-10l8)
...
## [](#create-a-google-cloud-platform-project)创建谷歌云平台项目
...
### [](#create-and-get-google-cloud-project-credentials)创建并获取谷歌云项目凭证
...
## [](#google-compute-instance-ip-address)谷歌计算实例 IP 地址

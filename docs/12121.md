...
> 原文:[https://dev . to/moesif/how-to-choose-the-right-API-gateway-for-your-platform-comparison-of-kong-tyk-API gee-and-alternatives-4oh 6](https://dev.to/moesif/how-to-choose-the-right-api-gateway-for-your-platform-comparison-of-kong-tyk-apigee-and-alternatives-4oh6)

## [](#why-api-gateways)为什么是 API 网关？
...
### [](#enterprise-integration-middleware)企业集成中间件
...
### [](#breaking-down-the-monolith)拆毁巨石
...
[![API-Gateway-with-Microservices](../Images/b479d185e18e1055284d7e7ede79a1a2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--6QQi1ix3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.moesif.com/images/posts/technical/api-management/API-Gateway-for-Microservices.png)
...
## [](#variables-to-compare-by)比较依据的变量
...
### [](#on-premise-vs-cloud-hosted)本地 vs 云托管
...
### [](#amazon-aws-api-gateway)亚马逊 AWS API 网关

...
> 原文:[https://dev . to/mikewheaton/sorting-by-created-date with-graph QL-and-prisma-318 c](https://dev.to/mikewheaton/sorting-by-created-date-with-graphql-and-prisma-318c)

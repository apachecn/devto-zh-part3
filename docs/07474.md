...
> 原文:[https://dev . to/mlen NOx/abstract-syntax-trees-for-fun-and-profit-4 mej](https://dev.to/mlennox/abstract-syntax-trees-for-fun-and-profit-4mej)

# [](#part-one-an-overview)第一部分-概述
...
[![](../Images/131863d9ecb9f024fd3fa78545337581.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--eHYOG4hX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/512sko41rdjlnz0oxp59.png)
...
# [](#what-are-abstract-syntax-trees)什么是抽象语法树
...
## [](#simple-variable-assignment)简单变量赋值
...
[![](../Images/1b36c8b9051bcd00b7d4a6821550c8fa.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--agQ--TA8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/9ncn271dhg3xjfojcdcz.png)

## [](#assigning-an-object)分配一个对象
...
[![](../Images/b4fa1a7e98c11a89c6d550d495cb9160.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--IyQNlxTo--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/erdw2xk21cbtzg4jnv86.png)

您可以看到层次结构分解成熟悉的节点排列，尽管与简单的赋值相比复杂性相对增加。

# [](#transforming-code)转换代码
...
## [](#babel-plugins-and-traversing-the-ast)巴别塔插件和穿越者 AST
...
## [](#convert-raw-var-endraw-to-raw-const-endraw-)将`var`转换为`const`
...
[![](../Images/7769dfe152e00ab2c326a2794fc869e7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--zgr4cQkT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/w3ep6fw8z88z0d41e2c6.png)
...
[![](../Images/d1b7f63d85e759747604dcca4a5adecf.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--VZNBsdbL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/zn0h18i89div7pn5v1o6.png)

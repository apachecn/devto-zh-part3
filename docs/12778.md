...
> 原文:[https://dev.to/molly/it-will-do-vs-it-will-scale-p38](https://dev.to/molly/it-will-do-vs-it-will-scale-p38)
...
## [](#finding-the-offending-code)查找违规代码
...
[![](../Images/bf41a1ac2579119996c9e9f83bcd6fe6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8AsrayQY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/6rtz45s2dw0x6rpyfxsq.gif)

现在这一切都完全说得通了。立刻，我对我找到的代码嗤之以鼻。但后来我阻止了自己。与其喋喋不休地抱怨这段代码有多低效，我还不如花些时间去理解为什么一开始要这样写。

## [](#writing-code-that-will-do)写代码就行了
...
## [](#writing-code-for-scale)为标尺编写代码
...
## [](#lesson-2-learned-dont-blindly-reuse-code)第二课学到了——不要盲目重用代码。

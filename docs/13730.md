...
> 原文:[https://dev . to/cmendibl 3/kubernetes-mount-a-file-in-your-pod-using-a-config map-50 of](https://dev.to/cmendibl3/kubernetes-mount-a-file-in-your-pod-using-a-configmap-50of)

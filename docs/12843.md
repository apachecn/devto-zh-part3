...
### [](#installing-ev3classesjar-as-a-local-maven-dependency)安装 ev3classes.jar 作为本地 maven 依赖项
...
### [](#to-package-or-not-to-package)要包还是不要包

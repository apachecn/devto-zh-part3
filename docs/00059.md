...
> 原文:[https://dev . to/lukethacoder/up-your-vs-code-game-with-work spaces-4fp 5](https://dev.to/lukethacoder/up-your-vs-code-game-with-workspaces-4fp5)

> 安妮·斯普拉特的照片

### [](#what-are-workspaces)什么是工作区
...
### [](#what-i-use-workspaces-for-atm)我用工作区做什么(atm)
...
### [](#my-workspace-starter-settings)我的工作区启动设置

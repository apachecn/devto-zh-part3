...
> 原文：<https://dev.to/spences10/convert-the-gatsby-default-starter-to-use-styled-components-2b9g>
...
在 CodeSandbox 编辑器的 dependencies 部分，您需要添加以下内容:
...
这篇文章最初发布在[我的盖茨比博客](https://blog.scottspence.me)上，你可以在这里[查看它](https://blog.scottspence.me/gatsby-starter-to-styled-components)如果你喜欢这篇文章，请看看我的其他内容。

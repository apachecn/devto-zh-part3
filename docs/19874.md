...
> 原文:[https://dev . to/rem bou 1/setup-an-azure-devo PS-ci-pipeline-with-e2e-tests-against-a-aspnet-core-server-48im](https://dev.to/rembou1/setup-an-azure-devops-ci-pipeline-with-e2e-tests-against-a-aspnet-core-server-48im)
...
## [](#selenium-chrome-web-driver)硒铬网络驱动
...
## [](#starting-the-aspnet-core-server)启动 ASPNET 核心服务器

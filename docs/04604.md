...
> 原文:[https://dev . to/hackersandslackers/becoming-family-Apache-Kafka-and-message-queues-10cb](https://dev.to/hackersandslackers/becoming-familiar-with-apache-kafka-and-message-queues-10cb)

[![Becoming Familiar with Apache Kafka and Message Queues](../Images/8f71c9e12dadcf29bda98a88349d1a54.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--FsLEWCBz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://storage.googleapis.com/hackersandslackers-cdn/2019/05/kafka-1-1%402x.jpg)
...
[![Becoming Familiar with Apache Kafka and Message Queues](../Images/1f2f32df7dbdcc5a304fc5794e381a9c.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--asSUNNRR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://storage.googleapis.com/hackersandslackers-cdn/2019/07/without-kafka-2.jpg) 
...
[![Becoming Familiar with Apache Kafka and Message Queues](../Images/f8464fb6029a2f94cb65c66f35d361e0.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--vDc3AFqd--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://storage.googleapis.com/hackersandslackers-cdn/2019/07/with-kafka.jpg) 
...
## [](#beneath-the-hood-of-a-kafka-cluster)卡夫卡簇的兜帽下
...
[![Becoming Familiar with Apache Kafka and Message Queues](../Images/3efc4299e93fa48895570496cb1e4259.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--aedJHNjV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://storage.googleapis.com/hackersandslackers-cdn/2019/07/kafkapatitions.jpg) 

<figcaption>卡夫卡中的隔断。</figcaption>

## [](#options-for-setting-up-kafka-or-equivalent)用于设置 Kafka(或等效物)的选项

建立卡夫卡有几个选择。Vanilla Kafka 并不完全是一个用户友好的设置，尤其是对于希望在一个集群中设置多个节点的任何人(也就是字面上的每个人)，因此值得考虑哪种实现最适合您的需求，尤其是在考虑您的云提供商时。

### [](#installing-kafka-manually)手动安装卡夫卡

这一点都不好玩，但是任何人都可以通过下载源代码并遵循这些说明来建立一个 Kafka 实例。Kafka 也依赖于 Apache 的 Zookeeper，所以需要相当多的设置。

### [](#kafka-as-a-service)卡夫卡式的服务
...
### [](#other-publishersubscriber-offerings)其他发布者/订阅者产品
...
## [](#the-future-is-unwritten)未来是不成文的

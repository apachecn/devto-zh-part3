...
> 原文:[https://dev.to/kt3k/write-aws-lambda-function-in-deno-4b20](https://dev.to/kt3k/write-aws-lambda-function-in-deno-4b20)
...
# [](#part-1-do-everything-on-your-own)第一部分。凡事都要靠自己

## [](#build-custom-deno)构建自定义 Deno
...
## [](#write-lambda-function)编写 Lambda 函数
...
# [](#part-2-use-the-shared-layer)第二部分。使用共享层
...
## [](#create-deno-lambda-function-using-public-deno-runtime)使用公共 Deno 运行时创建 Deno Lambda 函数

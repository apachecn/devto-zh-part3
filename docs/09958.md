...
> 原文:[https://dev . to/renegade coder 94/石头剪子布使用模运算-2j4p](https://dev.to/renegadecoder94/rock-paper-scissors-using-modular-arithmetic-2j4p)

最近，在我的 Java 课程中，学生们正在完成一项类似于石头剪刀布的作业，其中一个学生提出了一个聪明的问题:我们可以用数字来比较每个选择吗？思考片刻后，我意识到我们完全可以使用模运算实现石头剪刀布。

## [](#rock-paper-scissors-rules)石头剪刀布规则
...
## [](#rock-paper-scissors-challenges)石头剪刀布挑战
...
## [](#rock-paper-scissors-solutions)石头剪子布解
...
### [](#the-general-boilerplate)通用样板文件
...
### [](#the-modular-arithmetic-minimalist)模运算极简
...
[![Rock Paper Scissors Cycle](../Images/66fcc36d18e0066d94f40672e276f4cc.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---9odrkRi--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/196oemkls19nsme8s7ui.png)
...
## [](#the-power-of-modular-arithmetic)模运算的威力

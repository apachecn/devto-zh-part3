...
> 原文：<https://dev.to/zellwk/dealing-with-nested-callbacks-55o2>
...
现在想象一下，如果您必须在`makeBurger`中写下这些步骤中的每一步...您可能会被大量的代码吓晕！
...
承诺可以让回拨变得更容易管理。您看到的不是上面的嵌套代码，而是:
...
他们三个都工作。您可以选择使用任何库。尽管每种方法之间有细微的差别。我会让你去检查他们的文档。
...
(注意:你可以对承诺做同样的事情...但是语法没有 async/await 函数那么好和清晰)。

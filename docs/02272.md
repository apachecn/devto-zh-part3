...
> 原文:[https://dev . to/HANA kla/introduction-of-fleur-it-s-a-new-flux-framework-19d 9](https://dev.to/hanakla/introduction-of-fleur-it-s-a-new-flux-framework-19d9)
...
### [](#in-search-of-the-easier-to-write-and-robust-flux-framework)寻找更容易编写且健壮的 Flux 框架。
...
### [](#also-wanted-a-router-designed-based-on-the-real-scene)也想要一个基于真实场景设计的路由器。
...
[![](../Images/6d87e490fb20128a93140721f884b954.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--zbEXyhW5--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/cbph6p21m05hkdgcnpmp.png)
...
## [](#performance-what-about-numerically)性能，数值上呢？

感觉就像 Travis CI 上的 Fleur vs Floible vs react-redux 的标杆。

[![](../Images/e3b800722e525eb33aaec2fa68d1eee8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--fXbaDDGz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/15zu8xoi5bkduwlzfnwp.png)

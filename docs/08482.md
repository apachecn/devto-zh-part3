...
> 原文:[https://dev.to/dhilipkmr/cursor-imitator-2p0j](https://dev.to/dhilipkmr/cursor-imitator-2p0j)

[![](../Images/19a2c7d1e72217db5d9625875d44563e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--KRuPQsen--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/0p2irzwq6gf6ag9h2aqd.png)

## [](#so-what-are-we-going-to-build-today)那么我们今天要造什么呢？

我们将在这个项目中使用 React 来模拟用户输入效果。

我们最终的**输出**将如下所示:

[![](../Images/13452e0ae9ec6a26cd7a9a4a8f5dcfa4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--CqCyd-uO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/97fibkkcxj4x6lgb9siv.gif)

## [](#project-outline)项目概述:
...
[![](../Images/199f1ae91451aade3275be085fd84c00.png)](https://i.giphy.com/media/aAkNru67Hh40E/giphy.gif)T3】
...
### [](#so-what-have-we-done-so-far)那么到目前为止我们做了什么？
...
### [](#up-next-loading-letter-by-letter)接下来:一个字母一个字母地加载
...
[![](../Images/2a01cf9b3862ed48df8628244997971f.png)T2】](https://i.giphy.com/media/ZUyfp4MH7dzwc/giphy.gif)

...
> 原文:[https://dev.to/ruffle1986/understanding-swift-closures-第一部分-390 米](https://dev.to/ruffle1986/understanding-swift-closures---part-1-390m)
...
# [](#the-function-type-annotation)函数类型标注

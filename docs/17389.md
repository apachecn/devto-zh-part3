...
> 原文:[https://dev . to/spences 10/从无到有-创建-反应-应用程序-windows-2b8h](https://dev.to/spences10/from-scratch-to-create-react-app-on-windows-2b8h)

###### [](#photo-by-luana-de-marco-on-unsplash)照片由 Unsplash 上的 Luana De Marco 拍摄
...
> ![COTTON HEADED NINNYMUGGINS profile image](../Images/704eae3abad5980ca7ba21f1126f1556.png)棉花头傻子[@ ken _ wheeler](https://dev.to/ken_wheeler)![twitter logo](../Images/4c8a2313941dda016bf4d78d103264aa.png)所以我在工作中全职使用 Windows 大约有 4 个月，而且还不错。2018 年 12 月 20 日上午 00:59[![Twitter reply action](../Images/44d8b042100e231770330321e5b63d65.png)](https://twitter.com/intent/tweet?in_reply_to=1075556283795824640)[![Twitter retweet action](../Images/93d9c70ccc54851d2e8e881b53c21dae.png)](https://twitter.com/intent/retweet?tweet_id=1075556283795824640)[![Twitter like action](../Images/2e93f7775eadefab8bcd34a4542cc5a7.png)](https://twitter.com/intent/like?tweet_id=1075556283795824640)
...
## [](#enable-wsl-on-your-machine)在机器上启用 WSL

官方指南很好地涵盖了这一点，但如果你不想用鼠标四处点击，我将在这里添加快捷键。

但是，在此之前，如果您还没有选择 PowerShell 作为您的默认命令提示符，您可以从任务栏设置页面(位于设置的个性化部分)中选择它，我建议您现在就选择:

[![lsb_release image](../Images/7522ed8afdab9d953913ef3e92b08b59.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--MG37TNki--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/dbt2lrp8dmt123stt56j.gif)
...
## [](#update-upgrade-and-autoremove)更新、升级和自动删除
...
[![lsb_release image](../Images/8b51d3f7fdc270dd4586c581be1357b1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--o53-kaDV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/flvjitn6am1cifs9xb5z.png)
...
## [](#install-node-with-raw-n-endraw-)安装节点(带`n`)
...
## [](#install-visual-studio-code)安装 Visual Studio 代码
...
[![vscode-wsl-config](../Images/bf113de8fbdd2b33d8a2cd2f7bcc0af5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--nY1AeP61--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/xiiv0zyatpiogbqm1sl6.gif)

## [](#install-windows-git)安装 Windows Git
...
[![windows git setup](../Images/c88bc457d1955d6caf7682c72bf3be9f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--djnF_brU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/1g28jysxr50c9lfbu4p3.gif)

现在，这就是我们需要做的，当涉及到使用 SSH 通过 GitHub 进行身份验证时，我们将使用 Git Bash 命令行来配置 Windows 端的东西。

## [](#install-a-terminal-hyper)安装一个终端(Hyper)
...
[![basic hyper](../Images/1c07b0af53ce59f7ddea0014971f661c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--lnG7XozY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8s68jy17r31rp31kqxir.png)
...
[![basic hyper](../Images/b79946f4b01c2405cc1ce57da6ff4dcd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--jUkupMK7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/09s8cb1zjact18m81d76.gif)
...
[![basic hyper](../Images/548efb100ffa2bff2bcb0cbcf1c7bf12.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--czp3FDGK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4mmkgczkna40pw5htswk.gif)
...
[![install fish](../Images/c689369951ff8e1a728853248abceaac.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--XM8hQSUn--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ghpni0arfb0uolc58phf.gif)

### [](#install-oh-my-fish)安装我的鱼哦
...
[![install fish](../Images/688ada6a1cf3c855cf217255439a2d65.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--2ZXPvxaM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/i30rxzvyz075rmuxvjn9.gif)

#### [](#fish-themes-with-omf)以 OMF 为题材的鱼
...
[![omf one](../Images/3c89ecd92a18c5ae6bc96a0feda0c29f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---MsplIVn--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/tz0lrrybbzdhxinuwlib.gif)
...
[![alias fish in .bashrc](../Images/4698006f7aeb3dfaddc41e1ac4db27af.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--94SjY8fT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/vcrobbsjfzttckuej6f4.gif)
...
## [](#use-ssh-with-github)配合 GitHub 使用 SSH
...
[![ssh config wsl](../Images/033a86a2b36dab154b43f20970be34bd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--OX-KndjO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/gboeyexnsif1j8iwcq4p.gif)

### [](#windows-git-bash-ssh-config)Windows Git Bash SSH 配置
...
[![ssh config win](../Images/07ddf6f2ebe95af91bcab00e1b7522d9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--S7zsRg_C--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/abbz2m9l2b3c5r4ad7r6.gif)

现在 SSH 的附加设置已经完成，我们应该能够返回 Hyper，并将我们的更改推送到 GitHub。

[![final push github](../Images/1f0cae695818bf43b47015706b2f852e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--azusvapH--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4t10jo2hnvvlifu29zph.gif)

您可能还注意到了 SSH 键🔑令牌在设置屏幕上从黑色变为绿色，这表明您已经通过身份验证。

## [](#change-wsl-version)更改 WSL 版本

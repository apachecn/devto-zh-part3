...
> 原文:[https://dev . to/gruberb/web-programming-in-rust-02x-deploy-your-first-app-1k 05](https://dev.to/gruberb/web-programming-in-rust-02x-deploy-your-first-app-1k05)
...
## [](#this-series-has-3-goals)这个系列有 3 个目标
...
## [](#so-how-should-i-learn-rust-then)“那我该怎么学铁锈呢？”
...
#### [](#i-will-make-mine-public-as-well)我也会公开我的:
...
[![nodejs_dev_cycle](../Images/a9d6ee19fd42aff55614f62be53d4c5b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ldAAOr8X--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gruberb/web-programming-in-rust/master/assets/nodejs_dev.png)

使用 NodeJS，您可以将任何代码推送到生产服务器。你必须有好的测试、ESLint 和其他工具来捕捉未定义和类型错误。

在一个理想的世界中，我们有一个类似这样的开发周期:

[![ideal_dev_cycle](../Images/6621a46decc3a176adea30ac18aa5852.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--IgnR5_1x--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gruberb/web-programming-in-rust/master/assets/rust_dev.png)
...
### [](#rust-moves-possible-errors-closer-to-the-coding-environment)Rust 将可能的错误移近编码环境
...
### [](#difference-between-local-and-productionready-code)本地代码和生产就绪代码的区别
...
### [](#four-different-deployment-options)四种不同的部署选项
...
## [](#building-the-first-version-of-your-app)构建你的应用的第一个版本
...
## [](#managed-deployments-via-heroku)通过 Heroku 管理部署
...
[![heroku_deployments](../Images/49be53e4078aeabb9a954b279f06ed7a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--JTg43RMS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gruberb/web-programming-in-rust/master/assets/heroku.png)

要开始，你需要一个 [Heroku 账号](https://signup.heroku.com/)(免费)。使用您的新帐户登录并创建一个新应用程序:

[![heroku_new_app](../Images/8a8d894843e33ef94e1caf111cae44a6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--CAVwlIQo--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gruberb/web-programming-in-rust/master/assets/Bildschirmfoto%25202019-03-17%2520um%252011.35.50.png)

点击“创建应用”后，Heroku 在“部署”选项卡下解释了如何将您的代码推送到他们的服务器:

[![heroku_deploy](../Images/d4b2313547ad4879dd9523444f5d9027.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--1YQ6fbaw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gruberb/web-programming-in-rust/master/assets/Bildschirmfoto%25202019-03-17%2520um%252011.36.13.png)

#### [](#prepare-your-code)准备你的代码
...
[![docker_git_registry](../Images/e4dfaf69723624cbdd15ba4ef876a010.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vbZP3Qnb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gruberb/web-programming-in-rust/master/assets/git_docker.png)

第二种选择是使用 Docker 注册表。在那里，你有优势预先构建你的容器，并按原样运送它。这使得有时运行部署更快，并且您必须交付更少的代码(特别是在 Rust 的情况下)。

[![docker_registry](../Images/cbb8b6152ab896042ca1af5c52ed14a4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--gCyxPorg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gruberb/web-programming-in-rust/master/assets/docker_registry.png)
...
[![small_docker_image](../Images/ec77a00e38c9ce0dd6950c110fd7d4a7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Ngq8CMTP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gruberb/web-programming-in-rust/master/assets/carbon.png)
...
## [](#serverless-runtimes%E2%80%8A%E2%80%8Azeitnow)无服务器运行时— ZEIT/now
...
[![ZEIT_dashboard](../Images/ca764a647b521f832b723715e08fc6e6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--YonmEatX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://raw.githubusercontent.com/gruberb/web-programming-in-rust/master/assets/zeit_dashboard.png)

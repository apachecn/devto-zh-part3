...
> 原文:[https://dev . to/bnevilleoneill/5-key-redux-libraries-to-improve-code-reuse-4d in](https://dev.to/bnevilleoneill/5-key-redux-libraries-to-improve-code-reuse-4din)
...
### [](#1-reduxactions)[1。重复动作](https://redux-actions.js.org)
...
### [](#flux-standard-actions-fsa)通量标准动作(FSA)
...
### [](#creating-and-handling-actions)创建和处理动作
...
### [](#reusing-action-reducers)重用动作减少器
...
### [](#2-reselect)[2。重新选择](https://github.com/reduxjs/reselect)
...
### [](#improved-code-reuse-with-selector-props)用选择器道具改进代码重用
...
### [](#3-reduxsaga)[3。Redux-Saga](https://redux-saga.js.org/)
...
### [](#4-reduxobservable)[4。可重复观察的](https://redux-observable.js.org/)
...
### [](#reduxobservable-epics)还原-可观察的史诗
...
### [](#5-normalizr)[5。normal Zr](https://github.com/paularmstrong/normalizr)

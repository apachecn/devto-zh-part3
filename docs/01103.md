...
> 原文:[https://dev . to/azure/ordered-queue-processing-in-azure-functions-4h6c](https://dev.to/azure/ordered-queue-processing-in-azure-functions-4h6c)
...
[![Service Bus logo](../Images/a117c2070fa1f8c92d462cabd57e7bd6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--pBFCUEkL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/OiEKwxX.png)

## [](#default-and-out-of-order)缺省和故障
...
## [](#antipattern-limit-scale-out-and-concurrency)反模式:限制向外扩展和并发
...
## [](#using-sessions-in-azure-functions)在 Azure 函数中使用会话
...
[![session enabled queue](../Images/05933ba0132c2de6becc30ccf01b6da0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--jNJu6QPv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/jc4osnmq7q20obk8d5ir.png)

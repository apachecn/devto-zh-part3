...
> 原文:[https://dev . to/scottshipp/useful-stream-utilities-not-found-in-Java-13cf](https://dev.to/scottshipp/useful-stream-utilities-not-found-in-java-13cf)
...
### [](#concatenate-more-than-two-streams)串联两个以上的流
...
### [](#filtering-by-comparison)通过比较过滤
...
## [](#but-wait-theres-more)但是，等等，还有更多
...
## ![GitHub logo](../Images/75095a8afc1e0f207cda715962e75c8d.png) [斯科塔希普](https://github.com/scottashipp) / [米尔](https://github.com/scottashipp/mill)

### Java 库使一般的任务更加优雅。兼容 Java 8+。

<article class="markdown-body entry-content container-lg" itemprop="text">

# 米尔 [![Build Status](../Images/927a371d5212f8a2d2b4c2741068f748.png)](https://travis-ci.com/scottashipp/mill)

[![logo](../Images/f5ce0956e0e330032bfeab8ac32eb16c.png)T2】](https://github.com/scottashipp/millmedia/mill-rind-90x90.png?raw=true)

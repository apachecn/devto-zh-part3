...
> 原文:[https://dev . to/arit developer/jscd-new-wheels-not-need-2bdh](https://dev.to/aritdeveloper/jscd-new-wheels-not-needed-2bdh)

在我新工作的这个星期，我再次意识到单独编码和作为团队的一部分编码之间的区别。

我的一个票证要求我向现有的表中添加一个新的数据列(指示某些产品是否提供免费试用)。如果有免费试用，会显示一个绿色的勾号；否则，会显示一个灰色的复选标记。

[![Green and Greyed-Out Checkmarks](../Images/0ba8396f6c4490d9ad8ce6a2dc6b2363.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--W_EAeXmF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/08oycgdc7gkpjr6y4vrc.png)

...
> 原文:[https://dev . to/dance 2 die/dynamic-build-typescript-string-literal-type-1 BC 7](https://dev.to/dance2die/dynamically-build-typescript-string-literal-type-1bc7)

...
> 原文:[https://dev.to/arjunrajkumar/write-better-code-day-4-排序-分数-2226](https://dev.to/arjunrajkumar/write-better-code-day-4---sorted-scores-2226)

这篇文章最初出现在 Arjun Rajkumar 的博客上。Arjun 是印度班加罗尔的一名 web 开发人员。

-

### [](#day-4-question-2)第四天:问题 2

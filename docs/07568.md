...
> 原文:[https://dev.to/rkowase/leetcode-in-kotlin-1-two-sum-3ci8](https://dev.to/rkowase/leetcode-in-kotlin-1-two-sum-3ci8)
...
### [](#approach-2-twopass-hash-table)方法 2:两遍哈希表
...
### [](#approach-3-onepass-hash-table)方法 3:一遍哈希表

...
> 原文:[https://dev.to/angular/angular-routing-企业应用最佳实践-3p6b](https://dev.to/angular/angular-routing---best-practices-for-enterprise-applications-3p6b)
...
## [](#best-practice-1-create-a-toplevel-routes-array-file)最佳实践#1 -创建顶级路由数组文件
...
## [](#best-practice-2-create-a-featurelevel-routes-array-file)最佳实践#2 -创建要素级路线数组文件
...
## [](#best-practice-3-add-lazy-loaded-features-to-toplevel-routes-file)最佳实践#3 -将延迟加载的特性添加到顶级路线文件中
...
## [](#best-practice-4-keep-router-guards-organized)最佳实践#4 -保持路由器防护有序

这里有一些让你的路由器防护保持有序的小技巧。这些只是指导方针，但我发现它们非常有帮助。

### [](#name-your-guards-well)给你的护卫起个好名字
...
[![](../Images/b13c1cd0c882dc53907d0cbf29b3b902.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ePzBk4Dk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://wesleygrimes.com/assets/post_headers/routing_directory.png)

### [](#organize-featurespecific-route-guards)组织特色路线守卫
...
[![](../Images/808ecbaffe562493c3ae98f20c426991.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--WUVWts1p--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://wesleygrimes.com/assets/post_headers/routing_feature_directory.png)

## [](#finished-application-structure)完成应用结构

完整的应用程序结构应该如下所示:

[![](../Images/17ae8cb51c3e275284d44eef9b77ce49.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---SqG8P_r--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://wesleygrimes.com/assets/post_headers/routing_completed_structure.png)

* * *

## [](#example-github-repository)示例 GitHub 资源库

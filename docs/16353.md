...
> 原文:[https://dev . to/itachiuchiha/lazy-loading-with-intersection observer-API-44pe](https://dev.to/itachiuchiha/lazy-loading-with-the-intersectionobserver-api-44pe)
...
## [](#html-ampamp-css-codes)HTML & & CSS 代码

...
> 原文:[https://dev . to/nsebhastian/firebase-as-simple-database-to-react-app-430 p](https://dev.to/nsebhastian/firebase-as-simple-database-to-react-app-430p)
...
## [](#create-your-database-application)创建您的数据库应用程序

首先，您需要在 Firebase 控制台中创建应用程序。

然后前往*数据库*菜单，向下滚动一点进入*选择实时数据库*部分。

[![Creating real time database](../Images/1b271c5ac6b320635301580854f0ae53.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--hnzCh9pr--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://sebhastian.com/static/918f9d5ee2d9c1912113d8cf4fa2a9e3/228d5/react-firebase-1.png)
...
[![Creating real time database](../Images/8da2a6463b2ad56d7e8c227b377cf513.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--lBiAskkl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://sebhastian.com/static/99e36d584cc576ff473460382936770c/228d5/react-firebase-3.png)
...
## [](#setting-up-your-react-application)设置 React 应用程序
...
## [](#creating-raw-configjs-endraw-file)创建`config.js`文件
...
## [](#write-the-raw-indexjs-endraw-file)写入`index.js`文件
...
## [](#creating-your-application)创建您的应用

...
> 原文:[https://dev . to/jhotterbeekx/testing-asynchronous-life cycle-methods-with-jest-13jo](https://dev.to/jhotterbeekx/testing-asynchronous-lifecycle-methods-with-jest-13jo)
...
## [](#testing-asynchronous-lifecycle-methods)测试异步生命周期方法

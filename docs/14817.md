...
> 原文:[https://dev . to/惠晶/handling-external-posts-on-your-own-Jekyll-site-1 ekm](https://dev.to/huijing/handling-external-posts-on-your-own-jekyll-site-1ekm)
...
## [](#replacing-internal-urls-with-external-urls)用外部 URL 替换内部 URL
...
## [](#visual-cues-for-external-links)外部链接的视觉提示
...
## [](#additional-things-you-could-do)你可以做的其他事情

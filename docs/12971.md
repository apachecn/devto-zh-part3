...
> 原文:[https://dev . to/Chen/how-to-run-your-own-docker-registry-with-password-SSL-and-S3-back end-268 b](https://dev.to/chen/how-to-run-your-own-docker-registry-with-password-ssl-and-s3-backend-268b)
...
# [](#get-the-registry-running)让注册表运行
...
[![Photo by Liam Tucker on Unsplash](../Images/b818c8e61ceab41db0d8535f46f2f6dc.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--lSr9Busq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/toglazr7ykc9udlk9kq1.jpg)

# [](#private-ssl-certificates)私有 SSL 证书
...
# [](#api-to-check-registry-contents)检查注册表内容的 API

...
> 原文:[https://dev . to/letmypeoplecode/learning-JavaScript-TDD-with-ava-glitch-and-free code camp-2njo](https://dev.to/letmypeoplecode/learning-javascript-tdd-with-ava-glitch-and-freecodecamp-2njo)
...
## [](#thats-a-word-salad-what-are-tdd-ava-and-glitch)**那是沙拉一词。什么是 TDD、AVA 和毛刺？**
...
### [](#what-is-ava)**什么是 [AVA](https://github.com/avajs/ava) ？**

[AVA](https://github.com/avajs/ava) 是 [node.js](https://nodejs.org) JavaScript 应用程序的测试人员。它有一个帮助指导你如何编写测试的结构，然后它运行测试并报告结果。

<figure>[![screen cap of good result](../Images/4d8e5671f94dbfa94c483c3d33e895c3.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--uA89W7Tm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://yiddish.ninja/wp-content/uploads/2019/04/goodresult.jpg) 

<figcaption id="caption-attachment-1173"><small>这就是我们在这篇文章中的目标。</small></figcaption>

</figure>

### [](#what-is-glitch)什么是[小故障](https://glitch.com)？
...
[![Screencap of Glitch](../Images/970353d306fbc71dc6fd65a75eb83837.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--n9GRJHOx--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://yiddish.ninja/wp-content/uploads/2019/04/glitch.jpg)
...
### [](#step-1-clone-the-timestamp-microservice-template-on-glitch)**第一步:在 Glitch 上克隆时间戳微服务模板**
...
### [](#step-2-add-testing-resources-to-raw-packagejson-endraw-)**第二步:将测试资源添加到`package.json`**
...
### [](#3-create-your-first-test)**3:创建你的第一个测试**
...
[![first test results](../Images/f62c822203e5c9ccdf154616e3647468.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Jo06QgkT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://yiddish.ninja/wp-content/uploads/2019/04/test1.jpg)

测试失败，出现“测试返回的拒绝承诺”那是因为 app 需要两样东西。

### [](#4-edit-raw-serverjs-endraw-)**4:编辑`server.js`**
...
### [](#4-add-raw-indexjs-endraw-)**4:添加`index.js`**
...
[![successful test](../Images/ec8b432bf0d77e83cff8a013e0e835a8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--DYNCEIm9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://yiddish.ninja/wp-content/uploads/2019/04/test2.jps_.jpg)

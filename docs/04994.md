...
> 原文:[https://dev . to/loukilaymen/Google-light house-custom-audits-173 l](https://dev.to/loukilaymen/google-lighthouse-custom-audits-173l)
...
## [](#what-is-google-lighthouse-)谷歌灯塔是什么？
...
## [](#custom-metrics-and-custom-audits-)自定义指标和自定义审计:
...
[![Google Lighthouse custom audit report](../Images/fb4b7efae8f0a58b54c55727e4e10f86.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--UpRlwBxA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.aymen-loukil.com/wp-content/uploads/2018/11/lighthouse-custom-audit-report-1.png)

在 Lighthouse 报告摘要中，我们看到一个新的审计类别被添加到默认类别旁边:“我的英雄形象指标”酷！

## [](#what-will-you-need-to-create-a-lighthouse-custom-audit-)创建灯塔自定义审计需要什么？
...
### [](#1-configure-your-web-page-for-the-custom-audit-)1-为自定义审计配置您的网页:
...
[![performance timing api](../Images/ab4eaa702caf296d1dbc2c39e224d534.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--OAg0GkMr--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/x6rrmkqow74528dz2i07.PNG)
...
### [](#2-create-a-custom-audit-in-lighthouse-)2-在 Lighthouse 中创建自定义审计:
...
## [](#now-what-only-lighthouse-)现在怎么样了？只有灯塔？
...
### [](#pull-the-source-code-of-this-custom-audit-and-start-building-yours-)获取这个定制审计的源代码，并开始构建您的！

要使用这个自定义审计，您可以从我的 Github
中提取它

## ![GitHub logo](../Images/a73f630113876d78cff79f59c2125b24.png) [ AymenLoukil ](https://github.com/AymenLoukil) / [谷歌-灯塔-定制-审计](https://github.com/AymenLoukil/Google-lighthouse-custom-audit)

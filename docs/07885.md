...
> 原文:[https://dev . to/oktadev/build-an-IOs-app-with-react-native-and-publish-it-to-the-app-store-340 I](https://dev.to/oktadev/build-an-ios-app-with-react-native-and-publish-it-to-the-app-store-340i)
...
## [](#configure-authentication-for-your-react-native-ios-app)为您的 React 原生 iOS 应用配置认证
...
## [](#running-your-react-native-app-on-ios-simulator)在 iOS 模拟器上运行 React 原生应用
...
## [](#adjust-styling-in-your-react-native-ios-app)在 React 原生 iOS 应用中调整样式
...
## [](#set-the-icon-and-display-name-and-run-on-a-device)设置图标和显示名称并在设备上运行
...
[![New Splash Screen](../Images/e3bfe88e14a9deba86f9abf01f777245.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--oDwkTJ7e--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://developer.okta.com/assets-jekyll/blog/react-native-ios-app-store/splash-screen-new-9a896fb9325729ea36a5d8cee1cc7534a498264d09a0ff36d8b1f068b04f9aa5.png)
...
## [](#submit-your-react-native-app-to-the-ios-store)将您的 React 原生应用提交至 iOS 商店
...
## [](#learn-more-about-react-native-and-secure-authentication)了解 React 本机和安全认证的更多信息

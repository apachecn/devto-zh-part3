...
> 原文:[https://dev . to/nzakas/computer-science-in-JavaScript-2019-linked-list-43 N2](https://dev.to/nzakas/computer-science-in-javascript-2019-linked-list-43n2)
...
## [](#the-design-of-a-linked-list)链表的设计
...
[![Diagram of a Linked List](../Images/920070341758448df878ca8e7c275d0b.png)T2】](http://en.wikipedia.org/wiki/File:Singly-linked-list.svg)
...
### [](#removing-data-from-a-linked-list)从链表中删除数据
...
[![Linked list removal diagram](../Images/300d487530dac9fb3d4ef5b5e21f81cb.png)T2】](http://en.wikipedia.org/wiki/File:Singly_linked_list_delete_after.png)
...
### [](#making-the-list-iterable)使列表可迭代
